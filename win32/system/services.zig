...
pub const ENUM_SERVICE_TYPE = packed struct(u32) {
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // FILE_SYSTEM_DRIVER (2) conflicts with FILE_SYSTEM_DRIVER_
    // WIN32_OWN_PROCESS (16) conflicts with WIN32_OWN_PROCESS_
};
pub const SERVICE_DRIVER = ENUM_SERVICE_TYPE{
    .KERNEL_DRIVER = 1,
    .FILE_SYSTEM_DRIVER_ = 1,
    .RECOGNIZER_DRIVER = 1,
};
pub const SERVICE_FILE_SYSTEM_DRIVER_ = ENUM_SERVICE_TYPE{ .FILE_SYSTEM_DRIVER_ = 1 };
pub const SERVICE_KERNEL_DRIVER = ENUM_SERVICE_TYPE{ .KERNEL_DRIVER = 1 };
pub const SERVICE_WIN32 = ENUM_SERVICE_TYPE{
    .WIN32_OWN_PROCESS_ = 1,
    .WIN32_SHARE_PROCESS = 1,
};
pub const SERVICE_WIN32_OWN_PROCESS_ = ENUM_SERVICE_TYPE{ .WIN32_OWN_PROCESS_ = 1 };
...
pub const SERVICE_FILE_SYSTEM_DRIVER = ENUM_SERVICE_TYPE{ .FILE_SYSTEM_DRIVER_ = 1 };
pub const SERVICE_RECOGNIZER_DRIVER = ENUM_SERVICE_TYPE{ .RECOGNIZER_DRIVER = 1 };
pub const SERVICE_WIN32_OWN_PROCESS = ENUM_SERVICE_TYPE{ .WIN32_OWN_PROCESS_ = 1 };
