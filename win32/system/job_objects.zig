...
pub const JOB_OBJECT_CPU_RATE_CONTROL = packed struct(u32) {
    CPU_RATE_CONTROL_ENABLE: u1 = 0,
    CPU_RATE_CONTROL_WEIGHT_BASED: u1 = 0,
    CPU_RATE_CONTROL_HARD_CAP: u1 = 0,
    CPU_RATE_CONTROL_NOTIFY: u1 = 0,
    _CPU_RATE_CONTROL_MIN_MAX_RATE: u1 = 0,
    _5: u1 = 0,
    _6: u1 = 0,
    _7: u1 = 0,
    _8: u1 = 0,
...
pub const JOB_OBJECT_CPU_RATE_CONTROL_ENABLE = JOB_OBJECT_CPU_RATE_CONTROL{ .CPU_RATE_CONTROL_ENABLE = 1 };
pub const JOB_OBJECT_CPU_RATE_CONTROL_WEIGHT_BASED = JOB_OBJECT_CPU_RATE_CONTROL{ .CPU_RATE_CONTROL_WEIGHT_BASED = 1 };
pub const JOB_OBJECT_CPU_RATE_CONTROL_HARD_CAP = JOB_OBJECT_CPU_RATE_CONTROL{ .CPU_RATE_CONTROL_HARD_CAP = 1 };
pub const JOB_OBJECT_CPU_RATE_CONTROL_NOTIFY = JOB_OBJECT_CPU_RATE_CONTROL{ .CPU_RATE_CONTROL_NOTIFY = 1 };
pub const JOB_OBJECT__CPU_RATE_CONTROL_MIN_MAX_RATE = JOB_OBJECT_CPU_RATE_CONTROL{ ._CPU_RATE_CONTROL_MIN_MAX_RATE = 1 };
