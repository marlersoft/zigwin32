...
pub const IWbemServices = extern union {
    ...
    pub fn ExecQuery(self: *const IWbemServices, strQueryLanguage: ?BSTR, strQuery: ?BSTR, lFlags: WBEM_GENERIC_FLAG_TYPE, pCtx: ?*IWbemContext, ppEnum: ?*?*IEnumWbemClassObject) callconv(.@"inline") HRESULT {
...
pub const WBEM_GENERIC_FLAG_TYPE = packed struct(u32) {
    _0: u1 = 0,
    _1: u1 = 0,
    _2: u1 = 0,
    _3: u1 = 0,
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // RETURN_IMMEDIATELY (bit index 4) conflicts with FLAG_RETURN_IMMEDIATELY
};
pub const WBEM_FLAG_RETURN_IMMEDIATELY = WBEM_GENERIC_FLAG_TYPE{ .FLAG_RETURN_IMMEDIATELY = 1 };
pub const WBEM_FLAG_RETURN_WBEM_COMPLETE = WBEM_GENERIC_FLAG_TYPE{ };
pub const WBEM_FLAG_BIDIRECTIONAL = WBEM_GENERIC_FLAG_TYPE{ };
pub const WBEM_FLAG_FORWARD_ONLY = WBEM_GENERIC_FLAG_TYPE{ .FLAG_FORWARD_ONLY = 1 };
pub const WBEM_FLAG_NO_ERROR_OBJECT = WBEM_GENERIC_FLAG_TYPE{ .FLAG_NO_ERROR_OBJECT = 1 };
pub const WBEM_FLAG_RETURN_ERROR_OBJECT = WBEM_GENERIC_FLAG_TYPE{ };
pub const WBEM_FLAG_SEND_STATUS = WBEM_GENERIC_FLAG_TYPE{ .FLAG_SEND_STATUS = 1 };
pub const WBEM_FLAG_DONT_SEND_STATUS = WBEM_GENERIC_FLAG_TYPE{ };
pub const WBEM_FLAG_ENSURE_LOCATABLE = WBEM_GENERIC_FLAG_TYPE{ .FLAG_ENSURE_LOCATABLE = 1 };
pub const WBEM_FLAG_DIRECT_READ = WBEM_GENERIC_FLAG_TYPE{ .FLAG_DIRECT_READ = 1 };
pub const WBEM_FLAG_SEND_ONLY_SELECTED = WBEM_GENERIC_FLAG_TYPE{ };
pub const WBEM_RETURN_WHEN_COMPLETE = WBEM_GENERIC_FLAG_TYPE{ };
pub const WBEM_RETURN_IMMEDIATELY = WBEM_GENERIC_FLAG_TYPE{ .FLAG_RETURN_IMMEDIATELY = 1 };
pub const WBEM_MASK_RESERVED_FLAGS = WBEM_GENERIC_FLAG_TYPE{
    ._12 = 1,
    ._13 = 1,
    ._14 = 1,
    ._15 = 1,
...
pub const WBEM_FLAG_USE_AMENDED_QUALIFIERS = WBEM_GENERIC_FLAG_TYPE{ .FLAG_USE_AMENDED_QUALIFIERS = 1 };
pub const WBEM_FLAG_STRONG_VALIDATION = WBEM_GENERIC_FLAG_TYPE{ .FLAG_STRONG_VALIDATION = 1 };
