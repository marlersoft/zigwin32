...
pub const CONSOLE_MODE = packed struct(u32) {
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // ENABLE_PROCESSED_OUTPUT (1) conflicts with ENABLE_PROCESSED_INPUT
    // ENABLE_WRAP_AT_EOL_OUTPUT (2) conflicts with ENABLE_LINE_INPUT
    // ENABLE_VIRTUAL_TERMINAL_PROCESSING (4) conflicts with ENABLE_ECHO_INPUT
    // DISABLE_NEWLINE_AUTO_RETURN (8) conflicts with ENABLE_WINDOW_INPUT
    // ENABLE_LVB_GRID_WORLDWIDE (16) conflicts with ENABLE_MOUSE_INPUT
};
