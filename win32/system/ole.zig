...
pub const ICreateTypeInfo = extern union {
    ...
    pub fn SetImplTypeFlags(self: *const ICreateTypeInfo, index: u32, implTypeFlags: IMPLTYPEFLAGS) callconv(.@"inline") HRESULT {
...
const IMPLTYPEFLAGS = @import("../system/com.zig").IMPLTYPEFLAGS;
