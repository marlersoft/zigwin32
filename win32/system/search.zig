...
pub const DB_NULLGUID = Guid.initString("00000000-0000-0000-0000-000000000000");
...
pub const DBCIDGUID = Guid.initString("0c733a81-2a1c-11ce-ade5-00aa0044773d");
...
pub const DBGUID_ROWDEFAULTSTREAM = Guid.initString("0c733ab7-2a1c-11ce-ade5-00aa0044773d");
pub const DBGUID_ROWURL = Guid.initString("0c733ab6-2a1c-11ce-ade5-00aa0044773d");
...
pub const DBSELFGUID = Guid.initString("c8b52231-5cf3-11ce-ade5-00aa0044773d");
...
pub const PRTH_E_ACCESS_DENIED = @as(u32, 2147750405);
pub const PRTH_E_ACL_IS_READ_NONE = @as(u32, 2147750417);
pub const PRTH_E_ACL_TOO_BIG = @as(u32, 2147750418);
pub const PRTH_E_BAD_REQUEST = @as(u32, 2147750408);
...
pub const PRTH_E_COMM_ERROR = @as(u32, 2147750400);
pub const PRTH_E_DATABASE_OPEN_ERROR = @as(i32, -2147216875);
pub const PRTH_E_HTTP_CANNOT_CONNECT = @as(u32, 2147750409);
...
pub const PRTH_E_NOT_REDIRECTED = @as(u32, 2147750407);
pub const PRTH_E_OBJ_NOT_FOUND = @as(u32, 2147750401);
pub const PRTH_E_OPLOCK_BROKEN = @as(i32, -2147216874);
pub const PRTH_E_REQUEST_ERROR = @as(u32, 2147750402);
pub const PRTH_E_RETRY = @as(i32, -2147216885);
pub const PRTH_E_SERVER_ERROR = @as(u32, 2147750406);
...
pub const PRTH_S_ACL_IS_READ_EVERYONE = @as(u32, 266768);
pub const PRTH_S_MAX_DOWNLOAD = @as(i32, 266764);
pub const PRTH_S_MAX_GROWTH = @as(i32, 266761);
pub const PRTH_S_NOT_ALL_PARTS = @as(u32, 266779);
pub const PRTH_S_NOT_MODIFIED = @as(u32, 266755);
