...
pub const MODIFIERKEYS_FLAGS = packed struct(u32) {
    LBUTTON: u1 = 0,
    RBUTTON: u1 = 0,
    SHIFT: u1 = 0,
    CONTROL: u1 = 0,
...
pub const MK_LBUTTON = MODIFIERKEYS_FLAGS{ .LBUTTON = 1 };
pub const MK_RBUTTON = MODIFIERKEYS_FLAGS{ .RBUTTON = 1 };
pub const MK_SHIFT = MODIFIERKEYS_FLAGS{ .SHIFT = 1 };
pub const MK_CONTROL = MODIFIERKEYS_FLAGS{ .CONTROL = 1 };
pub const MK_MBUTTON = MODIFIERKEYS_FLAGS{ .MBUTTON = 1 };
pub const MK_XBUTTON1 = MODIFIERKEYS_FLAGS{ .XBUTTON1 = 1 };
pub const MK_XBUTTON2 = MODIFIERKEYS_FLAGS{ .XBUTTON2 = 1 };
...
pub const STATIC_STYLES = enum(u32) {
    ...
    PATHELLIPSIS = 32768,
    WORDELLIPSIS = 49152,
    pub const ELLIPSISMASK = .WORDELLIPSIS;
};
