...
const USN_RECORD_COMMON_HEADER = @import("../storage/file_system.zig").USN_RECORD_COMMON_HEADER;
const USN_RECORD_V3 = @import("../storage/file_system.zig").USN_RECORD_V3;
