...
pub const REG_ROUTINE_FLAGS = packed struct(u32) {
    RT_REG_NONE: u1 = 0,
    RT_REG_SZ: u1 = 0,
...
pub const RRF_RT_DWORD = REG_ROUTINE_FLAGS{
    .RT_REG_BINARY = 1,
    .RT_REG_DWORD = 1,
};
pub const RRF_RT_QWORD = REG_ROUTINE_FLAGS{
    .RT_REG_BINARY = 1,
    .RT_REG_QWORD = 1,
};
pub const RRF_RT_REG_NONE = REG_ROUTINE_FLAGS{ .RT_REG_NONE = 1 };
pub const RRF_RT_REG_SZ = REG_ROUTINE_FLAGS{ .RT_REG_SZ = 1 };
pub const RRF_RT_REG_EXPAND_SZ = REG_ROUTINE_FLAGS{ .RT_REG_EXPAND_SZ = 1 };
pub const RRF_RT_REG_BINARY = REG_ROUTINE_FLAGS{ .RT_REG_BINARY = 1 };
pub const RRF_RT_REG_DWORD = REG_ROUTINE_FLAGS{ .RT_REG_DWORD = 1 };
pub const RRF_RT_REG_MULTI_SZ = REG_ROUTINE_FLAGS{ .RT_REG_MULTI_SZ = 1 };
pub const RRF_RT_REG_QWORD = REG_ROUTINE_FLAGS{ .RT_REG_QWORD = 1 };
pub const RRF_RT_ANY = REG_ROUTINE_FLAGS{
    .RT_REG_NONE = 1,
    .RT_REG_SZ = 1,
    .RT_REG_EXPAND_SZ = 1,
    .RT_REG_BINARY = 1,
...
pub const RRF_SUBKEY_WOW6464KEY = REG_ROUTINE_FLAGS{ .SUBKEY_WOW6464KEY = 1 };
pub const RRF_SUBKEY_WOW6432KEY = REG_ROUTINE_FLAGS{ .SUBKEY_WOW6432KEY = 1 };
pub const RRF_WOW64_MASK = REG_ROUTINE_FLAGS{
    .SUBKEY_WOW6464KEY = 1,
    .SUBKEY_WOW6432KEY = 1,
};
pub const RRF_NOEXPAND = REG_ROUTINE_FLAGS{ .NOEXPAND = 1 };
pub const RRF_ZEROONFAILURE = REG_ROUTINE_FLAGS{ .ZEROONFAILURE = 1 };
