...
// skipped 'WTS_CURRENT_SERVER'
// skipped 'WTS_CURRENT_SERVER_HANDLE'
...
pub const WTS_SECURITY_FLAGS = packed struct(u32) {
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // GUEST_ACCESS (bit index 5) conflicts with LOGON
};
pub const WTS_SECURITY_CURRENT_GUEST_ACCESS = WTS_SECURITY_FLAGS{
    .VIRTUAL_CHANNELS = 1,
    .LOGOFF = 1,
};
pub const WTS_SECURITY_USER_ACCESS = WTS_SECURITY_FLAGS{
    .QUERY_INFORMATION = 1,
    .VIRTUAL_CHANNELS = 1,
    .LOGOFF = 1,
    .CONNECT = 1,
};
pub const WTS_SECURITY_CURRENT_USER_ACCESS = WTS_SECURITY_FLAGS{
    .SET_INFORMATION = 1,
    .RESET = 1,
    .VIRTUAL_CHANNELS = 1,
    .LOGOFF = 1,
...
pub const WTS_SECURITY_ALL_ACCESS = WTS_SECURITY_FLAGS{
    .QUERY_INFORMATION = 1,
    .SET_INFORMATION = 1,
    .RESET = 1,
    .VIRTUAL_CHANNELS = 1,
...
pub const WTS_SECURITY_QUERY_INFORMATION = WTS_SECURITY_FLAGS{ .QUERY_INFORMATION = 1 };
pub const WTS_SECURITY_SET_INFORMATION = WTS_SECURITY_FLAGS{ .SET_INFORMATION = 1 };
pub const WTS_SECURITY_RESET = WTS_SECURITY_FLAGS{ .RESET = 1 };
pub const WTS_SECURITY_VIRTUAL_CHANNELS = WTS_SECURITY_FLAGS{ .VIRTUAL_CHANNELS = 1 };
pub const WTS_SECURITY_REMOTE_CONTROL = WTS_SECURITY_FLAGS{ .REMOTE_CONTROL = 1 };
pub const WTS_SECURITY_LOGON = WTS_SECURITY_FLAGS{ .LOGON = 1 };
pub const WTS_SECURITY_LOGOFF = WTS_SECURITY_FLAGS{ .LOGOFF = 1 };
pub const WTS_SECURITY_MESSAGE = WTS_SECURITY_FLAGS{ .MESSAGE = 1 };
pub const WTS_SECURITY_CONNECT = WTS_SECURITY_FLAGS{ .CONNECT = 1 };
pub const WTS_SECURITY_DISCONNECT = WTS_SECURITY_FLAGS{ .DISCONNECT = 1 };
