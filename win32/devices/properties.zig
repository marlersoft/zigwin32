...
//--------------------------------------------------------------------------------
pub const DEVPKEY_DeviceInterface_Autoplay_Silent = PROPERTYKEY { .fmtid = @import("../zig.zig").Guid.initString("434dd28f-9e75-450a-9ab9-ff61e618bad0"), .pid = 2 };
...
pub const DEVPKEY_Device_CreatorProcessId = PROPERTYKEY { .fmtid = @import("../zig.zig").Guid.initString("540b947e-8b40-45bc-a8a2-6a0b894cbda2"), .pid = 25 };
