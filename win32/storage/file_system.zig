...
pub const FILE_FLAGS_AND_ATTRIBUTES = packed struct(u32) {
    ...
    // FILE_ATTRIBUTE_RECALL_ON_OPEN (262144) conflicts with FILE_ATTRIBUTE_EA
    // FILE_FLAG_OPEN_NO_RECALL (1048576) conflicts with FILE_ATTRIBUTE_UNPINNED
    // FILE_FLAG_FIRST_PIPE_INSTANCE (524288) conflicts with FILE_ATTRIBUTE_PINNED
    // PIPE_ACCESS_INBOUND (1) conflicts with FILE_ATTRIBUTE_READONLY
    // PIPE_ACCESS_OUTBOUND (2) conflicts with FILE_ATTRIBUTE_HIDDEN
    // SECURITY_IDENTIFICATION (65536) conflicts with FILE_ATTRIBUTE_VIRTUAL
    // SECURITY_IMPERSONATION (131072) conflicts with FILE_ATTRIBUTE_NO_SCRUB_DATA
    // SECURITY_CONTEXT_TRACKING (262144) conflicts with FILE_ATTRIBUTE_EA
    // SECURITY_EFFECTIVE_ONLY (524288) conflicts with FILE_ATTRIBUTE_PINNED
    // SECURITY_SQOS_PRESENT (1048576) conflicts with FILE_ATTRIBUTE_UNPINNED
};
...
pub const FILE_ACCESS_FLAGS = packed struct(u32) {
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // FILE_LIST_DIRECTORY (1) conflicts with FILE_READ_DATA
    // FILE_ADD_FILE (2) conflicts with FILE_WRITE_DATA
    // FILE_ADD_SUBDIRECTORY (4) conflicts with FILE_APPEND_DATA
    // FILE_CREATE_PIPE_INSTANCE (4) conflicts with FILE_APPEND_DATA
    // FILE_TRAVERSE (32) conflicts with FILE_EXECUTE
    // STANDARD_RIGHTS_READ (131072) conflicts with READ_CONTROL
    // STANDARD_RIGHTS_WRITE (131072) conflicts with READ_CONTROL
    // STANDARD_RIGHTS_EXECUTE (131072) conflicts with READ_CONTROL
};
