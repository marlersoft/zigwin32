...
pub const VIRTUAL_KEY = enum(u16) {
    ...
    pub const OEM_ATTN = .DBE_ALPHANUMERIC;
    pub const OEM_FINISH = .DBE_KATAKANA;
    pub const OEM_COPY = .DBE_HIRAGANA;
    pub const OEM_AUTO = .DBE_SBCSCHAR;
    pub const OEM_ENLW = .DBE_DBCSCHAR;
    pub const OEM_BACKTAB = .DBE_ROMAN;
    pub const ATTN = .DBE_NOROMAN;
    pub const CRSEL = .DBE_ENTERWORDREGISTERMODE;
    pub const EXSEL = .DBE_ENTERIMECONFIGMODE;
    pub const EREOF = .DBE_FLUSHSTRING;
    pub const PLAY = .DBE_CODEINPUT;
    pub const ZOOM = .DBE_NOCODEINPUT;
    pub const NONAME = .DBE_DETERMINESTRING;
    pub const PA1 = .DBE_ENTERDLGCONVERSIONMODE;
};
...
pub const VK_ABNT_C1 = VIRTUAL_KEY.ABNT_C1;
pub const VK_ABNT_C2 = VIRTUAL_KEY.ABNT_C2;
pub const VK_DBE_ALPHANUMERIC = VIRTUAL_KEY.DBE_ALPHANUMERIC;
pub const VK_DBE_CODEINPUT = VIRTUAL_KEY.DBE_CODEINPUT;
pub const VK_DBE_DBCSCHAR = VIRTUAL_KEY.DBE_DBCSCHAR;
pub const VK_DBE_DETERMINESTRING = VIRTUAL_KEY.DBE_DETERMINESTRING;
pub const VK_DBE_ENTERDLGCONVERSIONMODE = VIRTUAL_KEY.DBE_ENTERDLGCONVERSIONMODE;
pub const VK_DBE_ENTERIMECONFIGMODE = VIRTUAL_KEY.DBE_ENTERIMECONFIGMODE;
pub const VK_DBE_ENTERWORDREGISTERMODE = VIRTUAL_KEY.DBE_ENTERWORDREGISTERMODE;
pub const VK_DBE_FLUSHSTRING = VIRTUAL_KEY.DBE_FLUSHSTRING;
pub const VK_DBE_HIRAGANA = VIRTUAL_KEY.DBE_HIRAGANA;
pub const VK_DBE_KATAKANA = VIRTUAL_KEY.DBE_KATAKANA;
pub const VK_DBE_NOCODEINPUT = VIRTUAL_KEY.DBE_NOCODEINPUT;
pub const VK_DBE_NOROMAN = VIRTUAL_KEY.DBE_NOROMAN;
pub const VK_DBE_ROMAN = VIRTUAL_KEY.DBE_ROMAN;
pub const VK_DBE_SBCSCHAR = VIRTUAL_KEY.DBE_SBCSCHAR;
pub const VK__none_ = VIRTUAL_KEY._none_;
...
pub const VK_OEM_ATTN = VIRTUAL_KEY.DBE_ALPHANUMERIC;
pub const VK_OEM_FINISH = VIRTUAL_KEY.DBE_KATAKANA;
pub const VK_OEM_COPY = VIRTUAL_KEY.DBE_HIRAGANA;
pub const VK_OEM_AUTO = VIRTUAL_KEY.DBE_SBCSCHAR;
pub const VK_OEM_ENLW = VIRTUAL_KEY.DBE_DBCSCHAR;
pub const VK_OEM_BACKTAB = VIRTUAL_KEY.DBE_ROMAN;
pub const VK_ATTN = VIRTUAL_KEY.DBE_NOROMAN;
pub const VK_CRSEL = VIRTUAL_KEY.DBE_ENTERWORDREGISTERMODE;
pub const VK_EXSEL = VIRTUAL_KEY.DBE_ENTERIMECONFIGMODE;
pub const VK_EREOF = VIRTUAL_KEY.DBE_FLUSHSTRING;
pub const VK_PLAY = VIRTUAL_KEY.DBE_CODEINPUT;
pub const VK_ZOOM = VIRTUAL_KEY.DBE_NOCODEINPUT;
pub const VK_NONAME = VIRTUAL_KEY.DBE_DETERMINESTRING;
pub const VK_PA1 = VIRTUAL_KEY.DBE_ENTERDLGCONVERSIONMODE;
