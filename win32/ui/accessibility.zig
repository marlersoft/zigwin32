...
pub const IRawElementProviderSimple = extern union {
    ...
    pub fn GetPatternProvider(self: *const IRawElementProviderSimple, patternId: UIA_PATTERN_ID, pRetVal: ?*?*IUnknown) callconv(.@"inline") HRESULT {
        return self.vtable.GetPatternProvider(self, patternId, pRetVal);
    }
    pub fn GetPropertyValue(self: *const IRawElementProviderSimple, propertyId: UIA_PROPERTY_ID, pRetVal: ?*VARIANT) callconv(.@"inline") HRESULT {
...
pub const UIA_ANNOTATIONTYPE = enum(u32) {
    Unknown = 60000,
    SpellingError = 60001,
    GrammarError = 60002,
    Comment = 60003,
...
pub const AnnotationType_Unknown = UIA_ANNOTATIONTYPE.Unknown;
pub const AnnotationType_SpellingError = UIA_ANNOTATIONTYPE.SpellingError;
pub const AnnotationType_GrammarError = UIA_ANNOTATIONTYPE.GrammarError;
pub const AnnotationType_Comment = UIA_ANNOTATIONTYPE.Comment;
pub const AnnotationType_FormulaError = UIA_ANNOTATIONTYPE.FormulaError;
pub const AnnotationType_TrackChanges = UIA_ANNOTATIONTYPE.TrackChanges;
pub const AnnotationType_Header = UIA_ANNOTATIONTYPE.Header;
pub const AnnotationType_Footer = UIA_ANNOTATIONTYPE.Footer;
pub const AnnotationType_Highlighted = UIA_ANNOTATIONTYPE.Highlighted;
pub const AnnotationType_Endnote = UIA_ANNOTATIONTYPE.Endnote;
pub const AnnotationType_Footnote = UIA_ANNOTATIONTYPE.Footnote;
pub const AnnotationType_InsertionChange = UIA_ANNOTATIONTYPE.InsertionChange;
pub const AnnotationType_DeletionChange = UIA_ANNOTATIONTYPE.DeletionChange;
pub const AnnotationType_MoveChange = UIA_ANNOTATIONTYPE.MoveChange;
pub const AnnotationType_FormatChange = UIA_ANNOTATIONTYPE.FormatChange;
pub const AnnotationType_UnsyncedChange = UIA_ANNOTATIONTYPE.UnsyncedChange;
pub const AnnotationType_EditingLockedChange = UIA_ANNOTATIONTYPE.EditingLockedChange;
pub const AnnotationType_ExternalChange = UIA_ANNOTATIONTYPE.ExternalChange;
pub const AnnotationType_ConflictingChange = UIA_ANNOTATIONTYPE.ConflictingChange;
pub const AnnotationType_Author = UIA_ANNOTATIONTYPE.Author;
pub const AnnotationType_AdvancedProofingIssue = UIA_ANNOTATIONTYPE.AdvancedProofingIssue;
pub const AnnotationType_DataValidationError = UIA_ANNOTATIONTYPE.DataValidationError;
pub const AnnotationType_CircularReferenceError = UIA_ANNOTATIONTYPE.CircularReferenceError;
pub const AnnotationType_Mathematics = UIA_ANNOTATIONTYPE.Mathematics;
pub const AnnotationType_Sensitive = UIA_ANNOTATIONTYPE.Sensitive;

pub const UIA_CHANGE_ID = enum(u32) {
    d = 90000,
};
pub const UIA_SummaryChangeId = UIA_CHANGE_ID.d;

pub const UIA_CONTROLTYPE_ID = enum(u32) {
...
pub const UIA_ButtonControlTypeId = UIA_CONTROLTYPE_ID.ButtonControlTypeId;
pub const UIA_CalendarControlTypeId = UIA_CONTROLTYPE_ID.CalendarControlTypeId;
pub const UIA_CheckBoxControlTypeId = UIA_CONTROLTYPE_ID.CheckBoxControlTypeId;
pub const UIA_ComboBoxControlTypeId = UIA_CONTROLTYPE_ID.ComboBoxControlTypeId;
pub const UIA_EditControlTypeId = UIA_CONTROLTYPE_ID.EditControlTypeId;
pub const UIA_HyperlinkControlTypeId = UIA_CONTROLTYPE_ID.HyperlinkControlTypeId;
pub const UIA_ImageControlTypeId = UIA_CONTROLTYPE_ID.ImageControlTypeId;
pub const UIA_ListItemControlTypeId = UIA_CONTROLTYPE_ID.ListItemControlTypeId;
pub const UIA_ListControlTypeId = UIA_CONTROLTYPE_ID.ListControlTypeId;
pub const UIA_MenuControlTypeId = UIA_CONTROLTYPE_ID.MenuControlTypeId;
pub const UIA_MenuBarControlTypeId = UIA_CONTROLTYPE_ID.MenuBarControlTypeId;
pub const UIA_MenuItemControlTypeId = UIA_CONTROLTYPE_ID.MenuItemControlTypeId;
pub const UIA_ProgressBarControlTypeId = UIA_CONTROLTYPE_ID.ProgressBarControlTypeId;
pub const UIA_RadioButtonControlTypeId = UIA_CONTROLTYPE_ID.RadioButtonControlTypeId;
pub const UIA_ScrollBarControlTypeId = UIA_CONTROLTYPE_ID.ScrollBarControlTypeId;
pub const UIA_SliderControlTypeId = UIA_CONTROLTYPE_ID.SliderControlTypeId;
pub const UIA_SpinnerControlTypeId = UIA_CONTROLTYPE_ID.SpinnerControlTypeId;
pub const UIA_StatusBarControlTypeId = UIA_CONTROLTYPE_ID.StatusBarControlTypeId;
pub const UIA_TabControlTypeId = UIA_CONTROLTYPE_ID.TabControlTypeId;
pub const UIA_TabItemControlTypeId = UIA_CONTROLTYPE_ID.TabItemControlTypeId;
pub const UIA_TextControlTypeId = UIA_CONTROLTYPE_ID.TextControlTypeId;
pub const UIA_ToolBarControlTypeId = UIA_CONTROLTYPE_ID.ToolBarControlTypeId;
pub const UIA_ToolTipControlTypeId = UIA_CONTROLTYPE_ID.ToolTipControlTypeId;
pub const UIA_TreeControlTypeId = UIA_CONTROLTYPE_ID.TreeControlTypeId;
pub const UIA_TreeItemControlTypeId = UIA_CONTROLTYPE_ID.TreeItemControlTypeId;
pub const UIA_CustomControlTypeId = UIA_CONTROLTYPE_ID.CustomControlTypeId;
pub const UIA_GroupControlTypeId = UIA_CONTROLTYPE_ID.GroupControlTypeId;
pub const UIA_ThumbControlTypeId = UIA_CONTROLTYPE_ID.ThumbControlTypeId;
pub const UIA_DataGridControlTypeId = UIA_CONTROLTYPE_ID.DataGridControlTypeId;
pub const UIA_DataItemControlTypeId = UIA_CONTROLTYPE_ID.DataItemControlTypeId;
pub const UIA_DocumentControlTypeId = UIA_CONTROLTYPE_ID.DocumentControlTypeId;
pub const UIA_SplitButtonControlTypeId = UIA_CONTROLTYPE_ID.SplitButtonControlTypeId;
pub const UIA_WindowControlTypeId = UIA_CONTROLTYPE_ID.WindowControlTypeId;
pub const UIA_PaneControlTypeId = UIA_CONTROLTYPE_ID.PaneControlTypeId;
pub const UIA_HeaderControlTypeId = UIA_CONTROLTYPE_ID.HeaderControlTypeId;
pub const UIA_HeaderItemControlTypeId = UIA_CONTROLTYPE_ID.HeaderItemControlTypeId;
pub const UIA_TableControlTypeId = UIA_CONTROLTYPE_ID.TableControlTypeId;
pub const UIA_TitleBarControlTypeId = UIA_CONTROLTYPE_ID.TitleBarControlTypeId;
pub const UIA_SeparatorControlTypeId = UIA_CONTROLTYPE_ID.SeparatorControlTypeId;
pub const UIA_SemanticZoomControlTypeId = UIA_CONTROLTYPE_ID.SemanticZoomControlTypeId;
pub const UIA_AppBarControlTypeId = UIA_CONTROLTYPE_ID.AppBarControlTypeId;

pub const UIA_EVENT_ID = enum(u32) {
...
pub const UIA_ToolTipOpenedEventId = UIA_EVENT_ID.ToolTipOpenedEventId;
pub const UIA_ToolTipClosedEventId = UIA_EVENT_ID.ToolTipClosedEventId;
pub const UIA_StructureChangedEventId = UIA_EVENT_ID.StructureChangedEventId;
pub const UIA_MenuOpenedEventId = UIA_EVENT_ID.MenuOpenedEventId;
pub const UIA_AutomationPropertyChangedEventId = UIA_EVENT_ID.AutomationPropertyChangedEventId;
pub const UIA_AutomationFocusChangedEventId = UIA_EVENT_ID.AutomationFocusChangedEventId;
pub const UIA_AsyncContentLoadedEventId = UIA_EVENT_ID.AsyncContentLoadedEventId;
pub const UIA_MenuClosedEventId = UIA_EVENT_ID.MenuClosedEventId;
pub const UIA_LayoutInvalidatedEventId = UIA_EVENT_ID.LayoutInvalidatedEventId;
pub const UIA_Invoke_InvokedEventId = UIA_EVENT_ID.Invoke_InvokedEventId;
pub const UIA_SelectionItem_ElementAddedToSelectionEventId = UIA_EVENT_ID.SelectionItem_ElementAddedToSelectionEventId;
pub const UIA_SelectionItem_ElementRemovedFromSelectionEventId = UIA_EVENT_ID.SelectionItem_ElementRemovedFromSelectionEventId;
pub const UIA_SelectionItem_ElementSelectedEventId = UIA_EVENT_ID.SelectionItem_ElementSelectedEventId;
pub const UIA_Selection_InvalidatedEventId = UIA_EVENT_ID.Selection_InvalidatedEventId;
pub const UIA_Text_TextSelectionChangedEventId = UIA_EVENT_ID.Text_TextSelectionChangedEventId;
pub const UIA_Text_TextChangedEventId = UIA_EVENT_ID.Text_TextChangedEventId;
pub const UIA_Window_WindowOpenedEventId = UIA_EVENT_ID.Window_WindowOpenedEventId;
pub const UIA_Window_WindowClosedEventId = UIA_EVENT_ID.Window_WindowClosedEventId;
pub const UIA_MenuModeStartEventId = UIA_EVENT_ID.MenuModeStartEventId;
pub const UIA_MenuModeEndEventId = UIA_EVENT_ID.MenuModeEndEventId;
pub const UIA_InputReachedTargetEventId = UIA_EVENT_ID.InputReachedTargetEventId;
pub const UIA_InputReachedOtherElementEventId = UIA_EVENT_ID.InputReachedOtherElementEventId;
pub const UIA_InputDiscardedEventId = UIA_EVENT_ID.InputDiscardedEventId;
pub const UIA_SystemAlertEventId = UIA_EVENT_ID.SystemAlertEventId;
pub const UIA_LiveRegionChangedEventId = UIA_EVENT_ID.LiveRegionChangedEventId;
pub const UIA_HostedFragmentRootsInvalidatedEventId = UIA_EVENT_ID.HostedFragmentRootsInvalidatedEventId;
pub const UIA_Drag_DragStartEventId = UIA_EVENT_ID.Drag_DragStartEventId;
pub const UIA_Drag_DragCancelEventId = UIA_EVENT_ID.Drag_DragCancelEventId;
pub const UIA_Drag_DragCompleteEventId = UIA_EVENT_ID.Drag_DragCompleteEventId;
pub const UIA_DropTarget_DragEnterEventId = UIA_EVENT_ID.DropTarget_DragEnterEventId;
pub const UIA_DropTarget_DragLeaveEventId = UIA_EVENT_ID.DropTarget_DragLeaveEventId;
pub const UIA_DropTarget_DroppedEventId = UIA_EVENT_ID.DropTarget_DroppedEventId;
pub const UIA_TextEdit_TextChangedEventId = UIA_EVENT_ID.TextEdit_TextChangedEventId;
pub const UIA_TextEdit_ConversionTargetChangedEventId = UIA_EVENT_ID.TextEdit_ConversionTargetChangedEventId;
pub const UIA_ChangesEventId = UIA_EVENT_ID.ChangesEventId;
pub const UIA_NotificationEventId = UIA_EVENT_ID.NotificationEventId;
pub const UIA_ActiveTextPositionChangedEventId = UIA_EVENT_ID.ActiveTextPositionChangedEventId;

pub const UIA_HEADINGLEVEL_ID = enum(u32) {
    _None = 80050,
    @"1" = 80051,
    @"2" = 80052,
    @"3" = 80053,
...
pub const HeadingLevel_None = UIA_HEADINGLEVEL_ID._None;
pub const HeadingLevel1 = UIA_HEADINGLEVEL_ID.@"1";
pub const HeadingLevel2 = UIA_HEADINGLEVEL_ID.@"2";
pub const HeadingLevel3 = UIA_HEADINGLEVEL_ID.@"3";
pub const HeadingLevel4 = UIA_HEADINGLEVEL_ID.@"4";
pub const HeadingLevel5 = UIA_HEADINGLEVEL_ID.@"5";
pub const HeadingLevel6 = UIA_HEADINGLEVEL_ID.@"6";
pub const HeadingLevel7 = UIA_HEADINGLEVEL_ID.@"7";
pub const HeadingLevel8 = UIA_HEADINGLEVEL_ID.@"8";
pub const HeadingLevel9 = UIA_HEADINGLEVEL_ID.@"9";

pub const UIA_LANDMARKTYPE_ID = enum(u32) {
    CustomLandmarkTypeId = 80000,
    FormLandmarkTypeId = 80001,
    MainLandmarkTypeId = 80002,
    NavigationLandmarkTypeId = 80003,
    SearchLandmarkTypeId = 80004,
};
pub const UIA_CustomLandmarkTypeId = UIA_LANDMARKTYPE_ID.CustomLandmarkTypeId;
pub const UIA_FormLandmarkTypeId = UIA_LANDMARKTYPE_ID.FormLandmarkTypeId;
pub const UIA_MainLandmarkTypeId = UIA_LANDMARKTYPE_ID.MainLandmarkTypeId;
pub const UIA_NavigationLandmarkTypeId = UIA_LANDMARKTYPE_ID.NavigationLandmarkTypeId;
pub const UIA_SearchLandmarkTypeId = UIA_LANDMARKTYPE_ID.SearchLandmarkTypeId;

pub const UIA_METADATA_ID = enum(u32) {
    d = 100000,
};
pub const UIA_SayAsInterpretAsMetadataId = UIA_METADATA_ID.d;

pub const UIA_PATTERN_ID = enum(u32) {
...
pub const UIA_InvokePatternId = UIA_PATTERN_ID.InvokePatternId;
pub const UIA_SelectionPatternId = UIA_PATTERN_ID.SelectionPatternId;
pub const UIA_ValuePatternId = UIA_PATTERN_ID.ValuePatternId;
pub const UIA_RangeValuePatternId = UIA_PATTERN_ID.RangeValuePatternId;
pub const UIA_ScrollPatternId = UIA_PATTERN_ID.ScrollPatternId;
pub const UIA_ExpandCollapsePatternId = UIA_PATTERN_ID.ExpandCollapsePatternId;
pub const UIA_GridPatternId = UIA_PATTERN_ID.GridPatternId;
pub const UIA_GridItemPatternId = UIA_PATTERN_ID.GridItemPatternId;
pub const UIA_MultipleViewPatternId = UIA_PATTERN_ID.MultipleViewPatternId;
pub const UIA_WindowPatternId = UIA_PATTERN_ID.WindowPatternId;
pub const UIA_SelectionItemPatternId = UIA_PATTERN_ID.SelectionItemPatternId;
pub const UIA_DockPatternId = UIA_PATTERN_ID.DockPatternId;
pub const UIA_TablePatternId = UIA_PATTERN_ID.TablePatternId;
pub const UIA_TableItemPatternId = UIA_PATTERN_ID.TableItemPatternId;
pub const UIA_TextPatternId = UIA_PATTERN_ID.TextPatternId;
pub const UIA_TogglePatternId = UIA_PATTERN_ID.TogglePatternId;
pub const UIA_TransformPatternId = UIA_PATTERN_ID.TransformPatternId;
pub const UIA_ScrollItemPatternId = UIA_PATTERN_ID.ScrollItemPatternId;
pub const UIA_LegacyIAccessiblePatternId = UIA_PATTERN_ID.LegacyIAccessiblePatternId;
pub const UIA_ItemContainerPatternId = UIA_PATTERN_ID.ItemContainerPatternId;
pub const UIA_VirtualizedItemPatternId = UIA_PATTERN_ID.VirtualizedItemPatternId;
pub const UIA_SynchronizedInputPatternId = UIA_PATTERN_ID.SynchronizedInputPatternId;
pub const UIA_ObjectModelPatternId = UIA_PATTERN_ID.ObjectModelPatternId;
pub const UIA_AnnotationPatternId = UIA_PATTERN_ID.AnnotationPatternId;
pub const UIA_TextPattern2Id = UIA_PATTERN_ID.TextPattern2Id;
pub const UIA_StylesPatternId = UIA_PATTERN_ID.StylesPatternId;
pub const UIA_SpreadsheetPatternId = UIA_PATTERN_ID.SpreadsheetPatternId;
pub const UIA_SpreadsheetItemPatternId = UIA_PATTERN_ID.SpreadsheetItemPatternId;
pub const UIA_TransformPattern2Id = UIA_PATTERN_ID.TransformPattern2Id;
pub const UIA_TextChildPatternId = UIA_PATTERN_ID.TextChildPatternId;
pub const UIA_DragPatternId = UIA_PATTERN_ID.DragPatternId;
pub const UIA_DropTargetPatternId = UIA_PATTERN_ID.DropTargetPatternId;
pub const UIA_TextEditPatternId = UIA_PATTERN_ID.TextEditPatternId;
pub const UIA_CustomNavigationPatternId = UIA_PATTERN_ID.CustomNavigationPatternId;
pub const UIA_SelectionPattern2Id = UIA_PATTERN_ID.SelectionPattern2Id;

pub const UIA_PROPERTY_ID = enum(u32) {
...
pub const UIA_RuntimeIdPropertyId = UIA_PROPERTY_ID.RuntimeIdPropertyId;
pub const UIA_BoundingRectanglePropertyId = UIA_PROPERTY_ID.BoundingRectanglePropertyId;
pub const UIA_ProcessIdPropertyId = UIA_PROPERTY_ID.ProcessIdPropertyId;
pub const UIA_ControlTypePropertyId = UIA_PROPERTY_ID.ControlTypePropertyId;
pub const UIA_LocalizedControlTypePropertyId = UIA_PROPERTY_ID.LocalizedControlTypePropertyId;
pub const UIA_NamePropertyId = UIA_PROPERTY_ID.NamePropertyId;
pub const UIA_AcceleratorKeyPropertyId = UIA_PROPERTY_ID.AcceleratorKeyPropertyId;
pub const UIA_AccessKeyPropertyId = UIA_PROPERTY_ID.AccessKeyPropertyId;
pub const UIA_HasKeyboardFocusPropertyId = UIA_PROPERTY_ID.HasKeyboardFocusPropertyId;
pub const UIA_IsKeyboardFocusablePropertyId = UIA_PROPERTY_ID.IsKeyboardFocusablePropertyId;
pub const UIA_IsEnabledPropertyId = UIA_PROPERTY_ID.IsEnabledPropertyId;
pub const UIA_AutomationIdPropertyId = UIA_PROPERTY_ID.AutomationIdPropertyId;
pub const UIA_ClassNamePropertyId = UIA_PROPERTY_ID.ClassNamePropertyId;
pub const UIA_HelpTextPropertyId = UIA_PROPERTY_ID.HelpTextPropertyId;
pub const UIA_ClickablePointPropertyId = UIA_PROPERTY_ID.ClickablePointPropertyId;
pub const UIA_CulturePropertyId = UIA_PROPERTY_ID.CulturePropertyId;
pub const UIA_IsControlElementPropertyId = UIA_PROPERTY_ID.IsControlElementPropertyId;
pub const UIA_IsContentElementPropertyId = UIA_PROPERTY_ID.IsContentElementPropertyId;
pub const UIA_LabeledByPropertyId = UIA_PROPERTY_ID.LabeledByPropertyId;
pub const UIA_IsPasswordPropertyId = UIA_PROPERTY_ID.IsPasswordPropertyId;
pub const UIA_NativeWindowHandlePropertyId = UIA_PROPERTY_ID.NativeWindowHandlePropertyId;
pub const UIA_ItemTypePropertyId = UIA_PROPERTY_ID.ItemTypePropertyId;
pub const UIA_IsOffscreenPropertyId = UIA_PROPERTY_ID.IsOffscreenPropertyId;
pub const UIA_OrientationPropertyId = UIA_PROPERTY_ID.OrientationPropertyId;
pub const UIA_FrameworkIdPropertyId = UIA_PROPERTY_ID.FrameworkIdPropertyId;
pub const UIA_IsRequiredForFormPropertyId = UIA_PROPERTY_ID.IsRequiredForFormPropertyId;
pub const UIA_ItemStatusPropertyId = UIA_PROPERTY_ID.ItemStatusPropertyId;
pub const UIA_IsDockPatternAvailablePropertyId = UIA_PROPERTY_ID.IsDockPatternAvailablePropertyId;
pub const UIA_IsExpandCollapsePatternAvailablePropertyId = UIA_PROPERTY_ID.IsExpandCollapsePatternAvailablePropertyId;
pub const UIA_IsGridItemPatternAvailablePropertyId = UIA_PROPERTY_ID.IsGridItemPatternAvailablePropertyId;
pub const UIA_IsGridPatternAvailablePropertyId = UIA_PROPERTY_ID.IsGridPatternAvailablePropertyId;
pub const UIA_IsInvokePatternAvailablePropertyId = UIA_PROPERTY_ID.IsInvokePatternAvailablePropertyId;
pub const UIA_IsMultipleViewPatternAvailablePropertyId = UIA_PROPERTY_ID.IsMultipleViewPatternAvailablePropertyId;
pub const UIA_IsRangeValuePatternAvailablePropertyId = UIA_PROPERTY_ID.IsRangeValuePatternAvailablePropertyId;
pub const UIA_IsScrollPatternAvailablePropertyId = UIA_PROPERTY_ID.IsScrollPatternAvailablePropertyId;
pub const UIA_IsScrollItemPatternAvailablePropertyId = UIA_PROPERTY_ID.IsScrollItemPatternAvailablePropertyId;
pub const UIA_IsSelectionItemPatternAvailablePropertyId = UIA_PROPERTY_ID.IsSelectionItemPatternAvailablePropertyId;
pub const UIA_IsSelectionPatternAvailablePropertyId = UIA_PROPERTY_ID.IsSelectionPatternAvailablePropertyId;
pub const UIA_IsTablePatternAvailablePropertyId = UIA_PROPERTY_ID.IsTablePatternAvailablePropertyId;
pub const UIA_IsTableItemPatternAvailablePropertyId = UIA_PROPERTY_ID.IsTableItemPatternAvailablePropertyId;
pub const UIA_IsTextPatternAvailablePropertyId = UIA_PROPERTY_ID.IsTextPatternAvailablePropertyId;
pub const UIA_IsTogglePatternAvailablePropertyId = UIA_PROPERTY_ID.IsTogglePatternAvailablePropertyId;
pub const UIA_IsTransformPatternAvailablePropertyId = UIA_PROPERTY_ID.IsTransformPatternAvailablePropertyId;
pub const UIA_IsValuePatternAvailablePropertyId = UIA_PROPERTY_ID.IsValuePatternAvailablePropertyId;
pub const UIA_IsWindowPatternAvailablePropertyId = UIA_PROPERTY_ID.IsWindowPatternAvailablePropertyId;
pub const UIA_ValueValuePropertyId = UIA_PROPERTY_ID.ValueValuePropertyId;
pub const UIA_ValueIsReadOnlyPropertyId = UIA_PROPERTY_ID.ValueIsReadOnlyPropertyId;
pub const UIA_RangeValueValuePropertyId = UIA_PROPERTY_ID.RangeValueValuePropertyId;
pub const UIA_RangeValueIsReadOnlyPropertyId = UIA_PROPERTY_ID.RangeValueIsReadOnlyPropertyId;
pub const UIA_RangeValueMinimumPropertyId = UIA_PROPERTY_ID.RangeValueMinimumPropertyId;
pub const UIA_RangeValueMaximumPropertyId = UIA_PROPERTY_ID.RangeValueMaximumPropertyId;
pub const UIA_RangeValueLargeChangePropertyId = UIA_PROPERTY_ID.RangeValueLargeChangePropertyId;
pub const UIA_RangeValueSmallChangePropertyId = UIA_PROPERTY_ID.RangeValueSmallChangePropertyId;
pub const UIA_ScrollHorizontalScrollPercentPropertyId = UIA_PROPERTY_ID.ScrollHorizontalScrollPercentPropertyId;
pub const UIA_ScrollHorizontalViewSizePropertyId = UIA_PROPERTY_ID.ScrollHorizontalViewSizePropertyId;
pub const UIA_ScrollVerticalScrollPercentPropertyId = UIA_PROPERTY_ID.ScrollVerticalScrollPercentPropertyId;
pub const UIA_ScrollVerticalViewSizePropertyId = UIA_PROPERTY_ID.ScrollVerticalViewSizePropertyId;
pub const UIA_ScrollHorizontallyScrollablePropertyId = UIA_PROPERTY_ID.ScrollHorizontallyScrollablePropertyId;
pub const UIA_ScrollVerticallyScrollablePropertyId = UIA_PROPERTY_ID.ScrollVerticallyScrollablePropertyId;
pub const UIA_SelectionSelectionPropertyId = UIA_PROPERTY_ID.SelectionSelectionPropertyId;
pub const UIA_SelectionCanSelectMultiplePropertyId = UIA_PROPERTY_ID.SelectionCanSelectMultiplePropertyId;
pub const UIA_SelectionIsSelectionRequiredPropertyId = UIA_PROPERTY_ID.SelectionIsSelectionRequiredPropertyId;
pub const UIA_GridRowCountPropertyId = UIA_PROPERTY_ID.GridRowCountPropertyId;
pub const UIA_GridColumnCountPropertyId = UIA_PROPERTY_ID.GridColumnCountPropertyId;
pub const UIA_GridItemRowPropertyId = UIA_PROPERTY_ID.GridItemRowPropertyId;
pub const UIA_GridItemColumnPropertyId = UIA_PROPERTY_ID.GridItemColumnPropertyId;
pub const UIA_GridItemRowSpanPropertyId = UIA_PROPERTY_ID.GridItemRowSpanPropertyId;
pub const UIA_GridItemColumnSpanPropertyId = UIA_PROPERTY_ID.GridItemColumnSpanPropertyId;
pub const UIA_GridItemContainingGridPropertyId = UIA_PROPERTY_ID.GridItemContainingGridPropertyId;
pub const UIA_DockDockPositionPropertyId = UIA_PROPERTY_ID.DockDockPositionPropertyId;
pub const UIA_ExpandCollapseExpandCollapseStatePropertyId = UIA_PROPERTY_ID.ExpandCollapseExpandCollapseStatePropertyId;
pub const UIA_MultipleViewCurrentViewPropertyId = UIA_PROPERTY_ID.MultipleViewCurrentViewPropertyId;
pub const UIA_MultipleViewSupportedViewsPropertyId = UIA_PROPERTY_ID.MultipleViewSupportedViewsPropertyId;
pub const UIA_WindowCanMaximizePropertyId = UIA_PROPERTY_ID.WindowCanMaximizePropertyId;
pub const UIA_WindowCanMinimizePropertyId = UIA_PROPERTY_ID.WindowCanMinimizePropertyId;
pub const UIA_WindowWindowVisualStatePropertyId = UIA_PROPERTY_ID.WindowWindowVisualStatePropertyId;
pub const UIA_WindowWindowInteractionStatePropertyId = UIA_PROPERTY_ID.WindowWindowInteractionStatePropertyId;
pub const UIA_WindowIsModalPropertyId = UIA_PROPERTY_ID.WindowIsModalPropertyId;
pub const UIA_WindowIsTopmostPropertyId = UIA_PROPERTY_ID.WindowIsTopmostPropertyId;
pub const UIA_SelectionItemIsSelectedPropertyId = UIA_PROPERTY_ID.SelectionItemIsSelectedPropertyId;
pub const UIA_SelectionItemSelectionContainerPropertyId = UIA_PROPERTY_ID.SelectionItemSelectionContainerPropertyId;
pub const UIA_TableRowHeadersPropertyId = UIA_PROPERTY_ID.TableRowHeadersPropertyId;
pub const UIA_TableColumnHeadersPropertyId = UIA_PROPERTY_ID.TableColumnHeadersPropertyId;
pub const UIA_TableRowOrColumnMajorPropertyId = UIA_PROPERTY_ID.TableRowOrColumnMajorPropertyId;
pub const UIA_TableItemRowHeaderItemsPropertyId = UIA_PROPERTY_ID.TableItemRowHeaderItemsPropertyId;
pub const UIA_TableItemColumnHeaderItemsPropertyId = UIA_PROPERTY_ID.TableItemColumnHeaderItemsPropertyId;
pub const UIA_ToggleToggleStatePropertyId = UIA_PROPERTY_ID.ToggleToggleStatePropertyId;
pub const UIA_TransformCanMovePropertyId = UIA_PROPERTY_ID.TransformCanMovePropertyId;
pub const UIA_TransformCanResizePropertyId = UIA_PROPERTY_ID.TransformCanResizePropertyId;
pub const UIA_TransformCanRotatePropertyId = UIA_PROPERTY_ID.TransformCanRotatePropertyId;
pub const UIA_IsLegacyIAccessiblePatternAvailablePropertyId = UIA_PROPERTY_ID.IsLegacyIAccessiblePatternAvailablePropertyId;
pub const UIA_LegacyIAccessibleChildIdPropertyId = UIA_PROPERTY_ID.LegacyIAccessibleChildIdPropertyId;
pub const UIA_LegacyIAccessibleNamePropertyId = UIA_PROPERTY_ID.LegacyIAccessibleNamePropertyId;
pub const UIA_LegacyIAccessibleValuePropertyId = UIA_PROPERTY_ID.LegacyIAccessibleValuePropertyId;
pub const UIA_LegacyIAccessibleDescriptionPropertyId = UIA_PROPERTY_ID.LegacyIAccessibleDescriptionPropertyId;
pub const UIA_LegacyIAccessibleRolePropertyId = UIA_PROPERTY_ID.LegacyIAccessibleRolePropertyId;
pub const UIA_LegacyIAccessibleStatePropertyId = UIA_PROPERTY_ID.LegacyIAccessibleStatePropertyId;
pub const UIA_LegacyIAccessibleHelpPropertyId = UIA_PROPERTY_ID.LegacyIAccessibleHelpPropertyId;
pub const UIA_LegacyIAccessibleKeyboardShortcutPropertyId = UIA_PROPERTY_ID.LegacyIAccessibleKeyboardShortcutPropertyId;
pub const UIA_LegacyIAccessibleSelectionPropertyId = UIA_PROPERTY_ID.LegacyIAccessibleSelectionPropertyId;
pub const UIA_LegacyIAccessibleDefaultActionPropertyId = UIA_PROPERTY_ID.LegacyIAccessibleDefaultActionPropertyId;
pub const UIA_AriaRolePropertyId = UIA_PROPERTY_ID.AriaRolePropertyId;
pub const UIA_AriaPropertiesPropertyId = UIA_PROPERTY_ID.AriaPropertiesPropertyId;
pub const UIA_IsDataValidForFormPropertyId = UIA_PROPERTY_ID.IsDataValidForFormPropertyId;
pub const UIA_ControllerForPropertyId = UIA_PROPERTY_ID.ControllerForPropertyId;
pub const UIA_DescribedByPropertyId = UIA_PROPERTY_ID.DescribedByPropertyId;
pub const UIA_FlowsToPropertyId = UIA_PROPERTY_ID.FlowsToPropertyId;
pub const UIA_ProviderDescriptionPropertyId = UIA_PROPERTY_ID.ProviderDescriptionPropertyId;
pub const UIA_IsItemContainerPatternAvailablePropertyId = UIA_PROPERTY_ID.IsItemContainerPatternAvailablePropertyId;
pub const UIA_IsVirtualizedItemPatternAvailablePropertyId = UIA_PROPERTY_ID.IsVirtualizedItemPatternAvailablePropertyId;
pub const UIA_IsSynchronizedInputPatternAvailablePropertyId = UIA_PROPERTY_ID.IsSynchronizedInputPatternAvailablePropertyId;
pub const UIA_OptimizeForVisualContentPropertyId = UIA_PROPERTY_ID.OptimizeForVisualContentPropertyId;
pub const UIA_IsObjectModelPatternAvailablePropertyId = UIA_PROPERTY_ID.IsObjectModelPatternAvailablePropertyId;
pub const UIA_AnnotationAnnotationTypeIdPropertyId = UIA_PROPERTY_ID.AnnotationAnnotationTypeIdPropertyId;
pub const UIA_AnnotationAnnotationTypeNamePropertyId = UIA_PROPERTY_ID.AnnotationAnnotationTypeNamePropertyId;
pub const UIA_AnnotationAuthorPropertyId = UIA_PROPERTY_ID.AnnotationAuthorPropertyId;
pub const UIA_AnnotationDateTimePropertyId = UIA_PROPERTY_ID.AnnotationDateTimePropertyId;
pub const UIA_AnnotationTargetPropertyId = UIA_PROPERTY_ID.AnnotationTargetPropertyId;
pub const UIA_IsAnnotationPatternAvailablePropertyId = UIA_PROPERTY_ID.IsAnnotationPatternAvailablePropertyId;
pub const UIA_IsTextPattern2AvailablePropertyId = UIA_PROPERTY_ID.IsTextPattern2AvailablePropertyId;
pub const UIA_StylesStyleIdPropertyId = UIA_PROPERTY_ID.StylesStyleIdPropertyId;
pub const UIA_StylesStyleNamePropertyId = UIA_PROPERTY_ID.StylesStyleNamePropertyId;
pub const UIA_StylesFillColorPropertyId = UIA_PROPERTY_ID.StylesFillColorPropertyId;
pub const UIA_StylesFillPatternStylePropertyId = UIA_PROPERTY_ID.StylesFillPatternStylePropertyId;
pub const UIA_StylesShapePropertyId = UIA_PROPERTY_ID.StylesShapePropertyId;
pub const UIA_StylesFillPatternColorPropertyId = UIA_PROPERTY_ID.StylesFillPatternColorPropertyId;
pub const UIA_StylesExtendedPropertiesPropertyId = UIA_PROPERTY_ID.StylesExtendedPropertiesPropertyId;
pub const UIA_IsStylesPatternAvailablePropertyId = UIA_PROPERTY_ID.IsStylesPatternAvailablePropertyId;
pub const UIA_IsSpreadsheetPatternAvailablePropertyId = UIA_PROPERTY_ID.IsSpreadsheetPatternAvailablePropertyId;
pub const UIA_SpreadsheetItemFormulaPropertyId = UIA_PROPERTY_ID.SpreadsheetItemFormulaPropertyId;
pub const UIA_SpreadsheetItemAnnotationObjectsPropertyId = UIA_PROPERTY_ID.SpreadsheetItemAnnotationObjectsPropertyId;
pub const UIA_SpreadsheetItemAnnotationTypesPropertyId = UIA_PROPERTY_ID.SpreadsheetItemAnnotationTypesPropertyId;
pub const UIA_IsSpreadsheetItemPatternAvailablePropertyId = UIA_PROPERTY_ID.IsSpreadsheetItemPatternAvailablePropertyId;
pub const UIA_Transform2CanZoomPropertyId = UIA_PROPERTY_ID.Transform2CanZoomPropertyId;
pub const UIA_IsTransformPattern2AvailablePropertyId = UIA_PROPERTY_ID.IsTransformPattern2AvailablePropertyId;
pub const UIA_LiveSettingPropertyId = UIA_PROPERTY_ID.LiveSettingPropertyId;
pub const UIA_IsTextChildPatternAvailablePropertyId = UIA_PROPERTY_ID.IsTextChildPatternAvailablePropertyId;
pub const UIA_IsDragPatternAvailablePropertyId = UIA_PROPERTY_ID.IsDragPatternAvailablePropertyId;
pub const UIA_DragIsGrabbedPropertyId = UIA_PROPERTY_ID.DragIsGrabbedPropertyId;
pub const UIA_DragDropEffectPropertyId = UIA_PROPERTY_ID.DragDropEffectPropertyId;
pub const UIA_DragDropEffectsPropertyId = UIA_PROPERTY_ID.DragDropEffectsPropertyId;
pub const UIA_IsDropTargetPatternAvailablePropertyId = UIA_PROPERTY_ID.IsDropTargetPatternAvailablePropertyId;
pub const UIA_DropTargetDropTargetEffectPropertyId = UIA_PROPERTY_ID.DropTargetDropTargetEffectPropertyId;
pub const UIA_DropTargetDropTargetEffectsPropertyId = UIA_PROPERTY_ID.DropTargetDropTargetEffectsPropertyId;
pub const UIA_DragGrabbedItemsPropertyId = UIA_PROPERTY_ID.DragGrabbedItemsPropertyId;
pub const UIA_Transform2ZoomLevelPropertyId = UIA_PROPERTY_ID.Transform2ZoomLevelPropertyId;
pub const UIA_Transform2ZoomMinimumPropertyId = UIA_PROPERTY_ID.Transform2ZoomMinimumPropertyId;
pub const UIA_Transform2ZoomMaximumPropertyId = UIA_PROPERTY_ID.Transform2ZoomMaximumPropertyId;
pub const UIA_FlowsFromPropertyId = UIA_PROPERTY_ID.FlowsFromPropertyId;
pub const UIA_IsTextEditPatternAvailablePropertyId = UIA_PROPERTY_ID.IsTextEditPatternAvailablePropertyId;
pub const UIA_IsPeripheralPropertyId = UIA_PROPERTY_ID.IsPeripheralPropertyId;
pub const UIA_IsCustomNavigationPatternAvailablePropertyId = UIA_PROPERTY_ID.IsCustomNavigationPatternAvailablePropertyId;
pub const UIA_PositionInSetPropertyId = UIA_PROPERTY_ID.PositionInSetPropertyId;
pub const UIA_SizeOfSetPropertyId = UIA_PROPERTY_ID.SizeOfSetPropertyId;
pub const UIA_LevelPropertyId = UIA_PROPERTY_ID.LevelPropertyId;
pub const UIA_AnnotationTypesPropertyId = UIA_PROPERTY_ID.AnnotationTypesPropertyId;
pub const UIA_AnnotationObjectsPropertyId = UIA_PROPERTY_ID.AnnotationObjectsPropertyId;
pub const UIA_LandmarkTypePropertyId = UIA_PROPERTY_ID.LandmarkTypePropertyId;
pub const UIA_LocalizedLandmarkTypePropertyId = UIA_PROPERTY_ID.LocalizedLandmarkTypePropertyId;
pub const UIA_FullDescriptionPropertyId = UIA_PROPERTY_ID.FullDescriptionPropertyId;
pub const UIA_FillColorPropertyId = UIA_PROPERTY_ID.FillColorPropertyId;
pub const UIA_OutlineColorPropertyId = UIA_PROPERTY_ID.OutlineColorPropertyId;
pub const UIA_FillTypePropertyId = UIA_PROPERTY_ID.FillTypePropertyId;
pub const UIA_VisualEffectsPropertyId = UIA_PROPERTY_ID.VisualEffectsPropertyId;
pub const UIA_OutlineThicknessPropertyId = UIA_PROPERTY_ID.OutlineThicknessPropertyId;
pub const UIA_CenterPointPropertyId = UIA_PROPERTY_ID.CenterPointPropertyId;
pub const UIA_RotationPropertyId = UIA_PROPERTY_ID.RotationPropertyId;
pub const UIA_SizePropertyId = UIA_PROPERTY_ID.SizePropertyId;
pub const UIA_IsSelectionPattern2AvailablePropertyId = UIA_PROPERTY_ID.IsSelectionPattern2AvailablePropertyId;
pub const UIA_Selection2FirstSelectedItemPropertyId = UIA_PROPERTY_ID.Selection2FirstSelectedItemPropertyId;
pub const UIA_Selection2LastSelectedItemPropertyId = UIA_PROPERTY_ID.Selection2LastSelectedItemPropertyId;
pub const UIA_Selection2CurrentSelectedItemPropertyId = UIA_PROPERTY_ID.Selection2CurrentSelectedItemPropertyId;
pub const UIA_Selection2ItemCountPropertyId = UIA_PROPERTY_ID.Selection2ItemCountPropertyId;
pub const UIA_HeadingLevelPropertyId = UIA_PROPERTY_ID.HeadingLevelPropertyId;
pub const UIA_IsDialogPropertyId = UIA_PROPERTY_ID.IsDialogPropertyId;

pub const UIA_STYLE_ID = enum(u32) {
    Custom = 70000,
    Heading1 = 70001,
    Heading2 = 70002,
    Heading3 = 70003,
...
pub const StyleId_Custom = UIA_STYLE_ID.Custom;
pub const StyleId_Heading1 = UIA_STYLE_ID.Heading1;
pub const StyleId_Heading2 = UIA_STYLE_ID.Heading2;
pub const StyleId_Heading3 = UIA_STYLE_ID.Heading3;
pub const StyleId_Heading4 = UIA_STYLE_ID.Heading4;
pub const StyleId_Heading5 = UIA_STYLE_ID.Heading5;
pub const StyleId_Heading6 = UIA_STYLE_ID.Heading6;
pub const StyleId_Heading7 = UIA_STYLE_ID.Heading7;
pub const StyleId_Heading8 = UIA_STYLE_ID.Heading8;
pub const StyleId_Heading9 = UIA_STYLE_ID.Heading9;
pub const StyleId_Title = UIA_STYLE_ID.Title;
pub const StyleId_Subtitle = UIA_STYLE_ID.Subtitle;
pub const StyleId_Normal = UIA_STYLE_ID.Normal;
pub const StyleId_Emphasis = UIA_STYLE_ID.Emphasis;
pub const StyleId_Quote = UIA_STYLE_ID.Quote;
pub const StyleId_BulletedList = UIA_STYLE_ID.BulletedList;
pub const StyleId_NumberedList = UIA_STYLE_ID.NumberedList;

pub const UIA_TEXTATTRIBUTE_ID = enum(u32) {
...
pub const UIA_AnimationStyleAttributeId = UIA_TEXTATTRIBUTE_ID.AnimationStyleAttributeId;
pub const UIA_BackgroundColorAttributeId = UIA_TEXTATTRIBUTE_ID.BackgroundColorAttributeId;
pub const UIA_BulletStyleAttributeId = UIA_TEXTATTRIBUTE_ID.BulletStyleAttributeId;
pub const UIA_CapStyleAttributeId = UIA_TEXTATTRIBUTE_ID.CapStyleAttributeId;
pub const UIA_CultureAttributeId = UIA_TEXTATTRIBUTE_ID.CultureAttributeId;
pub const UIA_FontNameAttributeId = UIA_TEXTATTRIBUTE_ID.FontNameAttributeId;
pub const UIA_FontSizeAttributeId = UIA_TEXTATTRIBUTE_ID.FontSizeAttributeId;
pub const UIA_FontWeightAttributeId = UIA_TEXTATTRIBUTE_ID.FontWeightAttributeId;
pub const UIA_ForegroundColorAttributeId = UIA_TEXTATTRIBUTE_ID.ForegroundColorAttributeId;
pub const UIA_HorizontalTextAlignmentAttributeId = UIA_TEXTATTRIBUTE_ID.HorizontalTextAlignmentAttributeId;
pub const UIA_IndentationFirstLineAttributeId = UIA_TEXTATTRIBUTE_ID.IndentationFirstLineAttributeId;
pub const UIA_IndentationLeadingAttributeId = UIA_TEXTATTRIBUTE_ID.IndentationLeadingAttributeId;
pub const UIA_IndentationTrailingAttributeId = UIA_TEXTATTRIBUTE_ID.IndentationTrailingAttributeId;
pub const UIA_IsHiddenAttributeId = UIA_TEXTATTRIBUTE_ID.IsHiddenAttributeId;
pub const UIA_IsItalicAttributeId = UIA_TEXTATTRIBUTE_ID.IsItalicAttributeId;
pub const UIA_IsReadOnlyAttributeId = UIA_TEXTATTRIBUTE_ID.IsReadOnlyAttributeId;
pub const UIA_IsSubscriptAttributeId = UIA_TEXTATTRIBUTE_ID.IsSubscriptAttributeId;
pub const UIA_IsSuperscriptAttributeId = UIA_TEXTATTRIBUTE_ID.IsSuperscriptAttributeId;
pub const UIA_MarginBottomAttributeId = UIA_TEXTATTRIBUTE_ID.MarginBottomAttributeId;
pub const UIA_MarginLeadingAttributeId = UIA_TEXTATTRIBUTE_ID.MarginLeadingAttributeId;
pub const UIA_MarginTopAttributeId = UIA_TEXTATTRIBUTE_ID.MarginTopAttributeId;
pub const UIA_MarginTrailingAttributeId = UIA_TEXTATTRIBUTE_ID.MarginTrailingAttributeId;
pub const UIA_OutlineStylesAttributeId = UIA_TEXTATTRIBUTE_ID.OutlineStylesAttributeId;
pub const UIA_OverlineColorAttributeId = UIA_TEXTATTRIBUTE_ID.OverlineColorAttributeId;
pub const UIA_OverlineStyleAttributeId = UIA_TEXTATTRIBUTE_ID.OverlineStyleAttributeId;
pub const UIA_StrikethroughColorAttributeId = UIA_TEXTATTRIBUTE_ID.StrikethroughColorAttributeId;
pub const UIA_StrikethroughStyleAttributeId = UIA_TEXTATTRIBUTE_ID.StrikethroughStyleAttributeId;
pub const UIA_TabsAttributeId = UIA_TEXTATTRIBUTE_ID.TabsAttributeId;
pub const UIA_TextFlowDirectionsAttributeId = UIA_TEXTATTRIBUTE_ID.TextFlowDirectionsAttributeId;
pub const UIA_UnderlineColorAttributeId = UIA_TEXTATTRIBUTE_ID.UnderlineColorAttributeId;
pub const UIA_UnderlineStyleAttributeId = UIA_TEXTATTRIBUTE_ID.UnderlineStyleAttributeId;
pub const UIA_AnnotationTypesAttributeId = UIA_TEXTATTRIBUTE_ID.AnnotationTypesAttributeId;
pub const UIA_AnnotationObjectsAttributeId = UIA_TEXTATTRIBUTE_ID.AnnotationObjectsAttributeId;
pub const UIA_StyleNameAttributeId = UIA_TEXTATTRIBUTE_ID.StyleNameAttributeId;
pub const UIA_StyleIdAttributeId = UIA_TEXTATTRIBUTE_ID.StyleIdAttributeId;
pub const UIA_LinkAttributeId = UIA_TEXTATTRIBUTE_ID.LinkAttributeId;
pub const UIA_IsActiveAttributeId = UIA_TEXTATTRIBUTE_ID.IsActiveAttributeId;
pub const UIA_SelectionActiveEndAttributeId = UIA_TEXTATTRIBUTE_ID.SelectionActiveEndAttributeId;
pub const UIA_CaretPositionAttributeId = UIA_TEXTATTRIBUTE_ID.CaretPositionAttributeId;
pub const UIA_CaretBidiModeAttributeId = UIA_TEXTATTRIBUTE_ID.CaretBidiModeAttributeId;
pub const UIA_LineSpacingAttributeId = UIA_TEXTATTRIBUTE_ID.LineSpacingAttributeId;
pub const UIA_BeforeParagraphSpacingAttributeId = UIA_TEXTATTRIBUTE_ID.BeforeParagraphSpacingAttributeId;
pub const UIA_AfterParagraphSpacingAttributeId = UIA_TEXTATTRIBUTE_ID.AfterParagraphSpacingAttributeId;
pub const UIA_SayAsInterpretAsAttributeId = UIA_TEXTATTRIBUTE_ID.SayAsInterpretAsAttributeId;
