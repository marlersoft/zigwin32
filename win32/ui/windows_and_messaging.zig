...
pub const ACCEL_VIRT_FLAGS = packed struct(u8) {
    VIRTKEY: u1 = 0,
    NOINVERT: u1 = 0,
    SHIFT: u1 = 0,
    CONTROL: u1 = 0,
...
pub const FVIRTKEY = ACCEL_VIRT_FLAGS{ .VIRTKEY = 1 };
pub const FNOINVERT = ACCEL_VIRT_FLAGS{ .NOINVERT = 1 };
pub const FSHIFT = ACCEL_VIRT_FLAGS{ .SHIFT = 1 };
pub const FCONTROL = ACCEL_VIRT_FLAGS{ .CONTROL = 1 };
pub const FALT = ACCEL_VIRT_FLAGS{ .ALT = 1 };
...
pub const SCROLLBAR_COMMAND = enum(i32) {
    ...
    RIGHT = 7,
    ENDSCROLL = 8,
    pub const LINELEFT = .LINEUP;
    pub const LINERIGHT = .LINEDOWN;
    pub const PAGELEFT = .PAGEUP;
    pub const PAGERIGHT = .PAGEDOWN;
    pub const LEFT = .TOP;
    pub const BOTTOM = .RIGHT;
};
