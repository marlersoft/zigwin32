...
pub const COMMON_DIALOG_NOTIFICATION = enum(i32) {
    FIRST = -601,
    LAST = -699,
    SELCHANGE = -602,
    FOLDERCHANGE = -603,
    ...
    TYPECHANGE = -607,
    INCLUDEITEM = -608,
    pub const INITDONE = .FIRST;
};
pub const CDN_FIRST = COMMON_DIALOG_NOTIFICATION.FIRST;
pub const CDN_LAST = COMMON_DIALOG_NOTIFICATION.LAST;
pub const CDN_INITDONE = COMMON_DIALOG_NOTIFICATION.FIRST;
pub const CDN_SELCHANGE = COMMON_DIALOG_NOTIFICATION.SELCHANGE;
pub const CDN_FOLDERCHANGE = COMMON_DIALOG_NOTIFICATION.FOLDERCHANGE;
pub const CDN_SHAREVIOLATION = COMMON_DIALOG_NOTIFICATION.SHAREVIOLATION;
pub const CDN_HELP = COMMON_DIALOG_NOTIFICATION.HELP;
pub const CDN_FILEOK = COMMON_DIALOG_NOTIFICATION.FILEOK;
pub const CDN_TYPECHANGE = COMMON_DIALOG_NOTIFICATION.TYPECHANGE;
pub const CDN_INCLUDEITEM = COMMON_DIALOG_NOTIFICATION.INCLUDEITEM;
...
pub const OPENFILENAME_NT4A = switch(@import("../../zig.zig").arch) {
    ...
    .X86 => extern struct {
        ...
        lpstrCustomFilter: ?[*:0]u8 align(1),
        nMaxCustFilter: u32 align(1),
        nFilterIndex: u32 align(1),
        lpstrFile: ?[*:0]u8 align(1),
        nMaxFile: u32 align(1),
        lpstrFileTitle: ?[*:0]u8 align(1),
...
pub const OPENFILENAME_NT4W = switch(@import("../../zig.zig").arch) {
    ...
    .X86 => extern struct {
        ...
        lpstrCustomFilter: ?[*:0]u16 align(1),
        nMaxCustFilter: u32 align(1),
        nFilterIndex: u32 align(1),
        lpstrFile: ?[*:0]u16 align(1),
        nMaxFile: u32 align(1),
        lpstrFileTitle: ?[*:0]u16 align(1),
        nMaxFileTitle: u32 align(1),
