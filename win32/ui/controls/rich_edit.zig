...
pub const IRichEditOleCallback = extern union {
    ...
    pub fn GetInPlaceContext(self: *const IRichEditOleCallback, lplpFrame: ?*?*IOleInPlaceFrame, lplpDoc: ?*?*IOleInPlaceUIWindow, lpFrameInfo: ?*OLEINPLACEFRAMEINFO) callconv(.@"inline") HRESULT {
    ...
    pub fn QueryAcceptData(self: *const IRichEditOleCallback, lpdataobj: ?*IDataObject, lpcfFormat: ?*u16, reco: RECO_FLAGS, fReally: BOOL, hMetaPict: isize) callconv(.@"inline") HRESULT {
    ...
    pub fn GetDragDropEffect(self: *const IRichEditOleCallback, fDrag: BOOL, grfKeyState: MODIFIERKEYS_FLAGS, pdwEffect: ?*DROPEFFECT) callconv(.@"inline") HRESULT {
...
pub const ITextDocument = extern union {
    ...
    pub fn Open(self: *const ITextDocument, pVar: ?*VARIANT, Flags: tomConstants, CodePage: i32) callconv(.@"inline") HRESULT {
        return self.vtable.Open(self, pVar, Flags, CodePage);
    }
    pub fn Save(self: *const ITextDocument, pVar: ?*VARIANT, Flags: tomConstants, CodePage: i32) callconv(.@"inline") HRESULT {
...
pub const ITextRange = extern union {
    ...
    pub fn FindText(self: *const ITextRange, bstr: ?BSTR, Count: i32, Flags: tomConstants, pLength: ?*i32) callconv(.@"inline") HRESULT {
        return self.vtable.FindText(self, bstr, Count, Flags, pLength);
    }
    pub fn FindTextStart(self: *const ITextRange, bstr: ?BSTR, Count: i32, Flags: tomConstants, pLength: ?*i32) callconv(.@"inline") HRESULT {
        return self.vtable.FindTextStart(self, bstr, Count, Flags, pLength);
    }
    pub fn FindTextEnd(self: *const ITextRange, bstr: ?BSTR, Count: i32, Flags: tomConstants, pLength: ?*i32) callconv(.@"inline") HRESULT {
    ...
    pub fn ChangeCase(self: *const ITextRange, Type: tomConstants) callconv(.@"inline") HRESULT {
        return self.vtable.ChangeCase(self, Type);
    }
    pub fn GetPoint(self: *const ITextRange, Type: tomConstants, px: ?*i32, py: ?*i32) callconv(.@"inline") HRESULT {
        return self.vtable.GetPoint(self, Type, px, py);
    }
    pub fn SetPoint(self: *const ITextRange, x: i32, y: i32, Type: tomConstants, Extend: i32) callconv(.@"inline") HRESULT {
...
pub const PARAFORMAT_NUMBERING = packed struct(u16) {
    BULLET: u1 = 0,
    ARABIC: u1 = 0,
    UCLETTER: u1 = 0,
    _3: u1 = 0,
...
pub const PFN_BULLET = PARAFORMAT_NUMBERING{ .BULLET = 1 };
pub const PFN_ARABIC = PARAFORMAT_NUMBERING{ .ARABIC = 1 };
pub const PFN_LCLETTER = PARAFORMAT_NUMBERING{
    .BULLET = 1,
    .ARABIC = 1,
};
pub const PFN_UCLETTER = PARAFORMAT_NUMBERING{ .UCLETTER = 1 };
pub const PFN_LCROMAN = PARAFORMAT_NUMBERING{
    .BULLET = 1,
    .UCLETTER = 1,
};
pub const PFN_UCROMAN = PARAFORMAT_NUMBERING{
    .ARABIC = 1,
    .UCLETTER = 1,
};
