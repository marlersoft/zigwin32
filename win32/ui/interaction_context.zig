...
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_TRANSLATION_X = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_TRANSLATION_X = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_TRANSLATION_Y = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_TRANSLATION_Y = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_ROTATION = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_ROTATION = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_SCALING = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_SCALING = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_TRANSLATION_INERTIA = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_TRANSLATION_INERTIA = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_ROTATION_INERTIA = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_ROTATION_INERTIA = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_SCALING_INERTIA = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_SCALING_INERTIA = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_RAILS_X = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_RAILS_X = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_RAILS_Y = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_RAILS_Y = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_EXACT = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_EXACT = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_MULTIPLE_FINGER_PANNING = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_MULTIPLE_FINGER_PANNING = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_HORIZONTAL = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_TRANSLATION_X = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_SELECT = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_TRANSLATION_Y = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_SPEED_BUMP = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_ROTATION = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_REARRANGE = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_SCALING = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_EXACT = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_TRANSLATION_INERTIA = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_TAP = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_TAP_DOUBLE = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_TRANSLATION_X = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_TAP_MULTIPLE_FINGER = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_TRANSLATION_Y = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_SECONDARY_TAP = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_HOLD = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_HOLD_MOUSE = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_TRANSLATION_X = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_HOLD_MULTIPLE_FINGER = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION_TRANSLATION_Y = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_DRAG = INTERACTION_CONFIGURATION_FLAGS{ .MANIPULATION = 1 };
pub const INTERACTION_CONFIGURATION_FLAG_MAX = INTERACTION_CONFIGURATION_FLAGS{
    .MANIPULATION = 1,
    .MANIPULATION_TRANSLATION_X = 1,
    .MANIPULATION_TRANSLATION_Y = 1,
    .MANIPULATION_ROTATION = 1,
    .MANIPULATION_SCALING = 1,
    .MANIPULATION_TRANSLATION_INERTIA = 1,
    .MANIPULATION_ROTATION_INERTIA = 1,
    .MANIPULATION_SCALING_INERTIA = 1,
    .MANIPULATION_RAILS_X = 1,
    .MANIPULATION_RAILS_Y = 1,
    .MANIPULATION_EXACT = 1,
    .MANIPULATION_MULTIPLE_FINGER_PANNING = 1,
    ._12 = 1,
    ._13 = 1,
    ._14 = 1,
    ._15 = 1,
