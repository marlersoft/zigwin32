...
pub const HEADER_HITTEST_INFO_FLAGS = packed struct(u32) {
    NOWHERE: u1 = 0,
    ONHEADER: u1 = 0,
    ONDIVIDER: u1 = 0,
    ONDIVOPEN: u1 = 0,
...
pub const HHT_NOWHERE = HEADER_HITTEST_INFO_FLAGS{ .NOWHERE = 1 };
pub const HHT_ONHEADER = HEADER_HITTEST_INFO_FLAGS{ .ONHEADER = 1 };
pub const HHT_ONDIVIDER = HEADER_HITTEST_INFO_FLAGS{ .ONDIVIDER = 1 };
pub const HHT_ONDIVOPEN = HEADER_HITTEST_INFO_FLAGS{ .ONDIVOPEN = 1 };
pub const HHT_ONFILTER = HEADER_HITTEST_INFO_FLAGS{ .ONFILTER = 1 };
pub const HHT_ONFILTERBUTTON = HEADER_HITTEST_INFO_FLAGS{ .ONFILTERBUTTON = 1 };
pub const HHT_ABOVE = HEADER_HITTEST_INFO_FLAGS{ .ABOVE = 1 };
pub const HHT_BELOW = HEADER_HITTEST_INFO_FLAGS{ .BELOW = 1 };
pub const HHT_TORIGHT = HEADER_HITTEST_INFO_FLAGS{ .TORIGHT = 1 };
pub const HHT_TOLEFT = HEADER_HITTEST_INFO_FLAGS{ .TOLEFT = 1 };
pub const HHT_ONITEMSTATEICON = HEADER_HITTEST_INFO_FLAGS{ .ONITEMSTATEICON = 1 };
pub const HHT_ONDROPDOWN = HEADER_HITTEST_INFO_FLAGS{ .ONDROPDOWN = 1 };
pub const HHT_ONOVERFLOW = HEADER_HITTEST_INFO_FLAGS{ .ONOVERFLOW = 1 };
...
pub const IMAGE_LIST_DRAW_STYLE = packed struct(u32) {
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // FOCUS (bit index 1) conflicts with BLEND25
    // SELECTED (bit index 2) conflicts with BLEND50
    // BLEND (bit index 2) conflicts with BLEND50
};
pub const ILD_NORMAL = IMAGE_LIST_DRAW_STYLE{ };
pub const ILD_TRANSPARENT = IMAGE_LIST_DRAW_STYLE{ .TRANSPARENT = 1 };
pub const ILD_BLEND25 = IMAGE_LIST_DRAW_STYLE{ .BLEND25 = 1 };
pub const ILD_FOCUS = IMAGE_LIST_DRAW_STYLE{ .BLEND25 = 1 };
pub const ILD_BLEND50 = IMAGE_LIST_DRAW_STYLE{ .BLEND50 = 1 };
pub const ILD_SELECTED = IMAGE_LIST_DRAW_STYLE{ .BLEND50 = 1 };
pub const ILD_BLEND = IMAGE_LIST_DRAW_STYLE{ .BLEND50 = 1 };
pub const ILD_MASK = IMAGE_LIST_DRAW_STYLE{ .MASK = 1 };
pub const ILD_IMAGE = IMAGE_LIST_DRAW_STYLE{ .IMAGE = 1 };
pub const ILD_ROP = IMAGE_LIST_DRAW_STYLE{ .ROP = 1 };
pub const ILD_OVERLAYMASK = IMAGE_LIST_DRAW_STYLE{
    ._8 = 1,
    ._9 = 1,
    ._10 = 1,
    ._11 = 1,
};
pub const ILD_PRESERVEALPHA = IMAGE_LIST_DRAW_STYLE{ .PRESERVEALPHA = 1 };
pub const ILD_SCALE = IMAGE_LIST_DRAW_STYLE{ .SCALE = 1 };
pub const ILD_DPISCALE = IMAGE_LIST_DRAW_STYLE{ .DPISCALE = 1 };
pub const ILD_ASYNC = IMAGE_LIST_DRAW_STYLE{ .ASYNC = 1 };
...
pub const IMAGE_LIST_WRITE_STREAM_FLAGS = packed struct(u32) {
    DOWNLEVEL: u1 = 0,
    _1: u1 = 0,
    _2: u1 = 0,
    _3: u1 = 0,
...
pub const ILP_NORMAL = IMAGE_LIST_WRITE_STREAM_FLAGS{ };
pub const ILP_DOWNLEVEL = IMAGE_LIST_WRITE_STREAM_FLAGS{ .DOWNLEVEL = 1 };
...
pub const LIST_ITEM_FLAGS = packed struct(u32) {
    ITEMINDEX: u1 = 0,
    STATE: u1 = 0,
    ITEMID: u1 = 0,
    URL: u1 = 0,
...
pub const LIF_ITEMINDEX = LIST_ITEM_FLAGS{ .ITEMINDEX = 1 };
pub const LIF_STATE = LIST_ITEM_FLAGS{ .STATE = 1 };
pub const LIF_ITEMID = LIST_ITEM_FLAGS{ .ITEMID = 1 };
pub const LIF_URL = LIST_ITEM_FLAGS{ .URL = 1 };

pub const LIST_ITEM_STATE_FLAGS = packed struct(u32) {
    FOCUSED: u1 = 0,
    ENABLED: u1 = 0,
    VISITED: u1 = 0,
    HOTTRACK: u1 = 0,
...
pub const LIS_FOCUSED = LIST_ITEM_STATE_FLAGS{ .FOCUSED = 1 };
pub const LIS_ENABLED = LIST_ITEM_STATE_FLAGS{ .ENABLED = 1 };
pub const LIS_VISITED = LIST_ITEM_STATE_FLAGS{ .VISITED = 1 };
pub const LIS_HOTTRACK = LIST_ITEM_STATE_FLAGS{ .HOTTRACK = 1 };
pub const LIS_DEFAULTCOLORS = LIST_ITEM_STATE_FLAGS{ .DEFAULTCOLORS = 1 };

pub const LIST_VIEW_BACKGROUND_IMAGE_FLAGS = packed struct(u32) {
    SOURCE_HBITMAP: u1 = 0,
    SOURCE_URL: u1 = 0,
    _2: u1 = 0,
    _3: u1 = 0,
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // STYLE_MASK (bit index 4) conflicts with STYLE_TILE
};
pub const LVBKIF_SOURCE_NONE = LIST_VIEW_BACKGROUND_IMAGE_FLAGS{ };
pub const LVBKIF_SOURCE_HBITMAP = LIST_VIEW_BACKGROUND_IMAGE_FLAGS{ .SOURCE_HBITMAP = 1 };
pub const LVBKIF_SOURCE_URL = LIST_VIEW_BACKGROUND_IMAGE_FLAGS{ .SOURCE_URL = 1 };
...
pub const LVBKIF_STYLE_TILE = LIST_VIEW_BACKGROUND_IMAGE_FLAGS{ .STYLE_TILE = 1 };
pub const LVBKIF_STYLE_MASK = LIST_VIEW_BACKGROUND_IMAGE_FLAGS{ .STYLE_TILE = 1 };
pub const LVBKIF_FLAG_TILEOFFSET = LIST_VIEW_BACKGROUND_IMAGE_FLAGS{ .FLAG_TILEOFFSET = 1 };
pub const LVBKIF_TYPE_WATERMARK = LIST_VIEW_BACKGROUND_IMAGE_FLAGS{ .TYPE_WATERMARK = 1 };
pub const LVBKIF_FLAG_ALPHABLEND = LIST_VIEW_BACKGROUND_IMAGE_FLAGS{ .FLAG_ALPHABLEND = 1 };

pub const LIST_VIEW_GROUP_ALIGN_FLAGS = packed struct(u32) {
    HEADER_LEFT: u1 = 0,
    HEADER_CENTER: u1 = 0,
    HEADER_RIGHT: u1 = 0,
    FOOTER_LEFT: u1 = 0,
...
pub const LVGA_HEADER_LEFT = LIST_VIEW_GROUP_ALIGN_FLAGS{ .HEADER_LEFT = 1 };
pub const LVGA_HEADER_CENTER = LIST_VIEW_GROUP_ALIGN_FLAGS{ .HEADER_CENTER = 1 };
pub const LVGA_HEADER_RIGHT = LIST_VIEW_GROUP_ALIGN_FLAGS{ .HEADER_RIGHT = 1 };
pub const LVGA_FOOTER_LEFT = LIST_VIEW_GROUP_ALIGN_FLAGS{ .FOOTER_LEFT = 1 };
pub const LVGA_FOOTER_CENTER = LIST_VIEW_GROUP_ALIGN_FLAGS{ .FOOTER_CENTER = 1 };
pub const LVGA_FOOTER_RIGHT = LIST_VIEW_GROUP_ALIGN_FLAGS{ .FOOTER_RIGHT = 1 };

pub const LIST_VIEW_GROUP_STATE_FLAGS = packed struct(u32) {
    COLLAPSED: u1 = 0,
    HIDDEN: u1 = 0,
    NOHEADER: u1 = 0,
    COLLAPSIBLE: u1 = 0,
...
pub const LVGS_NORMAL = LIST_VIEW_GROUP_STATE_FLAGS{ };
pub const LVGS_COLLAPSED = LIST_VIEW_GROUP_STATE_FLAGS{ .COLLAPSED = 1 };
pub const LVGS_HIDDEN = LIST_VIEW_GROUP_STATE_FLAGS{ .HIDDEN = 1 };
pub const LVGS_NOHEADER = LIST_VIEW_GROUP_STATE_FLAGS{ .NOHEADER = 1 };
pub const LVGS_COLLAPSIBLE = LIST_VIEW_GROUP_STATE_FLAGS{ .COLLAPSIBLE = 1 };
pub const LVGS_FOCUSED = LIST_VIEW_GROUP_STATE_FLAGS{ .FOCUSED = 1 };
pub const LVGS_SELECTED = LIST_VIEW_GROUP_STATE_FLAGS{ .SELECTED = 1 };
pub const LVGS_SUBSETED = LIST_VIEW_GROUP_STATE_FLAGS{ .SUBSETED = 1 };
pub const LVGS_SUBSETLINKFOCUSED = LIST_VIEW_GROUP_STATE_FLAGS{ .SUBSETLINKFOCUSED = 1 };

pub const LIST_VIEW_INSERT_MARK_FLAGS = packed struct(u32) {
    R: u1 = 0,
    _1: u1 = 0,
    _2: u1 = 0,
    _3: u1 = 0,
...
pub const LVIM_AFTER = LIST_VIEW_INSERT_MARK_FLAGS{ .R = 1 };

pub const LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS = packed struct(i32) {
    _0: u1 = 0,
    _1: u1 = 0,
    _2: u1 = 0,
    _3: u1 = 0,
...
pub const LVCFMT_LINE_BREAK = LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS{ .LINE_BREAK = 1 };
pub const LVCFMT_FILL = LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS{ .FILL = 1 };
pub const LVCFMT_WRAP = LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS{ .WRAP = 1 };
pub const LVCFMT_NO_TITLE = LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS{ .NO_TITLE = 1 };
pub const LVCFMT_TILE_PLACEMENTMASK = LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS{
    .LINE_BREAK = 1,
    .FILL = 1,
};

pub const LIST_VIEW_ITEM_FLAGS = packed struct(u32) {
    TEXT: u1 = 0,
    IMAGE: u1 = 0,
    PARAM: u1 = 0,
    STATE: u1 = 0,
...
pub const LVIF_TEXT = LIST_VIEW_ITEM_FLAGS{ .TEXT = 1 };
pub const LVIF_IMAGE = LIST_VIEW_ITEM_FLAGS{ .IMAGE = 1 };
pub const LVIF_PARAM = LIST_VIEW_ITEM_FLAGS{ .PARAM = 1 };
pub const LVIF_STATE = LIST_VIEW_ITEM_FLAGS{ .STATE = 1 };
pub const LVIF_INDENT = LIST_VIEW_ITEM_FLAGS{ .INDENT = 1 };
pub const LVIF_NORECOMPUTE = LIST_VIEW_ITEM_FLAGS{ .NORECOMPUTE = 1 };
pub const LVIF_GROUPID = LIST_VIEW_ITEM_FLAGS{ .GROUPID = 1 };
pub const LVIF_COLUMNS = LIST_VIEW_ITEM_FLAGS{ .COLUMNS = 1 };
pub const LVIF_COLFMT = LIST_VIEW_ITEM_FLAGS{ .COLFMT = 1 };
pub const LVIF_DI_SETITEM = LIST_VIEW_ITEM_FLAGS{ .DI_SETITEM = 1 };
...
pub const LVTILEVIEWINFO_FLAGS = packed struct(u32) {
    FIXEDWIDTH: u1 = 0,
    FIXEDHEIGHT: u1 = 0,
    _2: u1 = 0,
    _3: u1 = 0,
...
pub const LVTVIF_AUTOSIZE = LVTILEVIEWINFO_FLAGS{ };
pub const LVTVIF_FIXEDWIDTH = LVTILEVIEWINFO_FLAGS{ .FIXEDWIDTH = 1 };
pub const LVTVIF_FIXEDHEIGHT = LVTILEVIEWINFO_FLAGS{ .FIXEDHEIGHT = 1 };
pub const LVTVIF_FIXEDSIZE = LVTILEVIEWINFO_FLAGS{
    .FIXEDWIDTH = 1,
    .FIXEDHEIGHT = 1,
};

pub const LVTILEVIEWINFO_MASK = packed struct(u32) {
    TILESIZE: u1 = 0,
    COLUMNS: u1 = 0,
    LABELMARGIN: u1 = 0,
    _3: u1 = 0,
...
pub const LVTVIM_TILESIZE = LVTILEVIEWINFO_MASK{ .TILESIZE = 1 };
pub const LVTVIM_COLUMNS = LVTILEVIEWINFO_MASK{ .COLUMNS = 1 };
pub const LVTVIM_LABELMARGIN = LVTILEVIEWINFO_MASK{ .LABELMARGIN = 1 };
...
pub const MCHITTESTINFO_HIT_FLAGS = packed struct(u32) {
    _0: u1 = 0,
    _1: u1 = 0,
    _2: u1 = 0,
    _3: u1 = 0,
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // TITLEBK (bit index 16) conflicts with TITLE
    // CALENDARBK (bit index 17) conflicts with CALENDAR
};
pub const MCHT_TITLE = MCHITTESTINFO_HIT_FLAGS{ .TITLE = 1 };
pub const MCHT_CALENDAR = MCHITTESTINFO_HIT_FLAGS{ .CALENDAR = 1 };
pub const MCHT_TODAYLINK = MCHITTESTINFO_HIT_FLAGS{
    .TITLE = 1,
    .CALENDAR = 1,
};
pub const MCHT_CALENDARCONTROL = MCHITTESTINFO_HIT_FLAGS{ .CALENDARCONTROL = 1 };
pub const MCHT_NEXT = MCHITTESTINFO_HIT_FLAGS{ .NEXT = 1 };
pub const MCHT_PREV = MCHITTESTINFO_HIT_FLAGS{ .PREV = 1 };
pub const MCHT_NOWHERE = MCHITTESTINFO_HIT_FLAGS{ };
pub const MCHT_TITLEBK = MCHITTESTINFO_HIT_FLAGS{ .TITLE = 1 };
pub const MCHT_TITLEMONTH = MCHITTESTINFO_HIT_FLAGS{
    ._0 = 1,
    .TITLE = 1,
};
pub const MCHT_TITLEYEAR = MCHITTESTINFO_HIT_FLAGS{
    ._1 = 1,
    .TITLE = 1,
};
pub const MCHT_TITLEBTNNEXT = MCHITTESTINFO_HIT_FLAGS{
    ._0 = 1,
    ._1 = 1,
    .TITLE = 1,
    .NEXT = 1,
};
pub const MCHT_TITLEBTNPREV = MCHITTESTINFO_HIT_FLAGS{
    ._0 = 1,
    ._1 = 1,
    .TITLE = 1,
    .PREV = 1,
};
pub const MCHT_CALENDARBK = MCHITTESTINFO_HIT_FLAGS{ .CALENDAR = 1 };
pub const MCHT_CALENDARDATE = MCHITTESTINFO_HIT_FLAGS{
    ._0 = 1,
    .CALENDAR = 1,
};
pub const MCHT_CALENDARDATENEXT = MCHITTESTINFO_HIT_FLAGS{
    ._0 = 1,
    .CALENDAR = 1,
    .NEXT = 1,
};
pub const MCHT_CALENDARDATEPREV = MCHITTESTINFO_HIT_FLAGS{
    ._0 = 1,
    .CALENDAR = 1,
    .PREV = 1,
};
pub const MCHT_CALENDARDAY = MCHITTESTINFO_HIT_FLAGS{
    ._1 = 1,
    .CALENDAR = 1,
};
pub const MCHT_CALENDARWEEKNUM = MCHITTESTINFO_HIT_FLAGS{
    ._0 = 1,
    ._1 = 1,
    .CALENDAR = 1,
};
pub const MCHT_CALENDARDATEMIN = MCHITTESTINFO_HIT_FLAGS{
    ._2 = 1,
    .CALENDAR = 1,
};
pub const MCHT_CALENDARDATEMAX = MCHITTESTINFO_HIT_FLAGS{
    ._0 = 1,
    ._2 = 1,
    .CALENDAR = 1,
};
...
pub const NM_TREEVIEW_ACTION = packed struct(u32) {
    E_COLLAPSE: u1 = 0,
    E_EXPAND: u1 = 0,
    _2: u1 = 0,
    _3: u1 = 0,
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // C_BYMOUSE (bit index 0) conflicts with E_COLLAPSE
    // C_BYKEYBOARD (bit index 1) conflicts with E_EXPAND
};
pub const TVE_COLLAPSE = NM_TREEVIEW_ACTION{ .E_COLLAPSE = 1 };
pub const TVE_EXPAND = NM_TREEVIEW_ACTION{ .E_EXPAND = 1 };
pub const TVE_TOGGLE = NM_TREEVIEW_ACTION{
    .E_COLLAPSE = 1,
    .E_EXPAND = 1,
};
pub const TVE_EXPANDPARTIAL = NM_TREEVIEW_ACTION{ .E_EXPANDPARTIAL = 1 };
pub const TVE_COLLAPSERESET = NM_TREEVIEW_ACTION{ .E_COLLAPSERESET = 1 };
pub const TVC_UNKNOWN = NM_TREEVIEW_ACTION{ };
pub const TVC_BYMOUSE = NM_TREEVIEW_ACTION{ .E_COLLAPSE = 1 };
pub const TVC_BYKEYBOARD = NM_TREEVIEW_ACTION{ .E_EXPAND = 1 };
...
pub const NMCUSTOMDRAW_DRAW_STATE_FLAGS = packed struct(u32) {
    SELECTED: u1 = 0,
    GRAYED: u1 = 0,
    DISABLED: u1 = 0,
    CHECKED: u1 = 0,
...
pub const CDIS_SELECTED = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .SELECTED = 1 };
pub const CDIS_GRAYED = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .GRAYED = 1 };
pub const CDIS_DISABLED = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .DISABLED = 1 };
pub const CDIS_CHECKED = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .CHECKED = 1 };
pub const CDIS_FOCUS = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .FOCUS = 1 };
pub const CDIS_DEFAULT = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .DEFAULT = 1 };
pub const CDIS_HOT = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .HOT = 1 };
pub const CDIS_MARKED = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .MARKED = 1 };
pub const CDIS_INDETERMINATE = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .INDETERMINATE = 1 };
pub const CDIS_SHOWKEYBOARDCUES = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .SHOWKEYBOARDCUES = 1 };
pub const CDIS_NEARHOT = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .NEARHOT = 1 };
pub const CDIS_OTHERSIDEHOT = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .OTHERSIDEHOT = 1 };
pub const CDIS_DROPHILITED = NMCUSTOMDRAW_DRAW_STATE_FLAGS{ .DROPHILITED = 1 };
...
pub const TOOLTIP_FLAGS = packed struct(u32) {
    IDISHWND: u1 = 0,
    CENTERTIP: u1 = 0,
    RTLREADING: u1 = 0,
    _3: u1 = 0,
...
pub const TTF_IDISHWND = TOOLTIP_FLAGS{ .IDISHWND = 1 };
pub const TTF_CENTERTIP = TOOLTIP_FLAGS{ .CENTERTIP = 1 };
pub const TTF_RTLREADING = TOOLTIP_FLAGS{ .RTLREADING = 1 };
pub const TTF_SUBCLASS = TOOLTIP_FLAGS{ .SUBCLASS = 1 };
pub const TTF_TRACK = TOOLTIP_FLAGS{ .TRACK = 1 };
pub const TTF_ABSOLUTE = TOOLTIP_FLAGS{ .ABSOLUTE = 1 };
pub const TTF_TRANSPARENT = TOOLTIP_FLAGS{ .TRANSPARENT = 1 };
pub const TTF_PARSELINKS = TOOLTIP_FLAGS{ .PARSELINKS = 1 };
pub const TTF_DI_SETITEM = TOOLTIP_FLAGS{ .DI_SETITEM = 1 };
...
pub const TREE_VIEW_ITEM_STATE_FLAGS = enum(u32) {
    ...
    STATEIMAGEMASK = 61440,
    EX_FLAT = 1,
    pub const USERMASK = .STATEIMAGEMASK;
    pub const EX_DISABLED = .SELECTED;
    pub const EX_ALL = .SELECTED;
};
...
const DRAW_EDGE_FLAGS = @import("../graphics/gdi.zig").DRAW_EDGE_FLAGS;
const DRAW_TEXT_FORMAT = @import("../graphics/gdi.zig").DRAW_TEXT_FORMAT;
const DRAWEDGE_FLAGS = @import("../graphics/gdi.zig").DRAWEDGE_FLAGS;
