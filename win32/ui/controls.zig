...
pub const SCROLLBAR_OBJID = enum(i32) {
    CLIENT = -4,
    HSCROLL = -6,
    VSCROLL = -5,
    MENU = -3,
...
pub const RICH_EDIT_GET_CONTEXT_MENU_SEL_TYPE = enum(u32) {
    SEL_EMPTY = 0,
    SEL_TEXT = 1,
    SEL_OBJECT = 2,
    SEL_MULTICHAR = 4,
...
pub const NMPGSCROLL_KEYS = enum(u32) {
    NONE = 0,
    SHIFT = 1,
    CONTROL = 2,
    MENU = 4,
...
pub const PARAFORMAT_BORDERS = enum(u32) {
    LEFT = 1,
    RIGHT = 2,
    TOP = 4,
    BOTTOM = 8,
...
pub const PARAFORMAT_SHADING_STYLE = enum(u32) {
    NONE = 0,
    DARK_HORIZ = 1,
    DARK_VERT = 2,
    DARK_DOWN_DIAG = 3,
...
pub const PARAFORMAT_NUMBERING_STYLE = enum(u32) {
    PAREN = 0,
    PARENS = 256,
    PERIOD = 512,
    PLAIN = 768,
...
pub const PARAFORMAT_ALIGNMENT = enum(u32) {
    CENTER = 3,
    LEFT = 1,
    RIGHT = 2,
};
...
pub const _TASKDIALOG_FLAGS = enum(i32) {
    ENABLE_HYPERLINKS = 1,
    USE_HICON_MAIN = 2,
    USE_HICON_FOOTER = 4,
...
pub const _TASKDIALOG_COMMON_BUTTON_FLAGS = enum(i32) {
    OK_BUTTON = 1,
    YES_BUTTON = 2,
    NO_BUTTON = 4,
    CANCEL_BUTTON = 8,
