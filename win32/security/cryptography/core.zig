...
pub const CERT_SET_KEY_PROV_HANDLE_PROP_ID = CRYPT_KEY_FLAGS.CERT_SET_KEY_PROV_HANDLE_PROP_ID;
pub const CERT_SET_KEY_CONTEXT_PROP_ID = CRYPT_KEY_FLAGS.CERT_SET_KEY_CONTEXT_PROP_ID;
