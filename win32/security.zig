...
pub const INHERIT_ONLY_ACE = ACE_FLAGS{ .INHERIT_ONLY_ACE = 1 };
pub const INHERITED_ACE = ACE_FLAGS{ .INHERITED_ACE = 1 };
pub const NO_PROPAGATE_INHERIT_ACE = ACE_FLAGS{ .NO_PROPAGATE_INHERIT_ACE = 1 };
pub const OBJECT_INHERIT_ACE = ACE_FLAGS{ .OBJECT_INHERIT_ACE = 1 };
pub const SUCCESSFUL_ACCESS_ACE_FLAG = ACE_FLAGS{ .SUCCESSFUL_ACCESS_ACE_FLAG = 1 };
pub const SUB_CONTAINERS_AND_OBJECTS_INHERIT = ACE_FLAGS{
    .OBJECT_INHERIT_ACE = 1,
    .CONTAINER_INHERIT_ACE = 1,
};
pub const SUB_CONTAINERS_ONLY_INHERIT = ACE_FLAGS{ .CONTAINER_INHERIT_ACE = 1 };
...
pub const ATTRIBUTE_SECURITY_INFORMATION = OBJECT_SECURITY_INFORMATION{ .ATTRIBUTE_SECURITY_INFORMATION = 1 };
pub const BACKUP_SECURITY_INFORMATION = OBJECT_SECURITY_INFORMATION{ .BACKUP_SECURITY_INFORMATION = 1 };
pub const DACL_SECURITY_INFORMATION = OBJECT_SECURITY_INFORMATION{ .DACL_SECURITY_INFORMATION = 1 };
pub const GROUP_SECURITY_INFORMATION = OBJECT_SECURITY_INFORMATION{ .GROUP_SECURITY_INFORMATION = 1 };
pub const LABEL_SECURITY_INFORMATION = OBJECT_SECURITY_INFORMATION{ .LABEL_SECURITY_INFORMATION = 1 };
pub const OWNER_SECURITY_INFORMATION = OBJECT_SECURITY_INFORMATION{ .OWNER_SECURITY_INFORMATION = 1 };
pub const PROTECTED_DACL_SECURITY_INFORMATION = OBJECT_SECURITY_INFORMATION{ .PROTECTED_DACL_SECURITY_INFORMATION = 1 };
pub const PROTECTED_SACL_SECURITY_INFORMATION = OBJECT_SECURITY_INFORMATION{ .PROTECTED_SACL_SECURITY_INFORMATION = 1 };
pub const SACL_SECURITY_INFORMATION = OBJECT_SECURITY_INFORMATION{ .SACL_SECURITY_INFORMATION = 1 };
pub const SCOPE_SECURITY_INFORMATION = OBJECT_SECURITY_INFORMATION{ .SCOPE_SECURITY_INFORMATION = 1 };
...
pub const SEF_AVOID_OWNER_CHECK = SECURITY_AUTO_INHERIT_FLAGS{ .AVOID_OWNER_CHECK = 1 };
pub const SEF_AVOID_OWNER_RESTRICTION = SECURITY_AUTO_INHERIT_FLAGS{ .AVOID_OWNER_RESTRICTION = 1 };
pub const SEF_AVOID_PRIVILEGE_CHECK = SECURITY_AUTO_INHERIT_FLAGS{ .AVOID_PRIVILEGE_CHECK = 1 };
pub const SEF_DACL_AUTO_INHERIT = SECURITY_AUTO_INHERIT_FLAGS{ .DACL_AUTO_INHERIT = 1 };
pub const SEF_DEFAULT_DESCRIPTOR_FOR_OBJECT = SECURITY_AUTO_INHERIT_FLAGS{ .DEFAULT_DESCRIPTOR_FOR_OBJECT = 1 };
pub const SEF_DEFAULT_GROUP_FROM_PARENT = SECURITY_AUTO_INHERIT_FLAGS{ .DEFAULT_GROUP_FROM_PARENT = 1 };
pub const SEF_DEFAULT_OWNER_FROM_PARENT = SECURITY_AUTO_INHERIT_FLAGS{ .DEFAULT_OWNER_FROM_PARENT = 1 };
pub const SEF_MACL_NO_EXECUTE_UP = SECURITY_AUTO_INHERIT_FLAGS{ .MACL_NO_EXECUTE_UP = 1 };
pub const SEF_MACL_NO_READ_UP = SECURITY_AUTO_INHERIT_FLAGS{ .MACL_NO_READ_UP = 1 };
...
pub const TOKEN_READ_CONTROL = TOKEN_ACCESS_MASK{ .READ_CONTROL = 1 };
...
pub const TOKEN_QUERY = TOKEN_ACCESS_MASK{ .QUERY = 1 };
pub const TOKEN_QUERY_SOURCE = TOKEN_ACCESS_MASK{ .QUERY_SOURCE = 1 };
pub const TOKEN_ADJUST_PRIVILEGES = TOKEN_ACCESS_MASK{ .ADJUST_PRIVILEGES = 1 };
...
pub const TOKEN_WRITE = TOKEN_ACCESS_MASK{
    .ADJUST_PRIVILEGES = 1,
    .ADJUST_GROUPS = 1,
    .ADJUST_DEFAULT = 1,
    .READ_CONTROL = 1,
};
pub const TOKEN_EXECUTE = TOKEN_ACCESS_MASK{ .READ_CONTROL = 1 };
pub const TOKEN_TRUST_CONSTRAINT_MASK = TOKEN_ACCESS_MASK{
    .QUERY = 1,
    .QUERY_SOURCE = 1,
    .READ_CONTROL = 1,
};
pub const TOKEN_ACCESS_PSEUDO_HANDLE_WIN8 = TOKEN_ACCESS_MASK{
    .QUERY = 1,
    .QUERY_SOURCE = 1,
};
pub const TOKEN_ACCESS_PSEUDO_HANDLE = TOKEN_ACCESS_MASK{
    .QUERY = 1,
    .QUERY_SOURCE = 1,
};
pub const TOKEN_ALL_ACCESS = TOKEN_ACCESS_MASK{
    .ASSIGN_PRIMARY = 1,
    .DUPLICATE = 1,
    .IMPERSONATE = 1,
    .QUERY = 1,
