...
pub const DNS_QUERY_OPTIONS = packed struct(u32) {
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // CACHE_ONLY (bit index 4) conflicts with NO_WIRE_QUERY
    // REQUEST_VERSION1 (bit index 0) conflicts with ACCEPT_TRUNCATED_RESPONSE
    // REQUEST_VERSION2 (bit index 1) conflicts with USE_TCP_ONLY
    // RESULTS_VERSION1 (bit index 0) conflicts with ACCEPT_TRUNCATED_RESPONSE
};
pub const DNS_QUERY_STANDARD = DNS_QUERY_OPTIONS{ };
pub const DNS_QUERY_ACCEPT_TRUNCATED_RESPONSE = DNS_QUERY_OPTIONS{ .ACCEPT_TRUNCATED_RESPONSE = 1 };
pub const DNS_QUERY_USE_TCP_ONLY = DNS_QUERY_OPTIONS{ .USE_TCP_ONLY = 1 };
pub const DNS_QUERY_NO_RECURSION = DNS_QUERY_OPTIONS{ .NO_RECURSION = 1 };
pub const DNS_QUERY_BYPASS_CACHE = DNS_QUERY_OPTIONS{ .BYPASS_CACHE = 1 };
pub const DNS_QUERY_NO_WIRE_QUERY = DNS_QUERY_OPTIONS{ .NO_WIRE_QUERY = 1 };
pub const DNS_QUERY_NO_LOCAL_NAME = DNS_QUERY_OPTIONS{ .NO_LOCAL_NAME = 1 };
pub const DNS_QUERY_NO_HOSTS_FILE = DNS_QUERY_OPTIONS{ .NO_HOSTS_FILE = 1 };
pub const DNS_QUERY_NO_NETBT = DNS_QUERY_OPTIONS{ .NO_NETBT = 1 };
pub const DNS_QUERY_WIRE_ONLY = DNS_QUERY_OPTIONS{ .WIRE_ONLY = 1 };
pub const DNS_QUERY_RETURN_MESSAGE = DNS_QUERY_OPTIONS{ .RETURN_MESSAGE = 1 };
pub const DNS_QUERY_MULTICAST_ONLY = DNS_QUERY_OPTIONS{ .MULTICAST_ONLY = 1 };
pub const DNS_QUERY_NO_MULTICAST = DNS_QUERY_OPTIONS{ .NO_MULTICAST = 1 };
pub const DNS_QUERY_TREAT_AS_FQDN = DNS_QUERY_OPTIONS{ .TREAT_AS_FQDN = 1 };
pub const DNS_QUERY_ADDRCONFIG = DNS_QUERY_OPTIONS{ .ADDRCONFIG = 1 };
pub const DNS_QUERY_DUAL_ADDR = DNS_QUERY_OPTIONS{ .DUAL_ADDR = 1 };
pub const DNS_QUERY_DONT_RESET_TTL_VALUES = DNS_QUERY_OPTIONS{ .DONT_RESET_TTL_VALUES = 1 };
pub const DNS_QUERY_DISABLE_IDN_ENCODING = DNS_QUERY_OPTIONS{ .DISABLE_IDN_ENCODING = 1 };
pub const DNS_QUERY_APPEND_MULTILABEL = DNS_QUERY_OPTIONS{ .APPEND_MULTILABEL = 1 };
pub const DNS_QUERY_DNSSEC_OK = DNS_QUERY_OPTIONS{ .DNSSEC_OK = 1 };
pub const DNS_QUERY_DNSSEC_CHECKING_DISABLED = DNS_QUERY_OPTIONS{ .DNSSEC_CHECKING_DISABLED = 1 };
pub const DNS_QUERY_RESERVED = DNS_QUERY_OPTIONS{
    ._28 = 1,
    ._29 = 1,
    ._30 = 1,
    ._31 = 1,
};
pub const DNS_QUERY_CACHE_ONLY = DNS_QUERY_OPTIONS{ .NO_WIRE_QUERY = 1 };
pub const DNS_QUERY_REQUEST_VERSION1 = DNS_QUERY_OPTIONS{ .ACCEPT_TRUNCATED_RESPONSE = 1 };
pub const DNS_QUERY_REQUEST_VERSION2 = DNS_QUERY_OPTIONS{ .USE_TCP_ONLY = 1 };
pub const DNS_QUERY_RESULTS_VERSION1 = DNS_QUERY_OPTIONS{ .ACCEPT_TRUNCATED_RESPONSE = 1 };
pub const DNS_QUERY_REQUEST_VERSION3 = DNS_QUERY_OPTIONS{
