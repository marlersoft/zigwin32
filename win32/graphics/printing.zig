...
pub usingnamespace switch (@import("../zig.zig").unicode_mode) {
    .ansi => struct {
        ...
        pub const CommonPropertySheetUI = CommonPropertySheetUIA;
    ...
    .wide => struct {
        ...
        pub const CommonPropertySheetUI = CommonPropertySheetUIW;
...
const FD_KERNINGPAIR = @import("../ui/display_devices.zig").FD_KERNINGPAIR;
...
const STREAM_SEEK = @import("../storage/structured_storage.zig").STREAM_SEEK;
