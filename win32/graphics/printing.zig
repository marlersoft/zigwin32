...
pub const PRINTER_ACCESS_RIGHTS = packed struct(u32) {
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // PRINTER_WRITE (131080) conflicts with PRINTER_READ
    // PRINTER_EXECUTE (131080) conflicts with PRINTER_READ
    // SERVER_EXECUTE (131074) conflicts with SERVER_READ
    // PRINTER_STANDARD_RIGHTS_READ (131072) conflicts with PRINTER_READ_CONTROL
    // PRINTER_STANDARD_RIGHTS_WRITE (131072) conflicts with PRINTER_READ_CONTROL
    // PRINTER_STANDARD_RIGHTS_EXECUTE (131072) conflicts with PRINTER_READ_CONTROL
};
