...
pub const DXGI_USAGE_SHADER_INPUT = DXGI_USAGE{ .SHADER_INPUT = 1 };
pub const DXGI_USAGE_RENDER_TARGET_OUTPUT = DXGI_USAGE{ .RENDER_TARGET_OUTPUT = 1 };
pub const DXGI_USAGE_BACK_BUFFER = DXGI_USAGE{ .BACK_BUFFER = 1 };
pub const DXGI_USAGE_SHARED = DXGI_USAGE{ .SHARED = 1 };
pub const DXGI_USAGE_READ_ONLY = DXGI_USAGE{ .READ_ONLY = 1 };
pub const DXGI_USAGE_DISCARD_ON_PRESENT = DXGI_USAGE{ .DISCARD_ON_PRESENT = 1 };
pub const DXGI_USAGE_UNORDERED_ACCESS = DXGI_USAGE{ .UNORDERED_ACCESS = 1 };
...
pub const IDXGIDevice = extern union {
    ...
    pub fn CreateSurface(self: *const IDXGIDevice, pDesc: ?*const DXGI_SURFACE_DESC, NumSurfaces: u32, Usage: DXGI_USAGE, pSharedResource: ?*const DXGI_SHARED_RESOURCE, ppSurface: [*]?*IDXGISurface) callconv(.@"inline") HRESULT {
...
pub const IDXGIResource = extern union {
    ...
    pub fn GetUsage(self: *const IDXGIResource, pUsage: ?*DXGI_USAGE) callconv(.@"inline") HRESULT {
