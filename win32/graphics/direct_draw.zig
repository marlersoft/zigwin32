...
pub const E_NOTIMPL = @as(i32, -2147467263);
pub const E_OUTOFMEMORY = @as(i32, -2147024882);
pub const E_INVALIDARG = @as(i32, -2147024809);
pub const E_FAIL = @as(i32, -2147467259);
...
pub const IDDVideoPortContainer = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDDVideoPortContainer_EnumVideoPorts(self: *const T, param0: u32, param1: *DDVIDEOPORTCAPS, param2: *c_void, param3: LPDDENUMVIDEOCALLBACK) callconv(.Inline) HRESULT {
