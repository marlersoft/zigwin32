...
pub const BI_COMPRESSION = enum(i32) {
    RGB = 0,
    RLE8 = 1,
    RLE4 = 2,
    BITFIELDS = 3,
...
pub const CREATE_FONT_PACKAGE_SUBSET_ENCODING = enum(u16) {
    STD_MAC_CHAR_SET = 0,
    UNICODE_CHAR_SET = 1,
...
pub const CREATE_FONT_PACKAGE_SUBSET_PLATFORM = enum(u16) {
...
pub const DEVMODE_COLLATE = enum(u16) {
    FALSE = 0,
    TRUE = 1,
};
...
pub const DEVMODE_COLOR = enum(u16) {
    MONOCHROME = 1,
    COLOR = 2,
};
...
pub const DEVMODE_FIELD_FLAGS = packed struct(u32) {
    ORIENTATION: u1 = 0,
    PAPERSIZE: u1 = 0,
    PAPERLENGTH: u1 = 0,
    PAPERWIDTH: u1 = 0,
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // INTERLACED (bit index 1) conflicts with PAPERSIZE
    // UPDATE (bit index 0) conflicts with ORIENTATION
    // COPY (bit index 1) conflicts with PAPERSIZE
    // PROMPT (bit index 2) conflicts with PAPERLENGTH
    // MODIFY (bit index 3) conflicts with PAPERWIDTH
    // IN_BUFFER (bit index 3) conflicts with PAPERWIDTH
    // IN_PROMPT (bit index 2) conflicts with PAPERLENGTH
    // OUT_BUFFER (bit index 1) conflicts with PAPERSIZE
    // OUT_DEFAULT (bit index 0) conflicts with ORIENTATION
};
pub const DM_SPECVERSION = DEVMODE_FIELD_FLAGS{
    .ORIENTATION = 1,
    .PRINTQUALITY = 1,
};
pub const DM_ORIENTATION = DEVMODE_FIELD_FLAGS{ .ORIENTATION = 1 };
pub const DM_PAPERSIZE = DEVMODE_FIELD_FLAGS{ .PAPERSIZE = 1 };
pub const DM_PAPERLENGTH = DEVMODE_FIELD_FLAGS{ .PAPERLENGTH = 1 };
pub const DM_PAPERWIDTH = DEVMODE_FIELD_FLAGS{ .PAPERWIDTH = 1 };
pub const DM_SCALE = DEVMODE_FIELD_FLAGS{ .SCALE = 1 };
pub const DM_POSITION = DEVMODE_FIELD_FLAGS{ .POSITION = 1 };
pub const DM_NUP = DEVMODE_FIELD_FLAGS{ .NUP = 1 };
pub const DM_DISPLAYORIENTATION = DEVMODE_FIELD_FLAGS{ .DISPLAYORIENTATION = 1 };
pub const DM_COPIES = DEVMODE_FIELD_FLAGS{ .COPIES = 1 };
pub const DM_DEFAULTSOURCE = DEVMODE_FIELD_FLAGS{ .DEFAULTSOURCE = 1 };
pub const DM_PRINTQUALITY = DEVMODE_FIELD_FLAGS{ .PRINTQUALITY = 1 };
pub const DM_COLOR = DEVMODE_FIELD_FLAGS{ .COLOR = 1 };
pub const DM_DUPLEX = DEVMODE_FIELD_FLAGS{ .DUPLEX = 1 };
pub const DM_YRESOLUTION = DEVMODE_FIELD_FLAGS{ .YRESOLUTION = 1 };
pub const DM_TTOPTION = DEVMODE_FIELD_FLAGS{ .TTOPTION = 1 };
pub const DM_COLLATE = DEVMODE_FIELD_FLAGS{ .COLLATE = 1 };
pub const DM_FORMNAME = DEVMODE_FIELD_FLAGS{ .FORMNAME = 1 };
pub const DM_LOGPIXELS = DEVMODE_FIELD_FLAGS{ .LOGPIXELS = 1 };
pub const DM_BITSPERPEL = DEVMODE_FIELD_FLAGS{ .BITSPERPEL = 1 };
pub const DM_PELSWIDTH = DEVMODE_FIELD_FLAGS{ .PELSWIDTH = 1 };
pub const DM_PELSHEIGHT = DEVMODE_FIELD_FLAGS{ .PELSHEIGHT = 1 };
pub const DM_DISPLAYFLAGS = DEVMODE_FIELD_FLAGS{ .DISPLAYFLAGS = 1 };
pub const DM_DISPLAYFREQUENCY = DEVMODE_FIELD_FLAGS{ .DISPLAYFREQUENCY = 1 };
pub const DM_ICMMETHOD = DEVMODE_FIELD_FLAGS{ .ICMMETHOD = 1 };
pub const DM_ICMINTENT = DEVMODE_FIELD_FLAGS{ .ICMINTENT = 1 };
pub const DM_MEDIATYPE = DEVMODE_FIELD_FLAGS{ .MEDIATYPE = 1 };
pub const DM_DITHERTYPE = DEVMODE_FIELD_FLAGS{ .DITHERTYPE = 1 };
pub const DM_PANNINGWIDTH = DEVMODE_FIELD_FLAGS{ .PANNINGWIDTH = 1 };
pub const DM_PANNINGHEIGHT = DEVMODE_FIELD_FLAGS{ .PANNINGHEIGHT = 1 };
pub const DM_DISPLAYFIXEDOUTPUT = DEVMODE_FIELD_FLAGS{ .DISPLAYFIXEDOUTPUT = 1 };
pub const DM_INTERLACED = DEVMODE_FIELD_FLAGS{ .PAPERSIZE = 1 };
pub const DM_UPDATE = DEVMODE_FIELD_FLAGS{ .ORIENTATION = 1 };
pub const DM_COPY = DEVMODE_FIELD_FLAGS{ .PAPERSIZE = 1 };
pub const DM_PROMPT = DEVMODE_FIELD_FLAGS{ .PAPERLENGTH = 1 };
pub const DM_MODIFY = DEVMODE_FIELD_FLAGS{ .PAPERWIDTH = 1 };
pub const DM_IN_BUFFER = DEVMODE_FIELD_FLAGS{ .PAPERWIDTH = 1 };
pub const DM_IN_PROMPT = DEVMODE_FIELD_FLAGS{ .PAPERLENGTH = 1 };
pub const DM_OUT_BUFFER = DEVMODE_FIELD_FLAGS{ .PAPERSIZE = 1 };
pub const DM_OUT_DEFAULT = DEVMODE_FIELD_FLAGS{ .ORIENTATION = 1 };

pub const DEVMODE_TRUETYPE_OPTION = enum(u16) {
    BITMAP = 1,
    DOWNLOAD = 2,
    SUBDEV = 3,
    DOWNLOAD_OUTLINE = 4,
...
pub const ENHANCED_METAFILE_RECORD_TYPE = enum(u32) {
    ...
    pub const MIN = .HEADER;
    pub const MAX = .CREATECOLORSPACEW;
};
...
pub const EDS_RAWMODE = ENUM_DISPLAY_SETTINGS_FLAGS{ .AWMODE = 1 };
pub const EDS_ROTATEDMODE = ENUM_DISPLAY_SETTINGS_FLAGS{ .OTATEDMODE = 1 };
...
pub const FONT_CHARSET = enum(u8) {
    ...
    MAC_CHARSET = 77,
    BALTIC_CHARSET = 186,
    pub const HANGUL_CHARSET = .HANGEUL_CHARSET;
};
...
pub const FONT_CLIP_PRECISION = packed struct(u8) {
    ...
    DFA_DISABLE: u1 = 0,
    EMBEDDED: u1 = 0,
    // DFA_OVERRIDE (bit index 6) conflicts with DFA_DISABLE
};
...
pub const CLIP_DFA_OVERRIDE = FONT_CLIP_PRECISION{ .DFA_DISABLE = 1 };
...
pub const FONT_WEIGHT = enum(u32) {
    ...
    EXTRABOLD = 800,
    HEAVY = 900,
    pub const ULTRALIGHT = .EXTRALIGHT;
    pub const REGULAR = .NORMAL;
    pub const DEMIBOLD = .SEMIBOLD;
    pub const ULTRABOLD = .EXTRABOLD;
    pub const BLACK = .HEAVY;
};
...
pub const PAN_ARM_STYLE = enum(u32) {
    ARM_ANY = 0,
    ARM_NO_FIT = 1,
...
pub const PAN_CONTRAST = enum(u32) {
    ANY = 0,
    NO_FIT = 1,
    INDEX = 4,
    NONE = 2,
...
pub const PAN_FAMILY_TYPE = enum(u32) {
    ANY = 0,
    NO_FIT = 1,
    TEXT_DISPLAY = 2,
    SCRIPT = 3,
...
pub const PAN_LETT_FORM = enum(u32) {
    FORM_ANY = 0,
    FORM_NO_FIT = 1,
    NORMAL_CONTACT = 2,
    NORMAL_WEIGHTED = 3,
...
pub const PAN_MIDLINE = enum(u32) {
    ANY = 0,
    NO_FIT = 1,
    INDEX = 8,
    STANDARD_TRIMMED = 2,
    ...
    LOW_POINTED = 12,
    LOW_SERIFED = 13,
    pub const CONSTANT_TRIMMED = .INDEX;
};
...
pub const PAN_PROPORTION = enum(u32) {
    ANY = 0,
    NO_FIT = 1,
    OLD_STYLE = 2,
    MODERN = 3,
...
pub const PAN_SERIF_STYLE = enum(u32) {
    ANY = 0,
    NO_FIT = 1,
    COVE = 2,
    OBTUSE_COVE = 3,
...
pub const PAN_STROKE_VARIATION = enum(u32) {
    ANY = 0,
    NO_FIT = 1,
    GRADUAL_DIAG = 2,
    GRADUAL_TRAN = 3,
...
pub const PAN_XHEIGHT = enum(u32) {
    ANY = 0,
    NO_FIT = 1,
    INDEX = 9,
    CONSTANT_SMALL = 2,
...
pub const SYS_COLOR_INDEX = enum(i32) {
    ...
    pub const @"3DFACE" = .BTNFACE;
    pub const @"3DSHADOW" = .BTNSHADOW;
    pub const @"3DHIGHLIGHT" = .BTNHIGHLIGHT;
    pub const @"3DHILIGHT" = .BTNHIGHLIGHT;
    pub const BTNHILIGHT = .BTNHIGHLIGHT;
};
...
pub const TEXT_ALIGN_OPTIONS = packed struct(u32) {
    TA_UPDATECP: u1 = 0,
    TA_RIGHT: u1 = 0,
    _2: u1 = 0,
    TA_BOTTOM: u1 = 0,
    ...
    _30: u1 = 0,
    _31: u1 = 0,
    // VTA_LEFT (bit index 3) conflicts with TA_BOTTOM
    // VTA_BOTTOM (bit index 1) conflicts with TA_RIGHT
};
pub const TA_NOUPDATECP = TEXT_ALIGN_OPTIONS{ };
pub const TA_UPDATECP = TEXT_ALIGN_OPTIONS{ .TA_UPDATECP = 1 };
pub const TA_LEFT = TEXT_ALIGN_OPTIONS{ };
pub const TA_RIGHT = TEXT_ALIGN_OPTIONS{ .TA_RIGHT = 1 };
pub const TA_CENTER = TEXT_ALIGN_OPTIONS{
    .TA_RIGHT = 1,
    ._2 = 1,
};
pub const TA_TOP = TEXT_ALIGN_OPTIONS{ };
pub const TA_BOTTOM = TEXT_ALIGN_OPTIONS{ .TA_BOTTOM = 1 };
pub const TA_BASELINE = TEXT_ALIGN_OPTIONS{
    .TA_BOTTOM = 1,
    ._4 = 1,
};
pub const TA_RTLREADING = TEXT_ALIGN_OPTIONS{ .TA_RTLREADING = 1 };
pub const TA_MASK = TEXT_ALIGN_OPTIONS{
    .TA_UPDATECP = 1,
    .TA_RIGHT = 1,
    ._2 = 1,
    .TA_BOTTOM = 1,
...
pub const VTA_BASELINE = TEXT_ALIGN_OPTIONS{
    .TA_BOTTOM = 1,
    ._4 = 1,
};
pub const VTA_LEFT = TEXT_ALIGN_OPTIONS{ .TA_BOTTOM = 1 };
pub const VTA_RIGHT = TEXT_ALIGN_OPTIONS{ };
pub const VTA_CENTER = TEXT_ALIGN_OPTIONS{
    .TA_RIGHT = 1,
    ._2 = 1,
};
pub const VTA_BOTTOM = TEXT_ALIGN_OPTIONS{ .TA_RIGHT = 1 };
...
pub const TMPF_FLAGS = packed struct(u8) {
    FIXED_PITCH: u1 = 0,
    VECTOR: u1 = 0,
    TRUETYPE: u1 = 0,
    DEVICE: u1 = 0,
...
pub const TMPF_FIXED_PITCH = TMPF_FLAGS{ .FIXED_PITCH = 1 };
pub const TMPF_VECTOR = TMPF_FLAGS{ .VECTOR = 1 };
pub const TMPF_DEVICE = TMPF_FLAGS{ .DEVICE = 1 };
pub const TMPF_TRUETYPE = TMPF_FLAGS{ .TRUETYPE = 1 };
