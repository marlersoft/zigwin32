...
pub const DEVMODE_COLLATE = enum(u32) {
    FALSE = 0,
    TRUE = 1,
};
...
pub const DEVMODE_COLOR = enum(u32) {
    MONOCHROME = 1,
    COLOR = 2,
};
...
pub const DEVMODE_DUPLEX = enum(u32) {
    SIMPLEX = 1,
    VERTICAL = 2,
    HORIZONTAL = 3,
};
...
pub const DEVMODE_TRUETYPE_OPTION = enum(u32) {
    BITMAP = 1,
    DOWNLOAD = 2,
    SUBDEV = 3,
    DOWNLOAD_OUTLINE = 4,
