...
const DISPLAYCONFIG_DEVICE_INFO_HEADER = @import("../ui/display_devices.zig").DISPLAYCONFIG_DEVICE_INFO_HEADER;
const LOGCOLORSPACEW = @import("../ui/color_system.zig").LOGCOLORSPACEW;
const DEVMODEW = @import("../ui/display_devices.zig").DEVMODEW;
const METAFILEPICT = @import("../system/data_exchange.zig").METAFILEPICT;
...
const LOGCOLORSPACEA = @import("../ui/color_system.zig").LOGCOLORSPACEA;
const WPARAM = @import("../ui/windows_and_messaging.zig").WPARAM;
const TEXT_ALIGN_OPTIONS = @import("../ui/controls.zig").TEXT_ALIGN_OPTIONS;
const CIEXYZTRIPLE = @import("../ui/color_system.zig").CIEXYZTRIPLE;
