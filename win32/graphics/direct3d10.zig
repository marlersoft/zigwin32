...
pub const D3D10_DEFAULT_BLEND_FACTOR_ALPHA = @as(f32, 1.0);
pub const D3D10_DEFAULT_BLEND_FACTOR_BLUE = @as(f32, 1.0);
pub const D3D10_DEFAULT_BLEND_FACTOR_GREEN = @as(f32, 1.0);
pub const D3D10_DEFAULT_BLEND_FACTOR_RED = @as(f32, 1.0);
pub const D3D10_DEFAULT_BORDER_COLOR_COMPONENT = @as(f32, 0.0);
pub const D3D10_DEFAULT_DEPTH_BIAS = @as(u32, 0);
pub const D3D10_DEFAULT_DEPTH_BIAS_CLAMP = @as(f32, 0.0);
pub const D3D10_DEFAULT_MAX_ANISOTROPY = @as(f32, 16.0);
pub const D3D10_DEFAULT_MIP_LOD_BIAS = @as(f32, 0.0);
...
pub const D3D10_DEFAULT_SLOPE_SCALED_DEPTH_BIAS = @as(f32, 0.0);
...
pub const D3D10_DEFAULT_VIEWPORT_MAX_DEPTH = @as(f32, 0.0);
pub const D3D10_DEFAULT_VIEWPORT_MIN_DEPTH = @as(f32, 0.0);
...
pub const D3D10_FLOAT_TO_SRGB_EXPONENT_NUMERATOR = @as(f32, 1.0);
...
pub const D3D10_FTOI_INSTRUCTION_MAX_INPUT = @as(f32, 2147483600.0);
pub const D3D10_FTOI_INSTRUCTION_MIN_INPUT = @as(f32, -2147483600.0);
pub const D3D10_FTOU_INSTRUCTION_MAX_INPUT = @as(f32, 4294967300.0);
pub const D3D10_FTOU_INSTRUCTION_MIN_INPUT = @as(f32, 0.0);
...
pub const D3D10_LINEAR_GAMMA = @as(f32, 1.0);
pub const D3D10_MAG_FILTER_SHIFT = @as(u32, 2);
pub const D3D10_MAX_BORDER_COLOR_COMPONENT = @as(f32, 1.0);
pub const D3D10_MAX_DEPTH = @as(f32, 1.0);
...
pub const D3D10_MIN_BORDER_COLOR_COMPONENT = @as(f32, 0.0);
pub const D3D10_MIN_DEPTH = @as(f32, 0.0);
...
pub const D3D10_MIP_LOD_BIAS_MIN = @as(f32, -16.0);
...
pub const D3D10_PS_LEGACY_PIXEL_CENTER_FRACTIONAL_COMPONENT = @as(f32, 0.0);
