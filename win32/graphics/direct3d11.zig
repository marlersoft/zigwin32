...
const D3D11_VIDEO_DECODER_BUFFER_TYPE = @import("../media/media_foundation.zig").D3D11_VIDEO_DECODER_BUFFER_TYPE;
const HRESULT = @import("../system/com.zig").HRESULT;
const ID3D11VideoDecoder = @import("../media/media_foundation.zig").ID3D11VideoDecoder;
const SECURITY_ATTRIBUTES = @import("../system/system_services.zig").SECURITY_ATTRIBUTES;
const ID3D11VideoDecoderOutputView = @import("../media/media_foundation.zig").ID3D11VideoDecoderOutputView;
...
const ID3D11CryptoSession = @import("../media/media_foundation.zig").ID3D11CryptoSession;
const DXGI_FORMAT = @import("../graphics/dxgi.zig").DXGI_FORMAT;
const D3D11_FEATURE_VIDEO = @import("../media/media_foundation.zig").D3D11_FEATURE_VIDEO;
const ID3D11VideoContext2 = @import("../media/media_foundation.zig").ID3D11VideoContext2;
const D3D11_VIDEO_DECODER_DESC = @import("../media/media_foundation.zig").D3D11_VIDEO_DECODER_DESC;
const ID3D11VideoDevice1 = @import("../media/media_foundation.zig").ID3D11VideoDevice1;
const HANDLE = @import("../system/system_services.zig").HANDLE;
const D3D11_VIDEO_DECODER_SUB_SAMPLE_MAPPING_BLOCK = @import("../media/media_foundation.zig").D3D11_VIDEO_DECODER_SUB_SAMPLE_MAPPING_BLOCK;
