...
pub usingnamespace if (@sizeOf(usize) == 8) struct {
    pub const SetWindowLongPtrA = win32.api.windows_and_messaging.SetWindowLongPtrA;
    pub const SetWindowLongPtrW = win32.api.windows_and_messaging.SetWindowLongPtrW;
    pub const GetWindowLongPtrA = win32.api.windows_and_messaging.GetWindowLongPtrA;
    pub const GetWindowLongPtrW = win32.api.windows_and_messaging.GetWindowLongPtrW;
} else struct {
