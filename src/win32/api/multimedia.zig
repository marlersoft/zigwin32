...
pub const CALLBACK_TYPEMASK = @as(i32, 458752);
pub const CALLBACK_NULL = @as(i32, 0);
pub const CALLBACK_WINDOW = @as(i32, 65536);
pub const CALLBACK_TASK = @as(i32, 131072);
pub const CALLBACK_FUNCTION = @as(i32, 196608);
pub const CALLBACK_EVENT = @as(i32, 327680);
...
pub const WAVE_FORMAT_QUERY = @as(u32, 1);
pub const WAVE_ALLOWSYNC = @as(u32, 2);
pub const WAVE_MAPPED = @as(u32, 4);
pub const WAVE_FORMAT_DIRECT = @as(u32, 8);
pub const WAVE_MAPPED_DEFAULT_COMMUNICATION_DEVICE = @as(u32, 16);
...
pub const MIDI_IO_STATUS = @as(i32, 32);
