...
pub const OPC_URI_TARGET_MODE = extern enum(i32) {
    INTERNAL = 0,
    EXTERNAL = 1,
};
...
pub const OPC_COMPRESSION_OPTIONS = extern enum(i32) {
...
pub const OPC_COMPRESSION_NONE = OPC_COMPRESSION_OPTIONS.OPC_COMPRESSION_NONE;
pub const OPC_COMPRESSION_NORMAL = OPC_COMPRESSION_OPTIONS.OPC_COMPRESSION_NORMAL;
pub const OPC_COMPRESSION_MAXIMUM = OPC_COMPRESSION_OPTIONS.OPC_COMPRESSION_MAXIMUM;
pub const OPC_COMPRESSION_FAST = OPC_COMPRESSION_OPTIONS.OPC_COMPRESSION_FAST;
pub const OPC_COMPRESSION_SUPERFAST = OPC_COMPRESSION_OPTIONS.OPC_COMPRESSION_SUPERFAST;

pub const OPC_STREAM_IO_MODE = extern enum(i32) {
    OPC_STREAM_IO_READ = 1,
    OPC_STREAM_IO_WRITE = 2,
};
pub const OPC_STREAM_IO_READ = OPC_STREAM_IO_MODE.OPC_STREAM_IO_READ;
pub const OPC_STREAM_IO_WRITE = OPC_STREAM_IO_MODE.OPC_STREAM_IO_WRITE;
...
pub const OPC_READ_DEFAULT = OPC_READ_FLAGS.OPC_READ_DEFAULT;
pub const OPC_VALIDATE_ON_LOAD = OPC_READ_FLAGS.OPC_VALIDATE_ON_LOAD;
pub const OPC_CACHE_ON_ACCESS = OPC_READ_FLAGS.OPC_CACHE_ON_ACCESS;

pub const OPC_WRITE_FLAGS = extern enum(i32) {
    OPC_WRITE_DEFAULT = 0,
    OPC_WRITE_FORCE_ZIP32 = 1,
};
pub const OPC_WRITE_DEFAULT = OPC_WRITE_FLAGS.OPC_WRITE_DEFAULT;
pub const OPC_WRITE_FORCE_ZIP32 = OPC_WRITE_FLAGS.OPC_WRITE_FORCE_ZIP32;

pub const OPC_SIGNATURE_VALIDATION_RESULT = extern enum(i32) {
    OPC_SIGNATURE_VALID = 0,
    OPC_SIGNATURE_INVALID = -1,
};
pub const OPC_SIGNATURE_VALID = OPC_SIGNATURE_VALIDATION_RESULT.OPC_SIGNATURE_VALID;
pub const OPC_SIGNATURE_INVALID = OPC_SIGNATURE_VALIDATION_RESULT.OPC_SIGNATURE_INVALID;

pub const OPC_CANONICALIZATION_METHOD = extern enum(i32) {
    OPC_CANONICALIZATION_NONE = 0,
    OPC_CANONICALIZATION_C14N = 1,
    OPC_CANONICALIZATION_C14N_WITH_COMMENTS = 2,
};
pub const OPC_CANONICALIZATION_NONE = OPC_CANONICALIZATION_METHOD.OPC_CANONICALIZATION_NONE;
pub const OPC_CANONICALIZATION_C14N = OPC_CANONICALIZATION_METHOD.OPC_CANONICALIZATION_C14N;
pub const OPC_CANONICALIZATION_C14N_WITH_COMMENTS = OPC_CANONICALIZATION_METHOD.OPC_CANONICALIZATION_C14N_WITH_COMMENTS;

pub const OPC_RELATIONSHIP_SELECTOR = extern enum(i32) {
    OPC_RELATIONSHIP_SELECT_BY_ID = 0,
    OPC_RELATIONSHIP_SELECT_BY_TYPE = 1,
};
pub const OPC_RELATIONSHIP_SELECT_BY_ID = OPC_RELATIONSHIP_SELECTOR.OPC_RELATIONSHIP_SELECT_BY_ID;
pub const OPC_RELATIONSHIP_SELECT_BY_TYPE = OPC_RELATIONSHIP_SELECTOR.OPC_RELATIONSHIP_SELECT_BY_TYPE;

pub const OPC_RELATIONSHIPS_SIGNING_OPTION = extern enum(i32) {
    OPC_RELATIONSHIP_SIGN_USING_SELECTORS = 0,
    OPC_RELATIONSHIP_SIGN_PART = 1,
};
pub const OPC_RELATIONSHIP_SIGN_USING_SELECTORS = OPC_RELATIONSHIPS_SIGNING_OPTION.OPC_RELATIONSHIP_SIGN_USING_SELECTORS;
pub const OPC_RELATIONSHIP_SIGN_PART = OPC_RELATIONSHIPS_SIGNING_OPTION.OPC_RELATIONSHIP_SIGN_PART;

pub const OPC_CERTIFICATE_EMBEDDING_OPTION = extern enum(i32) {
    OPC_CERTIFICATE_IN_CERTIFICATE_PART = 0,
    OPC_CERTIFICATE_IN_SIGNATURE_PART = 1,
    OPC_CERTIFICATE_NOT_EMBEDDED = 2,
};
pub const OPC_CERTIFICATE_IN_CERTIFICATE_PART = OPC_CERTIFICATE_EMBEDDING_OPTION.OPC_CERTIFICATE_IN_CERTIFICATE_PART;
pub const OPC_CERTIFICATE_IN_SIGNATURE_PART = OPC_CERTIFICATE_EMBEDDING_OPTION.OPC_CERTIFICATE_IN_SIGNATURE_PART;
pub const OPC_CERTIFICATE_NOT_EMBEDDED = OPC_CERTIFICATE_EMBEDDING_OPTION.OPC_CERTIFICATE_NOT_EMBEDDED;

pub const OPC_SIGNATURE_TIME_FORMAT = extern enum(i32) {
    MILLISECONDS = 0,
    SECONDS = 1,
    MINUTES = 2,
    DAYS = 3,
...
pub const IOpcSignatureReference = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IOpcSignatureReference_GetType(self: *const T, type: ?*?PWSTR) callconv(.Inline) HRESULT {
            return @ptrCast(*const IOpcSignatureReference.VTable, self.vtable).GetType(@ptrCast(*const IOpcSignatureReference, self), type);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const IOpcCertificateEnumerator = extern struct {
    pub const VTable = extern struct {
        ...
        GetCurrent: fn(
            self: *const IOpcCertificateEnumerator,
            certificate: *const *const CERT_CONTEXT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        Clone: fn(
            self: *const IOpcCertificateEnumerator,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IOpcCertificateEnumerator_GetCurrent(self: *const T, certificate: *const *const CERT_CONTEXT) callconv(.Inline) HRESULT {
...
pub const IOpcSignatureReferenceSet = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IOpcSignatureReferenceSet_Create(self: *const T, referenceUri: ?*IUri, referenceId: ?[*:0]const u16, type: ?[*:0]const u16, digestMethod: ?[*:0]const u16, transformMethod: OPC_CANONICALIZATION_METHOD, reference: **IOpcSignatureReference) callconv(.Inline) HRESULT {
            return @ptrCast(*const IOpcSignatureReferenceSet.VTable, self.vtable).Create(@ptrCast(*const IOpcSignatureReferenceSet, self), referenceUri, referenceId, type, digestMethod, transformMethod, reference);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
test {
    ...
    const com_iface_id_export_count = 31;
