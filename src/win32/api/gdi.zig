...
pub const TA_NOUPDATECP = @as(u32, 0);
pub const TA_UPDATECP = @as(u32, 1);
pub const TA_LEFT = @as(u32, 0);
pub const TA_RIGHT = @as(u32, 2);
pub const TA_CENTER = @as(u32, 6);
pub const TA_RTLREADING = @as(u32, 256);
...
pub const PS_USERSTYLE = @as(u32, 7);
pub const PS_ALTERNATE = @as(u32, 8);
pub const PS_STYLE_MASK = @as(u32, 15);
pub const PS_ENDCAP_ROUND = @as(u32, 0);
pub const PS_ENDCAP_SQUARE = @as(u32, 256);
pub const PS_ENDCAP_FLAT = @as(u32, 512);
pub const PS_ENDCAP_MASK = @as(u32, 3840);
pub const PS_JOIN_ROUND = @as(u32, 0);
pub const PS_JOIN_BEVEL = @as(u32, 4096);
pub const PS_JOIN_MITER = @as(u32, 8192);
pub const PS_JOIN_MASK = @as(u32, 61440);
pub const PS_TYPE_MASK = @as(u32, 983040);
pub const TECHNOLOGY = @as(u32, 2);
pub const HORZSIZE = @as(u32, 4);
pub const VERTSIZE = @as(u32, 6);
pub const HORZRES = @as(u32, 8);
pub const VERTRES = @as(u32, 10);
pub const BITSPIXEL = @as(u32, 12);
pub const PLANES = @as(u32, 14);
pub const NUMBRUSHES = @as(u32, 16);
pub const NUMPENS = @as(u32, 18);
pub const NUMMARKERS = @as(u32, 20);
pub const NUMFONTS = @as(u32, 22);
pub const NUMCOLORS = @as(u32, 24);
pub const PDEVICESIZE = @as(u32, 26);
pub const CURVECAPS = @as(u32, 28);
pub const LINECAPS = @as(u32, 30);
pub const POLYGONALCAPS = @as(u32, 32);
pub const TEXTCAPS = @as(u32, 34);
pub const CLIPCAPS = @as(u32, 36);
pub const RASTERCAPS = @as(u32, 38);
pub const ASPECTX = @as(u32, 40);
pub const ASPECTY = @as(u32, 42);
pub const ASPECTXY = @as(u32, 44);
pub const LOGPIXELSX = @as(u32, 88);
pub const LOGPIXELSY = @as(u32, 90);
pub const SIZEPALETTE = @as(u32, 104);
pub const NUMRESERVED = @as(u32, 106);
pub const COLORRES = @as(u32, 108);
pub const PHYSICALWIDTH = @as(u32, 110);
pub const PHYSICALHEIGHT = @as(u32, 111);
pub const PHYSICALOFFSETX = @as(u32, 112);
pub const PHYSICALOFFSETY = @as(u32, 113);
pub const SCALINGFACTORX = @as(u32, 114);
pub const SCALINGFACTORY = @as(u32, 115);
pub const VREFRESH = @as(u32, 116);
pub const DESKTOPVERTRES = @as(u32, 117);
pub const DESKTOPHORZRES = @as(u32, 118);
pub const BLTALIGNMENT = @as(u32, 119);
pub const SHADEBLENDCAPS = @as(u32, 120);
pub const COLORMGMTCAPS = @as(u32, 121);
...
pub const DISPLAYCONFIG_PATH_VALID_FLAGS = @as(u32, 13);
...
pub const GetCurrentObject_typeFlags = extern enum(u32) {
    BITMAP = 7,
    BRUSH = 2,
    COLORSPACE = 14,
    FONT = 6,
...
// TODO: enum 'GetCurrentObject_typeFlags' has known issues with its value aliases
...
pub const SetROP2_rop2Flags = extern enum(u32) {
    BLACK = 1,
    COPYPEN = 13,
    MASKNOTPEN = 3,
    MASKPEN = 9,
...
// TODO: enum 'SetROP2_rop2Flags' has known issues with its value aliases
...
test {
    ...
    const constant_export_count = 1266;
