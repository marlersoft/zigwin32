...
pub const WMDM_DEVICE_PROTOCOL_MTP = @import("../zig.zig").Guid.initString("979e54e5-0afc-4604-8d93-dc798a4bcf45");
pub const WMDM_DEVICE_PROTOCOL_RAPI = @import("../zig.zig").Guid.initString("2a11ed91-8c8f-41e4-82d1-8386e003561c");
pub const WMDM_DEVICE_PROTOCOL_MSC = @import("../zig.zig").Guid.initString("a4d2c26c-a881-44bb-bd5d-1f703c71f7a9");
pub const WMDM_SERVICE_PROVIDER_VENDOR_MICROSOFT = @import("../zig.zig").Guid.initString("7de8686d-78ee-43ea-a496-c625ac91cc5d");
...
pub const SCP_EVENTID_ACQSECURECLOCK = @import("../zig.zig").Guid.initString("86248cc9-4a59-43e2-9146-48a7f3f4140c");
pub const SCP_EVENTID_NEEDTOINDIV = @import("../zig.zig").Guid.initString("87a507c7-b469-4386-b976-d5d1ce538a6f");
pub const SCP_EVENTID_DRMINFO = @import("../zig.zig").Guid.initString("213dd287-41d2-432b-9e3f-3b4f7b3581dd");
pub const SCP_PARAMID_DRMVERSION = @import("../zig.zig").Guid.initString("41d0155d-7cc7-4217-ada9-005074624da4");
