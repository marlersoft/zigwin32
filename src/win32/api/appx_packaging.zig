...
pub const APPX_CAPABILITY_INTERNET_CLIENT = APPX_CAPABILITIES.APPX_CAPABILITY_INTERNET_CLIENT;
pub const APPX_CAPABILITY_INTERNET_CLIENT_SERVER = APPX_CAPABILITIES.APPX_CAPABILITY_INTERNET_CLIENT_SERVER;
pub const APPX_CAPABILITY_PRIVATE_NETWORK_CLIENT_SERVER = APPX_CAPABILITIES.APPX_CAPABILITY_PRIVATE_NETWORK_CLIENT_SERVER;
pub const APPX_CAPABILITY_DOCUMENTS_LIBRARY = APPX_CAPABILITIES.APPX_CAPABILITY_DOCUMENTS_LIBRARY;
pub const APPX_CAPABILITY_PICTURES_LIBRARY = APPX_CAPABILITIES.APPX_CAPABILITY_PICTURES_LIBRARY;
pub const APPX_CAPABILITY_VIDEOS_LIBRARY = APPX_CAPABILITIES.APPX_CAPABILITY_VIDEOS_LIBRARY;
pub const APPX_CAPABILITY_MUSIC_LIBRARY = APPX_CAPABILITIES.APPX_CAPABILITY_MUSIC_LIBRARY;
pub const APPX_CAPABILITY_ENTERPRISE_AUTHENTICATION = APPX_CAPABILITIES.APPX_CAPABILITY_ENTERPRISE_AUTHENTICATION;
pub const APPX_CAPABILITY_SHARED_USER_CERTIFICATES = APPX_CAPABILITIES.APPX_CAPABILITY_SHARED_USER_CERTIFICATES;
pub const APPX_CAPABILITY_REMOVABLE_STORAGE = APPX_CAPABILITIES.APPX_CAPABILITY_REMOVABLE_STORAGE;
pub const APPX_CAPABILITY_APPOINTMENTS = APPX_CAPABILITIES.APPX_CAPABILITY_APPOINTMENTS;
pub const APPX_CAPABILITY_CONTACTS = APPX_CAPABILITIES.APPX_CAPABILITY_CONTACTS;
...
pub const DX_FEATURE_LEVEL_9 = DX_FEATURE_LEVEL._9;
pub const DX_FEATURE_LEVEL_10 = DX_FEATURE_LEVEL._10;
pub const DX_FEATURE_LEVEL_11 = DX_FEATURE_LEVEL._11;
...
pub const APPX_CAPABILITY_CLASS_DEFAULT = APPX_CAPABILITY_CLASS_TYPE.APPX_CAPABILITY_CLASS_DEFAULT;
pub const APPX_CAPABILITY_CLASS_GENERAL = APPX_CAPABILITY_CLASS_TYPE.APPX_CAPABILITY_CLASS_GENERAL;
pub const APPX_CAPABILITY_CLASS_RESTRICTED = APPX_CAPABILITY_CLASS_TYPE.APPX_CAPABILITY_CLASS_RESTRICTED;
pub const APPX_CAPABILITY_CLASS_WINDOWS = APPX_CAPABILITY_CLASS_TYPE.APPX_CAPABILITY_CLASS_WINDOWS;
pub const APPX_CAPABILITY_CLASS_ALL = APPX_CAPABILITY_CLASS_TYPE.APPX_CAPABILITY_CLASS_ALL;
pub const APPX_CAPABILITY_CLASS_CUSTOM = APPX_CAPABILITY_CLASS_TYPE.APPX_CAPABILITY_CLASS_CUSTOM;
...
pub const APPX_ENCRYPTED_PACKAGE_OPTION_NONE = APPX_ENCRYPTED_PACKAGE_OPTIONS.APPX_ENCRYPTED_PACKAGE_OPTION_NONE;
pub const APPX_ENCRYPTED_PACKAGE_OPTION_DIFFUSION = APPX_ENCRYPTED_PACKAGE_OPTIONS.APPX_ENCRYPTED_PACKAGE_OPTION_DIFFUSION;
pub const APPX_ENCRYPTED_PACKAGE_OPTION_PAGE_HASHING = APPX_ENCRYPTED_PACKAGE_OPTIONS.APPX_ENCRYPTED_PACKAGE_OPTION_PAGE_HASHING;
...
pub const APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_OPTION_APPEND_DELTA = APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_OPTION.APPEND_DELTA;
...
pub const APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTION_NONE = APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS.APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTION_NONE;
pub const APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTION_SKIP_VALIDATION = APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS.APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTION_SKIP_VALIDATION;
pub const APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTION_LOCALIZED = APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS.APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTION_LOCALIZED;
