...
pub const ServiceAccountPasswordGUID = @import("../zig.zig").Guid.initString("262e99c9-6160-4871-acec-4e61736b6f21");
...
pub const CREATE_COMPRESS_NETWORK_TRAFFIC : u32 = 128;
