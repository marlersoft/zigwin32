...
pub const TASK_TIME_TRIGGER_ONCE = TASK_TRIGGER_TYPE.TASK_TIME_TRIGGER_ONCE;
pub const TASK_TIME_TRIGGER_DAILY = TASK_TRIGGER_TYPE.TASK_TIME_TRIGGER_DAILY;
pub const TASK_TIME_TRIGGER_WEEKLY = TASK_TRIGGER_TYPE.TASK_TIME_TRIGGER_WEEKLY;
pub const TASK_TIME_TRIGGER_MONTHLYDATE = TASK_TRIGGER_TYPE.TASK_TIME_TRIGGER_MONTHLYDATE;
pub const TASK_TIME_TRIGGER_MONTHLYDOW = TASK_TRIGGER_TYPE.TASK_TIME_TRIGGER_MONTHLYDOW;
pub const TASK_EVENT_TRIGGER_ON_IDLE = TASK_TRIGGER_TYPE.TASK_EVENT_TRIGGER_ON_IDLE;
pub const TASK_EVENT_TRIGGER_AT_SYSTEMSTART = TASK_TRIGGER_TYPE.TASK_EVENT_TRIGGER_AT_SYSTEMSTART;
pub const TASK_EVENT_TRIGGER_AT_LOGON = TASK_TRIGGER_TYPE.TASK_EVENT_TRIGGER_AT_LOGON;
...
pub const TASK_RUN_NO_FLAGS = TASK_RUN_FLAGS.TASK_RUN_NO_FLAGS;
pub const TASK_RUN_AS_SELF = TASK_RUN_FLAGS.TASK_RUN_AS_SELF;
pub const TASK_RUN_IGNORE_CONSTRAINTS = TASK_RUN_FLAGS.TASK_RUN_IGNORE_CONSTRAINTS;
pub const TASK_RUN_USE_SESSION_ID = TASK_RUN_FLAGS.TASK_RUN_USE_SESSION_ID;
pub const TASK_RUN_USER_SID = TASK_RUN_FLAGS.TASK_RUN_USER_SID;

pub const TASK_ENUM_FLAGS = extern enum(i32) {
    TASK_ENUM_HIDDEN = 1,
};
pub const TASK_ENUM_HIDDEN = TASK_ENUM_FLAGS.TASK_ENUM_HIDDEN;
...
pub const TASK_LOGON_NONE = TASK_LOGON_TYPE.TASK_LOGON_NONE;
pub const TASK_LOGON_PASSWORD = TASK_LOGON_TYPE.TASK_LOGON_PASSWORD;
pub const TASK_LOGON_S4U = TASK_LOGON_TYPE.TASK_LOGON_S4U;
pub const TASK_LOGON_INTERACTIVE_TOKEN = TASK_LOGON_TYPE.TASK_LOGON_INTERACTIVE_TOKEN;
pub const TASK_LOGON_GROUP = TASK_LOGON_TYPE.TASK_LOGON_GROUP;
pub const TASK_LOGON_SERVICE_ACCOUNT = TASK_LOGON_TYPE.TASK_LOGON_SERVICE_ACCOUNT;
pub const TASK_LOGON_INTERACTIVE_TOKEN_OR_PASSWORD = TASK_LOGON_TYPE.TASK_LOGON_INTERACTIVE_TOKEN_OR_PASSWORD;

pub const TASK_RUNLEVEL_TYPE = extern enum(i32) {
    TASK_RUNLEVEL_LUA = 0,
    TASK_RUNLEVEL_HIGHEST = 1,
};
pub const TASK_RUNLEVEL_LUA = TASK_RUNLEVEL_TYPE.TASK_RUNLEVEL_LUA;
pub const TASK_RUNLEVEL_HIGHEST = TASK_RUNLEVEL_TYPE.TASK_RUNLEVEL_HIGHEST;
...
pub const TASK_PROCESSTOKENSID_NONE = TASK_PROCESSTOKENSID_TYPE.TASK_PROCESSTOKENSID_NONE;
pub const TASK_PROCESSTOKENSID_UNRESTRICTED = TASK_PROCESSTOKENSID_TYPE.TASK_PROCESSTOKENSID_UNRESTRICTED;
pub const TASK_PROCESSTOKENSID_DEFAULT = TASK_PROCESSTOKENSID_TYPE.TASK_PROCESSTOKENSID_DEFAULT;
...
pub const TASK_VALIDATE_ONLY = TASK_CREATION.TASK_VALIDATE_ONLY;
pub const TASK_CREATE = TASK_CREATION.TASK_CREATE;
pub const TASK_UPDATE = TASK_CREATION.TASK_UPDATE;
pub const TASK_CREATE_OR_UPDATE = TASK_CREATION.TASK_CREATE_OR_UPDATE;
pub const TASK_DISABLE = TASK_CREATION.TASK_DISABLE;
pub const TASK_DONT_ADD_PRINCIPAL_ACE = TASK_CREATION.TASK_DONT_ADD_PRINCIPAL_ACE;
pub const TASK_IGNORE_REGISTRATION_TRIGGERS = TASK_CREATION.TASK_IGNORE_REGISTRATION_TRIGGERS;
...
pub const TASK_TRIGGER_EVENT = TASK_TRIGGER_TYPE2.TASK_TRIGGER_EVENT;
pub const TASK_TRIGGER_TIME = TASK_TRIGGER_TYPE2.TASK_TRIGGER_TIME;
pub const TASK_TRIGGER_DAILY = TASK_TRIGGER_TYPE2.TASK_TRIGGER_DAILY;
pub const TASK_TRIGGER_WEEKLY = TASK_TRIGGER_TYPE2.TASK_TRIGGER_WEEKLY;
pub const TASK_TRIGGER_MONTHLY = TASK_TRIGGER_TYPE2.TASK_TRIGGER_MONTHLY;
pub const TASK_TRIGGER_MONTHLYDOW = TASK_TRIGGER_TYPE2.TASK_TRIGGER_MONTHLYDOW;
pub const TASK_TRIGGER_IDLE = TASK_TRIGGER_TYPE2.TASK_TRIGGER_IDLE;
pub const TASK_TRIGGER_REGISTRATION = TASK_TRIGGER_TYPE2.TASK_TRIGGER_REGISTRATION;
pub const TASK_TRIGGER_BOOT = TASK_TRIGGER_TYPE2.TASK_TRIGGER_BOOT;
pub const TASK_TRIGGER_LOGON = TASK_TRIGGER_TYPE2.TASK_TRIGGER_LOGON;
pub const TASK_TRIGGER_SESSION_STATE_CHANGE = TASK_TRIGGER_TYPE2.TASK_TRIGGER_SESSION_STATE_CHANGE;
pub const TASK_TRIGGER_CUSTOM_TRIGGER_01 = TASK_TRIGGER_TYPE2.TASK_TRIGGER_CUSTOM_TRIGGER_01;
...
pub const TASK_CONSOLE_CONNECT = TASK_SESSION_STATE_CHANGE_TYPE.TASK_CONSOLE_CONNECT;
pub const TASK_CONSOLE_DISCONNECT = TASK_SESSION_STATE_CHANGE_TYPE.TASK_CONSOLE_DISCONNECT;
pub const TASK_REMOTE_CONNECT = TASK_SESSION_STATE_CHANGE_TYPE.TASK_REMOTE_CONNECT;
pub const TASK_REMOTE_DISCONNECT = TASK_SESSION_STATE_CHANGE_TYPE.TASK_REMOTE_DISCONNECT;
pub const TASK_SESSION_LOCK = TASK_SESSION_STATE_CHANGE_TYPE.TASK_SESSION_LOCK;
pub const TASK_SESSION_UNLOCK = TASK_SESSION_STATE_CHANGE_TYPE.TASK_SESSION_UNLOCK;
...
pub const TASK_ACTION_EXEC = TASK_ACTION_TYPE.TASK_ACTION_EXEC;
pub const TASK_ACTION_COM_HANDLER = TASK_ACTION_TYPE.TASK_ACTION_COM_HANDLER;
pub const TASK_ACTION_SEND_EMAIL = TASK_ACTION_TYPE.TASK_ACTION_SEND_EMAIL;
pub const TASK_ACTION_SHOW_MESSAGE = TASK_ACTION_TYPE.TASK_ACTION_SHOW_MESSAGE;
...
pub const TASK_INSTANCES_PARALLEL = TASK_INSTANCES_POLICY.TASK_INSTANCES_PARALLEL;
pub const TASK_INSTANCES_QUEUE = TASK_INSTANCES_POLICY.TASK_INSTANCES_QUEUE;
pub const TASK_INSTANCES_IGNORE_NEW = TASK_INSTANCES_POLICY.TASK_INSTANCES_IGNORE_NEW;
pub const TASK_INSTANCES_STOP_EXISTING = TASK_INSTANCES_POLICY.TASK_INSTANCES_STOP_EXISTING;
...
pub const ISessionStateChangeTrigger = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn ISessionStateChangeTrigger_put_StateChange(self: *const T, type: TASK_SESSION_STATE_CHANGE_TYPE) callconv(.Inline) HRESULT {
            return @ptrCast(*const ISessionStateChangeTrigger.VTable, self.vtable).put_StateChange(@ptrCast(*const ISessionStateChangeTrigger, self), type);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const ITriggerCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn ITriggerCollection_Create(self: *const T, type: TASK_TRIGGER_TYPE2, ppTrigger: **ITrigger) callconv(.Inline) HRESULT {
            return @ptrCast(*const ITriggerCollection.VTable, self.vtable).Create(@ptrCast(*const ITriggerCollection, self), type, ppTrigger);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const IActionCollection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        pub fn IActionCollection_Create(self: *const T, type: TASK_ACTION_TYPE, ppAction: **IAction) callconv(.Inline) HRESULT {
            return @ptrCast(*const IActionCollection.VTable, self.vtable).Create(@ptrCast(*const IActionCollection, self), type, ppAction);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
