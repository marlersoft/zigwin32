...
pub const PxeProviderSetAttribute_pParameterBufferFlags = extern enum(u32) {
    ALL = 0,
    DHCP_ONLY = 1,
    PXE_ONLY = 2,
};
pub const PXE_PROV_FILTER_ALL = PxeProviderSetAttribute_pParameterBufferFlags.ALL;
pub const PXE_PROV_FILTER_DHCP_ONLY = PxeProviderSetAttribute_pParameterBufferFlags.DHCP_ONLY;
pub const PXE_PROV_FILTER_PXE_ONLY = PxeProviderSetAttribute_pParameterBufferFlags.PXE_ONLY;

pub const WdsBpInitialize_bPacketTypeFlags = extern enum(u32) {
    WDSNBP = 2,
    BCD = 4,
    DHCPV6 = 8,
};
pub const WDSBP_PK_TYPE_WDSNBP = WdsBpInitialize_bPacketTypeFlags.WDSNBP;
pub const WDSBP_PK_TYPE_BCD = WdsBpInitialize_bPacketTypeFlags.BCD;
pub const WDSBP_PK_TYPE_DHCPV6 = WdsBpInitialize_bPacketTypeFlags.DHCPV6;

pub const PFN_WdsCliCallback_dwMessageIdFlags = extern enum(u32) {
    START = 0,
    COMPLETE = 1,
    PROGRESS = 2,
    TEXT = 3,
};
// TODO: enum 'PFN_WdsCliCallback_dwMessageIdFlags' has known issues with its value aliases

pub const WDS_TRANSPORTCLIENT_REQUEST_ulAuthLevelFlags = extern enum(u32) {
    AUTH = 1,
    NO_AUTH = 2,
};
pub const WDS_TRANSPORTCLIENT_AUTH = WDS_TRANSPORTCLIENT_REQUEST_ulAuthLevelFlags.AUTH;
pub const WDS_TRANSPORTCLIENT_NO_AUTH = WDS_TRANSPORTCLIENT_REQUEST_ulAuthLevelFlags.NO_AUTH;
...
pub const PFN_WdsCliCallback = fn(
    dwMessageId: PFN_WdsCliCallback_dwMessageIdFlags,
    wParam: WPARAM,
    lParam: LPARAM,
    pvUserData: ?*c_void,
) callconv(@import("std").os.windows.WINAPI) void;
...
pub const WDS_TRANSPORTCLIENT_REQUEST = extern struct {
    ulLength: u32,
    ulApiVersion: u32,
    ulAuthLevel: WDS_TRANSPORTCLIENT_REQUEST_ulAuthLevelFlags,
...
pub extern "WDSBP" fn WdsBpInitialize(
    bPacketType: WdsBpInitialize_bPacketTypeFlags,
    phHandle: *HANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
...
test {
    ...
    const type_export_count = 70;
    const enum_value_export_count = 81;
