...
pub const ISpRecoGrammar = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ISpRecoGrammar_LoadCmdFromResource(self: *const T, hModule: isize, pszResourceName: [*:0]const u16, pszResourceType: [*:0]const u16, wLanguage: u16, Options: SPLOADOPTIONS) callconv(.Inline) HRESULT {
...
const IInternetSecurityManager = @import("com.zig").IInternetSecurityManager;
