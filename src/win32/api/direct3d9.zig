...
pub const D3DAUTHENTICATEDQUERY_PROTECTION = @import("../zig.zig").Guid.initString("a84eb584-c495-48aa-b94d-8bd2d6fbce05");
pub const D3DAUTHENTICATEDQUERY_CHANNELTYPE = @import("../zig.zig").Guid.initString("bc1b18a5-b1fb-42ab-bd94-b5828b4bf7be");
pub const D3DAUTHENTICATEDQUERY_DEVICEHANDLE = @import("../zig.zig").Guid.initString("ec1c539d-8cff-4e2a-bcc4-f5692f99f480");
pub const D3DAUTHENTICATEDQUERY_CRYPTOSESSION = @import("../zig.zig").Guid.initString("2634499e-d018-4d74-ac17-7f724059528d");
pub const D3DAUTHENTICATEDQUERY_RESTRICTEDSHAREDRESOURCEPROCESSCOUNT = @import("../zig.zig").Guid.initString("0db207b3-9450-46a6-82de-1b96d44f9cf2");
pub const D3DAUTHENTICATEDQUERY_RESTRICTEDSHAREDRESOURCEPROCESS = @import("../zig.zig").Guid.initString("649bbadb-f0f4-4639-a15b-24393fc3abac");
pub const D3DAUTHENTICATEDQUERY_UNRESTRICTEDPROTECTEDSHAREDRESOURCECOUNT = @import("../zig.zig").Guid.initString("012f0bd6-e662-4474-befd-aa53e5143c6d");
pub const D3DAUTHENTICATEDQUERY_OUTPUTIDCOUNT = @import("../zig.zig").Guid.initString("2c042b5e-8c07-46d5-aabe-8f75cbad4c31");
pub const D3DAUTHENTICATEDQUERY_OUTPUTID = @import("../zig.zig").Guid.initString("839ddca3-9b4e-41e4-b053-892bd2a11ee7");
pub const D3DAUTHENTICATEDQUERY_ACCESSIBILITYATTRIBUTES = @import("../zig.zig").Guid.initString("6214d9d2-432c-4abb-9fce-216eea269e3b");
pub const D3DAUTHENTICATEDQUERY_ENCRYPTIONWHENACCESSIBLEGUIDCOUNT = @import("../zig.zig").Guid.initString("b30f7066-203c-4b07-93fc-ceaafd61241e");
pub const D3DAUTHENTICATEDQUERY_ENCRYPTIONWHENACCESSIBLEGUID = @import("../zig.zig").Guid.initString("f83a5958-e986-4bda-beb0-411f6a7a01b7");
pub const D3DAUTHENTICATEDQUERY_CURRENTENCRYPTIONWHENACCESSIBLE = @import("../zig.zig").Guid.initString("ec1791c7-dad3-4f15-9ec3-faa93d60d4f0");
pub const D3DAUTHENTICATEDCONFIGURE_INITIALIZE = @import("../zig.zig").Guid.initString("06114bdb-3523-470a-8dca-fbc2845154f0");
pub const D3DAUTHENTICATEDCONFIGURE_PROTECTION = @import("../zig.zig").Guid.initString("50455658-3f47-4362-bf99-bfdfcde9ed29");
pub const D3DAUTHENTICATEDCONFIGURE_CRYPTOSESSION = @import("../zig.zig").Guid.initString("6346cc54-2cfc-4ad4-8224-d15837de7700");
pub const D3DAUTHENTICATEDCONFIGURE_SHAREDRESOURCE = @import("../zig.zig").Guid.initString("0772d047-1b40-48e8-9ca6-b5f510de9f01");
pub const D3DAUTHENTICATEDCONFIGURE_ENCRYPTIONWHENACCESSIBLE = @import("../zig.zig").Guid.initString("41fff286-6ae0-4d43-9d55-a46e9efd158a");
...
pub const D3DCRYPTOTYPE_AES128_CTR = @import("../zig.zig").Guid.initString("9b6bd711-4f74-41c9-9e7b-0be2d7d93b4f");
pub const D3DCRYPTOTYPE_PROPRIETARY = @import("../zig.zig").Guid.initString("ab4e9afd-1d1c-46e6-a72f-0869917b0de8");
pub const D3DKEYEXCHANGE_RSAES_OAEP = @import("../zig.zig").Guid.initString("c1949895-d72a-4a1d-8e5d-ed857d171520");
pub const D3DKEYEXCHANGE_DXVA = @import("../zig.zig").Guid.initString("43d3775c-38e5-4924-8d86-d3fccf153e9b");
