...
pub const PARAFORMAT = extern struct {
    ...
    dxRightIndent: i32,
    dxOffset: i32,
    wAlignment: PARAFORMAT_wAlignmentFlags,
    cTabCount: i16,
    rgxTabs: [32]u32,
    const _Anonymous_e__Union = u32; // TODO: generate this nested type!
};
...
pub const NMHEADERA_iButton = extern enum(u32) {
    None = 0,
    @"1" = 1,
    @"2" = 2,
};
pub const iButton1 = NMHEADERA_iButton.@"1";
pub const iButton2 = NMHEADERA_iButton.@"2";
...
pub const CheckDlgButton_uCheck = extern enum(u32) {
    CHECKED = 1,
    INDETERMINATE = 2,
    UNCHECKED = 0,
};
pub const BST_CHECKED = CheckDlgButton_uCheck.CHECKED;
pub const BST_INDETERMINATE = CheckDlgButton_uCheck.INDETERMINATE;
pub const BST_UNCHECKED = CheckDlgButton_uCheck.UNCHECKED;
...
// TODO: This Enum is marked as [Flags], what do I do with this?
pub const SCROLLINFO_fMaskFlags = extern enum(u32) {
    ALL = 23,
    DISABLENOSCROLL = 8,
    PAGE = 2,
    POS = 4,
...
pub const SIF_ALL = SCROLLINFO_fMaskFlags.ALL;
pub const SIF_DISABLENOSCROLL = SCROLLINFO_fMaskFlags.DISABLENOSCROLL;
pub const SIF_PAGE = SCROLLINFO_fMaskFlags.PAGE;
pub const SIF_POS = SCROLLINFO_fMaskFlags.POS;
pub const SIF_RANGE = SCROLLINFO_fMaskFlags.RANGE;
pub const SIF_TRACKPOS = SCROLLINFO_fMaskFlags.TRACKPOS;
...
pub const PARAFORMAT_wAlignmentFlags = extern enum(u32) {
    CENTER = 3,
    LEFT = 1,
    RIGHT = 2,
};
pub const PFA_CENTER = PARAFORMAT_wAlignmentFlags.CENTER;
pub const PFA_LEFT = PARAFORMAT_wAlignmentFlags.LEFT;
pub const PFA_RIGHT = PARAFORMAT_wAlignmentFlags.RIGHT;
...
test {
    ...
    const constant_export_count = 2038;
    const type_export_count = 425;
