...
//--------------------------------------------------------------------------------
// Section: Constants (1158)
//--------------------------------------------------------------------------------
pub const TVI_ROOT : i32 = -65536;
pub const TVI_FIRST : i32 = -65535;
pub const TVI_LAST : i32 = -65534;
pub const TVI_SORT : i32 = -65533;
...
pub const PSH_WIZARD97 : u32 = 8192;
...
pub const BOM_DEFPARADIR : u32 = 1;
pub const BOM_PLAINTEXT : u32 = 2;
...
pub const BOE_RTLDIR : u32 = 1;
pub const BOE_PLAINTEXT : u32 = 2;
...
pub const INITCOMMONCONTROLSEX = extern struct {
    dwSize: u32,
    dwICC: INITCOMMONCONTROLSEX_dwICCFlags,
};
...
pub const IMAGELISTDRAWPARAMS = extern struct {
    ...
    xBitmap: i32,
    yBitmap: i32,
    rgbBk: ImageListDrawEx_rgbFg,
    rgbFg: ImageListDrawEx_rgbFg,
    fStyle: u32,
    dwRop: u32,
    fState: u32,
    Frame: u32,
...
pub const LVTILEVIEWINFO = extern struct {
    cbSize: u32,
    dwMask: u32,
    dwFlags: LVTILEVIEWINFO_dwFlags,
    sizeTile: SIZE,
    cLines: i32,
    rcLabelMargin: RECT,
};
...
pub const NMLVCUSTOMDRAW = extern struct {
    ...
    clrTextBk: u32,
    iSubItem: i32,
    dwItemType: NMLVCUSTOMDRAW_dwItemTypeFlags,
    clrFace: u32,
    iIconEffect: i32,
    iIconPhase: i32,
    iPartId: i32,
    iStateId: i32,
    rcText: RECT,
    uAlign: NMLVCUSTOMDRAW_uAlignFlags,
};
...
pub const NMLVEMPTYMARKUP = extern struct {
    hdr: NMHDR,
    dwFlags: NMLVEMPTYMARKUP_dwFlags,
    szMarkup: [2084]u16,
};
...
pub const MCGRIDINFO = extern struct {
    cbSize: u32,
    dwPart: MCGRIDINFO_dwPartFlags,
    dwFlags: MCGRIDINFO_dwFlags,
    iCalendar: i32,
    iRow: i32,
    iCol: i32,
    bSelected: BOOL,
...
pub const NMPGSCROLL = extern struct {
    hdr: NMHDR,
    fwKeys: NMPGSCROLL_fwKeysFlags,
    rcParent: RECT,
    iDir: NMPGSCROLL_iDirFlags,
    iXpos: i32,
    iYpos: i32,
    iScroll: i32,
};
...
pub const NMPGCALCSIZE = extern struct {
    hdr: NMHDR,
    dwFlag: NMPGCALCSIZE_dwFlagFlags,
    iWidth: i32,
    iHeight: i32,
};
...
pub const BUTTON_IMAGELIST = extern struct {
    himl: HIMAGELIST,
    margin: RECT,
    uAlign: BUTTON_IMAGELIST_uAlignFlags,
};
...
pub const EDITBALLOONTIP = extern struct {
    ...
    pszTitle: [*:0]const u16,
    pszText: [*:0]const u16,
    ttiIcon: EDITBALLOONTIP_ttiIconFlags,
};
...
pub const IImageList = extern struct {
    pub const VTable = extern struct {
        ...
        GetItemFlags: fn(
            self: *const IImageList,
            i: i32,
            dwFlags: *IImageList_GetItemFlagsFlags,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetOverlayImage: fn(
            self: *const IImageList,
            iOverlay: i32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IImageList_GetItemFlags(self: *const T, i: i32, dwFlags: *IImageList_GetItemFlagsFlags) callconv(.Inline) HRESULT {
...
pub const ENDCOMPOSITIONNOTIFY = extern struct {
    nmhdr: NMHDR,
    dwCode: ENDCOMPOSITIONNOTIFY_dwCodeFlags,
};
...
pub const PARAFORMAT = extern struct {
    ...
    dxRightIndent: i32,
    dxOffset: i32,
    wAlignment: PARAFORMAT2_wAlignmentFlags,
    cTabCount: i16,
    rgxTabs: [32]u32,
    const _Anonymous_e__Union = u32; // TODO: generate this nested type!
};
...
pub const PARAFORMAT2 = extern struct {
    ...
    dyLineSpacing: i32,
    sStyle: i16,
    bLineSpacingRule: PARAFORMAT2_bLineSpacingRuleFlags,
    bOutlineLevel: u8,
    wShadingWeight: u16,
    wShadingStyle: PARAFORMAT2_wShadingStyleFlags,
    wNumberingStart: u16,
    wNumberingStyle: PARAFORMAT2_wNumberingStyleFlags,
    wNumberingTab: u16,
    wBorderSpace: u16,
    wBorderWidth: u16,
    wBorders: PARAFORMAT2_wBordersFlags,
};
...
pub const SELCHANGE = extern struct {
    nmhdr: NMHDR,
    chrg: CHARRANGE,
    seltyp: IRichEditOleCallback_GetContextMenu_seltypeFlags,
};
...
pub const ITextRange2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextRange2_InsertImage(self: *const T, width: i32, height: i32, ascent: i32, Type: InsertImage_Type, bstrAltText: BSTR, pStream: ?*IStream) callconv(.Inline) HRESULT {
...
pub const IRichEditOle = extern struct {
    pub const VTable = extern struct {
        ...
        GetObject: fn(
            ...
            iob: i32,
            lpreobject: *REOBJECT,
            dwFlags: IRichEditOle_GetObjectFlags,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        InsertObject: fn(
            self: *const IRichEditOle,
            lpreobject: *REOBJECT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRichEditOle_GetObject(self: *const T, iob: i32, lpreobject: *REOBJECT, dwFlags: IRichEditOle_GetObjectFlags) callconv(.Inline) HRESULT {
...
pub const IRichEditOleCallback = extern struct {
    pub const VTable = extern struct {
        ...
        GetContextMenu: fn(
            self: *const IRichEditOleCallback,
            seltype: IRichEditOleCallback_GetContextMenu_seltypeFlags,
            lpoleobj: *IOleObject,
            lpchrg: *CHARRANGE,
            lphmenu: *HMENU,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IRichEditOleCallback_GetContextMenu(self: *const T, seltype: IRichEditOleCallback_GetContextMenu_seltypeFlags, lpoleobj: *IOleObject, lpchrg: *CHARRANGE, lphmenu: *HMENU) callconv(.Inline) HRESULT {
...
pub const ITextHost = extern struct {
    pub const VTable = extern struct {
        ...
        TxEnableScrollBar: fn(
            ...
            fuArrowflags: EnableScrollBar_wArrows,
        ) callconv(@import("std").os.windows.WINAPI) BOOL,
        TxSetScrollRange: fn(
            self: *const ITextHost,
            fnBar: i32,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITextHost_TxEnableScrollBar(self: *const T, fuSBFlags: SCROLLBAR_CONSTANTS, fuArrowflags: EnableScrollBar_wArrows) callconv(.Inline) BOOL {
...
// TODO: This Enum is marked as [Flags], what do I do with this?
pub const PARAFORMAT2_EFFECTS = extern enum(u32) {
    DONOTHYPHEN = 64,
    KEEP = 2,
    KEEPNEXT = 4,
    NOLINENUMBER = 16,
    ...
    SIDEBYSIDE = 128,
    TABLE = 16384,
    TABLEROWDELIMITER = 4096,
    _,
};
pub const PFE_DONOTHYPHEN = PARAFORMAT2_EFFECTS.DONOTHYPHEN;
pub const PFE_KEEP = PARAFORMAT2_EFFECTS.KEEP;
pub const PFE_KEEPNEXT = PARAFORMAT2_EFFECTS.KEEPNEXT;
pub const PFE_NOLINENUMBER = PARAFORMAT2_EFFECTS.NOLINENUMBER;
pub const PFE_NOWIDOWCONTROL = PARAFORMAT2_EFFECTS.NOWIDOWCONTROL;
pub const PFE_PAGEBREAKBEFORE = PARAFORMAT2_EFFECTS.PAGEBREAKBEFORE;
pub const PFE_RTLPARA = PARAFORMAT2_EFFECTS.RTLPARA;
pub const PFE_SIDEBYSIDE = PARAFORMAT2_EFFECTS.SIDEBYSIDE;
pub const PFE_TABLE = PARAFORMAT2_EFFECTS.TABLE;
pub const PFE_TABLEROWDELIMITER = PARAFORMAT2_EFFECTS.TABLEROWDELIMITER;

pub const InsertImage_Type = extern enum(u32) {
    BASELINE = 24,
    BOTTOM = 8,
    TOP = 0,
};
pub const TA_BASELINE = InsertImage_Type.BASELINE;
pub const TA_BOTTOM = InsertImage_Type.BOTTOM;
pub const TA_TOP = InsertImage_Type.TOP;

pub const EDITWORDBREAKPROC_code = extern enum(u32) {
    CLASSIFY = 3,
    ISDELIMITER = 2,
    LEFT = 0,
    LEFTBREAK = 6,
...
pub const WB_CLASSIFY = EDITWORDBREAKPROC_code.CLASSIFY;
pub const WB_ISDELIMITER = EDITWORDBREAKPROC_code.ISDELIMITER;
pub const WB_LEFT = EDITWORDBREAKPROC_code.LEFT;
pub const WB_LEFTBREAK = EDITWORDBREAKPROC_code.LEFTBREAK;
pub const WB_MOVEWORDLEFT = EDITWORDBREAKPROC_code.MOVEWORDLEFT;
pub const WB_MOVEWORDRIGHT = EDITWORDBREAKPROC_code.MOVEWORDRIGHT;
pub const WB_RIGHT = EDITWORDBREAKPROC_code.RIGHT;
pub const WB_RIGHTBREAK = EDITWORDBREAKPROC_code.RIGHTBREAK;

pub const ListView_iImageList = extern enum(u32) {
    NORMAL = 0,
    SMALL = 1,
    STATE = 2,
    GROUPHEADER = 3,
};
pub const LVSIL_NORMAL = ListView_iImageList.NORMAL;
pub const LVSIL_SMALL = ListView_iImageList.SMALL;
pub const LVSIL_STATE = ListView_iImageList.STATE;
pub const LVSIL_GROUPHEADER = ListView_iImageList.GROUPHEADER;

pub const PFNDPAMERGE_uMsg = extern enum(u32) {
    MERGE = 1,
    DELETE = 2,
    INSERT = 3,
};
pub const DPAMM_MERGE = PFNDPAMERGE_uMsg.MERGE;
pub const DPAMM_DELETE = PFNDPAMERGE_uMsg.DELETE;
pub const DPAMM_INSERT = PFNDPAMERGE_uMsg.INSERT;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const ImageListLoadImage_uFlags = extern enum(u32) {
...
pub const LR_CREATEDIBSECTION = ImageListLoadImage_uFlags.CREATEDIBSECTION;
pub const LR_DEFAULTCOLOR = ImageListLoadImage_uFlags.DEFAULTCOLOR;
pub const LR_DEFAULTSIZE = ImageListLoadImage_uFlags.DEFAULTSIZE;
pub const LR_LOADFROMFILE = ImageListLoadImage_uFlags.LOADFROMFILE;
pub const LR_LOADMAP3DCOLORS = ImageListLoadImage_uFlags.LOADMAP3DCOLORS;
pub const LR_LOADTRANSPARENT = ImageListLoadImage_uFlags.LOADTRANSPARENT;
pub const LR_MONOCHROME = ImageListLoadImage_uFlags.MONOCHROME;
pub const LR_SHARED = ImageListLoadImage_uFlags.SHARED;
pub const LR_VGACOLOR = ImageListLoadImage_uFlags.VGACOLOR;
pub const LR_COPYDELETEORG = ImageListLoadImage_uFlags.COPYDELETEORG;
pub const LR_COPYFROMRESOURCE = ImageListLoadImage_uFlags.COPYFROMRESOURCE;
pub const LR_COPYRETURNORG = ImageListLoadImage_uFlags.COPYRETURNORG;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const DlgDirList_uFiletype = extern enum(u32) {
    ARCHIVE = 32,
    DIRECTORY = 16,
    DRIVES = 16384,
    EXCLUSIVE = 32768,
...
pub const DDL_ARCHIVE = DlgDirList_uFiletype.ARCHIVE;
pub const DDL_DIRECTORY = DlgDirList_uFiletype.DIRECTORY;
pub const DDL_DRIVES = DlgDirList_uFiletype.DRIVES;
pub const DDL_EXCLUSIVE = DlgDirList_uFiletype.EXCLUSIVE;
pub const DDL_HIDDEN = DlgDirList_uFiletype.HIDDEN;
pub const DDL_READONLY = DlgDirList_uFiletype.READONLY;
pub const DDL_READWRITE = DlgDirList_uFiletype.READWRITE;
pub const DDL_SYSTEM = DlgDirList_uFiletype.SYSTEM;
pub const DDL_POSTMSGS = DlgDirList_uFiletype.POSTMSGS;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const OpenThemeDataEx_dwFlags = extern enum(u32) {
    FORCE_RECT_SIZING = 1,
    NONCLIENT = 2,
    _,
};
pub const OTD_FORCE_RECT_SIZING = OpenThemeDataEx_dwFlags.FORCE_RECT_SIZING;
pub const OTD_NONCLIENT = OpenThemeDataEx_dwFlags.NONCLIENT;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const SetScrollInfo_lpsiFlags = extern enum(u32) {
    DISABLENOSCROLL = 8,
    PAGE = 2,
    POS = 4,
    RANGE = 1,
...
pub const SIF_DISABLENOSCROLL = SetScrollInfo_lpsiFlags.DISABLENOSCROLL;
pub const SIF_PAGE = SetScrollInfo_lpsiFlags.PAGE;
pub const SIF_POS = SetScrollInfo_lpsiFlags.POS;
pub const SIF_RANGE = SetScrollInfo_lpsiFlags.RANGE;
pub const SIF_TRACKPOS = SetScrollInfo_lpsiFlags.TRACKPOS;
pub const SIF_ALL = SetScrollInfo_lpsiFlags.ALL;

pub const GetThemeBitmap_dwFlags = extern enum(u32) {
    DIRECT = 1,
    COPY = 2,
    VALIDBITS = 3,
};
pub const GBF_DIRECT = GetThemeBitmap_dwFlags.DIRECT;
pub const GBF_COPY = GetThemeBitmap_dwFlags.COPY;
pub const GBF_VALIDBITS = GetThemeBitmap_dwFlags.VALIDBITS;

pub const ListView_Arrange_codeFlags = extern enum(u32) {
    ALIGNLEFT = 1,
    ALIGNTOP = 2,
    DEFAULT = 0,
    SNAPTOGRID = 5,
};
pub const LVA_ALIGNLEFT = ListView_Arrange_codeFlags.ALIGNLEFT;
pub const LVA_ALIGNTOP = ListView_Arrange_codeFlags.ALIGNTOP;
pub const LVA_DEFAULT = ListView_Arrange_codeFlags.DEFAULT;
pub const LVA_SNAPTOGRID = ListView_Arrange_codeFlags.SNAPTOGRID;

pub const DPA_SortedInsertPtr_optionsFlags = extern enum(u32) {
    BEFORE = 2,
    AFTER = 4,
};
pub const DPAS_INSERTBEFORE = DPA_SortedInsertPtr_optionsFlags.BEFORE;
pub const DPAS_INSERTAFTER = DPA_SortedInsertPtr_optionsFlags.AFTER;

pub const PropSheet_SetButtonText_dwButtonFlags = extern enum(u32) {
    BACK = 1,
    NEXT = 2,
    FINISH = 4,
    CANCEL = 16,
};
pub const PSWIZB_BACK = PropSheet_SetButtonText_dwButtonFlags.BACK;
pub const PSWIZB_NEXT = PropSheet_SetButtonText_dwButtonFlags.NEXT;
pub const PSWIZB_FINISH = PropSheet_SetButtonText_dwButtonFlags.FINISH;
pub const PSWIZB_CANCEL = PropSheet_SetButtonText_dwButtonFlags.CANCEL;

pub const EnableScrollBar_wArrows = extern enum(u32) {
    DISABLE_BOTH = 3,
    DISABLE_DOWN = 2,
    DISABLE_LEFT = 1,
    DISABLE_LTUP = 1,
...
pub const ESB_DISABLE_BOTH = EnableScrollBar_wArrows.DISABLE_BOTH;
pub const ESB_DISABLE_DOWN = EnableScrollBar_wArrows.DISABLE_DOWN;
pub const ESB_DISABLE_LEFT = EnableScrollBar_wArrows.DISABLE_LEFT;
pub const ESB_DISABLE_LTUP = EnableScrollBar_wArrows.DISABLE_LTUP;
pub const ESB_DISABLE_RIGHT = EnableScrollBar_wArrows.DISABLE_RIGHT;
pub const ESB_DISABLE_RTDN = EnableScrollBar_wArrows.DISABLE_RTDN;
pub const ESB_DISABLE_UP = EnableScrollBar_wArrows.DISABLE_UP;
pub const ESB_ENABLE_BOTH = EnableScrollBar_wArrows.ENABLE_BOTH;

pub const TreeView_iImage = extern enum(u32) {
    NORMAL = 0,
    STATE = 2,
};
pub const TVSIL_NORMAL = TreeView_iImage.NORMAL;
pub const TVSIL_STATE = TreeView_iImage.STATE;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const ImageListDraw_fStyle = extern enum(u32) {
    BLEND = 4,
    BLEND50 = 4,
    FOCUS = 2,
    MASK = 16,
...
pub const ILD_BLEND = ImageListDraw_fStyle.BLEND;
pub const ILD_BLEND50 = ImageListDraw_fStyle.BLEND50;
pub const ILD_FOCUS = ImageListDraw_fStyle.FOCUS;
pub const ILD_MASK = ImageListDraw_fStyle.MASK;
pub const ILD_NORMAL = ImageListDraw_fStyle.NORMAL;
pub const ILD_SELECTED = ImageListDraw_fStyle.SELECTED;
...
pub const LPFNPSPCALLBACK_uMsg = extern enum(u32) {
    ADDREF = 0,
    CREATE = 2,
    RELEASE = 1,
};
pub const PSPCB_ADDREF = LPFNPSPCALLBACK_uMsg.ADDREF;
pub const PSPCB_CREATE = LPFNPSPCALLBACK_uMsg.CREATE;
pub const PSPCB_RELEASE = LPFNPSPCALLBACK_uMsg.RELEASE;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const ListView_SetItemState_dataFlags = extern enum(u32) {
    CUT = 4,
    DROPHILITED = 8,
    FOCUSED = 1,
    SELECTED = 2,
...
pub const LVIS_CUT = ListView_SetItemState_dataFlags.CUT;
pub const LVIS_DROPHILITED = ListView_SetItemState_dataFlags.DROPHILITED;
pub const LVIS_FOCUSED = ListView_SetItemState_dataFlags.FOCUSED;
pub const LVIS_SELECTED = ListView_SetItemState_dataFlags.SELECTED;

pub const ImageList_CopyFlags = extern enum(u32) {
    MOVE = 0,
    SWAP = 1,
};
pub const ILCF_MOVE = ImageList_CopyFlags.MOVE;
pub const ILCF_SWAP = ImageList_CopyFlags.SWAP;

pub const Button_SetCheck_check = extern enum(u32) {
    CHECKED = 1,
    INDETERMINATE = 2,
    UNCHECKED = 0,
};
pub const BST_CHECKED = Button_SetCheck_check.CHECKED;
pub const BST_INDETERMINATE = Button_SetCheck_check.INDETERMINATE;
pub const BST_UNCHECKED = Button_SetCheck_check.UNCHECKED;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const DrawThemeParentBackgroundEx_dwFlags = extern enum(u32) {
    WINDOWDC = 1,
    USECTLCOLORSTATIC = 2,
    USEERASEBKGND = 4,
    _,
};
pub const DTPB_WINDOWDC = DrawThemeParentBackgroundEx_dwFlags.WINDOWDC;
pub const DTPB_USECTLCOLORSTATIC = DrawThemeParentBackgroundEx_dwFlags.USECTLCOLORSTATIC;
pub const DTPB_USEERASEBKGND = DrawThemeParentBackgroundEx_dwFlags.USEERASEBKGND;

pub const TreeView_Select_codeFlags = extern enum(u32) {
    CARET = 9,
    DROPHILITE = 8,
    FIRSTVISIBLE = 5,
    CHILD = 4,
};
pub const TVGN_CARET = TreeView_Select_codeFlags.CARET;
pub const TVGN_DROPHILITE = TreeView_Select_codeFlags.DROPHILITE;
pub const TVGN_FIRSTVISIBLE = TreeView_Select_codeFlags.FIRSTVISIBLE;
pub const TVGN_CHILD = TreeView_Select_codeFlags.CHILD;

pub const DateTime_SetSystemtime_gdFlags = extern enum(u32) {
    VALID = 0,
    NONE = 1,
};
pub const GDT_VALID = DateTime_SetSystemtime_gdFlags.VALID;
pub const GDT_NONE = DateTime_SetSystemtime_gdFlags.NONE;

pub const ListView_GetGroupRect_typeFlags = extern enum(u32) {
    GROUP = 0,
    HEADER = 1,
    LABEL = 2,
    SUBSETLINK = 3,
};
pub const LVGGR_GROUP = ListView_GetGroupRect_typeFlags.GROUP;
pub const LVGGR_HEADER = ListView_GetGroupRect_typeFlags.HEADER;
pub const LVGGR_LABEL = ListView_GetGroupRect_typeFlags.LABEL;
pub const LVGGR_SUBSETLINK = ListView_GetGroupRect_typeFlags.SUBSETLINK;

pub const ListView_GetItemIndexRect_codeFlags = extern enum(u32) {
    BOUNDS = 0,
    ICON = 1,
    LABEL = 2,
};
pub const LVIR_BOUNDS = ListView_GetItemIndexRect_codeFlags.BOUNDS;
pub const LVIR_ICON = ListView_GetItemIndexRect_codeFlags.ICON;
pub const LVIR_LABEL = ListView_GetItemIndexRect_codeFlags.LABEL;

pub const ImageListDrawEx_rgbFg = extern enum(i32) {
    NONE = -1,
    DEFAULT = -16777216,
};
pub const CLR_NONE = ImageListDrawEx_rgbFg.NONE;
pub const CLR_DEFAULT = ImageListDrawEx_rgbFg.DEFAULT;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const IRichEditOleCallback_GetContextMenu_seltypeFlags = extern enum(u32) {
    SEL_EMPTY = 0,
    SEL_TEXT = 1,
    SEL_OBJECT = 2,
    SEL_MULTICHAR = 4,
...
pub const SEL_EMPTY = IRichEditOleCallback_GetContextMenu_seltypeFlags.SEL_EMPTY;
pub const SEL_TEXT = IRichEditOleCallback_GetContextMenu_seltypeFlags.SEL_TEXT;
pub const SEL_OBJECT = IRichEditOleCallback_GetContextMenu_seltypeFlags.SEL_OBJECT;
pub const SEL_MULTICHAR = IRichEditOleCallback_GetContextMenu_seltypeFlags.SEL_MULTICHAR;
pub const SEL_MULTIOBJECT = IRichEditOleCallback_GetContextMenu_seltypeFlags.SEL_MULTIOBJECT;
pub const GCM_RIGHTMOUSEDROP = IRichEditOleCallback_GetContextMenu_seltypeFlags.GCM_RIGHTMOUSEDROP;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const TreeView_SetBorderFlags = extern enum(u32) {
    XBORDER = 1,
    YBORDER = 2,
    _,
};
pub const TVSBF_XBORDER = TreeView_SetBorderFlags.XBORDER;
pub const TVSBF_YBORDER = TreeView_SetBorderFlags.YBORDER;

pub const PropSheet_PressButton_iButtonFlags = extern enum(u32) {
    APPLYNOW = 4,
    BACK = 0,
    CANCEL = 5,
    FINISH = 2,
...
pub const PSBTN_APPLYNOW = PropSheet_PressButton_iButtonFlags.APPLYNOW;
pub const PSBTN_BACK = PropSheet_PressButton_iButtonFlags.BACK;
pub const PSBTN_CANCEL = PropSheet_PressButton_iButtonFlags.CANCEL;
pub const PSBTN_FINISH = PropSheet_PressButton_iButtonFlags.FINISH;
pub const PSBTN_HELP = PropSheet_PressButton_iButtonFlags.HELP;
pub const PSBTN_NEXT = PropSheet_PressButton_iButtonFlags.NEXT;
pub const PSBTN_OK = PropSheet_PressButton_iButtonFlags.OK;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const IRichEditOle_GetObjectFlags = extern enum(u32) {
    POLEOBJ = 1,
    PSTG = 2,
    POLESITE = 4,
    NO_INTERFACES = 0,
...
pub const REO_GETOBJ_POLEOBJ = IRichEditOle_GetObjectFlags.POLEOBJ;
pub const REO_GETOBJ_PSTG = IRichEditOle_GetObjectFlags.PSTG;
pub const REO_GETOBJ_POLESITE = IRichEditOle_GetObjectFlags.POLESITE;
pub const REO_GETOBJ_NO_INTERFACES = IRichEditOle_GetObjectFlags.NO_INTERFACES;
pub const REO_GETOBJ_ALL_INTERFACES = IRichEditOle_GetObjectFlags.ALL_INTERFACES;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const NMREBAR_dwMaskFlags = extern enum(u32) {
    ID = 1,
    LPARAM = 4,
    STYLE = 2,
    _,
};
pub const RBNM_ID = NMREBAR_dwMaskFlags.ID;
pub const RBNM_LPARAM = NMREBAR_dwMaskFlags.LPARAM;
pub const RBNM_STYLE = NMREBAR_dwMaskFlags.STYLE;

pub const EDITBALLOONTIP_ttiIconFlags = extern enum(u32) {
    ERROR = 3,
    INFO = 1,
    NONE = 0,
    WARNING = 2,
...
pub const TTI_ERROR = EDITBALLOONTIP_ttiIconFlags.ERROR;
pub const TTI_INFO = EDITBALLOONTIP_ttiIconFlags.INFO;
pub const TTI_NONE = EDITBALLOONTIP_ttiIconFlags.NONE;
pub const TTI_WARNING = EDITBALLOONTIP_ttiIconFlags.WARNING;
pub const TTI_INFO_LARGE = EDITBALLOONTIP_ttiIconFlags.INFO_LARGE;
pub const TTI_WARNING_LARGE = EDITBALLOONTIP_ttiIconFlags.WARNING_LARGE;
pub const TTI_ERROR_LARGE = EDITBALLOONTIP_ttiIconFlags.ERROR_LARGE;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const LVCOLUMNW_fmt = extern enum(u32) {
    LEFT = 0,
    RIGHT = 1,
    CENTER = 2,
    JUSTIFYMASK = 3,
...
pub const LVCFMT_LEFT = LVCOLUMNW_fmt.LEFT;
pub const LVCFMT_RIGHT = LVCOLUMNW_fmt.RIGHT;
pub const LVCFMT_CENTER = LVCOLUMNW_fmt.CENTER;
pub const LVCFMT_JUSTIFYMASK = LVCOLUMNW_fmt.JUSTIFYMASK;
pub const LVCFMT_IMAGE = LVCOLUMNW_fmt.IMAGE;
pub const LVCFMT_BITMAP_ON_RIGHT = LVCOLUMNW_fmt.BITMAP_ON_RIGHT;
pub const LVCFMT_COL_HAS_IMAGES = LVCOLUMNW_fmt.COL_HAS_IMAGES;
pub const LVCFMT_FIXED_WIDTH = LVCOLUMNW_fmt.FIXED_WIDTH;
pub const LVCFMT_NO_DPI_SCALE = LVCOLUMNW_fmt.NO_DPI_SCALE;
pub const LVCFMT_FIXED_RATIO = LVCOLUMNW_fmt.FIXED_RATIO;
pub const LVCFMT_SPLITBUTTON = LVCOLUMNW_fmt.SPLITBUTTON;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const NMPGSCROLL_fwKeysFlags = extern enum(u32) {
    None = 0,
    SHIFT = 1,
    CONTROL = 2,
    MENU = 4,
...
pub const PGK_SHIFT = NMPGSCROLL_fwKeysFlags.SHIFT;
pub const PGK_CONTROL = NMPGSCROLL_fwKeysFlags.CONTROL;
pub const PGK_MENU = NMPGSCROLL_fwKeysFlags.MENU;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const COMBOBOXEXITEMW_mask = extern enum(u32) {
...
pub const CBEIF_DI_SETITEM = COMBOBOXEXITEMW_mask.DI_SETITEM;
pub const CBEIF_IMAGE = COMBOBOXEXITEMW_mask.IMAGE;
pub const CBEIF_INDENT = COMBOBOXEXITEMW_mask.INDENT;
pub const CBEIF_LPARAM = COMBOBOXEXITEMW_mask.LPARAM;
pub const CBEIF_OVERLAY = COMBOBOXEXITEMW_mask.OVERLAY;
pub const CBEIF_SELECTEDIMAGE = COMBOBOXEXITEMW_mask.SELECTEDIMAGE;
pub const CBEIF_TEXT = COMBOBOXEXITEMW_mask.TEXT;

pub const TVITEMEXW_cChildren = extern enum(i32) {
    CALLBACK = -1,
    AUTO = -2,
};
...
pub const TVIF_CHILDREN = TVITEMA_mask.CHILDREN;
pub const TVIF_DI_SETITEM = TVITEMA_mask.DI_SETITEM;
pub const TVIF_HANDLE = TVITEMA_mask.HANDLE;
pub const TVIF_IMAGE = TVITEMA_mask.IMAGE;
pub const TVIF_PARAM = TVITEMA_mask.PARAM;
pub const TVIF_SELECTEDIMAGE = TVITEMA_mask.SELECTEDIMAGE;
pub const TVIF_STATE = TVITEMA_mask.STATE;
pub const TVIF_TEXT = TVITEMA_mask.TEXT;
pub const TVIF_EXPANDEDIMAGE = TVITEMA_mask.EXPANDEDIMAGE;
pub const TVIF_INTEGRAL = TVITEMA_mask.INTEGRAL;
pub const TVIF_STATEEX = TVITEMA_mask.STATEEX;
...
pub const PARAFORMAT_wReservedFlags = extern enum(u32) {
    None = 0,
};

pub const COMBOBOXINFO_stateButtonFlags = extern enum(u32) {
    INVISIBLE = 32768,
    PRESSED = 8,
    FOCUSABLE = 1048576,
    OFFSCREEN = 65536,
...
pub const STATE_SYSTEM_INVISIBLE = COMBOBOXINFO_stateButtonFlags.INVISIBLE;
pub const STATE_SYSTEM_PRESSED = COMBOBOXINFO_stateButtonFlags.PRESSED;
pub const STATE_SYSTEM_FOCUSABLE = COMBOBOXINFO_stateButtonFlags.FOCUSABLE;
pub const STATE_SYSTEM_OFFSCREEN = COMBOBOXINFO_stateButtonFlags.OFFSCREEN;
pub const STATE_SYSTEM_UNAVAILABLE = COMBOBOXINFO_stateButtonFlags.UNAVAILABLE;

pub const NMCUSTOMDRAW_dwDrawStageFlags = extern enum(u32) {
    POSTPAINT = 2,
    PREERASE = 3,
    PREPAINT = 1,
    ITEMPOSTERASE = 65540,
...
pub const CDDS_POSTPAINT = NMCUSTOMDRAW_dwDrawStageFlags.POSTPAINT;
pub const CDDS_PREERASE = NMCUSTOMDRAW_dwDrawStageFlags.PREERASE;
pub const CDDS_PREPAINT = NMCUSTOMDRAW_dwDrawStageFlags.PREPAINT;
pub const CDDS_ITEMPOSTERASE = NMCUSTOMDRAW_dwDrawStageFlags.ITEMPOSTERASE;
pub const CDDS_ITEMPOSTPAINT = NMCUSTOMDRAW_dwDrawStageFlags.ITEMPOSTPAINT;
pub const CDDS_ITEMPREERASE = NMCUSTOMDRAW_dwDrawStageFlags.ITEMPREERASE;
pub const CDDS_ITEMPREPAINT = NMCUSTOMDRAW_dwDrawStageFlags.ITEMPREPAINT;
pub const CDDS_SUBITEM = NMCUSTOMDRAW_dwDrawStageFlags.SUBITEM;

pub const MCGRIDINFO_dwPartFlags = extern enum(u32) {
    CALENDARCONTROL = 0,
    NEXT = 1,
    PREV = 2,
    FOOTER = 3,
...
pub const MCGIP_CALENDARCONTROL = MCGRIDINFO_dwPartFlags.CALENDARCONTROL;
pub const MCGIP_NEXT = MCGRIDINFO_dwPartFlags.NEXT;
pub const MCGIP_PREV = MCGRIDINFO_dwPartFlags.PREV;
pub const MCGIP_FOOTER = MCGRIDINFO_dwPartFlags.FOOTER;
pub const MCGIP_CALENDAR = MCGRIDINFO_dwPartFlags.CALENDAR;
pub const MCGIP_CALENDARHEADER = MCGRIDINFO_dwPartFlags.CALENDARHEADER;
pub const MCGIP_CALENDARBODY = MCGRIDINFO_dwPartFlags.CALENDARBODY;
pub const MCGIP_CALENDARROW = MCGRIDINFO_dwPartFlags.CALENDARROW;
pub const MCGIP_CALENDARCELL = MCGRIDINFO_dwPartFlags.CALENDARCELL;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const PARAFORMAT2_wBordersFlags = extern enum(u32) {
    @"1" = 1,
    @"2" = 2,
    @"4" = 4,
    @"8" = 8,
...
pub const wBorders1 = PARAFORMAT2_wBordersFlags.@"1";
pub const wBorders2 = PARAFORMAT2_wBordersFlags.@"2";
pub const wBorders4 = PARAFORMAT2_wBordersFlags.@"4";
pub const wBorders8 = PARAFORMAT2_wBordersFlags.@"8";
pub const wBorders16 = PARAFORMAT2_wBordersFlags.@"16";
pub const wBorders32 = PARAFORMAT2_wBordersFlags.@"32";
pub const wBorders64 = PARAFORMAT2_wBordersFlags.@"64";

pub const LVITEMA_iGroupId = extern enum(i32) {
    CALLBACK = -1,
    NONE = -2,
};
pub const I_GROUPIDCALLBACK = LVITEMA_iGroupId.CALLBACK;
pub const I_GROUPIDNONE = LVITEMA_iGroupId.NONE;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const NMTBHOTITEM_dwFlags = extern enum(u32) {
    ACCELERATOR = 4,
    ARROWKEYS = 2,
    DUPACCEL = 8,
    ENTERING = 16,
...
pub const HICF_ACCELERATOR = NMTBHOTITEM_dwFlags.ACCELERATOR;
pub const HICF_ARROWKEYS = NMTBHOTITEM_dwFlags.ARROWKEYS;
pub const HICF_DUPACCEL = NMTBHOTITEM_dwFlags.DUPACCEL;
pub const HICF_ENTERING = NMTBHOTITEM_dwFlags.ENTERING;
pub const HICF_LEAVING = NMTBHOTITEM_dwFlags.LEAVING;
pub const HICF_LMOUSE = NMTBHOTITEM_dwFlags.LMOUSE;
pub const HICF_MOUSE = NMTBHOTITEM_dwFlags.MOUSE;
...
pub const LVTVIF_EXTENDED = LVTILEVIEWINFO_dwFlags.D;

pub const NMPGSCROLL_iDirFlags = extern enum(u32) {
    DOWN = 2,
    LEFT = 4,
    RIGHT = 8,
    UP = 1,
};
pub const PGF_SCROLLDOWN = NMPGSCROLL_iDirFlags.DOWN;
pub const PGF_SCROLLLEFT = NMPGSCROLL_iDirFlags.LEFT;
pub const PGF_SCROLLRIGHT = NMPGSCROLL_iDirFlags.RIGHT;
pub const PGF_SCROLLUP = NMPGSCROLL_iDirFlags.UP;

pub const PARAFORMAT2_wAlignmentFlags = extern enum(u32) {
    LEFT = 1,
    RIGHT = 2,
    CENTER = 3,
    JUSTIFY = 4,
...
pub const PFA_LEFT = PARAFORMAT2_wAlignmentFlags.LEFT;
pub const PFA_RIGHT = PARAFORMAT2_wAlignmentFlags.RIGHT;
pub const PFA_CENTER = PARAFORMAT2_wAlignmentFlags.CENTER;
pub const PFA_JUSTIFY = PARAFORMAT2_wAlignmentFlags.JUSTIFY;
pub const PFA_FULL_INTERWORD = PARAFORMAT2_wAlignmentFlags.FULL_INTERWORD;

pub const PARAFORMAT2_wShadingStyleFlags = extern enum(u32) {
    None = 0,
    @"1" = 1,
    @"2" = 2,
    @"3" = 3,
...
pub const wShadingStyle1 = PARAFORMAT2_wShadingStyleFlags.@"1";
pub const wShadingStyle2 = PARAFORMAT2_wShadingStyleFlags.@"2";
pub const wShadingStyle3 = PARAFORMAT2_wShadingStyleFlags.@"3";
pub const wShadingStyle4 = PARAFORMAT2_wShadingStyleFlags.@"4";
pub const wShadingStyle5 = PARAFORMAT2_wShadingStyleFlags.@"5";
pub const wShadingStyle6 = PARAFORMAT2_wShadingStyleFlags.@"6";
pub const wShadingStyle7 = PARAFORMAT2_wShadingStyleFlags.@"7";
pub const wShadingStyle8 = PARAFORMAT2_wShadingStyleFlags.@"8";
pub const wShadingStyle9 = PARAFORMAT2_wShadingStyleFlags.@"9";
pub const wShadingStyle10 = PARAFORMAT2_wShadingStyleFlags.@"10";
pub const wShadingStyle11 = PARAFORMAT2_wShadingStyleFlags.@"11";
pub const wShadingStyle12 = PARAFORMAT2_wShadingStyleFlags.@"12";
...
pub const BUTTON_IMAGELIST_uAlignFlags = extern enum(u32) {
    LEFT = 0,
    RIGHT = 1,
    TOP = 2,
    BOTTOM = 3,
...
pub const BUTTON_IMAGELIST_ALIGN_LEFT = BUTTON_IMAGELIST_uAlignFlags.LEFT;
pub const BUTTON_IMAGELIST_ALIGN_RIGHT = BUTTON_IMAGELIST_uAlignFlags.RIGHT;
pub const BUTTON_IMAGELIST_ALIGN_TOP = BUTTON_IMAGELIST_uAlignFlags.TOP;
pub const BUTTON_IMAGELIST_ALIGN_BOTTOM = BUTTON_IMAGELIST_uAlignFlags.BOTTOM;
pub const BUTTON_IMAGELIST_ALIGN_CENTER = BUTTON_IMAGELIST_uAlignFlags.CENTER;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const TBBUTTONINFOW_dwMask = extern enum(u32) {
    BYINDEX = 2147483648,
    COMMAND = 32,
    IMAGE = 1,
    LPARAM = 16,
...
pub const TBIF_BYINDEX = TBBUTTONINFOW_dwMask.BYINDEX;
pub const TBIF_COMMAND = TBBUTTONINFOW_dwMask.COMMAND;
pub const TBIF_IMAGE = TBBUTTONINFOW_dwMask.IMAGE;
pub const TBIF_LPARAM = TBBUTTONINFOW_dwMask.LPARAM;
pub const TBIF_SIZE = TBBUTTONINFOW_dwMask.SIZE;
pub const TBIF_STATE = TBBUTTONINFOW_dwMask.STATE;
pub const TBIF_STYLE = TBBUTTONINFOW_dwMask.STYLE;
pub const TBIF_TEXT = TBBUTTONINFOW_dwMask.TEXT;

pub const TBINSERTMARK_dwFlags = extern enum(u32) {
    None = 0,
    AFTER = 1,
    BACKGROUND = 2,
};
pub const TBIMHT_AFTER = TBINSERTMARK_dwFlags.AFTER;
pub const TBIMHT_BACKGROUND = TBINSERTMARK_dwFlags.BACKGROUND;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const LVGROUP_maskFlags = extern enum(u32) {
    NONE = 0,
    HEADER = 1,
    FOOTER = 2,
    STATE = 4,
...
pub const LVGF_NONE = LVGROUP_maskFlags.NONE;
pub const LVGF_HEADER = LVGROUP_maskFlags.HEADER;
pub const LVGF_FOOTER = LVGROUP_maskFlags.FOOTER;
pub const LVGF_STATE = LVGROUP_maskFlags.STATE;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const BP_PAINTPARAMSFlags = extern enum(u32) {
    ERASE = 1,
    NOCLIP = 2,
    NONCLIENT = 4,
    _,
};
pub const BPPF_ERASE = BP_PAINTPARAMSFlags.ERASE;
pub const BPPF_NOCLIP = BP_PAINTPARAMSFlags.NOCLIP;
pub const BPPF_NONCLIENT = BP_PAINTPARAMSFlags.NONCLIENT;
...
pub const DRAWITEMSTRUCT_CtlTypeFlags = extern enum(u32) {
    BUTTON = 4,
    COMBOBOX = 3,
    LISTBOX = 2,
    LISTVIEW = 102,
...
pub const ODT_BUTTON = DRAWITEMSTRUCT_CtlTypeFlags.BUTTON;
pub const ODT_COMBOBOX = DRAWITEMSTRUCT_CtlTypeFlags.COMBOBOX;
pub const ODT_LISTBOX = DRAWITEMSTRUCT_CtlTypeFlags.LISTBOX;
pub const ODT_LISTVIEW = DRAWITEMSTRUCT_CtlTypeFlags.LISTVIEW;
pub const ODT_MENU = DRAWITEMSTRUCT_CtlTypeFlags.MENU;
pub const ODT_STATIC = DRAWITEMSTRUCT_CtlTypeFlags.STATIC;
pub const ODT_TAB = DRAWITEMSTRUCT_CtlTypeFlags.TAB;

pub const NMPGCALCSIZE_dwFlagFlags = extern enum(u32) {
    HEIGHT = 2,
    WIDTH = 1,
};
pub const PGF_CALCHEIGHT = NMPGCALCSIZE_dwFlagFlags.HEIGHT;
pub const PGF_CALCWIDTH = NMPGCALCSIZE_dwFlagFlags.WIDTH;

pub const ENDCOMPOSITIONNOTIFY_dwCodeFlags = extern enum(u32) {
    ENDCOMPOSITION = 1,
    NEWTEXT = 2,
};
pub const ECN_ENDCOMPOSITION = ENDCOMPOSITIONNOTIFY_dwCodeFlags.ENDCOMPOSITION;
pub const ECN_NEWTEXT = ENDCOMPOSITIONNOTIFY_dwCodeFlags.NEWTEXT;

pub const NMLVCUSTOMDRAW_uAlignFlags = extern enum(u32) {
    CENTER = 2,
    LEFT = 1,
    RIGHT = 4,
};
pub const LVGA_HEADER_CENTER = NMLVCUSTOMDRAW_uAlignFlags.CENTER;
pub const LVGA_HEADER_LEFT = NMLVCUSTOMDRAW_uAlignFlags.LEFT;
pub const LVGA_HEADER_RIGHT = NMLVCUSTOMDRAW_uAlignFlags.RIGHT;
...
// TODO: This Enum is marked as [Flags], what do I do with this?
pub const MCGRIDINFO_dwFlags = extern enum(u32) {
    DATE = 1,
    RECT = 2,
    NAME = 4,
    _,
};
pub const MCGIF_DATE = MCGRIDINFO_dwFlags.DATE;
pub const MCGIF_RECT = MCGRIDINFO_dwFlags.RECT;
pub const MCGIF_NAME = MCGRIDINFO_dwFlags.NAME;
...
// TODO: This Enum is marked as [Flags], what do I do with this?
pub const INITCOMMONCONTROLSEX_dwICCFlags = extern enum(u32) {
    ANIMATE_CLASS = 128,
    BAR_CLASSES = 4,
    COOL_CLASSES = 1024,
    DATE_CLASSES = 256,
...
pub const ICC_ANIMATE_CLASS = INITCOMMONCONTROLSEX_dwICCFlags.ANIMATE_CLASS;
pub const ICC_BAR_CLASSES = INITCOMMONCONTROLSEX_dwICCFlags.BAR_CLASSES;
pub const ICC_COOL_CLASSES = INITCOMMONCONTROLSEX_dwICCFlags.COOL_CLASSES;
pub const ICC_DATE_CLASSES = INITCOMMONCONTROLSEX_dwICCFlags.DATE_CLASSES;
pub const ICC_HOTKEY_CLASS = INITCOMMONCONTROLSEX_dwICCFlags.HOTKEY_CLASS;
pub const ICC_INTERNET_CLASSES = INITCOMMONCONTROLSEX_dwICCFlags.INTERNET_CLASSES;
pub const ICC_LINK_CLASS = INITCOMMONCONTROLSEX_dwICCFlags.LINK_CLASS;
pub const ICC_LISTVIEW_CLASSES = INITCOMMONCONTROLSEX_dwICCFlags.LISTVIEW_CLASSES;
pub const ICC_NATIVEFNTCTL_CLASS = INITCOMMONCONTROLSEX_dwICCFlags.NATIVEFNTCTL_CLASS;
pub const ICC_PAGESCROLLER_CLASS = INITCOMMONCONTROLSEX_dwICCFlags.PAGESCROLLER_CLASS;
pub const ICC_PROGRESS_CLASS = INITCOMMONCONTROLSEX_dwICCFlags.PROGRESS_CLASS;
pub const ICC_STANDARD_CLASSES = INITCOMMONCONTROLSEX_dwICCFlags.STANDARD_CLASSES;
pub const ICC_TAB_CLASSES = INITCOMMONCONTROLSEX_dwICCFlags.TAB_CLASSES;
pub const ICC_TREEVIEW_CLASSES = INITCOMMONCONTROLSEX_dwICCFlags.TREEVIEW_CLASSES;
pub const ICC_UPDOWN_CLASS = INITCOMMONCONTROLSEX_dwICCFlags.UPDOWN_CLASS;
pub const ICC_USEREX_CLASSES = INITCOMMONCONTROLSEX_dwICCFlags.USEREX_CLASSES;
pub const ICC_WIN95_CLASSES = INITCOMMONCONTROLSEX_dwICCFlags.WIN95_CLASSES;

pub const NMLVCUSTOMDRAW_dwItemTypeFlags = extern enum(u32) {
    ITEM = 0,
    GROUP = 1,
    ITEMSLIST = 2,
};
pub const LVCDI_ITEM = NMLVCUSTOMDRAW_dwItemTypeFlags.ITEM;
pub const LVCDI_GROUP = NMLVCUSTOMDRAW_dwItemTypeFlags.GROUP;
pub const LVCDI_ITEMSLIST = NMLVCUSTOMDRAW_dwItemTypeFlags.ITEMSLIST;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const NMTBDISPINFOW_dwMask = extern enum(u32) {
    IMAGE = 1,
    TEXT = 2,
    DI_SETITEM = 268435456,
    _,
};
pub const TBNF_IMAGE = NMTBDISPINFOW_dwMask.IMAGE;
pub const TBNF_TEXT = NMTBDISPINFOW_dwMask.TEXT;
pub const TBNF_DI_SETITEM = NMTBDISPINFOW_dwMask.DI_SETITEM;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const REOBJECT_dwFlags = extern enum(u32) {
    ALIGNTORIGHT = 256,
    BELOWBASELINE = 2,
    BLANK = 16,
    CANROTATE = 128,
...
pub const REO_ALIGNTORIGHT = REOBJECT_dwFlags.ALIGNTORIGHT;
pub const REO_BELOWBASELINE = REOBJECT_dwFlags.BELOWBASELINE;
pub const REO_BLANK = REOBJECT_dwFlags.BLANK;
pub const REO_CANROTATE = REOBJECT_dwFlags.CANROTATE;
pub const REO_DONTNEEDPALETTE = REOBJECT_dwFlags.DONTNEEDPALETTE;
pub const REO_DYNAMICSIZE = REOBJECT_dwFlags.DYNAMICSIZE;
pub const REO_GETMETAFILE = REOBJECT_dwFlags.GETMETAFILE;
pub const REO_HILITED = REOBJECT_dwFlags.HILITED;
pub const REO_INPLACEACTIVE = REOBJECT_dwFlags.INPLACEACTIVE;
pub const REO_INVERTEDSELECT = REOBJECT_dwFlags.INVERTEDSELECT;
pub const REO_LINK = REOBJECT_dwFlags.LINK;
pub const REO_LINKAVAILABLE = REOBJECT_dwFlags.LINKAVAILABLE;
pub const REO_OPEN = REOBJECT_dwFlags.OPEN;
pub const REO_OWNERDRAWSELECT = REOBJECT_dwFlags.OWNERDRAWSELECT;
pub const REO_RESIZABLE = REOBJECT_dwFlags.RESIZABLE;
pub const REO_SELECTED = REOBJECT_dwFlags.SELECTED;
pub const REO_STATIC = REOBJECT_dwFlags.STATIC;
pub const REO_USEASBACKGROUND = REOBJECT_dwFlags.USEASBACKGROUND;
pub const REO_WRAPTEXTAROUND = REOBJECT_dwFlags.WRAPTEXTAROUND;

pub const NMLVEMPTYMARKUP_dwFlags = extern enum(u32) {
    D = 1,
};
pub const EMF_CENTERED = NMLVEMPTYMARKUP_dwFlags.D;

pub const PARAFORMAT2_wNumberingStyleFlags = extern enum(u32) {
    PAREN = 0,
    PARENS = 256,
    PERIOD = 512,
    PLAIN = 768,
...
pub const PFNS_PAREN = PARAFORMAT2_wNumberingStyleFlags.PAREN;
pub const PFNS_PARENS = PARAFORMAT2_wNumberingStyleFlags.PARENS;
pub const PFNS_PERIOD = PARAFORMAT2_wNumberingStyleFlags.PERIOD;
pub const PFNS_PLAIN = PARAFORMAT2_wNumberingStyleFlags.PLAIN;
pub const PFNS_NONUMBER = PARAFORMAT2_wNumberingStyleFlags.NONUMBER;
pub const PFNS_NEWNUMBER = PARAFORMAT2_wNumberingStyleFlags.NEWNUMBER;

pub const TBADDBITMAP_hInstFlags = extern enum(u32) {
    STD_LARGE_COLOR = 1,
    STD_SMALL_COLOR = 0,
    VIEW_LARGE_COLOR = 5,
    VIEW_SMALL_COLOR = 4,
...
pub const IDB_STD_LARGE_COLOR = TBADDBITMAP_hInstFlags.STD_LARGE_COLOR;
pub const IDB_STD_SMALL_COLOR = TBADDBITMAP_hInstFlags.STD_SMALL_COLOR;
pub const IDB_VIEW_LARGE_COLOR = TBADDBITMAP_hInstFlags.VIEW_LARGE_COLOR;
pub const IDB_VIEW_SMALL_COLOR = TBADDBITMAP_hInstFlags.VIEW_SMALL_COLOR;
pub const IDB_HIST_NORMAL = TBADDBITMAP_hInstFlags.HIST_NORMAL;
pub const IDB_HIST_HOT = TBADDBITMAP_hInstFlags.HIST_HOT;
pub const IDB_HIST_DISABLED = TBADDBITMAP_hInstFlags.HIST_DISABLED;
pub const IDB_HIST_PRESSED = TBADDBITMAP_hInstFlags.HIST_PRESSED;

pub const LVFOOTERITEM_maskFlags = extern enum(u32) {
    TEXT = 1,
    STATE = 2,
};
pub const LVFIF_TEXT = LVFOOTERITEM_maskFlags.TEXT;
pub const LVFIF_STATE = LVFOOTERITEM_maskFlags.STATE;
...
pub const HTREEITEM = ?*c_void;

pub const EDITWORDBREAKPROCA = fn(
    lpch: PSTR,
    ichCurrent: i32,
    cch: i32,
    code: EDITWORDBREAKPROC_code,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const DRAWITEMSTRUCT = extern struct {
    CtlType: DRAWITEMSTRUCT_CtlTypeFlags,
    CtlID: u32,
    itemID: u32,
    itemAction: u32,
    itemState: u32,
...
pub const COMBOBOXINFO = extern struct {
    ...
    rcItem: RECT,
    rcButton: RECT,
    stateButton: COMBOBOXINFO_stateButtonFlags,
    hwndCombo: HWND,
    hwndItem: HWND,
    hwndList: HWND,
};
...
pub extern "COMCTL32" fn ImageList_LoadImageA(
    ...
    crMask: u32,
    uType: u32,
    uFlags: ImageListLoadImage_uFlags,
) callconv(@import("std").os.windows.WINAPI) HIMAGELIST;
...
pub extern "UxTheme" fn DrawThemeParentBackgroundEx(
    hwnd: HWND,
    hdc: HDC,
    dwFlags: DrawThemeParentBackgroundEx_dwFlags,
    prc: ?*const RECT,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "UXTHEME" fn GetThemeBitmap(
    ...
    iStateId: i32,
    iPropId: i32,
    dwFlags: GetThemeBitmap_dwFlags,
    phBitmap: *HBITMAP,
) callconv(@import("std").os.windows.WINAPI) HRESULT;
...
pub extern "USER32" fn EnableScrollBar(
    ...
    wArrows: EnableScrollBar_wArrows,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "USER32" fn DlgDirListA(
    ...
    nIDListBox: i32,
    nIDStaticPath: i32,
    uFileType: DlgDirList_uFiletype,
) callconv(@import("std").os.windows.WINAPI) i32;
...
const RasDial_arg4 = @import("routing_and_remote_access_service.zig").RasDial_arg4;
...
const IImageList_GetItemFlagsFlags = @import("system_services.zig").IImageList_GetItemFlagsFlags;
...
test {
    ...
    const constant_export_count = 1158;
    const type_export_count = 444;
    const enum_value_export_count = 1348;
