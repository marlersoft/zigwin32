...
pub const PEERDIST_STATUS_INFO = extern struct {
    ...
    dwMinVer: PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION,
    dwMaxVer: PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION,
};
...
pub const PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION = extern enum(u32) {
    @"1" = 1,
    @"2" = 2,
};
pub const PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_1 = PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION.@"1";
pub const PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_2 = PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION.@"2";
...
test {
    ...
    const constant_export_count = 26;
