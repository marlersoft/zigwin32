...
pub const PERF_REG_COUNTERSET_STRUCT = PerfRegInfoType.PERF_REG_COUNTERSET_STRUCT;
pub const PERF_REG_COUNTER_STRUCT = PerfRegInfoType.PERF_REG_COUNTER_STRUCT;
pub const PERF_REG_COUNTERSET_NAME_STRING = PerfRegInfoType.PERF_REG_COUNTERSET_NAME_STRING;
pub const PERF_REG_COUNTERSET_HELP_STRING = PerfRegInfoType.PERF_REG_COUNTERSET_HELP_STRING;
pub const PERF_REG_COUNTER_NAME_STRINGS = PerfRegInfoType.PERF_REG_COUNTER_NAME_STRINGS;
pub const PERF_REG_COUNTER_HELP_STRINGS = PerfRegInfoType.PERF_REG_COUNTER_HELP_STRINGS;
pub const PERF_REG_PROVIDER_NAME = PerfRegInfoType.PERF_REG_PROVIDER_NAME;
pub const PERF_REG_PROVIDER_GUID = PerfRegInfoType.PERF_REG_PROVIDER_GUID;
pub const PERF_REG_COUNTERSET_ENGLISH_NAME = PerfRegInfoType.PERF_REG_COUNTERSET_ENGLISH_NAME;
pub const PERF_REG_COUNTER_ENGLISH_NAMES = PerfRegInfoType.PERF_REG_COUNTER_ENGLISH_NAMES;
...
pub const PERF_ERROR_RETURN = PerfCounterDataType.PERF_ERROR_RETURN;
pub const PERF_SINGLE_COUNTER = PerfCounterDataType.PERF_SINGLE_COUNTER;
pub const PERF_MULTIPLE_COUNTERS = PerfCounterDataType.PERF_MULTIPLE_COUNTERS;
pub const PERF_MULTIPLE_INSTANCES = PerfCounterDataType.PERF_MULTIPLE_INSTANCES;
pub const PERF_COUNTERSET = PerfCounterDataType.PERF_COUNTERSET;
...
test {
    ...
    const enum_value_export_count = 15;
