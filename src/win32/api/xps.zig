...
//--------------------------------------------------------------------------------
pub const NOTIFICATION_RELEASE = @import("../zig.zig").Guid.initString("ba9a5027-a70e-4ae7-9b7d-eb3e06ad4157");
pub const PRINT_APP_BIDI_NOTIFY_CHANNEL = @import("../zig.zig").Guid.initString("2abad223-b994-4aca-82fc-4571b1b585ac");
pub const PRINT_PORT_MONITOR_NOTIFY_CHANNEL = @import("../zig.zig").Guid.initString("25df3b0e-74a9-47f5-80ce-79b4b1eb5c58");
pub const ID_DOCUMENTPACKAGETARGET_MSXPS = @import("../zig.zig").Guid.initString("9cae40a8-ded1-41c9-a9fd-d735ef33aeda");
pub const ID_DOCUMENTPACKAGETARGET_OPENXPS = @import("../zig.zig").Guid.initString("0056bb72-8c9c-4612-bd0f-93012a87099d");
pub const ID_DOCUMENTPACKAGETARGET_OPENXPS_WITH_3D = @import("../zig.zig").Guid.initString("63dbd720-8b14-4577-b074-7bb11b596d28");
