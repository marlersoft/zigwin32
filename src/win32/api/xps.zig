...
pub const PSINJECT_BEGINSTREAM = PSINJECT_POINT.PSINJECT_BEGINSTREAM;
pub const PSINJECT_PSADOBE = PSINJECT_POINT.PSINJECT_PSADOBE;
pub const PSINJECT_PAGESATEND = PSINJECT_POINT.PSINJECT_PAGESATEND;
pub const PSINJECT_PAGES = PSINJECT_POINT.PSINJECT_PAGES;
pub const PSINJECT_DOCNEEDEDRES = PSINJECT_POINT.PSINJECT_DOCNEEDEDRES;
pub const PSINJECT_DOCSUPPLIEDRES = PSINJECT_POINT.PSINJECT_DOCSUPPLIEDRES;
pub const PSINJECT_PAGEORDER = PSINJECT_POINT.PSINJECT_PAGEORDER;
pub const PSINJECT_ORIENTATION = PSINJECT_POINT.PSINJECT_ORIENTATION;
pub const PSINJECT_BOUNDINGBOX = PSINJECT_POINT.PSINJECT_BOUNDINGBOX;
pub const PSINJECT_DOCUMENTPROCESSCOLORS = PSINJECT_POINT.PSINJECT_DOCUMENTPROCESSCOLORS;
pub const PSINJECT_COMMENTS = PSINJECT_POINT.PSINJECT_COMMENTS;
pub const PSINJECT_BEGINDEFAULTS = PSINJECT_POINT.PSINJECT_BEGINDEFAULTS;
pub const PSINJECT_ENDDEFAULTS = PSINJECT_POINT.PSINJECT_ENDDEFAULTS;
pub const PSINJECT_BEGINPROLOG = PSINJECT_POINT.PSINJECT_BEGINPROLOG;
pub const PSINJECT_ENDPROLOG = PSINJECT_POINT.PSINJECT_ENDPROLOG;
pub const PSINJECT_BEGINSETUP = PSINJECT_POINT.PSINJECT_BEGINSETUP;
pub const PSINJECT_ENDSETUP = PSINJECT_POINT.PSINJECT_ENDSETUP;
pub const PSINJECT_TRAILER = PSINJECT_POINT.PSINJECT_TRAILER;
pub const PSINJECT_EOF = PSINJECT_POINT.PSINJECT_EOF;
pub const PSINJECT_ENDSTREAM = PSINJECT_POINT.PSINJECT_ENDSTREAM;
pub const PSINJECT_DOCUMENTPROCESSCOLORSATEND = PSINJECT_POINT.PSINJECT_DOCUMENTPROCESSCOLORSATEND;
pub const PSINJECT_PAGENUMBER = PSINJECT_POINT.PSINJECT_PAGENUMBER;
pub const PSINJECT_BEGINPAGESETUP = PSINJECT_POINT.PSINJECT_BEGINPAGESETUP;
pub const PSINJECT_ENDPAGESETUP = PSINJECT_POINT.PSINJECT_ENDPAGESETUP;
pub const PSINJECT_PAGETRAILER = PSINJECT_POINT.PSINJECT_PAGETRAILER;
pub const PSINJECT_PLATECOLOR = PSINJECT_POINT.PSINJECT_PLATECOLOR;
pub const PSINJECT_SHOWPAGE = PSINJECT_POINT.PSINJECT_SHOWPAGE;
pub const PSINJECT_PAGEBBOX = PSINJECT_POINT.PSINJECT_PAGEBBOX;
pub const PSINJECT_ENDPAGECOMMENTS = PSINJECT_POINT.PSINJECT_ENDPAGECOMMENTS;
pub const PSINJECT_VMSAVE = PSINJECT_POINT.PSINJECT_VMSAVE;
pub const PSINJECT_VMRESTORE = PSINJECT_POINT.PSINJECT_VMRESTORE;
...
pub const XPS_COLOR_INTERPOLATION_SCRGBLINEAR = XPS_COLOR_INTERPOLATION.SCRGBLINEAR;
pub const XPS_COLOR_INTERPOLATION_SRGBLINEAR = XPS_COLOR_INTERPOLATION.SRGBLINEAR;
...
pub const XPS_INTERLEAVING_OFF = XPS_INTERLEAVING.OFF;
pub const XPS_INTERLEAVING_ON = XPS_INTERLEAVING.ON;
...
pub const XPS_COLOR = extern struct {
    ...
    value: XPS_COLOR.__MIDL___MIDL_itf_xpsobjectmodel_0000_0000_0028,
...
pub const kUserDefaultDevmode = EDefaultDevmodeType.kUserDefaultDevmode;
pub const kPrinterDefaultDevmode = EDefaultDevmodeType.kPrinterDefaultDevmode;
...
pub const kPTPageScope = EPrintTicketScope.kPTPageScope;
pub const kPTDocumentScope = EPrintTicketScope.kPTDocumentScope;
pub const kPTJobScope = EPrintTicketScope.kPTJobScope;
...
const IOpcSignatureReferenceSet = @import("packaging.zig").IOpcSignatureReferenceSet;
const SECURITY_ATTRIBUTES = @import("system_services.zig").SECURITY_ATTRIBUTES;
const BSTR = @import("automation.zig").BSTR;
const PSTR = @import("system_services.zig").PSTR;
const XPS_GLYPH_INDEX = @import("print_docs.zig").XPS_GLYPH_INDEX;
const IOpcSignatureCustomObjectSet = @import("packaging.zig").IOpcSignatureCustomObjectSet;
const IOpcSignatureCustomObjectEnumerator = @import("packaging.zig").IOpcSignatureCustomObjectEnumerator;
...
const OPC_SIGNATURE_TIME_FORMAT = @import("packaging.zig").OPC_SIGNATURE_TIME_FORMAT;
const IOpcSignatureReferenceEnumerator = @import("packaging.zig").IOpcSignatureReferenceEnumerator;
...
test {
    ...
    const enum_value_export_count = 121;
