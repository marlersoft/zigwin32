...
pub const FWP_BITMAP_ARRAY64_SIZE : u32 = 64;
...
pub const FWP_ACTION_BITMAP_INDEX_SET : u32 = 9;
...
pub const FWP_CONDITION_REAUTHORIZE_REASON_PRECLASSIFY_LOCALADDR_LAYER_CHANGE : u32 = 1024;
pub const FWP_CONDITION_REAUTHORIZE_REASON_PRECLASSIFY_REMOTEADDR_LAYER_CHANGE : u32 = 2048;
pub const FWP_CONDITION_REAUTHORIZE_REASON_PRECLASSIFY_LOCALPORT_LAYER_CHANGE : u32 = 4096;
pub const FWP_CONDITION_REAUTHORIZE_REASON_PRECLASSIFY_REMOTEPORT_LAYER_CHANGE : u32 = 8192;
pub const FWP_CONDITION_REAUTHORIZE_REASON_PROXY_HANDLE_CHANGED : u32 = 16384;
pub const FWP_CONDITION_REAUTHORIZE_REASON_PRECLASSIFY_POLICY_CHANGED : u32 = 32768;
...
pub const FWPM_LAYER_INBOUND_IPPACKET_V4 = @import("../zig.zig").Guid.initString("c86fd1bf-21cd-497e-a0bb-17425c885c58");
pub const FWPM_LAYER_INBOUND_IPPACKET_V4_DISCARD = @import("../zig.zig").Guid.initString("b5a230d0-a8c0-44f2-916e-991b53ded1f7");
pub const FWPM_LAYER_INBOUND_IPPACKET_V6 = @import("../zig.zig").Guid.initString("f52032cb-991c-46e7-971d-2601459a91ca");
pub const FWPM_LAYER_INBOUND_IPPACKET_V6_DISCARD = @import("../zig.zig").Guid.initString("bb24c279-93b4-47a2-83ad-ae1698b50885");
pub const FWPM_LAYER_OUTBOUND_IPPACKET_V4 = @import("../zig.zig").Guid.initString("1e5c9fae-8a84-4135-a331-950b54229ecd");
pub const FWPM_LAYER_OUTBOUND_IPPACKET_V4_DISCARD = @import("../zig.zig").Guid.initString("08e4bcb5-b647-48f3-953c-e5ddbd03937e");
pub const FWPM_LAYER_OUTBOUND_IPPACKET_V6 = @import("../zig.zig").Guid.initString("a3b3ab6b-3564-488c-9117-f34e82142763");
pub const FWPM_LAYER_OUTBOUND_IPPACKET_V6_DISCARD = @import("../zig.zig").Guid.initString("9513d7c4-a934-49dc-91a7-6ccb80cc02e3");
pub const FWPM_LAYER_IPFORWARD_V4 = @import("../zig.zig").Guid.initString("a82acc24-4ee1-4ee1-b465-fd1d25cb10a4");
pub const FWPM_LAYER_IPFORWARD_V4_DISCARD = @import("../zig.zig").Guid.initString("9e9ea773-2fae-4210-8f17-34129ef369eb");
pub const FWPM_LAYER_IPFORWARD_V6 = @import("../zig.zig").Guid.initString("7b964818-19c7-493a-b71f-832c3684d28c");
pub const FWPM_LAYER_IPFORWARD_V6_DISCARD = @import("../zig.zig").Guid.initString("31524a5d-1dfe-472f-bb93-518ee945d8a2");
pub const FWPM_LAYER_INBOUND_TRANSPORT_V4 = @import("../zig.zig").Guid.initString("5926dfc8-e3cf-4426-a283-dc393f5d0f9d");
pub const FWPM_LAYER_INBOUND_TRANSPORT_V4_DISCARD = @import("../zig.zig").Guid.initString("ac4a9833-f69d-4648-b261-6dc84835ef39");
pub const FWPM_LAYER_INBOUND_TRANSPORT_V6 = @import("../zig.zig").Guid.initString("634a869f-fc23-4b90-b0c1-bf620a36ae6f");
pub const FWPM_LAYER_INBOUND_TRANSPORT_V6_DISCARD = @import("../zig.zig").Guid.initString("2a6ff955-3b2b-49d2-9848-ad9d72dcaab7");
pub const FWPM_LAYER_OUTBOUND_TRANSPORT_V4 = @import("../zig.zig").Guid.initString("09e61aea-d214-46e2-9b21-b26b0b2f28c8");
pub const FWPM_LAYER_OUTBOUND_TRANSPORT_V4_DISCARD = @import("../zig.zig").Guid.initString("c5f10551-bdb0-43d7-a313-50e211f4d68a");
pub const FWPM_LAYER_OUTBOUND_TRANSPORT_V6 = @import("../zig.zig").Guid.initString("e1735bde-013f-4655-b351-a49e15762df0");
pub const FWPM_LAYER_OUTBOUND_TRANSPORT_V6_DISCARD = @import("../zig.zig").Guid.initString("f433df69-ccbd-482e-b9b2-57165658c3b3");
pub const FWPM_LAYER_STREAM_V4 = @import("../zig.zig").Guid.initString("3b89653c-c170-49e4-b1cd-e0eeeee19a3e");
pub const FWPM_LAYER_STREAM_V4_DISCARD = @import("../zig.zig").Guid.initString("25c4c2c2-25ff-4352-82f9-c54a4a4726dc");
pub const FWPM_LAYER_STREAM_V6 = @import("../zig.zig").Guid.initString("47c9137a-7ec4-46b3-b6e4-48e926b1eda4");
pub const FWPM_LAYER_STREAM_V6_DISCARD = @import("../zig.zig").Guid.initString("10a59fc7-b628-4c41-9eb8-cf37d55103cf");
pub const FWPM_LAYER_DATAGRAM_DATA_V4 = @import("../zig.zig").Guid.initString("3d08bf4e-45f6-4930-a922-417098e20027");
pub const FWPM_LAYER_DATAGRAM_DATA_V4_DISCARD = @import("../zig.zig").Guid.initString("18e330c6-7248-4e52-aaab-472ed67704fd");
pub const FWPM_LAYER_DATAGRAM_DATA_V6 = @import("../zig.zig").Guid.initString("fa45fe2f-3cba-4427-87fc-57b9a4b10d00");
pub const FWPM_LAYER_DATAGRAM_DATA_V6_DISCARD = @import("../zig.zig").Guid.initString("09d1dfe1-9b86-4a42-be9d-8c315b92a5d0");
pub const FWPM_LAYER_INBOUND_ICMP_ERROR_V4 = @import("../zig.zig").Guid.initString("61499990-3cb6-4e84-b950-53b94b6964f3");
pub const FWPM_LAYER_INBOUND_ICMP_ERROR_V4_DISCARD = @import("../zig.zig").Guid.initString("a6b17075-ebaf-4053-a4e7-213c8121ede5");
pub const FWPM_LAYER_INBOUND_ICMP_ERROR_V6 = @import("../zig.zig").Guid.initString("65f9bdff-3b2d-4e5d-b8c6-c720651fe898");
pub const FWPM_LAYER_INBOUND_ICMP_ERROR_V6_DISCARD = @import("../zig.zig").Guid.initString("a6e7ccc0-08fb-468d-a472-9771d5595e09");
pub const FWPM_LAYER_OUTBOUND_ICMP_ERROR_V4 = @import("../zig.zig").Guid.initString("41390100-564c-4b32-bc1d-718048354d7c");
pub const FWPM_LAYER_OUTBOUND_ICMP_ERROR_V4_DISCARD = @import("../zig.zig").Guid.initString("b3598d36-0561-4588-a6bf-e955e3f6264b");
pub const FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6 = @import("../zig.zig").Guid.initString("7fb03b60-7b8d-4dfa-badd-980176fc4e12");
pub const FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6_DISCARD = @import("../zig.zig").Guid.initString("65f2e647-8d0c-4f47-b19b-33a4d3f1357c");
pub const FWPM_LAYER_ALE_RESOURCE_ASSIGNMENT_V4 = @import("../zig.zig").Guid.initString("1247d66d-0b60-4a15-8d44-7155d0f53a0c");
pub const FWPM_LAYER_ALE_RESOURCE_ASSIGNMENT_V4_DISCARD = @import("../zig.zig").Guid.initString("0b5812a2-c3ff-4eca-b88d-c79e20ac6322");
pub const FWPM_LAYER_ALE_RESOURCE_ASSIGNMENT_V6 = @import("../zig.zig").Guid.initString("55a650e1-5f0a-4eca-a653-88f53b26aa8c");
pub const FWPM_LAYER_ALE_RESOURCE_ASSIGNMENT_V6_DISCARD = @import("../zig.zig").Guid.initString("cbc998bb-c51f-4c1a-bb4f-9775fcacab2f");
pub const FWPM_LAYER_ALE_AUTH_LISTEN_V4 = @import("../zig.zig").Guid.initString("88bb5dad-76d7-4227-9c71-df0a3ed7be7e");
pub const FWPM_LAYER_ALE_AUTH_LISTEN_V4_DISCARD = @import("../zig.zig").Guid.initString("371dfada-9f26-45fd-b4eb-c29eb212893f");
pub const FWPM_LAYER_ALE_AUTH_LISTEN_V6 = @import("../zig.zig").Guid.initString("7ac9de24-17dd-4814-b4bd-a9fbc95a321b");
pub const FWPM_LAYER_ALE_AUTH_LISTEN_V6_DISCARD = @import("../zig.zig").Guid.initString("60703b07-63c8-48e9-ada3-12b1af40a617");
pub const FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4 = @import("../zig.zig").Guid.initString("e1cd9fe7-f4b5-4273-96c0-592e487b8650");
pub const FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4_DISCARD = @import("../zig.zig").Guid.initString("9eeaa99b-bd22-4227-919f-0073c63357b1");
pub const FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6 = @import("../zig.zig").Guid.initString("a3b42c97-9f04-4672-b87e-cee9c483257f");
pub const FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6_DISCARD = @import("../zig.zig").Guid.initString("89455b97-dbe1-453f-a224-13da895af396");
pub const FWPM_LAYER_ALE_AUTH_CONNECT_V4 = @import("../zig.zig").Guid.initString("c38d57d1-05a7-4c33-904f-7fbceee60e82");
pub const FWPM_LAYER_ALE_AUTH_CONNECT_V4_DISCARD = @import("../zig.zig").Guid.initString("d632a801-f5ba-4ad6-96e3-607017d9836a");
pub const FWPM_LAYER_ALE_AUTH_CONNECT_V6 = @import("../zig.zig").Guid.initString("4a72393b-319f-44bc-84c3-ba54dcb3b6b4");
pub const FWPM_LAYER_ALE_AUTH_CONNECT_V6_DISCARD = @import("../zig.zig").Guid.initString("c97bc3b8-c9a3-4e33-8695-8e17aad4de09");
pub const FWPM_LAYER_ALE_FLOW_ESTABLISHED_V4 = @import("../zig.zig").Guid.initString("af80470a-5596-4c13-9992-539e6fe57967");
pub const FWPM_LAYER_ALE_FLOW_ESTABLISHED_V4_DISCARD = @import("../zig.zig").Guid.initString("146ae4a9-a1d2-4d43-a31a-4c42682b8e4f");
pub const FWPM_LAYER_ALE_FLOW_ESTABLISHED_V6 = @import("../zig.zig").Guid.initString("7021d2b3-dfa4-406e-afeb-6afaf7e70efd");
pub const FWPM_LAYER_ALE_FLOW_ESTABLISHED_V6_DISCARD = @import("../zig.zig").Guid.initString("46928636-bbca-4b76-941d-0fa7f5d7d372");
pub const FWPM_LAYER_INBOUND_MAC_FRAME_ETHERNET = @import("../zig.zig").Guid.initString("effb7edb-0055-4f9a-a231-4ff8131ad191");
pub const FWPM_LAYER_OUTBOUND_MAC_FRAME_ETHERNET = @import("../zig.zig").Guid.initString("694673bc-d6db-4870-adee-0acdbdb7f4b2");
pub const FWPM_LAYER_INBOUND_MAC_FRAME_NATIVE = @import("../zig.zig").Guid.initString("d4220bd3-62ce-4f08-ae88-b56e8526df50");
pub const FWPM_LAYER_OUTBOUND_MAC_FRAME_NATIVE = @import("../zig.zig").Guid.initString("94c44912-9d6f-4ebf-b995-05ab8a088d1b");
pub const FWPM_LAYER_INGRESS_VSWITCH_ETHERNET = @import("../zig.zig").Guid.initString("7d98577a-9a87-41ec-9718-7cf589c9f32d");
pub const FWPM_LAYER_EGRESS_VSWITCH_ETHERNET = @import("../zig.zig").Guid.initString("86c872b0-76fa-4b79-93a4-0750530ae292");
pub const FWPM_LAYER_INGRESS_VSWITCH_TRANSPORT_V4 = @import("../zig.zig").Guid.initString("b2696ff6-774f-4554-9f7d-3da3945f8e85");
pub const FWPM_LAYER_INGRESS_VSWITCH_TRANSPORT_V6 = @import("../zig.zig").Guid.initString("5ee314fc-7d8a-47f4-b7e3-291a36da4e12");
pub const FWPM_LAYER_EGRESS_VSWITCH_TRANSPORT_V4 = @import("../zig.zig").Guid.initString("b92350b6-91f0-46b6-bdc4-871dfd4a7c98");
pub const FWPM_LAYER_EGRESS_VSWITCH_TRANSPORT_V6 = @import("../zig.zig").Guid.initString("1b2def23-1881-40bd-82f4-4254e63141cb");
pub const FWPM_LAYER_INBOUND_TRANSPORT_FAST = @import("../zig.zig").Guid.initString("e41d2719-05c7-40f0-8983-ea8d17bbc2f6");
pub const FWPM_LAYER_OUTBOUND_TRANSPORT_FAST = @import("../zig.zig").Guid.initString("13ed4388-a070-4815-9935-7a9be6408b78");
pub const FWPM_LAYER_INBOUND_MAC_FRAME_NATIVE_FAST = @import("../zig.zig").Guid.initString("853aaa8e-2b78-4d24-a804-36db08b29711");
pub const FWPM_LAYER_OUTBOUND_MAC_FRAME_NATIVE_FAST = @import("../zig.zig").Guid.initString("470df946-c962-486f-9446-8293cbc75eb8");
pub const FWPM_LAYER_IPSEC_KM_DEMUX_V4 = @import("../zig.zig").Guid.initString("f02b1526-a459-4a51-b9e3-759de52b9d2c");
pub const FWPM_LAYER_IPSEC_KM_DEMUX_V6 = @import("../zig.zig").Guid.initString("2f755cf6-2fd4-4e88-b3e4-a91bca495235");
pub const FWPM_LAYER_IPSEC_V4 = @import("../zig.zig").Guid.initString("eda65c74-610d-4bc5-948f-3c4f89556867");
pub const FWPM_LAYER_IPSEC_V6 = @import("../zig.zig").Guid.initString("13c48442-8d87-4261-9a29-59d2abc348b4");
pub const FWPM_LAYER_IKEEXT_V4 = @import("../zig.zig").Guid.initString("b14b7bdb-dbbd-473e-bed4-8b4708d4f270");
pub const FWPM_LAYER_IKEEXT_V6 = @import("../zig.zig").Guid.initString("b64786b3-f687-4eb9-89d2-8ef32acdabe2");
pub const FWPM_LAYER_RPC_UM = @import("../zig.zig").Guid.initString("75a89dda-95e4-40f3-adc7-7688a9c847e1");
pub const FWPM_LAYER_RPC_EPMAP = @import("../zig.zig").Guid.initString("9247bc61-eb07-47ee-872c-bfd78bfd1616");
pub const FWPM_LAYER_RPC_EP_ADD = @import("../zig.zig").Guid.initString("618dffc7-c450-4943-95db-99b4c16a55d4");
pub const FWPM_LAYER_RPC_PROXY_CONN = @import("../zig.zig").Guid.initString("94a4b50b-ba5c-4f27-907a-229fac0c2a7a");
pub const FWPM_LAYER_RPC_PROXY_IF = @import("../zig.zig").Guid.initString("f8a38615-e12c-41ac-98df-121ad981aade");
pub const FWPM_LAYER_KM_AUTHORIZATION = @import("../zig.zig").Guid.initString("4aa226e9-9020-45fb-956a-c0249d841195");
pub const FWPM_LAYER_NAME_RESOLUTION_CACHE_V4 = @import("../zig.zig").Guid.initString("0c2aa681-905b-4ccd-a467-4dd811d07b7b");
pub const FWPM_LAYER_NAME_RESOLUTION_CACHE_V6 = @import("../zig.zig").Guid.initString("92d592fa-6b01-434a-9dea-d1e96ea97da9");
pub const FWPM_LAYER_ALE_RESOURCE_RELEASE_V4 = @import("../zig.zig").Guid.initString("74365cce-ccb0-401a-bfc1-b89934ad7e15");
pub const FWPM_LAYER_ALE_RESOURCE_RELEASE_V6 = @import("../zig.zig").Guid.initString("f4e5ce80-edcc-4e13-8a2f-b91454bb057b");
pub const FWPM_LAYER_ALE_ENDPOINT_CLOSURE_V4 = @import("../zig.zig").Guid.initString("b4766427-e2a2-467a-bd7e-dbcd1bd85a09");
pub const FWPM_LAYER_ALE_ENDPOINT_CLOSURE_V6 = @import("../zig.zig").Guid.initString("bb536ccd-4755-4ba9-9ff7-f9edf8699c7b");
pub const FWPM_LAYER_ALE_CONNECT_REDIRECT_V4 = @import("../zig.zig").Guid.initString("c6e63c8c-b784-4562-aa7d-0a67cfcaf9a3");
pub const FWPM_LAYER_ALE_CONNECT_REDIRECT_V6 = @import("../zig.zig").Guid.initString("587e54a7-8046-42ba-a0aa-b716250fc7fd");
pub const FWPM_LAYER_ALE_BIND_REDIRECT_V4 = @import("../zig.zig").Guid.initString("66978cad-c704-42ac-86ac-7c1a231bd253");
pub const FWPM_LAYER_ALE_BIND_REDIRECT_V6 = @import("../zig.zig").Guid.initString("bef02c9c-606b-4536-8c26-1c2fc7b631d4");
pub const FWPM_LAYER_STREAM_PACKET_V4 = @import("../zig.zig").Guid.initString("af52d8ec-cb2d-44e5-ad92-f8dc38d2eb29");
pub const FWPM_LAYER_STREAM_PACKET_V6 = @import("../zig.zig").Guid.initString("779a8ca3-f099-468f-b5d4-83535c461c02");
pub const FWPM_LAYER_INBOUND_RESERVED2 = @import("../zig.zig").Guid.initString("f4fb8d55-c076-46d8-a2c7-6a4c722ca4ed");
pub const FWPM_SUBLAYER_RPC_AUDIT = @import("../zig.zig").Guid.initString("758c84f4-fb48-4de9-9aeb-3ed9551ab1fd");
pub const FWPM_SUBLAYER_IPSEC_TUNNEL = @import("../zig.zig").Guid.initString("83f299ed-9ff4-4967-aff4-c309f4dab827");
pub const FWPM_SUBLAYER_UNIVERSAL = @import("../zig.zig").Guid.initString("eebecc03-ced4-4380-819a-2734397b2b74");
pub const FWPM_SUBLAYER_LIPS = @import("../zig.zig").Guid.initString("1b75c0ce-ff60-4711-a70f-b4958cc3b2d0");
pub const FWPM_SUBLAYER_SECURE_SOCKET = @import("../zig.zig").Guid.initString("15a66e17-3f3c-4f7b-aa6c-812aa613dd82");
pub const FWPM_SUBLAYER_TCP_CHIMNEY_OFFLOAD = @import("../zig.zig").Guid.initString("337608b9-b7d5-4d5f-82f9-3618618bc058");
pub const FWPM_SUBLAYER_INSPECTION = @import("../zig.zig").Guid.initString("877519e1-e6a9-41a5-81b4-8c4f118e4a60");
pub const FWPM_SUBLAYER_TEREDO = @import("../zig.zig").Guid.initString("ba69dc66-5176-4979-9c89-26a7b46a8327");
pub const FWPM_SUBLAYER_IPSEC_FORWARD_OUTBOUND_TUNNEL = @import("../zig.zig").Guid.initString("a5082e73-8f71-4559-8a9a-101cea04ef87");
pub const FWPM_SUBLAYER_IPSEC_DOSP = @import("../zig.zig").Guid.initString("e076d572-5d3d-48ef-802b-909eddb098bd");
pub const FWPM_SUBLAYER_TCP_TEMPLATES = @import("../zig.zig").Guid.initString("24421dcf-0ac5-4caa-9e14-50f6e3636af0");
pub const FWPM_SUBLAYER_IPSEC_SECURITY_REALM = @import("../zig.zig").Guid.initString("37a57701-5884-4964-92b8-3e704688b0ad");
pub const FWPM_CONDITION_INTERFACE_MAC_ADDRESS = @import("../zig.zig").Guid.initString("f6e63dce-1f4b-4c6b-b6ef-1165e71f8ee7");
pub const FWPM_CONDITION_MAC_LOCAL_ADDRESS = @import("../zig.zig").Guid.initString("d999e981-7948-4c83-b742-c84e3b678f8f");
pub const FWPM_CONDITION_MAC_REMOTE_ADDRESS = @import("../zig.zig").Guid.initString("408f2ed4-3a70-4b4d-92a6-415ac20e2f12");
pub const FWPM_CONDITION_ETHER_TYPE = @import("../zig.zig").Guid.initString("fd08948d-a219-4d52-bb98-1a5540ee7b4e");
pub const FWPM_CONDITION_VLAN_ID = @import("../zig.zig").Guid.initString("938eab21-3618-4e64-9ca5-2141ebda1ca2");
pub const FWPM_CONDITION_VSWITCH_TENANT_NETWORK_ID = @import("../zig.zig").Guid.initString("dc04843c-79e6-4e44-a025-65b9bb0f9f94");
pub const FWPM_CONDITION_NDIS_PORT = @import("../zig.zig").Guid.initString("db7bb42b-2dac-4cd4-a59a-e0bdce1e6834");
pub const FWPM_CONDITION_NDIS_MEDIA_TYPE = @import("../zig.zig").Guid.initString("cb31cef1-791d-473b-89d1-61c5984304a0");
pub const FWPM_CONDITION_NDIS_PHYSICAL_MEDIA_TYPE = @import("../zig.zig").Guid.initString("34c79823-c229-44f2-b83c-74020882ae77");
pub const FWPM_CONDITION_L2_FLAGS = @import("../zig.zig").Guid.initString("7bc43cbf-37ba-45f1-b74a-82ff518eeb10");
pub const FWPM_CONDITION_MAC_LOCAL_ADDRESS_TYPE = @import("../zig.zig").Guid.initString("cc31355c-3073-4ffb-a14f-79415cb1ead1");
pub const FWPM_CONDITION_MAC_REMOTE_ADDRESS_TYPE = @import("../zig.zig").Guid.initString("027fedb4-f1c1-4030-b564-ee777fd867ea");
pub const FWPM_CONDITION_ALE_PACKAGE_ID = @import("../zig.zig").Guid.initString("71bc78fa-f17c-4997-a602-6abb261f351c");
pub const FWPM_CONDITION_MAC_SOURCE_ADDRESS = @import("../zig.zig").Guid.initString("7b795451-f1f6-4d05-b7cb-21779d802336");
pub const FWPM_CONDITION_MAC_DESTINATION_ADDRESS = @import("../zig.zig").Guid.initString("04ea2a93-858c-4027-b613-b43180c7859e");
pub const FWPM_CONDITION_MAC_SOURCE_ADDRESS_TYPE = @import("../zig.zig").Guid.initString("5c1b72e4-299e-4437-a298-bc3f014b3dc2");
pub const FWPM_CONDITION_MAC_DESTINATION_ADDRESS_TYPE = @import("../zig.zig").Guid.initString("ae052932-ef42-4e99-b129-f3b3139e34f7");
pub const FWPM_CONDITION_IP_SOURCE_PORT = @import("../zig.zig").Guid.initString("a6afef91-3df4-4730-a214-f5426aebf821");
pub const FWPM_CONDITION_IP_DESTINATION_PORT = @import("../zig.zig").Guid.initString("ce6def45-60fb-4a7b-a304-af30a117000e");
pub const FWPM_CONDITION_VSWITCH_ID = @import("../zig.zig").Guid.initString("c4a414ba-437b-4de6-9946-d99c1b95b312");
pub const FWPM_CONDITION_VSWITCH_NETWORK_TYPE = @import("../zig.zig").Guid.initString("11d48b4b-e77a-40b4-9155-392c906c2608");
pub const FWPM_CONDITION_VSWITCH_SOURCE_INTERFACE_ID = @import("../zig.zig").Guid.initString("7f4ef24b-b2c1-4938-ba33-a1ecbed512ba");
pub const FWPM_CONDITION_VSWITCH_DESTINATION_INTERFACE_ID = @import("../zig.zig").Guid.initString("8ed48be4-c926-49f6-a4f6-ef3030e3fc16");
pub const FWPM_CONDITION_VSWITCH_SOURCE_VM_ID = @import("../zig.zig").Guid.initString("9c2a9ec2-9fc6-42bc-bdd8-406d4da0be64");
pub const FWPM_CONDITION_VSWITCH_DESTINATION_VM_ID = @import("../zig.zig").Guid.initString("6106aace-4de1-4c84-9671-3637f8bcf731");
pub const FWPM_CONDITION_VSWITCH_SOURCE_INTERFACE_TYPE = @import("../zig.zig").Guid.initString("e6b040a2-edaf-4c36-908b-f2f58ae43807");
pub const FWPM_CONDITION_VSWITCH_DESTINATION_INTERFACE_TYPE = @import("../zig.zig").Guid.initString("fa9b3f06-2f1a-4c57-9e68-a7098b28dbfe");
pub const FWPM_CONDITION_ALE_SECURITY_ATTRIBUTE_FQBN_VALUE = @import("../zig.zig").Guid.initString("37a57699-5883-4963-92b8-3e704688b0ad");
pub const FWPM_CONDITION_IPSEC_SECURITY_REALM_ID = @import("../zig.zig").Guid.initString("37a57700-5884-4964-92b8-3e704688b0ad");
pub const FWPM_CONDITION_ALE_EFFECTIVE_NAME = @import("../zig.zig").Guid.initString("b1277b9a-b781-40fc-9671-e5f1b989f34e");
pub const FWPM_CONDITION_IP_LOCAL_ADDRESS = @import("../zig.zig").Guid.initString("d9ee00de-c1ef-4617-bfe3-ffd8f5a08957");
pub const FWPM_CONDITION_IP_REMOTE_ADDRESS = @import("../zig.zig").Guid.initString("b235ae9a-1d64-49b8-a44c-5ff3d9095045");
pub const FWPM_CONDITION_IP_SOURCE_ADDRESS = @import("../zig.zig").Guid.initString("ae96897e-2e94-4bc9-b313-b27ee80e574d");
pub const FWPM_CONDITION_IP_DESTINATION_ADDRESS = @import("../zig.zig").Guid.initString("2d79133b-b390-45c6-8699-acaceaafed33");
pub const FWPM_CONDITION_IP_LOCAL_ADDRESS_TYPE = @import("../zig.zig").Guid.initString("6ec7f6c4-376b-45d7-9e9c-d337cedcd237");
pub const FWPM_CONDITION_IP_DESTINATION_ADDRESS_TYPE = @import("../zig.zig").Guid.initString("1ec1b7c9-4eea-4f5e-b9ef-76beaaaf17ee");
pub const FWPM_CONDITION_BITMAP_IP_LOCAL_ADDRESS = @import("../zig.zig").Guid.initString("16ebc3df-957a-452e-a1fc-3d2ff6a730ba");
pub const FWPM_CONDITION_BITMAP_IP_LOCAL_PORT = @import("../zig.zig").Guid.initString("9f90a920-c3b5-4569-ba31-8bd3910dc656");
pub const FWPM_CONDITION_BITMAP_IP_REMOTE_ADDRESS = @import("../zig.zig").Guid.initString("33f00e25-8eec-4531-a005-41b911f62452");
pub const FWPM_CONDITION_BITMAP_IP_REMOTE_PORT = @import("../zig.zig").Guid.initString("2663d549-aaf2-46a2-8666-1e7667f86985");
pub const FWPM_CONDITION_IP_NEXTHOP_ADDRESS = @import("../zig.zig").Guid.initString("eabe448a-a711-4d64-85b7-3f76b65299c7");
pub const FWPM_CONDITION_BITMAP_INDEX_KEY = @import("../zig.zig").Guid.initString("0f36514c-3226-4a81-a214-2d518b04d08a");
pub const FWPM_CONDITION_IP_LOCAL_INTERFACE = @import("../zig.zig").Guid.initString("4cd62a49-59c3-4969-b7f3-bda5d32890a4");
pub const FWPM_CONDITION_IP_ARRIVAL_INTERFACE = @import("../zig.zig").Guid.initString("618a9b6d-386b-4136-ad6e-b51587cfb1cd");
pub const FWPM_CONDITION_ARRIVAL_INTERFACE_TYPE = @import("../zig.zig").Guid.initString("89f990de-e798-4e6d-ab76-7c9558292e6f");
pub const FWPM_CONDITION_ARRIVAL_TUNNEL_TYPE = @import("../zig.zig").Guid.initString("511166dc-7a8c-4aa7-b533-95ab59fb0340");
pub const FWPM_CONDITION_ARRIVAL_INTERFACE_INDEX = @import("../zig.zig").Guid.initString("cc088db3-1792-4a71-b0f9-037d21cd828b");
pub const FWPM_CONDITION_NEXTHOP_SUB_INTERFACE_INDEX = @import("../zig.zig").Guid.initString("ef8a6122-0577-45a7-9aaf-825fbeb4fb95");
pub const FWPM_CONDITION_IP_NEXTHOP_INTERFACE = @import("../zig.zig").Guid.initString("93ae8f5b-7f6f-4719-98c8-14e97429ef04");
pub const FWPM_CONDITION_NEXTHOP_INTERFACE_TYPE = @import("../zig.zig").Guid.initString("97537c6c-d9a3-4767-a381-e942675cd920");
pub const FWPM_CONDITION_NEXTHOP_TUNNEL_TYPE = @import("../zig.zig").Guid.initString("72b1a111-987b-4720-99dd-c7c576fa2d4c");
pub const FWPM_CONDITION_NEXTHOP_INTERFACE_INDEX = @import("../zig.zig").Guid.initString("138e6888-7ab8-4d65-9ee8-0591bcf6a494");
pub const FWPM_CONDITION_ORIGINAL_PROFILE_ID = @import("../zig.zig").Guid.initString("46ea1551-2255-492b-8019-aabeee349f40");
pub const FWPM_CONDITION_CURRENT_PROFILE_ID = @import("../zig.zig").Guid.initString("ab3033c9-c0e3-4759-937d-5758c65d4ae3");
pub const FWPM_CONDITION_LOCAL_INTERFACE_PROFILE_ID = @import("../zig.zig").Guid.initString("4ebf7562-9f18-4d06-9941-a7a625744d71");
pub const FWPM_CONDITION_ARRIVAL_INTERFACE_PROFILE_ID = @import("../zig.zig").Guid.initString("cdfe6aab-c083-4142-8679-c08f95329c61");
pub const FWPM_CONDITION_NEXTHOP_INTERFACE_PROFILE_ID = @import("../zig.zig").Guid.initString("d7ff9a56-cdaa-472b-84db-d23963c1d1bf");
pub const FWPM_CONDITION_REAUTHORIZE_REASON = @import("../zig.zig").Guid.initString("11205e8c-11ae-457a-8a44-477026dd764a");
pub const FWPM_CONDITION_ORIGINAL_ICMP_TYPE = @import("../zig.zig").Guid.initString("076dfdbe-c56c-4f72-ae8a-2cfe7e5c8286");
pub const FWPM_CONDITION_IP_PHYSICAL_ARRIVAL_INTERFACE = @import("../zig.zig").Guid.initString("da50d5c8-fa0d-4c89-b032-6e62136d1e96");
pub const FWPM_CONDITION_IP_PHYSICAL_NEXTHOP_INTERFACE = @import("../zig.zig").Guid.initString("f09bd5ce-5150-48be-b098-c25152fb1f92");
pub const FWPM_CONDITION_INTERFACE_QUARANTINE_EPOCH = @import("../zig.zig").Guid.initString("cce68d5e-053b-43a8-9a6f-33384c28e4f6");
pub const FWPM_CONDITION_INTERFACE_TYPE = @import("../zig.zig").Guid.initString("daf8cd14-e09e-4c93-a5ae-c5c13b73ffca");
pub const FWPM_CONDITION_TUNNEL_TYPE = @import("../zig.zig").Guid.initString("77a40437-8779-4868-a261-f5a902f1c0cd");
pub const FWPM_CONDITION_IP_FORWARD_INTERFACE = @import("../zig.zig").Guid.initString("1076b8a5-6323-4c5e-9810-e8d3fc9e6136");
pub const FWPM_CONDITION_IP_PROTOCOL = @import("../zig.zig").Guid.initString("3971ef2b-623e-4f9a-8cb1-6e79b806b9a7");
pub const FWPM_CONDITION_IP_LOCAL_PORT = @import("../zig.zig").Guid.initString("0c1ba1af-5765-453f-af22-a8f791ac775b");
pub const FWPM_CONDITION_IP_REMOTE_PORT = @import("../zig.zig").Guid.initString("c35a604d-d22b-4e1a-91b4-68f674ee674b");
pub const FWPM_CONDITION_EMBEDDED_LOCAL_ADDRESS_TYPE = @import("../zig.zig").Guid.initString("4672a468-8a0a-4202-abb4-849e92e66809");
pub const FWPM_CONDITION_EMBEDDED_REMOTE_ADDRESS = @import("../zig.zig").Guid.initString("77ee4b39-3273-4671-b63b-ab6feb66eeb6");
pub const FWPM_CONDITION_EMBEDDED_PROTOCOL = @import("../zig.zig").Guid.initString("07784107-a29e-4c7b-9ec7-29c44afafdbc");
pub const FWPM_CONDITION_EMBEDDED_LOCAL_PORT = @import("../zig.zig").Guid.initString("bfca394d-acdb-484e-b8e6-2aff79757345");
pub const FWPM_CONDITION_EMBEDDED_REMOTE_PORT = @import("../zig.zig").Guid.initString("cae4d6a1-2968-40ed-a4ce-547160dda88d");
pub const FWPM_CONDITION_FLAGS = @import("../zig.zig").Guid.initString("632ce23b-5167-435c-86d7-e903684aa80c");
pub const FWPM_CONDITION_DIRECTION = @import("../zig.zig").Guid.initString("8784c146-ca97-44d6-9fd1-19fb1840cbf7");
pub const FWPM_CONDITION_INTERFACE_INDEX = @import("../zig.zig").Guid.initString("667fd755-d695-434a-8af5-d3835a1259bc");
pub const FWPM_CONDITION_SUB_INTERFACE_INDEX = @import("../zig.zig").Guid.initString("0cd42473-d621-4be3-ae8c-72a348d283e1");
pub const FWPM_CONDITION_SOURCE_INTERFACE_INDEX = @import("../zig.zig").Guid.initString("2311334d-c92d-45bf-9496-edf447820e2d");
pub const FWPM_CONDITION_SOURCE_SUB_INTERFACE_INDEX = @import("../zig.zig").Guid.initString("055edd9d-acd2-4361-8dab-f9525d97662f");
pub const FWPM_CONDITION_DESTINATION_INTERFACE_INDEX = @import("../zig.zig").Guid.initString("35cf6522-4139-45ee-a0d5-67b80949d879");
pub const FWPM_CONDITION_DESTINATION_SUB_INTERFACE_INDEX = @import("../zig.zig").Guid.initString("2b7d4399-d4c7-4738-a2f5-e994b43da388");
pub const FWPM_CONDITION_ALE_APP_ID = @import("../zig.zig").Guid.initString("d78e1e87-8644-4ea5-9437-d809ecefc971");
pub const FWPM_CONDITION_ALE_ORIGINAL_APP_ID = @import("../zig.zig").Guid.initString("0e6cd086-e1fb-4212-842f-8a9f993fb3f6");
pub const FWPM_CONDITION_ALE_USER_ID = @import("../zig.zig").Guid.initString("af043a0a-b34d-4f86-979c-c90371af6e66");
pub const FWPM_CONDITION_ALE_REMOTE_USER_ID = @import("../zig.zig").Guid.initString("f63073b7-0189-4ab0-95a4-6123cbfab862");
pub const FWPM_CONDITION_ALE_REMOTE_MACHINE_ID = @import("../zig.zig").Guid.initString("1aa47f51-7f93-4508-a271-81abb00c9cab");
pub const FWPM_CONDITION_ALE_PROMISCUOUS_MODE = @import("../zig.zig").Guid.initString("1c974776-7182-46e9-afd3-b02910e30334");
pub const FWPM_CONDITION_ALE_SIO_FIREWALL_SYSTEM_PORT = @import("../zig.zig").Guid.initString("b9f4e088-cb98-4efb-a2c7-ad07332643db");
pub const FWPM_CONDITION_ALE_REAUTH_REASON = @import("../zig.zig").Guid.initString("b482d227-1979-4a98-8044-18bbe6237542");
pub const FWPM_CONDITION_ALE_NAP_CONTEXT = @import("../zig.zig").Guid.initString("46275a9d-c03f-4d77-b784-1c57f4d02753");
pub const FWPM_CONDITION_KM_AUTH_NAP_CONTEXT = @import("../zig.zig").Guid.initString("35d0ea0e-15ca-492b-900e-97fd46352cce");
pub const FWPM_CONDITION_REMOTE_USER_TOKEN = @import("../zig.zig").Guid.initString("9bf0ee66-06c9-41b9-84da-288cb43af51f");
pub const FWPM_CONDITION_RPC_IF_UUID = @import("../zig.zig").Guid.initString("7c9c7d9f-0075-4d35-a0d1-8311c4cf6af1");
pub const FWPM_CONDITION_RPC_IF_VERSION = @import("../zig.zig").Guid.initString("eabfd9b7-1262-4a2e-adaa-5f96f6fe326d");
pub const FWPM_CONDITION_RPC_IF_FLAG = @import("../zig.zig").Guid.initString("238a8a32-3199-467d-871c-272621ab3896");
pub const FWPM_CONDITION_DCOM_APP_ID = @import("../zig.zig").Guid.initString("ff2e7b4d-3112-4770-b636-4d24ae3a6af2");
pub const FWPM_CONDITION_IMAGE_NAME = @import("../zig.zig").Guid.initString("d024de4d-deaa-4317-9c85-e40ef6e140c3");
pub const FWPM_CONDITION_RPC_PROTOCOL = @import("../zig.zig").Guid.initString("2717bc74-3a35-4ce7-b7ef-c838fabdec45");
pub const FWPM_CONDITION_RPC_AUTH_TYPE = @import("../zig.zig").Guid.initString("daba74ab-0d67-43e7-986e-75b84f82f594");
pub const FWPM_CONDITION_RPC_AUTH_LEVEL = @import("../zig.zig").Guid.initString("e5a0aed5-59ac-46ea-be05-a5f05ecf446e");
pub const FWPM_CONDITION_SEC_ENCRYPT_ALGORITHM = @import("../zig.zig").Guid.initString("0d306ef0-e974-4f74-b5c7-591b0da7d562");
pub const FWPM_CONDITION_SEC_KEY_SIZE = @import("../zig.zig").Guid.initString("4772183b-ccf8-4aeb-bce1-c6c6161c8fe4");
pub const FWPM_CONDITION_IP_LOCAL_ADDRESS_V4 = @import("../zig.zig").Guid.initString("03a629cb-6e52-49f8-9c41-5709633c09cf");
pub const FWPM_CONDITION_IP_LOCAL_ADDRESS_V6 = @import("../zig.zig").Guid.initString("2381be84-7524-45b3-a05b-1e637d9c7a6a");
pub const FWPM_CONDITION_PIPE = @import("../zig.zig").Guid.initString("1bd0741d-e3df-4e24-8634-762046eef6eb");
pub const FWPM_CONDITION_IP_REMOTE_ADDRESS_V4 = @import("../zig.zig").Guid.initString("1febb610-3bcc-45e1-bc36-2e067e2cb186");
pub const FWPM_CONDITION_IP_REMOTE_ADDRESS_V6 = @import("../zig.zig").Guid.initString("246e1d8c-8bee-4018-9b98-31d4582f3361");
pub const FWPM_CONDITION_PROCESS_WITH_RPC_IF_UUID = @import("../zig.zig").Guid.initString("e31180a8-bbbd-4d14-a65e-7157b06233bb");
pub const FWPM_CONDITION_RPC_EP_VALUE = @import("../zig.zig").Guid.initString("dccea0b9-0886-4360-9c6a-ab043a24fba9");
pub const FWPM_CONDITION_RPC_EP_FLAGS = @import("../zig.zig").Guid.initString("218b814a-0a39-49b8-8e71-c20c39c7dd2e");
pub const FWPM_CONDITION_CLIENT_TOKEN = @import("../zig.zig").Guid.initString("c228fc1e-403a-4478-be05-c9baa4c05ace");
pub const FWPM_CONDITION_RPC_SERVER_NAME = @import("../zig.zig").Guid.initString("b605a225-c3b3-48c7-9833-7aefa9527546");
pub const FWPM_CONDITION_RPC_SERVER_PORT = @import("../zig.zig").Guid.initString("8090f645-9ad5-4e3b-9f9f-8023ca097909");
pub const FWPM_CONDITION_RPC_PROXY_AUTH_TYPE = @import("../zig.zig").Guid.initString("40953fe2-8565-4759-8488-1771b4b4b5db");
pub const FWPM_CONDITION_CLIENT_CERT_KEY_LENGTH = @import("../zig.zig").Guid.initString("a3ec00c7-05f4-4df7-91f2-5f60d91ff443");
pub const FWPM_CONDITION_CLIENT_CERT_OID = @import("../zig.zig").Guid.initString("c491ad5e-f882-4283-b916-436b103ff4ad");
pub const FWPM_CONDITION_NET_EVENT_TYPE = @import("../zig.zig").Guid.initString("206e9996-490e-40cf-b831-b38641eb6fcb");
pub const FWPM_CONDITION_PEER_NAME = @import("../zig.zig").Guid.initString("9b539082-eb90-4186-a6cc-de5b63235016");
pub const FWPM_CONDITION_REMOTE_ID = @import("../zig.zig").Guid.initString("f68166fd-0682-4c89-b8f5-86436c7ef9b7");
pub const FWPM_CONDITION_AUTHENTICATION_TYPE = @import("../zig.zig").Guid.initString("eb458cd5-da7b-4ef9-8d43-7b0a840332f2");
pub const FWPM_CONDITION_KM_TYPE = @import("../zig.zig").Guid.initString("ff0f5f49-0ceb-481b-8638-1479791f3f2c");
pub const FWPM_CONDITION_KM_MODE = @import("../zig.zig").Guid.initString("feef4582-ef8f-4f7b-858b-9077d122de47");
pub const FWPM_CONDITION_IPSEC_POLICY_KEY = @import("../zig.zig").Guid.initString("ad37dee3-722f-45cc-a4e3-068048124452");
pub const FWPM_CONDITION_QM_MODE = @import("../zig.zig").Guid.initString("f64fc6d1-f9cb-43d2-8a5f-e13bc894f265");
pub const FWPM_CONDITION_COMPARTMENT_ID = @import("../zig.zig").Guid.initString("35a791ab-04ac-4ff2-a6bb-da6cfac71806");
pub const FWPM_CONDITION_RESERVED0 = @import("../zig.zig").Guid.initString("678f4deb-45af-4882-93fe-19d4729d9834");
pub const FWPM_CONDITION_RESERVED1 = @import("../zig.zig").Guid.initString("d818f827-5c69-48eb-bf80-d86b17755f97");
pub const FWPM_CONDITION_RESERVED2 = @import("../zig.zig").Guid.initString("53d4123d-e15b-4e84-b7a8-dce16f7b62d9");
pub const FWPM_CONDITION_RESERVED3 = @import("../zig.zig").Guid.initString("7f6e8ca3-6606-4932-97c7-e1f20710af3b");
pub const FWPM_CONDITION_RESERVED4 = @import("../zig.zig").Guid.initString("5f58e642-b937-495e-a94b-f6b051a49250");
pub const FWPM_CONDITION_RESERVED5 = @import("../zig.zig").Guid.initString("9ba8f6cd-f77c-43e6-8847-11939dc5db5a");
pub const FWPM_CONDITION_RESERVED6 = @import("../zig.zig").Guid.initString("f13d84bd-59d5-44c4-8817-5ecdae1805bd");
pub const FWPM_CONDITION_RESERVED7 = @import("../zig.zig").Guid.initString("65a0f930-45dd-4983-aa33-efc7b611af08");
pub const FWPM_CONDITION_RESERVED8 = @import("../zig.zig").Guid.initString("4f424974-0c12-4816-9b47-9a547db39a32");
pub const FWPM_CONDITION_RESERVED9 = @import("../zig.zig").Guid.initString("ce78e10f-13ff-4c70-8643-36ad1879afa3");
pub const FWPM_CONDITION_RESERVED10 = @import("../zig.zig").Guid.initString("b979e282-d621-4c8c-b184-b105a61c36ce");
pub const FWPM_CONDITION_RESERVED11 = @import("../zig.zig").Guid.initString("2d62ee4d-023d-411f-9582-43acbb795975");
pub const FWPM_CONDITION_RESERVED12 = @import("../zig.zig").Guid.initString("a3677c32-7e35-4ddc-93da-e8c33fc923c7");
pub const FWPM_CONDITION_RESERVED13 = @import("../zig.zig").Guid.initString("335a3e90-84aa-42f5-9e6f-59309536a44c");
pub const FWPM_CONDITION_RESERVED14 = @import("../zig.zig").Guid.initString("30e44da2-2f1a-4116-a559-f907de83604a");
pub const FWPM_CONDITION_RESERVED15 = @import("../zig.zig").Guid.initString("bab8340f-afe0-43d1-80d8-5ca456962de3");
pub const FWPM_PROVIDER_IKEEXT = @import("../zig.zig").Guid.initString("10ad9216-ccde-456c-8b16-e9f04e60a90b");
pub const FWPM_PROVIDER_IPSEC_DOSP_CONFIG = @import("../zig.zig").Guid.initString("3c6c05a9-c05c-4bb9-8338-2327814ce8bf");
pub const FWPM_PROVIDER_TCP_CHIMNEY_OFFLOAD = @import("../zig.zig").Guid.initString("896aa19e-9a34-4bcb-ae79-beb9127c84b9");
pub const FWPM_PROVIDER_TCP_TEMPLATES = @import("../zig.zig").Guid.initString("76cfcd30-3394-432d-bed3-441ae50e63c3");
pub const FWPM_CALLOUT_IPSEC_INBOUND_TRANSPORT_V4 = @import("../zig.zig").Guid.initString("5132900d-5e84-4b5f-80e4-01741e81ff10");
pub const FWPM_CALLOUT_IPSEC_INBOUND_TRANSPORT_V6 = @import("../zig.zig").Guid.initString("49d3ac92-2a6c-4dcf-955f-1c3be009dd99");
pub const FWPM_CALLOUT_IPSEC_OUTBOUND_TRANSPORT_V4 = @import("../zig.zig").Guid.initString("4b46bf0a-4523-4e57-aa38-a87987c910d9");
pub const FWPM_CALLOUT_IPSEC_OUTBOUND_TRANSPORT_V6 = @import("../zig.zig").Guid.initString("38d87722-ad83-4f11-a91f-df0fb077225b");
pub const FWPM_CALLOUT_IPSEC_INBOUND_TUNNEL_V4 = @import("../zig.zig").Guid.initString("191a8a46-0bf8-46cf-b045-4b45dfa6a324");
pub const FWPM_CALLOUT_IPSEC_INBOUND_TUNNEL_V6 = @import("../zig.zig").Guid.initString("80c342e3-1e53-4d6f-9b44-03df5aeee154");
pub const FWPM_CALLOUT_IPSEC_OUTBOUND_TUNNEL_V4 = @import("../zig.zig").Guid.initString("70a4196c-835b-4fb0-98e8-075f4d977d46");
pub const FWPM_CALLOUT_IPSEC_OUTBOUND_TUNNEL_V6 = @import("../zig.zig").Guid.initString("f1835363-a6a5-4e62-b180-23db789d8da6");
pub const FWPM_CALLOUT_IPSEC_FORWARD_INBOUND_TUNNEL_V4 = @import("../zig.zig").Guid.initString("28829633-c4f0-4e66-873f-844db2a899c7");
pub const FWPM_CALLOUT_IPSEC_FORWARD_INBOUND_TUNNEL_V6 = @import("../zig.zig").Guid.initString("af50bec2-c686-429a-884d-b74443e7b0b4");
pub const FWPM_CALLOUT_IPSEC_FORWARD_OUTBOUND_TUNNEL_V4 = @import("../zig.zig").Guid.initString("fb532136-15cb-440b-937c-1717ca320c40");
pub const FWPM_CALLOUT_IPSEC_FORWARD_OUTBOUND_TUNNEL_V6 = @import("../zig.zig").Guid.initString("dae640cc-e021-4bee-9eb6-a48b275c8c1d");
pub const FWPM_CALLOUT_IPSEC_INBOUND_INITIATE_SECURE_V4 = @import("../zig.zig").Guid.initString("7dff309b-ba7d-4aba-91aa-ae5c6640c944");
pub const FWPM_CALLOUT_IPSEC_INBOUND_INITIATE_SECURE_V6 = @import("../zig.zig").Guid.initString("a9a0d6d9-c58c-474e-8aeb-3cfe99d6d53d");
pub const FWPM_CALLOUT_IPSEC_INBOUND_TUNNEL_ALE_ACCEPT_V4 = @import("../zig.zig").Guid.initString("3df6e7de-fd20-48f2-9f26-f854444cba79");
pub const FWPM_CALLOUT_IPSEC_INBOUND_TUNNEL_ALE_ACCEPT_V6 = @import("../zig.zig").Guid.initString("a1e392d3-72ac-47bb-87a7-0122c69434ab");
pub const FWPM_CALLOUT_IPSEC_ALE_CONNECT_V4 = @import("../zig.zig").Guid.initString("6ac141fc-f75d-4203-b9c8-48e6149c2712");
pub const FWPM_CALLOUT_IPSEC_ALE_CONNECT_V6 = @import("../zig.zig").Guid.initString("4c0dda05-e31f-4666-90b0-b3dfad34129a");
pub const FWPM_CALLOUT_IPSEC_DOSP_FORWARD_V6 = @import("../zig.zig").Guid.initString("6d08a342-db9e-4fbe-9ed2-57374ce89f79");
pub const FWPM_CALLOUT_IPSEC_DOSP_FORWARD_V4 = @import("../zig.zig").Guid.initString("2fcb56ec-cd37-4b4f-b108-62c2b1850a0c");
pub const FWPM_CALLOUT_WFP_TRANSPORT_LAYER_V4_SILENT_DROP = @import("../zig.zig").Guid.initString("eda08606-2494-4d78-89bc-67837c03b969");
pub const FWPM_CALLOUT_WFP_TRANSPORT_LAYER_V6_SILENT_DROP = @import("../zig.zig").Guid.initString("8693cc74-a075-4156-b476-9286eece814e");
pub const FWPM_CALLOUT_TCP_CHIMNEY_CONNECT_LAYER_V4 = @import("../zig.zig").Guid.initString("f3e10ab3-2c25-4279-ac36-c30fc181bec4");
pub const FWPM_CALLOUT_TCP_CHIMNEY_CONNECT_LAYER_V6 = @import("../zig.zig").Guid.initString("39e22085-a341-42fc-a279-aec94e689c56");
pub const FWPM_CALLOUT_TCP_CHIMNEY_ACCEPT_LAYER_V4 = @import("../zig.zig").Guid.initString("e183ecb2-3a7f-4b54-8ad9-76050ed880ca");
pub const FWPM_CALLOUT_TCP_CHIMNEY_ACCEPT_LAYER_V6 = @import("../zig.zig").Guid.initString("0378cf41-bf98-4603-81f2-7f12586079f6");
pub const FWPM_CALLOUT_SET_OPTIONS_AUTH_CONNECT_LAYER_V4 = @import("../zig.zig").Guid.initString("bc582280-1677-41e9-94ab-c2fcb15c2eeb");
pub const FWPM_CALLOUT_SET_OPTIONS_AUTH_CONNECT_LAYER_V6 = @import("../zig.zig").Guid.initString("98e5373c-b884-490f-b65f-2f6a4a575195");
pub const FWPM_CALLOUT_SET_OPTIONS_AUTH_RECV_ACCEPT_LAYER_V4 = @import("../zig.zig").Guid.initString("2d55f008-0c01-4f92-b26e-a08a94569b8d");
pub const FWPM_CALLOUT_SET_OPTIONS_AUTH_RECV_ACCEPT_LAYER_V6 = @import("../zig.zig").Guid.initString("63018537-f281-4dc4-83d3-8dec18b7ade2");
pub const FWPM_CALLOUT_RESERVED_AUTH_CONNECT_LAYER_V4 = @import("../zig.zig").Guid.initString("288b524d-0566-4e19-b612-8f441a2e5949");
pub const FWPM_CALLOUT_RESERVED_AUTH_CONNECT_LAYER_V6 = @import("../zig.zig").Guid.initString("00b84b92-2b5e-4b71-ab0e-aaca43e387e6");
pub const FWPM_CALLOUT_TEREDO_ALE_RESOURCE_ASSIGNMENT_V6 = @import("../zig.zig").Guid.initString("31b95392-066e-42a2-b7db-92f8acdd56f9");
pub const FWPM_CALLOUT_EDGE_TRAVERSAL_ALE_RESOURCE_ASSIGNMENT_V4 = @import("../zig.zig").Guid.initString("079b1010-f1c5-4fcd-ae05-da41107abd0b");
pub const FWPM_CALLOUT_TEREDO_ALE_LISTEN_V6 = @import("../zig.zig").Guid.initString("81a434e7-f60c-4378-bab8-c625a30f0197");
pub const FWPM_CALLOUT_EDGE_TRAVERSAL_ALE_LISTEN_V4 = @import("../zig.zig").Guid.initString("33486ab5-6d5e-4e65-a00b-a7afed0ba9a1");
pub const FWPM_CALLOUT_TCP_TEMPLATES_CONNECT_LAYER_V4 = @import("../zig.zig").Guid.initString("215a0b39-4b7e-4eda-8ce4-179679df6224");
pub const FWPM_CALLOUT_TCP_TEMPLATES_CONNECT_LAYER_V6 = @import("../zig.zig").Guid.initString("838b37a1-5c12-4d34-8b38-078728b2d25c");
pub const FWPM_CALLOUT_TCP_TEMPLATES_ACCEPT_LAYER_V4 = @import("../zig.zig").Guid.initString("2f23f5d0-40c4-4c41-a254-46d8dba8957c");
pub const FWPM_CALLOUT_TCP_TEMPLATES_ACCEPT_LAYER_V6 = @import("../zig.zig").Guid.initString("b25152f0-991c-4f53-bbe7-d24b45fe632c");
pub const FWPM_CALLOUT_POLICY_SILENT_MODE_AUTH_CONNECT_LAYER_V4 = @import("../zig.zig").Guid.initString("5fbfc31d-a51c-44dc-acb6-0624a030a700");
pub const FWPM_CALLOUT_POLICY_SILENT_MODE_AUTH_CONNECT_LAYER_V6 = @import("../zig.zig").Guid.initString("5fbfc31d-a51c-44dc-acb6-0624a030a701");
pub const FWPM_CALLOUT_POLICY_SILENT_MODE_AUTH_RECV_ACCEPT_LAYER_V4 = @import("../zig.zig").Guid.initString("5fbfc31d-a51c-44dc-acb6-0624a030a702");
pub const FWPM_CALLOUT_POLICY_SILENT_MODE_AUTH_RECV_ACCEPT_LAYER_V6 = @import("../zig.zig").Guid.initString("5fbfc31d-a51c-44dc-acb6-0624a030a703");
pub const FWPM_CALLOUT_HTTP_TEMPLATE_SSL_HANDSHAKE = @import("../zig.zig").Guid.initString("b3423249-8d09-4858-9210-95c7fda8e30f");
pub const FWPM_PROVIDER_CONTEXT_SECURE_SOCKET_AUTHIP = @import("../zig.zig").Guid.initString("b25ea800-0d02-46ed-92bd-7fa84bb73e9d");
pub const FWPM_PROVIDER_CONTEXT_SECURE_SOCKET_IPSEC = @import("../zig.zig").Guid.initString("8c2d4144-f8e0-42c0-94ce-7ccfc63b2f9b");
pub const FWPM_KEYING_MODULE_IKE = @import("../zig.zig").Guid.initString("a9bbf787-82a8-45bb-a400-5d7e5952c7a9");
pub const FWPM_KEYING_MODULE_AUTHIP = @import("../zig.zig").Guid.initString("11e3dae0-dd26-4590-857d-ab4b28d1a095");
pub const FWPM_KEYING_MODULE_IKEV2 = @import("../zig.zig").Guid.initString("041792cc-8f07-419d-a394-716968cb1647");
...
pub const FWPM_TUNNEL_FLAG_SITE_TO_SITE : u32 = 4;
pub const DL_HEADER_LENGTH_MAXIMUM : u32 = 64;
pub const SNAP_DSAP : u32 = 170;
pub const SNAP_SSAP : u32 = 170;
pub const SNAP_CONTROL : u32 = 3;
pub const SNAP_OUI : u32 = 0;
pub const ETH_LENGTH_OF_HEADER : u32 = 14;
pub const ETH_LENGTH_OF_VLAN_HEADER : u32 = 4;
pub const ETH_LENGTH_OF_SNAP_HEADER : u32 = 8;
pub const ETHERNET_TYPE_MINIMUM : u32 = 1536;
pub const ETHERNET_TYPE_IPV4 : u32 = 2048;
pub const ETHERNET_TYPE_ARP : u32 = 2054;
pub const ETHERNET_TYPE_IPV6 : u32 = 34525;
pub const ETHERNET_TYPE_802_1Q : u32 = 33024;
pub const IP_VER_MASK : u32 = 240;
pub const IPV4_VERSION : u32 = 4;
pub const MAX_IPV4_PACKET : u32 = 65535;
pub const MAX_IPV4_HLEN : u32 = 60;
pub const IPV4_MINIMUM_MTU : u32 = 576;
pub const IPV4_MIN_MINIMUM_MTU : u32 = 352;
pub const SIZEOF_IP_OPT_ROUTING_HEADER : u32 = 3;
pub const SIZEOF_IP_OPT_TIMESTAMP_HEADER : u32 = 4;
pub const SIZEOF_IP_OPT_SECURITY : u32 = 11;
pub const SIZEOF_IP_OPT_STREAMIDENTIFIER : u32 = 4;
pub const SIZEOF_IP_OPT_ROUTERALERT : u32 = 4;
pub const IP4_OFF_MASK : u32 = 65311;
pub const ICMPV4_INVALID_PREFERENCE_LEVEL : u32 = 2147483648;
pub const IGMP_QUERY_TYPE : u32 = 17;
pub const IGMP_VERSION1_REPORT_TYPE : u32 = 18;
pub const IGMP_VERSION2_REPORT_TYPE : u32 = 22;
pub const IGMP_LEAVE_GROUP_TYPE : u32 = 23;
pub const IGMP_VERSION3_REPORT_TYPE : u32 = 34;
pub const IPV6_VERSION : u32 = 96;
pub const IPV6_TRAFFIC_CLASS_MASK : u32 = 49167;
pub const IPV6_FULL_TRAFFIC_CLASS_MASK : u32 = 61455;
pub const IPV6_ECN_MASK : u32 = 12288;
pub const IPV6_FLOW_LABEL_MASK : u32 = 4294905600;
pub const MAX_IPV6_PAYLOAD : u32 = 65535;
pub const IPV6_ECN_SHIFT : u32 = 12;
pub const IPV6_MINIMUM_MTU : u32 = 1280;
pub const IP6F_OFF_MASK : u32 = 63743;
pub const IP6F_RESERVED_MASK : u32 = 1536;
pub const IP6F_MORE_FRAG : u32 = 256;
pub const EXT_LEN_UNIT : u32 = 8;
...
pub const ICMPV6_ECHO_REQUEST_FLAG_REVERSE : u32 = 1;
pub const ND_RA_FLAG_MANAGED : u32 = 128;
pub const ND_RA_FLAG_OTHER : u32 = 64;
pub const ND_RA_FLAG_HOME_AGENT : u32 = 32;
pub const ND_RA_FLAG_PREFERENCE : u32 = 24;
pub const ND_NA_FLAG_ROUTER : u32 = 2147483648;
pub const ND_NA_FLAG_SOLICITED : u32 = 1073741824;
pub const ND_NA_FLAG_OVERRIDE : u32 = 536870912;
pub const ND_OPT_PI_FLAG_ONLINK : u32 = 128;
pub const ND_OPT_PI_FLAG_AUTO : u32 = 64;
pub const ND_OPT_PI_FLAG_ROUTER_ADDR : u32 = 32;
pub const ND_OPT_PI_FLAG_SITE_PREFIX : u32 = 16;
pub const ND_OPT_PI_FLAG_ROUTE : u32 = 1;
pub const ND_OPT_RI_FLAG_PREFERENCE : u32 = 24;
pub const ND_OPT_RDNSS_MIN_LEN : u32 = 24;
pub const ND_OPT_DNSSL_MIN_LEN : u32 = 16;
pub const IN6_EMBEDDEDV4_UOCTET_POSITION : u32 = 8;
pub const IN6_EMBEDDEDV4_BITS_IN_BYTE : u32 = 8;
pub const TH_FIN : u32 = 1;
pub const TH_SYN : u32 = 2;
pub const TH_RST : u32 = 4;
pub const TH_PSH : u32 = 8;
pub const TH_ACK : u32 = 16;
pub const TH_URG : u32 = 32;
pub const TH_ECE : u32 = 64;
pub const TH_CWR : u32 = 128;
pub const TH_OPT_EOL : u32 = 0;
pub const TH_OPT_NOP : u32 = 1;
pub const TH_OPT_MSS : u32 = 2;
pub const TH_OPT_WS : u32 = 3;
pub const TH_OPT_SACK_PERMITTED : u32 = 4;
pub const TH_OPT_SACK : u32 = 5;
pub const TH_OPT_TS : u32 = 8;
pub const TH_OPT_FASTOPEN : u32 = 34;

//--------------------------------------------------------------------------------
// Section: Types (346)
//--------------------------------------------------------------------------------
// TODO: This Enum is marked as [Flags], what do I do with this?
pub const FWPM_NET_EVENT_KEYWORD_INBOUND = extern enum(u32) {
    MCAST = 1,
    BCAST = 2,
    _,
};
pub const FWPM_NET_EVENT_KEYWORD_INBOUND_MCAST = FWPM_NET_EVENT_KEYWORD_INBOUND.MCAST;
pub const FWPM_NET_EVENT_KEYWORD_INBOUND_BCAST = FWPM_NET_EVENT_KEYWORD_INBOUND.BCAST;
...
pub const FWP_DATA_TYPE = extern enum(i32) {
    ...
    BYTE_ARRAY6_TYPE = 18,
    BITMAP_INDEX_TYPE = 19,
    BITMAP_ARRAY64_TYPE = 20,
...
pub const FWP_BITMAP_INDEX_TYPE = FWP_DATA_TYPE.BITMAP_INDEX_TYPE;
pub const FWP_BITMAP_ARRAY64_TYPE = FWP_DATA_TYPE.BITMAP_ARRAY64_TYPE;
...
pub extern "fwpuclnt" fn FwpmEngineGetOption0(
    ...
    value: FWPM_NET_EVENT_KEYWORD_INBOUND,
) callconv(@import("std").os.windows.WINAPI) u32;

pub extern "fwpuclnt" fn FwpmEngineSetOption0(
    engineHandle: HANDLE,
    option: FWPM_ENGINE_OPTION,
    newValue: FWPM_NET_EVENT_KEYWORD_INBOUND,
) callconv(@import("std").os.windows.WINAPI) u32;
...
test {
    ...
    const constant_export_count = 591;
    const type_export_count = 346;
    const enum_value_export_count = 391;
