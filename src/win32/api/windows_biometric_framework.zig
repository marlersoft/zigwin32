...
pub const WINBIO_IDENTITY = extern struct {
    Type: u32,
    Value: WINBIO_IDENTITY._Value_e__Union,
...
pub const WINBIO_BIR_HEADER = extern struct {
    ...
    ValidityPeriod: WINBIO_BIR_HEADER._ValidityPeriod_e__Struct,
...
pub const WINBIO_EVENT = extern struct {
    Type: u32,
    Parameters: WINBIO_EVENT._Parameters_e__Union,
    const _Parameters_e__Union = u32; // TODO: generate this nested type!
};

pub const WINBIO_PRESENCE_PROPERTIES = u32; // TODO: implement StructOrUnion types?
...
pub const WINBIO_PRESENCE = extern struct {
    ...
    Authorization: WINBIO_PRESENCE._Authorization_e__Struct,
...
pub const WINBIO_EXTENDED_SENSOR_INFO = extern struct {
    ...
    Factor: u32,
    Specific: WINBIO_EXTENDED_SENSOR_INFO._Specific_e__Union,
...
pub const WINBIO_EXTENDED_ENGINE_INFO = extern struct {
    ...
    Factor: u32,
    Specific: WINBIO_EXTENDED_ENGINE_INFO._Specific_e__Union,
    const _Specific_e__Union = u32; // TODO: generate this nested type!
};
...
pub const WINBIO_EXTENDED_STORAGE_INFO = extern struct {
    ...
    Factor: u32,
    Specific: WINBIO_EXTENDED_STORAGE_INFO._Specific_e__Union,
    const _Specific_e__Union = u32; // TODO: generate this nested type!
};
...
pub const WINBIO_EXTENDED_ENROLLMENT_STATUS = extern struct {
    ...
    Factor: u32,
    SubFactor: u8,
    Specific: WINBIO_EXTENDED_ENROLLMENT_STATUS._Specific_e__Union,
    const _Specific_e__Union = u32; // TODO: generate this nested type!
};
...
pub const WINBIO_ANTI_SPOOF_DISABLE = WINBIO_ANTI_SPOOF_POLICY_ACTION.WINBIO_ANTI_SPOOF_DISABLE;
pub const WINBIO_ANTI_SPOOF_ENABLE = WINBIO_ANTI_SPOOF_POLICY_ACTION.WINBIO_ANTI_SPOOF_ENABLE;
pub const WINBIO_ANTI_SPOOF_REMOVE = WINBIO_ANTI_SPOOF_POLICY_ACTION.WINBIO_ANTI_SPOOF_REMOVE;
...
pub const WINBIO_POLICY_UNKNOWN = WINBIO_POLICY_SOURCE.WINBIO_POLICY_UNKNOWN;
pub const WINBIO_POLICY_DEFAULT = WINBIO_POLICY_SOURCE.WINBIO_POLICY_DEFAULT;
pub const WINBIO_POLICY_LOCAL = WINBIO_POLICY_SOURCE.WINBIO_POLICY_LOCAL;
pub const WINBIO_POLICY_ADMIN = WINBIO_POLICY_SOURCE.WINBIO_POLICY_ADMIN;
...
pub const WINBIO_CREDENTIAL_PASSWORD = WINBIO_CREDENTIAL_TYPE.WINBIO_CREDENTIAL_PASSWORD;
pub const WINBIO_CREDENTIAL_ALL = WINBIO_CREDENTIAL_TYPE.WINBIO_CREDENTIAL_ALL;
...
pub const WINBIO_PASSWORD_GENERIC = WINBIO_CREDENTIAL_FORMAT.WINBIO_PASSWORD_GENERIC;
pub const WINBIO_PASSWORD_PACKED = WINBIO_CREDENTIAL_FORMAT.WINBIO_PASSWORD_PACKED;
pub const WINBIO_PASSWORD_PROTECTED = WINBIO_CREDENTIAL_FORMAT.WINBIO_PASSWORD_PROTECTED;

pub const WINBIO_CREDENTIAL_STATE = extern enum(i32) {
    WINBIO_CREDENTIAL_NOT_SET = 1,
    WINBIO_CREDENTIAL_SET = 2,
};
pub const WINBIO_CREDENTIAL_NOT_SET = WINBIO_CREDENTIAL_STATE.WINBIO_CREDENTIAL_NOT_SET;
pub const WINBIO_CREDENTIAL_SET = WINBIO_CREDENTIAL_STATE.WINBIO_CREDENTIAL_SET;
...
pub const WINBIO_ASYNC_NOTIFY_NONE = WINBIO_ASYNC_NOTIFICATION_METHOD.WINBIO_ASYNC_NOTIFY_NONE;
pub const WINBIO_ASYNC_NOTIFY_CALLBACK = WINBIO_ASYNC_NOTIFICATION_METHOD.WINBIO_ASYNC_NOTIFY_CALLBACK;
pub const WINBIO_ASYNC_NOTIFY_MESSAGE = WINBIO_ASYNC_NOTIFICATION_METHOD.WINBIO_ASYNC_NOTIFY_MESSAGE;
pub const WINBIO_ASYNC_NOTIFY_MAXIMUM_VALUE = WINBIO_ASYNC_NOTIFICATION_METHOD.WINBIO_ASYNC_NOTIFY_MAXIMUM_VALUE;
...
pub const WINBIO_ASYNC_RESULT = extern struct {
    ...
    UnitId: u32,
    UserData: *c_void,
    Parameters: WINBIO_ASYNC_RESULT._Parameters_e__Union,
    const _Parameters_e__Union = u32; // TODO: generate this nested type!
};
