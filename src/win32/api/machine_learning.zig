...
pub const WINML_TENSOR_UNDEFINED = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_UNDEFINED;
pub const WINML_TENSOR_FLOAT = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_FLOAT;
pub const WINML_TENSOR_UINT8 = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_UINT8;
pub const WINML_TENSOR_INT8 = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_INT8;
pub const WINML_TENSOR_UINT16 = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_UINT16;
pub const WINML_TENSOR_INT16 = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_INT16;
pub const WINML_TENSOR_INT32 = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_INT32;
pub const WINML_TENSOR_INT64 = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_INT64;
pub const WINML_TENSOR_STRING = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_STRING;
pub const WINML_TENSOR_BOOLEAN = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_BOOLEAN;
pub const WINML_TENSOR_FLOAT16 = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_FLOAT16;
pub const WINML_TENSOR_DOUBLE = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_DOUBLE;
pub const WINML_TENSOR_UINT32 = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_UINT32;
pub const WINML_TENSOR_UINT64 = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_UINT64;
pub const WINML_TENSOR_COMPLEX64 = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_COMPLEX64;
pub const WINML_TENSOR_COMPLEX128 = WINML_TENSOR_DATA_TYPE.WINML_TENSOR_COMPLEX128;
...
pub const WINML_FEATURE_UNDEFINED = WINML_FEATURE_TYPE.WINML_FEATURE_UNDEFINED;
pub const WINML_FEATURE_TENSOR = WINML_FEATURE_TYPE.WINML_FEATURE_TENSOR;
pub const WINML_FEATURE_SEQUENCE = WINML_FEATURE_TYPE.WINML_FEATURE_SEQUENCE;
pub const WINML_FEATURE_MAP = WINML_FEATURE_TYPE.WINML_FEATURE_MAP;
pub const WINML_FEATURE_IMAGE = WINML_FEATURE_TYPE.WINML_FEATURE_IMAGE;
...
pub const WINML_BINDING_UNDEFINED = WINML_BINDING_TYPE.WINML_BINDING_UNDEFINED;
pub const WINML_BINDING_TENSOR = WINML_BINDING_TYPE.WINML_BINDING_TENSOR;
pub const WINML_BINDING_SEQUENCE = WINML_BINDING_TYPE.WINML_BINDING_SEQUENCE;
pub const WINML_BINDING_MAP = WINML_BINDING_TYPE.WINML_BINDING_MAP;
pub const WINML_BINDING_IMAGE = WINML_BINDING_TYPE.WINML_BINDING_IMAGE;
pub const WINML_BINDING_RESOURCE = WINML_BINDING_TYPE.WINML_BINDING_RESOURCE;
...
pub const WINML_RUNTIME_CNTK = WINML_RUNTIME_TYPE.WINML_RUNTIME_CNTK;
...
pub const Undefined = MLOperatorAttributeType.Undefined;
pub const Float = MLOperatorAttributeType.Float;
pub const Int = MLOperatorAttributeType.Int;
pub const String = MLOperatorAttributeType.String;
pub const FloatArray = MLOperatorAttributeType.FloatArray;
pub const IntArray = MLOperatorAttributeType.IntArray;
pub const StringArray = MLOperatorAttributeType.StringArray;
...
// TODO: enum 'MLOperatorTensorDataType' has known value symbol conflicts, skipping the value aliases

pub const MLOperatorEdgeType = extern enum(u32) {
    Undefined = 0,
    Tensor = 1,
};
// TODO: enum 'MLOperatorEdgeType' has known value symbol conflicts, skipping the value aliases
...
pub const Variadic = MLOperatorParameterOptions.Variadic;

pub const MLOperatorSchemaEdgeTypeFormat = extern enum(i32) {
    EdgeDescription = 0,
    Label = 1,
};
pub const EdgeDescription = MLOperatorSchemaEdgeTypeFormat.EdgeDescription;
pub const Label = MLOperatorSchemaEdgeTypeFormat.Label;
...
pub const None = MLOperatorKernelOptions.None;
pub const AllowDynamicInputShapes = MLOperatorKernelOptions.AllowDynamicInputShapes;
...
// TODO: enum 'MLOperatorExecutionType' has known value symbol conflicts, skipping the value aliases
