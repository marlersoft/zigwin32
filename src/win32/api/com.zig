...
pub const OLEMISC_INVISIBLEATRUNTIME = @as(i32, 1024);
pub const OLEMISC_ALWAYSRUN = @as(i32, 2048);
pub const OLEMISC_ACTSLIKEBUTTON = @as(i32, 4096);
pub const OLEMISC_ACTSLIKELABEL = @as(i32, 8192);
pub const OLEMISC_NOUIACTIVATE = @as(i32, 16384);
pub const OLEMISC_ALIGNABLE = @as(i32, 32768);
pub const OLEMISC_SIMPLEFRAME = @as(i32, 65536);
pub const OLEMISC_SETCLIENTSITEFIRST = @as(i32, 131072);
pub const OLEMISC_IMEMODE = @as(i32, 262144);
