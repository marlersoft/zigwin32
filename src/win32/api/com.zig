...
//--------------------------------------------------------------------------------
pub const CLSID_CFontPropPage = @import("../zig.zig").Guid.initString("0be35200-8f91-11ce-9de3-00aa004bb851");
pub const CLSID_CColorPropPage = @import("../zig.zig").Guid.initString("0be35201-8f91-11ce-9de3-00aa004bb851");
pub const CLSID_CPicturePropPage = @import("../zig.zig").Guid.initString("0be35202-8f91-11ce-9de3-00aa004bb851");
pub const CLSID_PersistPropset = @import("../zig.zig").Guid.initString("fb8f0821-0164-101b-84ed-08002b2ec713");
pub const CLSID_ConvertVBX = @import("../zig.zig").Guid.initString("fb8f0822-0164-101b-84ed-08002b2ec713");
pub const CLSID_StdFont = @import("../zig.zig").Guid.initString("0be35203-8f91-11ce-9de3-00aa004bb851");
pub const CLSID_StdPicture = @import("../zig.zig").Guid.initString("0be35204-8f91-11ce-9de3-00aa004bb851");
pub const GUID_HIMETRIC = @import("../zig.zig").Guid.initString("66504300-be0f-101a-8bbb-00aa00300cab");
pub const GUID_COLOR = @import("../zig.zig").Guid.initString("66504301-be0f-101a-8bbb-00aa00300cab");
pub const GUID_XPOSPIXEL = @import("../zig.zig").Guid.initString("66504302-be0f-101a-8bbb-00aa00300cab");
pub const GUID_YPOSPIXEL = @import("../zig.zig").Guid.initString("66504303-be0f-101a-8bbb-00aa00300cab");
pub const GUID_XSIZEPIXEL = @import("../zig.zig").Guid.initString("66504304-be0f-101a-8bbb-00aa00300cab");
pub const GUID_YSIZEPIXEL = @import("../zig.zig").Guid.initString("66504305-be0f-101a-8bbb-00aa00300cab");
pub const GUID_XPOS = @import("../zig.zig").Guid.initString("66504306-be0f-101a-8bbb-00aa00300cab");
pub const GUID_YPOS = @import("../zig.zig").Guid.initString("66504307-be0f-101a-8bbb-00aa00300cab");
pub const GUID_XSIZE = @import("../zig.zig").Guid.initString("66504308-be0f-101a-8bbb-00aa00300cab");
pub const GUID_YSIZE = @import("../zig.zig").Guid.initString("66504309-be0f-101a-8bbb-00aa00300cab");
pub const GUID_TRISTATE = @import("../zig.zig").Guid.initString("6650430a-be0f-101a-8bbb-00aa00300cab");
pub const GUID_OPTIONVALUEEXCLUSIVE = @import("../zig.zig").Guid.initString("6650430b-be0f-101a-8bbb-00aa00300cab");
pub const GUID_CHECKVALUEEXCLUSIVE = @import("../zig.zig").Guid.initString("6650430c-be0f-101a-8bbb-00aa00300cab");
pub const GUID_FONTNAME = @import("../zig.zig").Guid.initString("6650430d-be0f-101a-8bbb-00aa00300cab");
pub const GUID_FONTSIZE = @import("../zig.zig").Guid.initString("6650430e-be0f-101a-8bbb-00aa00300cab");
pub const GUID_FONTBOLD = @import("../zig.zig").Guid.initString("6650430f-be0f-101a-8bbb-00aa00300cab");
pub const GUID_FONTITALIC = @import("../zig.zig").Guid.initString("66504310-be0f-101a-8bbb-00aa00300cab");
pub const GUID_FONTUNDERSCORE = @import("../zig.zig").Guid.initString("66504311-be0f-101a-8bbb-00aa00300cab");
pub const GUID_FONTSTRIKETHROUGH = @import("../zig.zig").Guid.initString("66504312-be0f-101a-8bbb-00aa00300cab");
pub const GUID_HANDLE = @import("../zig.zig").Guid.initString("66504313-be0f-101a-8bbb-00aa00300cab");
...
pub const IOF_SHOWHELP : i32 = 1;
pub const IOF_SELECTCREATENEW : i32 = 2;
pub const IOF_SELECTCREATEFROMFILE : i32 = 4;
pub const IOF_CHECKLINK : i32 = 8;
pub const IOF_CHECKDISPLAYASICON : i32 = 16;
pub const IOF_CREATENEWOBJECT : i32 = 32;
pub const IOF_CREATEFILEOBJECT : i32 = 64;
pub const IOF_CREATELINKOBJECT : i32 = 128;
pub const IOF_DISABLELINK : i32 = 256;
pub const IOF_VERIFYSERVERSEXIST : i32 = 512;
pub const IOF_DISABLEDISPLAYASICON : i32 = 1024;
pub const IOF_HIDECHANGEICON : i32 = 2048;
pub const IOF_SHOWINSERTCONTROL : i32 = 4096;
pub const IOF_SELECTCREATECONTROL : i32 = 8192;
pub const PS_MAXLINKTYPES : u32 = 8;
pub const PSF_SHOWHELP : i32 = 1;
pub const PSF_SELECTPASTE : i32 = 2;
pub const PSF_SELECTPASTELINK : i32 = 4;
pub const PSF_CHECKDISPLAYASICON : i32 = 8;
pub const PSF_DISABLEDISPLAYASICON : i32 = 16;
pub const PSF_HIDECHANGEICON : i32 = 32;
pub const PSF_STAYONCLIPBOARDCHANGE : i32 = 64;
pub const PSF_NOREFRESHDATAOBJECT : i32 = 128;
pub const ELF_SHOWHELP : i32 = 1;
pub const ELF_DISABLEUPDATENOW : i32 = 2;
pub const ELF_DISABLEOPENSOURCE : i32 = 4;
pub const ELF_DISABLECHANGESOURCE : i32 = 8;
pub const ELF_DISABLECANCELLINK : i32 = 16;
pub const CIF_SHOWHELP : i32 = 1;
pub const CIF_SELECTCURRENT : i32 = 2;
pub const CIF_SELECTDEFAULT : i32 = 4;
pub const CIF_SELECTFROMFILE : i32 = 8;
pub const CIF_USEICONEXE : i32 = 16;
pub const CF_SHOWHELPBUTTON : i32 = 1;
pub const CF_SETCONVERTDEFAULT : i32 = 2;
pub const CF_SETACTIVATEDEFAULT : i32 = 4;
pub const CF_SELECTCONVERTTO : i32 = 8;
pub const CF_SELECTACTIVATEAS : i32 = 16;
pub const CF_DISABLEDISPLAYASICON : i32 = 32;
pub const CF_DISABLEACTIVATEAS : i32 = 64;
pub const CF_HIDECHANGEICON : i32 = 128;
pub const CF_CONVERTONLY : i32 = 256;
pub const BZ_DISABLECANCELBUTTON : i32 = 1;
pub const BZ_DISABLESWITCHTOBUTTON : i32 = 2;
pub const BZ_DISABLERETRYBUTTON : i32 = 4;
pub const BZ_NOTRESPONDINGDIALOG : i32 = 8;
pub const CSF_SHOWHELP : i32 = 1;
pub const CSF_VALIDSOURCE : i32 = 2;
pub const CSF_ONLYGETSOURCE : i32 = 4;
pub const CSF_EXPLORER : i32 = 8;
pub const VPF_SELECTRELATIVE : i32 = 1;
pub const VPF_DISABLERELATIVE : i32 = 2;
pub const VPF_DISABLESCALE : i32 = 4;
pub const OPF_OBJECTISLINK : i32 = 1;
pub const OPF_NOFILLDEFAULT : i32 = 2;
pub const OPF_SHOWHELP : i32 = 4;
pub const OPF_DISABLECONVERT : i32 = 8;
...
pub const MK_S_ASYNCHRONOUS : i32 = 262632;
pub const INET_E_CANNOT_LOCK_REQUEST : i32 = -2146697194;
pub const INET_E_USE_EXTEND_BINDING : i32 = -2146697193;
pub const INET_E_TERMINATED_BIND : i32 = -2146697192;
pub const INET_E_RESERVED_1 : i32 = -2146697190;
pub const INET_E_BLOCKED_REDIRECT_XSECURITYID : i32 = -2146697189;
pub const INET_E_DOMINJECTIONVALIDATION : i32 = -2146697188;
pub const INET_E_VTAB_SWITCH_FORCE_ENGINE : i32 = -2146697187;
pub const INET_E_HSTS_CERTIFICATE_ERROR : i32 = -2146697186;
pub const INET_E_RESERVED_2 : i32 = -2146697185;
pub const INET_E_RESERVED_3 : i32 = -2146697184;
pub const INET_E_RESERVED_4 : i32 = -2146697183;
pub const INET_E_RESERVED_5 : i32 = -2146697182;
pub const INET_E_ERROR_FIRST : i32 = -2146697214;
pub const INET_E_CODE_DOWNLOAD_DECLINED : i32 = -2146696960;
pub const INET_E_RESULT_DISPATCHED : i32 = -2146696704;
pub const INET_E_CANNOT_REPLACE_SFP_FILE : i32 = -2146696448;
pub const INET_E_CODE_INSTALL_SUPPRESSED : i32 = -2146696192;
pub const INET_E_CODE_INSTALL_BLOCKED_BY_HASH_POLICY : i32 = -2146695936;
pub const INET_E_DOWNLOAD_BLOCKED_BY_INPRIVATE : i32 = -2146695935;
pub const INET_E_CODE_INSTALL_BLOCKED_IMMERSIVE : i32 = -2146695934;
pub const INET_E_FORBIDFRAMING : i32 = -2146695933;
pub const INET_E_CODE_INSTALL_BLOCKED_ARM : i32 = -2146695932;
pub const INET_E_BLOCKED_PLUGGABLE_PROTOCOL : i32 = -2146695931;
pub const INET_E_BLOCKED_ENHANCEDPROTECTEDMODE : i32 = -2146695930;
pub const INET_E_CODE_INSTALL_BLOCKED_BITNESS : i32 = -2146695929;
pub const INET_E_DOWNLOAD_BLOCKED_BY_CSP : i32 = -2146695928;
...
pub const INET_E_USE_DEFAULT_PROTOCOLHANDLER : i32 = -2146697199;
pub const INET_E_USE_DEFAULT_SETTING : i32 = -2146697198;
pub const INET_E_QUERYOPTION_UNKNOWN : i32 = -2146697197;
pub const INET_E_REDIRECTING : i32 = -2146697196;
...
pub const IInternetProtocolRoot = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetProtocolRoot_Start(self: *const T, szUrl: [*:0]const u16, pOIProtSink: *IInternetProtocolSink, pOIBindInfo: *IInternetBindInfo, grfPI: u32, dwReserved: u32) callconv(.Inline) HRESULT {
...
pub const IInternetProtocolEx = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IInternetProtocolEx_StartEx(self: *const T, pUri: *IUri, pOIProtSink: *IInternetProtocolSink, pOIBindInfo: *IInternetBindInfo, grfPI: u32, dwReserved: u32) callconv(.Inline) HRESULT {
...
test {
    ...
    const constant_export_count = 724;
    const type_export_count = 492;
    const enum_value_export_count = 966;
    const com_iface_id_export_count = 240;
