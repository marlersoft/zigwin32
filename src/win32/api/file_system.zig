...
pub const FindChangeNotificationHandle = ?*c_void;
...
// TODO: enum 'ReOpenFile_dwFlagsAndAttributes' has known issues with its value aliases
...
test {
    ...
    const enum_value_export_count = 653;
