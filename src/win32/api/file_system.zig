...
pub const DISK_CACHE_INFORMATION = extern struct {
    ...
    ReadRetentionPriority: DISK_CACHE_INFORMATION_ReadRetentionPriorityFlags,
...
pub const USN_RECORD_V4 = extern struct {
    ...
    Usn: i64,
    Reason: u32,
    SourceInfo: USN_RECORD_V4_SourceInfoFlags,
...
pub const DELETE_USN_JOURNAL_DATA = extern struct {
    UsnJournalID: u64,
    DeleteFlags: DELETE_USN_JOURNAL_DATAFlags,
};
...
pub const FILE_SHARE_NONE = FILE_SHARE_FLAGS.NONE;
pub const FILE_SHARE_DELETE = FILE_SHARE_FLAGS.DELETE;
pub const FILE_SHARE_READ = FILE_SHARE_FLAGS.READ;
pub const FILE_SHARE_WRITE = FILE_SHARE_FLAGS.WRITE;
...
pub const FILE_ATTRIBUTE_READONLY = FILE_FLAGS_AND_ATTRIBUTES.READONLY;
pub const FILE_ATTRIBUTE_HIDDEN = FILE_FLAGS_AND_ATTRIBUTES.HIDDEN;
pub const FILE_ATTRIBUTE_SYSTEM = FILE_FLAGS_AND_ATTRIBUTES.SYSTEM;
pub const FILE_ATTRIBUTE_DIRECTORY = FILE_FLAGS_AND_ATTRIBUTES.DIRECTORY;
pub const FILE_ATTRIBUTE_ARCHIVE = FILE_FLAGS_AND_ATTRIBUTES.ARCHIVE;
pub const FILE_ATTRIBUTE_DEVICE = FILE_FLAGS_AND_ATTRIBUTES.DEVICE;
pub const FILE_ATTRIBUTE_NORMAL = FILE_FLAGS_AND_ATTRIBUTES.NORMAL;
pub const FILE_ATTRIBUTE_TEMPORARY = FILE_FLAGS_AND_ATTRIBUTES.TEMPORARY;
pub const FILE_ATTRIBUTE_SPARSE_FILE = FILE_FLAGS_AND_ATTRIBUTES.SPARSE_FILE;
pub const FILE_ATTRIBUTE_REPARSE_POINT = FILE_FLAGS_AND_ATTRIBUTES.REPARSE_POINT;
pub const FILE_ATTRIBUTE_COMPRESSED = FILE_FLAGS_AND_ATTRIBUTES.COMPRESSED;
pub const FILE_ATTRIBUTE_OFFLINE = FILE_FLAGS_AND_ATTRIBUTES.OFFLINE;
pub const FILE_ATTRIBUTE_NOT_CONTENT_INDEXED = FILE_FLAGS_AND_ATTRIBUTES.NOT_CONTENT_INDEXED;
pub const FILE_ATTRIBUTE_ENCRYPTED = FILE_FLAGS_AND_ATTRIBUTES.ENCRYPTED;
pub const FILE_ATTRIBUTE_INTEGRITY_STREAM = FILE_FLAGS_AND_ATTRIBUTES.INTEGRITY_STREAM;
pub const FILE_ATTRIBUTE_VIRTUAL = FILE_FLAGS_AND_ATTRIBUTES.VIRTUAL;
pub const FILE_ATTRIBUTE_NO_SCRUB_DATA = FILE_FLAGS_AND_ATTRIBUTES.NO_SCRUB_DATA;
pub const FILE_ATTRIBUTE_EA = FILE_FLAGS_AND_ATTRIBUTES.EA;
pub const FILE_ATTRIBUTE_PINNED = FILE_FLAGS_AND_ATTRIBUTES.PINNED;
pub const FILE_ATTRIBUTE_UNPINNED = FILE_FLAGS_AND_ATTRIBUTES.UNPINNED;
pub const FILE_ATTRIBUTE_RECALL_ON_OPEN = FILE_FLAGS_AND_ATTRIBUTES.RECALL_ON_OPEN;
pub const FILE_ATTRIBUTE_RECALL_ON_DATA_ACCESS = FILE_FLAGS_AND_ATTRIBUTES.RECALL_ON_DATA_ACCESS;
...
pub const SetFilePointer_dwMoveMethod = extern enum(u32) {
    BEGIN = 0,
    CURRENT = 1,
    END = 2,
};
pub const FILE_BEGIN = SetFilePointer_dwMoveMethod.BEGIN;
pub const FILE_CURRENT = SetFilePointer_dwMoveMethod.CURRENT;
pub const FILE_END = SetFilePointer_dwMoveMethod.END;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const MoveFileTransacted_dwFlags = extern enum(u32) {
    COPY_ALLOWED = 2,
    CREATE_HARDLINK = 16,
...
pub const MOVEFILE_COPY_ALLOWED = MoveFileTransacted_dwFlags.COPY_ALLOWED;
pub const MOVEFILE_CREATE_HARDLINK = MoveFileTransacted_dwFlags.CREATE_HARDLINK;
pub const MOVEFILE_DELAY_UNTIL_REBOOT = MoveFileTransacted_dwFlags.DELAY_UNTIL_REBOOT;
pub const MOVEFILE_REPLACE_EXISTING = MoveFileTransacted_dwFlags.REPLACE_EXISTING;
pub const MOVEFILE_WRITE_THROUGH = MoveFileTransacted_dwFlags.WRITE_THROUGH;
pub const MOVEFILE_FAIL_IF_NOT_TRACKABLE = MoveFileTransacted_dwFlags.FAIL_IF_NOT_TRACKABLE;
...
// TODO: This Enum is marked as [Flags], what do I do with this?
pub const DefineDosDevice_dwFlags = extern enum(u32) {
    EXACT_MATCH_ON_REMOVE = 4,
    NO_BROADCAST_SYSTEM = 8,
    RAW_TARGET_PATH = 1,
    REMOVE_DEFINITION = 2,
...
// TODO: enum 'DefineDosDevice_dwFlags' has known issues with its value aliases

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const CreateFile_dwShareMode = extern enum(u32) {
    None = 0,
    DELETE = 4,
    READ = 1,
    WRITE = 2,
...
// TODO: enum 'CreateFile_dwShareMode' has known issues with its value aliases

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const LZOpenFile_wStyle = extern enum(u32) {
    CANCEL = 2048,
    CREATE = 4096,
    DELETE = 512,
    EXIST = 16384,
...
pub const OF_CANCEL = LZOpenFile_wStyle.CANCEL;
pub const OF_CREATE = LZOpenFile_wStyle.CREATE;
pub const OF_DELETE = LZOpenFile_wStyle.DELETE;
pub const OF_EXIST = LZOpenFile_wStyle.EXIST;
pub const OF_PARSE = LZOpenFile_wStyle.PARSE;
pub const OF_PROMPT = LZOpenFile_wStyle.PROMPT;
pub const OF_READ = LZOpenFile_wStyle.READ;
pub const OF_READWRITE = LZOpenFile_wStyle.READWRITE;
pub const OF_REOPEN = LZOpenFile_wStyle.REOPEN;
pub const OF_SHARE_DENY_NONE = LZOpenFile_wStyle.SHARE_DENY_NONE;
pub const OF_SHARE_DENY_READ = LZOpenFile_wStyle.SHARE_DENY_READ;
pub const OF_SHARE_DENY_WRITE = LZOpenFile_wStyle.SHARE_DENY_WRITE;
pub const OF_SHARE_EXCLUSIVE = LZOpenFile_wStyle.SHARE_EXCLUSIVE;
pub const OF_WRITE = LZOpenFile_wStyle.WRITE;
pub const OF_SHARE_COMPAT = LZOpenFile_wStyle.SHARE_COMPAT;
pub const OF_VERIFY = LZOpenFile_wStyle.VERIFY;

pub const CreateLogFile_fCreateDispositionFlags = extern enum(u32) {
    CREATE_NEW = 1,
    OPEN_EXISTING = 3,
    OPEN_ALWAYS = 4,
    CREATE_ALWAYS = 2,
...
// TODO: enum 'CreateLogFile_fCreateDispositionFlags' has known issues with its value aliases
...
// TODO: This Enum is marked as [Flags], what do I do with this?
pub const ReOpenFile_dwFlagsAndAttributes = extern enum(u32) {
    BACKUP_SEMANTICS = 33554432,
    DELETE_ON_CLOSE = 67108864,
    NO_BUFFERING = 536870912,
    OPEN_NO_RECALL = 1048576,
    OPEN_REPARSE_POINT = 2097152,
    OVERLAPPED = 1073741824,
    POSIX_SEMANTICS = 16777216,
    RANDOM_ACCESS = 268435456,
    SEQUENTIAL_SCAN = 134217728,
    WRITE_THROUGH = 2147483648,
    _,
};
pub const FILE_FLAG_BACKUP_SEMANTICS = ReOpenFile_dwFlagsAndAttributes.BACKUP_SEMANTICS;
pub const FILE_FLAG_DELETE_ON_CLOSE = ReOpenFile_dwFlagsAndAttributes.DELETE_ON_CLOSE;
pub const FILE_FLAG_NO_BUFFERING = ReOpenFile_dwFlagsAndAttributes.NO_BUFFERING;
pub const FILE_FLAG_OPEN_NO_RECALL = ReOpenFile_dwFlagsAndAttributes.OPEN_NO_RECALL;
pub const FILE_FLAG_OPEN_REPARSE_POINT = ReOpenFile_dwFlagsAndAttributes.OPEN_REPARSE_POINT;
pub const FILE_FLAG_OVERLAPPED = ReOpenFile_dwFlagsAndAttributes.OVERLAPPED;
pub const FILE_FLAG_POSIX_SEMANTICS = ReOpenFile_dwFlagsAndAttributes.POSIX_SEMANTICS;
pub const FILE_FLAG_RANDOM_ACCESS = ReOpenFile_dwFlagsAndAttributes.RANDOM_ACCESS;
pub const FILE_FLAG_SEQUENTIAL_SCAN = ReOpenFile_dwFlagsAndAttributes.SEQUENTIAL_SCAN;
pub const FILE_FLAG_WRITE_THROUGH = ReOpenFile_dwFlagsAndAttributes.WRITE_THROUGH;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const ReplaceFile_dwReplaceFlags = extern enum(u32) {
    WRITE_THROUGH = 1,
    IGNORE_MERGE_ERRORS = 2,
    IGNORE_ACL_ERRORS = 4,
    _,
};
pub const REPLACEFILE_WRITE_THROUGH = ReplaceFile_dwReplaceFlags.WRITE_THROUGH;
pub const REPLACEFILE_IGNORE_MERGE_ERRORS = ReplaceFile_dwReplaceFlags.IGNORE_MERGE_ERRORS;
pub const REPLACEFILE_IGNORE_ACL_ERRORS = ReplaceFile_dwReplaceFlags.IGNORE_ACL_ERRORS;
...
pub const UpdateNtmsOmidInfo_labelTypeFlags = extern enum(u32) {
    FILESYSTEM_INFO = 2,
    RAW_LABEL = 1,
};
pub const NTMS_OMID_TYPE_FILESYSTEM_INFO = UpdateNtmsOmidInfo_labelTypeFlags.FILESYSTEM_INFO;
pub const NTMS_OMID_TYPE_RAW_LABEL = UpdateNtmsOmidInfo_labelTypeFlags.RAW_LABEL;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const LockFileEx_dwFlags = extern enum(u32) {
    EXCLUSIVE_LOCK = 2,
    FAIL_IMMEDIATELY = 1,
    _,
};
pub const LOCKFILE_EXCLUSIVE_LOCK = LockFileEx_dwFlags.EXCLUSIVE_LOCK;
pub const LOCKFILE_FAIL_IMMEDIATELY = LockFileEx_dwFlags.FAIL_IMMEDIATELY;

pub const LPPROGRESS_ROUTINE_dwCallbackReasonFlags = extern enum(u32) {
    CHUNK_FINISHED = 0,
    STREAM_SWITCH = 1,
};
pub const CALLBACK_CHUNK_FINISHED = LPPROGRESS_ROUTINE_dwCallbackReasonFlags.CHUNK_FINISHED;
pub const CALLBACK_STREAM_SWITCH = LPPROGRESS_ROUTINE_dwCallbackReasonFlags.STREAM_SWITCH;
...
// TODO: This Enum is marked as [Flags], what do I do with this?
pub const DELETE_USN_JOURNAL_DATAFlags = extern enum(u32) {
    DELETE = 1,
    NOTIFY = 2,
    _,
};
pub const USN_DELETE_FLAG_DELETE = DELETE_USN_JOURNAL_DATAFlags.DELETE;
pub const USN_DELETE_FLAG_NOTIFY = DELETE_USN_JOURNAL_DATAFlags.NOTIFY;

pub const SHARE_INFO_501_shi501_type = extern enum(u32) {
    DISKTREE = 0,
    PRINTQ = 1,
    DEVICE = 2,
    IPC = 3,
};
pub const STYPE_DISKTREE = SHARE_INFO_501_shi501_type.DISKTREE;
pub const STYPE_PRINTQ = SHARE_INFO_501_shi501_type.PRINTQ;
pub const STYPE_DEVICE = SHARE_INFO_501_shi501_type.DEVICE;
pub const STYPE_IPC = SHARE_INFO_501_shi501_type.IPC;

pub const SHARE_INFO_502_shi502_permissionsFlags = extern enum(u32) {
    READ = 1,
    WRITE = 2,
    CREATE = 4,
    EXEC = 8,
...
pub const ACCESS_READ = SHARE_INFO_502_shi502_permissionsFlags.READ;
pub const ACCESS_WRITE = SHARE_INFO_502_shi502_permissionsFlags.WRITE;
pub const ACCESS_CREATE = SHARE_INFO_502_shi502_permissionsFlags.CREATE;
pub const ACCESS_EXEC = SHARE_INFO_502_shi502_permissionsFlags.EXEC;
pub const ACCESS_DELETE = SHARE_INFO_502_shi502_permissionsFlags.DELETE;
pub const ACCESS_ATRIB = SHARE_INFO_502_shi502_permissionsFlags.ATRIB;
pub const ACCESS_PERM = SHARE_INFO_502_shi502_permissionsFlags.PERM;
pub const ACCESS_ALL = SHARE_INFO_502_shi502_permissionsFlags.ALL;

pub const NTMS_MEDIATYPEINFORMATION_DeviceTypeFlags = extern enum(u32) {
    CD_ROM = 2,
    DISK = 7,
    TAPE = 31,
    DVD = 51,
};
pub const FILE_DEVICE_CD_ROM = NTMS_MEDIATYPEINFORMATION_DeviceTypeFlags.CD_ROM;
pub const FILE_DEVICE_DISK = NTMS_MEDIATYPEINFORMATION_DeviceTypeFlags.DISK;
pub const FILE_DEVICE_TAPE = NTMS_MEDIATYPEINFORMATION_DeviceTypeFlags.TAPE;
pub const FILE_DEVICE_DVD = NTMS_MEDIATYPEINFORMATION_DeviceTypeFlags.DVD;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const TXFS_MODIFY_RMFlags = extern enum(u32) {
    LOGGING_MODE = 1,
    RENAME_RM = 2,
...
pub const TXFS_RM_FLAG_LOGGING_MODE = TXFS_MODIFY_RMFlags.LOGGING_MODE;
pub const TXFS_RM_FLAG_RENAME_RM = TXFS_MODIFY_RMFlags.RENAME_RM;
pub const TXFS_RM_FLAG_LOG_CONTAINER_COUNT_MAX = TXFS_MODIFY_RMFlags.LOG_CONTAINER_COUNT_MAX;
pub const TXFS_RM_FLAG_LOG_CONTAINER_COUNT_MIN = TXFS_MODIFY_RMFlags.LOG_CONTAINER_COUNT_MIN;
pub const TXFS_RM_FLAG_LOG_GROWTH_INCREMENT_NUM_CONTAINERS = TXFS_MODIFY_RMFlags.LOG_GROWTH_INCREMENT_NUM_CONTAINERS;
pub const TXFS_RM_FLAG_LOG_GROWTH_INCREMENT_PERCENT = TXFS_MODIFY_RMFlags.LOG_GROWTH_INCREMENT_PERCENT;
pub const TXFS_RM_FLAG_LOG_AUTO_SHRINK_PERCENTAGE = TXFS_MODIFY_RMFlags.LOG_AUTO_SHRINK_PERCENTAGE;
pub const TXFS_RM_FLAG_LOG_NO_CONTAINER_COUNT_MAX = TXFS_MODIFY_RMFlags.LOG_NO_CONTAINER_COUNT_MAX;
pub const TXFS_RM_FLAG_LOG_NO_CONTAINER_COUNT_MIN = TXFS_MODIFY_RMFlags.LOG_NO_CONTAINER_COUNT_MIN;
pub const TXFS_RM_FLAG_GROW_LOG = TXFS_MODIFY_RMFlags.GROW_LOG;
pub const TXFS_RM_FLAG_SHRINK_LOG = TXFS_MODIFY_RMFlags.SHRINK_LOG;
pub const TXFS_RM_FLAG_ENFORCE_MINIMUM_SIZE = TXFS_MODIFY_RMFlags.ENFORCE_MINIMUM_SIZE;
pub const TXFS_RM_FLAG_PRESERVE_CHANGES = TXFS_MODIFY_RMFlags.PRESERVE_CHANGES;
pub const TXFS_RM_FLAG_RESET_RM_AT_NEXT_START = TXFS_MODIFY_RMFlags.RESET_RM_AT_NEXT_START;
pub const TXFS_RM_FLAG_DO_NOT_RESET_RM_AT_NEXT_START = TXFS_MODIFY_RMFlags.DO_NOT_RESET_RM_AT_NEXT_START;
pub const TXFS_RM_FLAG_PREFER_CONSISTENCY = TXFS_MODIFY_RMFlags.PREFER_CONSISTENCY;
pub const TXFS_RM_FLAG_PREFER_AVAILABILITY = TXFS_MODIFY_RMFlags.PREFER_AVAILABILITY;
...
pub const USN_RECORD_V4_SourceInfoFlags = extern enum(u32) {
    AUXILIARY_DATA = 2,
    DATA_MANAGEMENT = 1,
    REPLICATION_MANAGEMENT = 4,
    CLIENT_REPLICATION_MANAGEMENT = 8,
};
pub const USN_SOURCE_AUXILIARY_DATA = USN_RECORD_V4_SourceInfoFlags.AUXILIARY_DATA;
pub const USN_SOURCE_DATA_MANAGEMENT = USN_RECORD_V4_SourceInfoFlags.DATA_MANAGEMENT;
pub const USN_SOURCE_REPLICATION_MANAGEMENT = USN_RECORD_V4_SourceInfoFlags.REPLICATION_MANAGEMENT;
pub const USN_SOURCE_CLIENT_REPLICATION_MANAGEMENT = USN_RECORD_V4_SourceInfoFlags.CLIENT_REPLICATION_MANAGEMENT;
...
pub const SESSION_INFO_502_sesi502_user_flags = extern enum(u32) {
    GUEST = 1,
    NOENCRYPTION = 2,
};
pub const SESS_GUEST = SESSION_INFO_502_sesi502_user_flags.GUEST;
pub const SESS_NOENCRYPTION = SESSION_INFO_502_sesi502_user_flags.NOENCRYPTION;

pub const TXF_LOG_RECORD_BASE_RecordTypeFlags = extern enum(u32) {
    AFFECTED_FILE = 4,
    TRUNCATE = 2,
    WRITE = 1,
};
pub const TXF_LOG_RECORD_TYPE_AFFECTED_FILE = TXF_LOG_RECORD_BASE_RecordTypeFlags.AFFECTED_FILE;
pub const TXF_LOG_RECORD_TYPE_TRUNCATE = TXF_LOG_RECORD_BASE_RecordTypeFlags.TRUNCATE;
pub const TXF_LOG_RECORD_TYPE_WRITE = TXF_LOG_RECORD_BASE_RecordTypeFlags.WRITE;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const FILE_INFO_3_fi3_permissionsFlags = extern enum(u32) {
    READ = 1,
    WRITE = 2,
    CREATE = 4,
    _,
};
pub const PERM_FILE_READ = FILE_INFO_3_fi3_permissionsFlags.READ;
pub const PERM_FILE_WRITE = FILE_INFO_3_fi3_permissionsFlags.WRITE;
pub const PERM_FILE_CREATE = FILE_INFO_3_fi3_permissionsFlags.CREATE;

pub const DISK_CACHE_INFORMATION_ReadRetentionPriorityFlags = extern enum(u32) {
    EqualPriority = 0,
    KeepPrefetchedData = 1,
    KeepReadData = 2,
};
pub const EqualPriority = DISK_CACHE_INFORMATION_ReadRetentionPriorityFlags.EqualPriority;
pub const KeepPrefetchedData = DISK_CACHE_INFORMATION_ReadRetentionPriorityFlags.KeepPrefetchedData;
pub const KeepReadData = DISK_CACHE_INFORMATION_ReadRetentionPriorityFlags.KeepReadData;
...
pub const NTMS_MEDIATYPEINFORMATION = extern struct {
    ...
    DeviceType: NTMS_MEDIATYPEINFORMATION_DeviceTypeFlags,
};
...
pub const IDiskQuotaControl = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDiskQuotaControl_AddUserSid(self: *const T, pUserSid: *c_void, fNameResolution: DISKQUOTA_USERNAME_RESOLVE, ppUser: **IDiskQuotaUser) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDiskQuotaControl_FindUserSid(self: *const T, pUserSid: *c_void, fNameResolution: DISKQUOTA_USERNAME_RESOLVE, ppUser: **IDiskQuotaUser) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDiskQuotaControl_CreateEnumUsers(self: *const T, rgpUserSids: **c_void, cpSids: u32, fNameResolution: DISKQUOTA_USERNAME_RESOLVE, ppEnum: **IEnumDiskQuotaUsers) callconv(.Inline) HRESULT {
...
pub const TXF_LOG_RECORD_BASE = extern struct {
    Version: u16,
    RecordType: TXF_LOG_RECORD_BASE_RecordTypeFlags,
    RecordLength: u32,
};
...
pub const SHARE_INFO_1 = extern struct {
    shi1_netname: PWSTR,
    shi1_type: SHARE_INFO_501_shi501_type,
    shi1_remark: PWSTR,
};

pub const SHARE_INFO_2 = extern struct {
    shi2_netname: PWSTR,
    shi2_type: SHARE_INFO_501_shi501_type,
    shi2_remark: PWSTR,
    shi2_permissions: SHARE_INFO_502_shi502_permissionsFlags,
    shi2_max_uses: u32,
...
pub const SHARE_INFO_501 = extern struct {
    ...
    shi501_type: SHARE_INFO_501_shi501_type,
    shi501_remark: PWSTR,
    shi501_flags: u32,
};
...
pub const SHARE_INFO_502 = extern struct {
    ...
    shi502_type: SHARE_INFO_501_shi501_type,
    shi502_remark: PWSTR,
    shi502_permissions: SHARE_INFO_502_shi502_permissionsFlags,
    shi502_max_uses: u32,
...
pub const SHARE_INFO_503 = extern struct {
    ...
    shi503_type: SHARE_INFO_501_shi501_type,
    shi503_remark: PWSTR,
    shi503_permissions: SHARE_INFO_502_shi502_permissionsFlags,
    shi503_max_uses: u32,
...
pub const SESSION_INFO_1 = extern struct {
    ...
    sesi1_time: u32,
    sesi1_idle_time: u32,
    sesi1_user_flags: SESSION_INFO_502_sesi502_user_flags,
};
...
pub const SESSION_INFO_2 = extern struct {
    ...
    sesi2_time: u32,
    sesi2_idle_time: u32,
    sesi2_user_flags: SESSION_INFO_502_sesi502_user_flags,
...
pub const SESSION_INFO_502 = extern struct {
    ...
    sesi502_user_flags: SESSION_INFO_502_sesi502_user_flags,
...
pub const CONNECTION_INFO_1 = extern struct {
    coni1_id: u32,
    coni1_type: SHARE_INFO_501_shi501_type,
    coni1_num_opens: u32,
    coni1_num_users: u32,
    coni1_time: u32,
...
pub const FILE_INFO_3 = extern struct {
    fi3_id: u32,
    fi3_permissions: FILE_INFO_3_fi3_permissionsFlags,
    fi3_num_locks: u32,
    fi3_pathname: PWSTR,
    fi3_username: PWSTR,
};
...
pub extern "KERNEL32" fn DefineDosDeviceA(
    dwFlags: DefineDosDevice_dwFlags,
...
pub extern "KERNEL32" fn CreateFileTransactedA(
    lpFileName: [*:0]const u8,
    dwDesiredAccess: u32,
    dwShareMode: CreateFile_dwShareMode,
    lpSecurityAttributes: ?*SECURITY_ATTRIBUTES,
    dwCreationDisposition: CreateLogFile_fCreateDispositionFlags,
...
pub extern "KERNEL32" fn ReOpenFile(
    ...
    dwDesiredAccess: u32,
    dwShareMode: CreateFile_dwShareMode,
    dwFlagsAndAttributes: ReOpenFile_dwFlagsAndAttributes,
) callconv(@import("std").os.windows.WINAPI) HANDLE;
...
pub extern "KERNEL32" fn MoveFileExA(
    lpExistingFileName: [*:0]const u8,
    lpNewFileName: ?[*:0]const u8,
    dwFlags: MoveFileTransacted_dwFlags,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "KERNEL32" fn ReplaceFileA(
    ...
    dwReplaceFlags: ReplaceFile_dwReplaceFlags,
    lpExclude: *c_void,
    lpReserved: *c_void,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "KERNEL32" fn SetFilePointer(
    ...
    dwMoveMethod: SetFilePointer_dwMoveMethod,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "clfsw32" fn CreateLogFile(
    ...
    fCreateDisposition: CreateLogFile_fCreateDispositionFlags,
...
const GPT_ATTRIBUTES = @import("system_services.zig").GPT_ATTRIBUTES;
...
test {
    ...
    const constant_export_count = 198;
    const type_export_count = 459;
    const enum_value_export_count = 641;
