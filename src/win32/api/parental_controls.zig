...
pub const WPCFLAG_LOGOFF_TYPE = extern enum(i32) {
    LOGOUT = 0,
    RESTART = 1,
    SHUTDOWN = 2,
    FUS = 4,
...
pub const WPCFLAG_IM_LEAVE = extern enum(i32) {
    NORMAL = 0,
    FORCED = 1,
    CONVERSATION_END = 2,
};
...
pub const WPC_ARGS_SETTINGSCHANGEEVENT = extern enum(i32) {
    CLASS = 0,
    SETTING = 1,
    OWNER = 2,
    OLDVAL = 3,
...
pub const WPC_ARGS_SAFERAPPBLOCKED = extern enum(i32) {
    TIMESTAMP = 0,
    USERID = 1,
    PATH = 2,
    RULEID = 3,
...
pub const WPC_ARGS_EMAILRECEIEVEDEVENT = extern enum(i32) {
    SENDER = 0,
    APPNAME = 1,
    APPVERSION = 2,
    SUBJECT = 3,
...
pub const WPC_ARGS_EMAILSENTEVENT = extern enum(i32) {
    SENDER = 0,
    APPNAME = 1,
    APPVERSION = 2,
    SUBJECT = 3,
...
pub const WPC_ARGS_EMAILCONTACTEVENT = extern enum(i32) {
    APPNAME = 0,
    APPVERSION = 1,
    OLDNAME = 2,
    OLDID = 3,
...
pub const WPC_MEDIA_TYPE = extern enum(i32) {
    OTHER = 0,
    DVD = 1,
    RECORDED_TV = 2,
    AUDIO_FILE = 3,
...
pub const WPC_MEDIA_EXPLICIT = extern enum(i32) {
    FALSE = 0,
    TRUE = 1,
    UNKNOWN = 2,
};
...
pub const WPC_ARGS_MEDIAPLAYBACKEVENT = extern enum(i32) {
    APPNAME = 0,
    APPVERSION = 1,
    MEDIATYPE = 2,
    PATH = 3,
...
pub const WPC_ARGS_MEDIADOWNLOADEVENT = extern enum(i32) {
    APPNAME = 0,
    APPVERSION = 1,
    MEDIATYPE = 2,
    PATH = 3,
...
pub const WPC_ARGS_CONVERSATIONINITEVENT = extern enum(i32) {
    APPNAME = 0,
    APPVERSION = 1,
    ACCOUNTNAME = 2,
    CONVID = 3,
...
pub const WPC_ARGS_CONVERSATIONJOINEVENT = extern enum(i32) {
    APPNAME = 0,
    APPVERSION = 1,
    ACCOUNTNAME = 2,
    CONVID = 3,
...
pub const WPC_ARGS_CONVERSATIONLEAVEEVENT = extern enum(i32) {
    APPNAME = 0,
    APPVERSION = 1,
    ACCOUNTNAME = 2,
    CONVID = 3,
...
pub const WPCFLAG_IM_FEATURE = extern enum(i32) {
    NONE = 0,
    VIDEO = 1,
    AUDIO = 2,
    GAME = 4,
...
pub const WPC_ARGS_IMFEATUREEVENT = extern enum(i32) {
    APPNAME = 0,
    APPVERSION = 1,
    ACCOUNTNAME = 2,
    CONVID = 3,
...
pub const WPC_ARGS_IMCONTACTEVENT = extern enum(i32) {
    APPNAME = 0,
    APPVERSION = 1,
    ACCOUNTNAME = 2,
    OLDNAME = 3,
...
pub const WPC_ARGS_GAMESTARTEVENT = extern enum(i32) {
    APPID = 0,
    INSTANCEID = 1,
    APPVERSION = 2,
    PATH = 3,
...
pub const WPC_ARGS_FILEDOWNLOADEVENT = extern enum(i32) {
    URL = 0,
    APPNAME = 1,
    VERSION = 2,
    BLOCKED = 3,
...
pub const WPC_ARGS_URLVISITEVENT = extern enum(i32) {
    URL = 0,
    APPNAME = 1,
    VERSION = 2,
    REASON = 3,
...
pub const WPC_ARGS_WEBSITEVISITEVENT = extern enum(i32) {
    URL = 0,
    DECISION = 1,
    CATEGORIES = 2,
    BLOCKEDCATEGORIES = 3,
...
pub const WPC_ARGS_APPLICATIONEVENT = extern enum(i32) {
...
pub const WPC_ARGS_COMPUTERUSAGEEVENT = extern enum(i32) {
    ID = 0,
    TIMEUSED = 1,
    CARGS = 2,
};
...
pub const WPC_ARGS_CONTENTUSAGEEVENT = extern enum(i32) {
    CONTENTPROVIDERID = 0,
...
pub const WPC_ARGS_CUSTOMEVENT = extern enum(i32) {
    PUBLISHER = 0,
    APPNAME = 1,
    APPVERSION = 2,
    EVENT = 3,
...
pub const WPC_ARGS_WEBOVERRIDEEVENT = extern enum(i32) {
    USERID = 0,
    URL = 1,
    REASON = 2,
    CARGS = 3,
...
pub const WPC_ARGS_APPOVERRIDEEVENT = extern enum(i32) {
    USERID = 0,
    PATH = 1,
    REASON = 2,
    CARGS = 3,
...
pub const WPC_SETTINGS = extern enum(i32) {
    WPC_EXTENSION_PATH = 0,
    WPC_EXTENSION_SILO = 1,
    WPC_EXTENSION_IMAGE_PATH = 2,
    WPC_EXTENSION_DISABLEDIMAGE_PATH = 3,
    WPC_EXTENSION_NAME = 4,
    WPC_EXTENSION_SUB_TITLE = 5,
    SYSTEM_CURRENT_RATING_SYSTEM = 6,
    SYSTEM_LAST_LOG_VIEW = 7,
    SYSTEM_LOG_VIEW_REMINDER_INTERVAL = 8,
    SYSTEM_HTTP_EXEMPTION_LIST = 9,
    SYSTEM_URL_EXEMPTION_LIST = 10,
    SYSTEM_FILTER_ID = 11,
    SYSTEM_FILTER_NAME = 12,
    SYSTEM_LOCALE = 13,
    ALLOW_BLOCK = 14,
    GAME_BLOCKED = 15,
    GAME_ALLOW_UNRATED = 16,
    GAME_MAX_ALLOWED = 17,
    GAME_DENIED_DESCRIPTORS = 18,
    USER_WPC_ENABLED = 19,
    USER_LOGGING_REQUIRED = 20,
    USER_HOURLY_RESTRICTIONS = 21,
    USER_OVERRRIDE_REQUESTS = 22,
    USER_LOGON_HOURS = 23,
    USER_APP_RESTRICTIONS = 24,
    WEB_FILTER_ON = 25,
    WEB_DOWNLOAD_BLOCKED = 26,
    WEB_FILTER_LEVEL = 27,
    WEB_BLOCKED_CATEGORY_LIST = 28,
    WEB_BLOCK_UNRATED = 29,
    WPC_ENABLED = 30,
    WPC_LOGGING_REQUIRED = 31,
    RATING_SYSTEM_PATH = 32,
    WPC_PROVIDER_CURRENT = 33,
    USER_TIME_ALLOWANCE = 34,
    USER_TIME_ALLOWANCE_RESTRICTIONS = 35,
    GAME_RESTRICTED = 36,
    WPC_SETTING_COUNT = 37,
};
pub const WPC_SETTINGS_WPC_EXTENSION_PATH = WPC_SETTINGS.WPC_EXTENSION_PATH;
pub const WPC_SETTINGS_WPC_EXTENSION_SILO = WPC_SETTINGS.WPC_EXTENSION_SILO;
pub const WPC_SETTINGS_WPC_EXTENSION_IMAGE_PATH = WPC_SETTINGS.WPC_EXTENSION_IMAGE_PATH;
pub const WPC_SETTINGS_WPC_EXTENSION_DISABLEDIMAGE_PATH = WPC_SETTINGS.WPC_EXTENSION_DISABLEDIMAGE_PATH;
pub const WPC_SETTINGS_WPC_EXTENSION_NAME = WPC_SETTINGS.WPC_EXTENSION_NAME;
pub const WPC_SETTINGS_WPC_EXTENSION_SUB_TITLE = WPC_SETTINGS.WPC_EXTENSION_SUB_TITLE;
pub const WPC_SETTINGS_SYSTEM_CURRENT_RATING_SYSTEM = WPC_SETTINGS.SYSTEM_CURRENT_RATING_SYSTEM;
pub const WPC_SETTINGS_SYSTEM_LAST_LOG_VIEW = WPC_SETTINGS.SYSTEM_LAST_LOG_VIEW;
pub const WPC_SETTINGS_SYSTEM_LOG_VIEW_REMINDER_INTERVAL = WPC_SETTINGS.SYSTEM_LOG_VIEW_REMINDER_INTERVAL;
pub const WPC_SETTINGS_SYSTEM_HTTP_EXEMPTION_LIST = WPC_SETTINGS.SYSTEM_HTTP_EXEMPTION_LIST;
pub const WPC_SETTINGS_SYSTEM_URL_EXEMPTION_LIST = WPC_SETTINGS.SYSTEM_URL_EXEMPTION_LIST;
pub const WPC_SETTINGS_SYSTEM_FILTER_ID = WPC_SETTINGS.SYSTEM_FILTER_ID;
pub const WPC_SETTINGS_SYSTEM_FILTER_NAME = WPC_SETTINGS.SYSTEM_FILTER_NAME;
pub const WPC_SETTINGS_SYSTEM_LOCALE = WPC_SETTINGS.SYSTEM_LOCALE;
pub const WPC_SETTINGS_ALLOW_BLOCK = WPC_SETTINGS.ALLOW_BLOCK;
pub const WPC_SETTINGS_GAME_BLOCKED = WPC_SETTINGS.GAME_BLOCKED;
pub const WPC_SETTINGS_GAME_ALLOW_UNRATED = WPC_SETTINGS.GAME_ALLOW_UNRATED;
pub const WPC_SETTINGS_GAME_MAX_ALLOWED = WPC_SETTINGS.GAME_MAX_ALLOWED;
pub const WPC_SETTINGS_GAME_DENIED_DESCRIPTORS = WPC_SETTINGS.GAME_DENIED_DESCRIPTORS;
pub const WPC_SETTINGS_USER_WPC_ENABLED = WPC_SETTINGS.USER_WPC_ENABLED;
pub const WPC_SETTINGS_USER_LOGGING_REQUIRED = WPC_SETTINGS.USER_LOGGING_REQUIRED;
pub const WPC_SETTINGS_USER_HOURLY_RESTRICTIONS = WPC_SETTINGS.USER_HOURLY_RESTRICTIONS;
pub const WPC_SETTINGS_USER_OVERRRIDE_REQUESTS = WPC_SETTINGS.USER_OVERRRIDE_REQUESTS;
pub const WPC_SETTINGS_USER_LOGON_HOURS = WPC_SETTINGS.USER_LOGON_HOURS;
pub const WPC_SETTINGS_USER_APP_RESTRICTIONS = WPC_SETTINGS.USER_APP_RESTRICTIONS;
pub const WPC_SETTINGS_WEB_FILTER_ON = WPC_SETTINGS.WEB_FILTER_ON;
pub const WPC_SETTINGS_WEB_DOWNLOAD_BLOCKED = WPC_SETTINGS.WEB_DOWNLOAD_BLOCKED;
pub const WPC_SETTINGS_WEB_FILTER_LEVEL = WPC_SETTINGS.WEB_FILTER_LEVEL;
pub const WPC_SETTINGS_WEB_BLOCKED_CATEGORY_LIST = WPC_SETTINGS.WEB_BLOCKED_CATEGORY_LIST;
pub const WPC_SETTINGS_WEB_BLOCK_UNRATED = WPC_SETTINGS.WEB_BLOCK_UNRATED;
pub const WPC_SETTINGS_WPC_ENABLED = WPC_SETTINGS.WPC_ENABLED;
pub const WPC_SETTINGS_WPC_LOGGING_REQUIRED = WPC_SETTINGS.WPC_LOGGING_REQUIRED;
pub const WPC_SETTINGS_RATING_SYSTEM_PATH = WPC_SETTINGS.RATING_SYSTEM_PATH;
pub const WPC_SETTINGS_WPC_PROVIDER_CURRENT = WPC_SETTINGS.WPC_PROVIDER_CURRENT;
pub const WPC_SETTINGS_USER_TIME_ALLOWANCE = WPC_SETTINGS.USER_TIME_ALLOWANCE;
pub const WPC_SETTINGS_USER_TIME_ALLOWANCE_RESTRICTIONS = WPC_SETTINGS.USER_TIME_ALLOWANCE_RESTRICTIONS;
...
pub const WPCFLAG_OVERRIDE = extern enum(i32) {
...
pub const WPCFLAG_RESTRICTION = extern enum(i32) {
...
pub const WPCFLAG_NO_RESTRICTION = WPCFLAG_RESTRICTION.WPCFLAG_NO_RESTRICTION;
pub const WPCFLAG_LOGGING_REQUIRED = WPCFLAG_RESTRICTION.WPCFLAG_LOGGING_REQUIRED;
pub const WPCFLAG_WEB_FILTERED = WPCFLAG_RESTRICTION.WPCFLAG_WEB_FILTERED;
pub const WPCFLAG_HOURS_RESTRICTED = WPCFLAG_RESTRICTION.WPCFLAG_HOURS_RESTRICTED;
pub const WPCFLAG_GAMES_BLOCKED = WPCFLAG_RESTRICTION.WPCFLAG_GAMES_BLOCKED;
pub const WPCFLAG_APPS_RESTRICTED = WPCFLAG_RESTRICTION.WPCFLAG_APPS_RESTRICTED;
...
pub const IWPCSettings = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWPCSettings_GetRestrictions(self: *const T, pdwRestrictions: *u32) callconv(.Inline) HRESULT {
...
pub const WPCFLAG_WEB_SETTING = extern enum(i32) {
    NOTBLOCKED = 0,
    DOWNLOADSBLOCKED = 1,
};
...
pub const IWPCWebSettings = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IWPCSettings.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWPCWebSettings_GetSettings(self: *const T, pdwSettings: *u32) callconv(.Inline) HRESULT {
...
pub const WPCFLAG_VISIBILITY = extern enum(i32) {
