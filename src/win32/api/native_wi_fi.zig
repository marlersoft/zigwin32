...
pub const GUID_NDIS_NDK_CAPABILITIES = @import("../zig.zig").Guid.initString("7969ba4d-dd80-4bc7-b3e6-68043997e519");
pub const GUID_NDIS_NDK_STATE = @import("../zig.zig").Guid.initString("530c69c9-2f51-49de-a1af-088d54ffa474");
...
pub const GUID_DEVINTERFACE_WIFIDIRECT_DEVICE = @import("../zig.zig").Guid.initString("439b20af-8955-405b-99f0-a62af0c68d43");
pub const GUID_AEPSERVICE_WIFIDIRECT_DEVICE = @import("../zig.zig").Guid.initString("cc29827c-9caf-4928-99a9-18f7c2381389");
pub const GUID_DEVINTERFACE_ASP_INFRA_DEVICE = @import("../zig.zig").Guid.initString("ff823995-7a72-4c80-8757-c67ee13d1a49");
pub const DEVPKEY_WiFiDirect_DeviceAddress = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 1);
pub const DEVPKEY_WiFiDirect_InterfaceAddress = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 2);
pub const DEVPKEY_WiFiDirect_InterfaceGuid = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 3);
pub const DEVPKEY_WiFiDirect_GroupId = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 4);
pub const DEVPKEY_WiFiDirect_IsConnected = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 5);
pub const DEVPKEY_WiFiDirect_IsVisible = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 6);
pub const DEVPKEY_WiFiDirect_IsLegacyDevice = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 7);
pub const DEVPKEY_WiFiDirect_MiracastVersion = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 8);
pub const DEVPKEY_WiFiDirect_IsMiracastLCPSupported = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 9);
pub const DEVPKEY_WiFiDirect_Services = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 10);
pub const DEVPKEY_WiFiDirect_SupportedChannelList = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 11);
pub const DEVPKEY_WiFiDirect_InformationElements = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 12);
pub const DEVPKEY_WiFiDirect_DeviceAddressCopy = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 13);
pub const DEVPKEY_WiFiDirect_IsRecentlyAssociated = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 14);
pub const DEVPKEY_WiFiDirect_Service_Aeps = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 15);
pub const DEVPKEY_WiFiDirect_NoMiracastAutoProject = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 16);
pub const DEVPKEY_InfraCast_Supported = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 17);
pub const DEVPKEY_InfraCast_StreamSecuritySupported = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 18);
pub const DEVPKEY_InfraCast_AccessPointBssid = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 19);
pub const DEVPKEY_InfraCast_SinkHostName = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 20);
pub const DEVPKEY_InfraCast_ChallengeAep = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 21);
pub const DEVPKEY_WiFiDirect_IsDMGCapable = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 22);
pub const DEVPKEY_InfraCast_DevnodeAep = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 23);
pub const DEVPKEY_WiFiDirect_FoundWsbService = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 24);
pub const DEVPKEY_InfraCast_HostName_ResolutionMode = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 25);
pub const DEVPKEY_InfraCast_SinkIpAddress = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 26);
pub const DEVPKEY_WiFiDirect_TransientAssociation = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 27);
pub const DEVPKEY_WiFiDirect_LinkQuality = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 28);
pub const DEVPKEY_InfraCast_PinSupported = @import("../zig.zig").PropertyKey.init("1506935d-e3e7-450f-8637-82233ebe5f6e", 29);
pub const DEVPKEY_WiFiDirectServices_ServiceAddress = @import("../zig.zig").PropertyKey.init("31b37743-7c5e-4005-93e6-e953f92b82e9", 2);
pub const DEVPKEY_WiFiDirectServices_ServiceName = @import("../zig.zig").PropertyKey.init("31b37743-7c5e-4005-93e6-e953f92b82e9", 3);
pub const DEVPKEY_WiFiDirectServices_ServiceInformation = @import("../zig.zig").PropertyKey.init("31b37743-7c5e-4005-93e6-e953f92b82e9", 4);
pub const DEVPKEY_WiFiDirectServices_AdvertisementId = @import("../zig.zig").PropertyKey.init("31b37743-7c5e-4005-93e6-e953f92b82e9", 5);
pub const DEVPKEY_WiFiDirectServices_ServiceConfigMethods = @import("../zig.zig").PropertyKey.init("31b37743-7c5e-4005-93e6-e953f92b82e9", 6);
pub const DEVPKEY_WiFiDirectServices_RequestServiceInformation = @import("../zig.zig").PropertyKey.init("31b37743-7c5e-4005-93e6-e953f92b82e9", 7);
pub const DEVPKEY_WiFi_InterfaceGuid = @import("../zig.zig").PropertyKey.init("ef1167eb-cbfc-4341-a568-a7c91a68982c", 2);
