...
pub const SXH_OPTION_URL = SERVERXMLHTTP_OPTION.SXH_OPTION_URL;
pub const SXH_OPTION_URL_CODEPAGE = SERVERXMLHTTP_OPTION.SXH_OPTION_URL_CODEPAGE;
pub const SXH_OPTION_ESCAPE_PERCENT_IN_URL = SERVERXMLHTTP_OPTION.SXH_OPTION_ESCAPE_PERCENT_IN_URL;
pub const SXH_OPTION_IGNORE_SERVER_SSL_CERT_ERROR_FLAGS = SERVERXMLHTTP_OPTION.SXH_OPTION_IGNORE_SERVER_SSL_CERT_ERROR_FLAGS;
pub const SXH_OPTION_SELECT_CLIENT_SSL_CERT = SERVERXMLHTTP_OPTION.SXH_OPTION_SELECT_CLIENT_SSL_CERT;
...
pub const SXH_SERVER_CERT_IGNORE_UNKNOWN_CA = SXH_SERVER_CERT_OPTION.SXH_SERVER_CERT_IGNORE_UNKNOWN_CA;
pub const SXH_SERVER_CERT_IGNORE_WRONG_USAGE = SXH_SERVER_CERT_OPTION.SXH_SERVER_CERT_IGNORE_WRONG_USAGE;
pub const SXH_SERVER_CERT_IGNORE_CERT_CN_INVALID = SXH_SERVER_CERT_OPTION.SXH_SERVER_CERT_IGNORE_CERT_CN_INVALID;
pub const SXH_SERVER_CERT_IGNORE_CERT_DATE_INVALID = SXH_SERVER_CERT_OPTION.SXH_SERVER_CERT_IGNORE_CERT_DATE_INVALID;
pub const SXH_SERVER_CERT_IGNORE_ALL_SERVER_ERRORS = SXH_SERVER_CERT_OPTION.SXH_SERVER_CERT_IGNORE_ALL_SERVER_ERRORS;
...
pub const SXH_PROXY_SET_DEFAULT = SXH_PROXY_SETTING.SXH_PROXY_SET_DEFAULT;
pub const SXH_PROXY_SET_PRECONFIG = SXH_PROXY_SETTING.SXH_PROXY_SET_PRECONFIG;
pub const SXH_PROXY_SET_DIRECT = SXH_PROXY_SETTING.SXH_PROXY_SET_DIRECT;
pub const SXH_PROXY_SET_PROXY = SXH_PROXY_SETTING.SXH_PROXY_SET_PROXY;
...
pub const SOMITEM_SCHEMA = SOMITEMTYPE.SOMITEM_SCHEMA;
pub const SOMITEM_ATTRIBUTE = SOMITEMTYPE.SOMITEM_ATTRIBUTE;
pub const SOMITEM_ATTRIBUTEGROUP = SOMITEMTYPE.SOMITEM_ATTRIBUTEGROUP;
pub const SOMITEM_NOTATION = SOMITEMTYPE.SOMITEM_NOTATION;
pub const SOMITEM_ANNOTATION = SOMITEMTYPE.SOMITEM_ANNOTATION;
pub const SOMITEM_IDENTITYCONSTRAINT = SOMITEMTYPE.SOMITEM_IDENTITYCONSTRAINT;
pub const SOMITEM_KEY = SOMITEMTYPE.SOMITEM_KEY;
pub const SOMITEM_KEYREF = SOMITEMTYPE.SOMITEM_KEYREF;
pub const SOMITEM_UNIQUE = SOMITEMTYPE.SOMITEM_UNIQUE;
pub const SOMITEM_ANYTYPE = SOMITEMTYPE.SOMITEM_ANYTYPE;
pub const SOMITEM_DATATYPE = SOMITEMTYPE.SOMITEM_DATATYPE;
pub const SOMITEM_DATATYPE_ANYTYPE = SOMITEMTYPE.SOMITEM_DATATYPE_ANYTYPE;
pub const SOMITEM_DATATYPE_ANYURI = SOMITEMTYPE.SOMITEM_DATATYPE_ANYURI;
pub const SOMITEM_DATATYPE_BASE64BINARY = SOMITEMTYPE.SOMITEM_DATATYPE_BASE64BINARY;
pub const SOMITEM_DATATYPE_BOOLEAN = SOMITEMTYPE.SOMITEM_DATATYPE_BOOLEAN;
pub const SOMITEM_DATATYPE_BYTE = SOMITEMTYPE.SOMITEM_DATATYPE_BYTE;
pub const SOMITEM_DATATYPE_DATE = SOMITEMTYPE.SOMITEM_DATATYPE_DATE;
pub const SOMITEM_DATATYPE_DATETIME = SOMITEMTYPE.SOMITEM_DATATYPE_DATETIME;
pub const SOMITEM_DATATYPE_DAY = SOMITEMTYPE.SOMITEM_DATATYPE_DAY;
pub const SOMITEM_DATATYPE_DECIMAL = SOMITEMTYPE.SOMITEM_DATATYPE_DECIMAL;
pub const SOMITEM_DATATYPE_DOUBLE = SOMITEMTYPE.SOMITEM_DATATYPE_DOUBLE;
pub const SOMITEM_DATATYPE_DURATION = SOMITEMTYPE.SOMITEM_DATATYPE_DURATION;
pub const SOMITEM_DATATYPE_ENTITIES = SOMITEMTYPE.SOMITEM_DATATYPE_ENTITIES;
pub const SOMITEM_DATATYPE_ENTITY = SOMITEMTYPE.SOMITEM_DATATYPE_ENTITY;
pub const SOMITEM_DATATYPE_FLOAT = SOMITEMTYPE.SOMITEM_DATATYPE_FLOAT;
pub const SOMITEM_DATATYPE_HEXBINARY = SOMITEMTYPE.SOMITEM_DATATYPE_HEXBINARY;
pub const SOMITEM_DATATYPE_ID = SOMITEMTYPE.SOMITEM_DATATYPE_ID;
pub const SOMITEM_DATATYPE_IDREF = SOMITEMTYPE.SOMITEM_DATATYPE_IDREF;
pub const SOMITEM_DATATYPE_IDREFS = SOMITEMTYPE.SOMITEM_DATATYPE_IDREFS;
pub const SOMITEM_DATATYPE_INT = SOMITEMTYPE.SOMITEM_DATATYPE_INT;
pub const SOMITEM_DATATYPE_INTEGER = SOMITEMTYPE.SOMITEM_DATATYPE_INTEGER;
pub const SOMITEM_DATATYPE_LANGUAGE = SOMITEMTYPE.SOMITEM_DATATYPE_LANGUAGE;
pub const SOMITEM_DATATYPE_LONG = SOMITEMTYPE.SOMITEM_DATATYPE_LONG;
pub const SOMITEM_DATATYPE_MONTH = SOMITEMTYPE.SOMITEM_DATATYPE_MONTH;
pub const SOMITEM_DATATYPE_MONTHDAY = SOMITEMTYPE.SOMITEM_DATATYPE_MONTHDAY;
pub const SOMITEM_DATATYPE_NAME = SOMITEMTYPE.SOMITEM_DATATYPE_NAME;
pub const SOMITEM_DATATYPE_NCNAME = SOMITEMTYPE.SOMITEM_DATATYPE_NCNAME;
pub const SOMITEM_DATATYPE_NEGATIVEINTEGER = SOMITEMTYPE.SOMITEM_DATATYPE_NEGATIVEINTEGER;
pub const SOMITEM_DATATYPE_NMTOKEN = SOMITEMTYPE.SOMITEM_DATATYPE_NMTOKEN;
pub const SOMITEM_DATATYPE_NMTOKENS = SOMITEMTYPE.SOMITEM_DATATYPE_NMTOKENS;
pub const SOMITEM_DATATYPE_NONNEGATIVEINTEGER = SOMITEMTYPE.SOMITEM_DATATYPE_NONNEGATIVEINTEGER;
pub const SOMITEM_DATATYPE_NONPOSITIVEINTEGER = SOMITEMTYPE.SOMITEM_DATATYPE_NONPOSITIVEINTEGER;
pub const SOMITEM_DATATYPE_NORMALIZEDSTRING = SOMITEMTYPE.SOMITEM_DATATYPE_NORMALIZEDSTRING;
pub const SOMITEM_DATATYPE_NOTATION = SOMITEMTYPE.SOMITEM_DATATYPE_NOTATION;
pub const SOMITEM_DATATYPE_POSITIVEINTEGER = SOMITEMTYPE.SOMITEM_DATATYPE_POSITIVEINTEGER;
pub const SOMITEM_DATATYPE_QNAME = SOMITEMTYPE.SOMITEM_DATATYPE_QNAME;
pub const SOMITEM_DATATYPE_SHORT = SOMITEMTYPE.SOMITEM_DATATYPE_SHORT;
pub const SOMITEM_DATATYPE_STRING = SOMITEMTYPE.SOMITEM_DATATYPE_STRING;
pub const SOMITEM_DATATYPE_TIME = SOMITEMTYPE.SOMITEM_DATATYPE_TIME;
pub const SOMITEM_DATATYPE_TOKEN = SOMITEMTYPE.SOMITEM_DATATYPE_TOKEN;
pub const SOMITEM_DATATYPE_UNSIGNEDBYTE = SOMITEMTYPE.SOMITEM_DATATYPE_UNSIGNEDBYTE;
pub const SOMITEM_DATATYPE_UNSIGNEDINT = SOMITEMTYPE.SOMITEM_DATATYPE_UNSIGNEDINT;
pub const SOMITEM_DATATYPE_UNSIGNEDLONG = SOMITEMTYPE.SOMITEM_DATATYPE_UNSIGNEDLONG;
pub const SOMITEM_DATATYPE_UNSIGNEDSHORT = SOMITEMTYPE.SOMITEM_DATATYPE_UNSIGNEDSHORT;
pub const SOMITEM_DATATYPE_YEAR = SOMITEMTYPE.SOMITEM_DATATYPE_YEAR;
pub const SOMITEM_DATATYPE_YEARMONTH = SOMITEMTYPE.SOMITEM_DATATYPE_YEARMONTH;
pub const SOMITEM_DATATYPE_ANYSIMPLETYPE = SOMITEMTYPE.SOMITEM_DATATYPE_ANYSIMPLETYPE;
pub const SOMITEM_SIMPLETYPE = SOMITEMTYPE.SOMITEM_SIMPLETYPE;
pub const SOMITEM_COMPLEXTYPE = SOMITEMTYPE.SOMITEM_COMPLEXTYPE;
pub const SOMITEM_PARTICLE = SOMITEMTYPE.SOMITEM_PARTICLE;
pub const SOMITEM_ANY = SOMITEMTYPE.SOMITEM_ANY;
pub const SOMITEM_ANYATTRIBUTE = SOMITEMTYPE.SOMITEM_ANYATTRIBUTE;
pub const SOMITEM_ELEMENT = SOMITEMTYPE.SOMITEM_ELEMENT;
pub const SOMITEM_GROUP = SOMITEMTYPE.SOMITEM_GROUP;
pub const SOMITEM_ALL = SOMITEMTYPE.SOMITEM_ALL;
pub const SOMITEM_CHOICE = SOMITEMTYPE.SOMITEM_CHOICE;
pub const SOMITEM_SEQUENCE = SOMITEMTYPE.SOMITEM_SEQUENCE;
pub const SOMITEM_EMPTYPARTICLE = SOMITEMTYPE.SOMITEM_EMPTYPARTICLE;
pub const SOMITEM_NULL = SOMITEMTYPE.SOMITEM_NULL;
pub const SOMITEM_NULL_TYPE = SOMITEMTYPE.SOMITEM_NULL_TYPE;
pub const SOMITEM_NULL_ANY = SOMITEMTYPE.SOMITEM_NULL_ANY;
pub const SOMITEM_NULL_ANYATTRIBUTE = SOMITEMTYPE.SOMITEM_NULL_ANYATTRIBUTE;
pub const SOMITEM_NULL_ELEMENT = SOMITEMTYPE.SOMITEM_NULL_ELEMENT;
...
pub const XHR_COOKIE_IS_SECURE = XHR_COOKIE_FLAG.XHR_COOKIE_IS_SECURE;
pub const XHR_COOKIE_IS_SESSION = XHR_COOKIE_FLAG.XHR_COOKIE_IS_SESSION;
pub const XHR_COOKIE_THIRD_PARTY = XHR_COOKIE_FLAG.XHR_COOKIE_THIRD_PARTY;
pub const XHR_COOKIE_PROMPT_REQUIRED = XHR_COOKIE_FLAG.XHR_COOKIE_PROMPT_REQUIRED;
pub const XHR_COOKIE_EVALUATE_P3P = XHR_COOKIE_FLAG.XHR_COOKIE_EVALUATE_P3P;
pub const XHR_COOKIE_APPLY_P3P = XHR_COOKIE_FLAG.XHR_COOKIE_APPLY_P3P;
pub const XHR_COOKIE_P3P_ENABLED = XHR_COOKIE_FLAG.XHR_COOKIE_P3P_ENABLED;
pub const XHR_COOKIE_IS_RESTRICTED = XHR_COOKIE_FLAG.XHR_COOKIE_IS_RESTRICTED;
pub const XHR_COOKIE_IE6 = XHR_COOKIE_FLAG.XHR_COOKIE_IE6;
pub const XHR_COOKIE_IS_LEGACY = XHR_COOKIE_FLAG.XHR_COOKIE_IS_LEGACY;
pub const XHR_COOKIE_NON_SCRIPT = XHR_COOKIE_FLAG.XHR_COOKIE_NON_SCRIPT;
pub const XHR_COOKIE_HTTPONLY = XHR_COOKIE_FLAG.XHR_COOKIE_HTTPONLY;
...
pub const XHR_PROP_NO_CRED_PROMPT = XHR_PROPERTY.XHR_PROP_NO_CRED_PROMPT;
pub const XHR_PROP_NO_AUTH = XHR_PROPERTY.XHR_PROP_NO_AUTH;
pub const XHR_PROP_TIMEOUT = XHR_PROPERTY.XHR_PROP_TIMEOUT;
pub const XHR_PROP_NO_DEFAULT_HEADERS = XHR_PROPERTY.XHR_PROP_NO_DEFAULT_HEADERS;
pub const XHR_PROP_REPORT_REDIRECT_STATUS = XHR_PROPERTY.XHR_PROP_REPORT_REDIRECT_STATUS;
pub const XHR_PROP_NO_CACHE = XHR_PROPERTY.XHR_PROP_NO_CACHE;
pub const XHR_PROP_EXTENDED_ERROR = XHR_PROPERTY.XHR_PROP_EXTENDED_ERROR;
pub const XHR_PROP_QUERY_STRING_UTF8 = XHR_PROPERTY.XHR_PROP_QUERY_STRING_UTF8;
pub const XHR_PROP_IGNORE_CERT_ERRORS = XHR_PROPERTY.XHR_PROP_IGNORE_CERT_ERRORS;
pub const XHR_PROP_ONDATA_THRESHOLD = XHR_PROPERTY.XHR_PROP_ONDATA_THRESHOLD;
pub const XHR_PROP_SET_ENTERPRISEID = XHR_PROPERTY.XHR_PROP_SET_ENTERPRISEID;
pub const XHR_PROP_MAX_CONNECTIONS = XHR_PROPERTY.XHR_PROP_MAX_CONNECTIONS;
...
pub const XHR_CERT_IGNORE_REVOCATION_FAILED = XHR_CERT_IGNORE_FLAG.XHR_CERT_IGNORE_REVOCATION_FAILED;
pub const XHR_CERT_IGNORE_UNKNOWN_CA = XHR_CERT_IGNORE_FLAG.XHR_CERT_IGNORE_UNKNOWN_CA;
pub const XHR_CERT_IGNORE_CERT_CN_INVALID = XHR_CERT_IGNORE_FLAG.XHR_CERT_IGNORE_CERT_CN_INVALID;
pub const XHR_CERT_IGNORE_CERT_DATE_INVALID = XHR_CERT_IGNORE_FLAG.XHR_CERT_IGNORE_CERT_DATE_INVALID;
pub const XHR_CERT_IGNORE_ALL_SERVER_ERRORS = XHR_CERT_IGNORE_FLAG.XHR_CERT_IGNORE_ALL_SERVER_ERRORS;
...
pub const XHR_CERT_ERROR_REVOCATION_FAILED = XHR_CERT_ERROR_FLAG.XHR_CERT_ERROR_REVOCATION_FAILED;
pub const XHR_CERT_ERROR_UNKNOWN_CA = XHR_CERT_ERROR_FLAG.XHR_CERT_ERROR_UNKNOWN_CA;
pub const XHR_CERT_ERROR_CERT_CN_INVALID = XHR_CERT_ERROR_FLAG.XHR_CERT_ERROR_CERT_CN_INVALID;
pub const XHR_CERT_ERROR_CERT_DATE_INVALID = XHR_CERT_ERROR_FLAG.XHR_CERT_ERROR_CERT_DATE_INVALID;
pub const XHR_CERT_ERROR_ALL_SERVER_ERRORS = XHR_CERT_ERROR_FLAG.XHR_CERT_ERROR_ALL_SERVER_ERRORS;
...
test {
    ...
    const type_export_count = 78;
    const enum_value_export_count = 160;
