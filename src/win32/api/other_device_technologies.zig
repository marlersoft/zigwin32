...
pub const SID_PnpProvider = @import("../zig.zig").Guid.initString("8101368e-cabb-4426-acff-96c410812000");
pub const SID_UPnPActivator = @import("../zig.zig").Guid.initString("0d0d66eb-cf74-4164-b52f-08344672dd46");
pub const SID_EnumInterface = @import("../zig.zig").Guid.initString("40eab0b9-4d7f-4b53-a334-1581dd9041f4");
pub const SID_PNPXPropertyStore = @import("../zig.zig").Guid.initString("a86530b1-542f-439f-b71c-b0756b13677a");
pub const SID_PNPXAssociation = @import("../zig.zig").Guid.initString("cee8ccc9-4f6b-4469-a235-5a22869eef03");
pub const SID_PNPXServiceCollection = @import("../zig.zig").Guid.initString("439e80ee-a217-4712-9fa6-deabd9c2a727");
pub const SID_FDPairingHandler = @import("../zig.zig").Guid.initString("383b69fa-5486-49da-91f5-d63c24c8e9d0");
pub const SID_EnumDeviceFunction = @import("../zig.zig").Guid.initString("13e0e9e2-c3fa-4e3c-906e-64502fa4dc95");
pub const SID_UnpairProvider = @import("../zig.zig").Guid.initString("89a502fc-857b-4698-a0b7-027192002f9e");
pub const SID_DeviceDisplayStatusManager = @import("../zig.zig").Guid.initString("f59aa553-8309-46ca-9736-1ac3c62d6031");
pub const SID_FunctionDiscoveryProviderRefresh = @import("../zig.zig").Guid.initString("2b4cbdc9-31c4-40d4-a62d-772aa174ed52");
pub const SID_UninstallDeviceFunction = @import("../zig.zig").Guid.initString("c920566e-5671-4496-8025-bf0b89bd44cd");
pub const FMTID_FD = @import("../zig.zig").Guid.initString("904b03a2-471d-423c-a584-f3483238a146");
pub const FD_Visibility_Default : u32 = 0;
pub const FD_Visibility_Hidden : u32 = 1;
pub const FMTID_Device = @import("../zig.zig").Guid.initString("78c34fc8-104a-4aca-9ea4-524d52996e57");
pub const FMTID_DeviceInterface = @import("../zig.zig").Guid.initString("53808008-07bb-4661-bc3c-b5953e708560");
pub const FMTID_Pairing = @import("../zig.zig").Guid.initString("8807cae6-7db6-4f10-8ee4-435eaa1392bc");
pub const FMTID_WSD = @import("../zig.zig").Guid.initString("92506491-ff95-4724-a05a-5b81885a7c92");
pub const FMTID_PNPX = @import("../zig.zig").Guid.initString("656a3bb3-ecc0-43fd-8477-4ae0404a96cd");
pub const FMTID_PNPXDynamicProperty = @import("../zig.zig").Guid.initString("4fc5077e-b686-44be-93e3-86cafe368ccd");
...
test {
    ...
    const constant_export_count = 42;
