...
pub const QC_EQUALS = PropertyConstraint.QC_EQUALS;
pub const QC_NOTEQUAL = PropertyConstraint.QC_NOTEQUAL;
pub const QC_LESSTHAN = PropertyConstraint.QC_LESSTHAN;
pub const QC_LESSTHANOREQUAL = PropertyConstraint.QC_LESSTHANOREQUAL;
pub const QC_GREATERTHAN = PropertyConstraint.QC_GREATERTHAN;
pub const QC_GREATERTHANOREQUAL = PropertyConstraint.QC_GREATERTHANOREQUAL;
pub const QC_STARTSWITH = PropertyConstraint.QC_STARTSWITH;
pub const QC_EXISTS = PropertyConstraint.QC_EXISTS;
pub const QC_DOESNOTEXIST = PropertyConstraint.QC_DOESNOTEXIST;
pub const QC_CONTAINS = PropertyConstraint.QC_CONTAINS;

pub const SystemVisibilityFlags = extern enum(i32) {
    SVF_SYSTEM = 0,
    SVF_USER = 1,
};
pub const SVF_SYSTEM = SystemVisibilityFlags.SVF_SYSTEM;
pub const SVF_USER = SystemVisibilityFlags.SVF_USER;
...
pub const QUA_ADD = QueryUpdateAction.QUA_ADD;
pub const QUA_REMOVE = QueryUpdateAction.QUA_REMOVE;
pub const QUA_CHANGE = QueryUpdateAction.QUA_CHANGE;

pub const QueryCategoryType = extern enum(i32) {
    QCT_PROVIDER = 0,
    QCT_LAYERED = 1,
};
pub const QCT_PROVIDER = QueryCategoryType.QCT_PROVIDER;
pub const QCT_LAYERED = QueryCategoryType.QCT_LAYERED;
...
pub const CFunctionDiscoveryNotificationWrapper = extern struct {
    pub const VTable = extern struct {
        base: IFunctionDiscoveryNotification.VTable,
    };
    vtable: *const VTable,
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IFunctionDiscoveryNotification.MethodMixin(T);
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const IFunctionDiscoveryProvider = extern struct {
    pub const VTable = extern struct {
        ...
        InstancePropertyStoreValidateAccess: fn(
            self: *const IFunctionDiscoveryProvider,
            pIFunctionInstance: *IFunctionInstance,
            iProviderInstanceContext: ?*c_void,
            dwStgAccess: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFunctionDiscoveryProvider_InstancePropertyStoreValidateAccess(self: *const T, pIFunctionInstance: *IFunctionInstance, iProviderInstanceContext: ?*c_void, dwStgAccess: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFunctionDiscoveryProvider_InstancePropertyStoreOpen(self: *const T, pIFunctionInstance: *IFunctionInstance, iProviderInstanceContext: ?*c_void, dwStgAccess: u32, ppIPropertyStore: **IPropertyStore) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFunctionDiscoveryProvider_InstancePropertyStoreFlush(self: *const T, pIFunctionInstance: *IFunctionInstance, iProviderInstanceContext: ?*c_void) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFunctionDiscoveryProvider_InstanceQueryService(self: *const T, pIFunctionInstance: *IFunctionInstance, iProviderInstanceContext: ?*c_void, guidService: *const Guid, riid: *const Guid, ppIUnknown: ?*?*IUnknown) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IFunctionDiscoveryProvider_InstanceReleased(self: *const T, pIFunctionInstance: *IFunctionInstance, iProviderInstanceContext: ?*c_void) callconv(.Inline) HRESULT {
...
pub const IProviderProperties = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IProviderProperties_GetCount(self: *const T, pIFunctionInstance: *IFunctionInstance, iProviderInstanceContext: ?*c_void, pdwCount: *u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IProviderProperties_GetAt(self: *const T, pIFunctionInstance: *IFunctionInstance, iProviderInstanceContext: ?*c_void, dwIndex: u32, pKey: *PROPERTYKEY) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IProviderProperties_GetValue(self: *const T, pIFunctionInstance: *IFunctionInstance, iProviderInstanceContext: ?*c_void, Key: *const PROPERTYKEY, ppropVar: *PROPVARIANT) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IProviderProperties_SetValue(self: *const T, pIFunctionInstance: *IFunctionInstance, iProviderInstanceContext: ?*c_void, Key: *const PROPERTYKEY, ppropVar: *const PROPVARIANT) callconv(.Inline) HRESULT {
...
pub const __MIDL___MIDL_itf_wsdxml_0000_0000_0001 = extern enum(i32) {
    OpNone = 0,
    OpEndOfTable = 1,
    OpBeginElement_ = 2,
    OpBeginAnyElement = 3,
...
pub const OpNone = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpNone;
pub const OpEndOfTable = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpEndOfTable;
pub const OpBeginElement_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpBeginElement_;
pub const OpBeginAnyElement = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpBeginAnyElement;
pub const OpEndElement = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpEndElement;
pub const OpElement_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpElement_;
pub const OpAnyElement = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpAnyElement;
pub const OpAnyElements = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpAnyElements;
pub const OpAnyText = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpAnyText;
pub const OpAttribute_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpAttribute_;
pub const OpBeginChoice = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpBeginChoice;
pub const OpEndChoice = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpEndChoice;
pub const OpBeginSequence = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpBeginSequence;
pub const OpEndSequence = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpEndSequence;
pub const OpBeginAll = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpBeginAll;
pub const OpEndAll = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpEndAll;
pub const OpAnything = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpAnything;
pub const OpAnyNumber = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpAnyNumber;
pub const OpOneOrMore = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpOneOrMore;
pub const OpOptional = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpOptional;
pub const OpFormatBool_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatBool_;
pub const OpFormatInt8_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatInt8_;
pub const OpFormatInt16_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatInt16_;
pub const OpFormatInt32_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatInt32_;
pub const OpFormatInt64_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatInt64_;
pub const OpFormatUInt8_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatUInt8_;
pub const OpFormatUInt16_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatUInt16_;
pub const OpFormatUInt32_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatUInt32_;
pub const OpFormatUInt64_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatUInt64_;
pub const OpFormatUnicodeString_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatUnicodeString_;
pub const OpFormatDom_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatDom_;
pub const OpFormatStruct_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatStruct_;
pub const OpFormatUri_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatUri_;
pub const OpFormatUuidUri_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatUuidUri_;
pub const OpFormatName_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatName_;
pub const OpFormatListInsertTail_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatListInsertTail_;
pub const OpFormatType_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatType_;
pub const OpFormatDynamicType_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatDynamicType_;
pub const OpFormatLookupType_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatLookupType_;
pub const OpFormatDuration_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatDuration_;
pub const OpFormatDateTime_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatDateTime_;
pub const OpFormatFloat_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatFloat_;
pub const OpFormatDouble_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatDouble_;
pub const OpProcess_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpProcess_;
pub const OpQualifiedAttribute_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpQualifiedAttribute_;
pub const OpFormatXMLDeclaration_ = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatXMLDeclaration_;
pub const OpFormatMax = __MIDL___MIDL_itf_wsdxml_0000_0000_0001.OpFormatMax;
...
pub const WSD_CONFIG_MAX_INBOUND_MESSAGE_SIZE = WSD_CONFIG_PARAM_TYPE.WSD_CONFIG_MAX_INBOUND_MESSAGE_SIZE;
pub const WSD_CONFIG_MAX_OUTBOUND_MESSAGE_SIZE = WSD_CONFIG_PARAM_TYPE.WSD_CONFIG_MAX_OUTBOUND_MESSAGE_SIZE;
pub const WSD_SECURITY_SSL_CERT_FOR_CLIENT_AUTH = WSD_CONFIG_PARAM_TYPE.WSD_SECURITY_SSL_CERT_FOR_CLIENT_AUTH;
pub const WSD_SECURITY_SSL_SERVER_CERT_VALIDATION = WSD_CONFIG_PARAM_TYPE.WSD_SECURITY_SSL_SERVER_CERT_VALIDATION;
pub const WSD_SECURITY_SSL_CLIENT_CERT_VALIDATION = WSD_CONFIG_PARAM_TYPE.WSD_SECURITY_SSL_CLIENT_CERT_VALIDATION;
pub const WSD_SECURITY_SSL_NEGOTIATE_CLIENT_CERT = WSD_CONFIG_PARAM_TYPE.WSD_SECURITY_SSL_NEGOTIATE_CLIENT_CERT;
pub const WSD_SECURITY_COMPACTSIG_SIGNING_CERT = WSD_CONFIG_PARAM_TYPE.WSD_SECURITY_COMPACTSIG_SIGNING_CERT;
pub const WSD_SECURITY_COMPACTSIG_VALIDATION = WSD_CONFIG_PARAM_TYPE.WSD_SECURITY_COMPACTSIG_VALIDATION;
pub const WSD_CONFIG_HOSTING_ADDRESSES = WSD_CONFIG_PARAM_TYPE.WSD_CONFIG_HOSTING_ADDRESSES;
pub const WSD_CONFIG_DEVICE_ADDRESSES = WSD_CONFIG_PARAM_TYPE.WSD_CONFIG_DEVICE_ADDRESSES;
pub const WSD_SECURITY_REQUIRE_HTTP_CLIENT_AUTH = WSD_CONFIG_PARAM_TYPE.WSD_SECURITY_REQUIRE_HTTP_CLIENT_AUTH;
pub const WSD_SECURITY_REQUIRE_CLIENT_CERT_OR_HTTP_CLIENT_AUTH = WSD_CONFIG_PARAM_TYPE.WSD_SECURITY_REQUIRE_CLIENT_CERT_OR_HTTP_CLIENT_AUTH;
pub const WSD_SECURITY_USE_HTTP_CLIENT_AUTH = WSD_CONFIG_PARAM_TYPE.WSD_SECURITY_USE_HTTP_CLIENT_AUTH;
...
pub const IWSDTransportAddress = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDTransportAddress_SetPortA(self: *const T, wPort: u16) callconv(.Inline) HRESULT {
            return @ptrCast(*const IWSDTransportAddress.VTable, self.vtable).SetPortA(@ptrCast(*const IWSDTransportAddress, self), wPort);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const IWSDSignatureProperty = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDSignatureProperty_GetKeyInfo(self: *const T, pbKeyInfo: ?[*:0]u8, pdwKeyInfoSize: *u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDSignatureProperty_GetSignature(self: *const T, pbSignature: ?[*:0]u8, pdwSignatureSize: *u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWSDSignatureProperty_GetSignedInfoHash(self: *const T, pbSignedInfoHash: ?[*:0]u8, pdwHashSize: *u32) callconv(.Inline) HRESULT {
...
pub const WSD_PT_NONE = WSD_PROTOCOL_TYPE.WSD_PT_NONE;
pub const WSD_PT_UDP = WSD_PROTOCOL_TYPE.WSD_PT_UDP;
pub const WSD_PT_HTTP = WSD_PROTOCOL_TYPE.WSD_PT_HTTP;
pub const WSD_PT_HTTPS = WSD_PROTOCOL_TYPE.WSD_PT_HTTPS;
pub const WSD_PT_ALL = WSD_PROTOCOL_TYPE.WSD_PT_ALL;
...
pub const WSDET_NONE = WSDEventType.WSDET_NONE;
pub const WSDET_INCOMING_MESSAGE = WSDEventType.WSDET_INCOMING_MESSAGE;
pub const WSDET_INCOMING_FAULT = WSDEventType.WSDET_INCOMING_FAULT;
pub const WSDET_TRANSMISSION_FAILURE = WSDEventType.WSDET_TRANSMISSION_FAILURE;
pub const WSDET_RESPONSE_TIMEOUT = WSDEventType.WSDET_RESPONSE_TIMEOUT;
