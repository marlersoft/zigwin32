...
pub const SYNC_CONSTRAINT_RESOLVE_ACTION = extern enum(i32) {
    DEFER = 0,
    ACCEPT_DESTINATION_PROVIDER = 1,
    ACCEPT_SOURCE_PROVIDER = 2,
...
pub const CONSTRAINT_CONFLICT_REASON = extern enum(i32) {
    OTHER = 0,
    COLLISION = 1,
    NOPARENT = 2,
    IDENTITY = 3,
...
pub const FILTER_COMBINATION_TYPE = extern enum(i32) {
    N = 0,
};
