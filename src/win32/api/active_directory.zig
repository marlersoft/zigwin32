...
pub const CLSID_DsQuery = @import("../zig.zig").Guid.initString("8a23e65e-31c2-11d0-891c-00a024ab2dbb");
pub const CLSID_DsFindObjects = @import("../zig.zig").Guid.initString("83ee3fe1-57d9-11d0-b932-00a024ab2dbb");
pub const CLSID_DsFindPeople = @import("../zig.zig").Guid.initString("83ee3fe2-57d9-11d0-b932-00a024ab2dbb");
pub const CLSID_DsFindPrinter = @import("../zig.zig").Guid.initString("b577f070-7ee2-11d0-913f-00aa00c16e65");
pub const CLSID_DsFindComputer = @import("../zig.zig").Guid.initString("16006700-87ad-11d0-9140-00aa00c16e65");
pub const CLSID_DsFindVolume = @import("../zig.zig").Guid.initString("c1b3cbf1-886a-11d0-9140-00aa00c16e65");
pub const CLSID_DsFindContainer = @import("../zig.zig").Guid.initString("c1b3cbf2-886a-11d0-9140-00aa00c16e65");
pub const CLSID_DsFindAdvanced = @import("../zig.zig").Guid.initString("83ee3fe3-57d9-11d0-b932-00a024ab2dbb");
pub const CLSID_DsFindDomainController = @import("../zig.zig").Guid.initString("538c7b7e-d25e-11d0-9742-00a0c906af45");
pub const CLSID_DsFindWriteableDomainController = @import("../zig.zig").Guid.initString("7cbef079-aa84-444b-bc70-68e41283eabc");
pub const CLSID_DsFindFrsMembers = @import("../zig.zig").Guid.initString("94ce4b18-b3d3-11d1-b9b4-00c04fd8d5b0");
pub const DSQPF_NOSAVE : u32 = 1;
pub const DSQPF_SAVELOCATION : u32 = 2;
pub const DSQPF_SHOWHIDDENOBJECTS : u32 = 4;
pub const DSQPF_ENABLEADMINFEATURES : u32 = 8;
pub const DSQPF_ENABLEADVANCEDFEATURES : u32 = 16;
pub const DSQPF_HASCREDENTIALS : u32 = 32;
pub const DSQPF_NOCHOOSECOLUMNS : u32 = 64;
pub const CLSID_CommonQuery = @import("../zig.zig").Guid.initString("83bc5ec0-6f2a-11d0-a1c4-00aa00c16e65");
pub const QUERYFORM_CHANGESFORMLIST : u64 = 1;
pub const QUERYFORM_CHANGESOPTFORMLIST : u64 = 2;
pub const CQFF_NOGLOBALPAGES : u32 = 1;
pub const CQFF_ISOPTIONAL : u32 = 2;
pub const CQPM_INITIALIZE : u32 = 1;
pub const CQPM_RELEASE : u32 = 2;
pub const CQPM_ENABLE : u32 = 3;
pub const CQPM_GETPARAMETERS : u32 = 5;
pub const CQPM_CLEARFORM : u32 = 6;
pub const CQPM_PERSIST : u32 = 7;
pub const CQPM_HELP : u32 = 8;
pub const CQPM_SETDEFAULTPARAMETERS : u32 = 9;
pub const CQPM_HANDLERSPECIFIC : u32 = 268435456;
pub const OQWF_OKCANCEL : u32 = 1;
pub const OQWF_DEFAULTFORM : u32 = 2;
pub const OQWF_SINGLESELECT : u32 = 4;
pub const OQWF_LOADQUERY : u32 = 8;
pub const OQWF_REMOVESCOPES : u32 = 16;
pub const OQWF_REMOVEFORMS : u32 = 32;
pub const OQWF_ISSUEONOPEN : u32 = 64;
pub const OQWF_SHOWOPTIONAL : u32 = 128;
pub const OQWF_SAVEQUERYONOK : u32 = 512;
pub const OQWF_HIDEMENUS : u32 = 1024;
pub const OQWF_HIDESEARCHUI : u32 = 2048;
pub const OQWF_PARAMISPROPERTYBAG : u32 = 2147483648;
pub const CLSID_MicrosoftDS = @import("../zig.zig").Guid.initString("fe1290f0-cfbd-11cf-a330-00aa00c16e65");
pub const CLSID_DsPropertyPages = @import("../zig.zig").Guid.initString("0d45d530-764b-11d0-a1ca-00aa00c16e65");
pub const CLSID_DsDomainTreeBrowser = @import("../zig.zig").Guid.initString("1698790a-e2b4-11d0-b0b1-00c04fd8dca6");
pub const CLSID_DsDisplaySpecifier = @import("../zig.zig").Guid.initString("1ab4a8c0-6a0b-11d2-ad49-00c04fa31a86");
pub const CLSID_DsFolderProperties = @import("../zig.zig").Guid.initString("9e51e0d0-6e0f-11d2-9601-00c04fa31a86");
pub const DSOBJECT_ISCONTAINER : u32 = 1;
pub const DSOBJECT_READONLYPAGES : u32 = 2147483648;
pub const DSPROVIDER_UNUSED_0 : u32 = 1;
pub const DSPROVIDER_UNUSED_1 : u32 = 2;
pub const DSPROVIDER_UNUSED_2 : u32 = 4;
pub const DSPROVIDER_UNUSED_3 : u32 = 8;
pub const DSPROVIDER_ADVANCED : u32 = 16;
pub const DSPROVIDER_AD_LDS : u32 = 32;
pub const DSDSOF_HASUSERANDSERVERINFO : u32 = 1;
pub const DSDSOF_SIMPLEAUTHENTICATE : u32 = 2;
pub const DSDSOF_DONTSIGNSEAL : u32 = 4;
pub const DSDSOF_DSAVAILABLE : u32 = 1073741824;
pub const DBDTF_RETURNFQDN : u32 = 1;
pub const DBDTF_RETURNMIXEDDOMAINS : u32 = 2;
pub const DBDTF_RETURNEXTERNAL : u32 = 4;
pub const DBDTF_RETURNINBOUND : u32 = 8;
pub const DBDTF_RETURNINOUTBOUND : u32 = 16;
pub const DSSSF_SIMPLEAUTHENTICATE : u32 = 1;
pub const DSSSF_DONTSIGNSEAL : u32 = 2;
pub const DSSSF_DSAVAILABLE : u32 = 2147483648;
pub const DSGIF_ISNORMAL : u32 = 0;
pub const DSGIF_ISOPEN : u32 = 1;
pub const DSGIF_ISDISABLED : u32 = 2;
pub const DSGIF_ISMASK : u32 = 15;
pub const DSGIF_GETDEFAULTICON : u32 = 16;
pub const DSGIF_DEFAULTISCONTAINER : u32 = 32;
pub const DSICCF_IGNORETREATASLEAF : u32 = 1;
pub const DSECAF_NOTLISTED : u32 = 1;
pub const DSCCIF_HASWIZARDDIALOG : u32 = 1;
pub const DSCCIF_HASWIZARDPRIMARYPAGE : u32 = 2;
pub const DSBI_NOBUTTONS : u32 = 1;
pub const DSBI_NOLINES : u32 = 2;
pub const DSBI_NOLINESATROOT : u32 = 4;
pub const DSBI_CHECKBOXES : u32 = 256;
pub const DSBI_NOROOT : u32 = 65536;
pub const DSBI_INCLUDEHIDDEN : u32 = 131072;
pub const DSBI_EXPANDONOPEN : u32 = 262144;
pub const DSBI_ENTIREDIRECTORY : u32 = 589824;
pub const DSBI_RETURN_FORMAT : u32 = 1048576;
pub const DSBI_HASCREDENTIALS : u32 = 2097152;
pub const DSBI_IGNORETREATASLEAF : u32 = 4194304;
pub const DSBI_SIMPLEAUTHENTICATE : u32 = 8388608;
pub const DSBI_RETURNOBJECTCLASS : u32 = 16777216;
pub const DSBI_DONTSIGNSEAL : u32 = 33554432;
pub const DSB_MAX_DISPLAYNAME_CHARS : u32 = 64;
pub const DSBF_STATE : u32 = 1;
pub const DSBF_ICONLOCATION : u32 = 2;
pub const DSBF_DISPLAYNAME : u32 = 4;
pub const DSBS_CHECKED : u32 = 1;
pub const DSBS_HIDDEN : u32 = 2;
pub const DSBS_ROOT : u32 = 4;
pub const DSBM_QUERYINSERTW : u32 = 100;
pub const DSBM_QUERYINSERTA : u32 = 101;
pub const DSBM_CHANGEIMAGESTATE : u32 = 102;
pub const DSBM_HELP : u32 = 103;
pub const DSBM_CONTEXTMENU : u32 = 104;
pub const DSBID_BANNER : u32 = 256;
pub const DSBID_CONTAINERLIST : u32 = 257;
pub const DSOP_SCOPE_TYPE_TARGET_COMPUTER : u32 = 1;
pub const DSOP_SCOPE_TYPE_UPLEVEL_JOINED_DOMAIN : u32 = 2;
pub const DSOP_SCOPE_TYPE_DOWNLEVEL_JOINED_DOMAIN : u32 = 4;
pub const DSOP_SCOPE_TYPE_ENTERPRISE_DOMAIN : u32 = 8;
pub const DSOP_SCOPE_TYPE_GLOBAL_CATALOG : u32 = 16;
pub const DSOP_SCOPE_TYPE_EXTERNAL_UPLEVEL_DOMAIN : u32 = 32;
pub const DSOP_SCOPE_TYPE_EXTERNAL_DOWNLEVEL_DOMAIN : u32 = 64;
pub const DSOP_SCOPE_TYPE_WORKGROUP : u32 = 128;
pub const DSOP_SCOPE_TYPE_USER_ENTERED_UPLEVEL_SCOPE : u32 = 256;
pub const DSOP_SCOPE_TYPE_USER_ENTERED_DOWNLEVEL_SCOPE : u32 = 512;
pub const DSOP_SCOPE_FLAG_STARTING_SCOPE : u32 = 1;
pub const DSOP_SCOPE_FLAG_WANT_PROVIDER_WINNT : u32 = 2;
pub const DSOP_SCOPE_FLAG_WANT_PROVIDER_LDAP : u32 = 4;
pub const DSOP_SCOPE_FLAG_WANT_PROVIDER_GC : u32 = 8;
pub const DSOP_SCOPE_FLAG_WANT_SID_PATH : u32 = 16;
pub const DSOP_SCOPE_FLAG_WANT_DOWNLEVEL_BUILTIN_PATH : u32 = 32;
pub const DSOP_SCOPE_FLAG_DEFAULT_FILTER_USERS : u32 = 64;
pub const DSOP_SCOPE_FLAG_DEFAULT_FILTER_GROUPS : u32 = 128;
pub const DSOP_SCOPE_FLAG_DEFAULT_FILTER_COMPUTERS : u32 = 256;
pub const DSOP_SCOPE_FLAG_DEFAULT_FILTER_CONTACTS : u32 = 512;
pub const DSOP_SCOPE_FLAG_DEFAULT_FILTER_SERVICE_ACCOUNTS : u32 = 1024;
pub const DSOP_SCOPE_FLAG_DEFAULT_FILTER_PASSWORDSETTINGS_OBJECTS : u32 = 2048;
pub const DSOP_FILTER_INCLUDE_ADVANCED_VIEW : u32 = 1;
pub const DSOP_FILTER_USERS : u32 = 2;
pub const DSOP_FILTER_BUILTIN_GROUPS : u32 = 4;
pub const DSOP_FILTER_WELL_KNOWN_PRINCIPALS : u32 = 8;
pub const DSOP_FILTER_UNIVERSAL_GROUPS_DL : u32 = 16;
pub const DSOP_FILTER_UNIVERSAL_GROUPS_SE : u32 = 32;
pub const DSOP_FILTER_GLOBAL_GROUPS_DL : u32 = 64;
pub const DSOP_FILTER_GLOBAL_GROUPS_SE : u32 = 128;
pub const DSOP_FILTER_DOMAIN_LOCAL_GROUPS_DL : u32 = 256;
pub const DSOP_FILTER_DOMAIN_LOCAL_GROUPS_SE : u32 = 512;
pub const DSOP_FILTER_CONTACTS : u32 = 1024;
pub const DSOP_FILTER_COMPUTERS : u32 = 2048;
pub const DSOP_FILTER_SERVICE_ACCOUNTS : u32 = 4096;
pub const DSOP_FILTER_PASSWORDSETTINGS_OBJECTS : u32 = 8192;
pub const DSOP_DOWNLEVEL_FILTER_USERS : u32 = 2147483649;
pub const DSOP_DOWNLEVEL_FILTER_LOCAL_GROUPS : u32 = 2147483650;
pub const DSOP_DOWNLEVEL_FILTER_GLOBAL_GROUPS : u32 = 2147483652;
pub const DSOP_DOWNLEVEL_FILTER_COMPUTERS : u32 = 2147483656;
pub const DSOP_DOWNLEVEL_FILTER_WORLD : u32 = 2147483664;
pub const DSOP_DOWNLEVEL_FILTER_AUTHENTICATED_USER : u32 = 2147483680;
pub const DSOP_DOWNLEVEL_FILTER_ANONYMOUS : u32 = 2147483712;
pub const DSOP_DOWNLEVEL_FILTER_BATCH : u32 = 2147483776;
pub const DSOP_DOWNLEVEL_FILTER_CREATOR_OWNER : u32 = 2147483904;
pub const DSOP_DOWNLEVEL_FILTER_CREATOR_GROUP : u32 = 2147484160;
pub const DSOP_DOWNLEVEL_FILTER_DIALUP : u32 = 2147484672;
pub const DSOP_DOWNLEVEL_FILTER_INTERACTIVE : u32 = 2147485696;
pub const DSOP_DOWNLEVEL_FILTER_NETWORK : u32 = 2147487744;
pub const DSOP_DOWNLEVEL_FILTER_SERVICE : u32 = 2147491840;
pub const DSOP_DOWNLEVEL_FILTER_SYSTEM : u32 = 2147500032;
pub const DSOP_DOWNLEVEL_FILTER_EXCLUDE_BUILTIN_GROUPS : u32 = 2147516416;
pub const DSOP_DOWNLEVEL_FILTER_TERMINAL_SERVER : u32 = 2147549184;
pub const DSOP_DOWNLEVEL_FILTER_ALL_WELLKNOWN_SIDS : u32 = 2147614720;
pub const DSOP_DOWNLEVEL_FILTER_LOCAL_SERVICE : u32 = 2147745792;
pub const DSOP_DOWNLEVEL_FILTER_NETWORK_SERVICE : u32 = 2148007936;
pub const DSOP_DOWNLEVEL_FILTER_REMOTE_LOGON : u32 = 2148532224;
pub const DSOP_DOWNLEVEL_FILTER_INTERNET_USER : u32 = 2149580800;
pub const DSOP_DOWNLEVEL_FILTER_OWNER_RIGHTS : u32 = 2151677952;
pub const DSOP_DOWNLEVEL_FILTER_SERVICES : u32 = 2155872256;
pub const DSOP_DOWNLEVEL_FILTER_LOCAL_LOGON : u32 = 2164260864;
pub const DSOP_DOWNLEVEL_FILTER_THIS_ORG_CERT : u32 = 2181038080;
pub const DSOP_DOWNLEVEL_FILTER_IIS_APP_POOL : u32 = 2214592512;
pub const DSOP_DOWNLEVEL_FILTER_ALL_APP_PACKAGES : u32 = 2281701376;
pub const DSOP_DOWNLEVEL_FILTER_LOCAL_ACCOUNTS : u32 = 2415919104;
pub const DSOP_FLAG_MULTISELECT : u32 = 1;
pub const DSOP_FLAG_SKIP_TARGET_COMPUTER_DC_CHECK : u32 = 2;
pub const CLSID_DsAdminCreateObj = @import("../zig.zig").Guid.initString("e301a009-f901-11d2-82b9-00c04f68928b");
pub const DSA_NEWOBJ_CTX_PRECOMMIT : u32 = 1;
pub const DSA_NEWOBJ_CTX_COMMIT : u32 = 2;
pub const DSA_NEWOBJ_CTX_POSTCOMMIT : u32 = 3;
pub const DSA_NEWOBJ_CTX_CLEANUP : u32 = 4;
pub const DSA_NOTIFY_DEL : u32 = 1;
pub const DSA_NOTIFY_REN : u32 = 2;
pub const DSA_NOTIFY_MOV : u32 = 4;
pub const DSA_NOTIFY_PROP : u32 = 8;
pub const DSA_NOTIFY_FLAG_ADDITIONAL_DATA : u32 = 2;
pub const DSA_NOTIFY_FLAG_FORCE_ADDITIONAL_DATA : u32 = 1;
...
pub const ADS_USE_SSL = ADS_AUTHENTICATION_ENUM.USE_SSL;
...
pub const ADS_SYSTEMFLAG_ATTR_NOT_REPLICATED = ADS_SYSTEMFLAG_ENUM.ATTR_NOT_REPLICATED;
...
pub const ADS_GROUP_TYPE_LOCAL_GROUP = ADS_GROUP_TYPE_ENUM.LOCAL_GROUP;
...
test {
    ...
    const constant_export_count = 440;
    const type_export_count = 240;
    const enum_value_export_count = 322;
    const com_iface_id_export_count = 78;
