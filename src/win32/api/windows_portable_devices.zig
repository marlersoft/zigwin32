...
//--------------------------------------------------------------------------------
pub const DEVPKEY_MTPBTH_IsConnected = @import("../zig.zig").PropertyKey.init("ea1237fa-589d-4472-84e4-0abe36fd62ef", 2);
pub const GUID_DEVINTERFACE_WPD = @import("../zig.zig").Guid.initString("6ac27878-a6fa-4155-ba85-f98f491d4f33");
pub const GUID_DEVINTERFACE_WPD_PRIVATE = @import("../zig.zig").Guid.initString("ba0c718f-4ded-49b7-bdd3-fabe28661211");
pub const GUID_DEVINTERFACE_WPD_SERVICE = @import("../zig.zig").Guid.initString("9ef44f80-3d64-4246-a6aa-206f328d1edc");
pub const WPD_CONTROL_FUNCTION_GENERIC_MESSAGE : u32 = 66;
pub const FACILITY_WPD : u32 = 42;
pub const WPD_EVENT_NOTIFICATION = @import("../zig.zig").Guid.initString("2ba2e40a-6b4c-4295-bb43-26322b99aeb2");
pub const WPD_EVENT_OBJECT_ADDED = @import("../zig.zig").Guid.initString("a726da95-e207-4b02-8d44-bef2e86cbffc");
pub const WPD_EVENT_OBJECT_REMOVED = @import("../zig.zig").Guid.initString("be82ab88-a52c-4823-96e5-d0272671fc38");
pub const WPD_EVENT_OBJECT_UPDATED = @import("../zig.zig").Guid.initString("1445a759-2e01-485d-9f27-ff07dae697ab");
pub const WPD_EVENT_DEVICE_RESET = @import("../zig.zig").Guid.initString("7755cf53-c1ed-44f3-b5a2-451e2c376b27");
pub const WPD_EVENT_DEVICE_CAPABILITIES_UPDATED = @import("../zig.zig").Guid.initString("36885aa1-cd54-4daa-b3d0-afb3e03f5999");
pub const WPD_EVENT_STORAGE_FORMAT = @import("../zig.zig").Guid.initString("3782616b-22bc-4474-a251-3070f8d38857");
pub const WPD_EVENT_OBJECT_TRANSFER_REQUESTED = @import("../zig.zig").Guid.initString("8d16a0a1-f2c6-41da-8f19-5e53721adbf2");
pub const WPD_EVENT_DEVICE_REMOVED = @import("../zig.zig").Guid.initString("e4cbca1b-6918-48b9-85ee-02be7c850af9");
pub const WPD_EVENT_SERVICE_METHOD_COMPLETE = @import("../zig.zig").Guid.initString("8a33f5f8-0acc-4d9b-9cc4-112d353b86ca");
pub const WPD_CONTENT_TYPE_FUNCTIONAL_OBJECT = @import("../zig.zig").Guid.initString("99ed0160-17ff-4c44-9d98-1d7a6f941921");
pub const WPD_CONTENT_TYPE_FOLDER = @import("../zig.zig").Guid.initString("27e2e392-a111-48e0-ab0c-e17705a05f85");
pub const WPD_CONTENT_TYPE_IMAGE = @import("../zig.zig").Guid.initString("ef2107d5-a52a-4243-a26b-62d4176d7603");
pub const WPD_CONTENT_TYPE_DOCUMENT = @import("../zig.zig").Guid.initString("680adf52-950a-4041-9b41-65e393648155");
pub const WPD_CONTENT_TYPE_CONTACT = @import("../zig.zig").Guid.initString("eaba8313-4525-4707-9f0e-87c6808e9435");
pub const WPD_CONTENT_TYPE_CONTACT_GROUP = @import("../zig.zig").Guid.initString("346b8932-4c36-40d8-9415-1828291f9de9");
pub const WPD_CONTENT_TYPE_AUDIO = @import("../zig.zig").Guid.initString("4ad2c85e-5e2d-45e5-8864-4f229e3c6cf0");
pub const WPD_CONTENT_TYPE_VIDEO = @import("../zig.zig").Guid.initString("9261b03c-3d78-4519-85e3-02c5e1f50bb9");
pub const WPD_CONTENT_TYPE_TELEVISION = @import("../zig.zig").Guid.initString("60a169cf-f2ae-4e21-9375-9677f11c1c6e");
pub const WPD_CONTENT_TYPE_PLAYLIST = @import("../zig.zig").Guid.initString("1a33f7e4-af13-48f5-994e-77369dfe04a3");
pub const WPD_CONTENT_TYPE_MIXED_CONTENT_ALBUM = @import("../zig.zig").Guid.initString("00f0c3ac-a593-49ac-9219-24abca5a2563");
pub const WPD_CONTENT_TYPE_AUDIO_ALBUM = @import("../zig.zig").Guid.initString("aa18737e-5009-48fa-ae21-85f24383b4e6");
pub const WPD_CONTENT_TYPE_IMAGE_ALBUM = @import("../zig.zig").Guid.initString("75793148-15f5-4a30-a813-54ed8a37e226");
pub const WPD_CONTENT_TYPE_VIDEO_ALBUM = @import("../zig.zig").Guid.initString("012b0db7-d4c1-45d6-b081-94b87779614f");
pub const WPD_CONTENT_TYPE_MEMO = @import("../zig.zig").Guid.initString("9cd20ecf-3b50-414f-a641-e473ffe45751");
pub const WPD_CONTENT_TYPE_EMAIL = @import("../zig.zig").Guid.initString("8038044a-7e51-4f8f-883d-1d0623d14533");
pub const WPD_CONTENT_TYPE_APPOINTMENT = @import("../zig.zig").Guid.initString("0fed060e-8793-4b1e-90c9-48ac389ac631");
pub const WPD_CONTENT_TYPE_TASK = @import("../zig.zig").Guid.initString("63252f2c-887f-4cb6-b1ac-d29855dcef6c");
pub const WPD_CONTENT_TYPE_PROGRAM = @import("../zig.zig").Guid.initString("d269f96a-247c-4bff-98fb-97f3c49220e6");
pub const WPD_CONTENT_TYPE_GENERIC_FILE = @import("../zig.zig").Guid.initString("0085e0a6-8d34-45d7-bc5c-447e59c73d48");
pub const WPD_CONTENT_TYPE_CALENDAR = @import("../zig.zig").Guid.initString("a1fd5967-6023-49a0-9df1-f8060be751b0");
pub const WPD_CONTENT_TYPE_GENERIC_MESSAGE = @import("../zig.zig").Guid.initString("e80eaaf8-b2db-4133-b67e-1bef4b4a6e5f");
pub const WPD_CONTENT_TYPE_NETWORK_ASSOCIATION = @import("../zig.zig").Guid.initString("031da7ee-18c8-4205-847e-89a11261d0f3");
pub const WPD_CONTENT_TYPE_CERTIFICATE = @import("../zig.zig").Guid.initString("dc3876e8-a948-4060-9050-cbd77e8a3d87");
pub const WPD_CONTENT_TYPE_WIRELESS_PROFILE = @import("../zig.zig").Guid.initString("0bac070a-9f5f-4da4-a8f6-3de44d68fd6c");
pub const WPD_CONTENT_TYPE_MEDIA_CAST = @import("../zig.zig").Guid.initString("5e88b3cc-3e65-4e62-bfff-229495253ab0");
pub const WPD_CONTENT_TYPE_SECTION = @import("../zig.zig").Guid.initString("821089f5-1d91-4dc9-be3c-bbb1b35b18ce");
pub const WPD_CONTENT_TYPE_UNSPECIFIED = @import("../zig.zig").Guid.initString("28d8d31e-249c-454e-aabc-34883168e634");
pub const WPD_CONTENT_TYPE_ALL = @import("../zig.zig").Guid.initString("80e170d2-1055-4a3e-b952-82cc4f8a8689");
pub const WPD_FUNCTIONAL_CATEGORY_DEVICE = @import("../zig.zig").Guid.initString("08ea466b-e3a4-4336-a1f3-a44d2b5c438c");
pub const WPD_FUNCTIONAL_CATEGORY_STORAGE = @import("../zig.zig").Guid.initString("23f05bbc-15de-4c2a-a55b-a9af5ce412ef");
pub const WPD_FUNCTIONAL_CATEGORY_STILL_IMAGE_CAPTURE = @import("../zig.zig").Guid.initString("613ca327-ab93-4900-b4fa-895bb5874b79");
pub const WPD_FUNCTIONAL_CATEGORY_AUDIO_CAPTURE = @import("../zig.zig").Guid.initString("3f2a1919-c7c2-4a00-855d-f57cf06debbb");
pub const WPD_FUNCTIONAL_CATEGORY_VIDEO_CAPTURE = @import("../zig.zig").Guid.initString("e23e5f6b-7243-43aa-8df1-0eb3d968a918");
pub const WPD_FUNCTIONAL_CATEGORY_SMS = @import("../zig.zig").Guid.initString("0044a0b1-c1e9-4afd-b358-a62c6117c9cf");
pub const WPD_FUNCTIONAL_CATEGORY_RENDERING_INFORMATION = @import("../zig.zig").Guid.initString("08600ba4-a7ba-4a01-ab0e-0065d0a356d3");
pub const WPD_FUNCTIONAL_CATEGORY_NETWORK_CONFIGURATION = @import("../zig.zig").Guid.initString("48f4db72-7c6a-4ab0-9e1a-470e3cdbf26a");
pub const WPD_FUNCTIONAL_CATEGORY_ALL = @import("../zig.zig").Guid.initString("2d8a6512-a74c-448e-ba8a-f4ac07c49399");
pub const WPD_OBJECT_FORMAT_ICON = @import("../zig.zig").Guid.initString("077232ed-102c-4638-9c22-83f142bfc822");
pub const WPD_OBJECT_FORMAT_M4A = @import("../zig.zig").Guid.initString("30aba7ac-6ffd-4c23-a359-3e9b52f3f1c8");
pub const WPD_OBJECT_FORMAT_NETWORK_ASSOCIATION = @import("../zig.zig").Guid.initString("b1020000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_X509V3CERTIFICATE = @import("../zig.zig").Guid.initString("b1030000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_MICROSOFT_WFC = @import("../zig.zig").Guid.initString("b1040000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_3GPA = @import("../zig.zig").Guid.initString("e5172730-f971-41ef-a10b-2271a0019d7a");
pub const WPD_OBJECT_FORMAT_3G2A = @import("../zig.zig").Guid.initString("1a11202d-8759-4e34-ba5e-b1211087eee4");
pub const WPD_OBJECT_FORMAT_ALL = @import("../zig.zig").Guid.initString("c1f62eb2-4bb3-479c-9cfa-05b5f3a57b22");
pub const WPD_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("ef6b490d-5cd8-437a-affc-da8b60ee4a3c");
pub const WPD_OBJECT_PROPERTIES_V2 = @import("../zig.zig").Guid.initString("0373cd3d-4a46-40d7-b4d8-73e8da74e775");
pub const WPD_FUNCTIONAL_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("8f052d93-abca-4fc5-a5ac-b01df4dbe598");
pub const WPD_STORAGE_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("01a3057a-74d6-4e80-bea7-dc4c212ce50a");
pub const WPD_NETWORK_ASSOCIATION_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("e4c93c1f-b203-43f1-a100-5a07d11b0274");
pub const WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("58c571ec-1bcb-42a7-8ac5-bb291573a260");
pub const WPD_RENDERING_INFORMATION_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("c53d039f-ee23-4a31-8590-7639879870b4");
pub const WPD_CLIENT_INFORMATION_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("204d9f0c-2292-4080-9f42-40664e70f859");
pub const WPD_PROPERTY_ATTRIBUTES_V1 = @import("../zig.zig").Guid.initString("ab7943d8-6332-445f-a00d-8d5ef1e96f37");
pub const WPD_PROPERTY_ATTRIBUTES_V2 = @import("../zig.zig").Guid.initString("5d9da160-74ae-43cc-85a9-fe555a80798e");
pub const WPD_CLASS_EXTENSION_OPTIONS_V1 = @import("../zig.zig").Guid.initString("6309ffef-a87c-4ca7-8434-797576e40a96");
pub const WPD_CLASS_EXTENSION_OPTIONS_V2 = @import("../zig.zig").Guid.initString("3e3595da-4d71-49fe-a0b4-d4406c3ae93f");
pub const WPD_CLASS_EXTENSION_OPTIONS_V3 = @import("../zig.zig").Guid.initString("65c160f8-1367-4ce2-939d-8310839f0d30");
pub const WPD_RESOURCE_ATTRIBUTES_V1 = @import("../zig.zig").Guid.initString("1eb6f604-9278-429f-93cc-5bb8c06656b6");
pub const WPD_DEVICE_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("26d4979a-e643-4626-9e2b-736dc0c92fdc");
pub const WPD_DEVICE_PROPERTIES_V2 = @import("../zig.zig").Guid.initString("463dd662-7fc4-4291-911c-7f4c9cca9799");
pub const WPD_DEVICE_PROPERTIES_V3 = @import("../zig.zig").Guid.initString("6c2b878c-c2ec-490d-b425-d7a75e23e5ed");
pub const WPD_SERVICE_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("7510698a-cb54-481c-b8db-0d75c93f1c06");
pub const WPD_EVENT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("15ab1953-f817-4fef-a921-5676e838f6e0");
pub const WPD_EVENT_PROPERTIES_V2 = @import("../zig.zig").Guid.initString("52807b8a-4914-4323-9b9a-74f654b2b846");
pub const WPD_EVENT_OPTIONS_V1 = @import("../zig.zig").Guid.initString("b3d8dad7-a361-4b83-8a48-5b02ce10713b");
pub const WPD_EVENT_ATTRIBUTES_V1 = @import("../zig.zig").Guid.initString("10c96578-2e81-4111-adde-e08ca6138f6d");
pub const WPD_API_OPTIONS_V1 = @import("../zig.zig").Guid.initString("10e54a3e-052d-4777-a13c-de7614be2bc4");
pub const WPD_FORMAT_ATTRIBUTES_V1 = @import("../zig.zig").Guid.initString("a0a02000-bcaf-4be8-b3f5-233f231cf58f");
pub const WPD_METHOD_ATTRIBUTES_V1 = @import("../zig.zig").Guid.initString("f17a5071-f039-44af-8efe-432cf32e432a");
pub const WPD_PARAMETER_ATTRIBUTES_V1 = @import("../zig.zig").Guid.initString("e6864dd7-f325-45ea-a1d5-97cf73b6ca58");
pub const WPD_CATEGORY_COMMON = @import("../zig.zig").Guid.initString("f0422a9c-5dc8-4440-b5bd-5df28835658a");
pub const WPD_CATEGORY_OBJECT_ENUMERATION = @import("../zig.zig").Guid.initString("b7474e91-e7f8-4ad9-b400-ad1a4b58eeec");
pub const WPD_CATEGORY_OBJECT_PROPERTIES = @import("../zig.zig").Guid.initString("9e5582e4-0814-44e6-981a-b2998d583804");
pub const WPD_CATEGORY_OBJECT_PROPERTIES_BULK = @import("../zig.zig").Guid.initString("11c824dd-04cd-4e4e-8c7b-f6efb794d84e");
pub const WPD_CATEGORY_OBJECT_RESOURCES = @import("../zig.zig").Guid.initString("b3a2b22d-a595-4108-be0a-fc3c965f3d4a");
pub const WPD_CATEGORY_OBJECT_MANAGEMENT = @import("../zig.zig").Guid.initString("ef1e43dd-a9ed-4341-8bcc-186192aea089");
pub const WPD_CATEGORY_CAPABILITIES = @import("../zig.zig").Guid.initString("0cabec78-6b74-41c6-9216-2639d1fce356");
pub const WPD_CATEGORY_STORAGE = @import("../zig.zig").Guid.initString("d8f907a6-34cc-45fa-97fb-d007fa47ec94");
pub const WPD_CATEGORY_SMS = @import("../zig.zig").Guid.initString("afc25d66-fe0d-4114-9097-970c93e920d1");
pub const WPD_CATEGORY_STILL_IMAGE_CAPTURE = @import("../zig.zig").Guid.initString("4fcd6982-22a2-4b05-a48b-62d38bf27b32");
pub const WPD_CATEGORY_MEDIA_CAPTURE = @import("../zig.zig").Guid.initString("59b433ba-fe44-4d8d-808c-6bcb9b0f15e8");
pub const WPD_CATEGORY_DEVICE_HINTS = @import("../zig.zig").Guid.initString("0d5fb92b-cb46-4c4f-8343-0bc3d3f17c84");
pub const WPD_CLASS_EXTENSION_V1 = @import("../zig.zig").Guid.initString("33fb0d11-64a3-4fac-b4c7-3dfeaa99b051");
pub const WPD_CLASS_EXTENSION_V2 = @import("../zig.zig").Guid.initString("7f0779b5-fa2b-4766-9cb2-f73ba30b6758");
pub const WPD_CATEGORY_NETWORK_CONFIGURATION = @import("../zig.zig").Guid.initString("78f9c6fc-79b8-473c-9060-6bd23dd072c4");
pub const WPD_CATEGORY_SERVICE_COMMON = @import("../zig.zig").Guid.initString("322f071d-36ef-477f-b4b5-6f52d734baee");
pub const WPD_CATEGORY_SERVICE_CAPABILITIES = @import("../zig.zig").Guid.initString("24457e74-2e9f-44f9-8c57-1d1bcb170b89");
pub const WPD_CATEGORY_SERVICE_METHODS = @import("../zig.zig").Guid.initString("2d521ca8-c1b0-4268-a342-cf19321569bc");
pub const WPD_OBJECT_FORMAT_PROPERTIES_ONLY = @import("../zig.zig").Guid.initString("30010000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_UNSPECIFIED = @import("../zig.zig").Guid.initString("30000000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_SCRIPT = @import("../zig.zig").Guid.initString("30020000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_EXECUTABLE = @import("../zig.zig").Guid.initString("30030000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_TEXT = @import("../zig.zig").Guid.initString("30040000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_HTML = @import("../zig.zig").Guid.initString("30050000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_DPOF = @import("../zig.zig").Guid.initString("30060000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_AIFF = @import("../zig.zig").Guid.initString("30070000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_WAVE = @import("../zig.zig").Guid.initString("30080000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_MP3 = @import("../zig.zig").Guid.initString("30090000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_AVI = @import("../zig.zig").Guid.initString("300a0000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_MPEG = @import("../zig.zig").Guid.initString("300b0000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_ASF = @import("../zig.zig").Guid.initString("300c0000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_EXIF = @import("../zig.zig").Guid.initString("38010000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_TIFFEP = @import("../zig.zig").Guid.initString("38020000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_FLASHPIX = @import("../zig.zig").Guid.initString("38030000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_BMP = @import("../zig.zig").Guid.initString("38040000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_CIFF = @import("../zig.zig").Guid.initString("38050000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_GIF = @import("../zig.zig").Guid.initString("38070000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_JFIF = @import("../zig.zig").Guid.initString("38080000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_PCD = @import("../zig.zig").Guid.initString("38090000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_PICT = @import("../zig.zig").Guid.initString("380a0000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_PNG = @import("../zig.zig").Guid.initString("380b0000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_TIFF = @import("../zig.zig").Guid.initString("380d0000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_TIFFIT = @import("../zig.zig").Guid.initString("380e0000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_JP2 = @import("../zig.zig").Guid.initString("380f0000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_JPX = @import("../zig.zig").Guid.initString("38100000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_WBMP = @import("../zig.zig").Guid.initString("b8030000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_JPEGXR = @import("../zig.zig").Guid.initString("b8040000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_WINDOWSIMAGEFORMAT = @import("../zig.zig").Guid.initString("b8810000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_WMA = @import("../zig.zig").Guid.initString("b9010000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_WMV = @import("../zig.zig").Guid.initString("b9810000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_WPLPLAYLIST = @import("../zig.zig").Guid.initString("ba100000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_M3UPLAYLIST = @import("../zig.zig").Guid.initString("ba110000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_MPLPLAYLIST = @import("../zig.zig").Guid.initString("ba120000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_ASXPLAYLIST = @import("../zig.zig").Guid.initString("ba130000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_PLSPLAYLIST = @import("../zig.zig").Guid.initString("ba140000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_ABSTRACT_CONTACT_GROUP = @import("../zig.zig").Guid.initString("ba060000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_ABSTRACT_MEDIA_CAST = @import("../zig.zig").Guid.initString("ba0b0000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_VCALENDAR1 = @import("../zig.zig").Guid.initString("be020000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_ICALENDAR = @import("../zig.zig").Guid.initString("be030000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_ABSTRACT_CONTACT = @import("../zig.zig").Guid.initString("bb810000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_VCARD2 = @import("../zig.zig").Guid.initString("bb820000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_VCARD3 = @import("../zig.zig").Guid.initString("bb830000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_XML = @import("../zig.zig").Guid.initString("ba820000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_AAC = @import("../zig.zig").Guid.initString("b9030000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_AUDIBLE = @import("../zig.zig").Guid.initString("b9040000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_FLAC = @import("../zig.zig").Guid.initString("b9060000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_QCELP = @import("../zig.zig").Guid.initString("b9070000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_AMR = @import("../zig.zig").Guid.initString("b9080000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_OGG = @import("../zig.zig").Guid.initString("b9020000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_MP4 = @import("../zig.zig").Guid.initString("b9820000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_MP2 = @import("../zig.zig").Guid.initString("b9830000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_MICROSOFT_WORD = @import("../zig.zig").Guid.initString("ba830000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_MHT_COMPILED_HTML = @import("../zig.zig").Guid.initString("ba840000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_MICROSOFT_EXCEL = @import("../zig.zig").Guid.initString("ba850000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_MICROSOFT_POWERPOINT = @import("../zig.zig").Guid.initString("ba860000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_3GP = @import("../zig.zig").Guid.initString("b9840000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_3G2 = @import("../zig.zig").Guid.initString("b9850000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_AVCHD = @import("../zig.zig").Guid.initString("b9860000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_ATSCTS = @import("../zig.zig").Guid.initString("b9870000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_DVBTS = @import("../zig.zig").Guid.initString("b9880000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_OBJECT_FORMAT_MKV = @import("../zig.zig").Guid.initString("b9900000-ae6c-4804-98ba-c57b46965fe7");
pub const WPD_FOLDER_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("7e9a7abf-e568-4b34-aa2f-13bb12ab177d");
pub const WPD_IMAGE_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("63d64908-9fa1-479f-85ba-9952216447db");
pub const WPD_DOCUMENT_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("0b110203-eb95-4f02-93e0-97c631493ad5");
pub const WPD_MEDIA_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("2ed8ba05-0ad3-42dc-b0d0-bc95ac396ac8");
pub const WPD_CONTACT_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("fbd4fdab-987d-4777-b3f9-726185a9312b");
pub const WPD_MUSIC_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("b324f56a-dc5d-46e5-b6df-d2ea414888c6");
pub const WPD_VIDEO_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("346f2163-f998-4146-8b01-d19b4c00de9a");
pub const WPD_COMMON_INFORMATION_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("b28ae94b-05a4-4e8e-be01-72cc7e099d8f");
pub const WPD_MEMO_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("5ffbfc7b-7483-41ad-afb9-da3f4e592b8d");
pub const WPD_EMAIL_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("41f8f65a-5484-4782-b13d-4740dd7c37c5");
pub const WPD_APPOINTMENT_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("f99efd03-431d-40d8-a1c9-4e220d9c88d3");
pub const WPD_TASK_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("e354e95e-d8a0-4637-a03a-0cb26838dbc7");
pub const WPD_SMS_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("7e1074cc-50ff-4dd1-a742-53be6f093a0d");
pub const WPD_SECTION_OBJECT_PROPERTIES_V1 = @import("../zig.zig").Guid.initString("516afd2b-c64e-44f0-98dc-bee1c88f7d66");
...
test {
    const constant_export_count = 183;
