...
//--------------------------------------------------------------------------------
pub const IMAPI_S_PROPERTIESIGNORED : i32 = 262656;
pub const IMAPI_S_BUFFER_TO_SMALL : i32 = 262657;
pub const IMAPI_E_NOTOPENED : i32 = -2147220981;
pub const IMAPI_E_NOTINITIALIZED : i32 = -2147220980;
pub const IMAPI_E_USERABORT : i32 = -2147220979;
pub const IMAPI_E_GENERIC : i32 = -2147220978;
pub const IMAPI_E_MEDIUM_NOTPRESENT : i32 = -2147220977;
pub const IMAPI_E_MEDIUM_INVALIDTYPE : i32 = -2147220976;
pub const IMAPI_E_DEVICE_NOPROPERTIES : i32 = -2147220975;
pub const IMAPI_E_DEVICE_NOTACCESSIBLE : i32 = -2147220974;
pub const IMAPI_E_DEVICE_NOTPRESENT : i32 = -2147220973;
pub const IMAPI_E_DEVICE_INVALIDTYPE : i32 = -2147220972;
pub const IMAPI_E_INITIALIZE_WRITE : i32 = -2147220971;
pub const IMAPI_E_INITIALIZE_ENDWRITE : i32 = -2147220970;
pub const IMAPI_E_FILESYSTEM : i32 = -2147220969;
pub const IMAPI_E_FILEACCESS : i32 = -2147220968;
pub const IMAPI_E_DISCINFO : i32 = -2147220967;
pub const IMAPI_E_TRACKNOTOPEN : i32 = -2147220966;
pub const IMAPI_E_TRACKOPEN : i32 = -2147220965;
pub const IMAPI_E_DISCFULL : i32 = -2147220964;
pub const IMAPI_E_BADJOLIETNAME : i32 = -2147220963;
pub const IMAPI_E_INVALIDIMAGE : i32 = -2147220962;
pub const IMAPI_E_NOACTIVEFORMAT : i32 = -2147220961;
pub const IMAPI_E_NOACTIVERECORDER : i32 = -2147220960;
pub const IMAPI_E_WRONGFORMAT : i32 = -2147220959;
pub const IMAPI_E_ALREADYOPEN : i32 = -2147220958;
pub const IMAPI_E_WRONGDISC : i32 = -2147220957;
pub const IMAPI_E_FILEEXISTS : i32 = -2147220956;
pub const IMAPI_E_STASHINUSE : i32 = -2147220955;
pub const IMAPI_E_DEVICE_STILL_IN_USE : i32 = -2147220954;
pub const IMAPI_E_LOSS_OF_STREAMING : i32 = -2147220953;
pub const IMAPI_E_COMPRESSEDSTASH : i32 = -2147220952;
pub const IMAPI_E_ENCRYPTEDSTASH : i32 = -2147220951;
pub const IMAPI_E_NOTENOUGHDISKFORSTASH : i32 = -2147220950;
pub const IMAPI_E_REMOVABLESTASH : i32 = -2147220949;
pub const IMAPI_E_CANNOT_WRITE_TO_MEDIA : i32 = -2147220948;
pub const IMAPI_E_TRACK_NOT_BIG_ENOUGH : i32 = -2147220947;
pub const IMAPI_E_BOOTIMAGE_AND_NONBLANK_DISC : i32 = -2147220946;
...
pub const IMAPI_MEDIA_TYPE_UNKNOWN = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_UNKNOWN;
pub const IMAPI_MEDIA_TYPE_CDROM = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_CDROM;
pub const IMAPI_MEDIA_TYPE_CDR = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_CDR;
pub const IMAPI_MEDIA_TYPE_CDRW = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_CDRW;
pub const IMAPI_MEDIA_TYPE_DVDROM = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_DVDROM;
pub const IMAPI_MEDIA_TYPE_DVDRAM = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_DVDRAM;
pub const IMAPI_MEDIA_TYPE_DVDPLUSR = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_DVDPLUSR;
pub const IMAPI_MEDIA_TYPE_DVDPLUSRW = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_DVDPLUSRW;
pub const IMAPI_MEDIA_TYPE_DVDPLUSR_DUALLAYER = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_DVDPLUSR_DUALLAYER;
pub const IMAPI_MEDIA_TYPE_DVDDASHR = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_DVDDASHR;
pub const IMAPI_MEDIA_TYPE_DVDDASHRW = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_DVDDASHRW;
pub const IMAPI_MEDIA_TYPE_DVDDASHR_DUALLAYER = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_DVDDASHR_DUALLAYER;
pub const IMAPI_MEDIA_TYPE_DISK = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_DISK;
pub const IMAPI_MEDIA_TYPE_DVDPLUSRW_DUALLAYER = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_DVDPLUSRW_DUALLAYER;
pub const IMAPI_MEDIA_TYPE_HDDVDROM = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_HDDVDROM;
pub const IMAPI_MEDIA_TYPE_HDDVDR = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_HDDVDR;
pub const IMAPI_MEDIA_TYPE_HDDVDRAM = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_HDDVDRAM;
pub const IMAPI_MEDIA_TYPE_BDROM = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_BDROM;
pub const IMAPI_MEDIA_TYPE_BDR = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_BDR;
pub const IMAPI_MEDIA_TYPE_BDRE = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_BDRE;
pub const IMAPI_MEDIA_TYPE_MAX = IMAPI_MEDIA_PHYSICAL_TYPE.IMAPI_MEDIA_TYPE_MAX;

pub const IMAPI_MEDIA_WRITE_PROTECT_STATE = extern enum(i32) {
...
pub const IMAPI_WRITEPROTECTED_UNTIL_POWERDOWN = IMAPI_MEDIA_WRITE_PROTECT_STATE.IMAPI_WRITEPROTECTED_UNTIL_POWERDOWN;
pub const IMAPI_WRITEPROTECTED_BY_CARTRIDGE = IMAPI_MEDIA_WRITE_PROTECT_STATE.IMAPI_WRITEPROTECTED_BY_CARTRIDGE;
pub const IMAPI_WRITEPROTECTED_BY_MEDIA_SPECIFIC_REASON = IMAPI_MEDIA_WRITE_PROTECT_STATE.IMAPI_WRITEPROTECTED_BY_MEDIA_SPECIFIC_REASON;
pub const IMAPI_WRITEPROTECTED_BY_SOFTWARE_WRITE_PROTECT = IMAPI_MEDIA_WRITE_PROTECT_STATE.IMAPI_WRITEPROTECTED_BY_SOFTWARE_WRITE_PROTECT;
pub const IMAPI_WRITEPROTECTED_BY_DISC_CONTROL_BLOCK = IMAPI_MEDIA_WRITE_PROTECT_STATE.IMAPI_WRITEPROTECTED_BY_DISC_CONTROL_BLOCK;
pub const IMAPI_WRITEPROTECTED_READ_ONLY_MEDIA = IMAPI_MEDIA_WRITE_PROTECT_STATE.IMAPI_WRITEPROTECTED_READ_ONLY_MEDIA;

pub const IMAPI_READ_TRACK_ADDRESS_TYPE = extern enum(i32) {
    LBA = 0,
    TRACK = 1,
    SESSION = 2,
};
...
pub const IMAPI_MODE_PAGE_REQUEST_TYPE = extern enum(i32) {
    CURRENT_VALUES = 0,
    CHANGEABLE_VALUES = 1,
    DEFAULT_VALUES = 2,
    SAVED_VALUES = 3,
...
pub const IMAPI_MODE_PAGE_TYPE = extern enum(i32) {
...
pub const IMAPI_FEATURE_PAGE_TYPE = extern enum(i32) {
    PROFILE_LIST = 0,
    CORE = 1,
    MORPHING = 2,
    REMOVABLE_MEDIUM = 3,
...
pub const IMAPI_PROFILE_TYPE = extern enum(i32) {
    INVALID = 0,
...
pub const IMAPI_FORMAT2_DATA_WRITE_ACTION = extern enum(i32) {
    VALIDATING_MEDIA = 0,
    FORMATTING_MEDIA = 1,
...
pub const IMAPI_FORMAT2_DATA_MEDIA_STATE = extern enum(i32) {
    UNKNOWN = 0,
...
pub const IMAPI_FORMAT2_DATA_MEDIA_STATE_RANDOMLY_WRITABLE = IMAPI_FORMAT2_DATA_MEDIA_STATE.RANDOMLY_WRITABLE;
...
pub const IMAPI_FORMAT2_TAO_WRITE_ACTION = extern enum(i32) {
    UNKNOWN = 0,
    PREPARING = 1,
    WRITING = 2,
    FINISHING = 3,
...
pub const IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE = extern enum(i32) {
    IMAPI_FORMAT2_RAW_CD_SUBCODE_PQ_ONLY = 1,
    IMAPI_FORMAT2_RAW_CD_SUBCODE_IS_COOKED = 2,
    IMAPI_FORMAT2_RAW_CD_SUBCODE_IS_RAW = 3,
};
pub const IMAPI_FORMAT2_RAW_CD_SUBCODE_PQ_ONLY = IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE.IMAPI_FORMAT2_RAW_CD_SUBCODE_PQ_ONLY;
pub const IMAPI_FORMAT2_RAW_CD_SUBCODE_IS_COOKED = IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE.IMAPI_FORMAT2_RAW_CD_SUBCODE_IS_COOKED;
pub const IMAPI_FORMAT2_RAW_CD_SUBCODE_IS_RAW = IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE.IMAPI_FORMAT2_RAW_CD_SUBCODE_IS_RAW;

pub const IMAPI_FORMAT2_RAW_CD_WRITE_ACTION = extern enum(i32) {
    UNKNOWN = 0,
    PREPARING = 1,
    WRITING = 2,
    FINISHING = 3,
...
pub const IMAPI_CD_SECTOR_TYPE = extern enum(i32) {
...
pub const IMAPI_CD_SECTOR_AUDIO = IMAPI_CD_SECTOR_TYPE.IMAPI_CD_SECTOR_AUDIO;
pub const IMAPI_CD_SECTOR_MODE_ZERO = IMAPI_CD_SECTOR_TYPE.IMAPI_CD_SECTOR_MODE_ZERO;
pub const IMAPI_CD_SECTOR_MODE1 = IMAPI_CD_SECTOR_TYPE.IMAPI_CD_SECTOR_MODE1;
pub const IMAPI_CD_SECTOR_MODE2FORM0 = IMAPI_CD_SECTOR_TYPE.IMAPI_CD_SECTOR_MODE2FORM0;
pub const IMAPI_CD_SECTOR_MODE2FORM1 = IMAPI_CD_SECTOR_TYPE.IMAPI_CD_SECTOR_MODE2FORM1;
pub const IMAPI_CD_SECTOR_MODE2FORM2 = IMAPI_CD_SECTOR_TYPE.IMAPI_CD_SECTOR_MODE2FORM2;
pub const IMAPI_CD_SECTOR_MODE1RAW = IMAPI_CD_SECTOR_TYPE.IMAPI_CD_SECTOR_MODE1RAW;
pub const IMAPI_CD_SECTOR_MODE2FORM0RAW = IMAPI_CD_SECTOR_TYPE.IMAPI_CD_SECTOR_MODE2FORM0RAW;
pub const IMAPI_CD_SECTOR_MODE2FORM1RAW = IMAPI_CD_SECTOR_TYPE.IMAPI_CD_SECTOR_MODE2FORM1RAW;
pub const IMAPI_CD_SECTOR_MODE2FORM2RAW = IMAPI_CD_SECTOR_TYPE.IMAPI_CD_SECTOR_MODE2FORM2RAW;

pub const IMAPI_CD_TRACK_DIGITAL_COPY_SETTING = extern enum(i32) {
    IMAPI_CD_TRACK_DIGITAL_COPY_PERMITTED = 0,
    IMAPI_CD_TRACK_DIGITAL_COPY_PROHIBITED = 1,
    IMAPI_CD_TRACK_DIGITAL_COPY_SCMS = 2,
};
pub const IMAPI_CD_TRACK_DIGITAL_COPY_PERMITTED = IMAPI_CD_TRACK_DIGITAL_COPY_SETTING.IMAPI_CD_TRACK_DIGITAL_COPY_PERMITTED;
pub const IMAPI_CD_TRACK_DIGITAL_COPY_PROHIBITED = IMAPI_CD_TRACK_DIGITAL_COPY_SETTING.IMAPI_CD_TRACK_DIGITAL_COPY_PROHIBITED;
pub const IMAPI_CD_TRACK_DIGITAL_COPY_SCMS = IMAPI_CD_TRACK_DIGITAL_COPY_SETTING.IMAPI_CD_TRACK_DIGITAL_COPY_SCMS;

pub const IMAPI_BURN_VERIFICATION_LEVEL = extern enum(i32) {
    IMAPI_BURN_VERIFICATION_NONE = 0,
    IMAPI_BURN_VERIFICATION_QUICK = 1,
    IMAPI_BURN_VERIFICATION_FULL = 2,
};
pub const IMAPI_BURN_VERIFICATION_NONE = IMAPI_BURN_VERIFICATION_LEVEL.IMAPI_BURN_VERIFICATION_NONE;
...
pub const FsiItemNotFound = FsiItemType.FsiItemNotFound;
pub const FsiItemDirectory = FsiItemType.FsiItemDirectory;
pub const FsiItemFile = FsiItemType.FsiItemFile;

pub const FsiFileSystems = extern enum(i32) {
    FsiFileSystemNone = 0,
...
pub const FsiFileSystemNone = FsiFileSystems.FsiFileSystemNone;
pub const FsiFileSystemISO9660 = FsiFileSystems.FsiFileSystemISO9660;
pub const FsiFileSystemJoliet = FsiFileSystems.FsiFileSystemJoliet;
pub const FsiFileSystemUDF = FsiFileSystems.FsiFileSystemUDF;
pub const FsiFileSystemUnknown = FsiFileSystems.FsiFileSystemUnknown;

pub const EmulationType = extern enum(i32) {
    EmulationNone = 0,
...
pub const EmulationNone = EmulationType.EmulationNone;
pub const Emulation12MFloppy = EmulationType.Emulation12MFloppy;
pub const Emulation144MFloppy = EmulationType.Emulation144MFloppy;
pub const Emulation288MFloppy = EmulationType.Emulation288MFloppy;
pub const EmulationHardDisk = EmulationType.EmulationHardDisk;

pub const PlatformId = extern enum(i32) {
    PlatformX86 = 0,
    PlatformPowerPC = 1,
    PlatformMac = 2,
    PlatformEFI = 239,
};
pub const PlatformX86 = PlatformId.PlatformX86;
pub const PlatformPowerPC = PlatformId.PlatformPowerPC;
...
pub const MEDIA_CDDA_CDROM = MEDIA_TYPES.MEDIA_CDDA_CDROM;
pub const MEDIA_CD_ROM_XA = MEDIA_TYPES.MEDIA_CD_ROM_XA;
pub const MEDIA_CD_I = MEDIA_TYPES.MEDIA_CD_I;
pub const MEDIA_CD_EXTRA = MEDIA_TYPES.MEDIA_CD_EXTRA;
pub const MEDIA_CD_OTHER = MEDIA_TYPES.MEDIA_CD_OTHER;
pub const MEDIA_SPECIAL = MEDIA_TYPES.MEDIA_SPECIAL;

pub const MEDIA_FLAGS = extern enum(i32) {
    MEDIA_BLANK = 1,
    MEDIA_RW = 2,
    MEDIA_WRITABLE = 4,
    MEDIA_FORMAT_UNUSABLE_BY_IMAPI = 8,
};
pub const MEDIA_BLANK = MEDIA_FLAGS.MEDIA_BLANK;
pub const MEDIA_RW = MEDIA_FLAGS.MEDIA_RW;
pub const MEDIA_WRITABLE = MEDIA_FLAGS.MEDIA_WRITABLE;
pub const MEDIA_FORMAT_UNUSABLE_BY_IMAPI = MEDIA_FLAGS.MEDIA_FORMAT_UNUSABLE_BY_IMAPI;

pub const RECORDER_TYPES = extern enum(i32) {
    RECORDER_CDR = 1,
    RECORDER_CDRW = 2,
};
...
pub const IDiscRecorder = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDiscRecorder_GetRecorderType(self: *const T, fTypeCode: *i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDiscRecorder_GetRecorderState(self: *const T, pulDevStateFlags: *u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDiscRecorder_QueryMediaType(self: *const T, fMediaType: *i32, fMediaFlags: *i32) callconv(.Inline) HRESULT {
...
pub const IDiscMaster = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDiscMaster_ProgressAdvise(self: *const T, pEvents: ?*IDiscMasterProgressEvents, pvCookie: *?*c_void) callconv(.Inline) HRESULT {
            return @ptrCast(*const IDiscMaster.VTable, self.vtable).ProgressAdvise(@ptrCast(*const IDiscMaster, self), pEvents, pvCookie);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IDiscMaster_ProgressUnadvise(self: *const T, vCookie: ?*c_void) callconv(.Inline) HRESULT {
...
test {
    ...
    const type_export_count = 80;
    const enum_value_export_count = 203;
    const com_iface_id_export_count = 58;
    const com_class_id_export_count = 32;
