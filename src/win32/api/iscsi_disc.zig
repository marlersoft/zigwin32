...
pub const NV_SEP_CACHE_PARAMETER = extern struct {
    Version: u32,
    Size: u32,
    Flags: NV_SEP_CACHE_PARAMETER._Flags_e__Union,
    WriteCacheType: u8,
...
pub const NVSEPWriteCacheTypeUnknown = NV_SEP_WRITE_CACHE_TYPE.NVSEPWriteCacheTypeUnknown;
pub const NVSEPWriteCacheTypeNone = NV_SEP_WRITE_CACHE_TYPE.NVSEPWriteCacheTypeNone;
pub const NVSEPWriteCacheTypeWriteBack = NV_SEP_WRITE_CACHE_TYPE.NVSEPWriteCacheTypeWriteBack;
pub const NVSEPWriteCacheTypeWriteThrough = NV_SEP_WRITE_CACHE_TYPE.NVSEPWriteCacheTypeWriteThrough;

pub const MP_STORAGE_DIAGNOSTIC_LEVEL = extern enum(i32) {
    MpStorageDiagnosticLevelDefault = 0,
    MpStorageDiagnosticLevelMax = 1,
};
pub const MpStorageDiagnosticLevelDefault = MP_STORAGE_DIAGNOSTIC_LEVEL.MpStorageDiagnosticLevelDefault;
pub const MpStorageDiagnosticLevelMax = MP_STORAGE_DIAGNOSTIC_LEVEL.MpStorageDiagnosticLevelMax;
...
pub const MpStorageDiagnosticTargetTypeUndefined = MP_STORAGE_DIAGNOSTIC_TARGET_TYPE.MpStorageDiagnosticTargetTypeUndefined;
pub const MpStorageDiagnosticTargetTypeMiniport = MP_STORAGE_DIAGNOSTIC_TARGET_TYPE.MpStorageDiagnosticTargetTypeMiniport;
pub const MpStorageDiagnosticTargetTypeHbaFirmware = MP_STORAGE_DIAGNOSTIC_TARGET_TYPE.MpStorageDiagnosticTargetTypeHbaFirmware;
pub const MpStorageDiagnosticTargetTypeMax = MP_STORAGE_DIAGNOSTIC_TARGET_TYPE.MpStorageDiagnosticTargetTypeMax;
...
pub const NvCacheTypeUnknown = NVCACHE_TYPE.NvCacheTypeUnknown;
pub const NvCacheTypeNone = NVCACHE_TYPE.NvCacheTypeNone;
pub const NvCacheTypeWriteBack = NVCACHE_TYPE.NvCacheTypeWriteBack;
pub const NvCacheTypeWriteThrough = NVCACHE_TYPE.NvCacheTypeWriteThrough;
...
pub const NvCacheStatusUnknown = NVCACHE_STATUS.NvCacheStatusUnknown;
pub const NvCacheStatusDisabling = NVCACHE_STATUS.NvCacheStatusDisabling;
pub const NvCacheStatusDisabled = NVCACHE_STATUS.NvCacheStatusDisabled;
pub const NvCacheStatusEnabled = NVCACHE_STATUS.NvCacheStatusEnabled;
...
pub const HYBRID_INFORMATION = extern struct {
    ...
    FractionBase: u32,
    CacheSize: u64,
    Attributes: HYBRID_INFORMATION._Attributes_e__Struct,
    Priorities: HYBRID_INFORMATION._Priorities_e__Struct,
...
pub const STORAGE_FIRMWARE_SLOT_INFO = extern struct {
    ...
    ReadOnly: u8,
    Reserved: [6]u8,
    Revision: STORAGE_FIRMWARE_SLOT_INFO._Revision_e__Union,
...
pub const _ADAPTER_OBJECT = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };
...
pub const STORAGE_ENDURANCE_INFO = extern struct {
    ValidFields: u32,
    GroupId: u32,
    Flags: STORAGE_ENDURANCE_INFO._Flags_e__Struct,
    LifePercentage: u32,
...
pub const ISCSI_DIGEST_TYPE_NONE = ISCSI_DIGEST_TYPES.ISCSI_DIGEST_TYPE_NONE;
pub const ISCSI_DIGEST_TYPE_CRC32C = ISCSI_DIGEST_TYPES.ISCSI_DIGEST_TYPE_CRC32C;
...
pub const ISCSI_NO_AUTH_TYPE = ISCSI_AUTH_TYPES.ISCSI_NO_AUTH_TYPE;
pub const ISCSI_CHAP_AUTH_TYPE = ISCSI_AUTH_TYPES.ISCSI_CHAP_AUTH_TYPE;
pub const ISCSI_MUTUAL_CHAP_AUTH_TYPE = ISCSI_AUTH_TYPES.ISCSI_MUTUAL_CHAP_AUTH_TYPE;
...
pub const IKE_AUTHENTICATION_PRESHARED_KEY_METHOD = IKE_AUTHENTICATION_METHOD.IKE_AUTHENTICATION_PRESHARED_KEY_METHOD;
...
pub const IKE_AUTHENTICATION_INFORMATION = extern struct {
    ...
    Anonymous: IKE_AUTHENTICATION_INFORMATION._Anonymous_e__Union,
...
pub const ISCSI_TCP_PROTOCOL_TYPE = TARGETPROTOCOLTYPE.ISCSI_TCP_PROTOCOL_TYPE;
