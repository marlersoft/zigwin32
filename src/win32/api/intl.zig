...
pub const CLSID_VERSION_DEPENDENT_MSIME_JAPANESE = @import("../zig.zig").Guid.initString("6a91029e-aa49-471b-aee7-7d332785660d");
...
pub const IME_SYSINFO_WOW16 : u32 = 2;
...
pub const CATID_MSIME_IImePadApplet_VER7 = @import("../zig.zig").Guid.initString("4a0f8e31-c3ee-11d1-afef-00805f0c8b6d");
pub const CATID_MSIME_IImePadApplet_VER80 = @import("../zig.zig").Guid.initString("56f7a792-fef1-11d3-8463-00c04f7a06e5");
pub const CATID_MSIME_IImePadApplet_VER81 = @import("../zig.zig").Guid.initString("656520b0-bb88-11d4-84c0-00c04f7a06e5");
pub const CATID_MSIME_IImePadApplet900 = @import("../zig.zig").Guid.initString("faae51bf-5e5b-4a1d-8de1-17c1d9e1728d");
pub const CATID_MSIME_IImePadApplet1000 = @import("../zig.zig").Guid.initString("e081e1d6-2389-43cb-b66f-609f823d9f9c");
pub const CATID_MSIME_IImePadApplet1200 = @import("../zig.zig").Guid.initString("a47fb5fc-7d15-4223-a789-b781bf9ae667");
pub const CATID_MSIME_IImePadApplet = @import("../zig.zig").Guid.initString("7566cad1-4ec9-4478-9fe9-8ed766619edf");
...
pub const CLSID_ImePlugInDictDictionaryList_CHS = @import("../zig.zig").Guid.initString("7bf0129b-5bef-4de4-9b0b-5edb66ac2fa6");
pub const CLSID_ImePlugInDictDictionaryList_JPN = @import("../zig.zig").Guid.initString("4fe2776b-b0f9-4396-b5fc-e9d4cf1ec195");
...
// Section: Types (365)
//--------------------------------------------------------------------------------
pub const HIMC = ?*c_void;

pub const HIMCC = ?*c_void;

pub const HSAVEDUILANGUAGES = ?*c_void;
...
pub const ImmUnregisterWord_DWORD = extern enum(u32) {
    C = 1,
};
pub const IME_REGWORD_STYLE_EUDC = ImmUnregisterWord_DWORD.C;
...
pub const IME_CONFIG = extern enum(u32) {
    GENERAL = 1,
    REGISTERWORD = 2,
    SELECTDICTIONARY = 3,
};
pub const IME_CONFIG_GENERAL = IME_CONFIG.GENERAL;
pub const IME_CONFIG_REGISTERWORD = IME_CONFIG.REGISTERWORD;
pub const IME_CONFIG_SELECTDICTIONARY = IME_CONFIG.SELECTDICTIONARY;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const ImmGetImeMenuItems_Arg3 = extern enum(u32) {
    CMODE = 1,
    SMODE = 2,
    CONFIGURE = 4,
    TOOLS = 8,
...
pub const IGIMII_CMODE = ImmGetImeMenuItems_Arg3.CMODE;
pub const IGIMII_SMODE = ImmGetImeMenuItems_Arg3.SMODE;
pub const IGIMII_CONFIGURE = ImmGetImeMenuItems_Arg3.CONFIGURE;
pub const IGIMII_TOOLS = ImmGetImeMenuItems_Arg3.TOOLS;
pub const IGIMII_HELP = ImmGetImeMenuItems_Arg3.HELP;
pub const IGIMII_OTHER = ImmGetImeMenuItems_Arg3.OTHER;
pub const IGIMII_INPUTTOOLS = ImmGetImeMenuItems_Arg3.INPUTTOOLS;
...
pub const ImmAssociateContextEx_arg3 = extern enum(u32) {
    CHILDREN = 1,
    DEFAULT = 16,
    IGNORENOCONTEXT = 32,
};
pub const IACE_CHILDREN = ImmAssociateContextEx_arg3.CHILDREN;
pub const IACE_DEFAULT = ImmAssociateContextEx_arg3.DEFAULT;
pub const IACE_IGNORENOCONTEXT = ImmAssociateContextEx_arg3.IGNORENOCONTEXT;
...
test {
    ...
    const constant_export_count = 1274;
    const type_export_count = 363;
    const enum_value_export_count = 2010;
