...
pub const FAXLOG_LEVEL_NONE = FAX_ENUM_LOG_LEVELS.FAXLOG_LEVEL_NONE;
pub const FAXLOG_LEVEL_MIN = FAX_ENUM_LOG_LEVELS.FAXLOG_LEVEL_MIN;
pub const FAXLOG_LEVEL_MED = FAX_ENUM_LOG_LEVELS.FAXLOG_LEVEL_MED;
pub const FAXLOG_LEVEL_MAX = FAX_ENUM_LOG_LEVELS.FAXLOG_LEVEL_MAX;
...
pub const FAXLOG_CATEGORY_INIT = FAX_ENUM_LOG_CATEGORIES.FAXLOG_CATEGORY_INIT;
pub const FAXLOG_CATEGORY_OUTBOUND = FAX_ENUM_LOG_CATEGORIES.FAXLOG_CATEGORY_OUTBOUND;
pub const FAXLOG_CATEGORY_INBOUND = FAX_ENUM_LOG_CATEGORIES.FAXLOG_CATEGORY_INBOUND;
pub const FAXLOG_CATEGORY_UNKNOWN = FAX_ENUM_LOG_CATEGORIES.FAXLOG_CATEGORY_UNKNOWN;
...
pub const JC_UNKNOWN = FAX_ENUM_JOB_COMMANDS.JC_UNKNOWN;
pub const JC_DELETE = FAX_ENUM_JOB_COMMANDS.JC_DELETE;
pub const JC_PAUSE = FAX_ENUM_JOB_COMMANDS.JC_PAUSE;
pub const JC_RESUME = FAX_ENUM_JOB_COMMANDS.JC_RESUME;
...
pub const JSA_NOW = FAX_ENUM_JOB_SEND_ATTRIBUTES.JSA_NOW;
pub const JSA_SPECIFIC_TIME = FAX_ENUM_JOB_SEND_ATTRIBUTES.JSA_SPECIFIC_TIME;
pub const JSA_DISCOUNT_PERIOD = FAX_ENUM_JOB_SEND_ATTRIBUTES.JSA_DISCOUNT_PERIOD;
...
pub const DRT_NONE = FAX_ENUM_DELIVERY_REPORT_TYPES.DRT_NONE;
pub const DRT_EMAIL = FAX_ENUM_DELIVERY_REPORT_TYPES.DRT_EMAIL;
pub const DRT_INBOX = FAX_ENUM_DELIVERY_REPORT_TYPES.DRT_INBOX;
...
pub const PORT_OPEN_QUERY = FAX_ENUM_PORT_OPEN_TYPE.PORT_OPEN_QUERY;
pub const PORT_OPEN_MODIFY = FAX_ENUM_PORT_OPEN_TYPE.PORT_OPEN_MODIFY;
...
pub const fjsPENDING = FAX_JOB_STATUS_ENUM.fjsPENDING;
pub const fjsINPROGRESS = FAX_JOB_STATUS_ENUM.fjsINPROGRESS;
pub const fjsFAILED = FAX_JOB_STATUS_ENUM.fjsFAILED;
pub const fjsPAUSED = FAX_JOB_STATUS_ENUM.fjsPAUSED;
pub const fjsNOLINE = FAX_JOB_STATUS_ENUM.fjsNOLINE;
pub const fjsRETRYING = FAX_JOB_STATUS_ENUM.fjsRETRYING;
pub const fjsRETRIES_EXCEEDED = FAX_JOB_STATUS_ENUM.fjsRETRIES_EXCEEDED;
pub const fjsCOMPLETED = FAX_JOB_STATUS_ENUM.fjsCOMPLETED;
pub const fjsCANCELED = FAX_JOB_STATUS_ENUM.fjsCANCELED;
pub const fjsCANCELING = FAX_JOB_STATUS_ENUM.fjsCANCELING;
pub const fjsROUTING = FAX_JOB_STATUS_ENUM.fjsROUTING;
...
pub const fjesNONE = FAX_JOB_EXTENDED_STATUS_ENUM.fjesNONE;
pub const fjesDISCONNECTED = FAX_JOB_EXTENDED_STATUS_ENUM.fjesDISCONNECTED;
pub const fjesINITIALIZING = FAX_JOB_EXTENDED_STATUS_ENUM.fjesINITIALIZING;
pub const fjesDIALING = FAX_JOB_EXTENDED_STATUS_ENUM.fjesDIALING;
pub const fjesTRANSMITTING = FAX_JOB_EXTENDED_STATUS_ENUM.fjesTRANSMITTING;
pub const fjesANSWERED = FAX_JOB_EXTENDED_STATUS_ENUM.fjesANSWERED;
pub const fjesRECEIVING = FAX_JOB_EXTENDED_STATUS_ENUM.fjesRECEIVING;
pub const fjesLINE_UNAVAILABLE = FAX_JOB_EXTENDED_STATUS_ENUM.fjesLINE_UNAVAILABLE;
pub const fjesBUSY = FAX_JOB_EXTENDED_STATUS_ENUM.fjesBUSY;
pub const fjesNO_ANSWER = FAX_JOB_EXTENDED_STATUS_ENUM.fjesNO_ANSWER;
pub const fjesBAD_ADDRESS = FAX_JOB_EXTENDED_STATUS_ENUM.fjesBAD_ADDRESS;
pub const fjesNO_DIAL_TONE = FAX_JOB_EXTENDED_STATUS_ENUM.fjesNO_DIAL_TONE;
pub const fjesFATAL_ERROR = FAX_JOB_EXTENDED_STATUS_ENUM.fjesFATAL_ERROR;
pub const fjesCALL_DELAYED = FAX_JOB_EXTENDED_STATUS_ENUM.fjesCALL_DELAYED;
pub const fjesCALL_BLACKLISTED = FAX_JOB_EXTENDED_STATUS_ENUM.fjesCALL_BLACKLISTED;
pub const fjesNOT_FAX_CALL = FAX_JOB_EXTENDED_STATUS_ENUM.fjesNOT_FAX_CALL;
pub const fjesPARTIALLY_RECEIVED = FAX_JOB_EXTENDED_STATUS_ENUM.fjesPARTIALLY_RECEIVED;
pub const fjesHANDLED = FAX_JOB_EXTENDED_STATUS_ENUM.fjesHANDLED;
pub const fjesCALL_COMPLETED = FAX_JOB_EXTENDED_STATUS_ENUM.fjesCALL_COMPLETED;
pub const fjesCALL_ABORTED = FAX_JOB_EXTENDED_STATUS_ENUM.fjesCALL_ABORTED;
pub const fjesPROPRIETARY = FAX_JOB_EXTENDED_STATUS_ENUM.fjesPROPRIETARY;
...
pub const fjoVIEW = FAX_JOB_OPERATIONS_ENUM.fjoVIEW;
pub const fjoPAUSE = FAX_JOB_OPERATIONS_ENUM.fjoPAUSE;
pub const fjoRESUME = FAX_JOB_OPERATIONS_ENUM.fjoRESUME;
pub const fjoRESTART = FAX_JOB_OPERATIONS_ENUM.fjoRESTART;
pub const fjoDELETE = FAX_JOB_OPERATIONS_ENUM.fjoDELETE;
pub const fjoRECIPIENT_INFO = FAX_JOB_OPERATIONS_ENUM.fjoRECIPIENT_INFO;
pub const fjoSENDER_INFO = FAX_JOB_OPERATIONS_ENUM.fjoSENDER_INFO;
...
pub const fjtSEND = FAX_JOB_TYPE_ENUM.fjtSEND;
pub const fjtRECEIVE = FAX_JOB_TYPE_ENUM.fjtRECEIVE;
pub const fjtROUTING = FAX_JOB_TYPE_ENUM.fjtROUTING;
...
pub const fsetNONE = FAX_SERVER_EVENTS_TYPE_ENUM.fsetNONE;
pub const fsetIN_QUEUE = FAX_SERVER_EVENTS_TYPE_ENUM.fsetIN_QUEUE;
pub const fsetOUT_QUEUE = FAX_SERVER_EVENTS_TYPE_ENUM.fsetOUT_QUEUE;
pub const fsetCONFIG = FAX_SERVER_EVENTS_TYPE_ENUM.fsetCONFIG;
pub const fsetACTIVITY = FAX_SERVER_EVENTS_TYPE_ENUM.fsetACTIVITY;
pub const fsetQUEUE_STATE = FAX_SERVER_EVENTS_TYPE_ENUM.fsetQUEUE_STATE;
pub const fsetIN_ARCHIVE = FAX_SERVER_EVENTS_TYPE_ENUM.fsetIN_ARCHIVE;
pub const fsetOUT_ARCHIVE = FAX_SERVER_EVENTS_TYPE_ENUM.fsetOUT_ARCHIVE;
pub const fsetFXSSVC_ENDED = FAX_SERVER_EVENTS_TYPE_ENUM.fsetFXSSVC_ENDED;
pub const fsetDEVICE_STATUS = FAX_SERVER_EVENTS_TYPE_ENUM.fsetDEVICE_STATUS;
pub const fsetINCOMING_CALL = FAX_SERVER_EVENTS_TYPE_ENUM.fsetINCOMING_CALL;
...
pub const fsAPI_VERSION_0 = FAX_SERVER_APIVERSION_ENUM.fsAPI_VERSION_0;
pub const fsAPI_VERSION_1 = FAX_SERVER_APIVERSION_ENUM.fsAPI_VERSION_1;
pub const fsAPI_VERSION_2 = FAX_SERVER_APIVERSION_ENUM.fsAPI_VERSION_2;
pub const fsAPI_VERSION_3 = FAX_SERVER_APIVERSION_ENUM.fsAPI_VERSION_3;
...
pub const fsatANONYMOUS = FAX_SMTP_AUTHENTICATION_TYPE_ENUM.fsatANONYMOUS;
pub const fsatBASIC = FAX_SMTP_AUTHENTICATION_TYPE_ENUM.fsatBASIC;
pub const fsatNTLM = FAX_SMTP_AUTHENTICATION_TYPE_ENUM.fsatNTLM;
...
pub const frtNONE = FAX_RECEIPT_TYPE_ENUM.frtNONE;
pub const frtMAIL = FAX_RECEIPT_TYPE_ENUM.frtMAIL;
pub const frtMSGBOX = FAX_RECEIPT_TYPE_ENUM.frtMSGBOX;
...
pub const farSUBMIT_LOW = FAX_ACCESS_RIGHTS_ENUM.farSUBMIT_LOW;
pub const farSUBMIT_NORMAL = FAX_ACCESS_RIGHTS_ENUM.farSUBMIT_NORMAL;
pub const farSUBMIT_HIGH = FAX_ACCESS_RIGHTS_ENUM.farSUBMIT_HIGH;
pub const farQUERY_JOBS = FAX_ACCESS_RIGHTS_ENUM.farQUERY_JOBS;
pub const farMANAGE_JOBS = FAX_ACCESS_RIGHTS_ENUM.farMANAGE_JOBS;
pub const farQUERY_CONFIG = FAX_ACCESS_RIGHTS_ENUM.farQUERY_CONFIG;
pub const farMANAGE_CONFIG = FAX_ACCESS_RIGHTS_ENUM.farMANAGE_CONFIG;
pub const farQUERY_IN_ARCHIVE = FAX_ACCESS_RIGHTS_ENUM.farQUERY_IN_ARCHIVE;
pub const farMANAGE_IN_ARCHIVE = FAX_ACCESS_RIGHTS_ENUM.farMANAGE_IN_ARCHIVE;
pub const farQUERY_OUT_ARCHIVE = FAX_ACCESS_RIGHTS_ENUM.farQUERY_OUT_ARCHIVE;
pub const farMANAGE_OUT_ARCHIVE = FAX_ACCESS_RIGHTS_ENUM.farMANAGE_OUT_ARCHIVE;
...
pub const fptLOW = FAX_PRIORITY_TYPE_ENUM.fptLOW;
pub const fptNORMAL = FAX_PRIORITY_TYPE_ENUM.fptNORMAL;
pub const fptHIGH = FAX_PRIORITY_TYPE_ENUM.fptHIGH;
...
pub const fcptNONE = FAX_COVERPAGE_TYPE_ENUM.fcptNONE;
pub const fcptLOCAL = FAX_COVERPAGE_TYPE_ENUM.fcptLOCAL;
pub const fcptSERVER = FAX_COVERPAGE_TYPE_ENUM.fcptSERVER;
...
pub const fstNOW = FAX_SCHEDULE_TYPE_ENUM.fstNOW;
pub const fstSPECIFIC_TIME = FAX_SCHEDULE_TYPE_ENUM.fstSPECIFIC_TIME;
pub const fstDISCOUNT_PERIOD = FAX_SCHEDULE_TYPE_ENUM.fstDISCOUNT_PERIOD;
...
pub const fpsSUCCESS = FAX_PROVIDER_STATUS_ENUM.fpsSUCCESS;
pub const fpsSERVER_ERROR = FAX_PROVIDER_STATUS_ENUM.fpsSERVER_ERROR;
pub const fpsBAD_GUID = FAX_PROVIDER_STATUS_ENUM.fpsBAD_GUID;
pub const fpsBAD_VERSION = FAX_PROVIDER_STATUS_ENUM.fpsBAD_VERSION;
pub const fpsCANT_LOAD = FAX_PROVIDER_STATUS_ENUM.fpsCANT_LOAD;
pub const fpsCANT_LINK = FAX_PROVIDER_STATUS_ENUM.fpsCANT_LINK;
pub const fpsCANT_INIT = FAX_PROVIDER_STATUS_ENUM.fpsCANT_INIT;
...
pub const fdrmNO_ANSWER = FAX_DEVICE_RECEIVE_MODE_ENUM.fdrmNO_ANSWER;
pub const fdrmAUTO_ANSWER = FAX_DEVICE_RECEIVE_MODE_ENUM.fdrmAUTO_ANSWER;
pub const fdrmMANUAL_ANSWER = FAX_DEVICE_RECEIVE_MODE_ENUM.fdrmMANUAL_ANSWER;
...
pub const fllNONE = FAX_LOG_LEVEL_ENUM.fllNONE;
pub const fllMIN = FAX_LOG_LEVEL_ENUM.fllMIN;
pub const fllMED = FAX_LOG_LEVEL_ENUM.fllMED;
pub const fllMAX = FAX_LOG_LEVEL_ENUM.fllMAX;
...
pub const fgsALL_DEV_VALID = FAX_GROUP_STATUS_ENUM.fgsALL_DEV_VALID;
pub const fgsEMPTY = FAX_GROUP_STATUS_ENUM.fgsEMPTY;
pub const fgsALL_DEV_NOT_VALID = FAX_GROUP_STATUS_ENUM.fgsALL_DEV_NOT_VALID;
pub const fgsSOME_DEV_NOT_VALID = FAX_GROUP_STATUS_ENUM.fgsSOME_DEV_NOT_VALID;
...
pub const frsVALID = FAX_RULE_STATUS_ENUM.frsVALID;
pub const frsEMPTY_GROUP = FAX_RULE_STATUS_ENUM.frsEMPTY_GROUP;
pub const frsALL_GROUP_DEV_NOT_VALID = FAX_RULE_STATUS_ENUM.frsALL_GROUP_DEV_NOT_VALID;
pub const frsSOME_GROUP_DEV_NOT_VALID = FAX_RULE_STATUS_ENUM.frsSOME_GROUP_DEV_NOT_VALID;
pub const frsBAD_DEVICE = FAX_RULE_STATUS_ENUM.frsBAD_DEVICE;
...
pub const faetNONE = FAX_ACCOUNT_EVENTS_TYPE_ENUM.faetNONE;
pub const faetIN_QUEUE = FAX_ACCOUNT_EVENTS_TYPE_ENUM.faetIN_QUEUE;
pub const faetOUT_QUEUE = FAX_ACCOUNT_EVENTS_TYPE_ENUM.faetOUT_QUEUE;
pub const faetIN_ARCHIVE = FAX_ACCOUNT_EVENTS_TYPE_ENUM.faetIN_ARCHIVE;
pub const faetOUT_ARCHIVE = FAX_ACCOUNT_EVENTS_TYPE_ENUM.faetOUT_ARCHIVE;
pub const faetFXSSVC_ENDED = FAX_ACCOUNT_EVENTS_TYPE_ENUM.faetFXSSVC_ENDED;
...
pub const far2SUBMIT_LOW = FAX_ACCESS_RIGHTS_ENUM_2.far2SUBMIT_LOW;
pub const far2SUBMIT_NORMAL = FAX_ACCESS_RIGHTS_ENUM_2.far2SUBMIT_NORMAL;
pub const far2SUBMIT_HIGH = FAX_ACCESS_RIGHTS_ENUM_2.far2SUBMIT_HIGH;
pub const far2QUERY_OUT_JOBS = FAX_ACCESS_RIGHTS_ENUM_2.far2QUERY_OUT_JOBS;
pub const far2MANAGE_OUT_JOBS = FAX_ACCESS_RIGHTS_ENUM_2.far2MANAGE_OUT_JOBS;
pub const far2QUERY_CONFIG = FAX_ACCESS_RIGHTS_ENUM_2.far2QUERY_CONFIG;
pub const far2MANAGE_CONFIG = FAX_ACCESS_RIGHTS_ENUM_2.far2MANAGE_CONFIG;
pub const far2QUERY_ARCHIVES = FAX_ACCESS_RIGHTS_ENUM_2.far2QUERY_ARCHIVES;
pub const far2MANAGE_ARCHIVES = FAX_ACCESS_RIGHTS_ENUM_2.far2MANAGE_ARCHIVES;
pub const far2MANAGE_RECEIVE_FOLDER = FAX_ACCESS_RIGHTS_ENUM_2.far2MANAGE_RECEIVE_FOLDER;
...
pub const frrcANY_CODE = FAX_ROUTING_RULE_CODE_ENUM.frrcANY_CODE;
...
pub const DEV_ID_SRC_FAX = FAX_ENUM_DEVICE_ID_SOURCE.DEV_ID_SRC_FAX;
pub const DEV_ID_SRC_TAPI = FAX_ENUM_DEVICE_ID_SOURCE.DEV_ID_SRC_TAPI;
...
pub const SEND_TO_FAX_RECIPIENT_ATTACHMENT = SendToMode.SEND_TO_FAX_RECIPIENT_ATTACHMENT;
