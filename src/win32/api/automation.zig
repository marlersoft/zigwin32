...
pub const SF_ERROR = SF_TYPE.SF_ERROR;
pub const SF_I1 = SF_TYPE.SF_I1;
pub const SF_I2 = SF_TYPE.SF_I2;
pub const SF_I4 = SF_TYPE.SF_I4;
pub const SF_I8 = SF_TYPE.SF_I8;
pub const SF_BSTR = SF_TYPE.SF_BSTR;
pub const SF_UNKNOWN = SF_TYPE.SF_UNKNOWN;
pub const SF_DISPATCH = SF_TYPE.SF_DISPATCH;
pub const SF_VARIANT = SF_TYPE.SF_VARIANT;
pub const SF_RECORD = SF_TYPE.SF_RECORD;
pub const SF_HAVEIID = SF_TYPE.SF_HAVEIID;
...
pub const TKIND_ENUM = TYPEKIND.TKIND_ENUM;
pub const TKIND_RECORD = TYPEKIND.TKIND_RECORD;
pub const TKIND_MODULE = TYPEKIND.TKIND_MODULE;
pub const TKIND_INTERFACE = TYPEKIND.TKIND_INTERFACE;
pub const TKIND_DISPATCH = TYPEKIND.TKIND_DISPATCH;
pub const TKIND_COCLASS = TYPEKIND.TKIND_COCLASS;
pub const TKIND_ALIAS = TYPEKIND.TKIND_ALIAS;
pub const TKIND_UNION = TYPEKIND.TKIND_UNION;
pub const TKIND_MAX = TYPEKIND.TKIND_MAX;
...
pub const CC_FASTCALL = CALLCONV.CC_FASTCALL;
pub const CC_CDECL = CALLCONV.CC_CDECL;
pub const CC_MSCPASCAL = CALLCONV.CC_MSCPASCAL;
pub const CC_PASCAL = CALLCONV.CC_PASCAL;
pub const CC_MACPASCAL = CALLCONV.CC_MACPASCAL;
pub const CC_STDCALL = CALLCONV.CC_STDCALL;
pub const CC_FPFASTCALL = CALLCONV.CC_FPFASTCALL;
pub const CC_SYSCALL = CALLCONV.CC_SYSCALL;
pub const CC_MPWCDECL = CALLCONV.CC_MPWCDECL;
pub const CC_MPWPASCAL = CALLCONV.CC_MPWPASCAL;
pub const CC_MAX = CALLCONV.CC_MAX;
...
pub const FUNC_VIRTUAL = FUNCKIND.FUNC_VIRTUAL;
pub const FUNC_PUREVIRTUAL = FUNCKIND.FUNC_PUREVIRTUAL;
pub const FUNC_NONVIRTUAL = FUNCKIND.FUNC_NONVIRTUAL;
pub const FUNC_STATIC = FUNCKIND.FUNC_STATIC;
pub const FUNC_DISPATCH = FUNCKIND.FUNC_DISPATCH;
...
pub const INVOKE_FUNC = INVOKEKIND.INVOKE_FUNC;
pub const INVOKE_PROPERTYGET = INVOKEKIND.INVOKE_PROPERTYGET;
pub const INVOKE_PROPERTYPUT = INVOKEKIND.INVOKE_PROPERTYPUT;
pub const INVOKE_PROPERTYPUTREF = INVOKEKIND.INVOKE_PROPERTYPUTREF;
...
pub const VAR_PERINSTANCE = VARKIND.VAR_PERINSTANCE;
pub const VAR_STATIC = VARKIND.VAR_STATIC;
pub const VAR_CONST = VARKIND.VAR_CONST;
pub const VAR_DISPATCH = VARKIND.VAR_DISPATCH;
...
pub const TYPEFLAG_FAPPOBJECT = TYPEFLAGS.TYPEFLAG_FAPPOBJECT;
pub const TYPEFLAG_FCANCREATE = TYPEFLAGS.TYPEFLAG_FCANCREATE;
pub const TYPEFLAG_FLICENSED = TYPEFLAGS.TYPEFLAG_FLICENSED;
pub const TYPEFLAG_FPREDECLID = TYPEFLAGS.TYPEFLAG_FPREDECLID;
pub const TYPEFLAG_FHIDDEN = TYPEFLAGS.TYPEFLAG_FHIDDEN;
pub const TYPEFLAG_FCONTROL = TYPEFLAGS.TYPEFLAG_FCONTROL;
pub const TYPEFLAG_FDUAL = TYPEFLAGS.TYPEFLAG_FDUAL;
pub const TYPEFLAG_FNONEXTENSIBLE = TYPEFLAGS.TYPEFLAG_FNONEXTENSIBLE;
pub const TYPEFLAG_FOLEAUTOMATION = TYPEFLAGS.TYPEFLAG_FOLEAUTOMATION;
pub const TYPEFLAG_FRESTRICTED = TYPEFLAGS.TYPEFLAG_FRESTRICTED;
pub const TYPEFLAG_FAGGREGATABLE = TYPEFLAGS.TYPEFLAG_FAGGREGATABLE;
pub const TYPEFLAG_FREPLACEABLE = TYPEFLAGS.TYPEFLAG_FREPLACEABLE;
pub const TYPEFLAG_FDISPATCHABLE = TYPEFLAGS.TYPEFLAG_FDISPATCHABLE;
pub const TYPEFLAG_FREVERSEBIND = TYPEFLAGS.TYPEFLAG_FREVERSEBIND;
pub const TYPEFLAG_FPROXY = TYPEFLAGS.TYPEFLAG_FPROXY;
...
pub const FUNCFLAG_FRESTRICTED = FUNCFLAGS.FUNCFLAG_FRESTRICTED;
pub const FUNCFLAG_FSOURCE = FUNCFLAGS.FUNCFLAG_FSOURCE;
pub const FUNCFLAG_FBINDABLE = FUNCFLAGS.FUNCFLAG_FBINDABLE;
pub const FUNCFLAG_FREQUESTEDIT = FUNCFLAGS.FUNCFLAG_FREQUESTEDIT;
pub const FUNCFLAG_FDISPLAYBIND = FUNCFLAGS.FUNCFLAG_FDISPLAYBIND;
pub const FUNCFLAG_FDEFAULTBIND = FUNCFLAGS.FUNCFLAG_FDEFAULTBIND;
pub const FUNCFLAG_FHIDDEN = FUNCFLAGS.FUNCFLAG_FHIDDEN;
pub const FUNCFLAG_FUSESGETLASTERROR = FUNCFLAGS.FUNCFLAG_FUSESGETLASTERROR;
pub const FUNCFLAG_FDEFAULTCOLLELEM = FUNCFLAGS.FUNCFLAG_FDEFAULTCOLLELEM;
pub const FUNCFLAG_FUIDEFAULT = FUNCFLAGS.FUNCFLAG_FUIDEFAULT;
pub const FUNCFLAG_FNONBROWSABLE = FUNCFLAGS.FUNCFLAG_FNONBROWSABLE;
pub const FUNCFLAG_FREPLACEABLE = FUNCFLAGS.FUNCFLAG_FREPLACEABLE;
pub const FUNCFLAG_FIMMEDIATEBIND = FUNCFLAGS.FUNCFLAG_FIMMEDIATEBIND;
...
pub const VARFLAG_FREADONLY = VARFLAGS.VARFLAG_FREADONLY;
pub const VARFLAG_FSOURCE = VARFLAGS.VARFLAG_FSOURCE;
pub const VARFLAG_FBINDABLE = VARFLAGS.VARFLAG_FBINDABLE;
pub const VARFLAG_FREQUESTEDIT = VARFLAGS.VARFLAG_FREQUESTEDIT;
pub const VARFLAG_FDISPLAYBIND = VARFLAGS.VARFLAG_FDISPLAYBIND;
pub const VARFLAG_FDEFAULTBIND = VARFLAGS.VARFLAG_FDEFAULTBIND;
pub const VARFLAG_FHIDDEN = VARFLAGS.VARFLAG_FHIDDEN;
pub const VARFLAG_FRESTRICTED = VARFLAGS.VARFLAG_FRESTRICTED;
pub const VARFLAG_FDEFAULTCOLLELEM = VARFLAGS.VARFLAG_FDEFAULTCOLLELEM;
pub const VARFLAG_FUIDEFAULT = VARFLAGS.VARFLAG_FUIDEFAULT;
pub const VARFLAG_FNONBROWSABLE = VARFLAGS.VARFLAG_FNONBROWSABLE;
pub const VARFLAG_FREPLACEABLE = VARFLAGS.VARFLAG_FREPLACEABLE;
pub const VARFLAG_FIMMEDIATEBIND = VARFLAGS.VARFLAG_FIMMEDIATEBIND;
...
pub const SYS_WIN16 = SYSKIND.SYS_WIN16;
pub const SYS_WIN32 = SYSKIND.SYS_WIN32;
pub const SYS_MAC = SYSKIND.SYS_MAC;
pub const SYS_WIN64 = SYSKIND.SYS_WIN64;
...
pub const LIBFLAG_FRESTRICTED = LIBFLAGS.LIBFLAG_FRESTRICTED;
pub const LIBFLAG_FCONTROL = LIBFLAGS.LIBFLAG_FCONTROL;
pub const LIBFLAG_FHIDDEN = LIBFLAGS.LIBFLAG_FHIDDEN;
pub const LIBFLAG_FHASDISKIMAGE = LIBFLAGS.LIBFLAG_FHASDISKIMAGE;
