...
//--------------------------------------------------------------------------------
// Section: Constants (926)
//--------------------------------------------------------------------------------
pub const LIBID_MSAATEXTLib = @import("../zig.zig").Guid.initString("150e2d7a-dac1-4582-947d-2a8fd78b82cd");
pub const TS_STRF_START : u32 = 0;
pub const TS_STRF_MID : u32 = 1;
pub const TS_STRF_END : u32 = 2;
pub const LIBID_Accessibility = @import("../zig.zig").Guid.initString("1ea4dbf0-3c3b-11cf-810c-00aa00389b71");
pub const CLSID_AccPropServices = @import("../zig.zig").Guid.initString("b5f8350b-0548-48b1-a6ee-88bd00b4a5e7");
pub const IIS_IsOleaccProxy = @import("../zig.zig").Guid.initString("902697fa-80e4-4560-802a-a13f22a64709");
pub const IIS_ControlAccessible = @import("../zig.zig").Guid.initString("38c682a6-9731-43f2-9fae-e901e641b101");
pub const ANRUS_PRIORITY_AUDIO_DYNAMIC_DUCK : u32 = 16;
pub const MSAA_MENU_SIG : i32 = -1441927155;
pub const PROPID_ACC_NAME = @import("../zig.zig").Guid.initString("608d3df8-8128-4aa7-a428-f55e49267291");
pub const PROPID_ACC_VALUE = @import("../zig.zig").Guid.initString("123fe443-211a-4615-9527-c45a7e93717a");
pub const PROPID_ACC_DESCRIPTION = @import("../zig.zig").Guid.initString("4d48dfe4-bd3f-491f-a648-492d6f20c588");
pub const PROPID_ACC_ROLE = @import("../zig.zig").Guid.initString("cb905ff2-7bd1-4c05-b3c8-e6c241364d70");
pub const PROPID_ACC_STATE = @import("../zig.zig").Guid.initString("a8d4d5b0-0a21-42d0-a5c0-514e984f457b");
pub const PROPID_ACC_HELP = @import("../zig.zig").Guid.initString("c831e11f-44db-4a99-9768-cb8f978b7231");
pub const PROPID_ACC_KEYBOARDSHORTCUT = @import("../zig.zig").Guid.initString("7d9bceee-7d1e-4979-9382-5180f4172c34");
pub const PROPID_ACC_DEFAULTACTION = @import("../zig.zig").Guid.initString("180c072b-c27f-43c7-9922-f63562a4632b");
pub const PROPID_ACC_HELPTOPIC = @import("../zig.zig").Guid.initString("787d1379-8ede-440b-8aec-11f7bf9030b3");
pub const PROPID_ACC_FOCUS = @import("../zig.zig").Guid.initString("6eb335df-1c29-4127-b12c-dee9fd157f2b");
pub const PROPID_ACC_SELECTION = @import("../zig.zig").Guid.initString("b99d073c-d731-405b-9061-d95e8f842984");
pub const PROPID_ACC_PARENT = @import("../zig.zig").Guid.initString("474c22b6-ffc2-467a-b1b5-e958b4657330");
pub const PROPID_ACC_NAV_UP = @import("../zig.zig").Guid.initString("016e1a2b-1a4e-4767-8612-3386f66935ec");
pub const PROPID_ACC_NAV_DOWN = @import("../zig.zig").Guid.initString("031670ed-3cdf-48d2-9613-138f2dd8a668");
pub const PROPID_ACC_NAV_LEFT = @import("../zig.zig").Guid.initString("228086cb-82f1-4a39-8705-dcdc0fff92f5");
pub const PROPID_ACC_NAV_RIGHT = @import("../zig.zig").Guid.initString("cd211d9f-e1cb-4fe5-a77c-920b884d095b");
pub const PROPID_ACC_NAV_PREV = @import("../zig.zig").Guid.initString("776d3891-c73b-4480-b3f6-076a16a15af6");
pub const PROPID_ACC_NAV_NEXT = @import("../zig.zig").Guid.initString("1cdc5455-8cd9-4c92-a371-3939a2fe3eee");
pub const PROPID_ACC_NAV_FIRSTCHILD = @import("../zig.zig").Guid.initString("cfd02558-557b-4c67-84f9-2a09fce40749");
pub const PROPID_ACC_NAV_LASTCHILD = @import("../zig.zig").Guid.initString("302ecaa5-48d5-4f8d-b671-1a8d20a77832");
pub const PROPID_ACC_ROLEMAP = @import("../zig.zig").Guid.initString("f79acda2-140d-4fe6-8914-208476328269");
pub const PROPID_ACC_VALUEMAP = @import("../zig.zig").Guid.initString("da1c3d79-fc5c-420e-b399-9d1533549e75");
pub const PROPID_ACC_STATEMAP = @import("../zig.zig").Guid.initString("43946c5e-0ac0-4042-b525-07bbdbe17fa7");
pub const PROPID_ACC_DESCRIPTIONMAP = @import("../zig.zig").Guid.initString("1ff1435f-8a14-477b-b226-a0abe279975d");
pub const PROPID_ACC_DODEFAULTACTION = @import("../zig.zig").Guid.initString("1ba09523-2e3b-49a6-a059-59682a3c48fd");
...
pub const RuntimeId_Property_GUID = @import("../zig.zig").Guid.initString("a39eebfa-7fba-4c89-b4d4-b99e2de7d160");
pub const BoundingRectangle_Property_GUID = @import("../zig.zig").Guid.initString("7bbfe8b2-3bfc-48dd-b729-c794b846e9a1");
pub const ProcessId_Property_GUID = @import("../zig.zig").Guid.initString("40499998-9c31-4245-a403-87320e59eaf6");
pub const ControlType_Property_GUID = @import("../zig.zig").Guid.initString("ca774fea-28ac-4bc2-94ca-acec6d6c10a3");
pub const LocalizedControlType_Property_GUID = @import("../zig.zig").Guid.initString("8763404f-a1bd-452a-89c4-3f01d3833806");
pub const Name_Property_GUID = @import("../zig.zig").Guid.initString("c3a6921b-4a99-44f1-bca6-61187052c431");
pub const AcceleratorKey_Property_GUID = @import("../zig.zig").Guid.initString("514865df-2557-4cb9-aeed-6ced084ce52c");
pub const AccessKey_Property_GUID = @import("../zig.zig").Guid.initString("06827b12-a7f9-4a15-917c-ffa5ad3eb0a7");
pub const HasKeyboardFocus_Property_GUID = @import("../zig.zig").Guid.initString("cf8afd39-3f46-4800-9656-b2bf12529905");
pub const IsKeyboardFocusable_Property_GUID = @import("../zig.zig").Guid.initString("f7b8552a-0859-4b37-b9cb-51e72092f29f");
pub const IsEnabled_Property_GUID = @import("../zig.zig").Guid.initString("2109427f-da60-4fed-bf1b-264bdce6eb3a");
pub const AutomationId_Property_GUID = @import("../zig.zig").Guid.initString("c82c0500-b60e-4310-a267-303c531f8ee5");
pub const ClassName_Property_GUID = @import("../zig.zig").Guid.initString("157b7215-894f-4b65-84e2-aac0da08b16b");
pub const HelpText_Property_GUID = @import("../zig.zig").Guid.initString("08555685-0977-45c7-a7a6-abaf5684121a");
pub const ClickablePoint_Property_GUID = @import("../zig.zig").Guid.initString("0196903b-b203-4818-a9f3-f08e675f2341");
pub const Culture_Property_GUID = @import("../zig.zig").Guid.initString("e2d74f27-3d79-4dc2-b88b-3044963a8afb");
pub const IsControlElement_Property_GUID = @import("../zig.zig").Guid.initString("95f35085-abcc-4afd-a5f4-dbb46c230fdb");
pub const IsContentElement_Property_GUID = @import("../zig.zig").Guid.initString("4bda64a8-f5d8-480b-8155-ef2e89adb672");
pub const LabeledBy_Property_GUID = @import("../zig.zig").Guid.initString("e5b8924b-fc8a-4a35-8031-cf78ac43e55e");
pub const IsPassword_Property_GUID = @import("../zig.zig").Guid.initString("e8482eb1-687c-497b-bebc-03be53ec1454");
pub const NewNativeWindowHandle_Property_GUID = @import("../zig.zig").Guid.initString("5196b33b-380a-4982-95e1-91f3ef60e024");
pub const ItemType_Property_GUID = @import("../zig.zig").Guid.initString("cdda434d-6222-413b-a68a-325dd1d40f39");
pub const IsOffscreen_Property_GUID = @import("../zig.zig").Guid.initString("03c3d160-db79-42db-a2ef-1c231eede507");
pub const Orientation_Property_GUID = @import("../zig.zig").Guid.initString("a01eee62-3884-4415-887e-678ec21e39ba");
pub const FrameworkId_Property_GUID = @import("../zig.zig").Guid.initString("dbfd9900-7e1a-4f58-b61b-7063120f773b");
pub const IsRequiredForForm_Property_GUID = @import("../zig.zig").Guid.initString("4f5f43cf-59fb-4bde-a270-602e5e1141e9");
pub const ItemStatus_Property_GUID = @import("../zig.zig").Guid.initString("51de0321-3973-43e7-8913-0b08e813c37f");
pub const AriaRole_Property_GUID = @import("../zig.zig").Guid.initString("dd207b95-be4a-4e0d-b727-63ace94b6916");
pub const AriaProperties_Property_GUID = @import("../zig.zig").Guid.initString("4213678c-e025-4922-beb5-e43ba08e6221");
pub const IsDataValidForForm_Property_GUID = @import("../zig.zig").Guid.initString("445ac684-c3fc-4dd9-acf8-845a579296ba");
pub const ControllerFor_Property_GUID = @import("../zig.zig").Guid.initString("51124c8a-a5d2-4f13-9be6-7fa8ba9d3a90");
pub const DescribedBy_Property_GUID = @import("../zig.zig").Guid.initString("7c5865b8-9992-40fd-8db0-6bf1d317f998");
pub const FlowsTo_Property_GUID = @import("../zig.zig").Guid.initString("e4f33d20-559a-47fb-a830-f9cb4ff1a70a");
pub const ProviderDescription_Property_GUID = @import("../zig.zig").Guid.initString("dca5708a-c16b-4cd9-b889-beb16a804904");
pub const OptimizeForVisualContent_Property_GUID = @import("../zig.zig").Guid.initString("6a852250-c75a-4e5d-b858-e381b0f78861");
pub const IsDockPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("2600a4c4-2ff8-4c96-ae31-8fe619a13c6c");
pub const IsExpandCollapsePatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("929d3806-5287-4725-aa16-222afc63d595");
pub const IsGridItemPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("5a43e524-f9a2-4b12-84c8-b48a3efedd34");
pub const IsGridPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("5622c26c-f0ef-4f3b-97cb-714c0868588b");
pub const IsInvokePatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("4e725738-8364-4679-aa6c-f3f41931f750");
pub const IsMultipleViewPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("ff0a31eb-8e25-469d-8d6e-e771a27c1b90");
pub const IsRangeValuePatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("fda4244a-eb4d-43ff-b5ad-ed36d373ec4c");
pub const IsScrollPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("3ebb7b4a-828a-4b57-9d22-2fea1632ed0d");
pub const IsScrollItemPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("1cad1a05-0927-4b76-97e1-0fcdb209b98a");
pub const IsSelectionItemPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("8becd62d-0bc3-4109-bee2-8e6715290e68");
pub const IsSelectionPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("f588acbe-c769-4838-9a60-2686dc1188c4");
pub const IsTablePatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("cb83575f-45c2-4048-9c76-159715a139df");
pub const IsTableItemPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("eb36b40d-8ea4-489b-a013-e60d5951fe34");
pub const IsTextPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("fbe2d69d-aff6-4a45-82e2-fc92a82f5917");
pub const IsTogglePatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("78686d53-fcd0-4b83-9b78-5832ce63bb5b");
pub const IsTransformPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("a7f78804-d68b-4077-a5c6-7a5ea1ac31c5");
pub const IsValuePatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("0b5020a7-2119-473b-be37-5ceb98bbfb22");
pub const IsWindowPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("e7a57bb1-5888-4155-98dc-b422fd57f2bc");
pub const IsLegacyIAccessiblePatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("d8ebd0c7-929a-4ee7-8d3a-d3d94413027b");
pub const IsItemContainerPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("624b5ca7-fe40-4957-a019-20c4cf11920f");
pub const IsVirtualizedItemPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("302cb151-2ac8-45d6-977b-d2b3a5a53f20");
pub const IsSynchronizedInputPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("75d69cc5-d2bf-4943-876e-b45b62a6cc66");
pub const IsObjectModelPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("6b21d89b-2841-412f-8ef2-15ca952318ba");
pub const IsAnnotationPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("0b5b3238-6d5c-41b6-bcc4-5e807f6551c4");
pub const IsTextPattern2Available_Property_GUID = @import("../zig.zig").Guid.initString("41cf921d-e3f1-4b22-9c81-e1c3ed331c22");
pub const IsTextEditPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("7843425c-8b32-484c-9ab5-e3200571ffda");
pub const IsCustomNavigationPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("8f8e80d4-2351-48e0-874a-54aa7313889a");
pub const IsStylesPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("27f353d3-459c-4b59-a490-50611dacafb5");
pub const IsSpreadsheetPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("6ff43732-e4b4-4555-97bc-ecdbbc4d1888");
pub const IsSpreadsheetItemPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("9fe79b2a-2f94-43fd-996b-549e316f4acd");
pub const IsTransformPattern2Available_Property_GUID = @import("../zig.zig").Guid.initString("25980b4b-be04-4710-ab4a-fda31dbd2895");
pub const IsTextChildPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("559e65df-30ff-43b5-b5ed-5b283b80c7e9");
pub const IsDragPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("e997a7b7-1d39-4ca7-be0f-277fcf5605cc");
pub const IsDropTargetPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("0686b62e-8e19-4aaf-873d-384f6d3b92be");
pub const IsStructuredMarkupPatternAvailable_Property_GUID = @import("../zig.zig").Guid.initString("b0d4c196-2c0b-489c-b165-a405928c6f3d");
pub const IsPeripheral_Property_GUID = @import("../zig.zig").Guid.initString("da758276-7ed5-49d4-8e68-ecc9a2d300dd");
pub const PositionInSet_Property_GUID = @import("../zig.zig").Guid.initString("33d1dc54-641e-4d76-a6b1-13f341c1f896");
pub const SizeOfSet_Property_GUID = @import("../zig.zig").Guid.initString("1600d33c-3b9f-4369-9431-aa293f344cf1");
pub const Level_Property_GUID = @import("../zig.zig").Guid.initString("242ac529-cd36-400f-aad9-7876ef3af627");
pub const AnnotationTypes_Property_GUID = @import("../zig.zig").Guid.initString("64b71f76-53c4-4696-a219-20e940c9a176");
pub const AnnotationObjects_Property_GUID = @import("../zig.zig").Guid.initString("310910c8-7c6e-4f20-becd-4aaf6d191156");
pub const LandmarkType_Property_GUID = @import("../zig.zig").Guid.initString("454045f2-6f61-49f7-a4f8-b5f0cf82da1e");
pub const LocalizedLandmarkType_Property_GUID = @import("../zig.zig").Guid.initString("7ac81980-eafb-4fb2-bf91-f485bef5e8e1");
pub const FullDescription_Property_GUID = @import("../zig.zig").Guid.initString("0d4450ff-6aef-4f33-95dd-7befa72a4391");
pub const Value_Value_Property_GUID = @import("../zig.zig").Guid.initString("e95f5e64-269f-4a85-ba99-4092c3ea2986");
pub const Value_IsReadOnly_Property_GUID = @import("../zig.zig").Guid.initString("eb090f30-e24c-4799-a705-0d247bc037f8");
pub const RangeValue_Value_Property_GUID = @import("../zig.zig").Guid.initString("131f5d98-c50c-489d-abe5-ae220898c5f7");
pub const RangeValue_IsReadOnly_Property_GUID = @import("../zig.zig").Guid.initString("25fa1055-debf-4373-a79e-1f1a1908d3c4");
pub const RangeValue_Minimum_Property_GUID = @import("../zig.zig").Guid.initString("78cbd3b2-684d-4860-af93-d1f95cb022fd");
pub const RangeValue_Maximum_Property_GUID = @import("../zig.zig").Guid.initString("19319914-f979-4b35-a1a6-d37e05433473");
pub const RangeValue_LargeChange_Property_GUID = @import("../zig.zig").Guid.initString("a1f96325-3a3d-4b44-8e1f-4a46d9844019");
pub const RangeValue_SmallChange_Property_GUID = @import("../zig.zig").Guid.initString("81c2c457-3941-4107-9975-139760f7c072");
pub const Scroll_HorizontalScrollPercent_Property_GUID = @import("../zig.zig").Guid.initString("c7c13c0e-eb21-47ff-acc4-b5a3350f5191");
pub const Scroll_HorizontalViewSize_Property_GUID = @import("../zig.zig").Guid.initString("70c2e5d4-fcb0-4713-a9aa-af92ff79e4cd");
pub const Scroll_VerticalScrollPercent_Property_GUID = @import("../zig.zig").Guid.initString("6c8d7099-b2a8-4948-bff7-3cf9058bfefb");
pub const Scroll_VerticalViewSize_Property_GUID = @import("../zig.zig").Guid.initString("de6a2e22-d8c7-40c5-83ba-e5f681d53108");
pub const Scroll_HorizontallyScrollable_Property_GUID = @import("../zig.zig").Guid.initString("8b925147-28cd-49ae-bd63-f44118d2e719");
pub const Scroll_VerticallyScrollable_Property_GUID = @import("../zig.zig").Guid.initString("89164798-0068-4315-b89a-1e7cfbbc3dfc");
pub const Selection_Selection_Property_GUID = @import("../zig.zig").Guid.initString("aa6dc2a2-0e2b-4d38-96d5-34e470b81853");
pub const Selection_CanSelectMultiple_Property_GUID = @import("../zig.zig").Guid.initString("49d73da5-c883-4500-883d-8fcf8daf6cbe");
pub const Selection_IsSelectionRequired_Property_GUID = @import("../zig.zig").Guid.initString("b1ae4422-63fe-44e7-a5a5-a738c829b19a");
pub const Grid_RowCount_Property_GUID = @import("../zig.zig").Guid.initString("2a9505bf-c2eb-4fb6-b356-8245ae53703e");
pub const Grid_ColumnCount_Property_GUID = @import("../zig.zig").Guid.initString("fe96f375-44aa-4536-ac7a-2a75d71a3efc");
pub const GridItem_Row_Property_GUID = @import("../zig.zig").Guid.initString("6223972a-c945-4563-9329-fdc974af2553");
pub const GridItem_Column_Property_GUID = @import("../zig.zig").Guid.initString("c774c15c-62c0-4519-8bdc-47be573c8ad5");
pub const GridItem_RowSpan_Property_GUID = @import("../zig.zig").Guid.initString("4582291c-466b-4e93-8e83-3d1715ec0c5e");
pub const GridItem_ColumnSpan_Property_GUID = @import("../zig.zig").Guid.initString("583ea3f5-86d0-4b08-a6ec-2c5463ffc109");
pub const GridItem_Parent_Property_GUID = @import("../zig.zig").Guid.initString("9d912252-b97f-4ecc-8510-ea0e33427c72");
pub const Dock_DockPosition_Property_GUID = @import("../zig.zig").Guid.initString("6d67f02e-c0b0-4b10-b5b9-18d6ecf98760");
pub const ExpandCollapse_ExpandCollapseState_Property_GUID = @import("../zig.zig").Guid.initString("275a4c48-85a7-4f69-aba0-af157610002b");
pub const MultipleView_CurrentView_Property_GUID = @import("../zig.zig").Guid.initString("7a81a67a-b94f-4875-918b-65c8d2f998e5");
pub const MultipleView_SupportedViews_Property_GUID = @import("../zig.zig").Guid.initString("8d5db9fd-ce3c-4ae7-b788-400a3c645547");
pub const Window_CanMaximize_Property_GUID = @import("../zig.zig").Guid.initString("64fff53f-635d-41c1-950c-cb5adfbe28e3");
pub const Window_CanMinimize_Property_GUID = @import("../zig.zig").Guid.initString("b73b4625-5988-4b97-b4c2-a6fe6e78c8c6");
pub const Window_WindowVisualState_Property_GUID = @import("../zig.zig").Guid.initString("4ab7905f-e860-453e-a30a-f6431e5daad5");
pub const Window_WindowInteractionState_Property_GUID = @import("../zig.zig").Guid.initString("4fed26a4-0455-4fa2-b21c-c4da2db1ff9c");
pub const Window_IsModal_Property_GUID = @import("../zig.zig").Guid.initString("ff4e6892-37b9-4fca-8532-ffe674ecfeed");
pub const Window_IsTopmost_Property_GUID = @import("../zig.zig").Guid.initString("ef7d85d3-0937-4962-9241-b62345f24041");
pub const SelectionItem_IsSelected_Property_GUID = @import("../zig.zig").Guid.initString("f122835f-cd5f-43df-b79d-4b849e9e6020");
pub const SelectionItem_SelectionContainer_Property_GUID = @import("../zig.zig").Guid.initString("a4365b6e-9c1e-4b63-8b53-c2421dd1e8fb");
pub const Table_RowHeaders_Property_GUID = @import("../zig.zig").Guid.initString("d9e35b87-6eb8-4562-aac6-a8a9075236a8");
pub const Table_ColumnHeaders_Property_GUID = @import("../zig.zig").Guid.initString("aff1d72b-968d-42b1-b459-150b299da664");
pub const Table_RowOrColumnMajor_Property_GUID = @import("../zig.zig").Guid.initString("83be75c3-29fe-4a30-85e1-2a6277fd106e");
pub const TableItem_RowHeaderItems_Property_GUID = @import("../zig.zig").Guid.initString("b3f853a0-0574-4cd8-bcd7-ed5923572d97");
pub const TableItem_ColumnHeaderItems_Property_GUID = @import("../zig.zig").Guid.initString("967a56a3-74b6-431e-8de6-99c411031c58");
pub const Toggle_ToggleState_Property_GUID = @import("../zig.zig").Guid.initString("b23cdc52-22c2-4c6c-9ded-f5c422479ede");
pub const Transform_CanMove_Property_GUID = @import("../zig.zig").Guid.initString("1b75824d-208b-4fdf-bccd-f1f4e5741f4f");
pub const Transform_CanResize_Property_GUID = @import("../zig.zig").Guid.initString("bb98dca5-4c1a-41d4-a4f6-ebc128644180");
pub const Transform_CanRotate_Property_GUID = @import("../zig.zig").Guid.initString("10079b48-3849-476f-ac96-44a95c8440d9");
pub const LegacyIAccessible_ChildId_Property_GUID = @import("../zig.zig").Guid.initString("9a191b5d-9ef2-4787-a459-dcde885dd4e8");
pub const LegacyIAccessible_Name_Property_GUID = @import("../zig.zig").Guid.initString("caeb063d-40ae-4869-aa5a-1b8e5d666739");
pub const LegacyIAccessible_Value_Property_GUID = @import("../zig.zig").Guid.initString("b5c5b0b6-8217-4a77-97a5-190a85ed0156");
pub const LegacyIAccessible_Description_Property_GUID = @import("../zig.zig").Guid.initString("46448418-7d70-4ea9-9d27-b7e775cf2ad7");
pub const LegacyIAccessible_Role_Property_GUID = @import("../zig.zig").Guid.initString("6856e59f-cbaf-4e31-93e8-bcbf6f7e491c");
pub const LegacyIAccessible_State_Property_GUID = @import("../zig.zig").Guid.initString("df985854-2281-4340-ab9c-c60e2c5803f6");
pub const LegacyIAccessible_Help_Property_GUID = @import("../zig.zig").Guid.initString("94402352-161c-4b77-a98d-a872cc33947a");
pub const LegacyIAccessible_KeyboardShortcut_Property_GUID = @import("../zig.zig").Guid.initString("8f6909ac-00b8-4259-a41c-966266d43a8a");
pub const LegacyIAccessible_Selection_Property_GUID = @import("../zig.zig").Guid.initString("8aa8b1e0-0891-40cc-8b06-90d7d4166219");
pub const LegacyIAccessible_DefaultAction_Property_GUID = @import("../zig.zig").Guid.initString("3b331729-eaad-4502-b85f-92615622913c");
pub const Annotation_AnnotationTypeId_Property_GUID = @import("../zig.zig").Guid.initString("20ae484f-69ef-4c48-8f5b-c4938b206ac7");
pub const Annotation_AnnotationTypeName_Property_GUID = @import("../zig.zig").Guid.initString("9b818892-5ac9-4af9-aa96-f58a77b058e3");
pub const Annotation_Author_Property_GUID = @import("../zig.zig").Guid.initString("7a528462-9c5c-4a03-a974-8b307a9937f2");
pub const Annotation_DateTime_Property_GUID = @import("../zig.zig").Guid.initString("99b5ca5d-1acf-414b-a4d0-6b350b047578");
pub const Annotation_Target_Property_GUID = @import("../zig.zig").Guid.initString("b71b302d-2104-44ad-9c5c-092b4907d70f");
pub const Styles_StyleId_Property_GUID = @import("../zig.zig").Guid.initString("da82852f-3817-4233-82af-02279e72cc77");
pub const Styles_StyleName_Property_GUID = @import("../zig.zig").Guid.initString("1c12b035-05d1-4f55-9e8e-1489f3ff550d");
pub const Styles_FillColor_Property_GUID = @import("../zig.zig").Guid.initString("63eff97a-a1c5-4b1d-84eb-b765f2edd632");
pub const Styles_FillPatternStyle_Property_GUID = @import("../zig.zig").Guid.initString("81cf651f-482b-4451-a30a-e1545e554fb8");
pub const Styles_Shape_Property_GUID = @import("../zig.zig").Guid.initString("c71a23f8-778c-400d-8458-3b543e526984");
pub const Styles_FillPatternColor_Property_GUID = @import("../zig.zig").Guid.initString("939a59fe-8fbd-4e75-a271-ac4595195163");
pub const Styles_ExtendedProperties_Property_GUID = @import("../zig.zig").Guid.initString("f451cda0-ba0a-4681-b0b0-0dbdb53e58f3");
pub const SpreadsheetItem_Formula_Property_GUID = @import("../zig.zig").Guid.initString("e602e47d-1b47-4bea-87cf-3b0b0b5c15b6");
pub const SpreadsheetItem_AnnotationObjects_Property_GUID = @import("../zig.zig").Guid.initString("a3194c38-c9bc-4604-9396-ae3f9f457f7b");
pub const SpreadsheetItem_AnnotationTypes_Property_GUID = @import("../zig.zig").Guid.initString("c70c51d0-d602-4b45-afbc-b4712b96d72b");
pub const Transform2_CanZoom_Property_GUID = @import("../zig.zig").Guid.initString("f357e890-a756-4359-9ca6-86702bf8f381");
pub const LiveSetting_Property_GUID = @import("../zig.zig").Guid.initString("c12bcd8e-2a8e-4950-8ae7-3625111d58eb");
pub const Drag_IsGrabbed_Property_GUID = @import("../zig.zig").Guid.initString("45f206f3-75cc-4cca-a9b9-fcdfb982d8a2");
pub const Drag_GrabbedItems_Property_GUID = @import("../zig.zig").Guid.initString("77c1562c-7b86-4b21-9ed7-3cefda6f4c43");
pub const Drag_DropEffect_Property_GUID = @import("../zig.zig").Guid.initString("646f2779-48d3-4b23-8902-4bf100005df3");
pub const Drag_DropEffects_Property_GUID = @import("../zig.zig").Guid.initString("f5d61156-7ce6-49be-a836-9269dcec920f");
pub const DropTarget_DropTargetEffect_Property_GUID = @import("../zig.zig").Guid.initString("8bb75975-a0ca-4981-b818-87fc66e9509d");
pub const DropTarget_DropTargetEffects_Property_GUID = @import("../zig.zig").Guid.initString("bc1dd4ed-cb89-45f1-a592-e03b08ae790f");
pub const Transform2_ZoomLevel_Property_GUID = @import("../zig.zig").Guid.initString("eee29f1a-f4a2-4b5b-ac65-95cf93283387");
pub const Transform2_ZoomMinimum_Property_GUID = @import("../zig.zig").Guid.initString("742ccc16-4ad1-4e07-96fe-b122c6e6b22b");
pub const Transform2_ZoomMaximum_Property_GUID = @import("../zig.zig").Guid.initString("42ab6b77-ceb0-4eca-b82a-6cfa5fa1fc08");
pub const FlowsFrom_Property_GUID = @import("../zig.zig").Guid.initString("05c6844f-19de-48f8-95fa-880d5b0fd615");
pub const FillColor_Property_GUID = @import("../zig.zig").Guid.initString("6e0ec4d0-e2a8-4a56-9de7-953389933b39");
pub const OutlineColor_Property_GUID = @import("../zig.zig").Guid.initString("c395d6c0-4b55-4762-a073-fd303a634f52");
pub const FillType_Property_GUID = @import("../zig.zig").Guid.initString("c6fc74e4-8cb9-429c-a9e1-9bc4ac372b62");
pub const VisualEffects_Property_GUID = @import("../zig.zig").Guid.initString("e61a8565-aad9-46d7-9e70-4e8a8420d420");
pub const OutlineThickness_Property_GUID = @import("../zig.zig").Guid.initString("13e67cc7-dac2-4888-bdd3-375c62fa9618");
pub const CenterPoint_Property_GUID = @import("../zig.zig").Guid.initString("0cb00c08-540c-4edb-9445-26359ea69785");
pub const Rotation_Property_GUID = @import("../zig.zig").Guid.initString("767cdc7d-aec0-4110-ad32-30edd403492e");
pub const Size_Property_GUID = @import("../zig.zig").Guid.initString("2b5f761d-f885-4404-973f-9b1d98e36d8f");
pub const ToolTipOpened_Event_GUID = @import("../zig.zig").Guid.initString("3f4b97ff-2edc-451d-bca4-95a3188d5b03");
pub const ToolTipClosed_Event_GUID = @import("../zig.zig").Guid.initString("276d71ef-24a9-49b6-8e97-da98b401bbcd");
pub const StructureChanged_Event_GUID = @import("../zig.zig").Guid.initString("59977961-3edd-4b11-b13b-676b2a2a6ca9");
pub const MenuOpened_Event_GUID = @import("../zig.zig").Guid.initString("ebe2e945-66ca-4ed1-9ff8-2ad7df0a1b08");
pub const AutomationPropertyChanged_Event_GUID = @import("../zig.zig").Guid.initString("2527fba1-8d7a-4630-a4cc-e66315942f52");
pub const AutomationFocusChanged_Event_GUID = @import("../zig.zig").Guid.initString("b68a1f17-f60d-41a7-a3cc-b05292155fe0");
pub const ActiveTextPositionChanged_Event_GUID = @import("../zig.zig").Guid.initString("a5c09e9c-c77d-4f25-b491-e5bb7017cbd4");
pub const AsyncContentLoaded_Event_GUID = @import("../zig.zig").Guid.initString("5fdee11c-d2fa-4fb9-904e-5cbee894d5ef");
pub const MenuClosed_Event_GUID = @import("../zig.zig").Guid.initString("3cf1266e-1582-4041-acd7-88a35a965297");
pub const LayoutInvalidated_Event_GUID = @import("../zig.zig").Guid.initString("ed7d6544-a6bd-4595-9bae-3d28946cc715");
pub const Invoke_Invoked_Event_GUID = @import("../zig.zig").Guid.initString("dfd699f0-c915-49dd-b422-dde785c3d24b");
pub const SelectionItem_ElementAddedToSelectionEvent_Event_GUID = @import("../zig.zig").Guid.initString("3c822dd1-c407-4dba-91dd-79d4aed0aec6");
pub const SelectionItem_ElementRemovedFromSelectionEvent_Event_GUID = @import("../zig.zig").Guid.initString("097fa8a9-7079-41af-8b9c-0934d8305e5c");
pub const SelectionItem_ElementSelectedEvent_Event_GUID = @import("../zig.zig").Guid.initString("b9c7dbfb-4ebe-4532-aaf4-008cf647233c");
pub const Selection_InvalidatedEvent_Event_GUID = @import("../zig.zig").Guid.initString("cac14904-16b4-4b53-8e47-4cb1df267bb7");
pub const Text_TextSelectionChangedEvent_Event_GUID = @import("../zig.zig").Guid.initString("918edaa1-71b3-49ae-9741-79beb8d358f3");
pub const Text_TextChangedEvent_Event_GUID = @import("../zig.zig").Guid.initString("4a342082-f483-48c4-ac11-a84b435e2a84");
pub const Window_WindowOpened_Event_GUID = @import("../zig.zig").Guid.initString("d3e81d06-de45-4f2f-9633-de9e02fb65af");
pub const Window_WindowClosed_Event_GUID = @import("../zig.zig").Guid.initString("edf141f8-fa67-4e22-bbf7-944e05735ee2");
pub const MenuModeStart_Event_GUID = @import("../zig.zig").Guid.initString("18d7c631-166a-4ac9-ae3b-ef4b5420e681");
pub const MenuModeEnd_Event_GUID = @import("../zig.zig").Guid.initString("9ecd4c9f-80dd-47b8-8267-5aec06bb2cff");
pub const InputReachedTarget_Event_GUID = @import("../zig.zig").Guid.initString("93ed549a-0549-40f0-bedb-28e44f7de2a3");
pub const InputReachedOtherElement_Event_GUID = @import("../zig.zig").Guid.initString("ed201d8a-4e6c-415e-a874-2460c9b66ba8");
pub const InputDiscarded_Event_GUID = @import("../zig.zig").Guid.initString("7f36c367-7b18-417c-97e3-9d58ddc944ab");
pub const SystemAlert_Event_GUID = @import("../zig.zig").Guid.initString("d271545d-7a3a-47a7-8474-81d29a2451c9");
pub const LiveRegionChanged_Event_GUID = @import("../zig.zig").Guid.initString("102d5e90-e6a9-41b6-b1c5-a9b1929d9510");
pub const HostedFragmentRootsInvalidated_Event_GUID = @import("../zig.zig").Guid.initString("e6bdb03e-0921-4ec5-8dcf-eae877b0426b");
pub const Drag_DragStart_Event_GUID = @import("../zig.zig").Guid.initString("883a480b-3aa9-429d-95e4-d9c8d011f0dd");
pub const Drag_DragCancel_Event_GUID = @import("../zig.zig").Guid.initString("c3ede6fa-3451-4e0f-9e71-df9c280a4657");
pub const Drag_DragComplete_Event_GUID = @import("../zig.zig").Guid.initString("38e96188-ef1f-463e-91ca-3a7792c29caf");
pub const DropTarget_DragEnter_Event_GUID = @import("../zig.zig").Guid.initString("aad9319b-032c-4a88-961d-1cf579581e34");
pub const DropTarget_DragLeave_Event_GUID = @import("../zig.zig").Guid.initString("0f82eb15-24a2-4988-9217-de162aee272b");
pub const DropTarget_Dropped_Event_GUID = @import("../zig.zig").Guid.initString("622cead8-1edb-4a3d-abbc-be2211ff68b5");
pub const StructuredMarkup_CompositionComplete_Event_GUID = @import("../zig.zig").Guid.initString("c48a3c17-677a-4047-a68d-fc1257528aef");
pub const StructuredMarkup_Deleted_Event_GUID = @import("../zig.zig").Guid.initString("f9d0a020-e1c1-4ecf-b9aa-52efde7e41e1");
pub const StructuredMarkup_SelectionChanged_Event_GUID = @import("../zig.zig").Guid.initString("a7c815f7-ff9f-41c7-a3a7-ab6cbfdb4903");
pub const Invoke_Pattern_GUID = @import("../zig.zig").Guid.initString("d976c2fc-66ea-4a6e-b28f-c24c7546ad37");
pub const Selection_Pattern_GUID = @import("../zig.zig").Guid.initString("66e3b7e8-d821-4d25-8761-435d2c8b253f");
pub const Value_Pattern_GUID = @import("../zig.zig").Guid.initString("17faad9e-c877-475b-b933-77332779b637");
pub const RangeValue_Pattern_GUID = @import("../zig.zig").Guid.initString("18b00d87-b1c9-476a-bfbd-5f0bdb926f63");
pub const Scroll_Pattern_GUID = @import("../zig.zig").Guid.initString("895fa4b4-759d-4c50-8e15-03460672003c");
pub const ExpandCollapse_Pattern_GUID = @import("../zig.zig").Guid.initString("ae05efa2-f9d1-428a-834c-53a5c52f9b8b");
pub const Grid_Pattern_GUID = @import("../zig.zig").Guid.initString("260a2ccb-93a8-4e44-a4c1-3df397f2b02b");
pub const GridItem_Pattern_GUID = @import("../zig.zig").Guid.initString("f2d5c877-a462-4957-a2a5-2c96b303bc63");
pub const MultipleView_Pattern_GUID = @import("../zig.zig").Guid.initString("547a6ae4-113f-47c4-850f-db4dfa466b1d");
pub const Window_Pattern_GUID = @import("../zig.zig").Guid.initString("27901735-c760-4994-ad11-5919e606b110");
pub const SelectionItem_Pattern_GUID = @import("../zig.zig").Guid.initString("9bc64eeb-87c7-4b28-94bb-4d9fa437b6ef");
pub const Dock_Pattern_GUID = @import("../zig.zig").Guid.initString("9cbaa846-83c8-428d-827f-7e6063fe0620");
pub const Table_Pattern_GUID = @import("../zig.zig").Guid.initString("c415218e-a028-461e-aa92-8f925cf79351");
pub const TableItem_Pattern_GUID = @import("../zig.zig").Guid.initString("df1343bd-1888-4a29-a50c-b92e6de37f6f");
pub const Text_Pattern_GUID = @import("../zig.zig").Guid.initString("8615f05d-7de5-44fd-a679-2ca4b46033a8");
pub const Toggle_Pattern_GUID = @import("../zig.zig").Guid.initString("0b419760-e2f4-43ff-8c5f-9457c82b56e9");
pub const Transform_Pattern_GUID = @import("../zig.zig").Guid.initString("24b46fdb-587e-49f1-9c4a-d8e98b664b7b");
pub const ScrollItem_Pattern_GUID = @import("../zig.zig").Guid.initString("4591d005-a803-4d5c-b4d5-8d2800f906a7");
pub const LegacyIAccessible_Pattern_GUID = @import("../zig.zig").Guid.initString("54cc0a9f-3395-48af-ba8d-73f85690f3e0");
pub const ItemContainer_Pattern_GUID = @import("../zig.zig").Guid.initString("3d13da0f-8b9a-4a99-85fa-c5c9a69f1ed4");
pub const VirtualizedItem_Pattern_GUID = @import("../zig.zig").Guid.initString("f510173e-2e71-45e9-a6e5-62f6ed8289d5");
pub const SynchronizedInput_Pattern_GUID = @import("../zig.zig").Guid.initString("05c288a6-c47b-488b-b653-33977a551b8b");
pub const ObjectModel_Pattern_GUID = @import("../zig.zig").Guid.initString("3e04acfe-08fc-47ec-96bc-353fa3b34aa7");
pub const Annotation_Pattern_GUID = @import("../zig.zig").Guid.initString("f6c72ad7-356c-4850-9291-316f608a8c84");
pub const Text_Pattern2_GUID = @import("../zig.zig").Guid.initString("498479a2-5b22-448d-b6e4-647490860698");
pub const TextEdit_Pattern_GUID = @import("../zig.zig").Guid.initString("69f3ff89-5af9-4c75-9340-f2de292e4591");
pub const CustomNavigation_Pattern_GUID = @import("../zig.zig").Guid.initString("afea938a-621e-4054-bb2c-2f46114dac3f");
pub const Styles_Pattern_GUID = @import("../zig.zig").Guid.initString("1ae62655-da72-4d60-a153-e5aa6988e3bf");
pub const Spreadsheet_Pattern_GUID = @import("../zig.zig").Guid.initString("6a5b24c9-9d1e-4b85-9e44-c02e3169b10b");
pub const SpreadsheetItem_Pattern_GUID = @import("../zig.zig").Guid.initString("32cf83ff-f1a8-4a8c-8658-d47ba74e20ba");
pub const Tranform_Pattern2_GUID = @import("../zig.zig").Guid.initString("8afcfd07-a369-44de-988b-2f7ff49fb8a8");
pub const TextChild_Pattern_GUID = @import("../zig.zig").Guid.initString("7533cab7-3bfe-41ef-9e85-e2638cbe169e");
pub const Drag_Pattern_GUID = @import("../zig.zig").Guid.initString("c0bee21f-ccb3-4fed-995b-114f6e3d2728");
pub const DropTarget_Pattern_GUID = @import("../zig.zig").Guid.initString("0bcbec56-bd34-4b7b-9fd5-2659905ea3dc");
pub const StructuredMarkup_Pattern_GUID = @import("../zig.zig").Guid.initString("abbd0878-8665-4f5c-94fc-36e7d8bb706b");
pub const Button_Control_GUID = @import("../zig.zig").Guid.initString("5a78e369-c6a1-4f33-a9d7-79f20d0c788e");
pub const Calendar_Control_GUID = @import("../zig.zig").Guid.initString("8913eb88-00e5-46bc-8e4e-14a786e165a1");
pub const CheckBox_Control_GUID = @import("../zig.zig").Guid.initString("fb50f922-a3db-49c0-8bc3-06dad55778e2");
pub const ComboBox_Control_GUID = @import("../zig.zig").Guid.initString("54cb426c-2f33-4fff-aaa1-aef60dac5deb");
pub const Edit_Control_GUID = @import("../zig.zig").Guid.initString("6504a5c8-2c86-4f87-ae7b-1abddc810cf9");
pub const Hyperlink_Control_GUID = @import("../zig.zig").Guid.initString("8a56022c-b00d-4d15-8ff0-5b6b266e5e02");
pub const Image_Control_GUID = @import("../zig.zig").Guid.initString("2d3736e4-6b16-4c57-a962-f93260a75243");
pub const ListItem_Control_GUID = @import("../zig.zig").Guid.initString("7b3717f2-44d1-4a58-98a8-f12a9b8f78e2");
pub const List_Control_GUID = @import("../zig.zig").Guid.initString("9b149ee1-7cca-4cfc-9af1-cac7bddd3031");
pub const Menu_Control_GUID = @import("../zig.zig").Guid.initString("2e9b1440-0ea8-41fd-b374-c1ea6f503cd1");
pub const MenuBar_Control_GUID = @import("../zig.zig").Guid.initString("cc384250-0e7b-4ae8-95ae-a08f261b52ee");
pub const MenuItem_Control_GUID = @import("../zig.zig").Guid.initString("f45225d3-d0a0-49d8-9834-9a000d2aeddc");
pub const ProgressBar_Control_GUID = @import("../zig.zig").Guid.initString("228c9f86-c36c-47bb-9fb6-a5834bfc53a4");
pub const RadioButton_Control_GUID = @import("../zig.zig").Guid.initString("3bdb49db-fe2c-4483-b3e1-e57f219440c6");
pub const ScrollBar_Control_GUID = @import("../zig.zig").Guid.initString("daf34b36-5065-4946-b22f-92595fc0751a");
pub const Slider_Control_GUID = @import("../zig.zig").Guid.initString("b033c24b-3b35-4cea-b609-763682fa660b");
pub const Spinner_Control_GUID = @import("../zig.zig").Guid.initString("60cc4b38-3cb1-4161-b442-c6b726c17825");
pub const StatusBar_Control_GUID = @import("../zig.zig").Guid.initString("d45e7d1b-5873-475f-95a4-0433e1f1b00a");
pub const Tab_Control_GUID = @import("../zig.zig").Guid.initString("38cd1f2d-337a-4bd2-a5e3-adb469e30bd3");
pub const TabItem_Control_GUID = @import("../zig.zig").Guid.initString("2c6a634f-921b-4e6e-b26e-08fcb0798f4c");
pub const Text_Control_GUID = @import("../zig.zig").Guid.initString("ae9772dc-d331-4f09-be20-7e6dfaf07b0a");
pub const ToolBar_Control_GUID = @import("../zig.zig").Guid.initString("8f06b751-e182-4e98-8893-2284543a7dce");
pub const ToolTip_Control_GUID = @import("../zig.zig").Guid.initString("05ddc6d1-2137-4768-98ea-73f52f7134f3");
pub const Tree_Control_GUID = @import("../zig.zig").Guid.initString("7561349c-d241-43f4-9908-b5f091bee611");
pub const TreeItem_Control_GUID = @import("../zig.zig").Guid.initString("62c9feb9-8ffc-4878-a3a4-96b030315c18");
pub const Custom_Control_GUID = @import("../zig.zig").Guid.initString("f29ea0c3-adb7-430a-ba90-e52c7313e6ed");
pub const Group_Control_GUID = @import("../zig.zig").Guid.initString("ad50aa1c-e8c8-4774-ae1b-dd86df0b3bdc");
pub const Thumb_Control_GUID = @import("../zig.zig").Guid.initString("701ca877-e310-4dd6-b644-797e4faea213");
pub const DataGrid_Control_GUID = @import("../zig.zig").Guid.initString("84b783af-d103-4b0a-8415-e73942410f4b");
pub const DataItem_Control_GUID = @import("../zig.zig").Guid.initString("a0177842-d94f-42a5-814b-6068addc8da5");
pub const Document_Control_GUID = @import("../zig.zig").Guid.initString("3cd6bb6f-6f08-4562-b229-e4e2fc7a9eb4");
pub const SplitButton_Control_GUID = @import("../zig.zig").Guid.initString("7011f01f-4ace-4901-b461-920a6f1ca650");
pub const Window_Control_GUID = @import("../zig.zig").Guid.initString("e13a7242-f462-4f4d-aec1-53b28d6c3290");
pub const Pane_Control_GUID = @import("../zig.zig").Guid.initString("5c2b3f5b-9182-42a3-8dec-8c04c1ee634d");
pub const Header_Control_GUID = @import("../zig.zig").Guid.initString("5b90cbce-78fb-4614-82b6-554d74718e67");
pub const HeaderItem_Control_GUID = @import("../zig.zig").Guid.initString("e6bc12cb-7c8e-49cf-b168-4a93a32bebb0");
pub const Table_Control_GUID = @import("../zig.zig").Guid.initString("773bfa0e-5bc4-4deb-921b-de7b3206229e");
pub const TitleBar_Control_GUID = @import("../zig.zig").Guid.initString("98aa55bf-3bb0-4b65-836e-2ea30dbc171f");
pub const Separator_Control_GUID = @import("../zig.zig").Guid.initString("8767eba3-2a63-4ab0-ac8d-aa50e23de978");
pub const SemanticZoom_Control_GUID = @import("../zig.zig").Guid.initString("5fd34a43-061e-42c8-b589-9dccf74bc43a");
pub const AppBar_Control_GUID = @import("../zig.zig").Guid.initString("6114908d-cc02-4d37-875b-b530c7139554");
pub const Text_AnimationStyle_Attribute_GUID = @import("../zig.zig").Guid.initString("628209f0-7c9a-4d57-be64-1f1836571ff5");
pub const Text_BackgroundColor_Attribute_GUID = @import("../zig.zig").Guid.initString("fdc49a07-583d-4f17-ad27-77fc832a3c0b");
pub const Text_BulletStyle_Attribute_GUID = @import("../zig.zig").Guid.initString("c1097c90-d5c4-4237-9781-3bec8ba54e48");
pub const Text_CapStyle_Attribute_GUID = @import("../zig.zig").Guid.initString("fb059c50-92cc-49a5-ba8f-0aa872bba2f3");
pub const Text_Culture_Attribute_GUID = @import("../zig.zig").Guid.initString("c2025af9-a42d-4ced-a1fb-c6746315222e");
pub const Text_FontName_Attribute_GUID = @import("../zig.zig").Guid.initString("64e63ba8-f2e5-476e-a477-1734feaaf726");
pub const Text_FontSize_Attribute_GUID = @import("../zig.zig").Guid.initString("dc5eeeff-0506-4673-93f2-377e4a8e01f1");
pub const Text_FontWeight_Attribute_GUID = @import("../zig.zig").Guid.initString("6fc02359-b316-4f5f-b401-f1ce55741853");
pub const Text_ForegroundColor_Attribute_GUID = @import("../zig.zig").Guid.initString("72d1c95d-5e60-471a-96b1-6c1b3b77a436");
pub const Text_HorizontalTextAlignment_Attribute_GUID = @import("../zig.zig").Guid.initString("04ea6161-fba3-477a-952a-bb326d026a5b");
pub const Text_IndentationFirstLine_Attribute_GUID = @import("../zig.zig").Guid.initString("206f9ad5-c1d3-424a-8182-6da9a7f3d632");
pub const Text_IndentationLeading_Attribute_GUID = @import("../zig.zig").Guid.initString("5cf66bac-2d45-4a4b-b6c9-f7221d2815b0");
pub const Text_IndentationTrailing_Attribute_GUID = @import("../zig.zig").Guid.initString("97ff6c0f-1ce4-408a-b67b-94d83eb69bf2");
pub const Text_IsHidden_Attribute_GUID = @import("../zig.zig").Guid.initString("360182fb-bdd7-47f6-ab69-19e33f8a3344");
pub const Text_IsItalic_Attribute_GUID = @import("../zig.zig").Guid.initString("fce12a56-1336-4a34-9663-1bab47239320");
pub const Text_IsReadOnly_Attribute_GUID = @import("../zig.zig").Guid.initString("a738156b-ca3e-495e-9514-833c440feb11");
pub const Text_IsSubscript_Attribute_GUID = @import("../zig.zig").Guid.initString("f0ead858-8f53-413c-873f-1a7d7f5e0de4");
pub const Text_IsSuperscript_Attribute_GUID = @import("../zig.zig").Guid.initString("da706ee4-b3aa-4645-a41f-cd25157dea76");
pub const Text_MarginBottom_Attribute_GUID = @import("../zig.zig").Guid.initString("7ee593c4-72b4-4cac-9271-3ed24b0e4d42");
pub const Text_MarginLeading_Attribute_GUID = @import("../zig.zig").Guid.initString("9e9242d0-5ed0-4900-8e8a-eecc03835afc");
pub const Text_MarginTop_Attribute_GUID = @import("../zig.zig").Guid.initString("683d936f-c9b9-4a9a-b3d9-d20d33311e2a");
pub const Text_MarginTrailing_Attribute_GUID = @import("../zig.zig").Guid.initString("af522f98-999d-40af-a5b2-0169d0342002");
pub const Text_OutlineStyles_Attribute_GUID = @import("../zig.zig").Guid.initString("5b675b27-db89-46fe-970c-614d523bb97d");
pub const Text_OverlineColor_Attribute_GUID = @import("../zig.zig").Guid.initString("83ab383a-fd43-40da-ab3e-ecf8165cbb6d");
pub const Text_OverlineStyle_Attribute_GUID = @import("../zig.zig").Guid.initString("0a234d66-617e-427f-871d-e1ff1e0c213f");
pub const Text_StrikethroughColor_Attribute_GUID = @import("../zig.zig").Guid.initString("bfe15a18-8c41-4c5a-9a0b-04af0e07f487");
pub const Text_StrikethroughStyle_Attribute_GUID = @import("../zig.zig").Guid.initString("72913ef1-da00-4f01-899c-ac5a8577a307");
pub const Text_Tabs_Attribute_GUID = @import("../zig.zig").Guid.initString("2e68d00b-92fe-42d8-899a-a784aa4454a1");
pub const Text_TextFlowDirections_Attribute_GUID = @import("../zig.zig").Guid.initString("8bdf8739-f420-423e-af77-20a5d973a907");
pub const Text_UnderlineColor_Attribute_GUID = @import("../zig.zig").Guid.initString("bfa12c73-fde2-4473-bf64-1036d6aa0f45");
pub const Text_UnderlineStyle_Attribute_GUID = @import("../zig.zig").Guid.initString("5f3b21c0-ede4-44bd-9c36-3853038cbfeb");
pub const Text_AnnotationTypes_Attribute_GUID = @import("../zig.zig").Guid.initString("ad2eb431-ee4e-4be1-a7ba-5559155a73ef");
pub const Text_AnnotationObjects_Attribute_GUID = @import("../zig.zig").Guid.initString("ff41cf68-e7ab-40b9-8c72-72a8ed94017d");
pub const Text_StyleName_Attribute_GUID = @import("../zig.zig").Guid.initString("22c9e091-4d66-45d8-a828-737bab4c98a7");
pub const Text_StyleId_Attribute_GUID = @import("../zig.zig").Guid.initString("14c300de-c32b-449b-ab7c-b0e0789aea5d");
pub const Text_Link_Attribute_GUID = @import("../zig.zig").Guid.initString("b38ef51d-9e8d-4e46-9144-56ebe177329b");
pub const Text_IsActive_Attribute_GUID = @import("../zig.zig").Guid.initString("f5a4e533-e1b8-436b-935d-b57aa3f558c4");
pub const Text_SelectionActiveEnd_Attribute_GUID = @import("../zig.zig").Guid.initString("1f668cc3-9bbf-416b-b0a2-f89f86f6612c");
pub const Text_CaretPosition_Attribute_GUID = @import("../zig.zig").Guid.initString("b227b131-9889-4752-a91b-733efdc5c5a0");
pub const Text_CaretBidiMode_Attribute_GUID = @import("../zig.zig").Guid.initString("929ee7a6-51d3-4715-96dc-b694fa24a168");
pub const Text_BeforeParagraphSpacing_Attribute_GUID = @import("../zig.zig").Guid.initString("be7b0ab1-c822-4a24-85e9-c8f2650fc79c");
pub const Text_AfterParagraphSpacing_Attribute_GUID = @import("../zig.zig").Guid.initString("588cbb38-e62f-497c-b5d1-ccdf0ee823d8");
pub const Text_LineSpacing_Attribute_GUID = @import("../zig.zig").Guid.initString("63ff70ae-d943-4b47-8ab7-a7a033d3214b");
pub const Text_BeforeSpacing_Attribute_GUID = @import("../zig.zig").Guid.initString("be7b0ab1-c822-4a24-85e9-c8f2650fc79c");
pub const Text_AfterSpacing_Attribute_GUID = @import("../zig.zig").Guid.initString("588cbb38-e62f-497c-b5d1-ccdf0ee823d8");
pub const Text_SayAsInterpretAs_Attribute_GUID = @import("../zig.zig").Guid.initString("b38ad6ac-eee1-4b6e-88cc-014cefa93fcb");
pub const TextEdit_TextChanged_Event_GUID = @import("../zig.zig").Guid.initString("120b0308-ec22-4eb8-9c98-9867cda1b165");
pub const TextEdit_ConversionTargetChanged_Event_GUID = @import("../zig.zig").Guid.initString("3388c183-ed4f-4c8b-9baa-364d51d8847f");
pub const Changes_Event_GUID = @import("../zig.zig").Guid.initString("7df26714-614f-4e05-9488-716c5ba19436");
pub const Annotation_Custom_GUID = @import("../zig.zig").Guid.initString("9ec82750-3931-4952-85bc-1dbff78a43e3");
pub const Annotation_SpellingError_GUID = @import("../zig.zig").Guid.initString("ae85567e-9ece-423f-81b7-96c43d53e50e");
pub const Annotation_GrammarError_GUID = @import("../zig.zig").Guid.initString("757a048d-4518-41c6-854c-dc009b7cfb53");
pub const Annotation_Comment_GUID = @import("../zig.zig").Guid.initString("fd2fda30-26b3-4c06-8bc7-98f1532e46fd");
pub const Annotation_FormulaError_GUID = @import("../zig.zig").Guid.initString("95611982-0cab-46d5-a2f0-e30d1905f8bf");
pub const Annotation_TrackChanges_GUID = @import("../zig.zig").Guid.initString("21e6e888-dc14-4016-ac27-190553c8c470");
pub const Annotation_Header_GUID = @import("../zig.zig").Guid.initString("867b409b-b216-4472-a219-525e310681f8");
pub const Annotation_Footer_GUID = @import("../zig.zig").Guid.initString("cceab046-1833-47aa-8080-701ed0b0c832");
pub const Annotation_Highlighted_GUID = @import("../zig.zig").Guid.initString("757c884e-8083-4081-8b9c-e87f5072f0e4");
pub const Annotation_Endnote_GUID = @import("../zig.zig").Guid.initString("7565725c-2d99-4839-960d-33d3b866aba5");
pub const Annotation_Footnote_GUID = @import("../zig.zig").Guid.initString("3de10e21-4125-42db-8620-be8083080624");
pub const Annotation_InsertionChange_GUID = @import("../zig.zig").Guid.initString("0dbeb3a6-df15-4164-a3c0-e21a8ce931c4");
pub const Annotation_DeletionChange_GUID = @import("../zig.zig").Guid.initString("be3d5b05-951d-42e7-901d-adc8c2cf34d0");
pub const Annotation_MoveChange_GUID = @import("../zig.zig").Guid.initString("9da587eb-23e5-4490-b385-1a22ddc8b187");
pub const Annotation_FormatChange_GUID = @import("../zig.zig").Guid.initString("eb247345-d4f1-41ce-8e52-f79b69635e48");
pub const Annotation_UnsyncedChange_GUID = @import("../zig.zig").Guid.initString("1851116a-0e47-4b30-8cb5-d7dae4fbcd1b");
pub const Annotation_EditingLockedChange_GUID = @import("../zig.zig").Guid.initString("c31f3e1c-7423-4dac-8348-41f099ff6f64");
pub const Annotation_ExternalChange_GUID = @import("../zig.zig").Guid.initString("75a05b31-5f11-42fd-887d-dfa010db2392");
pub const Annotation_ConflictingChange_GUID = @import("../zig.zig").Guid.initString("98af8802-517c-459f-af13-016d3fab877e");
pub const Annotation_Author_GUID = @import("../zig.zig").Guid.initString("f161d3a7-f81b-4128-b17f-71f690914520");
pub const Annotation_AdvancedProofingIssue_GUID = @import("../zig.zig").Guid.initString("dac7b72c-c0f2-4b84-b90d-5fafc0f0ef1c");
pub const Annotation_DataValidationError_GUID = @import("../zig.zig").Guid.initString("c8649fa8-9775-437e-ad46-e709d93c2343");
pub const Annotation_CircularReferenceError_GUID = @import("../zig.zig").Guid.initString("25bd9cf4-1745-4659-ba67-727f0318c616");
pub const Annotation_Mathematics_GUID = @import("../zig.zig").Guid.initString("eaab634b-26d0-40c1-8073-57ca1c633c9b");
pub const Annotation_Sensitive_GUID = @import("../zig.zig").Guid.initString("37f4c04f-0f12-4464-929c-828fd15292e3");
pub const Changes_Summary_GUID = @import("../zig.zig").Guid.initString("313d65a6-e60f-4d62-9861-55afd728d207");
pub const StyleId_Custom_GUID = @import("../zig.zig").Guid.initString("ef2edd3e-a999-4b7c-a378-09bbd52a3516");
pub const StyleId_Heading1_GUID = @import("../zig.zig").Guid.initString("7f7e8f69-6866-4621-930c-9a5d0ca5961c");
pub const StyleId_Heading2_GUID = @import("../zig.zig").Guid.initString("baa9b241-5c69-469d-85ad-474737b52b14");
pub const StyleId_Heading3_GUID = @import("../zig.zig").Guid.initString("bf8be9d2-d8b8-4ec5-8c52-9cfb0d035970");
pub const StyleId_Heading4_GUID = @import("../zig.zig").Guid.initString("8436ffc0-9578-45fc-83a4-ff40053315dd");
pub const StyleId_Heading5_GUID = @import("../zig.zig").Guid.initString("909f424d-0dbf-406e-97bb-4e773d9798f7");
pub const StyleId_Heading6_GUID = @import("../zig.zig").Guid.initString("89d23459-5d5b-4824-a420-11d3ed82e40f");
pub const StyleId_Heading7_GUID = @import("../zig.zig").Guid.initString("a3790473-e9ae-422d-b8e3-3b675c6181a4");
pub const StyleId_Heading8_GUID = @import("../zig.zig").Guid.initString("2bc14145-a40c-4881-84ae-f2235685380c");
pub const StyleId_Heading9_GUID = @import("../zig.zig").Guid.initString("c70d9133-bb2a-43d3-8ac6-33657884b0f0");
pub const StyleId_Title_GUID = @import("../zig.zig").Guid.initString("15d8201a-ffcf-481f-b0a1-30b63be98f07");
pub const StyleId_Subtitle_GUID = @import("../zig.zig").Guid.initString("b5d9fc17-5d6f-4420-b439-7cb19ad434e2");
pub const StyleId_Normal_GUID = @import("../zig.zig").Guid.initString("cd14d429-e45e-4475-a1c5-7f9e6be96eba");
pub const StyleId_Emphasis_GUID = @import("../zig.zig").Guid.initString("ca6e7dbe-355e-4820-95a0-925f041d3470");
pub const StyleId_Quote_GUID = @import("../zig.zig").Guid.initString("5d1c21ea-8195-4f6c-87ea-5dabece64c1d");
pub const StyleId_BulletedList_GUID = @import("../zig.zig").Guid.initString("5963ed64-6426-4632-8caf-a32ad402d91a");
pub const StyleId_NumberedList_GUID = @import("../zig.zig").Guid.initString("1e96dbd5-64c3-43d0-b1ee-b53b06e3eddf");
pub const Notification_Event_GUID = @import("../zig.zig").Guid.initString("72c5a2f7-9788-480f-b8eb-4dee00f6186f");
pub const SID_IsUIAutomationObject = @import("../zig.zig").Guid.initString("b96fdb85-7204-4724-842b-c7059dedb9d0");
pub const SID_ControlElementProvider = @import("../zig.zig").Guid.initString("f4791d68-e254-4ba3-9a53-26a5c5497946");
pub const IsSelectionPattern2Available_Property_GUID = @import("../zig.zig").Guid.initString("490806fb-6e89-4a47-8319-d266e511f021");
pub const Selection2_FirstSelectedItem_Property_GUID = @import("../zig.zig").Guid.initString("cc24ea67-369c-4e55-9ff7-38da69540c29");
pub const Selection2_LastSelectedItem_Property_GUID = @import("../zig.zig").Guid.initString("cf7bda90-2d83-49f8-860c-9ce394cf89b4");
pub const Selection2_CurrentSelectedItem_Property_GUID = @import("../zig.zig").Guid.initString("34257c26-83b5-41a6-939c-ae841c136236");
pub const Selection2_ItemCount_Property_GUID = @import("../zig.zig").Guid.initString("bb49eb9f-456d-4048-b591-9c2026b84636");
pub const Selection_Pattern2_GUID = @import("../zig.zig").Guid.initString("fba25cab-ab98-49f7-a7dc-fe539dc15be7");
pub const HeadingLevel_Property_GUID = @import("../zig.zig").Guid.initString("29084272-aaaf-4a30-8796-3c12f62b6bbb");
pub const IsDialog_Property_GUID = @import("../zig.zig").Guid.initString("9d0dfb9b-8436-4501-bbbb-e534a4fb3b3f");
...
// TODO: This Enum is marked as [Flags], what do I do with this?
pub const AccSetRunningUtilityState_dwUtilityStateFlags = extern enum(u32) {
...
pub const ANRUS_ON_SCREEN_KEYBOARD_ACTIVE = AccSetRunningUtilityState_dwUtilityStateFlags.ON_SCREEN_KEYBOARD_ACTIVE;
pub const ANRUS_TOUCH_MODIFICATION_ACTIVE = AccSetRunningUtilityState_dwUtilityStateFlags.TOUCH_MODIFICATION_ACTIVE;
pub const ANRUS_PRIORITY_AUDIO_ACTIVE = AccSetRunningUtilityState_dwUtilityStateFlags.PRIORITY_AUDIO_ACTIVE;
pub const ANRUS_PRIORITY_AUDIO_ACTIVE_NODUCK = AccSetRunningUtilityState_dwUtilityStateFlags.PRIORITY_AUDIO_ACTIVE_NODUCK;

pub const SOUNDSENTRYW_iFSGrafEffect = extern enum(u32) {
    DISPLAY = 3,
    NONE = 0,
};
pub const SSGF_DISPLAY = SOUNDSENTRYW_iFSGrafEffect.DISPLAY;
pub const SSGF_NONE = SOUNDSENTRYW_iFSGrafEffect.NONE;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const SERIALKEYSW_dwFlags = extern enum(u32) {
    AVAILABLE = 2,
    INDICATOR = 4,
    SERIALKEYSON = 1,
    _,
};
pub const SERKF_AVAILABLE = SERIALKEYSW_dwFlags.AVAILABLE;
pub const SERKF_INDICATOR = SERIALKEYSW_dwFlags.INDICATOR;
pub const SERKF_SERIALKEYSON = SERIALKEYSW_dwFlags.SERIALKEYSON;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const HIGHCONTRASTW_dwFlags = extern enum(u32) {
    HIGHCONTRASTON = 1,
    AVAILABLE = 2,
    HOTKEYACTIVE = 4,
    CONFIRMHOTKEY = 8,
...
pub const HCF_HIGHCONTRASTON = HIGHCONTRASTW_dwFlags.HIGHCONTRASTON;
pub const HCF_AVAILABLE = HIGHCONTRASTW_dwFlags.AVAILABLE;
pub const HCF_HOTKEYACTIVE = HIGHCONTRASTW_dwFlags.HOTKEYACTIVE;
pub const HCF_CONFIRMHOTKEY = HIGHCONTRASTW_dwFlags.CONFIRMHOTKEY;
pub const HCF_HOTKEYSOUND = HIGHCONTRASTW_dwFlags.HOTKEYSOUND;
pub const HCF_INDICATOR = HIGHCONTRASTW_dwFlags.INDICATOR;
pub const HCF_HOTKEYAVAILABLE = HIGHCONTRASTW_dwFlags.HOTKEYAVAILABLE;
pub const HCF_OPTION_NOTHEMECHANGE = HIGHCONTRASTW_dwFlags.OPTION_NOTHEMECHANGE;

pub const SOUNDSENTRYA_iFSTextEffect = extern enum(u32) {
    BORDER = 2,
    CHARS = 1,
    DISPLAY = 3,
    NONE = 0,
};
pub const SSTF_BORDER = SOUNDSENTRYA_iFSTextEffect.BORDER;
pub const SSTF_CHARS = SOUNDSENTRYA_iFSTextEffect.CHARS;
pub const SSTF_DISPLAY = SOUNDSENTRYA_iFSTextEffect.DISPLAY;
pub const SSTF_NONE = SOUNDSENTRYA_iFSTextEffect.NONE;

pub const SOUNDSENTRYA_iWindowsEffect = extern enum(u32) {
    CUSTOM = 4,
    DISPLAY = 3,
    NONE = 0,
    TITLE = 1,
...
pub const SSWF_CUSTOM = SOUNDSENTRYA_iWindowsEffect.CUSTOM;
pub const SSWF_DISPLAY = SOUNDSENTRYA_iWindowsEffect.DISPLAY;
...
pub const SOUNDSENTRYA = extern struct {
    ...
    iFSTextEffect: SOUNDSENTRYA_iFSTextEffect,
    iFSTextEffectMSec: u32,
    iFSTextEffectColorBits: u32,
    iFSGrafEffect: SOUNDSENTRYW_iFSGrafEffect,
    iFSGrafEffectMSec: u32,
    iFSGrafEffectColor: u32,
    iWindowsEffect: SOUNDSENTRYA_iWindowsEffect,
