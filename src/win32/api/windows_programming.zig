...
// TODO: enum 'VER_MASK' has known issues with its value aliases

pub const RegSaveKeyEx_Flags = extern enum(u32) {
    STANDARD_FORMAT = 1,
    LATEST_FORMAT = 2,
    NO_COMPRESSION = 4,
};
pub const REG_STANDARD_FORMAT = RegSaveKeyEx_Flags.STANDARD_FORMAT;
pub const REG_LATEST_FORMAT = RegSaveKeyEx_Flags.LATEST_FORMAT;
pub const REG_NO_COMPRESSION = RegSaveKeyEx_Flags.NO_COMPRESSION;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const VerifierEnumerateResource_Flags = extern enum(u32) {
    DONT_RESOLVE_TRACES = 2,
    SUSPEND = 1,
    _,
};
pub const AVRF_ENUM_RESOURCES_FLAGS_DONT_RESOLVE_TRACES = VerifierEnumerateResource_Flags.DONT_RESOLVE_TRACES;
pub const AVRF_ENUM_RESOURCES_FLAGS_SUSPEND = VerifierEnumerateResource_Flags.SUSPEND;

pub const VerSetConditionMask_Condition = extern enum(u32) {
    EQUAL = 1,
    GREATER = 2,
    GREATER_EQUAL = 3,
    LESS = 4,
...
pub const VER_EQUAL = VerSetConditionMask_Condition.EQUAL;
pub const VER_GREATER = VerSetConditionMask_Condition.GREATER;
pub const VER_GREATER_EQUAL = VerSetConditionMask_Condition.GREATER_EQUAL;
pub const VER_LESS = VerSetConditionMask_Condition.LESS;
pub const VER_LESS_EQUAL = VerSetConditionMask_Condition.LESS_EQUAL;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const DuplicateHandle_dwOptionsFlags = extern enum(u32) {
    CLOSE_SOURCE = 1,
    SAME_ACCESS = 2,
    _,
};
// TODO: enum 'DuplicateHandle_dwOptionsFlags' has known issues with its value aliases

pub const RegRestoreKey_dwFlags = extern enum(i32) {
    FORCE_RESTORE = 8,
    WHOLE_HIVE_VOLATILE = 1,
};
pub const REG_FORCE_RESTORE = RegRestoreKey_dwFlags.FORCE_RESTORE;
pub const REG_WHOLE_HIVE_VOLATILE = RegRestoreKey_dwFlags.WHOLE_HIVE_VOLATILE;

pub const REG_OPTION = extern enum(i32) {
    BACKUP_RESTORE = 4,
    NON_VOLATILE = 0,
    VOLATILE = 1,
    CREATE_LINK = 2,
};
pub const REG_OPTION_BACKUP_RESTORE = REG_OPTION.BACKUP_RESTORE;
pub const REG_OPTION_NON_VOLATILE = REG_OPTION.NON_VOLATILE;
pub const REG_OPTION_VOLATILE = REG_OPTION.VOLATILE;
pub const REG_OPTION_CREATE_LINK = REG_OPTION.CREATE_LINK;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const RegNotifyChangeKeyValue_dwNotifyFilterFlags = extern enum(u32) {
    CHANGE_NAME = 1,
    CHANGE_ATTRIBUTES = 2,
    CHANGE_LAST_SET = 4,
    CHANGE_SECURITY = 8,
...
pub const REG_NOTIFY_CHANGE_NAME = RegNotifyChangeKeyValue_dwNotifyFilterFlags.CHANGE_NAME;
pub const REG_NOTIFY_CHANGE_ATTRIBUTES = RegNotifyChangeKeyValue_dwNotifyFilterFlags.CHANGE_ATTRIBUTES;
pub const REG_NOTIFY_CHANGE_LAST_SET = RegNotifyChangeKeyValue_dwNotifyFilterFlags.CHANGE_LAST_SET;
pub const REG_NOTIFY_CHANGE_SECURITY = RegNotifyChangeKeyValue_dwNotifyFilterFlags.CHANGE_SECURITY;
pub const REG_NOTIFY_THREAD_AGNOSTIC = RegNotifyChangeKeyValue_dwNotifyFilterFlags.THREAD_AGNOSTIC;

pub const FDICreate_cpuTypeFlags = extern enum(u32) {
    @"286" = 0,
    @"386" = 1,
};
pub const cpu80286 = FDICreate_cpuTypeFlags.@"286";
pub const cpu80386 = FDICreate_cpuTypeFlags.@"386";

pub const IsUserCetAvailableInEnvironment_UserCetEnvironmentFlags = extern enum(u32) {
    WIN32_PROCESS = 0,
    SGX2_ENCLAVE = 2,
    VBS_BASIC_ENCLAVE = 17,
};
pub const USER_CET_ENVIRONMENT_WIN32_PROCESS = IsUserCetAvailableInEnvironment_UserCetEnvironmentFlags.WIN32_PROCESS;
pub const USER_CET_ENVIRONMENT_SGX2_ENCLAVE = IsUserCetAvailableInEnvironment_UserCetEnvironmentFlags.SGX2_ENCLAVE;
pub const USER_CET_ENVIRONMENT_VBS_BASIC_ENCLAVE = IsUserCetAvailableInEnvironment_UserCetEnvironmentFlags.VBS_BASIC_ENCLAVE;

pub const NtCreateFile_CreateDispositionFlags = extern enum(u32) {
    SUPERSEDE = 0,
    CREATE = 2,
    OPEN = 1,
    OPEN_IF = 3,
...
pub const FILE_SUPERSEDE = NtCreateFile_CreateDispositionFlags.SUPERSEDE;
pub const FILE_CREATE = NtCreateFile_CreateDispositionFlags.CREATE;
pub const FILE_OPEN = NtCreateFile_CreateDispositionFlags.OPEN;
pub const FILE_OPEN_IF = NtCreateFile_CreateDispositionFlags.OPEN_IF;
pub const FILE_OVERWRITE = NtCreateFile_CreateDispositionFlags.OVERWRITE;
pub const FILE_OVERWRITE_IF = NtCreateFile_CreateDispositionFlags.OVERWRITE_IF;
...
// TODO: This Enum is marked as [Flags], what do I do with this?
pub const SetHandleInformation_dwFlags = extern enum(u32) {
    INHERIT = 1,
    PROTECT_FROM_CLOSE = 2,
    _,
};
// TODO: enum 'SetHandleInformation_dwFlags' has known issues with its value aliases

pub const GetProductInfo_pdwReturnedProductTypeFlags = extern enum(u32) {
    BUSINESS = 6,
    BUSINESS_N = 16,
    CLUSTER_SERVER = 18,
    CLUSTER_SERVER_V = 64,
...
pub const PRODUCT_BUSINESS = GetProductInfo_pdwReturnedProductTypeFlags.BUSINESS;
pub const PRODUCT_BUSINESS_N = GetProductInfo_pdwReturnedProductTypeFlags.BUSINESS_N;
pub const PRODUCT_CLUSTER_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.CLUSTER_SERVER;
pub const PRODUCT_CLUSTER_SERVER_V = GetProductInfo_pdwReturnedProductTypeFlags.CLUSTER_SERVER_V;
pub const PRODUCT_CORE = GetProductInfo_pdwReturnedProductTypeFlags.CORE;
pub const PRODUCT_CORE_COUNTRYSPECIFIC = GetProductInfo_pdwReturnedProductTypeFlags.CORE_COUNTRYSPECIFIC;
pub const PRODUCT_CORE_N = GetProductInfo_pdwReturnedProductTypeFlags.CORE_N;
pub const PRODUCT_CORE_SINGLELANGUAGE = GetProductInfo_pdwReturnedProductTypeFlags.CORE_SINGLELANGUAGE;
pub const PRODUCT_DATACENTER_EVALUATION_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.DATACENTER_EVALUATION_SERVER;
pub const PRODUCT_DATACENTER_A_SERVER_CORE = GetProductInfo_pdwReturnedProductTypeFlags.DATACENTER_A_SERVER_CORE;
pub const PRODUCT_STANDARD_A_SERVER_CORE = GetProductInfo_pdwReturnedProductTypeFlags.STANDARD_A_SERVER_CORE;
pub const PRODUCT_DATACENTER_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.DATACENTER_SERVER;
pub const PRODUCT_DATACENTER_SERVER_CORE = GetProductInfo_pdwReturnedProductTypeFlags.DATACENTER_SERVER_CORE;
pub const PRODUCT_DATACENTER_SERVER_CORE_V = GetProductInfo_pdwReturnedProductTypeFlags.DATACENTER_SERVER_CORE_V;
pub const PRODUCT_DATACENTER_SERVER_V = GetProductInfo_pdwReturnedProductTypeFlags.DATACENTER_SERVER_V;
pub const PRODUCT_EDUCATION = GetProductInfo_pdwReturnedProductTypeFlags.EDUCATION;
pub const PRODUCT_EDUCATION_N = GetProductInfo_pdwReturnedProductTypeFlags.EDUCATION_N;
pub const PRODUCT_ENTERPRISE = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE;
pub const PRODUCT_ENTERPRISE_E = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_E;
pub const PRODUCT_ENTERPRISE_EVALUATION = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_EVALUATION;
pub const PRODUCT_ENTERPRISE_N = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_N;
pub const PRODUCT_ENTERPRISE_N_EVALUATION = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_N_EVALUATION;
pub const PRODUCT_ENTERPRISE_S = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_S;
pub const PRODUCT_ENTERPRISE_S_EVALUATION = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_S_EVALUATION;
pub const PRODUCT_ENTERPRISE_S_N = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_S_N;
pub const PRODUCT_ENTERPRISE_S_N_EVALUATION = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_S_N_EVALUATION;
pub const PRODUCT_ENTERPRISE_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_SERVER;
pub const PRODUCT_ENTERPRISE_SERVER_CORE = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_SERVER_CORE;
pub const PRODUCT_ENTERPRISE_SERVER_CORE_V = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_SERVER_CORE_V;
pub const PRODUCT_ENTERPRISE_SERVER_IA64 = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_SERVER_IA64;
pub const PRODUCT_ENTERPRISE_SERVER_V = GetProductInfo_pdwReturnedProductTypeFlags.ENTERPRISE_SERVER_V;
pub const PRODUCT_ESSENTIALBUSINESS_SERVER_ADDL = GetProductInfo_pdwReturnedProductTypeFlags.ESSENTIALBUSINESS_SERVER_ADDL;
pub const PRODUCT_ESSENTIALBUSINESS_SERVER_ADDLSVC = GetProductInfo_pdwReturnedProductTypeFlags.ESSENTIALBUSINESS_SERVER_ADDLSVC;
pub const PRODUCT_ESSENTIALBUSINESS_SERVER_MGMT = GetProductInfo_pdwReturnedProductTypeFlags.ESSENTIALBUSINESS_SERVER_MGMT;
pub const PRODUCT_ESSENTIALBUSINESS_SERVER_MGMTSVC = GetProductInfo_pdwReturnedProductTypeFlags.ESSENTIALBUSINESS_SERVER_MGMTSVC;
pub const PRODUCT_HOME_BASIC = GetProductInfo_pdwReturnedProductTypeFlags.HOME_BASIC;
pub const PRODUCT_HOME_BASIC_E = GetProductInfo_pdwReturnedProductTypeFlags.HOME_BASIC_E;
pub const PRODUCT_HOME_BASIC_N = GetProductInfo_pdwReturnedProductTypeFlags.HOME_BASIC_N;
pub const PRODUCT_HOME_PREMIUM = GetProductInfo_pdwReturnedProductTypeFlags.HOME_PREMIUM;
pub const PRODUCT_HOME_PREMIUM_E = GetProductInfo_pdwReturnedProductTypeFlags.HOME_PREMIUM_E;
pub const PRODUCT_HOME_PREMIUM_N = GetProductInfo_pdwReturnedProductTypeFlags.HOME_PREMIUM_N;
pub const PRODUCT_HOME_PREMIUM_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.HOME_PREMIUM_SERVER;
pub const PRODUCT_HOME_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.HOME_SERVER;
pub const PRODUCT_HYPERV = GetProductInfo_pdwReturnedProductTypeFlags.HYPERV;
pub const PRODUCT_IOTUAP = GetProductInfo_pdwReturnedProductTypeFlags.IOTUAP;
pub const PRODUCT_IOTUAPCOMMERCIAL = GetProductInfo_pdwReturnedProductTypeFlags.IOTUAPCOMMERCIAL;
pub const PRODUCT_MEDIUMBUSINESS_SERVER_MANAGEMENT = GetProductInfo_pdwReturnedProductTypeFlags.MEDIUMBUSINESS_SERVER_MANAGEMENT;
pub const PRODUCT_MEDIUMBUSINESS_SERVER_MESSAGING = GetProductInfo_pdwReturnedProductTypeFlags.MEDIUMBUSINESS_SERVER_MESSAGING;
pub const PRODUCT_MEDIUMBUSINESS_SERVER_SECURITY = GetProductInfo_pdwReturnedProductTypeFlags.MEDIUMBUSINESS_SERVER_SECURITY;
pub const PRODUCT_MOBILE_CORE = GetProductInfo_pdwReturnedProductTypeFlags.MOBILE_CORE;
pub const PRODUCT_MOBILE_ENTERPRISE = GetProductInfo_pdwReturnedProductTypeFlags.MOBILE_ENTERPRISE;
pub const PRODUCT_MULTIPOINT_PREMIUM_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.MULTIPOINT_PREMIUM_SERVER;
pub const PRODUCT_MULTIPOINT_STANDARD_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.MULTIPOINT_STANDARD_SERVER;
pub const PRODUCT_PRO_WORKSTATION = GetProductInfo_pdwReturnedProductTypeFlags.PRO_WORKSTATION;
pub const PRODUCT_PRO_WORKSTATION_N = GetProductInfo_pdwReturnedProductTypeFlags.PRO_WORKSTATION_N;
pub const PRODUCT_PROFESSIONAL = GetProductInfo_pdwReturnedProductTypeFlags.PROFESSIONAL;
pub const PRODUCT_PROFESSIONAL_E = GetProductInfo_pdwReturnedProductTypeFlags.PROFESSIONAL_E;
pub const PRODUCT_PROFESSIONAL_N = GetProductInfo_pdwReturnedProductTypeFlags.PROFESSIONAL_N;
pub const PRODUCT_PROFESSIONAL_WMC = GetProductInfo_pdwReturnedProductTypeFlags.PROFESSIONAL_WMC;
pub const PRODUCT_SB_SOLUTION_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.SB_SOLUTION_SERVER;
pub const PRODUCT_SB_SOLUTION_SERVER_EM = GetProductInfo_pdwReturnedProductTypeFlags.SB_SOLUTION_SERVER_EM;
pub const PRODUCT_SERVER_FOR_SB_SOLUTIONS = GetProductInfo_pdwReturnedProductTypeFlags.SERVER_FOR_SB_SOLUTIONS;
pub const PRODUCT_SERVER_FOR_SB_SOLUTIONS_EM = GetProductInfo_pdwReturnedProductTypeFlags.SERVER_FOR_SB_SOLUTIONS_EM;
pub const PRODUCT_SERVER_FOR_SMALLBUSINESS = GetProductInfo_pdwReturnedProductTypeFlags.SERVER_FOR_SMALLBUSINESS;
pub const PRODUCT_SERVER_FOR_SMALLBUSINESS_V = GetProductInfo_pdwReturnedProductTypeFlags.SERVER_FOR_SMALLBUSINESS_V;
pub const PRODUCT_SERVER_FOUNDATION = GetProductInfo_pdwReturnedProductTypeFlags.SERVER_FOUNDATION;
pub const PRODUCT_SMALLBUSINESS_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.SMALLBUSINESS_SERVER;
pub const PRODUCT_SMALLBUSINESS_SERVER_PREMIUM = GetProductInfo_pdwReturnedProductTypeFlags.SMALLBUSINESS_SERVER_PREMIUM;
pub const PRODUCT_SMALLBUSINESS_SERVER_PREMIUM_CORE = GetProductInfo_pdwReturnedProductTypeFlags.SMALLBUSINESS_SERVER_PREMIUM_CORE;
pub const PRODUCT_SOLUTION_EMBEDDEDSERVER = GetProductInfo_pdwReturnedProductTypeFlags.SOLUTION_EMBEDDEDSERVER;
pub const PRODUCT_STANDARD_EVALUATION_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.STANDARD_EVALUATION_SERVER;
pub const PRODUCT_STANDARD_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.STANDARD_SERVER;
pub const PRODUCT_STANDARD_SERVER_CORE_ = GetProductInfo_pdwReturnedProductTypeFlags.STANDARD_SERVER_CORE_;
pub const PRODUCT_STANDARD_SERVER_CORE_V = GetProductInfo_pdwReturnedProductTypeFlags.STANDARD_SERVER_CORE_V;
pub const PRODUCT_STANDARD_SERVER_V = GetProductInfo_pdwReturnedProductTypeFlags.STANDARD_SERVER_V;
pub const PRODUCT_STANDARD_SERVER_SOLUTIONS = GetProductInfo_pdwReturnedProductTypeFlags.STANDARD_SERVER_SOLUTIONS;
pub const PRODUCT_STANDARD_SERVER_SOLUTIONS_CORE = GetProductInfo_pdwReturnedProductTypeFlags.STANDARD_SERVER_SOLUTIONS_CORE;
pub const PRODUCT_STARTER = GetProductInfo_pdwReturnedProductTypeFlags.STARTER;
pub const PRODUCT_STARTER_E = GetProductInfo_pdwReturnedProductTypeFlags.STARTER_E;
pub const PRODUCT_STARTER_N = GetProductInfo_pdwReturnedProductTypeFlags.STARTER_N;
pub const PRODUCT_STORAGE_ENTERPRISE_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.STORAGE_ENTERPRISE_SERVER;
pub const PRODUCT_STORAGE_ENTERPRISE_SERVER_CORE = GetProductInfo_pdwReturnedProductTypeFlags.STORAGE_ENTERPRISE_SERVER_CORE;
pub const PRODUCT_STORAGE_EXPRESS_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.STORAGE_EXPRESS_SERVER;
pub const PRODUCT_STORAGE_EXPRESS_SERVER_CORE = GetProductInfo_pdwReturnedProductTypeFlags.STORAGE_EXPRESS_SERVER_CORE;
pub const PRODUCT_STORAGE_STANDARD_EVALUATION_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.STORAGE_STANDARD_EVALUATION_SERVER;
pub const PRODUCT_STORAGE_STANDARD_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.STORAGE_STANDARD_SERVER;
pub const PRODUCT_STORAGE_STANDARD_SERVER_CORE = GetProductInfo_pdwReturnedProductTypeFlags.STORAGE_STANDARD_SERVER_CORE;
pub const PRODUCT_STORAGE_WORKGROUP_EVALUATION_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.STORAGE_WORKGROUP_EVALUATION_SERVER;
pub const PRODUCT_STORAGE_WORKGROUP_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.STORAGE_WORKGROUP_SERVER;
pub const PRODUCT_STORAGE_WORKGROUP_SERVER_CORE = GetProductInfo_pdwReturnedProductTypeFlags.STORAGE_WORKGROUP_SERVER_CORE;
pub const PRODUCT_ULTIMATE = GetProductInfo_pdwReturnedProductTypeFlags.ULTIMATE;
pub const PRODUCT_ULTIMATE_E = GetProductInfo_pdwReturnedProductTypeFlags.ULTIMATE_E;
pub const PRODUCT_ULTIMATE_N = GetProductInfo_pdwReturnedProductTypeFlags.ULTIMATE_N;
pub const PRODUCT_UNDEFINED = GetProductInfo_pdwReturnedProductTypeFlags.UNDEFINED;
pub const PRODUCT_WEB_SERVER = GetProductInfo_pdwReturnedProductTypeFlags.WEB_SERVER;
pub const PRODUCT_WEB_SERVER_CORE = GetProductInfo_pdwReturnedProductTypeFlags.WEB_SERVER_CORE;

pub const IsProcessorFeaturePresent_ProcessorFeatureFlags = extern enum(u32) {
...
pub const PF_ARM_64BIT_LOADSTORE_ATOMIC = IsProcessorFeaturePresent_ProcessorFeatureFlags.ARM_64BIT_LOADSTORE_ATOMIC;
pub const PF_ARM_DIVIDE_INSTRUCTION_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.ARM_DIVIDE_INSTRUCTION_AVAILABLE;
pub const PF_ARM_EXTERNAL_CACHE_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.ARM_EXTERNAL_CACHE_AVAILABLE;
pub const PF_ARM_FMAC_INSTRUCTIONS_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.ARM_FMAC_INSTRUCTIONS_AVAILABLE;
pub const PF_ARM_VFP_32_REGISTERS_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.ARM_VFP_32_REGISTERS_AVAILABLE;
pub const PF_3DNOW_INSTRUCTIONS_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.@"3DNOW_INSTRUCTIONS_AVAILABLE";
pub const PF_CHANNELS_ENABLED = IsProcessorFeaturePresent_ProcessorFeatureFlags.CHANNELS_ENABLED;
pub const PF_COMPARE_EXCHANGE_DOUBLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.COMPARE_EXCHANGE_DOUBLE;
pub const PF_COMPARE_EXCHANGE128 = IsProcessorFeaturePresent_ProcessorFeatureFlags.COMPARE_EXCHANGE128;
pub const PF_COMPARE64_EXCHANGE128 = IsProcessorFeaturePresent_ProcessorFeatureFlags.COMPARE64_EXCHANGE128;
pub const PF_FASTFAIL_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.FASTFAIL_AVAILABLE;
pub const PF_FLOATING_POINT_EMULATED = IsProcessorFeaturePresent_ProcessorFeatureFlags.FLOATING_POINT_EMULATED;
pub const PF_FLOATING_POINT_PRECISION_ERRATA = IsProcessorFeaturePresent_ProcessorFeatureFlags.FLOATING_POINT_PRECISION_ERRATA;
pub const PF_MMX_INSTRUCTIONS_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.MMX_INSTRUCTIONS_AVAILABLE;
pub const PF_NX_ENABLED = IsProcessorFeaturePresent_ProcessorFeatureFlags.NX_ENABLED;
pub const PF_PAE_ENABLED = IsProcessorFeaturePresent_ProcessorFeatureFlags.PAE_ENABLED;
pub const PF_RDTSC_INSTRUCTION_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.RDTSC_INSTRUCTION_AVAILABLE;
pub const PF_RDWRFSGSBASE_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.RDWRFSGSBASE_AVAILABLE;
pub const PF_SECOND_LEVEL_ADDRESS_TRANSLATION = IsProcessorFeaturePresent_ProcessorFeatureFlags.SECOND_LEVEL_ADDRESS_TRANSLATION;
pub const PF_SSE3_INSTRUCTIONS_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.SSE3_INSTRUCTIONS_AVAILABLE;
pub const PF_VIRT_FIRMWARE_ENABLED = IsProcessorFeaturePresent_ProcessorFeatureFlags.VIRT_FIRMWARE_ENABLED;
pub const PF_XMMI_INSTRUCTIONS_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.XMMI_INSTRUCTIONS_AVAILABLE;
pub const PF_XMMI64_INSTRUCTIONS_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.XMMI64_INSTRUCTIONS_AVAILABLE;
pub const PF_XSAVE_ENABLED = IsProcessorFeaturePresent_ProcessorFeatureFlags.XSAVE_ENABLED;
pub const PF_ARM_V8_INSTRUCTIONS_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.ARM_V8_INSTRUCTIONS_AVAILABLE;
pub const PF_ARM_V8_CRYPTO_INSTRUCTIONS_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.ARM_V8_CRYPTO_INSTRUCTIONS_AVAILABLE;
pub const PF_ARM_V8_CRC32_INSTRUCTIONS_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.ARM_V8_CRC32_INSTRUCTIONS_AVAILABLE;
pub const PF_ARM_V81_ATOMIC_INSTRUCTIONS_AVAILABLE = IsProcessorFeaturePresent_ProcessorFeatureFlags.ARM_V81_ATOMIC_INSTRUCTIONS_AVAILABLE;

pub const VER_NT = extern enum(u32) {
    DOMAIN_CONTROLLER = 2,
    SERVER = 3,
    WORKSTATION = 1,
};
pub const VER_NT_DOMAIN_CONTROLLER = VER_NT.DOMAIN_CONTROLLER;
pub const VER_NT_SERVER = VER_NT.SERVER;
pub const VER_NT_WORKSTATION = VER_NT.WORKSTATION;

pub const TDIEntityID_tei_entityFlags = extern enum(u32) {
    GENERIC_ENTITY = 0,
    AT_ENTITY = 640,
    CL_NL_ENTITY = 769,
    CO_NL_ENTITY = 768,
...
pub const GENERIC_ENTITY = TDIEntityID_tei_entityFlags.GENERIC_ENTITY;
pub const AT_ENTITY = TDIEntityID_tei_entityFlags.AT_ENTITY;
pub const CL_NL_ENTITY = TDIEntityID_tei_entityFlags.CL_NL_ENTITY;
pub const CO_NL_ENTITY = TDIEntityID_tei_entityFlags.CO_NL_ENTITY;
pub const CL_TL_ENTITY = TDIEntityID_tei_entityFlags.CL_TL_ENTITY;
pub const CO_TL_ENTITY = TDIEntityID_tei_entityFlags.CO_TL_ENTITY;
...
pub const _PROC_THREAD_ATTRIBUTE_LIST = extern struct {
...
pub const TDIEntityID = extern struct {
    tei_entity: TDIEntityID_tei_entityFlags,
    tei_instance: u32,
};
...
pub const GF_FRAGMENTS = _GlobalFilter.FRAGMENTS;
pub const GF_STRONGHOST = _GlobalFilter.STRONGHOST;
pub const GF_FRAGCACHE = _GlobalFilter.FRAGCACHE;

pub const _PfForwardAction = extern enum(i32) {
    FORWARD = 0,
    DROP = 1,
};
pub const PF_ACTION_FORWARD = _PfForwardAction.FORWARD;
pub const PF_ACTION_DROP = _PfForwardAction.DROP;

pub const _PfAddresType = extern enum(i32) {
    @"4" = 0,
    @"6" = 1,
};
pub const PF_IPV4 = _PfAddresType.@"4";
pub const PF_IPV6 = _PfAddresType.@"6";
...
pub const PFFT_FILTER = _PfFrameType.FILTER;
pub const PFFT_FRAG = _PfFrameType.FRAG;
pub const PFFT_SPOOF = _PfFrameType.SPOOF;
...
pub extern "KERNEL32" fn IsProcessorFeaturePresent(
    ProcessorFeature: IsProcessorFeaturePresent_ProcessorFeatureFlags,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "KERNEL32" fn IsUserCetAvailableInEnvironment(
    UserCetEnvironment: IsUserCetAvailableInEnvironment_UserCetEnvironmentFlags,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "KERNEL32" fn GetProductInfo(
    ...
    pdwReturnedProductType: *GetProductInfo_pdwReturnedProductTypeFlags,
) callconv(@import("std").os.windows.WINAPI) BOOL;
...
pub extern "ADVAPI32" fn RegNotifyChangeKeyValue(
    hKey: HKEY,
    bWatchSubtree: BOOL,
    dwNotifyFilter: RegNotifyChangeKeyValue_dwNotifyFilterFlags,
    hEvent: HANDLE,
    fAsynchronous: BOOL,
) callconv(@import("std").os.windows.WINAPI) LSTATUS;
...
pub extern "ntdll" fn NtCreateFile(
    ...
    CreateDisposition: NtCreateFile_CreateDispositionFlags,
    CreateOptions: u32,
    EaBuffer: *c_void,
    EaLength: u32,
) callconv(@import("std").os.windows.WINAPI) NTSTATUS;
...
pub extern "Cabinet" fn FDICreate(
    ...
    pfnclose: PFNCLOSE,
    pfnseek: PFNSEEK,
    cpuType: FDICreate_cpuTypeFlags,
    perf: *ERF,
) callconv(@import("std").os.windows.WINAPI) *c_void;
...
test {
    ...
    const constant_export_count = 906;
    const type_export_count = 573;
    const enum_value_export_count = 790;
