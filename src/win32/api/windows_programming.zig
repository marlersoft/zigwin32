...
pub const VER_SET_CONDITION__c_ = extern enum(u32) {
    EQUAL = 1,
    GREATER = 2,
    GREATER_EQUAL = 3,
    LESS = 4,
...
pub const VER_EQUAL = VER_SET_CONDITION__c_.EQUAL;
pub const VER_GREATER = VER_SET_CONDITION__c_.GREATER;
pub const VER_GREATER_EQUAL = VER_SET_CONDITION__c_.GREATER_EQUAL;
pub const VER_LESS = VER_SET_CONDITION__c_.LESS;
pub const VER_LESS_EQUAL = VER_SET_CONDITION__c_.LESS_EQUAL;
...
pub const REG_OPTION_RESERVED = REG_OPEN_CREATE_OPTIONS.RESERVED;
pub const REG_OPTION_NON_VOLATILE = REG_OPEN_CREATE_OPTIONS.NON_VOLATILE;
pub const REG_OPTION_VOLATILE = REG_OPEN_CREATE_OPTIONS.VOLATILE;
pub const REG_OPTION_CREATE_LINK = REG_OPEN_CREATE_OPTIONS.CREATE_LINK;
pub const REG_OPTION_BACKUP_RESTORE = REG_OPEN_CREATE_OPTIONS.BACKUP_RESTORE;
pub const REG_OPTION_OPEN_LINK = REG_OPEN_CREATE_OPTIONS.OPEN_LINK;
pub const REG_OPTION_DONT_VIRTUALIZE = REG_OPEN_CREATE_OPTIONS.DONT_VIRTUALIZE;
...
pub extern "KERNEL32" fn VerSetConditionMask(
    ConditionMask: u64,
    TypeMask: VER_MASK,
    Condition: VER_SET_CONDITION__c_,
) callconv(@import("std").os.windows.WINAPI) u64;
...
pub extern "ntdll" fn NtCreateFile(
    ...
    FileAttributes: u32,
    ShareAccess: CreateFile_dwShareMode,
...
const CreateFile_dwShareMode = @import("file_system.zig").CreateFile_dwShareMode;
