...
// Section: Types (14)
//--------------------------------------------------------------------------------
pub const EnumProcessModulesEx_dwFilterFlagFlags = extern enum(u32) {
    @"32BIT" = 1,
    @"64BIT" = 2,
    ALL = 3,
    DEFAULT = 0,
};
pub const LIST_MODULES_32BIT = EnumProcessModulesEx_dwFilterFlagFlags.@"32BIT";
pub const LIST_MODULES_64BIT = EnumProcessModulesEx_dwFilterFlagFlags.@"64BIT";
pub const LIST_MODULES_ALL = EnumProcessModulesEx_dwFilterFlagFlags.ALL;
pub const LIST_MODULES_DEFAULT = EnumProcessModulesEx_dwFilterFlagFlags.DEFAULT;
