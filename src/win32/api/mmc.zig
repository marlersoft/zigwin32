...
pub const MMC_PROPACT_DELETING = MMC_PROPERTY_ACTION.MMC_PROPACT_DELETING;
pub const MMC_PROPACT_CHANGING = MMC_PROPERTY_ACTION.MMC_PROPACT_CHANGING;
pub const MMC_PROPACT_INITIALIZED = MMC_PROPERTY_ACTION.MMC_PROPACT_INITIALIZED;
...
pub const DocumentMode_Author = _DocumentMode.DocumentMode_Author;
pub const DocumentMode_User = _DocumentMode.DocumentMode_User;
pub const DocumentMode_User_MDI = _DocumentMode.DocumentMode_User_MDI;
pub const DocumentMode_User_SDI = _DocumentMode.DocumentMode_User_SDI;
...
pub const ListMode_Small_Icons = _ListViewMode.ListMode_Small_Icons;
pub const ListMode_Large_Icons = _ListViewMode.ListMode_Large_Icons;
pub const ListMode_List = _ListViewMode.ListMode_List;
pub const ListMode_Detail = _ListViewMode.ListMode_Detail;
pub const ListMode_Filtered = _ListViewMode.ListMode_Filtered;
...
pub const ViewOption_Default = _ViewOptions.ViewOption_Default;
pub const ViewOption_ScopeTreeHidden = _ViewOptions.ViewOption_ScopeTreeHidden;
pub const ViewOption_NoToolBars = _ViewOptions.ViewOption_NoToolBars;
pub const ViewOption_NotPersistable = _ViewOptions.ViewOption_NotPersistable;
pub const ViewOption_ActionPaneHidden = _ViewOptions.ViewOption_ActionPaneHidden;
...
pub const ExportListOptions_Default = _ExportListOptions.ExportListOptions_Default;
pub const ExportListOptions_Unicode = _ExportListOptions.ExportListOptions_Unicode;
pub const ExportListOptions_TabDelimited = _ExportListOptions.ExportListOptions_TabDelimited;
pub const ExportListOptions_SelectedItemsOnly = _ExportListOptions.ExportListOptions_SelectedItemsOnly;
...
pub const _Application = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _Application_get_Document(self: *const T, Document: **Document) callconv(.Inline) HRESULT {
            return @ptrCast(*const _Application.VTable, self.vtable).get_Document(@ptrCast(*const _Application, self), Document);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _Application_get_Frame(self: *const T, Frame: **Frame) callconv(.Inline) HRESULT {
            return @ptrCast(*const _Application.VTable, self.vtable).get_Frame(@ptrCast(*const _Application, self), Frame);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const _AppEvents = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _AppEvents_OnDocumentOpen(self: *const T, Document: *Document, New: BOOL) callconv(.Inline) HRESULT {
            return @ptrCast(*const _AppEvents.VTable, self.vtable).OnDocumentOpen(@ptrCast(*const _AppEvents, self), Document, New);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _AppEvents_OnDocumentClose(self: *const T, Document: *Document) callconv(.Inline) HRESULT {
            return @ptrCast(*const _AppEvents.VTable, self.vtable).OnDocumentClose(@ptrCast(*const _AppEvents, self), Document);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _AppEvents_OnSnapInAdded(self: *const T, Document: *Document, SnapIn: *SnapIn) callconv(.Inline) HRESULT {
            return @ptrCast(*const _AppEvents.VTable, self.vtable).OnSnapInAdded(@ptrCast(*const _AppEvents, self), Document, SnapIn);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _AppEvents_OnSnapInRemoved(self: *const T, Document: *Document, SnapIn: *SnapIn) callconv(.Inline) HRESULT {
            return @ptrCast(*const _AppEvents.VTable, self.vtable).OnSnapInRemoved(@ptrCast(*const _AppEvents, self), Document, SnapIn);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _AppEvents_OnNewView(self: *const T, View: *View) callconv(.Inline) HRESULT {
            return @ptrCast(*const _AppEvents.VTable, self.vtable).OnNewView(@ptrCast(*const _AppEvents, self), View);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _AppEvents_OnViewClose(self: *const T, View: *View) callconv(.Inline) HRESULT {
            return @ptrCast(*const _AppEvents.VTable, self.vtable).OnViewClose(@ptrCast(*const _AppEvents, self), View);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _AppEvents_OnViewChange(self: *const T, View: *View, NewOwnerNode: *Node) callconv(.Inline) HRESULT {
            return @ptrCast(*const _AppEvents.VTable, self.vtable).OnViewChange(@ptrCast(*const _AppEvents, self), View, NewOwnerNode);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _AppEvents_OnSelectionChange(self: *const T, View: *View, NewNodes: *Nodes) callconv(.Inline) HRESULT {
            return @ptrCast(*const _AppEvents.VTable, self.vtable).OnSelectionChange(@ptrCast(*const _AppEvents, self), View, NewNodes);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _AppEvents_OnContextMenuExecuted(self: *const T, MenuItem: *MenuItem) callconv(.Inline) HRESULT {
            return @ptrCast(*const _AppEvents.VTable, self.vtable).OnContextMenuExecuted(@ptrCast(*const _AppEvents, self), MenuItem);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn _AppEvents_OnListUpdated(self: *const T, View: *View) callconv(.Inline) HRESULT {
            return @ptrCast(*const _AppEvents.VTable, self.vtable).OnListUpdated(@ptrCast(*const _AppEvents, self), View);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const ScopeNamespace = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ScopeNamespace_GetParent(self: *const T, Node: *Node, Parent: **Node) callconv(.Inline) HRESULT {
            return @ptrCast(*const ScopeNamespace.VTable, self.vtable).GetParent(@ptrCast(*const ScopeNamespace, self), Node, Parent);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ScopeNamespace_GetChild(self: *const T, Node: *Node, Child: **Node) callconv(.Inline) HRESULT {
            return @ptrCast(*const ScopeNamespace.VTable, self.vtable).GetChild(@ptrCast(*const ScopeNamespace, self), Node, Child);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ScopeNamespace_GetNext(self: *const T, Node: *Node, Next: **Node) callconv(.Inline) HRESULT {
            return @ptrCast(*const ScopeNamespace.VTable, self.vtable).GetNext(@ptrCast(*const ScopeNamespace, self), Node, Next);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ScopeNamespace_Expand(self: *const T, Node: *Node) callconv(.Inline) HRESULT {
            return @ptrCast(*const ScopeNamespace.VTable, self.vtable).Expand(@ptrCast(*const ScopeNamespace, self), Node);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const Document = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Document_get_Views(self: *const T, Views: **Views) callconv(.Inline) HRESULT {
            return @ptrCast(*const Document.VTable, self.vtable).get_Views(@ptrCast(*const Document, self), Views);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Document_get_SnapIns(self: *const T, SnapIns: **SnapIns) callconv(.Inline) HRESULT {
            return @ptrCast(*const Document.VTable, self.vtable).get_SnapIns(@ptrCast(*const Document, self), SnapIns);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Document_get_ActiveView(self: *const T, View: **View) callconv(.Inline) HRESULT {
            return @ptrCast(*const Document.VTable, self.vtable).get_ActiveView(@ptrCast(*const Document, self), View);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Document_get_RootNode(self: *const T, Node: **Node) callconv(.Inline) HRESULT {
            return @ptrCast(*const Document.VTable, self.vtable).get_RootNode(@ptrCast(*const Document, self), Node);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Document_get_ScopeNamespace(self: *const T, ScopeNamespace: **ScopeNamespace) callconv(.Inline) HRESULT {
            return @ptrCast(*const Document.VTable, self.vtable).get_ScopeNamespace(@ptrCast(*const Document, self), ScopeNamespace);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Document_CreateProperties(self: *const T, Properties: **Properties) callconv(.Inline) HRESULT {
            return @ptrCast(*const Document.VTable, self.vtable).CreateProperties(@ptrCast(*const Document, self), Properties);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const SnapIn = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn SnapIn_get_Extensions(self: *const T, Extensions: **Extensions) callconv(.Inline) HRESULT {
            return @ptrCast(*const SnapIn.VTable, self.vtable).get_Extensions(@ptrCast(*const SnapIn, self), Extensions);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn SnapIn_get_Properties(self: *const T, Properties: **Properties) callconv(.Inline) HRESULT {
            return @ptrCast(*const SnapIn.VTable, self.vtable).get_Properties(@ptrCast(*const SnapIn, self), Properties);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const SnapIns = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn SnapIns_Item(self: *const T, Index: i32, SnapIn: **SnapIn) callconv(.Inline) HRESULT {
            return @ptrCast(*const SnapIns.VTable, self.vtable).Item(@ptrCast(*const SnapIns, self), Index, SnapIn);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn SnapIns_Add(self: *const T, SnapinNameOrCLSID: BSTR, ParentSnapin: VARIANT, Properties: VARIANT, SnapIn: **SnapIn) callconv(.Inline) HRESULT {
            return @ptrCast(*const SnapIns.VTable, self.vtable).Add(@ptrCast(*const SnapIns, self), SnapinNameOrCLSID, ParentSnapin, Properties, SnapIn);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn SnapIns_Remove(self: *const T, SnapIn: *SnapIn) callconv(.Inline) HRESULT {
            return @ptrCast(*const SnapIns.VTable, self.vtable).Remove(@ptrCast(*const SnapIns, self), SnapIn);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const Extension = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Extension_get_Extensions(self: *const T, Extensions: **Extensions) callconv(.Inline) HRESULT {
            return @ptrCast(*const Extension.VTable, self.vtable).get_Extensions(@ptrCast(*const Extension, self), Extensions);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const Extensions = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Extensions_Item(self: *const T, Index: i32, Extension: **Extension) callconv(.Inline) HRESULT {
            return @ptrCast(*const Extensions.VTable, self.vtable).Item(@ptrCast(*const Extensions, self), Index, Extension);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const Columns = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Columns_Item(self: *const T, Index: i32, Column: **Column) callconv(.Inline) HRESULT {
            return @ptrCast(*const Columns.VTable, self.vtable).Item(@ptrCast(*const Columns, self), Index, Column);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const Views = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Views_Item(self: *const T, Index: i32, View: **View) callconv(.Inline) HRESULT {
            return @ptrCast(*const Views.VTable, self.vtable).Item(@ptrCast(*const Views, self), Index, View);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Views_Add(self: *const T, Node: *Node, viewOptions: _ViewOptions) callconv(.Inline) HRESULT {
            return @ptrCast(*const Views.VTable, self.vtable).Add(@ptrCast(*const Views, self), Node, viewOptions);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const View = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IDispatch.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_get_ActiveScopeNode(self: *const T, Node: **Node) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).get_ActiveScopeNode(@ptrCast(*const View, self), Node);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_put_ActiveScopeNode(self: *const T, Node: *Node) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).put_ActiveScopeNode(@ptrCast(*const View, self), Node);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_get_Selection(self: *const T, Nodes: **Nodes) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).get_Selection(@ptrCast(*const View, self), Nodes);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_get_ListItems(self: *const T, Nodes: **Nodes) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).get_ListItems(@ptrCast(*const View, self), Nodes);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_Is(self: *const T, View: *View, TheSame: *i16) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).Is(@ptrCast(*const View, self), View, TheSame);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_get_Document(self: *const T, Document: **Document) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).get_Document(@ptrCast(*const View, self), Document);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_Select(self: *const T, Node: *Node) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).Select(@ptrCast(*const View, self), Node);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_Deselect(self: *const T, Node: *Node) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).Deselect(@ptrCast(*const View, self), Node);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_IsSelected(self: *const T, Node: *Node, IsSelected: *BOOL) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).IsSelected(@ptrCast(*const View, self), Node, IsSelected);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_get_ScopeNodeContextMenu(self: *const T, ScopeNode: VARIANT, ContextMenu: **ContextMenu) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).get_ScopeNodeContextMenu(@ptrCast(*const View, self), ScopeNode, ContextMenu);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_get_SelectionContextMenu(self: *const T, ContextMenu: **ContextMenu) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).get_SelectionContextMenu(@ptrCast(*const View, self), ContextMenu);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_get_Frame(self: *const T, Frame: **Frame) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).get_Frame(@ptrCast(*const View, self), Frame);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_get_Columns(self: *const T, Columns: **Columns) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).get_Columns(@ptrCast(*const View, self), Columns);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn View_get_CellContents(self: *const T, Node: *Node, Column: i32, CellContents: **u16) callconv(.Inline) HRESULT {
            return @ptrCast(*const View.VTable, self.vtable).get_CellContents(@ptrCast(*const View, self), Node, Column, CellContents);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const Nodes = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Nodes_Item(self: *const T, Index: i32, Node: **Node) callconv(.Inline) HRESULT {
            return @ptrCast(*const Nodes.VTable, self.vtable).Item(@ptrCast(*const Nodes, self), Index, Node);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const ContextMenu = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ContextMenu_get_Item(self: *const T, IndexOrPath: VARIANT, MenuItem: **MenuItem) callconv(.Inline) HRESULT {
            return @ptrCast(*const ContextMenu.VTable, self.vtable).get_Item(@ptrCast(*const ContextMenu, self), IndexOrPath, MenuItem);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const Properties = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn Properties_Item(self: *const T, Name: BSTR, Property: **Property) callconv(.Inline) HRESULT {
            return @ptrCast(*const Properties.VTable, self.vtable).Item(@ptrCast(*const Properties, self), Name, Property);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const MMC_SINGLESEL = MMC_RESULT_VIEW_STYLE.MMC_SINGLESEL;
pub const MMC_SHOWSELALWAYS = MMC_RESULT_VIEW_STYLE.MMC_SHOWSELALWAYS;
pub const MMC_NOSORTHEADER = MMC_RESULT_VIEW_STYLE.MMC_NOSORTHEADER;
pub const MMC_ENSUREFOCUSVISIBLE = MMC_RESULT_VIEW_STYLE.MMC_ENSUREFOCUSVISIBLE;
...
pub const MMC_VERB_NONE = MMC_CONSOLE_VERB.MMC_VERB_NONE;
pub const MMC_VERB_OPEN = MMC_CONSOLE_VERB.MMC_VERB_OPEN;
pub const MMC_VERB_COPY = MMC_CONSOLE_VERB.MMC_VERB_COPY;
pub const MMC_VERB_PASTE = MMC_CONSOLE_VERB.MMC_VERB_PASTE;
pub const MMC_VERB_DELETE = MMC_CONSOLE_VERB.MMC_VERB_DELETE;
pub const MMC_VERB_PROPERTIES = MMC_CONSOLE_VERB.MMC_VERB_PROPERTIES;
pub const MMC_VERB_RENAME = MMC_CONSOLE_VERB.MMC_VERB_RENAME;
pub const MMC_VERB_REFRESH = MMC_CONSOLE_VERB.MMC_VERB_REFRESH;
pub const MMC_VERB_PRINT = MMC_CONSOLE_VERB.MMC_VERB_PRINT;
pub const MMC_VERB_CUT = MMC_CONSOLE_VERB.MMC_VERB_CUT;
pub const MMC_VERB_MAX = MMC_CONSOLE_VERB.MMC_VERB_MAX;
pub const MMC_VERB_FIRST = MMC_CONSOLE_VERB.MMC_VERB_FIRST;
pub const MMC_VERB_LAST = MMC_CONSOLE_VERB.MMC_VERB_LAST;
...
pub const MMCC_STANDARD_VIEW_SELECT = MMC_MENU_COMMAND_IDS.MMCC_STANDARD_VIEW_SELECT;
...
pub const MMC_STRING_FILTER = MMC_FILTER_TYPE.MMC_STRING_FILTER;
pub const MMC_INT_FILTER = MMC_FILTER_TYPE.MMC_INT_FILTER;
pub const MMC_FILTER_NOVALUE = MMC_FILTER_TYPE.MMC_FILTER_NOVALUE;
...
pub const MFCC_DISABLE = MMC_FILTER_CHANGE_CODE.MFCC_DISABLE;
pub const MFCC_ENABLE = MMC_FILTER_CHANGE_CODE.MFCC_ENABLE;
pub const MFCC_VALUE_CHANGE = MMC_FILTER_CHANGE_CODE.MFCC_VALUE_CHANGE;
...
pub const MMCN_ACTIVATE = MMC_NOTIFY_TYPE.MMCN_ACTIVATE;
pub const MMCN_ADD_IMAGES = MMC_NOTIFY_TYPE.MMCN_ADD_IMAGES;
pub const MMCN_BTN_CLICK = MMC_NOTIFY_TYPE.MMCN_BTN_CLICK;
pub const MMCN_CLICK = MMC_NOTIFY_TYPE.MMCN_CLICK;
pub const MMCN_COLUMN_CLICK = MMC_NOTIFY_TYPE.MMCN_COLUMN_CLICK;
pub const MMCN_CONTEXTMENU = MMC_NOTIFY_TYPE.MMCN_CONTEXTMENU;
pub const MMCN_CUTORMOVE = MMC_NOTIFY_TYPE.MMCN_CUTORMOVE;
pub const MMCN_DBLCLICK = MMC_NOTIFY_TYPE.MMCN_DBLCLICK;
pub const MMCN_DELETE = MMC_NOTIFY_TYPE.MMCN_DELETE;
pub const MMCN_DESELECT_ALL = MMC_NOTIFY_TYPE.MMCN_DESELECT_ALL;
pub const MMCN_EXPAND = MMC_NOTIFY_TYPE.MMCN_EXPAND;
pub const MMCN_HELP = MMC_NOTIFY_TYPE.MMCN_HELP;
pub const MMCN_MENU_BTNCLICK = MMC_NOTIFY_TYPE.MMCN_MENU_BTNCLICK;
pub const MMCN_MINIMIZED = MMC_NOTIFY_TYPE.MMCN_MINIMIZED;
pub const MMCN_PASTE = MMC_NOTIFY_TYPE.MMCN_PASTE;
pub const MMCN_PROPERTY_CHANGE = MMC_NOTIFY_TYPE.MMCN_PROPERTY_CHANGE;
pub const MMCN_QUERY_PASTE = MMC_NOTIFY_TYPE.MMCN_QUERY_PASTE;
pub const MMCN_REFRESH = MMC_NOTIFY_TYPE.MMCN_REFRESH;
pub const MMCN_REMOVE_CHILDREN = MMC_NOTIFY_TYPE.MMCN_REMOVE_CHILDREN;
pub const MMCN_RENAME = MMC_NOTIFY_TYPE.MMCN_RENAME;
pub const MMCN_SELECT = MMC_NOTIFY_TYPE.MMCN_SELECT;
pub const MMCN_SHOW = MMC_NOTIFY_TYPE.MMCN_SHOW;
pub const MMCN_VIEW_CHANGE = MMC_NOTIFY_TYPE.MMCN_VIEW_CHANGE;
pub const MMCN_SNAPINHELP = MMC_NOTIFY_TYPE.MMCN_SNAPINHELP;
pub const MMCN_CONTEXTHELP = MMC_NOTIFY_TYPE.MMCN_CONTEXTHELP;
pub const MMCN_INITOCX = MMC_NOTIFY_TYPE.MMCN_INITOCX;
pub const MMCN_FILTER_CHANGE = MMC_NOTIFY_TYPE.MMCN_FILTER_CHANGE;
pub const MMCN_FILTERBTN_CLICK = MMC_NOTIFY_TYPE.MMCN_FILTERBTN_CLICK;
pub const MMCN_RESTORE_VIEW = MMC_NOTIFY_TYPE.MMCN_RESTORE_VIEW;
pub const MMCN_PRINT = MMC_NOTIFY_TYPE.MMCN_PRINT;
pub const MMCN_PRELOAD = MMC_NOTIFY_TYPE.MMCN_PRELOAD;
pub const MMCN_LISTPAD = MMC_NOTIFY_TYPE.MMCN_LISTPAD;
pub const MMCN_EXPANDSYNC = MMC_NOTIFY_TYPE.MMCN_EXPANDSYNC;
pub const MMCN_COLUMNS_CHANGED = MMC_NOTIFY_TYPE.MMCN_COLUMNS_CHANGED;
pub const MMCN_CANPASTE_OUTOFPROC = MMC_NOTIFY_TYPE.MMCN_CANPASTE_OUTOFPROC;
...
pub const CCT_SCOPE = DATA_OBJECT_TYPES.CCT_SCOPE;
pub const CCT_RESULT = DATA_OBJECT_TYPES.CCT_RESULT;
pub const CCT_SNAPIN_MANAGER = DATA_OBJECT_TYPES.CCT_SNAPIN_MANAGER;
pub const CCT_UNINITIALIZED = DATA_OBJECT_TYPES.CCT_UNINITIALIZED;
...
pub const IComponentData = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComponentData_QueryDataObject(self: *const T, cookie: ?*c_void, type: DATA_OBJECT_TYPES, ppDataObject: **IDataObject) callconv(.Inline) HRESULT {
...
pub const IComponent = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComponent_Destroy(self: *const T, cookie: ?*c_void) callconv(.Inline) HRESULT {
            return @ptrCast(*const IComponent.VTable, self.vtable).Destroy(@ptrCast(*const IComponent, self), cookie);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComponent_QueryDataObject(self: *const T, cookie: ?*c_void, type: DATA_OBJECT_TYPES, ppDataObject: **IDataObject) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComponent_GetResultViewType(self: *const T, cookie: ?*c_void, ppViewType: *PWSTR, pViewOptions: *i32) callconv(.Inline) HRESULT {
...
pub const IResultDataCompare = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IResultDataCompare_Compare(self: *const T, lUserParam: LPARAM, cookieA: ?*c_void, cookieB: ?*c_void, pnResult: *i32) callconv(.Inline) HRESULT {
...
pub const IConsole = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsole_UpdateAllViews(self: *const T, lpDataObject: *IDataObject, data: LPARAM, hint: ?*c_void) callconv(.Inline) HRESULT {
            return @ptrCast(*const IConsole.VTable, self.vtable).UpdateAllViews(@ptrCast(*const IConsole, self), lpDataObject, data, hint);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsole_MessageBoxA(self: *const T, lpszText: [*:0]const u16, lpszTitle: [*:0]const u16, fuStyle: u32, piRetval: *i32) callconv(.Inline) HRESULT {
            return @ptrCast(*const IConsole.VTable, self.vtable).MessageBoxA(@ptrCast(*const IConsole, self), lpszText, lpszTitle, fuStyle, piRetval);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsole_SelectScopeItem(self: *const T, hScopeItem: ?*c_void) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsole_NewWindow(self: *const T, hScopeItem: ?*c_void, lOptions: u32) callconv(.Inline) HRESULT {
...
pub const __MIDL___MIDL_itf_mmc_0000_0006_0001 = extern enum(i32) {
...
pub const CCM_INSERTIONPOINTID_MASK_SPECIAL = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_MASK_SPECIAL;
pub const CCM_INSERTIONPOINTID_MASK_SHARED = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_MASK_SHARED;
pub const CCM_INSERTIONPOINTID_MASK_CREATE_PRIMARY = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_MASK_CREATE_PRIMARY;
pub const CCM_INSERTIONPOINTID_MASK_ADD_PRIMARY = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_MASK_ADD_PRIMARY;
pub const CCM_INSERTIONPOINTID_MASK_ADD_3RDPARTY = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_MASK_ADD_3RDPARTY;
pub const CCM_INSERTIONPOINTID_MASK_RESERVED = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_MASK_RESERVED;
pub const CCM_INSERTIONPOINTID_MASK_FLAGINDEX = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_MASK_FLAGINDEX;
pub const CCM_INSERTIONPOINTID_PRIMARY_TOP = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_PRIMARY_TOP;
pub const CCM_INSERTIONPOINTID_PRIMARY_NEW = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_PRIMARY_NEW;
pub const CCM_INSERTIONPOINTID_PRIMARY_TASK = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_PRIMARY_TASK;
pub const CCM_INSERTIONPOINTID_PRIMARY_VIEW = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_PRIMARY_VIEW;
pub const CCM_INSERTIONPOINTID_PRIMARY_HELP = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_PRIMARY_HELP;
pub const CCM_INSERTIONPOINTID_3RDPARTY_NEW = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_3RDPARTY_NEW;
pub const CCM_INSERTIONPOINTID_3RDPARTY_TASK = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_3RDPARTY_TASK;
pub const CCM_INSERTIONPOINTID_ROOT_MENU = __MIDL___MIDL_itf_mmc_0000_0006_0001.CCM_INSERTIONPOINTID_ROOT_MENU;

pub const __MIDL___MIDL_itf_mmc_0000_0006_0002 = extern enum(i32) {
    CCM_INSERTIONALLOWED_TOP = 1,
    CCM_INSERTIONALLOWED_NEW = 2,
    CCM_INSERTIONALLOWED_TASK = 4,
    CCM_INSERTIONALLOWED_VIEW = 8,
};
pub const CCM_INSERTIONALLOWED_TOP = __MIDL___MIDL_itf_mmc_0000_0006_0002.CCM_INSERTIONALLOWED_TOP;
pub const CCM_INSERTIONALLOWED_NEW = __MIDL___MIDL_itf_mmc_0000_0006_0002.CCM_INSERTIONALLOWED_NEW;
pub const CCM_INSERTIONALLOWED_TASK = __MIDL___MIDL_itf_mmc_0000_0006_0002.CCM_INSERTIONALLOWED_TASK;
pub const CCM_INSERTIONALLOWED_VIEW = __MIDL___MIDL_itf_mmc_0000_0006_0002.CCM_INSERTIONALLOWED_VIEW;

pub const __MIDL___MIDL_itf_mmc_0000_0006_0003 = extern enum(i32) {
    CCM_COMMANDID_MASK_RESERVED = -65536,
};
pub const CCM_COMMANDID_MASK_RESERVED = __MIDL___MIDL_itf_mmc_0000_0006_0003.CCM_COMMANDID_MASK_RESERVED;

pub const __MIDL___MIDL_itf_mmc_0000_0006_0004 = extern enum(i32) {
...
pub const CCM_SPECIAL_SEPARATOR = __MIDL___MIDL_itf_mmc_0000_0006_0004.CCM_SPECIAL_SEPARATOR;
pub const CCM_SPECIAL_SUBMENU = __MIDL___MIDL_itf_mmc_0000_0006_0004.CCM_SPECIAL_SUBMENU;
pub const CCM_SPECIAL_DEFAULT_ITEM = __MIDL___MIDL_itf_mmc_0000_0006_0004.CCM_SPECIAL_DEFAULT_ITEM;
pub const CCM_SPECIAL_INSERTION_POINT = __MIDL___MIDL_itf_mmc_0000_0006_0004.CCM_SPECIAL_INSERTION_POINT;
pub const CCM_SPECIAL_TESTONLY = __MIDL___MIDL_itf_mmc_0000_0006_0004.CCM_SPECIAL_TESTONLY;
...
pub const IImageList = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IImageList_ImageListSetIcon(self: *const T, pIcon: *?*c_void, nLoc: i32) callconv(.Inline) HRESULT {
            return @ptrCast(*const IImageList.VTable, self.vtable).ImageListSetIcon(@ptrCast(*const IImageList, self), pIcon, nLoc);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IImageList_ImageListSetStrip(self: *const T, pBMapSm: *?*c_void, pBMapLg: *?*c_void, nStartLoc: i32, cMask: u32) callconv(.Inline) HRESULT {
...
pub const IResultData = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IResultData_DeleteItem(self: *const T, itemID: ?*c_void, nCol: i32) callconv(.Inline) HRESULT {
            return @ptrCast(*const IResultData.VTable, self.vtable).DeleteItem(@ptrCast(*const IResultData, self), itemID, nCol);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IResultData_FindItemByLParam(self: *const T, lParam: LPARAM, pItemID: *?*c_void) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IResultData_ModifyItemState(self: *const T, nIndex: i32, itemID: ?*c_void, uAdd: u32, uRemove: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IResultData_UpdateItem(self: *const T, itemID: ?*c_void) callconv(.Inline) HRESULT {
...
pub const IConsoleNameSpace = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsoleNameSpace_DeleteItem(self: *const T, hItem: ?*c_void, fDeleteThis: i32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsoleNameSpace_GetChildItem(self: *const T, item: ?*c_void, pItemChild: *?*c_void, pCookie: *?*c_void) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsoleNameSpace_GetNextItem(self: *const T, item: ?*c_void, pItemNext: *?*c_void, pCookie: *?*c_void) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsoleNameSpace_GetParentItem(self: *const T, item: ?*c_void, pItemParent: *?*c_void, pCookie: *?*c_void) callconv(.Inline) HRESULT {
...
pub const IConsoleNameSpace2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsoleNameSpace2_Expand(self: *const T, hItem: ?*c_void) callconv(.Inline) HRESULT {
            return @ptrCast(*const IConsoleNameSpace2.VTable, self.vtable).Expand(@ptrCast(*const IConsoleNameSpace2, self), hItem);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsoleNameSpace2_AddExtension(self: *const T, hItem: ?*c_void, lpClsid: *Guid) callconv(.Inline) HRESULT {
...
pub const IPropertySheetProvider = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPropertySheetProvider_CreatePropertySheet(self: *const T, title: [*:0]const u16, type: u8, cookie: ?*c_void, pIDataObjectm: *IDataObject, dwOptions: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPropertySheetProvider_FindPropertySheet(self: *const T, hItem: ?*c_void, lpComponent: *IComponent, lpDataObject: *IDataObject) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IPropertySheetProvider_Show(self: *const T, window: ?*c_void, page: i32) callconv(.Inline) HRESULT {
...
pub const IExtendPropertySheet = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IExtendPropertySheet_CreatePropertyPages(self: *const T, lpProvider: *IPropertySheetCallback, handle: ?*c_void, lpIDataObject: *IDataObject) callconv(.Inline) HRESULT {
...
pub const MMC_TASK_DISPLAY_UNINITIALIZED = MMC_TASK_DISPLAY_TYPE.MMC_TASK_DISPLAY_UNINITIALIZED;
pub const MMC_TASK_DISPLAY_TYPE_SYMBOL = MMC_TASK_DISPLAY_TYPE.SYMBOL;
pub const MMC_TASK_DISPLAY_TYPE_VANILLA_GIF = MMC_TASK_DISPLAY_TYPE.VANILLA_GIF;
pub const MMC_TASK_DISPLAY_TYPE_CHOCOLATE_GIF = MMC_TASK_DISPLAY_TYPE.CHOCOLATE_GIF;
pub const MMC_TASK_DISPLAY_TYPE_BITMAP = MMC_TASK_DISPLAY_TYPE.BITMAP;
...
pub const MMC_ACTION_UNINITIALIZED = MMC_ACTION_TYPE.MMC_ACTION_UNINITIALIZED;
pub const MMC_ACTION_ID = MMC_ACTION_TYPE.MMC_ACTION_ID;
pub const MMC_ACTION_LINK = MMC_ACTION_TYPE.MMC_ACTION_LINK;
pub const MMC_ACTION_SCRIPT = MMC_ACTION_TYPE.MMC_ACTION_SCRIPT;
...
pub const IConsole2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsole2_Expand(self: *const T, hItem: ?*c_void, bExpand: BOOL) callconv(.Inline) HRESULT {
...
pub const Icon_None = IconIdentifier.Icon_None;
pub const Icon_Error = IconIdentifier.Icon_Error;
pub const Icon_Question = IconIdentifier.Icon_Question;
pub const Icon_Warning = IconIdentifier.Icon_Warning;
pub const Icon_Information = IconIdentifier.Icon_Information;
pub const Icon_First = IconIdentifier.Icon_First;
pub const Icon_Last = IconIdentifier.Icon_Last;
...
pub const IComponentData2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComponentData2_QueryDispatch(self: *const T, cookie: ?*c_void, type: DATA_OBJECT_TYPES, ppDispatch: **IDispatch) callconv(.Inline) HRESULT {
...
pub const IComponent2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComponent2_QueryDispatch(self: *const T, cookie: ?*c_void, type: DATA_OBJECT_TYPES, ppDispatch: **IDispatch) callconv(.Inline) HRESULT {
            return @ptrCast(*const IComponent2.VTable, self.vtable).QueryDispatch(@ptrCast(*const IComponent2, self), cookie, type, ppDispatch);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComponent2_GetResultViewType2(self: *const T, cookie: ?*c_void, pResultViewType: *RESULT_VIEW_TYPE_INFO) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IComponent2_RestoreResultView(self: *const T, cookie: ?*c_void, pResultViewType: *RESULT_VIEW_TYPE_INFO) callconv(.Inline) HRESULT {
...
pub const IConsole3 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IConsole3_RenameScopeItem(self: *const T, hScopeItem: ?*c_void) callconv(.Inline) HRESULT {
...
pub const IResultData2 = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IResultData2_RenameResultItem(self: *const T, itemID: ?*c_void) callconv(.Inline) HRESULT {
...
const _ColumnSortOrder = @import("legacy_windows_environment_features.zig")._ColumnSortOrder;
