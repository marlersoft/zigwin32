...
pub const aunlNotConfigured = AutomaticUpdatesNotificationLevel.aunlNotConfigured;
pub const aunlDisabled = AutomaticUpdatesNotificationLevel.aunlDisabled;
pub const aunlNotifyBeforeDownload = AutomaticUpdatesNotificationLevel.aunlNotifyBeforeDownload;
pub const aunlNotifyBeforeInstallation = AutomaticUpdatesNotificationLevel.aunlNotifyBeforeInstallation;
pub const aunlScheduledInstallation = AutomaticUpdatesNotificationLevel.aunlScheduledInstallation;
...
pub const ausidEveryDay = AutomaticUpdatesScheduledInstallationDay.ausidEveryDay;
pub const ausidEverySunday = AutomaticUpdatesScheduledInstallationDay.ausidEverySunday;
pub const ausidEveryMonday = AutomaticUpdatesScheduledInstallationDay.ausidEveryMonday;
pub const ausidEveryTuesday = AutomaticUpdatesScheduledInstallationDay.ausidEveryTuesday;
pub const ausidEveryWednesday = AutomaticUpdatesScheduledInstallationDay.ausidEveryWednesday;
pub const ausidEveryThursday = AutomaticUpdatesScheduledInstallationDay.ausidEveryThursday;
pub const ausidEveryFriday = AutomaticUpdatesScheduledInstallationDay.ausidEveryFriday;
pub const ausidEverySaturday = AutomaticUpdatesScheduledInstallationDay.ausidEverySaturday;
...
pub const dphInitializing = DownloadPhase.dphInitializing;
pub const dphDownloading = DownloadPhase.dphDownloading;
pub const dphVerifying = DownloadPhase.dphVerifying;
...
pub const dpLow = DownloadPriority.dpLow;
pub const dpNormal = DownloadPriority.dpNormal;
pub const dpHigh = DownloadPriority.dpHigh;
pub const dpExtraHigh = DownloadPriority.dpExtraHigh;
...
pub const asLetWindowsUpdateDecide = AutoSelectionMode.asLetWindowsUpdateDecide;
pub const asAutoSelectIfDownloaded = AutoSelectionMode.asAutoSelectIfDownloaded;
pub const asNeverAutoSelect = AutoSelectionMode.asNeverAutoSelect;
pub const asAlwaysAutoSelect = AutoSelectionMode.asAlwaysAutoSelect;
...
pub const adLetWindowsUpdateDecide = AutoDownloadMode.adLetWindowsUpdateDecide;
pub const adNeverAutoDownload = AutoDownloadMode.adNeverAutoDownload;
pub const adAlwaysAutoDownload = AutoDownloadMode.adAlwaysAutoDownload;
...
pub const iiNormal = InstallationImpact.iiNormal;
pub const iiMinor = InstallationImpact.iiMinor;
pub const iiRequiresExclusiveHandling = InstallationImpact.iiRequiresExclusiveHandling;
...
pub const irbNeverReboots = InstallationRebootBehavior.irbNeverReboots;
pub const irbAlwaysRequiresReboot = InstallationRebootBehavior.irbAlwaysRequiresReboot;
pub const irbCanRequestReboot = InstallationRebootBehavior.irbCanRequestReboot;
...
pub const orcNotStarted = OperationResultCode.orcNotStarted;
pub const orcInProgress = OperationResultCode.orcInProgress;
pub const orcSucceeded = OperationResultCode.orcSucceeded;
pub const orcSucceededWithErrors = OperationResultCode.orcSucceededWithErrors;
pub const orcFailed = OperationResultCode.orcFailed;
pub const orcAborted = OperationResultCode.orcAborted;
...
pub const ssDefault = ServerSelection.ssDefault;
pub const ssManagedServer = ServerSelection.ssManagedServer;
pub const ssWindowsUpdate = ServerSelection.ssWindowsUpdate;
pub const ssOthers = ServerSelection.ssOthers;

pub const UpdateType = extern enum(i32) {
    utSoftware = 1,
    utDriver = 2,
};
pub const utSoftware = UpdateType.utSoftware;
pub const utDriver = UpdateType.utDriver;

pub const UpdateOperation = extern enum(i32) {
    uoInstallation = 1,
    uoUninstallation = 2,
};
pub const uoInstallation = UpdateOperation.uoInstallation;
pub const uoUninstallation = UpdateOperation.uoUninstallation;
...
pub const daNone = DeploymentAction.daNone;
pub const daInstallation = DeploymentAction.daInstallation;
pub const daUninstallation = DeploymentAction.daUninstallation;
pub const daDetection = DeploymentAction.daDetection;
pub const daOptionalInstallation = DeploymentAction.daOptionalInstallation;
...
pub const uecGeneral = UpdateExceptionContext.uecGeneral;
pub const uecWindowsDriver = UpdateExceptionContext.uecWindowsDriver;
pub const uecWindowsInstaller = UpdateExceptionContext.uecWindowsInstaller;
pub const uecSearchIncomplete = UpdateExceptionContext.uecSearchIncomplete;

pub const AutomaticUpdatesUserType = extern enum(i32) {
    auutCurrentUser = 1,
    auutLocalAdministrator = 2,
};
pub const auutCurrentUser = AutomaticUpdatesUserType.auutCurrentUser;
pub const auutLocalAdministrator = AutomaticUpdatesUserType.auutLocalAdministrator;
...
pub const auptSetNotificationLevel = AutomaticUpdatesPermissionType.auptSetNotificationLevel;
pub const auptDisableAutomaticUpdates = AutomaticUpdatesPermissionType.auptDisableAutomaticUpdates;
pub const auptSetIncludeRecommendedUpdates = AutomaticUpdatesPermissionType.auptSetIncludeRecommendedUpdates;
pub const auptSetFeaturedUpdatesEnabled = AutomaticUpdatesPermissionType.auptSetFeaturedUpdatesEnabled;
pub const auptSetNonAdministratorsElevated = AutomaticUpdatesPermissionType.auptSetNonAdministratorsElevated;
...
pub const usrsNotRegistered = UpdateServiceRegistrationState.usrsNotRegistered;
pub const usrsRegistrationPending = UpdateServiceRegistrationState.usrsRegistrationPending;
pub const usrsRegistered = UpdateServiceRegistrationState.usrsRegistered;
...
pub const searchScopeDefault = SearchScope.searchScopeDefault;
pub const searchScopeMachineOnly = SearchScope.searchScopeMachineOnly;
pub const searchScopeCurrentUserOnly = SearchScope.searchScopeCurrentUserOnly;
pub const searchScopeMachineAndCurrentUser = SearchScope.searchScopeMachineAndCurrentUser;
pub const searchScopeMachineAndAllUsers = SearchScope.searchScopeMachineAndAllUsers;
pub const searchScopeAllUsers = SearchScope.searchScopeAllUsers;
...
pub const uloForWebsiteAccess = UpdateLockdownOption.uloForWebsiteAccess;
...
pub const asfAllowPendingRegistration = AddServiceFlag.asfAllowPendingRegistration;
pub const asfAllowOnlineRegistration = AddServiceFlag.asfAllowOnlineRegistration;
pub const asfRegisterServiceWithAU = AddServiceFlag.asfRegisterServiceWithAU;

pub const UpdateServiceOption = extern enum(i32) {
    usoNonVolatileService = 1,
};
pub const usoNonVolatileService = UpdateServiceOption.usoNonVolatileService;
...
test {
    ...
    const com_iface_id_export_count = 76;
