...
pub const MBN_RSSI_DEFAULT = MBN_SIGNAL_CONSTANTS.MBN_RSSI_DEFAULT;
pub const MBN_RSSI_DISABLE = MBN_SIGNAL_CONSTANTS.MBN_RSSI_DISABLE;
pub const MBN_RSSI_UNKNOWN = MBN_SIGNAL_CONSTANTS.MBN_RSSI_UNKNOWN;
pub const MBN_ERROR_RATE_UNKNOWN = MBN_SIGNAL_CONSTANTS.MBN_ERROR_RATE_UNKNOWN;

pub const MBN_CELLULAR_CLASS = extern enum(i32) {
    NONE = 0,
    GSM = 1,
    CDMA = 2,
};
...
pub const MBN_VOICE_CLASS = extern enum(i32) {
    NONE = 0,
    NO_VOICE = 1,
...
pub const MBN_PROVIDER_STATE = extern enum(i32) {
    NONE = 0,
    HOME = 1,
    FORBIDDEN = 2,
    PREFERRED = 4,
...
pub const MBN_PROVIDER_CONSTANTS = extern enum(i32) {
    MBN_PROVIDERNAME_LEN = 20,
    MBN_PROVIDERID_LEN = 6,
};
pub const MBN_PROVIDERNAME_LEN = MBN_PROVIDER_CONSTANTS.MBN_PROVIDERNAME_LEN;
pub const MBN_PROVIDERID_LEN = MBN_PROVIDER_CONSTANTS.MBN_PROVIDERID_LEN;

pub const MBN_INTERFACE_CAPS_CONSTANTS = extern enum(i32) {
    MBN_DEVICEID_LEN = 18,
    MBN_MANUFACTURER_LEN = 32,
    MBN_MODEL_LEN = 32,
    MBN_FIRMWARE_LEN = 32,
};
pub const MBN_DEVICEID_LEN = MBN_INTERFACE_CAPS_CONSTANTS.MBN_DEVICEID_LEN;
pub const MBN_MANUFACTURER_LEN = MBN_INTERFACE_CAPS_CONSTANTS.MBN_MANUFACTURER_LEN;
pub const MBN_MODEL_LEN = MBN_INTERFACE_CAPS_CONSTANTS.MBN_MODEL_LEN;
pub const MBN_FIRMWARE_LEN = MBN_INTERFACE_CAPS_CONSTANTS.MBN_FIRMWARE_LEN;

pub const MBN_DATA_CLASS = extern enum(i32) {
    NONE = 0,
    GPRS = 1,
    EDGE = 2,
    UMTS = 4,
...
pub const MBN_DATA_CLASS_5G_NSA = MBN_DATA_CLASS._5G_NSA;
pub const MBN_DATA_CLASS_5G_SA = MBN_DATA_CLASS._5G_SA;
pub const MBN_DATA_CLASS_1XRTT = MBN_DATA_CLASS._1XRTT;
pub const MBN_DATA_CLASS_1XEVDO = MBN_DATA_CLASS._1XEVDO;
pub const MBN_DATA_CLASS_1XEVDO_REVA = MBN_DATA_CLASS._1XEVDO_REVA;
pub const MBN_DATA_CLASS_1XEVDV = MBN_DATA_CLASS._1XEVDV;
pub const MBN_DATA_CLASS_3XRTT = MBN_DATA_CLASS._3XRTT;
pub const MBN_DATA_CLASS_1XEVDO_REVB = MBN_DATA_CLASS._1XEVDO_REVB;
pub const MBN_DATA_CLASS_UMB = MBN_DATA_CLASS.UMB;
pub const MBN_DATA_CLASS_CUSTOM = MBN_DATA_CLASS.CUSTOM;

pub const MBN_CTRL_CAPS = extern enum(i32) {
    NONE = 0,
    REG_MANUAL = 1,
    HW_RADIO_SWITCH = 2,
    CDMA_MOBILE_IP = 4,
...
pub const MBN_SMS_CAPS = extern enum(i32) {
    NONE = 0,
    PDU_RECEIVE = 1,
    PDU_SEND = 2,
    TEXT_RECEIVE = 4,
...
pub const MBN_BAND_CLASS = extern enum(i32) {
    NONE = 0,
    _0 = 1,
    I = 2,
    II = 4,
...
pub const MBN_BAND_CLASS_0 = MBN_BAND_CLASS._0;
...
pub const MBN_READY_STATE = extern enum(i32) {
    OFF = 0,
    INITIALIZED = 1,
    SIM_NOT_INSERTED = 2,
    BAD_SIM = 3,
...
pub const MBN_ACTIVATION_STATE = extern enum(i32) {
    NONE = 0,
    ACTIVATED = 1,
    ACTIVATING = 2,
    DEACTIVATED = 3,
...
pub const MBN_CONNECTION_MODE = extern enum(i32) {
    PROFILE = 0,
    TMP_PROFILE = 1,
};
...
pub const MBN_VOICE_CALL_STATE = extern enum(i32) {
    NONE = 0,
    IN_PROGRESS = 1,
    HANGUP = 2,
};
...
pub const MBN_REGISTRATION_CONSTANTS = extern enum(i32) {
    MBN_ROAMTEXT_LEN = 64,
    MBN_CDMA_DEFAULT_PROVIDER_ID = 0,
};
pub const MBN_ROAMTEXT_LEN = MBN_REGISTRATION_CONSTANTS.MBN_ROAMTEXT_LEN;
pub const MBN_CDMA_DEFAULT_PROVIDER_ID = MBN_REGISTRATION_CONSTANTS.MBN_CDMA_DEFAULT_PROVIDER_ID;

pub const MBN_REGISTER_STATE = extern enum(i32) {
    NONE = 0,
    DEREGISTERED = 1,
    SEARCHING = 2,
    HOME = 3,
...
pub const MBN_REGISTER_MODE = extern enum(i32) {
    NONE = 0,
    AUTOMATIC = 1,
    MANUAL = 2,
};
...
pub const MBN_PIN_CONSTANTS = extern enum(i32) {
    MBN_ATTEMPTS_REMAINING_UNKNOWN = -1,
    MBN_PIN_LENGTH_UNKNOWN = -1,
};
pub const MBN_ATTEMPTS_REMAINING_UNKNOWN = MBN_PIN_CONSTANTS.MBN_ATTEMPTS_REMAINING_UNKNOWN;
pub const MBN_PIN_LENGTH_UNKNOWN = MBN_PIN_CONSTANTS.MBN_PIN_LENGTH_UNKNOWN;

pub const MBN_PIN_STATE = extern enum(i32) {
    NONE = 0,
    ENTER = 1,
    UNBLOCK = 2,
};
...
pub const MBN_PIN_TYPE = extern enum(i32) {
    NONE = 0,
    CUSTOM = 1,
    PIN1 = 2,
    PIN2 = 3,
...
pub const MBN_PIN_MODE = extern enum(i32) {
    ENABLED = 1,
    DISABLED = 2,
};
...
pub const MBN_PIN_FORMAT = extern enum(i32) {
    NONE = 0,
    NUMERIC = 1,
    ALPHANUMERIC = 2,
};
...
pub const MBN_CONTEXT_CONSTANTS = extern enum(i32) {
    MBN_ACCESSSTRING_LEN = 100,
    MBN_USERNAME_LEN = 255,
    MBN_PASSWORD_LEN = 255,
    MBN_CONTEXT_ID_APPEND = -1,
};
pub const MBN_ACCESSSTRING_LEN = MBN_CONTEXT_CONSTANTS.MBN_ACCESSSTRING_LEN;
pub const MBN_USERNAME_LEN = MBN_CONTEXT_CONSTANTS.MBN_USERNAME_LEN;
pub const MBN_PASSWORD_LEN = MBN_CONTEXT_CONSTANTS.MBN_PASSWORD_LEN;
pub const MBN_CONTEXT_ID_APPEND = MBN_CONTEXT_CONSTANTS.MBN_CONTEXT_ID_APPEND;

pub const MBN_AUTH_PROTOCOL = extern enum(i32) {
    NONE = 0,
    PAP = 1,
    CHAP = 2,
    MSCHAPV2 = 3,
...
pub const MBN_COMPRESSION = extern enum(i32) {
    NONE = 0,
    ENABLE = 1,
};
...
pub const MBN_CONTEXT_TYPE = extern enum(i32) {
    NONE = 0,
    INTERNET = 1,
    VPN = 2,
    VOICE = 3,
...
pub const WWAEXT_SMS_CONSTANTS = extern enum(i32) {
    MBN_MESSAGE_INDEX_NONE = 0,
    MBN_CDMA_SHORT_MSG_SIZE_UNKNOWN = 0,
    MBN_CDMA_SHORT_MSG_SIZE_MAX = 160,
};
pub const MBN_MESSAGE_INDEX_NONE = WWAEXT_SMS_CONSTANTS.MBN_MESSAGE_INDEX_NONE;
pub const MBN_CDMA_SHORT_MSG_SIZE_UNKNOWN = WWAEXT_SMS_CONSTANTS.MBN_CDMA_SHORT_MSG_SIZE_UNKNOWN;
pub const MBN_CDMA_SHORT_MSG_SIZE_MAX = WWAEXT_SMS_CONSTANTS.MBN_CDMA_SHORT_MSG_SIZE_MAX;

pub const MBN_MSG_STATUS = extern enum(i32) {
    NEW = 0,
    OLD = 1,
    DRAFT = 2,
    SENT = 3,
...
pub const MBN_SMS_CDMA_LANG = extern enum(i32) {
    NONE = 0,
    ENGLISH = 1,
    FRENCH = 2,
    SPANISH = 3,
...
pub const MBN_SMS_CDMA_ENCODING = extern enum(i32) {
    OCTET = 0,
    EPM = 1,
    _7BIT_ASCII = 2,
    IA5 = 3,
...
pub const MBN_SMS_CDMA_ENCODING_7BIT_ASCII = MBN_SMS_CDMA_ENCODING._7BIT_ASCII;
...
pub const MBN_SMS_FLAG = extern enum(i32) {
    ALL = 0,
    INDEX = 1,
    NEW = 2,
    OLD = 3,
...
pub const MBN_SMS_STATUS_FLAG = extern enum(i32) {
    MBN_SMS_FLAG_NONE = 0,
    MBN_SMS_FLAG_MESSAGE_STORE_FULL = 1,
    MBN_SMS_FLAG_NEW_MESSAGE = 2,
};
pub const MBN_SMS_FLAG_NONE = MBN_SMS_STATUS_FLAG.MBN_SMS_FLAG_NONE;
pub const MBN_SMS_FLAG_MESSAGE_STORE_FULL = MBN_SMS_STATUS_FLAG.MBN_SMS_FLAG_MESSAGE_STORE_FULL;
pub const MBN_SMS_FLAG_NEW_MESSAGE = MBN_SMS_STATUS_FLAG.MBN_SMS_FLAG_NEW_MESSAGE;
...
pub const MBN_SMS_FORMAT = extern enum(i32) {
    NONE = 0,
    PDU = 1,
    TEXT = 2,
};
...
pub const MBN_RADIO = extern enum(i32) {
    OFF = 0,
    ON = 1,
};
pub const MBN_RADIO_OFF = MBN_RADIO.OFF;
pub const MBN_RADIO_ON = MBN_RADIO.ON;
...
pub const MBN_DEVICE_SERVICES_INTERFACE_STATE = extern enum(i32) {
    MBN_DEVICE_SERVICES_CAPABLE_INTERFACE_ARRIVAL = 0,
    MBN_DEVICE_SERVICES_CAPABLE_INTERFACE_REMOVAL = 1,
};
pub const MBN_DEVICE_SERVICES_CAPABLE_INTERFACE_ARRIVAL = MBN_DEVICE_SERVICES_INTERFACE_STATE.MBN_DEVICE_SERVICES_CAPABLE_INTERFACE_ARRIVAL;
pub const MBN_DEVICE_SERVICES_CAPABLE_INTERFACE_REMOVAL = MBN_DEVICE_SERVICES_INTERFACE_STATE.MBN_DEVICE_SERVICES_CAPABLE_INTERFACE_REMOVAL;
...
pub const IMbnConnection = extern struct {
    pub const VTable = extern struct {
        ...
        GetVoiceCallState: fn(
            self: *const IMbnConnection,
            voiceCallState: *MBN_VOICE_CALL_STATE,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetActivationNetworkError: fn(
            self: *const IMbnConnection,
            networkError: *u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
...
pub const IMbnConnectionEvents = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        OnConnectComplete: fn(
            self: *const IMbnConnectionEvents,
            newConnection: *IMbnConnection,
            requestID: u32,
            status: HRESULT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnDisconnectComplete: fn(
            self: *const IMbnConnectionEvents,
            newConnection: *IMbnConnection,
            requestID: u32,
            status: HRESULT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnConnectStateChange: fn(
            self: *const IMbnConnectionEvents,
            newConnection: *IMbnConnection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnVoiceCallStateChange: fn(
            self: *const IMbnConnectionEvents,
            newConnection: *IMbnConnection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
...
pub const IMbnInterface = extern struct {
    pub const VTable = extern struct {
        ...
        GetInterfaceCapability: fn(
            self: *const IMbnInterface,
            interfaceCaps: *MBN_INTERFACE_CAPS,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetSubscriberInformation: fn(
            self: *const IMbnInterface,
...
pub const IMbnInterfaceEvents = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        OnInterfaceCapabilityAvailable: fn(
            self: *const IMbnInterfaceEvents,
            newInterface: *IMbnInterface,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnSubscriberInformationChange: fn(
            self: *const IMbnInterfaceEvents,
            newInterface: *IMbnInterface,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        ...
        OnEmergencyModeChange: fn(
            self: *const IMbnInterfaceEvents,
            newInterface: *IMbnInterface,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnHomeProviderAvailable: fn(
            self: *const IMbnInterfaceEvents,
            newInterface: *IMbnInterface,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnPreferredProvidersChange: fn(
            self: *const IMbnInterfaceEvents,
            newInterface: *IMbnInterface,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnSetPreferredProvidersComplete: fn(
            self: *const IMbnInterfaceEvents,
            newInterface: *IMbnInterface,
            requestID: u32,
            status: HRESULT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnScanNetworkComplete: fn(
            self: *const IMbnInterfaceEvents,
            newInterface: *IMbnInterface,
            requestID: u32,
            status: HRESULT,
...
pub const IMbnInterfaceManagerEvents = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        OnInterfaceArrival: fn(
            self: *const IMbnInterfaceManagerEvents,
            newInterface: *IMbnInterface,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnInterfaceRemoval: fn(
            self: *const IMbnInterfaceManagerEvents,
...
pub const IMbnRegistration = extern struct {
    pub const VTable = extern struct {
        ...
        GetAvailableDataClasses: fn(
            self: *const IMbnRegistration,
            availableDataClasses: *u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetCurrentDataClass: fn(
            self: *const IMbnRegistration,
            currentDataClass: *u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetRegistrationNetworkError: fn(
            self: *const IMbnRegistration,
            registrationNetworkError: *u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        GetPacketAttachNetworkError: fn(
            self: *const IMbnRegistration,
...
pub const IMbnRegistrationEvents = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        OnRegisterModeAvailable: fn(
            self: *const IMbnRegistrationEvents,
            newInterface: *IMbnRegistration,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnRegisterStateChange: fn(
            self: *const IMbnRegistrationEvents,
            newInterface: *IMbnRegistration,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnPacketServiceStateChange: fn(
            self: *const IMbnRegistrationEvents,
            newInterface: *IMbnRegistration,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnSetRegisterModeComplete: fn(
            self: *const IMbnRegistrationEvents,
            newInterface: *IMbnRegistration,
            requestID: u32,
            status: HRESULT,
...
pub const IMbnConnectionManagerEvents = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        OnConnectionArrival: fn(
            self: *const IMbnConnectionManagerEvents,
            newConnection: *IMbnConnection,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnConnectionRemoval: fn(
            self: *const IMbnConnectionManagerEvents,
...
pub const IMbnSmsConfiguration = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        get_ServiceCenterAddress: fn(
            self: *const IMbnSmsConfiguration,
            scAddress: *BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        put_ServiceCenterAddress: fn(
            self: *const IMbnSmsConfiguration,
            scAddress: [*:0]const u16,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        get_MaxMessageIndex: fn(
            self: *const IMbnSmsConfiguration,
            index: *u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        get_CdmaShortMsgSize: fn(
            self: *const IMbnSmsConfiguration,
            shortMsgSize: *u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        get_SmsFormat: fn(
...
pub const IMbnSmsEvents = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        OnSmsConfigurationChange: fn(
            self: *const IMbnSmsEvents,
            sms: *IMbnSms,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnSetSmsConfigurationComplete: fn(
            self: *const IMbnSmsEvents,
            sms: *IMbnSms,
            requestID: u32,
            status: HRESULT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnSmsSendComplete: fn(
            self: *const IMbnSmsEvents,
            sms: *IMbnSms,
            requestID: u32,
            status: HRESULT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnSmsReadComplete: fn(
            self: *const IMbnSmsEvents,
            sms: *IMbnSms,
            smsFormat: MBN_SMS_FORMAT,
            readMsgs: *SAFEARRAY,
        ...
        OnSmsNewClass0Message: fn(
            self: *const IMbnSmsEvents,
            sms: *IMbnSms,
            smsFormat: MBN_SMS_FORMAT,
            readMsgs: *SAFEARRAY,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnSmsDeleteComplete: fn(
            self: *const IMbnSmsEvents,
            sms: *IMbnSms,
            requestID: u32,
            status: HRESULT,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnSmsStatusChange: fn(
            self: *const IMbnSmsEvents,
            sms: *IMbnSms,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
...
pub const IMbnRadioEvents = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        OnRadioStateChange: fn(
            self: *const IMbnRadioEvents,
            newInterface: *IMbnRadio,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnSetSoftwareRadioStateComplete: fn(
            self: *const IMbnRadioEvents,
            newInterface: *IMbnRadio,
            requestID: u32,
            status: HRESULT,
...
pub const IMbnMultiCarrierEvents = extern struct {
    pub const VTable = extern struct {
        ...
        OnInterfaceCapabilityChange: fn(
            self: *const IMbnMultiCarrierEvents,
            mbnInterface: *IMbnMultiCarrier,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
...
pub const IMbnDeviceServicesEvents = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        OnQuerySupportedCommandsComplete: fn(
        ...
        OnOpenCommandSessionComplete: fn(
            self: *const IMbnDeviceServicesEvents,
            deviceService: *IMbnDeviceService,
            status: HRESULT,
            requestID: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnCloseCommandSessionComplete: fn(
            self: *const IMbnDeviceServicesEvents,
            deviceService: *IMbnDeviceService,
            status: HRESULT,
            requestID: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnSetCommandComplete: fn(
            self: *const IMbnDeviceServicesEvents,
            deviceService: *IMbnDeviceService,
            responseID: u32,
        ...
        OnOpenDataSessionComplete: fn(
            self: *const IMbnDeviceServicesEvents,
            deviceService: *IMbnDeviceService,
            status: HRESULT,
            requestID: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnCloseDataSessionComplete: fn(
            self: *const IMbnDeviceServicesEvents,
            deviceService: *IMbnDeviceService,
            status: HRESULT,
            requestID: u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OnWriteDataComplete: fn(
            self: *const IMbnDeviceServicesEvents,
            deviceService: *IMbnDeviceService,
            status: HRESULT,
            requestID: u32,
...
pub const IMbnDeviceService = extern struct {
    pub const VTable = extern struct {
        base: IUnknown.VTable,
        QuerySupportedCommands: fn(
            self: *const IMbnDeviceService,
            requestID: *u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        OpenCommandSession: fn(
            self: *const IMbnDeviceService,
            requestID: *u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        CloseCommandSession: fn(
            self: *const IMbnDeviceService,
            requestID: *u32,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        SetCommand: fn(
        ...
        get_DeviceServiceID: fn(
            self: *const IMbnDeviceService,
            DeviceServiceID: *BSTR,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        get_IsCommandSessionOpen: fn(
            self: *const IMbnDeviceService,
            value: *BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
        get_IsDataSessionOpen: fn(
            self: *const IMbnDeviceService,
            value: *BOOL,
        ) callconv(@import("std").os.windows.WINAPI) HRESULT,
    };
