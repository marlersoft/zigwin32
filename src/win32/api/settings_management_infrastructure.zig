...
pub const OfflineMode = WcmTargetMode.OfflineMode;
pub const OnlineMode = WcmTargetMode.OnlineMode;
...
pub const dataTypeByte = WcmDataType.dataTypeByte;
pub const dataTypeSByte = WcmDataType.dataTypeSByte;
pub const dataTypeUInt16 = WcmDataType.dataTypeUInt16;
pub const dataTypeInt16 = WcmDataType.dataTypeInt16;
pub const dataTypeUInt32 = WcmDataType.dataTypeUInt32;
pub const dataTypeInt32 = WcmDataType.dataTypeInt32;
pub const dataTypeUInt64 = WcmDataType.dataTypeUInt64;
pub const dataTypeInt64 = WcmDataType.dataTypeInt64;
pub const dataTypeBoolean = WcmDataType.dataTypeBoolean;
pub const dataTypeString = WcmDataType.dataTypeString;
pub const dataTypeFlagArray = WcmDataType.dataTypeFlagArray;
...
pub const settingTypeScalar = WcmSettingType.settingTypeScalar;
pub const settingTypeComplex = WcmSettingType.settingTypeComplex;
pub const settingTypeList = WcmSettingType.settingTypeList;
...
pub const restrictionFacetMaxLength = WcmRestrictionFacets.restrictionFacetMaxLength;
pub const restrictionFacetEnumeration = WcmRestrictionFacets.restrictionFacetEnumeration;
pub const restrictionFacetMaxInclusive = WcmRestrictionFacets.restrictionFacetMaxInclusive;
pub const restrictionFacetMinInclusive = WcmRestrictionFacets.restrictionFacetMinInclusive;
...
pub const UnknownStatus = WcmUserStatus.UnknownStatus;
pub const UserRegistered = WcmUserStatus.UserRegistered;
pub const UserUnregistered = WcmUserStatus.UserUnregistered;
pub const UserLoaded = WcmUserStatus.UserLoaded;
pub const UserUnloaded = WcmUserStatus.UserUnloaded;

pub const WcmNamespaceAccess = extern enum(i32) {
    ReadOnlyAccess = 1,
    ReadWriteAccess = 2,
};
pub const ReadOnlyAccess = WcmNamespaceAccess.ReadOnlyAccess;
pub const ReadWriteAccess = WcmNamespaceAccess.ReadWriteAccess;
