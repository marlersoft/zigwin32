...
pub const ITSGPolicyEngine = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITSGPolicyEngine_AuthorizeConnection(self: *const T, mainSessionId: Guid, username: BSTR, authType: AAAuthSchemes, clientMachineIP: BSTR, clientMachineName: BSTR, sohData: [*:0]u8, numSOHBytes: u32, cookieData: [*:0]u8, numCookieBytes: u32, userToken: u32, pSink: *ITSGAuthorizeConnectionSink) callconv(.Inline) HRESULT {
...
pub const ITSGAuthenticateUserSink = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITSGAuthenticateUserSink_OnUserAuthenticated(self: *const T, userName: BSTR, userDomain: BSTR, context: ?*c_void, userToken: u32) callconv(.Inline) HRESULT {
...
pub const IWTSProtocolConnection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWTSProtocolConnection_GetProtocolHandles(self: *const T, pKeyboardHandle: *u32, pMouseHandle: *u32, pBeepHandle: *u32, pVideoHandle: *u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWTSProtocolConnection_IsUserAllowedToLogon(self: *const T, SessionId: u32, UserToken: u32, pDomainName: PWSTR, pUserName: PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWTSProtocolConnection_SessionArbitrationEnumeration(self: *const T, hUserToken: u32, bSingleSessionPerUserEnabled: BOOL, pSessionIdArray: [*]u32, pdwSessionIdentifierCount: *u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWTSProtocolConnection_LogonNotify(self: *const T, hClientToken: u32, wszUserName: PWSTR, wszDomainName: PWSTR, SessionId: *WTS_SESSION_ID) callconv(.Inline) HRESULT {
...
pub const IWRdsProtocolConnection = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWRdsProtocolConnection_NotifySessionId(self: *const T, SessionId: *WTS_SESSION_ID, SessionHandle: u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWRdsProtocolConnection_GetInputHandles(self: *const T, pKeyboardHandle: *u32, pMouseHandle: *u32, pBeepHandle: *u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWRdsProtocolConnection_GetVideoHandle(self: *const T, pVideoHandle: *u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWRdsProtocolConnection_IsUserAllowedToLogon(self: *const T, SessionId: u32, UserToken: u32, pDomainName: PWSTR, pUserName: PWSTR) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWRdsProtocolConnection_SessionArbitrationEnumeration(self: *const T, hUserToken: u32, bSingleSessionPerUserEnabled: BOOL, pSessionIdArray: [*]u32, pdwSessionIdentifierCount: *u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWRdsProtocolConnection_LogonNotify(self: *const T, hClientToken: u32, wszUserName: PWSTR, wszDomainName: PWSTR, SessionId: *WTS_SESSION_ID, pWRdsConnectionSettings: *WRDS_CONNECTION_SETTINGS) callconv(.Inline) HRESULT {
...
pub const IWRdsWddmIddProps = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWRdsWddmIddProps_OnDriverLoad(self: *const T, SessionId: u32, DriverHandle: u32) callconv(.Inline) HRESULT {
