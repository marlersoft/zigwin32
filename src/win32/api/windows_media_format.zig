...
pub const WEBSTREAM_SAMPLE_TYPE = extern enum(i32) {
    FILE = 1,
    RENDER = 2,
};
...
pub const WM_SF_TYPE = extern enum(i32) {
    CLEANPOINT = 1,
    DISCONTINUITY = 2,
    DATALOSS = 4,
};
...
pub const WM_SFEX_TYPE = extern enum(i32) {
    NOTASYNCPOINT = 2,
    DATALOSS = 4,
};
...
pub const WMT_END_OF_FILE = WMT_STATUS.END_OF_FILE;
...
pub const WM_DM_INTERLACED_TYPE = extern enum(i32) {
    NOTINTERLACED = 0,
...
pub const WM_DM_IT_FIRST_FRAME_COHERENCY = extern enum(i32) {
...
pub const WM_PLAYBACK_DRC_LEVEL = extern enum(i32) {
    HIGH = 0,
    MEDIUM = 1,
    LOW = 2,
};
...
pub const WMT_TIMECODE_FRAMERATE = extern enum(i32) {
    @"30" = 0,
    @"30DROP" = 1,
    @"25" = 2,
    @"24" = 3,
