...
pub const NCCF_NONE = NETCON_CHARACTERISTIC_FLAGS.NCCF_NONE;
pub const NCCF_ALL_USERS = NETCON_CHARACTERISTIC_FLAGS.NCCF_ALL_USERS;
pub const NCCF_ALLOW_DUPLICATION = NETCON_CHARACTERISTIC_FLAGS.NCCF_ALLOW_DUPLICATION;
pub const NCCF_ALLOW_REMOVAL = NETCON_CHARACTERISTIC_FLAGS.NCCF_ALLOW_REMOVAL;
pub const NCCF_ALLOW_RENAME = NETCON_CHARACTERISTIC_FLAGS.NCCF_ALLOW_RENAME;
pub const NCCF_INCOMING_ONLY = NETCON_CHARACTERISTIC_FLAGS.NCCF_INCOMING_ONLY;
pub const NCCF_OUTGOING_ONLY = NETCON_CHARACTERISTIC_FLAGS.NCCF_OUTGOING_ONLY;
pub const NCCF_BRANDED = NETCON_CHARACTERISTIC_FLAGS.NCCF_BRANDED;
pub const NCCF_SHARED = NETCON_CHARACTERISTIC_FLAGS.NCCF_SHARED;
pub const NCCF_BRIDGED = NETCON_CHARACTERISTIC_FLAGS.NCCF_BRIDGED;
pub const NCCF_FIREWALLED = NETCON_CHARACTERISTIC_FLAGS.NCCF_FIREWALLED;
pub const NCCF_DEFAULT = NETCON_CHARACTERISTIC_FLAGS.NCCF_DEFAULT;
pub const NCCF_HOMENET_CAPABLE = NETCON_CHARACTERISTIC_FLAGS.NCCF_HOMENET_CAPABLE;
pub const NCCF_SHARED_PRIVATE = NETCON_CHARACTERISTIC_FLAGS.NCCF_SHARED_PRIVATE;
pub const NCCF_QUARANTINED = NETCON_CHARACTERISTIC_FLAGS.NCCF_QUARANTINED;
pub const NCCF_RESERVED = NETCON_CHARACTERISTIC_FLAGS.NCCF_RESERVED;
pub const NCCF_HOSTED_NETWORK = NETCON_CHARACTERISTIC_FLAGS.NCCF_HOSTED_NETWORK;
pub const NCCF_VIRTUAL_STATION = NETCON_CHARACTERISTIC_FLAGS.NCCF_VIRTUAL_STATION;
pub const NCCF_WIFI_DIRECT = NETCON_CHARACTERISTIC_FLAGS.NCCF_WIFI_DIRECT;
pub const NCCF_BLUETOOTH_MASK = NETCON_CHARACTERISTIC_FLAGS.NCCF_BLUETOOTH_MASK;
pub const NCCF_LAN_MASK = NETCON_CHARACTERISTIC_FLAGS.NCCF_LAN_MASK;
...
pub const NCS_DISCONNECTED = NETCON_STATUS.NCS_DISCONNECTED;
pub const NCS_CONNECTING = NETCON_STATUS.NCS_CONNECTING;
pub const NCS_CONNECTED = NETCON_STATUS.NCS_CONNECTED;
pub const NCS_DISCONNECTING = NETCON_STATUS.NCS_DISCONNECTING;
pub const NCS_HARDWARE_NOT_PRESENT = NETCON_STATUS.NCS_HARDWARE_NOT_PRESENT;
pub const NCS_HARDWARE_DISABLED = NETCON_STATUS.NCS_HARDWARE_DISABLED;
pub const NCS_HARDWARE_MALFUNCTION = NETCON_STATUS.NCS_HARDWARE_MALFUNCTION;
pub const NCS_MEDIA_DISCONNECTED = NETCON_STATUS.NCS_MEDIA_DISCONNECTED;
pub const NCS_AUTHENTICATING = NETCON_STATUS.NCS_AUTHENTICATING;
pub const NCS_AUTHENTICATION_SUCCEEDED = NETCON_STATUS.NCS_AUTHENTICATION_SUCCEEDED;
pub const NCS_AUTHENTICATION_FAILED = NETCON_STATUS.NCS_AUTHENTICATION_FAILED;
pub const NCS_INVALID_ADDRESS = NETCON_STATUS.NCS_INVALID_ADDRESS;
pub const NCS_CREDENTIALS_REQUIRED = NETCON_STATUS.NCS_CREDENTIALS_REQUIRED;
pub const NCS_ACTION_REQUIRED = NETCON_STATUS.NCS_ACTION_REQUIRED;
pub const NCS_ACTION_REQUIRED_RETRY = NETCON_STATUS.NCS_ACTION_REQUIRED_RETRY;
pub const NCS_CONNECT_FAILED = NETCON_STATUS.NCS_CONNECT_FAILED;
...
pub const NCT_DIRECT_CONNECT = NETCON_TYPE.NCT_DIRECT_CONNECT;
pub const NCT_INBOUND = NETCON_TYPE.NCT_INBOUND;
pub const NCT_INTERNET = NETCON_TYPE.NCT_INTERNET;
pub const NCT_LAN = NETCON_TYPE.NCT_LAN;
pub const NCT_PHONE = NETCON_TYPE.NCT_PHONE;
pub const NCT_TUNNEL = NETCON_TYPE.NCT_TUNNEL;
pub const NCT_BRIDGE = NETCON_TYPE.NCT_BRIDGE;
...
pub const NCM_NONE = NETCON_MEDIATYPE.NCM_NONE;
pub const NCM_DIRECT = NETCON_MEDIATYPE.NCM_DIRECT;
pub const NCM_ISDN = NETCON_MEDIATYPE.NCM_ISDN;
pub const NCM_LAN = NETCON_MEDIATYPE.NCM_LAN;
pub const NCM_PHONE = NETCON_MEDIATYPE.NCM_PHONE;
pub const NCM_TUNNEL = NETCON_MEDIATYPE.NCM_TUNNEL;
pub const NCM_PPPOE = NETCON_MEDIATYPE.NCM_PPPOE;
pub const NCM_BRIDGE = NETCON_MEDIATYPE.NCM_BRIDGE;
pub const NCM_SHAREDACCESSHOST_LAN = NETCON_MEDIATYPE.NCM_SHAREDACCESSHOST_LAN;
pub const NCM_SHAREDACCESSHOST_RAS = NETCON_MEDIATYPE.NCM_SHAREDACCESSHOST_RAS;
...
pub const NCME_DEFAULT = NETCONMGR_ENUM_FLAGS.NCME_DEFAULT;
pub const NCME_HIDDEN = NETCONMGR_ENUM_FLAGS.NCME_HIDDEN;
...
pub const NCUC_DEFAULT = NETCONUI_CONNECT_FLAGS.NCUC_DEFAULT;
pub const NCUC_NO_UI = NETCONUI_CONNECT_FLAGS.NCUC_NO_UI;
pub const NCUC_ENABLE_DISABLE = NETCONUI_CONNECT_FLAGS.NCUC_ENABLE_DISABLE;
...
pub const ICSSHARINGTYPE_PUBLIC = SHARINGCONNECTIONTYPE.ICSSHARINGTYPE_PUBLIC;
pub const ICSSHARINGTYPE_PRIVATE = SHARINGCONNECTIONTYPE.ICSSHARINGTYPE_PRIVATE;

pub const SHARINGCONNECTION_ENUM_FLAGS = extern enum(i32) {
    ICSSC_DEFAULT = 0,
    ICSSC_ENABLED = 1,
};
pub const ICSSC_DEFAULT = SHARINGCONNECTION_ENUM_FLAGS.ICSSC_DEFAULT;
pub const ICSSC_ENABLED = SHARINGCONNECTION_ENUM_FLAGS.ICSSC_ENABLED;

pub const ICS_TARGETTYPE = extern enum(i32) {
    ICSTT_NAME = 0,
    ICSTT_IPADDRESS = 1,
};
pub const ICSTT_NAME = ICS_TARGETTYPE.ICSTT_NAME;
pub const ICSTT_IPADDRESS = ICS_TARGETTYPE.ICSTT_IPADDRESS;
...
pub const NET_FW_POLICY_GROUP = NET_FW_POLICY_TYPE.NET_FW_POLICY_GROUP;
pub const NET_FW_POLICY_LOCAL = NET_FW_POLICY_TYPE.NET_FW_POLICY_LOCAL;
pub const NET_FW_POLICY_EFFECTIVE = NET_FW_POLICY_TYPE.NET_FW_POLICY_EFFECTIVE;
pub const NET_FW_POLICY_TYPE_MAX = NET_FW_POLICY_TYPE.MAX;
...
pub const NET_FW_PROFILE_DOMAIN = NET_FW_PROFILE_TYPE.NET_FW_PROFILE_DOMAIN;
pub const NET_FW_PROFILE_STANDARD = NET_FW_PROFILE_TYPE.NET_FW_PROFILE_STANDARD;
pub const NET_FW_PROFILE_CURRENT = NET_FW_PROFILE_TYPE.NET_FW_PROFILE_CURRENT;
pub const NET_FW_PROFILE_TYPE_MAX = NET_FW_PROFILE_TYPE.MAX;
...
pub const NET_FW_PROFILE2_DOMAIN = NET_FW_PROFILE_TYPE2.NET_FW_PROFILE2_DOMAIN;
pub const NET_FW_PROFILE2_PRIVATE = NET_FW_PROFILE_TYPE2.NET_FW_PROFILE2_PRIVATE;
pub const NET_FW_PROFILE2_PUBLIC = NET_FW_PROFILE_TYPE2.NET_FW_PROFILE2_PUBLIC;
pub const NET_FW_PROFILE2_ALL = NET_FW_PROFILE_TYPE2.NET_FW_PROFILE2_ALL;
...
pub const NET_FW_SERVICE_FILE_AND_PRINT = NET_FW_SERVICE_TYPE.NET_FW_SERVICE_FILE_AND_PRINT;
pub const NET_FW_SERVICE_UPNP = NET_FW_SERVICE_TYPE.NET_FW_SERVICE_UPNP;
pub const NET_FW_SERVICE_REMOTE_DESKTOP = NET_FW_SERVICE_TYPE.NET_FW_SERVICE_REMOTE_DESKTOP;
pub const NET_FW_SERVICE_NONE = NET_FW_SERVICE_TYPE.NET_FW_SERVICE_NONE;
pub const NET_FW_SERVICE_TYPE_MAX = NET_FW_SERVICE_TYPE.MAX;
...
pub const NET_FW_RULE_DIR_IN = NET_FW_RULE_DIRECTION.NET_FW_RULE_DIR_IN;
pub const NET_FW_RULE_DIR_OUT = NET_FW_RULE_DIRECTION.NET_FW_RULE_DIR_OUT;
pub const NET_FW_RULE_DIR_MAX = NET_FW_RULE_DIRECTION.NET_FW_RULE_DIR_MAX;
...
pub const NET_FW_AUTHENTICATE_NONE = NET_FW_AUTHENTICATE_TYPE.NET_FW_AUTHENTICATE_NONE;
pub const NET_FW_AUTHENTICATE_NO_ENCAPSULATION = NET_FW_AUTHENTICATE_TYPE.NET_FW_AUTHENTICATE_NO_ENCAPSULATION;
pub const NET_FW_AUTHENTICATE_WITH_INTEGRITY = NET_FW_AUTHENTICATE_TYPE.NET_FW_AUTHENTICATE_WITH_INTEGRITY;
pub const NET_FW_AUTHENTICATE_AND_NEGOTIATE_ENCRYPTION = NET_FW_AUTHENTICATE_TYPE.NET_FW_AUTHENTICATE_AND_NEGOTIATE_ENCRYPTION;
pub const NET_FW_AUTHENTICATE_AND_ENCRYPT = NET_FW_AUTHENTICATE_TYPE.NET_FW_AUTHENTICATE_AND_ENCRYPT;
...
pub const INET_FIREWALL_AC_NONE = INET_FIREWALL_AC_CREATION_TYPE.INET_FIREWALL_AC_NONE;
pub const INET_FIREWALL_AC_PACKAGE_ID_ONLY = INET_FIREWALL_AC_CREATION_TYPE.INET_FIREWALL_AC_PACKAGE_ID_ONLY;
pub const INET_FIREWALL_AC_BINARY = INET_FIREWALL_AC_CREATION_TYPE.INET_FIREWALL_AC_BINARY;
pub const INET_FIREWALL_AC_MAX = INET_FIREWALL_AC_CREATION_TYPE.INET_FIREWALL_AC_MAX;
...
pub const INET_FIREWALL_AC_CHANGE_INVALID = INET_FIREWALL_AC_CHANGE_TYPE.INET_FIREWALL_AC_CHANGE_INVALID;
pub const INET_FIREWALL_AC_CHANGE_CREATE = INET_FIREWALL_AC_CHANGE_TYPE.INET_FIREWALL_AC_CHANGE_CREATE;
pub const INET_FIREWALL_AC_CHANGE_DELETE = INET_FIREWALL_AC_CHANGE_TYPE.INET_FIREWALL_AC_CHANGE_DELETE;
pub const INET_FIREWALL_AC_CHANGE_MAX = INET_FIREWALL_AC_CHANGE_TYPE.INET_FIREWALL_AC_CHANGE_MAX;
