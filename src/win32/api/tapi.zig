...
pub const TAPI_TONEMODE = extern enum(i32) {
    TTM_RINGBACK = 2,
    TTM_BUSY = 4,
    TTM_BEEP = 8,
    TTM_BILLING = 16,
};
pub const TTM_RINGBACK = TAPI_TONEMODE.TTM_RINGBACK;
pub const TTM_BUSY = TAPI_TONEMODE.TTM_BUSY;
pub const TTM_BEEP = TAPI_TONEMODE.TTM_BEEP;
pub const TTM_BILLING = TAPI_TONEMODE.TTM_BILLING;

pub const TAPI_GATHERTERM = extern enum(i32) {
    TGT_BUFFERFULL = 1,
    TGT_TERMDIGIT = 2,
    TGT_FIRSTTIMEOUT = 4,
    TGT_INTERTIMEOUT = 8,
...
pub const TGT_BUFFERFULL = TAPI_GATHERTERM.TGT_BUFFERFULL;
pub const TGT_TERMDIGIT = TAPI_GATHERTERM.TGT_TERMDIGIT;
pub const TGT_FIRSTTIMEOUT = TAPI_GATHERTERM.TGT_FIRSTTIMEOUT;
pub const TGT_INTERTIMEOUT = TAPI_GATHERTERM.TGT_INTERTIMEOUT;
pub const TGT_CANCEL = TAPI_GATHERTERM.TGT_CANCEL;
...
pub const ADDRESS_EVENT = extern enum(i32) {
    AE_STATE = 0,
    AE_CAPSCHANGE = 1,
    AE_RINGING = 2,
    AE_CONFIGCHANGE = 3,
...
pub const AE_STATE = ADDRESS_EVENT.AE_STATE;
pub const AE_CAPSCHANGE = ADDRESS_EVENT.AE_CAPSCHANGE;
pub const AE_RINGING = ADDRESS_EVENT.AE_RINGING;
pub const AE_CONFIGCHANGE = ADDRESS_EVENT.AE_CONFIGCHANGE;
pub const AE_FORWARD = ADDRESS_EVENT.AE_FORWARD;
pub const AE_NEWTERMINAL = ADDRESS_EVENT.AE_NEWTERMINAL;
pub const AE_REMOVETERMINAL = ADDRESS_EVENT.AE_REMOVETERMINAL;
pub const AE_MSGWAITON = ADDRESS_EVENT.AE_MSGWAITON;
pub const AE_MSGWAITOFF = ADDRESS_EVENT.AE_MSGWAITOFF;
pub const AE_LASTITEM = ADDRESS_EVENT.AE_LASTITEM;

pub const ADDRESS_STATE = extern enum(i32) {
    AS_INSERVICE = 0,
    AS_OUTOFSERVICE = 1,
};
pub const AS_INSERVICE = ADDRESS_STATE.AS_INSERVICE;
pub const AS_OUTOFSERVICE = ADDRESS_STATE.AS_OUTOFSERVICE;

pub const CALL_STATE = extern enum(i32) {
    CS_IDLE = 0,
    CS_INPROGRESS = 1,
    CS_CONNECTED = 2,
    CS_DISCONNECTED = 3,
...
pub const CS_IDLE = CALL_STATE.CS_IDLE;
pub const CS_INPROGRESS = CALL_STATE.CS_INPROGRESS;
pub const CS_CONNECTED = CALL_STATE.CS_CONNECTED;
pub const CS_DISCONNECTED = CALL_STATE.CS_DISCONNECTED;
pub const CS_OFFERING = CALL_STATE.CS_OFFERING;
pub const CS_HOLD = CALL_STATE.CS_HOLD;
pub const CS_QUEUED = CALL_STATE.CS_QUEUED;
pub const CS_LASTITEM = CALL_STATE.CS_LASTITEM;

pub const CALL_STATE_EVENT_CAUSE = extern enum(i32) {
    CEC_NONE = 0,
...
pub const CEC_NONE = CALL_STATE_EVENT_CAUSE.CEC_NONE;
pub const CEC_DISCONNECT_NORMAL = CALL_STATE_EVENT_CAUSE.CEC_DISCONNECT_NORMAL;
pub const CEC_DISCONNECT_BUSY = CALL_STATE_EVENT_CAUSE.CEC_DISCONNECT_BUSY;
pub const CEC_DISCONNECT_BADADDRESS = CALL_STATE_EVENT_CAUSE.CEC_DISCONNECT_BADADDRESS;
pub const CEC_DISCONNECT_NOANSWER = CALL_STATE_EVENT_CAUSE.CEC_DISCONNECT_NOANSWER;
pub const CEC_DISCONNECT_CANCELLED = CALL_STATE_EVENT_CAUSE.CEC_DISCONNECT_CANCELLED;
pub const CEC_DISCONNECT_REJECTED = CALL_STATE_EVENT_CAUSE.CEC_DISCONNECT_REJECTED;
pub const CEC_DISCONNECT_FAILED = CALL_STATE_EVENT_CAUSE.CEC_DISCONNECT_FAILED;
pub const CEC_DISCONNECT_BLOCKED = CALL_STATE_EVENT_CAUSE.CEC_DISCONNECT_BLOCKED;

pub const CALL_MEDIA_EVENT = extern enum(i32) {
    CME_NEW_STREAM = 0,
    CME_STREAM_FAIL = 1,
    CME_TERMINAL_FAIL = 2,
...
pub const CME_NEW_STREAM = CALL_MEDIA_EVENT.CME_NEW_STREAM;
pub const CME_STREAM_FAIL = CALL_MEDIA_EVENT.CME_STREAM_FAIL;
pub const CME_TERMINAL_FAIL = CALL_MEDIA_EVENT.CME_TERMINAL_FAIL;
pub const CME_STREAM_NOT_USED = CALL_MEDIA_EVENT.CME_STREAM_NOT_USED;
pub const CME_STREAM_ACTIVE = CALL_MEDIA_EVENT.CME_STREAM_ACTIVE;
pub const CME_STREAM_INACTIVE = CALL_MEDIA_EVENT.CME_STREAM_INACTIVE;
pub const CME_LASTITEM = CALL_MEDIA_EVENT.CME_LASTITEM;

pub const CALL_MEDIA_EVENT_CAUSE = extern enum(i32) {
    CMC_UNKNOWN = 0,
    CMC_BAD_DEVICE = 1,
    CMC_CONNECT_FAIL = 2,
    CMC_LOCAL_REQUEST = 3,
...
pub const CMC_UNKNOWN = CALL_MEDIA_EVENT_CAUSE.CMC_UNKNOWN;
pub const CMC_BAD_DEVICE = CALL_MEDIA_EVENT_CAUSE.CMC_BAD_DEVICE;
pub const CMC_CONNECT_FAIL = CALL_MEDIA_EVENT_CAUSE.CMC_CONNECT_FAIL;
pub const CMC_LOCAL_REQUEST = CALL_MEDIA_EVENT_CAUSE.CMC_LOCAL_REQUEST;
pub const CMC_REMOTE_REQUEST = CALL_MEDIA_EVENT_CAUSE.CMC_REMOTE_REQUEST;
pub const CMC_MEDIA_TIMEOUT = CALL_MEDIA_EVENT_CAUSE.CMC_MEDIA_TIMEOUT;
pub const CMC_MEDIA_RECOVERED = CALL_MEDIA_EVENT_CAUSE.CMC_MEDIA_RECOVERED;
pub const CMC_QUALITY_OF_SERVICE = CALL_MEDIA_EVENT_CAUSE.CMC_QUALITY_OF_SERVICE;

pub const DISCONNECT_CODE = extern enum(i32) {
    DC_NORMAL = 0,
    DC_NOANSWER = 1,
    DC_REJECTED = 2,
};
pub const DC_NORMAL = DISCONNECT_CODE.DC_NORMAL;
pub const DC_NOANSWER = DISCONNECT_CODE.DC_NOANSWER;
pub const DC_REJECTED = DISCONNECT_CODE.DC_REJECTED;

pub const TERMINAL_STATE = extern enum(i32) {
    TS_INUSE = 0,
    TS_NOTINUSE = 1,
};
pub const TS_INUSE = TERMINAL_STATE.TS_INUSE;
pub const TS_NOTINUSE = TERMINAL_STATE.TS_NOTINUSE;

pub const TERMINAL_DIRECTION = extern enum(i32) {
    TD_CAPTURE = 0,
    TD_RENDER = 1,
    TD_BIDIRECTIONAL = 2,
...
pub const TD_CAPTURE = TERMINAL_DIRECTION.TD_CAPTURE;
pub const TD_RENDER = TERMINAL_DIRECTION.TD_RENDER;
pub const TD_BIDIRECTIONAL = TERMINAL_DIRECTION.TD_BIDIRECTIONAL;
pub const TD_MULTITRACK_MIXED = TERMINAL_DIRECTION.TD_MULTITRACK_MIXED;
pub const TD_NONE = TERMINAL_DIRECTION.TD_NONE;

pub const TERMINAL_TYPE = extern enum(i32) {
    TT_STATIC = 0,
    TT_DYNAMIC = 1,
};
pub const TT_STATIC = TERMINAL_TYPE.TT_STATIC;
pub const TT_DYNAMIC = TERMINAL_TYPE.TT_DYNAMIC;

pub const CALL_PRIVILEGE = extern enum(i32) {
    CP_OWNER = 0,
    CP_MONITOR = 1,
};
pub const CP_OWNER = CALL_PRIVILEGE.CP_OWNER;
pub const CP_MONITOR = CALL_PRIVILEGE.CP_MONITOR;

pub const TAPI_EVENT = extern enum(i32) {
    TE_TAPIOBJECT = 1,
    TE_ADDRESS = 2,
...
pub const TE_TAPIOBJECT = TAPI_EVENT.TE_TAPIOBJECT;
pub const TE_ADDRESS = TAPI_EVENT.TE_ADDRESS;
pub const TE_CALLNOTIFICATION = TAPI_EVENT.TE_CALLNOTIFICATION;
pub const TE_CALLSTATE = TAPI_EVENT.TE_CALLSTATE;
pub const TE_CALLMEDIA = TAPI_EVENT.TE_CALLMEDIA;
pub const TE_CALLHUB = TAPI_EVENT.TE_CALLHUB;
pub const TE_CALLINFOCHANGE = TAPI_EVENT.TE_CALLINFOCHANGE;
pub const TE_PRIVATE = TAPI_EVENT.TE_PRIVATE;
pub const TE_REQUEST = TAPI_EVENT.TE_REQUEST;
pub const TE_AGENT = TAPI_EVENT.TE_AGENT;
pub const TE_AGENTSESSION = TAPI_EVENT.TE_AGENTSESSION;
pub const TE_QOSEVENT = TAPI_EVENT.TE_QOSEVENT;
pub const TE_AGENTHANDLER = TAPI_EVENT.TE_AGENTHANDLER;
pub const TE_ACDGROUP = TAPI_EVENT.TE_ACDGROUP;
pub const TE_QUEUE = TAPI_EVENT.TE_QUEUE;
pub const TE_DIGITEVENT = TAPI_EVENT.TE_DIGITEVENT;
pub const TE_GENERATEEVENT = TAPI_EVENT.TE_GENERATEEVENT;
pub const TE_ASRTERMINAL = TAPI_EVENT.TE_ASRTERMINAL;
pub const TE_TTSTERMINAL = TAPI_EVENT.TE_TTSTERMINAL;
pub const TE_FILETERMINAL = TAPI_EVENT.TE_FILETERMINAL;
pub const TE_TONETERMINAL = TAPI_EVENT.TE_TONETERMINAL;
pub const TE_PHONEEVENT = TAPI_EVENT.TE_PHONEEVENT;
pub const TE_TONEEVENT = TAPI_EVENT.TE_TONEEVENT;
pub const TE_GATHERDIGITS = TAPI_EVENT.TE_GATHERDIGITS;
pub const TE_ADDRESSDEVSPECIFIC = TAPI_EVENT.TE_ADDRESSDEVSPECIFIC;
pub const TE_PHONEDEVSPECIFIC = TAPI_EVENT.TE_PHONEDEVSPECIFIC;

pub const CALL_NOTIFICATION_EVENT = extern enum(i32) {
    CNE_OWNER = 0,
    CNE_MONITOR = 1,
    CNE_LASTITEM = 1,
};
pub const CNE_OWNER = CALL_NOTIFICATION_EVENT.CNE_OWNER;
pub const CNE_MONITOR = CALL_NOTIFICATION_EVENT.CNE_MONITOR;
pub const CNE_LASTITEM = CALL_NOTIFICATION_EVENT.CNE_LASTITEM;

pub const CALLHUB_EVENT = extern enum(i32) {
    CHE_CALLJOIN = 0,
    CHE_CALLLEAVE = 1,
    CHE_CALLHUBNEW = 2,
    CHE_CALLHUBIDLE = 3,
...
pub const CHE_CALLJOIN = CALLHUB_EVENT.CHE_CALLJOIN;
pub const CHE_CALLLEAVE = CALLHUB_EVENT.CHE_CALLLEAVE;
pub const CHE_CALLHUBNEW = CALLHUB_EVENT.CHE_CALLHUBNEW;
pub const CHE_CALLHUBIDLE = CALLHUB_EVENT.CHE_CALLHUBIDLE;
pub const CHE_LASTITEM = CALLHUB_EVENT.CHE_LASTITEM;

pub const CALLHUB_STATE = extern enum(i32) {
    CHS_ACTIVE = 0,
    CHS_IDLE = 1,
};
pub const CHS_ACTIVE = CALLHUB_STATE.CHS_ACTIVE;
pub const CHS_IDLE = CALLHUB_STATE.CHS_IDLE;

pub const TAPIOBJECT_EVENT = extern enum(i32) {
    TE_ADDRESSCREATE = 0,
    TE_ADDRESSREMOVE = 1,
    TE_REINIT = 2,
...
pub const TE_ADDRESSCREATE = TAPIOBJECT_EVENT.TE_ADDRESSCREATE;
pub const TE_ADDRESSREMOVE = TAPIOBJECT_EVENT.TE_ADDRESSREMOVE;
pub const TE_REINIT = TAPIOBJECT_EVENT.TE_REINIT;
pub const TE_TRANSLATECHANGE = TAPIOBJECT_EVENT.TE_TRANSLATECHANGE;
pub const TE_ADDRESSCLOSE = TAPIOBJECT_EVENT.TE_ADDRESSCLOSE;
pub const TE_PHONECREATE = TAPIOBJECT_EVENT.TE_PHONECREATE;
pub const TE_PHONEREMOVE = TAPIOBJECT_EVENT.TE_PHONEREMOVE;

pub const TAPI_OBJECT_TYPE = extern enum(i32) {
    TOT_NONE = 0,
    TOT_TAPI = 1,
    TOT_ADDRESS = 2,
    TOT_TERMINAL = 3,
...
pub const TOT_NONE = TAPI_OBJECT_TYPE.TOT_NONE;
pub const TOT_TAPI = TAPI_OBJECT_TYPE.TOT_TAPI;
pub const TOT_ADDRESS = TAPI_OBJECT_TYPE.TOT_ADDRESS;
pub const TOT_TERMINAL = TAPI_OBJECT_TYPE.TOT_TERMINAL;
pub const TOT_CALL = TAPI_OBJECT_TYPE.TOT_CALL;
pub const TOT_CALLHUB = TAPI_OBJECT_TYPE.TOT_CALLHUB;
pub const TOT_PHONE = TAPI_OBJECT_TYPE.TOT_PHONE;

pub const QOS_SERVICE_LEVEL = extern enum(i32) {
    QSL_NEEDED = 1,
    QSL_IF_AVAILABLE = 2,
    QSL_BEST_EFFORT = 3,
};
pub const QSL_NEEDED = QOS_SERVICE_LEVEL.QSL_NEEDED;
pub const QSL_IF_AVAILABLE = QOS_SERVICE_LEVEL.QSL_IF_AVAILABLE;
pub const QSL_BEST_EFFORT = QOS_SERVICE_LEVEL.QSL_BEST_EFFORT;

pub const QOS_EVENT = extern enum(i32) {
    QE_NOQOS = 1,
...
pub const QE_NOQOS = QOS_EVENT.QE_NOQOS;
pub const QE_ADMISSIONFAILURE = QOS_EVENT.QE_ADMISSIONFAILURE;
pub const QE_POLICYFAILURE = QOS_EVENT.QE_POLICYFAILURE;
pub const QE_GENERICERROR = QOS_EVENT.QE_GENERICERROR;
pub const QE_LASTITEM = QOS_EVENT.QE_LASTITEM;

pub const CALLINFOCHANGE_CAUSE = extern enum(i32) {
    CIC_OTHER = 0,
    CIC_DEVSPECIFIC = 1,
    CIC_BEARERMODE = 2,
    CIC_RATE = 3,
...
pub const CIC_OTHER = CALLINFOCHANGE_CAUSE.CIC_OTHER;
pub const CIC_DEVSPECIFIC = CALLINFOCHANGE_CAUSE.CIC_DEVSPECIFIC;
pub const CIC_BEARERMODE = CALLINFOCHANGE_CAUSE.CIC_BEARERMODE;
pub const CIC_RATE = CALLINFOCHANGE_CAUSE.CIC_RATE;
pub const CIC_APPSPECIFIC = CALLINFOCHANGE_CAUSE.CIC_APPSPECIFIC;
pub const CIC_CALLID = CALLINFOCHANGE_CAUSE.CIC_CALLID;
pub const CIC_RELATEDCALLID = CALLINFOCHANGE_CAUSE.CIC_RELATEDCALLID;
pub const CIC_ORIGIN = CALLINFOCHANGE_CAUSE.CIC_ORIGIN;
pub const CIC_REASON = CALLINFOCHANGE_CAUSE.CIC_REASON;
pub const CIC_COMPLETIONID = CALLINFOCHANGE_CAUSE.CIC_COMPLETIONID;
pub const CIC_NUMOWNERINCR = CALLINFOCHANGE_CAUSE.CIC_NUMOWNERINCR;
pub const CIC_NUMOWNERDECR = CALLINFOCHANGE_CAUSE.CIC_NUMOWNERDECR;
pub const CIC_NUMMONITORS = CALLINFOCHANGE_CAUSE.CIC_NUMMONITORS;
pub const CIC_TRUNK = CALLINFOCHANGE_CAUSE.CIC_TRUNK;
pub const CIC_CALLERID = CALLINFOCHANGE_CAUSE.CIC_CALLERID;
pub const CIC_CALLEDID = CALLINFOCHANGE_CAUSE.CIC_CALLEDID;
pub const CIC_CONNECTEDID = CALLINFOCHANGE_CAUSE.CIC_CONNECTEDID;
pub const CIC_REDIRECTIONID = CALLINFOCHANGE_CAUSE.CIC_REDIRECTIONID;
pub const CIC_REDIRECTINGID = CALLINFOCHANGE_CAUSE.CIC_REDIRECTINGID;
pub const CIC_USERUSERINFO = CALLINFOCHANGE_CAUSE.CIC_USERUSERINFO;
pub const CIC_HIGHLEVELCOMP = CALLINFOCHANGE_CAUSE.CIC_HIGHLEVELCOMP;
pub const CIC_LOWLEVELCOMP = CALLINFOCHANGE_CAUSE.CIC_LOWLEVELCOMP;
pub const CIC_CHARGINGINFO = CALLINFOCHANGE_CAUSE.CIC_CHARGINGINFO;
pub const CIC_TREATMENT = CALLINFOCHANGE_CAUSE.CIC_TREATMENT;
pub const CIC_CALLDATA = CALLINFOCHANGE_CAUSE.CIC_CALLDATA;
pub const CIC_PRIVILEGE = CALLINFOCHANGE_CAUSE.CIC_PRIVILEGE;
pub const CIC_MEDIATYPE = CALLINFOCHANGE_CAUSE.CIC_MEDIATYPE;
pub const CIC_LASTITEM = CALLINFOCHANGE_CAUSE.CIC_LASTITEM;

pub const CALLINFO_LONG = extern enum(i32) {
...
pub const CIL_MEDIATYPESAVAILABLE = CALLINFO_LONG.CIL_MEDIATYPESAVAILABLE;
pub const CIL_BEARERMODE = CALLINFO_LONG.CIL_BEARERMODE;
pub const CIL_CALLERIDADDRESSTYPE = CALLINFO_LONG.CIL_CALLERIDADDRESSTYPE;
pub const CIL_CALLEDIDADDRESSTYPE = CALLINFO_LONG.CIL_CALLEDIDADDRESSTYPE;
pub const CIL_CONNECTEDIDADDRESSTYPE = CALLINFO_LONG.CIL_CONNECTEDIDADDRESSTYPE;
pub const CIL_REDIRECTIONIDADDRESSTYPE = CALLINFO_LONG.CIL_REDIRECTIONIDADDRESSTYPE;
pub const CIL_REDIRECTINGIDADDRESSTYPE = CALLINFO_LONG.CIL_REDIRECTINGIDADDRESSTYPE;
pub const CIL_ORIGIN = CALLINFO_LONG.CIL_ORIGIN;
pub const CIL_REASON = CALLINFO_LONG.CIL_REASON;
pub const CIL_APPSPECIFIC = CALLINFO_LONG.CIL_APPSPECIFIC;
pub const CIL_CALLPARAMSFLAGS = CALLINFO_LONG.CIL_CALLPARAMSFLAGS;
pub const CIL_CALLTREATMENT = CALLINFO_LONG.CIL_CALLTREATMENT;
pub const CIL_MINRATE = CALLINFO_LONG.CIL_MINRATE;
pub const CIL_MAXRATE = CALLINFO_LONG.CIL_MAXRATE;
pub const CIL_COUNTRYCODE = CALLINFO_LONG.CIL_COUNTRYCODE;
pub const CIL_CALLID = CALLINFO_LONG.CIL_CALLID;
pub const CIL_RELATEDCALLID = CALLINFO_LONG.CIL_RELATEDCALLID;
pub const CIL_COMPLETIONID = CALLINFO_LONG.CIL_COMPLETIONID;
pub const CIL_NUMBEROFOWNERS = CALLINFO_LONG.CIL_NUMBEROFOWNERS;
pub const CIL_NUMBEROFMONITORS = CALLINFO_LONG.CIL_NUMBEROFMONITORS;
pub const CIL_TRUNK = CALLINFO_LONG.CIL_TRUNK;
pub const CIL_RATE = CALLINFO_LONG.CIL_RATE;
pub const CIL_GENERATEDIGITDURATION = CALLINFO_LONG.CIL_GENERATEDIGITDURATION;
pub const CIL_MONITORDIGITMODES = CALLINFO_LONG.CIL_MONITORDIGITMODES;
pub const CIL_MONITORMEDIAMODES = CALLINFO_LONG.CIL_MONITORMEDIAMODES;

pub const CALLINFO_STRING = extern enum(i32) {
    CIS_CALLERIDNAME = 0,
...
pub const CIS_CALLERIDNAME = CALLINFO_STRING.CIS_CALLERIDNAME;
pub const CIS_CALLERIDNUMBER = CALLINFO_STRING.CIS_CALLERIDNUMBER;
pub const CIS_CALLEDIDNAME = CALLINFO_STRING.CIS_CALLEDIDNAME;
pub const CIS_CALLEDIDNUMBER = CALLINFO_STRING.CIS_CALLEDIDNUMBER;
pub const CIS_CONNECTEDIDNAME = CALLINFO_STRING.CIS_CONNECTEDIDNAME;
pub const CIS_CONNECTEDIDNUMBER = CALLINFO_STRING.CIS_CONNECTEDIDNUMBER;
pub const CIS_REDIRECTIONIDNAME = CALLINFO_STRING.CIS_REDIRECTIONIDNAME;
pub const CIS_REDIRECTIONIDNUMBER = CALLINFO_STRING.CIS_REDIRECTIONIDNUMBER;
pub const CIS_REDIRECTINGIDNAME = CALLINFO_STRING.CIS_REDIRECTINGIDNAME;
pub const CIS_REDIRECTINGIDNUMBER = CALLINFO_STRING.CIS_REDIRECTINGIDNUMBER;
pub const CIS_CALLEDPARTYFRIENDLYNAME = CALLINFO_STRING.CIS_CALLEDPARTYFRIENDLYNAME;
pub const CIS_COMMENT = CALLINFO_STRING.CIS_COMMENT;
pub const CIS_DISPLAYABLEADDRESS = CALLINFO_STRING.CIS_DISPLAYABLEADDRESS;
pub const CIS_CALLINGPARTYID = CALLINFO_STRING.CIS_CALLINGPARTYID;

pub const CALLINFO_BUFFER = extern enum(i32) {
    CIB_USERUSERINFO = 0,
...
pub const CIB_USERUSERINFO = CALLINFO_BUFFER.CIB_USERUSERINFO;
pub const CIB_DEVSPECIFICBUFFER = CALLINFO_BUFFER.CIB_DEVSPECIFICBUFFER;
pub const CIB_CALLDATABUFFER = CALLINFO_BUFFER.CIB_CALLDATABUFFER;
pub const CIB_CHARGINGINFOBUFFER = CALLINFO_BUFFER.CIB_CHARGINGINFOBUFFER;
pub const CIB_HIGHLEVELCOMPATIBILITYBUFFER = CALLINFO_BUFFER.CIB_HIGHLEVELCOMPATIBILITYBUFFER;
pub const CIB_LOWLEVELCOMPATIBILITYBUFFER = CALLINFO_BUFFER.CIB_LOWLEVELCOMPATIBILITYBUFFER;

pub const ADDRESS_CAPABILITY = extern enum(i32) {
    AC_ADDRESSTYPES = 0,
    AC_BEARERMODES = 1,
    AC_MAXACTIVECALLS = 2,
    AC_MAXONHOLDCALLS = 3,
...
pub const AC_ADDRESSTYPES = ADDRESS_CAPABILITY.AC_ADDRESSTYPES;
pub const AC_BEARERMODES = ADDRESS_CAPABILITY.AC_BEARERMODES;
pub const AC_MAXACTIVECALLS = ADDRESS_CAPABILITY.AC_MAXACTIVECALLS;
pub const AC_MAXONHOLDCALLS = ADDRESS_CAPABILITY.AC_MAXONHOLDCALLS;
pub const AC_MAXONHOLDPENDINGCALLS = ADDRESS_CAPABILITY.AC_MAXONHOLDPENDINGCALLS;
pub const AC_MAXNUMCONFERENCE = ADDRESS_CAPABILITY.AC_MAXNUMCONFERENCE;
pub const AC_MAXNUMTRANSCONF = ADDRESS_CAPABILITY.AC_MAXNUMTRANSCONF;
pub const AC_MONITORDIGITSUPPORT = ADDRESS_CAPABILITY.AC_MONITORDIGITSUPPORT;
pub const AC_GENERATEDIGITSUPPORT = ADDRESS_CAPABILITY.AC_GENERATEDIGITSUPPORT;
pub const AC_GENERATETONEMODES = ADDRESS_CAPABILITY.AC_GENERATETONEMODES;
pub const AC_GENERATETONEMAXNUMFREQ = ADDRESS_CAPABILITY.AC_GENERATETONEMAXNUMFREQ;
pub const AC_MONITORTONEMAXNUMFREQ = ADDRESS_CAPABILITY.AC_MONITORTONEMAXNUMFREQ;
pub const AC_MONITORTONEMAXNUMENTRIES = ADDRESS_CAPABILITY.AC_MONITORTONEMAXNUMENTRIES;
pub const AC_DEVCAPFLAGS = ADDRESS_CAPABILITY.AC_DEVCAPFLAGS;
pub const AC_ANSWERMODES = ADDRESS_CAPABILITY.AC_ANSWERMODES;
pub const AC_LINEFEATURES = ADDRESS_CAPABILITY.AC_LINEFEATURES;
pub const AC_SETTABLEDEVSTATUS = ADDRESS_CAPABILITY.AC_SETTABLEDEVSTATUS;
pub const AC_PARKSUPPORT = ADDRESS_CAPABILITY.AC_PARKSUPPORT;
pub const AC_CALLERIDSUPPORT = ADDRESS_CAPABILITY.AC_CALLERIDSUPPORT;
pub const AC_CALLEDIDSUPPORT = ADDRESS_CAPABILITY.AC_CALLEDIDSUPPORT;
pub const AC_CONNECTEDIDSUPPORT = ADDRESS_CAPABILITY.AC_CONNECTEDIDSUPPORT;
pub const AC_REDIRECTIONIDSUPPORT = ADDRESS_CAPABILITY.AC_REDIRECTIONIDSUPPORT;
pub const AC_REDIRECTINGIDSUPPORT = ADDRESS_CAPABILITY.AC_REDIRECTINGIDSUPPORT;
pub const AC_ADDRESSCAPFLAGS = ADDRESS_CAPABILITY.AC_ADDRESSCAPFLAGS;
pub const AC_CALLFEATURES1 = ADDRESS_CAPABILITY.AC_CALLFEATURES1;
pub const AC_CALLFEATURES2 = ADDRESS_CAPABILITY.AC_CALLFEATURES2;
pub const AC_REMOVEFROMCONFCAPS = ADDRESS_CAPABILITY.AC_REMOVEFROMCONFCAPS;
pub const AC_REMOVEFROMCONFSTATE = ADDRESS_CAPABILITY.AC_REMOVEFROMCONFSTATE;
pub const AC_TRANSFERMODES = ADDRESS_CAPABILITY.AC_TRANSFERMODES;
pub const AC_ADDRESSFEATURES = ADDRESS_CAPABILITY.AC_ADDRESSFEATURES;
pub const AC_PREDICTIVEAUTOTRANSFERSTATES = ADDRESS_CAPABILITY.AC_PREDICTIVEAUTOTRANSFERSTATES;
pub const AC_MAXCALLDATASIZE = ADDRESS_CAPABILITY.AC_MAXCALLDATASIZE;
pub const AC_LINEID = ADDRESS_CAPABILITY.AC_LINEID;
pub const AC_ADDRESSID = ADDRESS_CAPABILITY.AC_ADDRESSID;
pub const AC_FORWARDMODES = ADDRESS_CAPABILITY.AC_FORWARDMODES;
pub const AC_MAXFORWARDENTRIES = ADDRESS_CAPABILITY.AC_MAXFORWARDENTRIES;
pub const AC_MAXSPECIFICENTRIES = ADDRESS_CAPABILITY.AC_MAXSPECIFICENTRIES;
pub const AC_MINFWDNUMRINGS = ADDRESS_CAPABILITY.AC_MINFWDNUMRINGS;
pub const AC_MAXFWDNUMRINGS = ADDRESS_CAPABILITY.AC_MAXFWDNUMRINGS;
pub const AC_MAXCALLCOMPLETIONS = ADDRESS_CAPABILITY.AC_MAXCALLCOMPLETIONS;
pub const AC_CALLCOMPLETIONCONDITIONS = ADDRESS_CAPABILITY.AC_CALLCOMPLETIONCONDITIONS;
pub const AC_CALLCOMPLETIONMODES = ADDRESS_CAPABILITY.AC_CALLCOMPLETIONMODES;
pub const AC_PERMANENTDEVICEID = ADDRESS_CAPABILITY.AC_PERMANENTDEVICEID;
pub const AC_GATHERDIGITSMINTIMEOUT = ADDRESS_CAPABILITY.AC_GATHERDIGITSMINTIMEOUT;
pub const AC_GATHERDIGITSMAXTIMEOUT = ADDRESS_CAPABILITY.AC_GATHERDIGITSMAXTIMEOUT;
pub const AC_GENERATEDIGITMINDURATION = ADDRESS_CAPABILITY.AC_GENERATEDIGITMINDURATION;
pub const AC_GENERATEDIGITMAXDURATION = ADDRESS_CAPABILITY.AC_GENERATEDIGITMAXDURATION;
pub const AC_GENERATEDIGITDEFAULTDURATION = ADDRESS_CAPABILITY.AC_GENERATEDIGITDEFAULTDURATION;

pub const ADDRESS_CAPABILITY_STRING = extern enum(i32) {
    ACS_PROTOCOL = 0,
...
pub const ACS_PROTOCOL = ADDRESS_CAPABILITY_STRING.ACS_PROTOCOL;
pub const ACS_ADDRESSDEVICESPECIFIC = ADDRESS_CAPABILITY_STRING.ACS_ADDRESSDEVICESPECIFIC;
pub const ACS_LINEDEVICESPECIFIC = ADDRESS_CAPABILITY_STRING.ACS_LINEDEVICESPECIFIC;
pub const ACS_PROVIDERSPECIFIC = ADDRESS_CAPABILITY_STRING.ACS_PROVIDERSPECIFIC;
pub const ACS_SWITCHSPECIFIC = ADDRESS_CAPABILITY_STRING.ACS_SWITCHSPECIFIC;
pub const ACS_PERMANENTDEVICEGUID = ADDRESS_CAPABILITY_STRING.ACS_PERMANENTDEVICEGUID;

pub const FULLDUPLEX_SUPPORT = extern enum(i32) {
    FDS_SUPPORTED = 0,
    FDS_NOTSUPPORTED = 1,
    FDS_UNKNOWN = 2,
};
pub const FDS_SUPPORTED = FULLDUPLEX_SUPPORT.FDS_SUPPORTED;
pub const FDS_NOTSUPPORTED = FULLDUPLEX_SUPPORT.FDS_NOTSUPPORTED;
pub const FDS_UNKNOWN = FULLDUPLEX_SUPPORT.FDS_UNKNOWN;

pub const FINISH_MODE = extern enum(i32) {
    FM_ASTRANSFER = 0,
    FM_ASCONFERENCE = 1,
};
pub const FM_ASTRANSFER = FINISH_MODE.FM_ASTRANSFER;
pub const FM_ASCONFERENCE = FINISH_MODE.FM_ASCONFERENCE;

pub const PHONE_PRIVILEGE = extern enum(i32) {
    PP_OWNER = 0,
    PP_MONITOR = 1,
};
pub const PP_OWNER = PHONE_PRIVILEGE.PP_OWNER;
pub const PP_MONITOR = PHONE_PRIVILEGE.PP_MONITOR;

pub const PHONE_HOOK_SWITCH_DEVICE = extern enum(i32) {
    PHSD_HANDSET = 1,
    PHSD_SPEAKERPHONE = 2,
    PHSD_HEADSET = 4,
};
pub const PHSD_HANDSET = PHONE_HOOK_SWITCH_DEVICE.PHSD_HANDSET;
pub const PHSD_SPEAKERPHONE = PHONE_HOOK_SWITCH_DEVICE.PHSD_SPEAKERPHONE;
pub const PHSD_HEADSET = PHONE_HOOK_SWITCH_DEVICE.PHSD_HEADSET;

pub const PHONE_HOOK_SWITCH_STATE = extern enum(i32) {
    PHSS_ONHOOK = 1,
    PHSS_OFFHOOK_MIC_ONLY = 2,
    PHSS_OFFHOOK_SPEAKER_ONLY = 4,
    PHSS_OFFHOOK = 8,
};
pub const PHSS_ONHOOK = PHONE_HOOK_SWITCH_STATE.PHSS_ONHOOK;
pub const PHSS_OFFHOOK_MIC_ONLY = PHONE_HOOK_SWITCH_STATE.PHSS_OFFHOOK_MIC_ONLY;
pub const PHSS_OFFHOOK_SPEAKER_ONLY = PHONE_HOOK_SWITCH_STATE.PHSS_OFFHOOK_SPEAKER_ONLY;
pub const PHSS_OFFHOOK = PHONE_HOOK_SWITCH_STATE.PHSS_OFFHOOK;

pub const PHONE_LAMP_MODE = extern enum(i32) {
    LM_DUMMY = 1,
    LM_OFF = 2,
    LM_STEADY = 4,
    LM_WINK = 8,
...
pub const LM_DUMMY = PHONE_LAMP_MODE.LM_DUMMY;
pub const LM_OFF = PHONE_LAMP_MODE.LM_OFF;
pub const LM_STEADY = PHONE_LAMP_MODE.LM_STEADY;
pub const LM_WINK = PHONE_LAMP_MODE.LM_WINK;
pub const LM_FLASH = PHONE_LAMP_MODE.LM_FLASH;
pub const LM_FLUTTER = PHONE_LAMP_MODE.LM_FLUTTER;
pub const LM_BROKENFLUTTER = PHONE_LAMP_MODE.LM_BROKENFLUTTER;
pub const LM_UNKNOWN = PHONE_LAMP_MODE.LM_UNKNOWN;

pub const PHONECAPS_LONG = extern enum(i32) {
    PCL_HOOKSWITCHES = 0,
...
pub const PCL_HOOKSWITCHES = PHONECAPS_LONG.PCL_HOOKSWITCHES;
pub const PCL_HANDSETHOOKSWITCHMODES = PHONECAPS_LONG.PCL_HANDSETHOOKSWITCHMODES;
pub const PCL_HEADSETHOOKSWITCHMODES = PHONECAPS_LONG.PCL_HEADSETHOOKSWITCHMODES;
pub const PCL_SPEAKERPHONEHOOKSWITCHMODES = PHONECAPS_LONG.PCL_SPEAKERPHONEHOOKSWITCHMODES;
pub const PCL_DISPLAYNUMROWS = PHONECAPS_LONG.PCL_DISPLAYNUMROWS;
pub const PCL_DISPLAYNUMCOLUMNS = PHONECAPS_LONG.PCL_DISPLAYNUMCOLUMNS;
pub const PCL_NUMRINGMODES = PHONECAPS_LONG.PCL_NUMRINGMODES;
pub const PCL_NUMBUTTONLAMPS = PHONECAPS_LONG.PCL_NUMBUTTONLAMPS;
pub const PCL_GENERICPHONE = PHONECAPS_LONG.PCL_GENERICPHONE;

pub const PHONECAPS_STRING = extern enum(i32) {
    PCS_PHONENAME = 0,
    PCS_PHONEINFO = 1,
    PCS_PROVIDERINFO = 2,
};
pub const PCS_PHONENAME = PHONECAPS_STRING.PCS_PHONENAME;
pub const PCS_PHONEINFO = PHONECAPS_STRING.PCS_PHONEINFO;
pub const PCS_PROVIDERINFO = PHONECAPS_STRING.PCS_PROVIDERINFO;

pub const PHONECAPS_BUFFER = extern enum(i32) {
    PCB_DEVSPECIFICBUFFER = 0,
};
pub const PCB_DEVSPECIFICBUFFER = PHONECAPS_BUFFER.PCB_DEVSPECIFICBUFFER;

pub const PHONE_BUTTON_STATE = extern enum(i32) {
    PBS_UP = 1,
    PBS_DOWN = 2,
    PBS_UNKNOWN = 4,
    PBS_UNAVAIL = 8,
};
pub const PBS_UP = PHONE_BUTTON_STATE.PBS_UP;
pub const PBS_DOWN = PHONE_BUTTON_STATE.PBS_DOWN;
pub const PBS_UNKNOWN = PHONE_BUTTON_STATE.PBS_UNKNOWN;
pub const PBS_UNAVAIL = PHONE_BUTTON_STATE.PBS_UNAVAIL;

pub const PHONE_BUTTON_MODE = extern enum(i32) {
    PBM_DUMMY = 0,
    PBM_CALL = 1,
    PBM_FEATURE = 2,
    PBM_KEYPAD = 3,
...
pub const PBM_DUMMY = PHONE_BUTTON_MODE.PBM_DUMMY;
pub const PBM_CALL = PHONE_BUTTON_MODE.PBM_CALL;
pub const PBM_FEATURE = PHONE_BUTTON_MODE.PBM_FEATURE;
pub const PBM_KEYPAD = PHONE_BUTTON_MODE.PBM_KEYPAD;
pub const PBM_LOCAL = PHONE_BUTTON_MODE.PBM_LOCAL;
pub const PBM_DISPLAY = PHONE_BUTTON_MODE.PBM_DISPLAY;

pub const PHONE_BUTTON_FUNCTION = extern enum(i32) {
    PBF_UNKNOWN = 0,
    PBF_CONFERENCE = 1,
    PBF_TRANSFER = 2,
    PBF_DROP = 3,
...
pub const PBF_UNKNOWN = PHONE_BUTTON_FUNCTION.PBF_UNKNOWN;
pub const PBF_CONFERENCE = PHONE_BUTTON_FUNCTION.PBF_CONFERENCE;
pub const PBF_TRANSFER = PHONE_BUTTON_FUNCTION.PBF_TRANSFER;
pub const PBF_DROP = PHONE_BUTTON_FUNCTION.PBF_DROP;
pub const PBF_HOLD = PHONE_BUTTON_FUNCTION.PBF_HOLD;
pub const PBF_RECALL = PHONE_BUTTON_FUNCTION.PBF_RECALL;
pub const PBF_DISCONNECT = PHONE_BUTTON_FUNCTION.PBF_DISCONNECT;
pub const PBF_CONNECT = PHONE_BUTTON_FUNCTION.PBF_CONNECT;
pub const PBF_MSGWAITON = PHONE_BUTTON_FUNCTION.PBF_MSGWAITON;
pub const PBF_MSGWAITOFF = PHONE_BUTTON_FUNCTION.PBF_MSGWAITOFF;
pub const PBF_SELECTRING = PHONE_BUTTON_FUNCTION.PBF_SELECTRING;
pub const PBF_ABBREVDIAL = PHONE_BUTTON_FUNCTION.PBF_ABBREVDIAL;
pub const PBF_FORWARD = PHONE_BUTTON_FUNCTION.PBF_FORWARD;
pub const PBF_PICKUP = PHONE_BUTTON_FUNCTION.PBF_PICKUP;
pub const PBF_RINGAGAIN = PHONE_BUTTON_FUNCTION.PBF_RINGAGAIN;
pub const PBF_PARK = PHONE_BUTTON_FUNCTION.PBF_PARK;
pub const PBF_REJECT = PHONE_BUTTON_FUNCTION.PBF_REJECT;
pub const PBF_REDIRECT = PHONE_BUTTON_FUNCTION.PBF_REDIRECT;
pub const PBF_MUTE = PHONE_BUTTON_FUNCTION.PBF_MUTE;
pub const PBF_VOLUMEUP = PHONE_BUTTON_FUNCTION.PBF_VOLUMEUP;
pub const PBF_VOLUMEDOWN = PHONE_BUTTON_FUNCTION.PBF_VOLUMEDOWN;
pub const PBF_SPEAKERON = PHONE_BUTTON_FUNCTION.PBF_SPEAKERON;
pub const PBF_SPEAKEROFF = PHONE_BUTTON_FUNCTION.PBF_SPEAKEROFF;
pub const PBF_FLASH = PHONE_BUTTON_FUNCTION.PBF_FLASH;
pub const PBF_DATAON = PHONE_BUTTON_FUNCTION.PBF_DATAON;
pub const PBF_DATAOFF = PHONE_BUTTON_FUNCTION.PBF_DATAOFF;
pub const PBF_DONOTDISTURB = PHONE_BUTTON_FUNCTION.PBF_DONOTDISTURB;
pub const PBF_INTERCOM = PHONE_BUTTON_FUNCTION.PBF_INTERCOM;
pub const PBF_BRIDGEDAPP = PHONE_BUTTON_FUNCTION.PBF_BRIDGEDAPP;
pub const PBF_BUSY = PHONE_BUTTON_FUNCTION.PBF_BUSY;
pub const PBF_CALLAPP = PHONE_BUTTON_FUNCTION.PBF_CALLAPP;
pub const PBF_DATETIME = PHONE_BUTTON_FUNCTION.PBF_DATETIME;
pub const PBF_DIRECTORY = PHONE_BUTTON_FUNCTION.PBF_DIRECTORY;
pub const PBF_COVER = PHONE_BUTTON_FUNCTION.PBF_COVER;
pub const PBF_CALLID = PHONE_BUTTON_FUNCTION.PBF_CALLID;
pub const PBF_LASTNUM = PHONE_BUTTON_FUNCTION.PBF_LASTNUM;
pub const PBF_NIGHTSRV = PHONE_BUTTON_FUNCTION.PBF_NIGHTSRV;
pub const PBF_SENDCALLS = PHONE_BUTTON_FUNCTION.PBF_SENDCALLS;
pub const PBF_MSGINDICATOR = PHONE_BUTTON_FUNCTION.PBF_MSGINDICATOR;
pub const PBF_REPDIAL = PHONE_BUTTON_FUNCTION.PBF_REPDIAL;
pub const PBF_SETREPDIAL = PHONE_BUTTON_FUNCTION.PBF_SETREPDIAL;
pub const PBF_SYSTEMSPEED = PHONE_BUTTON_FUNCTION.PBF_SYSTEMSPEED;
pub const PBF_STATIONSPEED = PHONE_BUTTON_FUNCTION.PBF_STATIONSPEED;
pub const PBF_CAMPON = PHONE_BUTTON_FUNCTION.PBF_CAMPON;
pub const PBF_SAVEREPEAT = PHONE_BUTTON_FUNCTION.PBF_SAVEREPEAT;
pub const PBF_QUEUECALL = PHONE_BUTTON_FUNCTION.PBF_QUEUECALL;
pub const PBF_NONE = PHONE_BUTTON_FUNCTION.PBF_NONE;
pub const PBF_SEND = PHONE_BUTTON_FUNCTION.PBF_SEND;

pub const PHONE_TONE = extern enum(i32) {
    PT_KEYPADZERO = 0,
    PT_KEYPADONE = 1,
    PT_KEYPADTWO = 2,
    PT_KEYPADTHREE = 3,
...
pub const PT_KEYPADZERO = PHONE_TONE.PT_KEYPADZERO;
pub const PT_KEYPADONE = PHONE_TONE.PT_KEYPADONE;
pub const PT_KEYPADTWO = PHONE_TONE.PT_KEYPADTWO;
pub const PT_KEYPADTHREE = PHONE_TONE.PT_KEYPADTHREE;
pub const PT_KEYPADFOUR = PHONE_TONE.PT_KEYPADFOUR;
pub const PT_KEYPADFIVE = PHONE_TONE.PT_KEYPADFIVE;
pub const PT_KEYPADSIX = PHONE_TONE.PT_KEYPADSIX;
pub const PT_KEYPADSEVEN = PHONE_TONE.PT_KEYPADSEVEN;
pub const PT_KEYPADEIGHT = PHONE_TONE.PT_KEYPADEIGHT;
pub const PT_KEYPADNINE = PHONE_TONE.PT_KEYPADNINE;
pub const PT_KEYPADSTAR = PHONE_TONE.PT_KEYPADSTAR;
pub const PT_KEYPADPOUND = PHONE_TONE.PT_KEYPADPOUND;
pub const PT_KEYPADA = PHONE_TONE.PT_KEYPADA;
pub const PT_KEYPADB = PHONE_TONE.PT_KEYPADB;
pub const PT_KEYPADC = PHONE_TONE.PT_KEYPADC;
pub const PT_KEYPADD = PHONE_TONE.PT_KEYPADD;
pub const PT_NORMALDIALTONE = PHONE_TONE.PT_NORMALDIALTONE;
pub const PT_EXTERNALDIALTONE = PHONE_TONE.PT_EXTERNALDIALTONE;
pub const PT_BUSY = PHONE_TONE.PT_BUSY;
pub const PT_RINGBACK = PHONE_TONE.PT_RINGBACK;
pub const PT_ERRORTONE = PHONE_TONE.PT_ERRORTONE;
pub const PT_SILENCE = PHONE_TONE.PT_SILENCE;

pub const PHONE_EVENT = extern enum(i32) {
    PE_DISPLAY = 0,
    PE_LAMPMODE = 1,
    PE_RINGMODE = 2,
    PE_RINGVOLUME = 3,
...
pub const PE_DISPLAY = PHONE_EVENT.PE_DISPLAY;
pub const PE_LAMPMODE = PHONE_EVENT.PE_LAMPMODE;
pub const PE_RINGMODE = PHONE_EVENT.PE_RINGMODE;
pub const PE_RINGVOLUME = PHONE_EVENT.PE_RINGVOLUME;
pub const PE_HOOKSWITCH = PHONE_EVENT.PE_HOOKSWITCH;
pub const PE_CAPSCHANGE = PHONE_EVENT.PE_CAPSCHANGE;
pub const PE_BUTTON = PHONE_EVENT.PE_BUTTON;
pub const PE_CLOSE = PHONE_EVENT.PE_CLOSE;
pub const PE_NUMBERGATHERED = PHONE_EVENT.PE_NUMBERGATHERED;
pub const PE_DIALING = PHONE_EVENT.PE_DIALING;
pub const PE_ANSWER = PHONE_EVENT.PE_ANSWER;
pub const PE_DISCONNECT = PHONE_EVENT.PE_DISCONNECT;
pub const PE_LASTITEM = PHONE_EVENT.PE_LASTITEM;
...
pub const TERMINAL_MEDIA_STATE = extern enum(i32) {
    TMS_IDLE = 0,
    TMS_ACTIVE = 1,
    TMS_PAUSED = 2,
    TMS_LASTITEM = 2,
};
pub const TMS_IDLE = TERMINAL_MEDIA_STATE.TMS_IDLE;
pub const TMS_ACTIVE = TERMINAL_MEDIA_STATE.TMS_ACTIVE;
pub const TMS_PAUSED = TERMINAL_MEDIA_STATE.TMS_PAUSED;
pub const TMS_LASTITEM = TERMINAL_MEDIA_STATE.TMS_LASTITEM;

pub const FT_STATE_EVENT_CAUSE = extern enum(i32) {
    FTEC_NORMAL = 0,
    FTEC_END_OF_FILE = 1,
    FTEC_READ_ERROR = 2,
    FTEC_WRITE_ERROR = 3,
};
pub const FTEC_NORMAL = FT_STATE_EVENT_CAUSE.FTEC_NORMAL;
pub const FTEC_END_OF_FILE = FT_STATE_EVENT_CAUSE.FTEC_END_OF_FILE;
pub const FTEC_READ_ERROR = FT_STATE_EVENT_CAUSE.FTEC_READ_ERROR;
pub const FTEC_WRITE_ERROR = FT_STATE_EVENT_CAUSE.FTEC_WRITE_ERROR;
...
pub const AGENT_EVENT = extern enum(i32) {
    AE_NOT_READY = 0,
    AE_READY = 1,
    AE_BUSY_ACD = 2,
    AE_BUSY_INCOMING = 3,
...
pub const AE_NOT_READY = AGENT_EVENT.AE_NOT_READY;
pub const AE_READY = AGENT_EVENT.AE_READY;
pub const AE_BUSY_ACD = AGENT_EVENT.AE_BUSY_ACD;
pub const AE_BUSY_INCOMING = AGENT_EVENT.AE_BUSY_INCOMING;
pub const AE_BUSY_OUTGOING = AGENT_EVENT.AE_BUSY_OUTGOING;
pub const AE_UNKNOWN = AGENT_EVENT.AE_UNKNOWN;

pub const AGENT_STATE = extern enum(i32) {
    AS_NOT_READY = 0,
    AS_READY = 1,
    AS_BUSY_ACD = 2,
    AS_BUSY_INCOMING = 3,
...
pub const AS_NOT_READY = AGENT_STATE.AS_NOT_READY;
pub const AS_READY = AGENT_STATE.AS_READY;
pub const AS_BUSY_ACD = AGENT_STATE.AS_BUSY_ACD;
pub const AS_BUSY_INCOMING = AGENT_STATE.AS_BUSY_INCOMING;
pub const AS_BUSY_OUTGOING = AGENT_STATE.AS_BUSY_OUTGOING;
pub const AS_UNKNOWN = AGENT_STATE.AS_UNKNOWN;

pub const AGENT_SESSION_EVENT = extern enum(i32) {
    ASE_NEW_SESSION = 0,
    ASE_NOT_READY = 1,
    ASE_READY = 2,
    ASE_BUSY = 3,
...
pub const ASE_NEW_SESSION = AGENT_SESSION_EVENT.ASE_NEW_SESSION;
pub const ASE_NOT_READY = AGENT_SESSION_EVENT.ASE_NOT_READY;
pub const ASE_READY = AGENT_SESSION_EVENT.ASE_READY;
pub const ASE_BUSY = AGENT_SESSION_EVENT.ASE_BUSY;
pub const ASE_WRAPUP = AGENT_SESSION_EVENT.ASE_WRAPUP;
pub const ASE_END = AGENT_SESSION_EVENT.ASE_END;

pub const AGENT_SESSION_STATE = extern enum(i32) {
    ASST_NOT_READY = 0,
    ASST_READY = 1,
    ASST_BUSY_ON_CALL = 2,
    ASST_BUSY_WRAPUP = 3,
...
pub const ASST_NOT_READY = AGENT_SESSION_STATE.ASST_NOT_READY;
pub const ASST_READY = AGENT_SESSION_STATE.ASST_READY;
pub const ASST_BUSY_ON_CALL = AGENT_SESSION_STATE.ASST_BUSY_ON_CALL;
pub const ASST_BUSY_WRAPUP = AGENT_SESSION_STATE.ASST_BUSY_WRAPUP;
pub const ASST_SESSION_ENDED = AGENT_SESSION_STATE.ASST_SESSION_ENDED;

pub const AGENTHANDLER_EVENT = extern enum(i32) {
    AHE_NEW_AGENTHANDLER = 0,
    AHE_AGENTHANDLER_REMOVED = 1,
};
pub const AHE_NEW_AGENTHANDLER = AGENTHANDLER_EVENT.AHE_NEW_AGENTHANDLER;
pub const AHE_AGENTHANDLER_REMOVED = AGENTHANDLER_EVENT.AHE_AGENTHANDLER_REMOVED;

pub const ACDGROUP_EVENT = extern enum(i32) {
    ACDGE_NEW_GROUP = 0,
    ACDGE_GROUP_REMOVED = 1,
};
pub const ACDGE_NEW_GROUP = ACDGROUP_EVENT.ACDGE_NEW_GROUP;
pub const ACDGE_GROUP_REMOVED = ACDGROUP_EVENT.ACDGE_GROUP_REMOVED;

pub const ACDQUEUE_EVENT = extern enum(i32) {
    ACDQE_NEW_QUEUE = 0,
    ACDQE_QUEUE_REMOVED = 1,
};
pub const ACDQE_NEW_QUEUE = ACDQUEUE_EVENT.ACDQE_NEW_QUEUE;
pub const ACDQE_QUEUE_REMOVED = ACDQUEUE_EVENT.ACDQE_QUEUE_REMOVED;
...
pub const MSP_ADDRESS_EVENT = extern enum(i32) {
    ADDRESS_TERMINAL_AVAILABLE = 0,
    ADDRESS_TERMINAL_UNAVAILABLE = 1,
};
pub const ADDRESS_TERMINAL_AVAILABLE = MSP_ADDRESS_EVENT.ADDRESS_TERMINAL_AVAILABLE;
pub const ADDRESS_TERMINAL_UNAVAILABLE = MSP_ADDRESS_EVENT.ADDRESS_TERMINAL_UNAVAILABLE;

pub const MSP_CALL_EVENT = extern enum(i32) {
    CALL_NEW_STREAM = 0,
    CALL_STREAM_FAIL = 1,
...
pub const CALL_NEW_STREAM = MSP_CALL_EVENT.CALL_NEW_STREAM;
pub const CALL_STREAM_FAIL = MSP_CALL_EVENT.CALL_STREAM_FAIL;
pub const CALL_TERMINAL_FAIL = MSP_CALL_EVENT.CALL_TERMINAL_FAIL;
pub const CALL_STREAM_NOT_USED = MSP_CALL_EVENT.CALL_STREAM_NOT_USED;
pub const CALL_STREAM_ACTIVE = MSP_CALL_EVENT.CALL_STREAM_ACTIVE;
pub const CALL_STREAM_INACTIVE = MSP_CALL_EVENT.CALL_STREAM_INACTIVE;

pub const MSP_CALL_EVENT_CAUSE = extern enum(i32) {
...
pub const CALL_CAUSE_UNKNOWN = MSP_CALL_EVENT_CAUSE.CALL_CAUSE_UNKNOWN;
pub const CALL_CAUSE_BAD_DEVICE = MSP_CALL_EVENT_CAUSE.CALL_CAUSE_BAD_DEVICE;
pub const CALL_CAUSE_CONNECT_FAIL = MSP_CALL_EVENT_CAUSE.CALL_CAUSE_CONNECT_FAIL;
pub const CALL_CAUSE_LOCAL_REQUEST = MSP_CALL_EVENT_CAUSE.CALL_CAUSE_LOCAL_REQUEST;
pub const CALL_CAUSE_REMOTE_REQUEST = MSP_CALL_EVENT_CAUSE.CALL_CAUSE_REMOTE_REQUEST;
pub const CALL_CAUSE_MEDIA_TIMEOUT = MSP_CALL_EVENT_CAUSE.CALL_CAUSE_MEDIA_TIMEOUT;
pub const CALL_CAUSE_MEDIA_RECOVERED = MSP_CALL_EVENT_CAUSE.CALL_CAUSE_MEDIA_RECOVERED;
pub const CALL_CAUSE_QUALITY_OF_SERVICE = MSP_CALL_EVENT_CAUSE.CALL_CAUSE_QUALITY_OF_SERVICE;

pub const MSP_EVENT = extern enum(i32) {
    ME_ADDRESS_EVENT = 0,
    ME_CALL_EVENT = 1,
    ME_TSP_DATA = 2,
    ME_PRIVATE_EVENT = 3,
...
pub const ME_ADDRESS_EVENT = MSP_EVENT.ME_ADDRESS_EVENT;
pub const ME_CALL_EVENT = MSP_EVENT.ME_CALL_EVENT;
pub const ME_TSP_DATA = MSP_EVENT.ME_TSP_DATA;
pub const ME_PRIVATE_EVENT = MSP_EVENT.ME_PRIVATE_EVENT;
pub const ME_ASR_TERMINAL_EVENT = MSP_EVENT.ME_ASR_TERMINAL_EVENT;
pub const ME_TTS_TERMINAL_EVENT = MSP_EVENT.ME_TTS_TERMINAL_EVENT;
pub const ME_FILE_TERMINAL_EVENT = MSP_EVENT.ME_FILE_TERMINAL_EVENT;
pub const ME_TONE_TERMINAL_EVENT = MSP_EVENT.ME_TONE_TERMINAL_EVENT;
...
pub const DIRECTORY_TYPE = extern enum(i32) {
    DT_NTDS = 1,
    DT_ILS = 2,
};
pub const DT_NTDS = DIRECTORY_TYPE.DT_NTDS;
pub const DT_ILS = DIRECTORY_TYPE.DT_ILS;

pub const DIRECTORY_OBJECT_TYPE = extern enum(i32) {
    OT_CONFERENCE = 1,
    OT_USER = 2,
};
pub const OT_CONFERENCE = DIRECTORY_OBJECT_TYPE.OT_CONFERENCE;
pub const OT_USER = DIRECTORY_OBJECT_TYPE.OT_USER;

pub const RND_ADVERTISING_SCOPE = extern enum(i32) {
    RAS_LOCAL = 1,
    RAS_SITE = 2,
    RAS_REGION = 3,
    RAS_WORLD = 4,
};
pub const RAS_LOCAL = RND_ADVERTISING_SCOPE.RAS_LOCAL;
pub const RAS_SITE = RND_ADVERTISING_SCOPE.RAS_SITE;
pub const RAS_REGION = RND_ADVERTISING_SCOPE.RAS_REGION;
pub const RAS_WORLD = RND_ADVERTISING_SCOPE.RAS_WORLD;
...
pub const ITRendezvous = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn ITRendezvous_CreateDirectoryA(self: *const T, DirectoryType: DIRECTORY_TYPE, pName: BSTR, ppDir: **ITDirectory) callconv(.Inline) HRESULT {
            return @ptrCast(*const ITRendezvous.VTable, self.vtable).CreateDirectoryA(@ptrCast(*const ITRendezvous, self), DirectoryType, pName, ppDir);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
const ALLOCATOR_PROPERTIES = @import("direct_show.zig").ALLOCATOR_PROPERTIES;
