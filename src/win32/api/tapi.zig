...
pub const AE_LASTITEM = ADDRESS_EVENT.LASTITEM;
...
pub const CS_LASTITEM = CALL_STATE.LASTITEM;
...
pub const CME_LASTITEM = CALL_MEDIA_EVENT.LASTITEM;
...
pub const CNE_LASTITEM = CALL_NOTIFICATION_EVENT.LASTITEM;
...
pub const CHE_LASTITEM = CALLHUB_EVENT.LASTITEM;
...
pub const QE_LASTITEM = QOS_EVENT.LASTITEM;
...
pub const CIC_LASTITEM = CALLINFOCHANGE_CAUSE.LASTITEM;
...
pub const PE_LASTITEM = PHONE_EVENT.LASTITEM;
...
pub const TMS_LASTITEM = TERMINAL_MEDIA_STATE.LASTITEM;
...
test {
    ...
    const constant_export_count = 889;
