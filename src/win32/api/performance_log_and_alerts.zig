...
pub const plaPerformanceCounter = DataCollectorType.plaPerformanceCounter;
pub const plaTrace = DataCollectorType.plaTrace;
pub const plaConfiguration = DataCollectorType.plaConfiguration;
pub const plaAlert = DataCollectorType.plaAlert;
pub const plaApiTrace = DataCollectorType.plaApiTrace;
...
pub const plaCommaSeparated = FileFormat.plaCommaSeparated;
pub const plaTabSeparated = FileFormat.plaTabSeparated;
pub const plaSql = FileFormat.plaSql;
pub const plaBinary = FileFormat.plaBinary;
...
pub const plaNone = AutoPathFormat.plaNone;
pub const plaPattern = AutoPathFormat.plaPattern;
pub const plaComputer = AutoPathFormat.plaComputer;
pub const plaMonthDayHour = AutoPathFormat.plaMonthDayHour;
pub const plaSerialNumber = AutoPathFormat.plaSerialNumber;
pub const plaYearDayOfYear = AutoPathFormat.plaYearDayOfYear;
pub const plaYearMonth = AutoPathFormat.plaYearMonth;
pub const plaYearMonthDay = AutoPathFormat.plaYearMonthDay;
pub const plaYearMonthDayHour = AutoPathFormat.plaYearMonthDayHour;
pub const plaMonthDayHourMinute = AutoPathFormat.plaMonthDayHourMinute;
...
pub const plaStopped = DataCollectorSetStatus.plaStopped;
pub const plaRunning = DataCollectorSetStatus.plaRunning;
pub const plaCompiling = DataCollectorSetStatus.plaCompiling;
pub const plaPending = DataCollectorSetStatus.plaPending;
pub const plaUndefined = DataCollectorSetStatus.plaUndefined;
...
pub const plaTimeStamp = ClockType.plaTimeStamp;
pub const plaPerformance = ClockType.plaPerformance;
pub const plaSystem = ClockType.plaSystem;
pub const plaCycle = ClockType.plaCycle;
...
pub const plaFile = StreamMode.plaFile;
pub const plaRealTime = StreamMode.plaRealTime;
pub const plaBoth = StreamMode.plaBoth;
pub const plaBuffering = StreamMode.plaBuffering;
...
pub const plaCreateNew = CommitMode.plaCreateNew;
pub const plaModify = CommitMode.plaModify;
pub const plaCreateOrModify = CommitMode.plaCreateOrModify;
pub const plaUpdateRunningInstance = CommitMode.plaUpdateRunningInstance;
pub const plaFlushTrace = CommitMode.plaFlushTrace;
pub const plaValidateOnly = CommitMode.plaValidateOnly;
...
pub const plaIndex = ValueMapType.plaIndex;
pub const plaFlag = ValueMapType.plaFlag;
pub const plaFlagArray = ValueMapType.plaFlagArray;
pub const plaValidation = ValueMapType.plaValidation;
...
pub const plaRunOnce = WeekDays.plaRunOnce;
pub const plaSunday = WeekDays.plaSunday;
pub const plaMonday = WeekDays.plaMonday;
pub const plaTuesday = WeekDays.plaTuesday;
pub const plaWednesday = WeekDays.plaWednesday;
pub const plaThursday = WeekDays.plaThursday;
pub const plaFriday = WeekDays.plaFriday;
pub const plaSaturday = WeekDays.plaSaturday;
pub const plaEveryday = WeekDays.plaEveryday;

pub const ResourcePolicy = extern enum(i32) {
    plaDeleteLargest = 0,
    plaDeleteOldest = 1,
};
pub const plaDeleteLargest = ResourcePolicy.plaDeleteLargest;
pub const plaDeleteOldest = ResourcePolicy.plaDeleteOldest;
...
pub const plaCreateReport = DataManagerSteps.plaCreateReport;
pub const plaRunRules = DataManagerSteps.plaRunRules;
pub const plaCreateHtml = DataManagerSteps.plaCreateHtml;
pub const plaFolderActions = DataManagerSteps.plaFolderActions;
pub const plaResourceFreeing = DataManagerSteps.plaResourceFreeing;
...
pub const plaCreateCab = FolderActionSteps.plaCreateCab;
pub const plaDeleteData = FolderActionSteps.plaDeleteData;
pub const plaSendCab = FolderActionSteps.plaSendCab;
pub const plaDeleteCab = FolderActionSteps.plaDeleteCab;
pub const plaDeleteReport = FolderActionSteps.plaDeleteReport;
