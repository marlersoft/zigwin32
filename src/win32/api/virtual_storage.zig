...
pub const CREATE_VIRTUAL_DISK_PARAMETERS_BlockSizeInBytesFlags = extern enum(u32) {
    E = 0,
};
pub const CREATE_VIRTUAL_DISK_PARAMETERS_DEFAULT_BLOCK_SIZE = CREATE_VIRTUAL_DISK_PARAMETERS_BlockSizeInBytesFlags.E;
