...
pub const WINHTTP_OPTION_SOURCE_ADDRESS : u32 = 156;
...
pub const HttpSchemeHttp = _HTTP_URI_SCHEME.Http;
pub const HttpSchemeHttps = _HTTP_URI_SCHEME.Https;
pub const HttpSchemeMaximum = _HTTP_URI_SCHEME.Maximum;
...
pub const HTTP_SERVICE_CONFIG_SSL_PARAM = extern struct {
    ...
    DefaultCertCheckMode: HTTP_SERVICE_CONFIG_SSL_PARAM_DefaultCertCheckModeFlags,
...
pub const WINHTTP_ASYNC_RESULT = extern struct {
    dwResult: WINHTTP_ASYNC_RESULT_dwResultFlags,
    dwError: u32,
};
...
pub const URL_COMPONENTS = extern struct {
    ...
    lpszScheme: PWSTR,
    dwSchemeLength: u32,
    nScheme: URL_COMPONENTS_nSchemeFlags,
    lpszHostName: PWSTR,
...
pub const WINHTTP_PROXY_INFO = extern struct {
    dwAccessType: WinHttpOpen_dwAccessTypeFlags,
    lpszProxy: PWSTR,
...
pub const WINHTTP_CREDS = extern struct {
    ...
    lpszPassword: PSTR,
    lpszRealm: PSTR,
    dwAuthScheme: WINHTTP_CREDS_dwAuthScheme,
    lpszHostName: PSTR,
    dwPort: u32,
};
...
pub const WINHTTP_STATUS_CALLBACK = fn(
    ...
    lpvStatusInformation: WINHTTP_STATUS_CALLBACK_lpvStatusInformationFlags,
...
pub const WINHTTP_STATUS_CALLBACK_lpvStatusInformationFlags = extern enum(u32) {
    CERT_REV_FAILED = 1,
    INVALID_CERT = 2,
    CERT_REVOKED = 4,
    INVALID_CA = 8,
    CERT_CN_INVALID = 16,
    CERT_DATE_INVALID = 32,
    SECURITY_CHANNEL_ERROR = 2147483648,
    _,
};
pub const WINHTTP_CALLBACK_STATUS_FLAG_CERT_REV_FAILED = WINHTTP_STATUS_CALLBACK_lpvStatusInformationFlags.CERT_REV_FAILED;
pub const WINHTTP_CALLBACK_STATUS_FLAG_INVALID_CERT = WINHTTP_STATUS_CALLBACK_lpvStatusInformationFlags.INVALID_CERT;
pub const WINHTTP_CALLBACK_STATUS_FLAG_CERT_REVOKED = WINHTTP_STATUS_CALLBACK_lpvStatusInformationFlags.CERT_REVOKED;
pub const WINHTTP_CALLBACK_STATUS_FLAG_INVALID_CA = WINHTTP_STATUS_CALLBACK_lpvStatusInformationFlags.INVALID_CA;
pub const WINHTTP_CALLBACK_STATUS_FLAG_CERT_CN_INVALID = WINHTTP_STATUS_CALLBACK_lpvStatusInformationFlags.CERT_CN_INVALID;
pub const WINHTTP_CALLBACK_STATUS_FLAG_CERT_DATE_INVALID = WINHTTP_STATUS_CALLBACK_lpvStatusInformationFlags.CERT_DATE_INVALID;
pub const WINHTTP_CALLBACK_STATUS_FLAG_SECURITY_CHANNEL_ERROR = WINHTTP_STATUS_CALLBACK_lpvStatusInformationFlags.SECURITY_CHANNEL_ERROR;

pub const WinHttpConnect_nServerPortFlags = extern enum(u32) {
    HTTP_PORT = 80,
    HTTPS_PORT = 443,
    PORT = 0,
};
pub const INTERNET_DEFAULT_HTTP_PORT = WinHttpConnect_nServerPortFlags.HTTP_PORT;
pub const INTERNET_DEFAULT_HTTPS_PORT = WinHttpConnect_nServerPortFlags.HTTPS_PORT;
pub const INTERNET_DEFAULT_PORT = WinHttpConnect_nServerPortFlags.PORT;

// TODO: This Enum is marked as [Flags], what do I do with this?
pub const WinHttpOpenRequest_dwFlags = extern enum(u32) {
...
pub const WINHTTP_FLAG_BYPASS_PROXY_CACHE = WinHttpOpenRequest_dwFlags.BYPASS_PROXY_CACHE;
pub const WINHTTP_FLAG_ESCAPE_DISABLE = WinHttpOpenRequest_dwFlags.ESCAPE_DISABLE;
pub const WINHTTP_FLAG_ESCAPE_DISABLE_QUERY = WinHttpOpenRequest_dwFlags.ESCAPE_DISABLE_QUERY;
pub const WINHTTP_FLAG_ESCAPE_PERCENT = WinHttpOpenRequest_dwFlags.ESCAPE_PERCENT;
pub const WINHTTP_FLAG_NULL_CODEPAGE = WinHttpOpenRequest_dwFlags.NULL_CODEPAGE;
pub const WINHTTP_FLAG_REFRESH = WinHttpOpenRequest_dwFlags.REFRESH;
pub const WINHTTP_FLAG_SECURE = WinHttpOpenRequest_dwFlags.SECURE;

pub const WinHttpCreateUrl_dwFlags = extern enum(u32) {
    ESCAPE = 2147483648,
    REJECT_USERPWD = 16384,
    DECODE = 268435456,
};
pub const ICU_ESCAPE = WinHttpCreateUrl_dwFlags.ESCAPE;
pub const ICU_REJECT_USERPWD = WinHttpCreateUrl_dwFlags.REJECT_USERPWD;
pub const ICU_DECODE = WinHttpCreateUrl_dwFlags.DECODE;

pub const HttpReceiveHttpRequest_Flags = extern enum(u32) {
    COPY_BODY = 1,
    FLUSH_BODY = 2,
};
pub const HTTP_RECEIVE_REQUEST_FLAG_COPY_BODY = HttpReceiveHttpRequest_Flags.COPY_BODY;
pub const HTTP_RECEIVE_REQUEST_FLAG_FLUSH_BODY = HttpReceiveHttpRequest_Flags.FLUSH_BODY;
...
pub const WinHttpOpen_dwAccessTypeFlags = extern enum(u32) {
    NO_PROXY = 1,
    DEFAULT_PROXY = 0,
    NAMED_PROXY = 3,
    AUTOMATIC_PROXY = 4,
};
pub const WINHTTP_ACCESS_TYPE_NO_PROXY = WinHttpOpen_dwAccessTypeFlags.NO_PROXY;
pub const WINHTTP_ACCESS_TYPE_DEFAULT_PROXY = WinHttpOpen_dwAccessTypeFlags.DEFAULT_PROXY;
pub const WINHTTP_ACCESS_TYPE_NAMED_PROXY = WinHttpOpen_dwAccessTypeFlags.NAMED_PROXY;
pub const WINHTTP_ACCESS_TYPE_AUTOMATIC_PROXY = WinHttpOpen_dwAccessTypeFlags.AUTOMATIC_PROXY;

pub const WINHTTP_ASYNC_RESULT_dwResultFlags = extern enum(u32) {
    RECEIVE_RESPONSE = 1,
    QUERY_DATA_AVAILABLE = 2,
    READ_DATA = 3,
    WRITE_DATA = 4,
    SEND_REQUEST = 5,
};
pub const API_RECEIVE_RESPONSE = WINHTTP_ASYNC_RESULT_dwResultFlags.RECEIVE_RESPONSE;
pub const API_QUERY_DATA_AVAILABLE = WINHTTP_ASYNC_RESULT_dwResultFlags.QUERY_DATA_AVAILABLE;
pub const API_READ_DATA = WINHTTP_ASYNC_RESULT_dwResultFlags.READ_DATA;
pub const API_WRITE_DATA = WINHTTP_ASYNC_RESULT_dwResultFlags.WRITE_DATA;
pub const API_SEND_REQUEST = WINHTTP_ASYNC_RESULT_dwResultFlags.SEND_REQUEST;

pub const URL_COMPONENTS_nSchemeFlags = extern enum(u32) {
    P = 1,
    S = 2,
};
pub const INTERNET_SCHEME_HTTP = URL_COMPONENTS_nSchemeFlags.P;
pub const INTERNET_SCHEME_HTTPS = URL_COMPONENTS_nSchemeFlags.S;

pub const HTTP_SERVICE_CONFIG_SSL_PARAM_DefaultCertCheckModeFlags = extern enum(u32) {
    None = 0,
    @"1" = 1,
    @"2" = 2,
    @"4" = 4,
};
pub const DefaultCertCheckMode1 = HTTP_SERVICE_CONFIG_SSL_PARAM_DefaultCertCheckModeFlags.@"1";
pub const DefaultCertCheckMode2 = HTTP_SERVICE_CONFIG_SSL_PARAM_DefaultCertCheckModeFlags.@"2";
pub const DefaultCertCheckMode4 = HTTP_SERVICE_CONFIG_SSL_PARAM_DefaultCertCheckModeFlags.@"4";

pub const WINHTTP_CREDS_dwAuthScheme = extern enum(u32) {
    BASIC = 1,
    NTLM = 2,
    NEGOTIATE = 16,
};
pub const WINHTTP_AUTH_SCHEME_BASIC = WINHTTP_CREDS_dwAuthScheme.BASIC;
pub const WINHTTP_AUTH_SCHEME_NTLM = WINHTTP_CREDS_dwAuthScheme.NTLM;
pub const WINHTTP_AUTH_SCHEME_NEGOTIATE = WINHTTP_CREDS_dwAuthScheme.NEGOTIATE;
...
pub extern "HTTPAPI" fn HttpReceiveHttpRequest(
    RequestQueueHandle: HANDLE,
    RequestId: u64,
    Flags: HttpReceiveHttpRequest_Flags,
...
pub extern "WINHTTP" fn WinHttpConnect(
    ...
    nServerPort: WinHttpConnect_nServerPortFlags,
    dwReserved: u32,
) callconv(@import("std").os.windows.WINAPI) *c_void;
...
pub extern "WINHTTP" fn WinHttpOpenRequest(
    ...
    dwFlags: WinHttpOpenRequest_dwFlags,
) callconv(@import("std").os.windows.WINAPI) *c_void;
...
test {
    ...
    const type_export_count = 146;
    const enum_value_export_count = 337;
