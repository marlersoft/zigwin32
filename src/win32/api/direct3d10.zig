...
pub const D3D10_DEFAULT_BLEND_FACTOR_ALPHA : f32 = 1;
pub const D3D10_DEFAULT_BLEND_FACTOR_BLUE : f32 = 1;
pub const D3D10_DEFAULT_BLEND_FACTOR_GREEN : f32 = 1;
pub const D3D10_DEFAULT_BLEND_FACTOR_RED : f32 = 1;
pub const D3D10_DEFAULT_BORDER_COLOR_COMPONENT : f32 = 0;
pub const D3D10_DEFAULT_DEPTH_BIAS : u32 = 0;
pub const D3D10_DEFAULT_DEPTH_BIAS_CLAMP : f32 = 0;
pub const D3D10_DEFAULT_MAX_ANISOTROPY : f32 = 16;
pub const D3D10_DEFAULT_MIP_LOD_BIAS : f32 = 0;
...
pub const D3D10_DEFAULT_SLOPE_SCALED_DEPTH_BIAS : f32 = 0;
...
pub const D3D10_DEFAULT_VIEWPORT_MAX_DEPTH : f32 = 0;
pub const D3D10_DEFAULT_VIEWPORT_MIN_DEPTH : f32 = 0;
...
pub const D3D10_FLOAT16_FUSED_TOLERANCE_IN_ULP : f64 = 6.0e-01;
pub const D3D10_FLOAT32_MAX : f32 = 3.4028235e+38;
pub const D3D10_FLOAT32_TO_INTEGER_TOLERANCE_IN_ULP : f32 = 6.0e-01;
pub const D3D10_FLOAT_TO_SRGB_EXPONENT_DENOMINATOR : f32 = 2.4e+00;
pub const D3D10_FLOAT_TO_SRGB_EXPONENT_NUMERATOR : f32 = 1;
pub const D3D10_FLOAT_TO_SRGB_OFFSET : f32 = 5.5e-02;
pub const D3D10_FLOAT_TO_SRGB_SCALE_1 : f32 = 1.292e+01;
pub const D3D10_FLOAT_TO_SRGB_SCALE_2 : f32 = 1.055e+00;
pub const D3D10_FLOAT_TO_SRGB_THRESHOLD : f32 = 3.1308e-03;
pub const D3D10_FTOI_INSTRUCTION_MAX_INPUT : f32 = 2.1474836e+09;
pub const D3D10_FTOI_INSTRUCTION_MIN_INPUT : f32 = -2.1474836e+09;
pub const D3D10_FTOU_INSTRUCTION_MAX_INPUT : f32 = 4.2949673e+09;
pub const D3D10_FTOU_INSTRUCTION_MIN_INPUT : f32 = 0;
...
pub const D3D10_LINEAR_GAMMA : f32 = 1;
pub const D3D10_MAX_BORDER_COLOR_COMPONENT : f32 = 1;
pub const D3D10_MAX_DEPTH : f32 = 1;
pub const D3D10_MAX_MAXANISOTROPY : u32 = 16;
pub const D3D10_MAX_MULTISAMPLE_SAMPLE_COUNT : u32 = 32;
pub const D3D10_MAX_POSITION_VALUE : f32 = 3.4028236e+34;
pub const D3D10_MAX_TEXTURE_DIMENSION_2_TO_EXP : u32 = 17;
pub const D3D10_MIN_BORDER_COLOR_COMPONENT : f32 = 0;
pub const D3D10_MIN_DEPTH : f32 = 0;
pub const D3D10_MIN_MAXANISOTROPY : u32 = 0;
pub const D3D10_MIP_LOD_BIAS_MAX : f32 = 1.599e+01;
pub const D3D10_MIP_LOD_BIAS_MIN : f32 = -16;
pub const D3D10_MIP_LOD_FRACTIONAL_BIT_COUNT : u32 = 6;
pub const D3D10_MIP_LOD_RANGE_BIT_COUNT : u32 = 8;
pub const D3D10_MULTISAMPLE_ANTIALIAS_LINE_WIDTH : f32 = 1.4e+00;
...
pub const D3D10_PS_LEGACY_PIXEL_CENTER_FRACTIONAL_COMPONENT : f32 = 0;
...
pub const D3D10_PS_PIXEL_CENTER_FRACTIONAL_COMPONENT : f32 = 5.0e-01;
...
pub const D3D10_SRGB_GAMMA : f32 = 2.2e+00;
pub const D3D10_SRGB_TO_FLOAT_DENOMINATOR_1 : f32 = 1.292e+01;
pub const D3D10_SRGB_TO_FLOAT_DENOMINATOR_2 : f32 = 1.055e+00;
pub const D3D10_SRGB_TO_FLOAT_EXPONENT : f32 = 2.4e+00;
pub const D3D10_SRGB_TO_FLOAT_OFFSET : f32 = 5.5e-02;
pub const D3D10_SRGB_TO_FLOAT_THRESHOLD : f32 = 4.045e-02;
pub const D3D10_SRGB_TO_FLOAT_TOLERANCE_IN_ULP : f32 = 5.0e-01;
...
pub const D3D_SPEC_VERSION : f64 = 1.050005e+00;
...
pub const D3D10_1_FLOAT16_FUSED_TOLERANCE_IN_ULP : f64 = 6.0e-01;
pub const D3D10_1_FLOAT32_TO_INTEGER_TOLERANCE_IN_ULP : f32 = 6.0e-01;
...
pub const DXGI_DEBUG_D3D10 = @import("../zig.zig").Guid.initString("243b4c52-3606-4d3a-99d7-a7e7b33ed706");
...
pub const GUID_DeviceType = @import("../zig.zig").Guid.initString("d722fb4d-7a68-437a-b20c-5804ee2494a6");
...
const IID_ID3D10StateBlock_Value = @import("../zig.zig").Guid.initString("0803425a-57f5-4dd6-9465-a87570834a08");
...
const IID_ID3D10EffectType_Value = @import("../zig.zig").Guid.initString("4e9e1ddc-cd9d-4772-a837-00180b9b88fd");
...
const IID_ID3D10EffectVariable_Value = @import("../zig.zig").Guid.initString("ae897105-00e6-45bf-bb8e-281dd6db8e1b");
...
const IID_ID3D10EffectScalarVariable_Value = @import("../zig.zig").Guid.initString("00e48f7b-d2c8-49e8-a86c-022dee53431f");
...
const IID_ID3D10EffectVectorVariable_Value = @import("../zig.zig").Guid.initString("62b98c44-1f82-4c67-bcd0-72cf8f217e81");
...
const IID_ID3D10EffectMatrixVariable_Value = @import("../zig.zig").Guid.initString("50666c24-b82f-4eed-a172-5b6e7e8522e0");
...
const IID_ID3D10EffectStringVariable_Value = @import("../zig.zig").Guid.initString("71417501-8df9-4e0a-a78a-255f9756baff");
...
const IID_ID3D10EffectShaderResourceVariable_Value = @import("../zig.zig").Guid.initString("c0a7157b-d872-4b1d-8073-efc2acd4b1fc");
...
const IID_ID3D10EffectRenderTargetViewVariable_Value = @import("../zig.zig").Guid.initString("28ca0cc3-c2c9-40bb-b57f-67b737122b17");
...
const IID_ID3D10EffectDepthStencilViewVariable_Value = @import("../zig.zig").Guid.initString("3e02c918-cc79-4985-b622-2d92ad701623");
...
const IID_ID3D10EffectConstantBuffer_Value = @import("../zig.zig").Guid.initString("56648f4d-cc8b-4444-a5ad-b5a3d76e91b3");
...
const IID_ID3D10EffectShaderVariable_Value = @import("../zig.zig").Guid.initString("80849279-c799-4797-8c33-0407a07d9e06");
...
const IID_ID3D10EffectBlendVariable_Value = @import("../zig.zig").Guid.initString("1fcd2294-df6d-4eae-86b3-0e9160cfb07b");
...
const IID_ID3D10EffectDepthStencilVariable_Value = @import("../zig.zig").Guid.initString("af482368-330a-46a5-9a5c-01c71af24c8d");
...
const IID_ID3D10EffectRasterizerVariable_Value = @import("../zig.zig").Guid.initString("21af9f0e-4d94-4ea9-9785-2cb76b8c0b34");
...
const IID_ID3D10EffectSamplerVariable_Value = @import("../zig.zig").Guid.initString("6530d5c7-07e9-4271-a418-e7ce4bd1e480");
...
const IID_ID3D10EffectPass_Value = @import("../zig.zig").Guid.initString("5cfbeb89-1a06-46e0-b282-e3f9bfa36a54");
...
const IID_ID3D10EffectTechnique_Value = @import("../zig.zig").Guid.initString("db122ce8-d1c9-4292-b237-24ed3de8b175");
...
const IID_ID3D10Effect_Value = @import("../zig.zig").Guid.initString("51b0ca8b-ec0b-4519-870d-8ee1cb5017c7");
...
const IID_ID3D10EffectPool_Value = @import("../zig.zig").Guid.initString("9537ab04-3250-412e-8213-fcd2f8677933");
...
const IID_ID3D10ShaderReflection1_Value = @import("../zig.zig").Guid.initString("c3457783-a846-47ce-9520-cea6f66e7447");
