...
// Section: Types (450)
//--------------------------------------------------------------------------------
pub const WS_XML_READER = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_XML_WRITER = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_XML_BUFFER = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_CHANNEL = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_OPERATION_CONTEXT = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_ERROR = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_HEAP = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_LISTENER = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_MESSAGE = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_SECURITY_TOKEN = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_SECURITY_CONTEXT = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_SERVICE_HOST = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_SERVICE_PROXY = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_METADATA = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };

pub const WS_POLICY = extern struct { comment: [*]const u8 = "TODO: why is this struct empty?" };
...
pub const WS_XML_READER_PROPERTY_MAX_DEPTH = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_MAX_DEPTH;
pub const WS_XML_READER_PROPERTY_ALLOW_FRAGMENT = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_ALLOW_FRAGMENT;
pub const WS_XML_READER_PROPERTY_MAX_ATTRIBUTES = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_MAX_ATTRIBUTES;
pub const WS_XML_READER_PROPERTY_READ_DECLARATION = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_READ_DECLARATION;
pub const WS_XML_READER_PROPERTY_CHARSET = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_CHARSET;
pub const WS_XML_READER_PROPERTY_ROW = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_ROW;
pub const WS_XML_READER_PROPERTY_COLUMN = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_COLUMN;
pub const WS_XML_READER_PROPERTY_UTF8_TRIM_SIZE = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_UTF8_TRIM_SIZE;
pub const WS_XML_READER_PROPERTY_STREAM_BUFFER_SIZE = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_STREAM_BUFFER_SIZE;
pub const WS_XML_READER_PROPERTY_IN_ATTRIBUTE = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_IN_ATTRIBUTE;
pub const WS_XML_READER_PROPERTY_STREAM_MAX_ROOT_MIME_PART_SIZE = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_STREAM_MAX_ROOT_MIME_PART_SIZE;
pub const WS_XML_READER_PROPERTY_STREAM_MAX_MIME_HEADERS_SIZE = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_STREAM_MAX_MIME_HEADERS_SIZE;
pub const WS_XML_READER_PROPERTY_MAX_MIME_PARTS = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_MAX_MIME_PARTS;
pub const WS_XML_READER_PROPERTY_ALLOW_INVALID_CHARACTER_REFERENCES = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_ALLOW_INVALID_CHARACTER_REFERENCES;
pub const WS_XML_READER_PROPERTY_MAX_NAMESPACES = WS_XML_READER_PROPERTY_ID.WS_XML_READER_PROPERTY_MAX_NAMESPACES;

pub const WS_XML_CANONICALIZATION_ALGORITHM = extern enum(i32) {
...
pub const WS_EXCLUSIVE_XML_CANONICALIZATION_ALGORITHM = WS_XML_CANONICALIZATION_ALGORITHM.WS_EXCLUSIVE_XML_CANONICALIZATION_ALGORITHM;
pub const WS_EXCLUSIVE_WITH_COMMENTS_XML_CANONICALIZATION_ALGORITHM = WS_XML_CANONICALIZATION_ALGORITHM.WS_EXCLUSIVE_WITH_COMMENTS_XML_CANONICALIZATION_ALGORITHM;
pub const WS_INCLUSIVE_XML_CANONICALIZATION_ALGORITHM = WS_XML_CANONICALIZATION_ALGORITHM.WS_INCLUSIVE_XML_CANONICALIZATION_ALGORITHM;
pub const WS_INCLUSIVE_WITH_COMMENTS_XML_CANONICALIZATION_ALGORITHM = WS_XML_CANONICALIZATION_ALGORITHM.WS_INCLUSIVE_WITH_COMMENTS_XML_CANONICALIZATION_ALGORITHM;

pub const WS_XML_CANONICALIZATION_PROPERTY_ID = extern enum(i32) {
...
pub const WS_XML_CANONICALIZATION_PROPERTY_ALGORITHM = WS_XML_CANONICALIZATION_PROPERTY_ID.WS_XML_CANONICALIZATION_PROPERTY_ALGORITHM;
pub const WS_XML_CANONICALIZATION_PROPERTY_INCLUSIVE_PREFIXES = WS_XML_CANONICALIZATION_PROPERTY_ID.WS_XML_CANONICALIZATION_PROPERTY_INCLUSIVE_PREFIXES;
pub const WS_XML_CANONICALIZATION_PROPERTY_OMITTED_ELEMENT = WS_XML_CANONICALIZATION_PROPERTY_ID.WS_XML_CANONICALIZATION_PROPERTY_OMITTED_ELEMENT;
pub const WS_XML_CANONICALIZATION_PROPERTY_OUTPUT_BUFFER_SIZE = WS_XML_CANONICALIZATION_PROPERTY_ID.WS_XML_CANONICALIZATION_PROPERTY_OUTPUT_BUFFER_SIZE;

pub const WS_XML_WRITER_PROPERTY_ID = extern enum(i32) {
...
pub const WS_XML_WRITER_PROPERTY_MAX_DEPTH = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_MAX_DEPTH;
pub const WS_XML_WRITER_PROPERTY_ALLOW_FRAGMENT = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_ALLOW_FRAGMENT;
pub const WS_XML_WRITER_PROPERTY_MAX_ATTRIBUTES = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_MAX_ATTRIBUTES;
pub const WS_XML_WRITER_PROPERTY_WRITE_DECLARATION = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_WRITE_DECLARATION;
pub const WS_XML_WRITER_PROPERTY_INDENT = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_INDENT;
pub const WS_XML_WRITER_PROPERTY_BUFFER_TRIM_SIZE = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_BUFFER_TRIM_SIZE;
pub const WS_XML_WRITER_PROPERTY_CHARSET = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_CHARSET;
pub const WS_XML_WRITER_PROPERTY_BUFFERS = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_BUFFERS;
pub const WS_XML_WRITER_PROPERTY_BUFFER_MAX_SIZE = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_BUFFER_MAX_SIZE;
pub const WS_XML_WRITER_PROPERTY_BYTES = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_BYTES;
pub const WS_XML_WRITER_PROPERTY_IN_ATTRIBUTE = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_IN_ATTRIBUTE;
pub const WS_XML_WRITER_PROPERTY_MAX_MIME_PARTS_BUFFER_SIZE = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_MAX_MIME_PARTS_BUFFER_SIZE;
pub const WS_XML_WRITER_PROPERTY_INITIAL_BUFFER = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_INITIAL_BUFFER;
pub const WS_XML_WRITER_PROPERTY_ALLOW_INVALID_CHARACTER_REFERENCES = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_ALLOW_INVALID_CHARACTER_REFERENCES;
pub const WS_XML_WRITER_PROPERTY_MAX_NAMESPACES = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_MAX_NAMESPACES;
pub const WS_XML_WRITER_PROPERTY_BYTES_WRITTEN = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_BYTES_WRITTEN;
pub const WS_XML_WRITER_PROPERTY_BYTES_TO_CLOSE = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_BYTES_TO_CLOSE;
pub const WS_XML_WRITER_PROPERTY_COMPRESS_EMPTY_ELEMENTS = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_COMPRESS_EMPTY_ELEMENTS;
pub const WS_XML_WRITER_PROPERTY_EMIT_UNCOMPRESSED_EMPTY_ELEMENTS = WS_XML_WRITER_PROPERTY_ID.WS_XML_WRITER_PROPERTY_EMIT_UNCOMPRESSED_EMPTY_ELEMENTS;

pub const WS_XML_BUFFER_PROPERTY_ID = extern enum(i32) {
    _
};

pub const WS_XML_TEXT_TYPE = extern enum(i32) {
    UTF8 = 1,
    UTF16 = 2,
    BASE64 = 3,
    BOOL = 4,
...
pub const WS_XML_NODE_TYPE = extern enum(i32) {
    ELEMENT = 1,
    TEXT = 2,
    END_ELEMENT = 3,
    COMMENT = 4,
...
pub const WS_MOVE_TO = extern enum(i32) {
    ROOT_ELEMENT = 0,
    NEXT_ELEMENT = 1,
    PREVIOUS_ELEMENT = 2,
    CHILD_ELEMENT = 3,
...
pub const WS_VALUE_TYPE = extern enum(i32) {
...
pub const WS_BOOL_VALUE_TYPE = WS_VALUE_TYPE.WS_BOOL_VALUE_TYPE;
pub const WS_INT8_VALUE_TYPE = WS_VALUE_TYPE.WS_INT8_VALUE_TYPE;
pub const WS_INT16_VALUE_TYPE = WS_VALUE_TYPE.WS_INT16_VALUE_TYPE;
pub const WS_INT32_VALUE_TYPE = WS_VALUE_TYPE.WS_INT32_VALUE_TYPE;
pub const WS_INT64_VALUE_TYPE = WS_VALUE_TYPE.WS_INT64_VALUE_TYPE;
pub const WS_UINT8_VALUE_TYPE = WS_VALUE_TYPE.WS_UINT8_VALUE_TYPE;
pub const WS_UINT16_VALUE_TYPE = WS_VALUE_TYPE.WS_UINT16_VALUE_TYPE;
pub const WS_UINT32_VALUE_TYPE = WS_VALUE_TYPE.WS_UINT32_VALUE_TYPE;
pub const WS_UINT64_VALUE_TYPE = WS_VALUE_TYPE.WS_UINT64_VALUE_TYPE;
pub const WS_FLOAT_VALUE_TYPE = WS_VALUE_TYPE.WS_FLOAT_VALUE_TYPE;
pub const WS_DOUBLE_VALUE_TYPE = WS_VALUE_TYPE.WS_DOUBLE_VALUE_TYPE;
pub const WS_DECIMAL_VALUE_TYPE = WS_VALUE_TYPE.WS_DECIMAL_VALUE_TYPE;
pub const WS_DATETIME_VALUE_TYPE = WS_VALUE_TYPE.WS_DATETIME_VALUE_TYPE;
pub const WS_TIMESPAN_VALUE_TYPE = WS_VALUE_TYPE.WS_TIMESPAN_VALUE_TYPE;
pub const WS_GUID_VALUE_TYPE = WS_VALUE_TYPE.WS_GUID_VALUE_TYPE;
pub const WS_DURATION_VALUE_TYPE = WS_VALUE_TYPE.WS_DURATION_VALUE_TYPE;

pub const WS_XML_READER_INPUT_TYPE = extern enum(i32) {
    BUFFER = 1,
    STREAM = 2,
};
...
pub const WS_XML_READER_ENCODING_TYPE = extern enum(i32) {
    TEXT = 1,
    BINARY = 2,
    MTOM = 3,
    RAW = 4,
...
pub const WS_CHARSET = extern enum(i32) {
    AUTO = 0,
    UTF8 = 1,
    UTF16LE = 2,
    UTF16BE = 3,
...
pub const WS_XML_WRITER_ENCODING_TYPE = extern enum(i32) {
    TEXT = 1,
    BINARY = 2,
    MTOM = 3,
    RAW = 4,
...
pub const WS_XML_WRITER_OUTPUT_TYPE = extern enum(i32) {
    BUFFER = 1,
    STREAM = 2,
};
...
pub const WS_CALLBACK_MODEL = extern enum(i32) {
    WS_SHORT_CALLBACK = 0,
    WS_LONG_CALLBACK = 1,
};
pub const WS_SHORT_CALLBACK = WS_CALLBACK_MODEL.WS_SHORT_CALLBACK;
pub const WS_LONG_CALLBACK = WS_CALLBACK_MODEL.WS_LONG_CALLBACK;

pub const WS_ENCODING = extern enum(i32) {
    XML_BINARY_1 = 0,
...
pub const WS_CHANNEL_STATE = extern enum(i32) {
    CREATED = 0,
    OPENING = 1,
    ACCEPTING = 2,
    OPEN = 3,
...
pub const WS_RECEIVE_OPTION = extern enum(i32) {
    WS_RECEIVE_REQUIRED_MESSAGE = 1,
    WS_RECEIVE_OPTIONAL_MESSAGE = 2,
};
pub const WS_RECEIVE_REQUIRED_MESSAGE = WS_RECEIVE_OPTION.WS_RECEIVE_REQUIRED_MESSAGE;
pub const WS_RECEIVE_OPTIONAL_MESSAGE = WS_RECEIVE_OPTION.WS_RECEIVE_OPTIONAL_MESSAGE;

pub const WS_CHANNEL_BINDING = extern enum(i32) {
...
pub const WS_HTTP_CHANNEL_BINDING = WS_CHANNEL_BINDING.WS_HTTP_CHANNEL_BINDING;
pub const WS_TCP_CHANNEL_BINDING = WS_CHANNEL_BINDING.WS_TCP_CHANNEL_BINDING;
pub const WS_UDP_CHANNEL_BINDING = WS_CHANNEL_BINDING.WS_UDP_CHANNEL_BINDING;
pub const WS_CUSTOM_CHANNEL_BINDING = WS_CHANNEL_BINDING.WS_CUSTOM_CHANNEL_BINDING;
pub const WS_NAMEDPIPE_CHANNEL_BINDING = WS_CHANNEL_BINDING.WS_NAMEDPIPE_CHANNEL_BINDING;

pub const WS_CHANNEL_TYPE = extern enum(i32) {
    INPUT = 1,
    OUTPUT = 2,
    SESSION = 4,
    INPUT_SESSION = 5,
...
pub const WS_TRANSFER_MODE = extern enum(i32) {
...
pub const WS_STREAMED_INPUT_TRANSFER_MODE = WS_TRANSFER_MODE.WS_STREAMED_INPUT_TRANSFER_MODE;
pub const WS_STREAMED_OUTPUT_TRANSFER_MODE = WS_TRANSFER_MODE.WS_STREAMED_OUTPUT_TRANSFER_MODE;
pub const WS_BUFFERED_TRANSFER_MODE = WS_TRANSFER_MODE.WS_BUFFERED_TRANSFER_MODE;
pub const WS_STREAMED_TRANSFER_MODE = WS_TRANSFER_MODE.WS_STREAMED_TRANSFER_MODE;

pub const WS_HTTP_PROXY_SETTING_MODE = extern enum(i32) {
    AUTO = 1,
    NONE = 2,
    CUSTOM = 3,
};
...
pub const WS_CHANNEL_PROPERTY_ID = extern enum(i32) {
...
pub const WS_CHANNEL_PROPERTY_MAX_BUFFERED_MESSAGE_SIZE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_MAX_BUFFERED_MESSAGE_SIZE;
pub const WS_CHANNEL_PROPERTY_MAX_STREAMED_MESSAGE_SIZE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_MAX_STREAMED_MESSAGE_SIZE;
pub const WS_CHANNEL_PROPERTY_MAX_STREAMED_START_SIZE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_MAX_STREAMED_START_SIZE;
pub const WS_CHANNEL_PROPERTY_MAX_STREAMED_FLUSH_SIZE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_MAX_STREAMED_FLUSH_SIZE;
pub const WS_CHANNEL_PROPERTY_ENCODING = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_ENCODING;
pub const WS_CHANNEL_PROPERTY_ENVELOPE_VERSION = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_ENVELOPE_VERSION;
pub const WS_CHANNEL_PROPERTY_ADDRESSING_VERSION = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_ADDRESSING_VERSION;
pub const WS_CHANNEL_PROPERTY_MAX_SESSION_DICTIONARY_SIZE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_MAX_SESSION_DICTIONARY_SIZE;
pub const WS_CHANNEL_PROPERTY_STATE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_STATE;
pub const WS_CHANNEL_PROPERTY_ASYNC_CALLBACK_MODEL = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_ASYNC_CALLBACK_MODEL;
pub const WS_CHANNEL_PROPERTY_IP_VERSION = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_IP_VERSION;
pub const WS_CHANNEL_PROPERTY_RESOLVE_TIMEOUT = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_RESOLVE_TIMEOUT;
pub const WS_CHANNEL_PROPERTY_CONNECT_TIMEOUT = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_CONNECT_TIMEOUT;
pub const WS_CHANNEL_PROPERTY_SEND_TIMEOUT = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_SEND_TIMEOUT;
pub const WS_CHANNEL_PROPERTY_RECEIVE_RESPONSE_TIMEOUT = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_RECEIVE_RESPONSE_TIMEOUT;
pub const WS_CHANNEL_PROPERTY_RECEIVE_TIMEOUT = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_RECEIVE_TIMEOUT;
pub const WS_CHANNEL_PROPERTY_CLOSE_TIMEOUT = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_CLOSE_TIMEOUT;
pub const WS_CHANNEL_PROPERTY_ENABLE_TIMEOUTS = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_ENABLE_TIMEOUTS;
pub const WS_CHANNEL_PROPERTY_TRANSFER_MODE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_TRANSFER_MODE;
pub const WS_CHANNEL_PROPERTY_MULTICAST_INTERFACE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_MULTICAST_INTERFACE;
pub const WS_CHANNEL_PROPERTY_MULTICAST_HOPS = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_MULTICAST_HOPS;
pub const WS_CHANNEL_PROPERTY_REMOTE_ADDRESS = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_REMOTE_ADDRESS;
pub const WS_CHANNEL_PROPERTY_REMOTE_IP_ADDRESS = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_REMOTE_IP_ADDRESS;
pub const WS_CHANNEL_PROPERTY_HTTP_CONNECTION_ID = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_HTTP_CONNECTION_ID;
pub const WS_CHANNEL_PROPERTY_CUSTOM_CHANNEL_CALLBACKS = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_CUSTOM_CHANNEL_CALLBACKS;
pub const WS_CHANNEL_PROPERTY_CUSTOM_CHANNEL_PARAMETERS = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_CUSTOM_CHANNEL_PARAMETERS;
pub const WS_CHANNEL_PROPERTY_CUSTOM_CHANNEL_INSTANCE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_CUSTOM_CHANNEL_INSTANCE;
pub const WS_CHANNEL_PROPERTY_TRANSPORT_URL = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_TRANSPORT_URL;
pub const WS_CHANNEL_PROPERTY_NO_DELAY = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_NO_DELAY;
pub const WS_CHANNEL_PROPERTY_SEND_KEEP_ALIVES = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_SEND_KEEP_ALIVES;
pub const WS_CHANNEL_PROPERTY_KEEP_ALIVE_TIME = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_KEEP_ALIVE_TIME;
pub const WS_CHANNEL_PROPERTY_KEEP_ALIVE_INTERVAL = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_KEEP_ALIVE_INTERVAL;
pub const WS_CHANNEL_PROPERTY_MAX_HTTP_SERVER_CONNECTIONS = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_MAX_HTTP_SERVER_CONNECTIONS;
pub const WS_CHANNEL_PROPERTY_IS_SESSION_SHUT_DOWN = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_IS_SESSION_SHUT_DOWN;
pub const WS_CHANNEL_PROPERTY_CHANNEL_TYPE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_CHANNEL_TYPE;
pub const WS_CHANNEL_PROPERTY_TRIM_BUFFERED_MESSAGE_SIZE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_TRIM_BUFFERED_MESSAGE_SIZE;
pub const WS_CHANNEL_PROPERTY_ENCODER = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_ENCODER;
pub const WS_CHANNEL_PROPERTY_DECODER = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_DECODER;
pub const WS_CHANNEL_PROPERTY_PROTECTION_LEVEL = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_PROTECTION_LEVEL;
pub const WS_CHANNEL_PROPERTY_COOKIE_MODE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_COOKIE_MODE;
pub const WS_CHANNEL_PROPERTY_HTTP_PROXY_SETTING_MODE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_HTTP_PROXY_SETTING_MODE;
pub const WS_CHANNEL_PROPERTY_CUSTOM_HTTP_PROXY = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_CUSTOM_HTTP_PROXY;
pub const WS_CHANNEL_PROPERTY_HTTP_MESSAGE_MAPPING = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_HTTP_MESSAGE_MAPPING;
pub const WS_CHANNEL_PROPERTY_ENABLE_HTTP_REDIRECT = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_ENABLE_HTTP_REDIRECT;
pub const WS_CHANNEL_PROPERTY_HTTP_REDIRECT_CALLBACK_CONTEXT = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_HTTP_REDIRECT_CALLBACK_CONTEXT;
pub const WS_CHANNEL_PROPERTY_FAULTS_AS_ERRORS = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_FAULTS_AS_ERRORS;
pub const WS_CHANNEL_PROPERTY_ALLOW_UNSECURED_FAULTS = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_ALLOW_UNSECURED_FAULTS;
pub const WS_CHANNEL_PROPERTY_HTTP_SERVER_SPN = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_HTTP_SERVER_SPN;
pub const WS_CHANNEL_PROPERTY_HTTP_PROXY_SPN = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_HTTP_PROXY_SPN;
pub const WS_CHANNEL_PROPERTY_MAX_HTTP_REQUEST_HEADERS_BUFFER_SIZE = WS_CHANNEL_PROPERTY_ID.WS_CHANNEL_PROPERTY_MAX_HTTP_REQUEST_HEADERS_BUFFER_SIZE;

pub const WS_COOKIE_MODE = extern enum(i32) {
    WS_MANUAL_COOKIE_MODE = 1,
    WS_AUTO_COOKIE_MODE = 2,
};
pub const WS_MANUAL_COOKIE_MODE = WS_COOKIE_MODE.WS_MANUAL_COOKIE_MODE;
pub const WS_AUTO_COOKIE_MODE = WS_COOKIE_MODE.WS_AUTO_COOKIE_MODE;

pub const WS_OPERATION_CONTEXT_PROPERTY_ID = extern enum(i32) {
...
pub const WS_OPERATION_CONTEXT_PROPERTY_CHANNEL = WS_OPERATION_CONTEXT_PROPERTY_ID.WS_OPERATION_CONTEXT_PROPERTY_CHANNEL;
pub const WS_OPERATION_CONTEXT_PROPERTY_CONTRACT_DESCRIPTION = WS_OPERATION_CONTEXT_PROPERTY_ID.WS_OPERATION_CONTEXT_PROPERTY_CONTRACT_DESCRIPTION;
pub const WS_OPERATION_CONTEXT_PROPERTY_HOST_USER_STATE = WS_OPERATION_CONTEXT_PROPERTY_ID.WS_OPERATION_CONTEXT_PROPERTY_HOST_USER_STATE;
pub const WS_OPERATION_CONTEXT_PROPERTY_CHANNEL_USER_STATE = WS_OPERATION_CONTEXT_PROPERTY_ID.WS_OPERATION_CONTEXT_PROPERTY_CHANNEL_USER_STATE;
pub const WS_OPERATION_CONTEXT_PROPERTY_INPUT_MESSAGE = WS_OPERATION_CONTEXT_PROPERTY_ID.WS_OPERATION_CONTEXT_PROPERTY_INPUT_MESSAGE;
pub const WS_OPERATION_CONTEXT_PROPERTY_OUTPUT_MESSAGE = WS_OPERATION_CONTEXT_PROPERTY_ID.WS_OPERATION_CONTEXT_PROPERTY_OUTPUT_MESSAGE;
pub const WS_OPERATION_CONTEXT_PROPERTY_HEAP = WS_OPERATION_CONTEXT_PROPERTY_ID.WS_OPERATION_CONTEXT_PROPERTY_HEAP;
pub const WS_OPERATION_CONTEXT_PROPERTY_LISTENER = WS_OPERATION_CONTEXT_PROPERTY_ID.WS_OPERATION_CONTEXT_PROPERTY_LISTENER;
pub const WS_OPERATION_CONTEXT_PROPERTY_ENDPOINT_ADDRESS = WS_OPERATION_CONTEXT_PROPERTY_ID.WS_OPERATION_CONTEXT_PROPERTY_ENDPOINT_ADDRESS;

pub const WS_ENDPOINT_IDENTITY_TYPE = extern enum(i32) {
...
pub const WS_DNS_ENDPOINT_IDENTITY_TYPE = WS_ENDPOINT_IDENTITY_TYPE.WS_DNS_ENDPOINT_IDENTITY_TYPE;
pub const WS_UPN_ENDPOINT_IDENTITY_TYPE = WS_ENDPOINT_IDENTITY_TYPE.WS_UPN_ENDPOINT_IDENTITY_TYPE;
pub const WS_SPN_ENDPOINT_IDENTITY_TYPE = WS_ENDPOINT_IDENTITY_TYPE.WS_SPN_ENDPOINT_IDENTITY_TYPE;
pub const WS_RSA_ENDPOINT_IDENTITY_TYPE = WS_ENDPOINT_IDENTITY_TYPE.WS_RSA_ENDPOINT_IDENTITY_TYPE;
pub const WS_CERT_ENDPOINT_IDENTITY_TYPE = WS_ENDPOINT_IDENTITY_TYPE.WS_CERT_ENDPOINT_IDENTITY_TYPE;
pub const WS_UNKNOWN_ENDPOINT_IDENTITY_TYPE = WS_ENDPOINT_IDENTITY_TYPE.WS_UNKNOWN_ENDPOINT_IDENTITY_TYPE;

pub const WS_ENDPOINT_ADDRESS_EXTENSION_TYPE = extern enum(i32) {
    WS_ENDPOINT_ADDRESS_EXTENSION_METADATA_ADDRESS = 1,
};
pub const WS_ENDPOINT_ADDRESS_EXTENSION_METADATA_ADDRESS = WS_ENDPOINT_ADDRESS_EXTENSION_TYPE.WS_ENDPOINT_ADDRESS_EXTENSION_METADATA_ADDRESS;

pub const WS_ERROR_PROPERTY_ID = extern enum(i32) {
    WS_ERROR_PROPERTY_STRING_COUNT = 0,
    WS_ERROR_PROPERTY_ORIGINAL_ERROR_CODE = 1,
    WS_ERROR_PROPERTY_LANGID = 2,
};
pub const WS_ERROR_PROPERTY_STRING_COUNT = WS_ERROR_PROPERTY_ID.WS_ERROR_PROPERTY_STRING_COUNT;
pub const WS_ERROR_PROPERTY_ORIGINAL_ERROR_CODE = WS_ERROR_PROPERTY_ID.WS_ERROR_PROPERTY_ORIGINAL_ERROR_CODE;
pub const WS_ERROR_PROPERTY_LANGID = WS_ERROR_PROPERTY_ID.WS_ERROR_PROPERTY_LANGID;

pub const WS_EXCEPTION_CODE = extern enum(i32) {
...
pub const WS_FAULT_ERROR_PROPERTY_ID = extern enum(i32) {
    WS_FAULT_ERROR_PROPERTY_FAULT = 0,
    WS_FAULT_ERROR_PROPERTY_ACTION = 1,
    WS_FAULT_ERROR_PROPERTY_HEADER = 2,
};
pub const WS_FAULT_ERROR_PROPERTY_FAULT = WS_FAULT_ERROR_PROPERTY_ID.WS_FAULT_ERROR_PROPERTY_FAULT;
pub const WS_FAULT_ERROR_PROPERTY_ACTION = WS_FAULT_ERROR_PROPERTY_ID.WS_FAULT_ERROR_PROPERTY_ACTION;
pub const WS_FAULT_ERROR_PROPERTY_HEADER = WS_FAULT_ERROR_PROPERTY_ID.WS_FAULT_ERROR_PROPERTY_HEADER;

pub const WS_FAULT_DISCLOSURE = extern enum(i32) {
    WS_MINIMAL_FAULT_DISCLOSURE = 0,
    WS_FULL_FAULT_DISCLOSURE = 1,
};
pub const WS_MINIMAL_FAULT_DISCLOSURE = WS_FAULT_DISCLOSURE.WS_MINIMAL_FAULT_DISCLOSURE;
pub const WS_FULL_FAULT_DISCLOSURE = WS_FAULT_DISCLOSURE.WS_FULL_FAULT_DISCLOSURE;

pub const WS_HEAP_PROPERTY_ID = extern enum(i32) {
    WS_HEAP_PROPERTY_MAX_SIZE = 0,
    WS_HEAP_PROPERTY_TRIM_SIZE = 1,
    WS_HEAP_PROPERTY_REQUESTED_SIZE = 2,
    WS_HEAP_PROPERTY_ACTUAL_SIZE = 3,
};
pub const WS_HEAP_PROPERTY_MAX_SIZE = WS_HEAP_PROPERTY_ID.WS_HEAP_PROPERTY_MAX_SIZE;
pub const WS_HEAP_PROPERTY_TRIM_SIZE = WS_HEAP_PROPERTY_ID.WS_HEAP_PROPERTY_TRIM_SIZE;
pub const WS_HEAP_PROPERTY_REQUESTED_SIZE = WS_HEAP_PROPERTY_ID.WS_HEAP_PROPERTY_REQUESTED_SIZE;
pub const WS_HEAP_PROPERTY_ACTUAL_SIZE = WS_HEAP_PROPERTY_ID.WS_HEAP_PROPERTY_ACTUAL_SIZE;

pub const WS_LISTENER_STATE = extern enum(i32) {
    CREATED = 0,
    OPENING = 1,
    OPEN = 2,
    FAULTED = 3,
...
pub const WS_LISTENER_PROPERTY_ID = extern enum(i32) {
...
pub const WS_LISTENER_PROPERTY_LISTEN_BACKLOG = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_LISTEN_BACKLOG;
pub const WS_LISTENER_PROPERTY_IP_VERSION = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_IP_VERSION;
pub const WS_LISTENER_PROPERTY_STATE = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_STATE;
pub const WS_LISTENER_PROPERTY_ASYNC_CALLBACK_MODEL = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_ASYNC_CALLBACK_MODEL;
pub const WS_LISTENER_PROPERTY_CHANNEL_TYPE = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_CHANNEL_TYPE;
pub const WS_LISTENER_PROPERTY_CHANNEL_BINDING = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_CHANNEL_BINDING;
pub const WS_LISTENER_PROPERTY_CONNECT_TIMEOUT = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_CONNECT_TIMEOUT;
pub const WS_LISTENER_PROPERTY_IS_MULTICAST = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_IS_MULTICAST;
pub const WS_LISTENER_PROPERTY_MULTICAST_INTERFACES = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_MULTICAST_INTERFACES;
pub const WS_LISTENER_PROPERTY_MULTICAST_LOOPBACK = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_MULTICAST_LOOPBACK;
pub const WS_LISTENER_PROPERTY_CLOSE_TIMEOUT = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_CLOSE_TIMEOUT;
pub const WS_LISTENER_PROPERTY_TO_HEADER_MATCHING_OPTIONS = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_TO_HEADER_MATCHING_OPTIONS;
pub const WS_LISTENER_PROPERTY_TRANSPORT_URL_MATCHING_OPTIONS = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_TRANSPORT_URL_MATCHING_OPTIONS;
pub const WS_LISTENER_PROPERTY_CUSTOM_LISTENER_CALLBACKS = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_CUSTOM_LISTENER_CALLBACKS;
pub const WS_LISTENER_PROPERTY_CUSTOM_LISTENER_PARAMETERS = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_CUSTOM_LISTENER_PARAMETERS;
pub const WS_LISTENER_PROPERTY_CUSTOM_LISTENER_INSTANCE = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_CUSTOM_LISTENER_INSTANCE;
pub const WS_LISTENER_PROPERTY_DISALLOWED_USER_AGENT = WS_LISTENER_PROPERTY_ID.WS_LISTENER_PROPERTY_DISALLOWED_USER_AGENT;

pub const WS_IP_VERSION = extern enum(i32) {
    _4 = 1,
    _6 = 2,
    AUTO = 3,
};
pub const WS_IP_VERSION_4 = WS_IP_VERSION._4;
pub const WS_IP_VERSION_6 = WS_IP_VERSION._6;
pub const WS_IP_VERSION_AUTO = WS_IP_VERSION.AUTO;

pub const WS_MESSAGE_STATE = extern enum(i32) {
    EMPTY = 1,
    INITIALIZED = 2,
    READING = 3,
    WRITING = 4,
...
pub const WS_MESSAGE_INITIALIZATION = extern enum(i32) {
    WS_BLANK_MESSAGE = 0,
...
pub const WS_BLANK_MESSAGE = WS_MESSAGE_INITIALIZATION.WS_BLANK_MESSAGE;
pub const WS_DUPLICATE_MESSAGE = WS_MESSAGE_INITIALIZATION.WS_DUPLICATE_MESSAGE;
pub const WS_REQUEST_MESSAGE = WS_MESSAGE_INITIALIZATION.WS_REQUEST_MESSAGE;
pub const WS_REPLY_MESSAGE = WS_MESSAGE_INITIALIZATION.WS_REPLY_MESSAGE;
pub const WS_FAULT_MESSAGE = WS_MESSAGE_INITIALIZATION.WS_FAULT_MESSAGE;

pub const WS_REPEATING_HEADER_OPTION = extern enum(i32) {
    WS_REPEATING_HEADER = 1,
    WS_SINGLETON_HEADER = 2,
};
pub const WS_REPEATING_HEADER = WS_REPEATING_HEADER_OPTION.WS_REPEATING_HEADER;
pub const WS_SINGLETON_HEADER = WS_REPEATING_HEADER_OPTION.WS_SINGLETON_HEADER;

pub const WS_HEADER_TYPE = extern enum(i32) {
    WS_ACTION_HEADER = 1,
    WS_TO_HEADER = 2,
...
pub const WS_ACTION_HEADER = WS_HEADER_TYPE.WS_ACTION_HEADER;
pub const WS_TO_HEADER = WS_HEADER_TYPE.WS_TO_HEADER;
pub const WS_MESSAGE_ID_HEADER = WS_HEADER_TYPE.WS_MESSAGE_ID_HEADER;
pub const WS_RELATES_TO_HEADER = WS_HEADER_TYPE.WS_RELATES_TO_HEADER;
pub const WS_FROM_HEADER = WS_HEADER_TYPE.WS_FROM_HEADER;
pub const WS_REPLY_TO_HEADER = WS_HEADER_TYPE.WS_REPLY_TO_HEADER;
pub const WS_FAULT_TO_HEADER = WS_HEADER_TYPE.WS_FAULT_TO_HEADER;

pub const WS_ADDRESSING_VERSION = extern enum(i32) {
    _0_9 = 1,
    _1_0 = 2,
    TRANSPORT = 3,
};
pub const WS_ADDRESSING_VERSION_0_9 = WS_ADDRESSING_VERSION._0_9;
pub const WS_ADDRESSING_VERSION_1_0 = WS_ADDRESSING_VERSION._1_0;
pub const WS_ADDRESSING_VERSION_TRANSPORT = WS_ADDRESSING_VERSION.TRANSPORT;

pub const WS_ENVELOPE_VERSION = extern enum(i32) {
    SOAP_1_1 = 1,
    SOAP_1_2 = 2,
    NONE = 3,
};
...
pub const WS_MESSAGE_PROPERTY_ID = extern enum(i32) {
...
pub const WS_MESSAGE_PROPERTY_STATE = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_STATE;
pub const WS_MESSAGE_PROPERTY_HEAP = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_HEAP;
pub const WS_MESSAGE_PROPERTY_ENVELOPE_VERSION = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_ENVELOPE_VERSION;
pub const WS_MESSAGE_PROPERTY_ADDRESSING_VERSION = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_ADDRESSING_VERSION;
pub const WS_MESSAGE_PROPERTY_HEADER_BUFFER = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_HEADER_BUFFER;
pub const WS_MESSAGE_PROPERTY_HEADER_POSITION = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_HEADER_POSITION;
pub const WS_MESSAGE_PROPERTY_BODY_READER = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_BODY_READER;
pub const WS_MESSAGE_PROPERTY_BODY_WRITER = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_BODY_WRITER;
pub const WS_MESSAGE_PROPERTY_IS_ADDRESSED = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_IS_ADDRESSED;
pub const WS_MESSAGE_PROPERTY_HEAP_PROPERTIES = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_HEAP_PROPERTIES;
pub const WS_MESSAGE_PROPERTY_XML_READER_PROPERTIES = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_XML_READER_PROPERTIES;
pub const WS_MESSAGE_PROPERTY_XML_WRITER_PROPERTIES = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_XML_WRITER_PROPERTIES;
pub const WS_MESSAGE_PROPERTY_IS_FAULT = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_IS_FAULT;
pub const WS_MESSAGE_PROPERTY_MAX_PROCESSED_HEADERS = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_MAX_PROCESSED_HEADERS;
pub const WS_MESSAGE_PROPERTY_USERNAME = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_USERNAME;
pub const WS_MESSAGE_PROPERTY_ENCODED_CERT = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_ENCODED_CERT;
pub const WS_MESSAGE_PROPERTY_TRANSPORT_SECURITY_WINDOWS_TOKEN = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_TRANSPORT_SECURITY_WINDOWS_TOKEN;
pub const WS_MESSAGE_PROPERTY_HTTP_HEADER_AUTH_WINDOWS_TOKEN = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_HTTP_HEADER_AUTH_WINDOWS_TOKEN;
pub const WS_MESSAGE_PROPERTY_MESSAGE_SECURITY_WINDOWS_TOKEN = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_MESSAGE_SECURITY_WINDOWS_TOKEN;
pub const WS_MESSAGE_PROPERTY_SAML_ASSERTION = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_SAML_ASSERTION;
pub const WS_MESSAGE_PROPERTY_SECURITY_CONTEXT = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_SECURITY_CONTEXT;
pub const WS_MESSAGE_PROPERTY_PROTECTION_LEVEL = WS_MESSAGE_PROPERTY_ID.WS_MESSAGE_PROPERTY_PROTECTION_LEVEL;

pub const WS_SECURITY_BINDING_TYPE = extern enum(i32) {
...
pub const WS_SSL_TRANSPORT_SECURITY_BINDING_TYPE = WS_SECURITY_BINDING_TYPE.WS_SSL_TRANSPORT_SECURITY_BINDING_TYPE;
pub const WS_TCP_SSPI_TRANSPORT_SECURITY_BINDING_TYPE = WS_SECURITY_BINDING_TYPE.WS_TCP_SSPI_TRANSPORT_SECURITY_BINDING_TYPE;
pub const WS_HTTP_HEADER_AUTH_SECURITY_BINDING_TYPE = WS_SECURITY_BINDING_TYPE.WS_HTTP_HEADER_AUTH_SECURITY_BINDING_TYPE;
pub const WS_USERNAME_MESSAGE_SECURITY_BINDING_TYPE = WS_SECURITY_BINDING_TYPE.WS_USERNAME_MESSAGE_SECURITY_BINDING_TYPE;
pub const WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING_TYPE = WS_SECURITY_BINDING_TYPE.WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING_TYPE;
pub const WS_XML_TOKEN_MESSAGE_SECURITY_BINDING_TYPE = WS_SECURITY_BINDING_TYPE.WS_XML_TOKEN_MESSAGE_SECURITY_BINDING_TYPE;
pub const WS_SAML_MESSAGE_SECURITY_BINDING_TYPE = WS_SECURITY_BINDING_TYPE.WS_SAML_MESSAGE_SECURITY_BINDING_TYPE;
pub const WS_SECURITY_CONTEXT_MESSAGE_SECURITY_BINDING_TYPE = WS_SECURITY_BINDING_TYPE.WS_SECURITY_CONTEXT_MESSAGE_SECURITY_BINDING_TYPE;
pub const WS_NAMEDPIPE_SSPI_TRANSPORT_SECURITY_BINDING_TYPE = WS_SECURITY_BINDING_TYPE.WS_NAMEDPIPE_SSPI_TRANSPORT_SECURITY_BINDING_TYPE;

pub const WS_HTTP_HEADER_AUTH_TARGET = extern enum(i32) {
    SERVICE = 1,
    PROXY = 2,
};
...
pub const WS_WINDOWS_INTEGRATED_AUTH_PACKAGE = extern enum(i32) {
    KERBEROS = 1,
    NTLM = 2,
    SPNEGO = 3,
};
...
pub const WS_SECURITY_HEADER_VERSION = extern enum(i32) {
    _1_0 = 1,
    _1_1 = 2,
};
pub const WS_SECURITY_HEADER_VERSION_1_0 = WS_SECURITY_HEADER_VERSION._1_0;
pub const WS_SECURITY_HEADER_VERSION_1_1 = WS_SECURITY_HEADER_VERSION._1_1;

pub const WS_TRUST_VERSION = extern enum(i32) {
    FEBRUARY_2005 = 1,
    _1_3 = 2,
};
pub const WS_TRUST_VERSION_FEBRUARY_2005 = WS_TRUST_VERSION.FEBRUARY_2005;
pub const WS_TRUST_VERSION_1_3 = WS_TRUST_VERSION._1_3;

pub const WS_REQUEST_SECURITY_TOKEN_ACTION = extern enum(i32) {
    ISSUE = 1,
    NEW_CONTEXT = 2,
    RENEW_CONTEXT = 3,
};
...
pub const WS_SECURE_CONVERSATION_VERSION = extern enum(i32) {
    FEBRUARY_2005 = 1,
    _1_3 = 2,
};
pub const WS_SECURE_CONVERSATION_VERSION_FEBRUARY_2005 = WS_SECURE_CONVERSATION_VERSION.FEBRUARY_2005;
pub const WS_SECURE_CONVERSATION_VERSION_1_3 = WS_SECURE_CONVERSATION_VERSION._1_3;

pub const WS_SECURE_PROTOCOL = extern enum(i32) {
    SSL2 = 1,
    SSL3 = 2,
    TLS1_0 = 4,
    TLS1_1 = 8,
...
pub const WS_SECURITY_TIMESTAMP_USAGE = extern enum(i32) {
    ALWAYS = 1,
    NEVER = 2,
    REQUESTS_ONLY = 3,
};
...
pub const WS_SECURITY_HEADER_LAYOUT = extern enum(i32) {
    STRICT = 1,
    LAX = 2,
...
pub const WS_SECURITY_ALGORITHM_PROPERTY_ID = extern enum(i32) {
    _
};

pub const WS_SECURITY_ALGORITHM_ID = extern enum(i32) {
...
pub const WS_SECURITY_ALGORITHM_DEFAULT = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_DEFAULT;
pub const WS_SECURITY_ALGORITHM_CANONICALIZATION_EXCLUSIVE = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_CANONICALIZATION_EXCLUSIVE;
pub const WS_SECURITY_ALGORITHM_CANONICALIZATION_EXCLUSIVE_WITH_COMMENTS = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_CANONICALIZATION_EXCLUSIVE_WITH_COMMENTS;
pub const WS_SECURITY_ALGORITHM_DIGEST_SHA1 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_DIGEST_SHA1;
pub const WS_SECURITY_ALGORITHM_DIGEST_SHA_256 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_DIGEST_SHA_256;
pub const WS_SECURITY_ALGORITHM_DIGEST_SHA_384 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_DIGEST_SHA_384;
pub const WS_SECURITY_ALGORITHM_DIGEST_SHA_512 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_DIGEST_SHA_512;
pub const WS_SECURITY_ALGORITHM_SYMMETRIC_SIGNATURE_HMAC_SHA1 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_SYMMETRIC_SIGNATURE_HMAC_SHA1;
pub const WS_SECURITY_ALGORITHM_SYMMETRIC_SIGNATURE_HMAC_SHA_256 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_SYMMETRIC_SIGNATURE_HMAC_SHA_256;
pub const WS_SECURITY_ALGORITHM_SYMMETRIC_SIGNATURE_HMAC_SHA_384 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_SYMMETRIC_SIGNATURE_HMAC_SHA_384;
pub const WS_SECURITY_ALGORITHM_SYMMETRIC_SIGNATURE_HMAC_SHA_512 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_SYMMETRIC_SIGNATURE_HMAC_SHA_512;
pub const WS_SECURITY_ALGORITHM_ASYMMETRIC_SIGNATURE_RSA_SHA1 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_ASYMMETRIC_SIGNATURE_RSA_SHA1;
pub const WS_SECURITY_ALGORITHM_ASYMMETRIC_SIGNATURE_DSA_SHA1 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_ASYMMETRIC_SIGNATURE_DSA_SHA1;
pub const WS_SECURITY_ALGORITHM_ASYMMETRIC_SIGNATURE_RSA_SHA_256 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_ASYMMETRIC_SIGNATURE_RSA_SHA_256;
pub const WS_SECURITY_ALGORITHM_ASYMMETRIC_SIGNATURE_RSA_SHA_384 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_ASYMMETRIC_SIGNATURE_RSA_SHA_384;
pub const WS_SECURITY_ALGORITHM_ASYMMETRIC_SIGNATURE_RSA_SHA_512 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_ASYMMETRIC_SIGNATURE_RSA_SHA_512;
pub const WS_SECURITY_ALGORITHM_ASYMMETRIC_KEYWRAP_RSA_1_5 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_ASYMMETRIC_KEYWRAP_RSA_1_5;
pub const WS_SECURITY_ALGORITHM_ASYMMETRIC_KEYWRAP_RSA_OAEP = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_ASYMMETRIC_KEYWRAP_RSA_OAEP;
pub const WS_SECURITY_ALGORITHM_KEY_DERIVATION_P_SHA1 = WS_SECURITY_ALGORITHM_ID.WS_SECURITY_ALGORITHM_KEY_DERIVATION_P_SHA1;

pub const WS_PROTECTION_LEVEL = extern enum(i32) {
    NONE = 1,
    SIGN = 2,
    SIGN_AND_ENCRYPT = 3,
};
...
pub const WS_SECURITY_PROPERTY_ID = extern enum(i32) {
...
pub const WS_SECURITY_PROPERTY_TRANSPORT_PROTECTION_LEVEL = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_TRANSPORT_PROTECTION_LEVEL;
pub const WS_SECURITY_PROPERTY_ALGORITHM_SUITE = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_ALGORITHM_SUITE;
pub const WS_SECURITY_PROPERTY_ALGORITHM_SUITE_NAME = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_ALGORITHM_SUITE_NAME;
pub const WS_SECURITY_PROPERTY_MAX_ALLOWED_LATENCY = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_MAX_ALLOWED_LATENCY;
pub const WS_SECURITY_PROPERTY_TIMESTAMP_VALIDITY_DURATION = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_TIMESTAMP_VALIDITY_DURATION;
pub const WS_SECURITY_PROPERTY_MAX_ALLOWED_CLOCK_SKEW = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_MAX_ALLOWED_CLOCK_SKEW;
pub const WS_SECURITY_PROPERTY_TIMESTAMP_USAGE = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_TIMESTAMP_USAGE;
pub const WS_SECURITY_PROPERTY_SECURITY_HEADER_LAYOUT = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_SECURITY_HEADER_LAYOUT;
pub const WS_SECURITY_PROPERTY_SECURITY_HEADER_VERSION = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_SECURITY_HEADER_VERSION;
pub const WS_SECURITY_PROPERTY_EXTENDED_PROTECTION_POLICY = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_EXTENDED_PROTECTION_POLICY;
pub const WS_SECURITY_PROPERTY_EXTENDED_PROTECTION_SCENARIO = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_EXTENDED_PROTECTION_SCENARIO;
pub const WS_SECURITY_PROPERTY_SERVICE_IDENTITIES = WS_SECURITY_PROPERTY_ID.WS_SECURITY_PROPERTY_SERVICE_IDENTITIES;

pub const WS_SECURITY_KEY_TYPE = extern enum(i32) {
    NONE = 1,
    SYMMETRIC = 2,
    ASYMMETRIC = 3,
};
...
pub const WS_SECURITY_ALGORITHM_SUITE_NAME = extern enum(i32) {
    BASIC256 = 1,
    BASIC192 = 2,
    BASIC128 = 3,
    BASIC256_RSA15 = 4,
...
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC256 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC256;
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC192 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC192;
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC128 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC128;
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC256_RSA15 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC256_RSA15;
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC192_RSA15 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC192_RSA15;
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC128_RSA15 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC128_RSA15;
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC256_SHA256 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC256_SHA256;
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC192_SHA256 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC192_SHA256;
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC128_SHA256 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC128_SHA256;
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC256_SHA256_RSA15 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC256_SHA256_RSA15;
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC192_SHA256_RSA15 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC192_SHA256_RSA15;
pub const WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC128_SHA256_RSA15 = WS_SECURITY_ALGORITHM_SUITE_NAME.BASIC128_SHA256_RSA15;

pub const WS_SECURITY_TOKEN_REFERENCE_MODE = extern enum(i32) {
    LOCAL_ID = 1,
    XML_BUFFER = 2,
    CERT_THUMBPRINT = 3,
...
pub const WS_SECURITY_KEY_ENTROPY_MODE = extern enum(i32) {
    CLIENT_ONLY = 1,
    SERVER_ONLY = 2,
    COMBINED = 3,
};
...
pub const WS_EXTENDED_PROTECTION_POLICY = extern enum(i32) {
    NEVER = 1,
    WHEN_SUPPORTED = 2,
    ALWAYS = 3,
};
...
pub const WS_EXTENDED_PROTECTION_SCENARIO = extern enum(i32) {
    BOUND_SERVER = 1,
    TERMINATED_SSL = 2,
};
...
pub const WS_SECURITY_BINDING_PROPERTY_ID = extern enum(i32) {
...
pub const WS_SECURITY_BINDING_PROPERTY_REQUIRE_SSL_CLIENT_CERT = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_REQUIRE_SSL_CLIENT_CERT;
pub const WS_SECURITY_BINDING_PROPERTY_WINDOWS_INTEGRATED_AUTH_PACKAGE = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_WINDOWS_INTEGRATED_AUTH_PACKAGE;
pub const WS_SECURITY_BINDING_PROPERTY_REQUIRE_SERVER_AUTH = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_REQUIRE_SERVER_AUTH;
pub const WS_SECURITY_BINDING_PROPERTY_ALLOW_ANONYMOUS_CLIENTS = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_ALLOW_ANONYMOUS_CLIENTS;
pub const WS_SECURITY_BINDING_PROPERTY_ALLOWED_IMPERSONATION_LEVEL = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_ALLOWED_IMPERSONATION_LEVEL;
pub const WS_SECURITY_BINDING_PROPERTY_HTTP_HEADER_AUTH_SCHEME = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_HTTP_HEADER_AUTH_SCHEME;
pub const WS_SECURITY_BINDING_PROPERTY_HTTP_HEADER_AUTH_TARGET = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_HTTP_HEADER_AUTH_TARGET;
pub const WS_SECURITY_BINDING_PROPERTY_HTTP_HEADER_AUTH_BASIC_REALM = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_HTTP_HEADER_AUTH_BASIC_REALM;
pub const WS_SECURITY_BINDING_PROPERTY_HTTP_HEADER_AUTH_DIGEST_REALM = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_HTTP_HEADER_AUTH_DIGEST_REALM;
pub const WS_SECURITY_BINDING_PROPERTY_HTTP_HEADER_AUTH_DIGEST_DOMAIN = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_HTTP_HEADER_AUTH_DIGEST_DOMAIN;
pub const WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_KEY_SIZE = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_KEY_SIZE;
pub const WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_KEY_ENTROPY_MODE = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_KEY_ENTROPY_MODE;
pub const WS_SECURITY_BINDING_PROPERTY_MESSAGE_PROPERTIES = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_MESSAGE_PROPERTIES;
pub const WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_MAX_PENDING_CONTEXTS = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_MAX_PENDING_CONTEXTS;
pub const WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_MAX_ACTIVE_CONTEXTS = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_MAX_ACTIVE_CONTEXTS;
pub const WS_SECURITY_BINDING_PROPERTY_SECURE_CONVERSATION_VERSION = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_SECURE_CONVERSATION_VERSION;
pub const WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_SUPPORT_RENEW = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_SUPPORT_RENEW;
pub const WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_RENEWAL_INTERVAL = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_RENEWAL_INTERVAL;
pub const WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_ROLLOVER_INTERVAL = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_ROLLOVER_INTERVAL;
pub const WS_SECURITY_BINDING_PROPERTY_CERT_FAILURES_TO_IGNORE = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_CERT_FAILURES_TO_IGNORE;
pub const WS_SECURITY_BINDING_PROPERTY_DISABLE_CERT_REVOCATION_CHECK = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_DISABLE_CERT_REVOCATION_CHECK;
pub const WS_SECURITY_BINDING_PROPERTY_DISALLOWED_SECURE_PROTOCOLS = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_DISALLOWED_SECURE_PROTOCOLS;
pub const WS_SECURITY_BINDING_PROPERTY_CERTIFICATE_VALIDATION_CALLBACK_CONTEXT = WS_SECURITY_BINDING_PROPERTY_ID.WS_SECURITY_BINDING_PROPERTY_CERTIFICATE_VALIDATION_CALLBACK_CONTEXT;

pub const WS_CERT_CREDENTIAL_TYPE = extern enum(i32) {
    WS_SUBJECT_NAME_CERT_CREDENTIAL_TYPE = 1,
    WS_THUMBPRINT_CERT_CREDENTIAL_TYPE = 2,
    WS_CUSTOM_CERT_CREDENTIAL_TYPE = 3,
};
pub const WS_SUBJECT_NAME_CERT_CREDENTIAL_TYPE = WS_CERT_CREDENTIAL_TYPE.WS_SUBJECT_NAME_CERT_CREDENTIAL_TYPE;
pub const WS_THUMBPRINT_CERT_CREDENTIAL_TYPE = WS_CERT_CREDENTIAL_TYPE.WS_THUMBPRINT_CERT_CREDENTIAL_TYPE;
pub const WS_CUSTOM_CERT_CREDENTIAL_TYPE = WS_CERT_CREDENTIAL_TYPE.WS_CUSTOM_CERT_CREDENTIAL_TYPE;

pub const WS_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE = extern enum(i32) {
...
pub const WS_STRING_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE = WS_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE.WS_STRING_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE;
pub const WS_DEFAULT_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE = WS_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE.WS_DEFAULT_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE;
pub const WS_OPAQUE_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE = WS_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE.WS_OPAQUE_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE;

pub const WS_USERNAME_CREDENTIAL_TYPE = extern enum(i32) {
    WS_STRING_USERNAME_CREDENTIAL_TYPE = 1,
};
pub const WS_STRING_USERNAME_CREDENTIAL_TYPE = WS_USERNAME_CREDENTIAL_TYPE.WS_STRING_USERNAME_CREDENTIAL_TYPE;

pub const WS_SECURITY_TOKEN_PROPERTY_ID = extern enum(i32) {
...
pub const WS_SECURITY_TOKEN_PROPERTY_KEY_TYPE = WS_SECURITY_TOKEN_PROPERTY_ID.WS_SECURITY_TOKEN_PROPERTY_KEY_TYPE;
pub const WS_SECURITY_TOKEN_PROPERTY_VALID_FROM_TIME = WS_SECURITY_TOKEN_PROPERTY_ID.WS_SECURITY_TOKEN_PROPERTY_VALID_FROM_TIME;
pub const WS_SECURITY_TOKEN_PROPERTY_VALID_TILL_TIME = WS_SECURITY_TOKEN_PROPERTY_ID.WS_SECURITY_TOKEN_PROPERTY_VALID_TILL_TIME;
pub const WS_SECURITY_TOKEN_PROPERTY_SERIALIZED_XML = WS_SECURITY_TOKEN_PROPERTY_ID.WS_SECURITY_TOKEN_PROPERTY_SERIALIZED_XML;
pub const WS_SECURITY_TOKEN_PROPERTY_ATTACHED_REFERENCE_XML = WS_SECURITY_TOKEN_PROPERTY_ID.WS_SECURITY_TOKEN_PROPERTY_ATTACHED_REFERENCE_XML;
pub const WS_SECURITY_TOKEN_PROPERTY_UNATTACHED_REFERENCE_XML = WS_SECURITY_TOKEN_PROPERTY_ID.WS_SECURITY_TOKEN_PROPERTY_UNATTACHED_REFERENCE_XML;
pub const WS_SECURITY_TOKEN_PROPERTY_SYMMETRIC_KEY = WS_SECURITY_TOKEN_PROPERTY_ID.WS_SECURITY_TOKEN_PROPERTY_SYMMETRIC_KEY;

pub const WS_SECURITY_KEY_HANDLE_TYPE = extern enum(i32) {
...
pub const WS_RAW_SYMMETRIC_SECURITY_KEY_HANDLE_TYPE = WS_SECURITY_KEY_HANDLE_TYPE.WS_RAW_SYMMETRIC_SECURITY_KEY_HANDLE_TYPE;
pub const WS_NCRYPT_ASYMMETRIC_SECURITY_KEY_HANDLE_TYPE = WS_SECURITY_KEY_HANDLE_TYPE.WS_NCRYPT_ASYMMETRIC_SECURITY_KEY_HANDLE_TYPE;
pub const WS_CAPI_ASYMMETRIC_SECURITY_KEY_HANDLE_TYPE = WS_SECURITY_KEY_HANDLE_TYPE.WS_CAPI_ASYMMETRIC_SECURITY_KEY_HANDLE_TYPE;

pub const WS_MESSAGE_SECURITY_USAGE = extern enum(i32) {
    WS_SUPPORTING_MESSAGE_SECURITY_USAGE = 1,
};
pub const WS_SUPPORTING_MESSAGE_SECURITY_USAGE = WS_MESSAGE_SECURITY_USAGE.WS_SUPPORTING_MESSAGE_SECURITY_USAGE;

pub const WS_SECURITY_CONTEXT_PROPERTY_ID = extern enum(i32) {
...
pub const WS_SECURITY_CONTEXT_PROPERTY_IDENTIFIER = WS_SECURITY_CONTEXT_PROPERTY_ID.WS_SECURITY_CONTEXT_PROPERTY_IDENTIFIER;
pub const WS_SECURITY_CONTEXT_PROPERTY_USERNAME = WS_SECURITY_CONTEXT_PROPERTY_ID.WS_SECURITY_CONTEXT_PROPERTY_USERNAME;
pub const WS_SECURITY_CONTEXT_PROPERTY_MESSAGE_SECURITY_WINDOWS_TOKEN = WS_SECURITY_CONTEXT_PROPERTY_ID.WS_SECURITY_CONTEXT_PROPERTY_MESSAGE_SECURITY_WINDOWS_TOKEN;
pub const WS_SECURITY_CONTEXT_PROPERTY_SAML_ASSERTION = WS_SECURITY_CONTEXT_PROPERTY_ID.WS_SECURITY_CONTEXT_PROPERTY_SAML_ASSERTION;

pub const WS_XML_SECURITY_TOKEN_PROPERTY_ID = extern enum(i32) {
...
pub const WS_XML_SECURITY_TOKEN_PROPERTY_ATTACHED_REFERENCE = WS_XML_SECURITY_TOKEN_PROPERTY_ID.WS_XML_SECURITY_TOKEN_PROPERTY_ATTACHED_REFERENCE;
pub const WS_XML_SECURITY_TOKEN_PROPERTY_UNATTACHED_REFERENCE = WS_XML_SECURITY_TOKEN_PROPERTY_ID.WS_XML_SECURITY_TOKEN_PROPERTY_UNATTACHED_REFERENCE;
pub const WS_XML_SECURITY_TOKEN_PROPERTY_VALID_FROM_TIME = WS_XML_SECURITY_TOKEN_PROPERTY_ID.WS_XML_SECURITY_TOKEN_PROPERTY_VALID_FROM_TIME;
pub const WS_XML_SECURITY_TOKEN_PROPERTY_VALID_TILL_TIME = WS_XML_SECURITY_TOKEN_PROPERTY_ID.WS_XML_SECURITY_TOKEN_PROPERTY_VALID_TILL_TIME;

pub const WS_SAML_AUTHENTICATOR_TYPE = extern enum(i32) {
    WS_CERT_SIGNED_SAML_AUTHENTICATOR_TYPE = 1,
};
pub const WS_CERT_SIGNED_SAML_AUTHENTICATOR_TYPE = WS_SAML_AUTHENTICATOR_TYPE.WS_CERT_SIGNED_SAML_AUTHENTICATOR_TYPE;

pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID = extern enum(i32) {
...
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_APPLIES_TO = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_APPLIES_TO;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_TRUST_VERSION = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_TRUST_VERSION;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_SECURE_CONVERSATION_VERSION = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_SECURE_CONVERSATION_VERSION;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_ISSUED_TOKEN_TYPE = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_ISSUED_TOKEN_TYPE;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_REQUEST_ACTION = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_REQUEST_ACTION;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_EXISTING_TOKEN = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_EXISTING_TOKEN;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_ISSUED_TOKEN_KEY_TYPE = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_ISSUED_TOKEN_KEY_TYPE;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_ISSUED_TOKEN_KEY_SIZE = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_ISSUED_TOKEN_KEY_SIZE;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_ISSUED_TOKEN_KEY_ENTROPY = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_ISSUED_TOKEN_KEY_ENTROPY;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_LOCAL_REQUEST_PARAMETERS = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_LOCAL_REQUEST_PARAMETERS;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_SERVICE_REQUEST_PARAMETERS = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_SERVICE_REQUEST_PARAMETERS;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_MESSAGE_PROPERTIES = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_MESSAGE_PROPERTIES;
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_BEARER_KEY_TYPE_VERSION = WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID.WS_REQUEST_SECURITY_TOKEN_PROPERTY_BEARER_KEY_TYPE_VERSION;

pub const WS_SECURITY_BEARER_KEY_TYPE_VERSION = extern enum(i32) {
    _1_3_ORIGINAL_SPECIFICATION = 1,
    _1_3_ORIGINAL_SCHEMA = 2,
    _1_3_ERRATA_01 = 3,
};
pub const WS_SECURITY_BEARER_KEY_TYPE_VERSION_1_3_ORIGINAL_SPECIFICATION = WS_SECURITY_BEARER_KEY_TYPE_VERSION._1_3_ORIGINAL_SPECIFICATION;
pub const WS_SECURITY_BEARER_KEY_TYPE_VERSION_1_3_ORIGINAL_SCHEMA = WS_SECURITY_BEARER_KEY_TYPE_VERSION._1_3_ORIGINAL_SCHEMA;
pub const WS_SECURITY_BEARER_KEY_TYPE_VERSION_1_3_ERRATA_01 = WS_SECURITY_BEARER_KEY_TYPE_VERSION._1_3_ERRATA_01;

pub const WS_TYPE = extern enum(i32) {
    WS_BOOL_TYPE = 0,
    WS_INT8_TYPE = 1,
    WS_INT16_TYPE = 2,
    WS_INT32_TYPE = 3,
...
pub const WS_BOOL_TYPE = WS_TYPE.WS_BOOL_TYPE;
pub const WS_INT8_TYPE = WS_TYPE.WS_INT8_TYPE;
pub const WS_INT16_TYPE = WS_TYPE.WS_INT16_TYPE;
pub const WS_INT32_TYPE = WS_TYPE.WS_INT32_TYPE;
pub const WS_INT64_TYPE = WS_TYPE.WS_INT64_TYPE;
pub const WS_UINT8_TYPE = WS_TYPE.WS_UINT8_TYPE;
pub const WS_UINT16_TYPE = WS_TYPE.WS_UINT16_TYPE;
pub const WS_UINT32_TYPE = WS_TYPE.WS_UINT32_TYPE;
pub const WS_UINT64_TYPE = WS_TYPE.WS_UINT64_TYPE;
pub const WS_FLOAT_TYPE = WS_TYPE.WS_FLOAT_TYPE;
pub const WS_DOUBLE_TYPE = WS_TYPE.WS_DOUBLE_TYPE;
pub const WS_DECIMAL_TYPE = WS_TYPE.WS_DECIMAL_TYPE;
pub const WS_DATETIME_TYPE = WS_TYPE.WS_DATETIME_TYPE;
pub const WS_TIMESPAN_TYPE = WS_TYPE.WS_TIMESPAN_TYPE;
pub const WS_GUID_TYPE = WS_TYPE.WS_GUID_TYPE;
pub const WS_UNIQUE_ID_TYPE = WS_TYPE.WS_UNIQUE_ID_TYPE;
pub const WS_STRING_TYPE = WS_TYPE.WS_STRING_TYPE;
pub const WS_WSZ_TYPE = WS_TYPE.WS_WSZ_TYPE;
pub const WS_BYTES_TYPE = WS_TYPE.WS_BYTES_TYPE;
pub const WS_XML_STRING_TYPE = WS_TYPE.WS_XML_STRING_TYPE;
pub const WS_XML_QNAME_TYPE = WS_TYPE.WS_XML_QNAME_TYPE;
pub const WS_XML_BUFFER_TYPE = WS_TYPE.WS_XML_BUFFER_TYPE;
pub const WS_CHAR_ARRAY_TYPE = WS_TYPE.WS_CHAR_ARRAY_TYPE;
pub const WS_UTF8_ARRAY_TYPE = WS_TYPE.WS_UTF8_ARRAY_TYPE;
pub const WS_BYTE_ARRAY_TYPE = WS_TYPE.WS_BYTE_ARRAY_TYPE;
pub const WS_DESCRIPTION_TYPE = WS_TYPE.WS_DESCRIPTION_TYPE;
pub const WS_STRUCT_TYPE = WS_TYPE.WS_STRUCT_TYPE;
pub const WS_CUSTOM_TYPE = WS_TYPE.WS_CUSTOM_TYPE;
pub const WS_ENDPOINT_ADDRESS_TYPE = WS_TYPE.WS_ENDPOINT_ADDRESS_TYPE;
pub const WS_FAULT_TYPE = WS_TYPE.WS_FAULT_TYPE;
pub const WS_VOID_TYPE = WS_TYPE.WS_VOID_TYPE;
pub const WS_ENUM_TYPE = WS_TYPE.WS_ENUM_TYPE;
pub const WS_DURATION_TYPE = WS_TYPE.WS_DURATION_TYPE;
pub const WS_UNION_TYPE = WS_TYPE.WS_UNION_TYPE;
pub const WS_ANY_ATTRIBUTES_TYPE = WS_TYPE.WS_ANY_ATTRIBUTES_TYPE;

pub const WS_FIELD_MAPPING = extern enum(i32) {
...
pub const WS_TYPE_ATTRIBUTE_FIELD_MAPPING = WS_FIELD_MAPPING.WS_TYPE_ATTRIBUTE_FIELD_MAPPING;
pub const WS_ATTRIBUTE_FIELD_MAPPING = WS_FIELD_MAPPING.WS_ATTRIBUTE_FIELD_MAPPING;
pub const WS_ELEMENT_FIELD_MAPPING = WS_FIELD_MAPPING.WS_ELEMENT_FIELD_MAPPING;
pub const WS_REPEATING_ELEMENT_FIELD_MAPPING = WS_FIELD_MAPPING.WS_REPEATING_ELEMENT_FIELD_MAPPING;
pub const WS_TEXT_FIELD_MAPPING = WS_FIELD_MAPPING.WS_TEXT_FIELD_MAPPING;
pub const WS_NO_FIELD_MAPPING = WS_FIELD_MAPPING.WS_NO_FIELD_MAPPING;
pub const WS_XML_ATTRIBUTE_FIELD_MAPPING = WS_FIELD_MAPPING.WS_XML_ATTRIBUTE_FIELD_MAPPING;
pub const WS_ELEMENT_CHOICE_FIELD_MAPPING = WS_FIELD_MAPPING.WS_ELEMENT_CHOICE_FIELD_MAPPING;
pub const WS_REPEATING_ELEMENT_CHOICE_FIELD_MAPPING = WS_FIELD_MAPPING.WS_REPEATING_ELEMENT_CHOICE_FIELD_MAPPING;
pub const WS_ANY_ELEMENT_FIELD_MAPPING = WS_FIELD_MAPPING.WS_ANY_ELEMENT_FIELD_MAPPING;
pub const WS_REPEATING_ANY_ELEMENT_FIELD_MAPPING = WS_FIELD_MAPPING.WS_REPEATING_ANY_ELEMENT_FIELD_MAPPING;
pub const WS_ANY_CONTENT_FIELD_MAPPING = WS_FIELD_MAPPING.WS_ANY_CONTENT_FIELD_MAPPING;
pub const WS_ANY_ATTRIBUTES_FIELD_MAPPING = WS_FIELD_MAPPING.WS_ANY_ATTRIBUTES_FIELD_MAPPING;

pub const WS_TYPE_MAPPING = extern enum(i32) {
    WS_ELEMENT_TYPE_MAPPING = 1,
    WS_ATTRIBUTE_TYPE_MAPPING = 2,
    WS_ELEMENT_CONTENT_TYPE_MAPPING = 3,
    WS_ANY_ELEMENT_TYPE_MAPPING = 4,
};
pub const WS_ELEMENT_TYPE_MAPPING = WS_TYPE_MAPPING.WS_ELEMENT_TYPE_MAPPING;
pub const WS_ATTRIBUTE_TYPE_MAPPING = WS_TYPE_MAPPING.WS_ATTRIBUTE_TYPE_MAPPING;
pub const WS_ELEMENT_CONTENT_TYPE_MAPPING = WS_TYPE_MAPPING.WS_ELEMENT_CONTENT_TYPE_MAPPING;
pub const WS_ANY_ELEMENT_TYPE_MAPPING = WS_TYPE_MAPPING.WS_ANY_ELEMENT_TYPE_MAPPING;

pub const WS_READ_OPTION = extern enum(i32) {
...
pub const WS_READ_REQUIRED_VALUE = WS_READ_OPTION.WS_READ_REQUIRED_VALUE;
pub const WS_READ_REQUIRED_POINTER = WS_READ_OPTION.WS_READ_REQUIRED_POINTER;
pub const WS_READ_OPTIONAL_POINTER = WS_READ_OPTION.WS_READ_OPTIONAL_POINTER;
pub const WS_READ_NILLABLE_POINTER = WS_READ_OPTION.WS_READ_NILLABLE_POINTER;
pub const WS_READ_NILLABLE_VALUE = WS_READ_OPTION.WS_READ_NILLABLE_VALUE;

pub const WS_WRITE_OPTION = extern enum(i32) {
    WS_WRITE_REQUIRED_VALUE = 1,
    WS_WRITE_REQUIRED_POINTER = 2,
    WS_WRITE_NILLABLE_VALUE = 3,
    WS_WRITE_NILLABLE_POINTER = 4,
};
pub const WS_WRITE_REQUIRED_VALUE = WS_WRITE_OPTION.WS_WRITE_REQUIRED_VALUE;
pub const WS_WRITE_REQUIRED_POINTER = WS_WRITE_OPTION.WS_WRITE_REQUIRED_POINTER;
pub const WS_WRITE_NILLABLE_VALUE = WS_WRITE_OPTION.WS_WRITE_NILLABLE_VALUE;
pub const WS_WRITE_NILLABLE_POINTER = WS_WRITE_OPTION.WS_WRITE_NILLABLE_POINTER;

pub const WS_SERVICE_CANCEL_REASON = extern enum(i32) {
    WS_SERVICE_HOST_ABORT = 0,
    WS_SERVICE_CHANNEL_FAULTED = 1,
};
pub const WS_SERVICE_HOST_ABORT = WS_SERVICE_CANCEL_REASON.WS_SERVICE_HOST_ABORT;
pub const WS_SERVICE_CHANNEL_FAULTED = WS_SERVICE_CANCEL_REASON.WS_SERVICE_CHANNEL_FAULTED;

pub const WS_OPERATION_STYLE = extern enum(i32) {
    WS_NON_RPC_LITERAL_OPERATION = 0,
    WS_RPC_LITERAL_OPERATION = 1,
};
pub const WS_NON_RPC_LITERAL_OPERATION = WS_OPERATION_STYLE.WS_NON_RPC_LITERAL_OPERATION;
pub const WS_RPC_LITERAL_OPERATION = WS_OPERATION_STYLE.WS_RPC_LITERAL_OPERATION;

pub const WS_PARAMETER_TYPE = extern enum(i32) {
    NORMAL = 0,
    ARRAY = 1,
    ARRAY_COUNT = 2,
    MESSAGES = 3,
...
pub const WS_SERVICE_ENDPOINT_PROPERTY_ID = extern enum(i32) {
...
pub const WS_SERVICE_ENDPOINT_PROPERTY_ACCEPT_CHANNEL_CALLBACK = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_ACCEPT_CHANNEL_CALLBACK;
pub const WS_SERVICE_ENDPOINT_PROPERTY_CLOSE_CHANNEL_CALLBACK = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_CLOSE_CHANNEL_CALLBACK;
pub const WS_SERVICE_ENDPOINT_PROPERTY_MAX_ACCEPTING_CHANNELS = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_MAX_ACCEPTING_CHANNELS;
pub const WS_SERVICE_ENDPOINT_PROPERTY_MAX_CONCURRENCY = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_MAX_CONCURRENCY;
pub const WS_SERVICE_ENDPOINT_PROPERTY_BODY_HEAP_MAX_SIZE = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_BODY_HEAP_MAX_SIZE;
pub const WS_SERVICE_ENDPOINT_PROPERTY_BODY_HEAP_TRIM_SIZE = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_BODY_HEAP_TRIM_SIZE;
pub const WS_SERVICE_ENDPOINT_PROPERTY_MESSAGE_PROPERTIES = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_MESSAGE_PROPERTIES;
pub const WS_SERVICE_ENDPOINT_PROPERTY_MAX_CALL_POOL_SIZE = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_MAX_CALL_POOL_SIZE;
pub const WS_SERVICE_ENDPOINT_PROPERTY_MAX_CHANNEL_POOL_SIZE = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_MAX_CHANNEL_POOL_SIZE;
pub const WS_SERVICE_ENDPOINT_PROPERTY_LISTENER_PROPERTIES = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_LISTENER_PROPERTIES;
pub const WS_SERVICE_ENDPOINT_PROPERTY_CHECK_MUST_UNDERSTAND = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_CHECK_MUST_UNDERSTAND;
pub const WS_SERVICE_ENDPOINT_PROPERTY_METADATA_EXCHANGE_TYPE = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_METADATA_EXCHANGE_TYPE;
pub const WS_SERVICE_ENDPOINT_PROPERTY_METADATA = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_METADATA;
pub const WS_SERVICE_ENDPOINT_PROPERTY_METADATA_EXCHANGE_URL_SUFFIX = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_METADATA_EXCHANGE_URL_SUFFIX;
pub const WS_SERVICE_ENDPOINT_PROPERTY_MAX_CHANNELS = WS_SERVICE_ENDPOINT_PROPERTY_ID.WS_SERVICE_ENDPOINT_PROPERTY_MAX_CHANNELS;

pub const WS_METADATA_EXCHANGE_TYPE = extern enum(i32) {
    NONE = 0,
    MEX = 1,
    HTTP_GET = 2,
};
...
pub const WS_SERVICE_PROPERTY_ID = extern enum(i32) {
...
pub const WS_SERVICE_PROPERTY_HOST_USER_STATE = WS_SERVICE_PROPERTY_ID.WS_SERVICE_PROPERTY_HOST_USER_STATE;
pub const WS_SERVICE_PROPERTY_FAULT_DISCLOSURE = WS_SERVICE_PROPERTY_ID.WS_SERVICE_PROPERTY_FAULT_DISCLOSURE;
pub const WS_SERVICE_PROPERTY_FAULT_LANGID = WS_SERVICE_PROPERTY_ID.WS_SERVICE_PROPERTY_FAULT_LANGID;
pub const WS_SERVICE_PROPERTY_HOST_STATE = WS_SERVICE_PROPERTY_ID.WS_SERVICE_PROPERTY_HOST_STATE;
pub const WS_SERVICE_PROPERTY_METADATA = WS_SERVICE_PROPERTY_ID.WS_SERVICE_PROPERTY_METADATA;
pub const WS_SERVICE_PROPERTY_CLOSE_TIMEOUT = WS_SERVICE_PROPERTY_ID.WS_SERVICE_PROPERTY_CLOSE_TIMEOUT;

pub const WS_SERVICE_HOST_STATE = extern enum(i32) {
    CREATED = 0,
    OPENING = 1,
    OPEN = 2,
    CLOSING = 3,
...
pub const WS_SERVICE_PROXY_STATE = extern enum(i32) {
    CREATED = 0,
    OPENING = 1,
    OPEN = 2,
    CLOSING = 3,
...
pub const WS_PROXY_PROPERTY_ID = extern enum(i32) {
...
pub const WS_PROXY_PROPERTY_CALL_TIMEOUT = WS_PROXY_PROPERTY_ID.WS_PROXY_PROPERTY_CALL_TIMEOUT;
pub const WS_PROXY_PROPERTY_MESSAGE_PROPERTIES = WS_PROXY_PROPERTY_ID.WS_PROXY_PROPERTY_MESSAGE_PROPERTIES;
pub const WS_PROXY_PROPERTY_MAX_CALL_POOL_SIZE = WS_PROXY_PROPERTY_ID.WS_PROXY_PROPERTY_MAX_CALL_POOL_SIZE;
pub const WS_PROXY_PROPERTY_STATE = WS_PROXY_PROPERTY_ID.WS_PROXY_PROPERTY_STATE;
pub const WS_PROXY_PROPERTY_MAX_PENDING_CALLS = WS_PROXY_PROPERTY_ID.WS_PROXY_PROPERTY_MAX_PENDING_CALLS;
pub const WS_PROXY_PROPERTY_MAX_CLOSE_TIMEOUT = WS_PROXY_PROPERTY_ID.WS_PROXY_PROPERTY_MAX_CLOSE_TIMEOUT;
pub const WS_PROXY_FAULT_LANG_ID = WS_PROXY_PROPERTY_ID.WS_PROXY_FAULT_LANG_ID;

pub const WS_CALL_PROPERTY_ID = extern enum(i32) {
...
pub const WS_CALL_PROPERTY_CHECK_MUST_UNDERSTAND = WS_CALL_PROPERTY_ID.WS_CALL_PROPERTY_CHECK_MUST_UNDERSTAND;
pub const WS_CALL_PROPERTY_SEND_MESSAGE_CONTEXT = WS_CALL_PROPERTY_ID.WS_CALL_PROPERTY_SEND_MESSAGE_CONTEXT;
pub const WS_CALL_PROPERTY_RECEIVE_MESSAGE_CONTEXT = WS_CALL_PROPERTY_ID.WS_CALL_PROPERTY_RECEIVE_MESSAGE_CONTEXT;
pub const WS_CALL_PROPERTY_CALL_ID = WS_CALL_PROPERTY_ID.WS_CALL_PROPERTY_CALL_ID;

pub const WS_TRACE_API = extern enum(i32) {
    NONE = -1,
...
pub const WS_URL_SCHEME_TYPE = extern enum(i32) {
...
pub const WS_URL_HTTP_SCHEME_TYPE = WS_URL_SCHEME_TYPE.WS_URL_HTTP_SCHEME_TYPE;
pub const WS_URL_HTTPS_SCHEME_TYPE = WS_URL_SCHEME_TYPE.WS_URL_HTTPS_SCHEME_TYPE;
pub const WS_URL_NETTCP_SCHEME_TYPE = WS_URL_SCHEME_TYPE.WS_URL_NETTCP_SCHEME_TYPE;
pub const WS_URL_SOAPUDP_SCHEME_TYPE = WS_URL_SCHEME_TYPE.WS_URL_SOAPUDP_SCHEME_TYPE;
pub const WS_URL_NETPIPE_SCHEME_TYPE = WS_URL_SCHEME_TYPE.WS_URL_NETPIPE_SCHEME_TYPE;

pub const WS_DATETIME_FORMAT = extern enum(i32) {
    UTC = 0,
    LOCAL = 1,
    NONE = 2,
};
...
pub const WS_METADATA_STATE = extern enum(i32) {
    CREATED = 1,
    RESOLVED = 2,
    FAULTED = 3,
};
...
pub const WS_METADATA_PROPERTY_ID = extern enum(i32) {
...
pub const WS_METADATA_PROPERTY_STATE = WS_METADATA_PROPERTY_ID.WS_METADATA_PROPERTY_STATE;
pub const WS_METADATA_PROPERTY_HEAP_PROPERTIES = WS_METADATA_PROPERTY_ID.WS_METADATA_PROPERTY_HEAP_PROPERTIES;
pub const WS_METADATA_PROPERTY_POLICY_PROPERTIES = WS_METADATA_PROPERTY_ID.WS_METADATA_PROPERTY_POLICY_PROPERTIES;
pub const WS_METADATA_PROPERTY_HEAP_REQUESTED_SIZE = WS_METADATA_PROPERTY_ID.WS_METADATA_PROPERTY_HEAP_REQUESTED_SIZE;
pub const WS_METADATA_PROPERTY_MAX_DOCUMENTS = WS_METADATA_PROPERTY_ID.WS_METADATA_PROPERTY_MAX_DOCUMENTS;
pub const WS_METADATA_PROPERTY_HOST_NAMES = WS_METADATA_PROPERTY_ID.WS_METADATA_PROPERTY_HOST_NAMES;
pub const WS_METADATA_PROPERTY_VERIFY_HOST_NAMES = WS_METADATA_PROPERTY_ID.WS_METADATA_PROPERTY_VERIFY_HOST_NAMES;

pub const WS_POLICY_STATE = extern enum(i32) {
    CREATED = 1,
    FAULTED = 2,
};
...
pub const WS_POLICY_PROPERTY_ID = extern enum(i32) {
...
pub const WS_POLICY_PROPERTY_STATE = WS_POLICY_PROPERTY_ID.WS_POLICY_PROPERTY_STATE;
pub const WS_POLICY_PROPERTY_MAX_ALTERNATIVES = WS_POLICY_PROPERTY_ID.WS_POLICY_PROPERTY_MAX_ALTERNATIVES;
pub const WS_POLICY_PROPERTY_MAX_DEPTH = WS_POLICY_PROPERTY_ID.WS_POLICY_PROPERTY_MAX_DEPTH;
pub const WS_POLICY_PROPERTY_MAX_EXTENSIONS = WS_POLICY_PROPERTY_ID.WS_POLICY_PROPERTY_MAX_EXTENSIONS;

pub const WS_SECURITY_BINDING_CONSTRAINT_TYPE = extern enum(i32) {
...
pub const WS_SSL_TRANSPORT_SECURITY_BINDING_CONSTRAINT_TYPE = WS_SECURITY_BINDING_CONSTRAINT_TYPE.WS_SSL_TRANSPORT_SECURITY_BINDING_CONSTRAINT_TYPE;
pub const WS_TCP_SSPI_TRANSPORT_SECURITY_BINDING_CONSTRAINT_TYPE = WS_SECURITY_BINDING_CONSTRAINT_TYPE.WS_TCP_SSPI_TRANSPORT_SECURITY_BINDING_CONSTRAINT_TYPE;
pub const WS_HTTP_HEADER_AUTH_SECURITY_BINDING_CONSTRAINT_TYPE = WS_SECURITY_BINDING_CONSTRAINT_TYPE.WS_HTTP_HEADER_AUTH_SECURITY_BINDING_CONSTRAINT_TYPE;
pub const WS_USERNAME_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE = WS_SECURITY_BINDING_CONSTRAINT_TYPE.WS_USERNAME_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE;
pub const WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE = WS_SECURITY_BINDING_CONSTRAINT_TYPE.WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE;
pub const WS_ISSUED_TOKEN_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE = WS_SECURITY_BINDING_CONSTRAINT_TYPE.WS_ISSUED_TOKEN_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE;
pub const WS_CERT_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE = WS_SECURITY_BINDING_CONSTRAINT_TYPE.WS_CERT_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE;
pub const WS_SECURITY_CONTEXT_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE = WS_SECURITY_BINDING_CONSTRAINT_TYPE.WS_SECURITY_CONTEXT_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE;

pub const WS_POLICY_EXTENSION_TYPE = extern enum(i32) {
    WS_ENDPOINT_POLICY_EXTENSION_TYPE = 1,
};
pub const WS_ENDPOINT_POLICY_EXTENSION_TYPE = WS_POLICY_EXTENSION_TYPE.WS_ENDPOINT_POLICY_EXTENSION_TYPE;

pub const WS_BINDING_TEMPLATE_TYPE = extern enum(i32) {
...
pub const WS_HTTP_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_HTTP_BINDING_TEMPLATE_TYPE;
pub const WS_HTTP_SSL_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_HTTP_SSL_BINDING_TEMPLATE_TYPE;
pub const WS_HTTP_HEADER_AUTH_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_HTTP_HEADER_AUTH_BINDING_TEMPLATE_TYPE;
pub const WS_HTTP_SSL_HEADER_AUTH_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_HTTP_SSL_HEADER_AUTH_BINDING_TEMPLATE_TYPE;
pub const WS_HTTP_SSL_USERNAME_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_HTTP_SSL_USERNAME_BINDING_TEMPLATE_TYPE;
pub const WS_HTTP_SSL_KERBEROS_APREQ_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_HTTP_SSL_KERBEROS_APREQ_BINDING_TEMPLATE_TYPE;
pub const WS_TCP_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_TCP_BINDING_TEMPLATE_TYPE;
pub const WS_TCP_SSPI_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_TCP_SSPI_BINDING_TEMPLATE_TYPE;
pub const WS_TCP_SSPI_USERNAME_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_TCP_SSPI_USERNAME_BINDING_TEMPLATE_TYPE;
pub const WS_TCP_SSPI_KERBEROS_APREQ_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_TCP_SSPI_KERBEROS_APREQ_BINDING_TEMPLATE_TYPE;
pub const WS_HTTP_SSL_USERNAME_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_HTTP_SSL_USERNAME_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE;
pub const WS_HTTP_SSL_KERBEROS_APREQ_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_HTTP_SSL_KERBEROS_APREQ_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE;
pub const WS_TCP_SSPI_USERNAME_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_TCP_SSPI_USERNAME_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE;
pub const WS_TCP_SSPI_KERBEROS_APREQ_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE = WS_BINDING_TEMPLATE_TYPE.WS_TCP_SSPI_KERBEROS_APREQ_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE;
