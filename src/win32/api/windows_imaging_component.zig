...
pub const CLSID_WICImagingFactory = @import("../zig.zig").Guid.initString("cacaf262-9370-4615-a13b-9f5539da4c0a");
pub const CLSID_WICImagingFactory1 = @import("../zig.zig").Guid.initString("cacaf262-9370-4615-a13b-9f5539da4c0a");
pub const CLSID_WICImagingFactory2 = @import("../zig.zig").Guid.initString("317d06e8-5f24-433d-bdf7-79ce68d8abc2");
pub const GUID_VendorMicrosoft = @import("../zig.zig").Guid.initString("f0e749ca-edef-4589-a73a-ee0e626a2a2b");
pub const GUID_VendorMicrosoftBuiltIn = @import("../zig.zig").Guid.initString("257a30fd-06b6-462b-aea4-63f70b86e533");
pub const CLSID_WICPngDecoder = @import("../zig.zig").Guid.initString("389ea17b-5078-4cde-b6ef-25c15175c751");
pub const CLSID_WICPngDecoder1 = @import("../zig.zig").Guid.initString("389ea17b-5078-4cde-b6ef-25c15175c751");
pub const CLSID_WICPngDecoder2 = @import("../zig.zig").Guid.initString("e018945b-aa86-4008-9bd4-6777a1e40c11");
pub const CLSID_WICBmpDecoder = @import("../zig.zig").Guid.initString("6b462062-7cbf-400d-9fdb-813dd10f2778");
pub const CLSID_WICIcoDecoder = @import("../zig.zig").Guid.initString("c61bfcdf-2e0f-4aad-a8d7-e06bafebcdfe");
pub const CLSID_WICJpegDecoder = @import("../zig.zig").Guid.initString("9456a480-e88b-43ea-9e73-0b2d9b71b1ca");
pub const CLSID_WICGifDecoder = @import("../zig.zig").Guid.initString("381dda3c-9ce9-4834-a23e-1f98f8fc52be");
pub const CLSID_WICTiffDecoder = @import("../zig.zig").Guid.initString("b54e85d9-fe23-499f-8b88-6acea713752b");
pub const CLSID_WICWmpDecoder = @import("../zig.zig").Guid.initString("a26cec36-234c-4950-ae16-e34aace71d0d");
pub const CLSID_WICDdsDecoder = @import("../zig.zig").Guid.initString("9053699f-a341-429d-9e90-ee437cf80c73");
pub const CLSID_WICBmpEncoder = @import("../zig.zig").Guid.initString("69be8bb4-d66d-47c8-865a-ed1589433782");
pub const CLSID_WICPngEncoder = @import("../zig.zig").Guid.initString("27949969-876a-41d7-9447-568f6a35a4dc");
pub const CLSID_WICJpegEncoder = @import("../zig.zig").Guid.initString("1a34f5c1-4a5a-46dc-b644-1f4567e7a676");
pub const CLSID_WICGifEncoder = @import("../zig.zig").Guid.initString("114f5598-0b22-40a0-86a1-c83ea495adbd");
pub const CLSID_WICTiffEncoder = @import("../zig.zig").Guid.initString("0131be10-2001-4c5f-a9b0-cc88fab64ce8");
pub const CLSID_WICWmpEncoder = @import("../zig.zig").Guid.initString("ac4ce3cb-e1c1-44cd-8215-5a1665509ec2");
pub const CLSID_WICDdsEncoder = @import("../zig.zig").Guid.initString("a61dde94-66ce-4ac1-881b-71680588895e");
pub const CLSID_WICAdngDecoder = @import("../zig.zig").Guid.initString("981d9411-909e-42a7-8f5d-a747ff052edb");
pub const CLSID_WICJpegQualcommPhoneEncoder = @import("../zig.zig").Guid.initString("68ed5c62-f534-4979-b2b3-686a12b2b34c");
pub const CLSID_WICHeifDecoder = @import("../zig.zig").Guid.initString("e9a4a80a-44fe-4de4-8971-7150b10a5199");
pub const CLSID_WICHeifEncoder = @import("../zig.zig").Guid.initString("0dbecec1-9eb3-4860-9c6f-ddbe86634575");
pub const CLSID_WICWebpDecoder = @import("../zig.zig").Guid.initString("7693e886-51c9-4070-8419-9f70738ec8fa");
pub const CLSID_WICRAWDecoder = @import("../zig.zig").Guid.initString("41945702-8302-44a6-9445-ac98e8afa086");
pub const GUID_ContainerFormatBmp = @import("../zig.zig").Guid.initString("0af1d87e-fcfe-4188-bdeb-a7906471cbe3");
pub const GUID_ContainerFormatPng = @import("../zig.zig").Guid.initString("1b7cfaf4-713f-473c-bbcd-6137425faeaf");
pub const GUID_ContainerFormatIco = @import("../zig.zig").Guid.initString("a3a860c4-338f-4c17-919a-fba4b5628f21");
pub const GUID_ContainerFormatJpeg = @import("../zig.zig").Guid.initString("19e4a5aa-5662-4fc5-a0c0-1758028e1057");
pub const GUID_ContainerFormatTiff = @import("../zig.zig").Guid.initString("163bcc30-e2e9-4f0b-961d-a3e9fdb788a3");
pub const GUID_ContainerFormatGif = @import("../zig.zig").Guid.initString("1f8a5601-7d4d-4cbd-9c82-1bc8d4eeb9a5");
pub const GUID_ContainerFormatWmp = @import("../zig.zig").Guid.initString("57a37caa-367a-4540-916b-f183c5093a4b");
pub const GUID_ContainerFormatDds = @import("../zig.zig").Guid.initString("9967cb95-2e85-4ac8-8ca2-83d7ccd425c9");
pub const GUID_ContainerFormatAdng = @import("../zig.zig").Guid.initString("f3ff6d0d-38c0-41c4-b1fe-1f3824f17b84");
pub const GUID_ContainerFormatHeif = @import("../zig.zig").Guid.initString("e1e62521-6787-405b-a339-500715b5763f");
pub const GUID_ContainerFormatWebp = @import("../zig.zig").Guid.initString("e094b0e2-67f2-45b3-b0ea-115337ca7cf3");
pub const GUID_ContainerFormatRaw = @import("../zig.zig").Guid.initString("fe99ce60-f19c-433c-a3ae-00acefa9ca21");
pub const CLSID_WICImagingCategories = @import("../zig.zig").Guid.initString("fae3d380-fea4-4623-8c75-c6b61110b681");
pub const CATID_WICBitmapDecoders = @import("../zig.zig").Guid.initString("7ed96837-96f0-4812-b211-f13c24117ed3");
pub const CATID_WICBitmapEncoders = @import("../zig.zig").Guid.initString("ac757296-3522-4e11-9862-c17be5a1767e");
pub const CATID_WICPixelFormats = @import("../zig.zig").Guid.initString("2b46e70f-cda7-473e-89f6-dc9630a2390b");
pub const CATID_WICFormatConverters = @import("../zig.zig").Guid.initString("7835eae8-bf14-49d1-93ce-533a407b2248");
pub const CATID_WICMetadataReader = @import("../zig.zig").Guid.initString("05af94d8-7174-4cd2-be4a-4124b80ee4b8");
pub const CATID_WICMetadataWriter = @import("../zig.zig").Guid.initString("abe3b9a4-257d-4b97-bd1a-294af496222e");
pub const CLSID_WICDefaultFormatConverter = @import("../zig.zig").Guid.initString("1a3f11dc-b514-4b17-8c5f-2154513852f1");
pub const CLSID_WICFormatConverterHighColor = @import("../zig.zig").Guid.initString("ac75d454-9f37-48f8-b972-4e19bc856011");
pub const CLSID_WICFormatConverterNChannel = @import("../zig.zig").Guid.initString("c17cabb2-d4a3-47d7-a557-339b2efbd4f1");
pub const CLSID_WICFormatConverterWMPhoto = @import("../zig.zig").Guid.initString("9cb5172b-d600-46ba-ab77-77bb7e3a00d9");
pub const CLSID_WICPlanarFormatConverter = @import("../zig.zig").Guid.initString("184132b8-32f8-4784-9131-dd7224b23438");
...
pub const GUID_WICPixelFormatDontCare = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc900");
pub const GUID_WICPixelFormat1bppIndexed = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc901");
pub const GUID_WICPixelFormat2bppIndexed = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc902");
pub const GUID_WICPixelFormat4bppIndexed = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc903");
pub const GUID_WICPixelFormat8bppIndexed = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc904");
pub const GUID_WICPixelFormatBlackWhite = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc905");
pub const GUID_WICPixelFormat2bppGray = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc906");
pub const GUID_WICPixelFormat4bppGray = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc907");
pub const GUID_WICPixelFormat8bppGray = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc908");
pub const GUID_WICPixelFormat8bppAlpha = @import("../zig.zig").Guid.initString("e6cd0116-eeba-4161-aa85-27dd9fb3a895");
pub const GUID_WICPixelFormat16bppBGR555 = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc909");
pub const GUID_WICPixelFormat16bppBGR565 = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc90a");
pub const GUID_WICPixelFormat16bppBGRA5551 = @import("../zig.zig").Guid.initString("05ec7c2b-f1e6-4961-ad46-e1cc810a87d2");
pub const GUID_WICPixelFormat16bppGray = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc90b");
pub const GUID_WICPixelFormat24bppBGR = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc90c");
pub const GUID_WICPixelFormat24bppRGB = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc90d");
pub const GUID_WICPixelFormat32bppBGR = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc90e");
pub const GUID_WICPixelFormat32bppBGRA = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc90f");
pub const GUID_WICPixelFormat32bppPBGRA = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc910");
pub const GUID_WICPixelFormat32bppGrayFloat = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc911");
pub const GUID_WICPixelFormat32bppRGB = @import("../zig.zig").Guid.initString("d98c6b95-3efe-47d6-bb25-eb1748ab0cf1");
pub const GUID_WICPixelFormat32bppRGBA = @import("../zig.zig").Guid.initString("f5c7ad2d-6a8d-43dd-a7a8-a29935261ae9");
pub const GUID_WICPixelFormat32bppPRGBA = @import("../zig.zig").Guid.initString("3cc4a650-a527-4d37-a916-3142c7ebedba");
pub const GUID_WICPixelFormat48bppRGB = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc915");
pub const GUID_WICPixelFormat48bppBGR = @import("../zig.zig").Guid.initString("e605a384-b468-46ce-bb2e-36f180e64313");
pub const GUID_WICPixelFormat64bppRGB = @import("../zig.zig").Guid.initString("a1182111-186d-4d42-bc6a-9c8303a8dff9");
pub const GUID_WICPixelFormat64bppRGBA = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc916");
pub const GUID_WICPixelFormat64bppBGRA = @import("../zig.zig").Guid.initString("1562ff7c-d352-46f9-979e-42976b792246");
pub const GUID_WICPixelFormat64bppPRGBA = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc917");
pub const GUID_WICPixelFormat64bppPBGRA = @import("../zig.zig").Guid.initString("8c518e8e-a4ec-468b-ae70-c9a35a9c5530");
pub const GUID_WICPixelFormat16bppGrayFixedPoint = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc913");
pub const GUID_WICPixelFormat32bppBGR101010 = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc914");
pub const GUID_WICPixelFormat48bppRGBFixedPoint = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc912");
pub const GUID_WICPixelFormat48bppBGRFixedPoint = @import("../zig.zig").Guid.initString("49ca140e-cab6-493b-9ddf-60187c37532a");
pub const GUID_WICPixelFormat96bppRGBFixedPoint = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc918");
pub const GUID_WICPixelFormat96bppRGBFloat = @import("../zig.zig").Guid.initString("e3fed78f-e8db-4acf-84c1-e97f6136b327");
pub const GUID_WICPixelFormat128bppRGBAFloat = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc919");
pub const GUID_WICPixelFormat128bppPRGBAFloat = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc91a");
pub const GUID_WICPixelFormat128bppRGBFloat = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc91b");
pub const GUID_WICPixelFormat32bppCMYK = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc91c");
pub const GUID_WICPixelFormat64bppRGBAFixedPoint = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc91d");
pub const GUID_WICPixelFormat64bppBGRAFixedPoint = @import("../zig.zig").Guid.initString("356de33c-54d2-4a23-bb04-9b7bf9b1d42d");
pub const GUID_WICPixelFormat64bppRGBFixedPoint = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc940");
pub const GUID_WICPixelFormat128bppRGBAFixedPoint = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc91e");
pub const GUID_WICPixelFormat128bppRGBFixedPoint = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc941");
pub const GUID_WICPixelFormat64bppRGBAHalf = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc93a");
pub const GUID_WICPixelFormat64bppPRGBAHalf = @import("../zig.zig").Guid.initString("58ad26c2-c623-4d9d-b320-387e49f8c442");
pub const GUID_WICPixelFormat64bppRGBHalf = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc942");
pub const GUID_WICPixelFormat48bppRGBHalf = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc93b");
pub const GUID_WICPixelFormat32bppRGBE = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc93d");
pub const GUID_WICPixelFormat16bppGrayHalf = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc93e");
pub const GUID_WICPixelFormat32bppGrayFixedPoint = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc93f");
pub const GUID_WICPixelFormat32bppRGBA1010102 = @import("../zig.zig").Guid.initString("25238d72-fcf9-4522-b514-5578e5ad55e0");
pub const GUID_WICPixelFormat32bppRGBA1010102XR = @import("../zig.zig").Guid.initString("00de6b9a-c101-434b-b502-d0165ee1122c");
pub const GUID_WICPixelFormat32bppR10G10B10A2 = @import("../zig.zig").Guid.initString("604e1bb5-8a3c-4b65-b11c-bc0b8dd75b7f");
pub const GUID_WICPixelFormat32bppR10G10B10A2HDR10 = @import("../zig.zig").Guid.initString("9c215c5d-1acc-4f0e-a4bc-70fb3ae8fd28");
pub const GUID_WICPixelFormat64bppCMYK = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc91f");
pub const GUID_WICPixelFormat24bpp3Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc920");
pub const GUID_WICPixelFormat32bpp4Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc921");
pub const GUID_WICPixelFormat40bpp5Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc922");
pub const GUID_WICPixelFormat48bpp6Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc923");
pub const GUID_WICPixelFormat56bpp7Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc924");
pub const GUID_WICPixelFormat64bpp8Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc925");
pub const GUID_WICPixelFormat48bpp3Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc926");
pub const GUID_WICPixelFormat64bpp4Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc927");
pub const GUID_WICPixelFormat80bpp5Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc928");
pub const GUID_WICPixelFormat96bpp6Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc929");
pub const GUID_WICPixelFormat112bpp7Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc92a");
pub const GUID_WICPixelFormat128bpp8Channels = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc92b");
pub const GUID_WICPixelFormat40bppCMYKAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc92c");
pub const GUID_WICPixelFormat80bppCMYKAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc92d");
pub const GUID_WICPixelFormat32bpp3ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc92e");
pub const GUID_WICPixelFormat40bpp4ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc92f");
pub const GUID_WICPixelFormat48bpp5ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc930");
pub const GUID_WICPixelFormat56bpp6ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc931");
pub const GUID_WICPixelFormat64bpp7ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc932");
pub const GUID_WICPixelFormat72bpp8ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc933");
pub const GUID_WICPixelFormat64bpp3ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc934");
pub const GUID_WICPixelFormat80bpp4ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc935");
pub const GUID_WICPixelFormat96bpp5ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc936");
pub const GUID_WICPixelFormat112bpp6ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc937");
pub const GUID_WICPixelFormat128bpp7ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc938");
pub const GUID_WICPixelFormat144bpp8ChannelsAlpha = @import("../zig.zig").Guid.initString("6fddc324-4e03-4bfe-b185-3d77768dc939");
pub const GUID_WICPixelFormat8bppY = @import("../zig.zig").Guid.initString("91b4db54-2df9-42f0-b449-2909bb3df88e");
pub const GUID_WICPixelFormat8bppCb = @import("../zig.zig").Guid.initString("1339f224-6bfe-4c3e-9302-e4f3a6d0ca2a");
pub const GUID_WICPixelFormat8bppCr = @import("../zig.zig").Guid.initString("b8145053-2116-49f0-8835-ed844b205c51");
pub const GUID_WICPixelFormat16bppCbCr = @import("../zig.zig").Guid.initString("ff95ba6e-11e0-4263-bb45-01721f3460a4");
pub const GUID_WICPixelFormat16bppYQuantizedDctCoefficients = @import("../zig.zig").Guid.initString("a355f433-48e8-4a42-84d8-e2aa26ca80a4");
pub const GUID_WICPixelFormat16bppCbQuantizedDctCoefficients = @import("../zig.zig").Guid.initString("d2c4ff61-56a5-49c2-8b5c-4c1925964837");
pub const GUID_WICPixelFormat16bppCrQuantizedDctCoefficients = @import("../zig.zig").Guid.initString("2fe354f0-1680-42d8-9231-e73c0565bfc1");
...
pub const GUID_MetadataFormatUnknown = @import("../zig.zig").Guid.initString("a45e592f-9078-4a7c-adb5-4edc4fd61b1f");
pub const GUID_MetadataFormatIfd = @import("../zig.zig").Guid.initString("537396c6-2d8a-4bb6-9bf8-2f0a8e2a3adf");
pub const GUID_MetadataFormatSubIfd = @import("../zig.zig").Guid.initString("58a2e128-2db9-4e57-bb14-5177891ed331");
pub const GUID_MetadataFormatExif = @import("../zig.zig").Guid.initString("1c3c4f9d-b84a-467d-9493-36cfbd59ea57");
pub const GUID_MetadataFormatGps = @import("../zig.zig").Guid.initString("7134ab8a-9351-44ad-af62-448db6b502ec");
pub const GUID_MetadataFormatInterop = @import("../zig.zig").Guid.initString("ed686f8e-681f-4c8b-bd41-a8addbf6b3fc");
pub const GUID_MetadataFormatApp0 = @import("../zig.zig").Guid.initString("79007028-268d-45d6-a3c2-354e6a504bc9");
pub const GUID_MetadataFormatApp1 = @import("../zig.zig").Guid.initString("8fd3dfc3-f951-492b-817f-69c2e6d9a5b0");
pub const GUID_MetadataFormatApp13 = @import("../zig.zig").Guid.initString("326556a2-f502-4354-9cc0-8e3f48eaf6b5");
pub const GUID_MetadataFormatIPTC = @import("../zig.zig").Guid.initString("4fab0914-e129-4087-a1d1-bc812d45a7b5");
pub const GUID_MetadataFormatIRB = @import("../zig.zig").Guid.initString("16100d66-8570-4bb9-b92d-fda4b23ece67");
pub const GUID_MetadataFormat8BIMIPTC = @import("../zig.zig").Guid.initString("0010568c-0852-4e6a-b191-5c33ac5b0430");
pub const GUID_MetadataFormat8BIMResolutionInfo = @import("../zig.zig").Guid.initString("739f305d-81db-43cb-ac5e-55013ef9f003");
pub const GUID_MetadataFormat8BIMIPTCDigest = @import("../zig.zig").Guid.initString("1ca32285-9ccd-4786-8bd8-79539db6a006");
pub const GUID_MetadataFormatXMP = @import("../zig.zig").Guid.initString("bb5acc38-f216-4cec-a6c5-5f6e739763a9");
pub const GUID_MetadataFormatThumbnail = @import("../zig.zig").Guid.initString("243dcee9-8703-40ee-8ef0-22a600b8058c");
pub const GUID_MetadataFormatChunktEXt = @import("../zig.zig").Guid.initString("568d8936-c0a9-4923-905d-df2b38238fbc");
pub const GUID_MetadataFormatXMPStruct = @import("../zig.zig").Guid.initString("22383cf1-ed17-4e2e-af17-d85b8f6b30d0");
pub const GUID_MetadataFormatXMPBag = @import("../zig.zig").Guid.initString("833cca5f-dcb7-4516-806f-6596ab26dce4");
pub const GUID_MetadataFormatXMPSeq = @import("../zig.zig").Guid.initString("63e8df02-eb6c-456c-a224-b25e794fd648");
pub const GUID_MetadataFormatXMPAlt = @import("../zig.zig").Guid.initString("7b08a675-91aa-481b-a798-4da94908613b");
pub const GUID_MetadataFormatLSD = @import("../zig.zig").Guid.initString("e256031e-6299-4929-b98d-5ac884afba92");
pub const GUID_MetadataFormatIMD = @import("../zig.zig").Guid.initString("bd2bb086-4d52-48dd-9677-db483e85ae8f");
pub const GUID_MetadataFormatGCE = @import("../zig.zig").Guid.initString("2a25cad8-deeb-4c69-a788-0ec2266dcafd");
pub const GUID_MetadataFormatAPE = @import("../zig.zig").Guid.initString("2e043dc2-c967-4e05-875e-618bf67e85c3");
pub const GUID_MetadataFormatJpegChrominance = @import("../zig.zig").Guid.initString("f73d0dcf-cec6-4f85-9b0e-1c3956b1bef7");
pub const GUID_MetadataFormatJpegLuminance = @import("../zig.zig").Guid.initString("86908007-edfc-4860-8d4b-4ee6e83e6058");
pub const GUID_MetadataFormatJpegComment = @import("../zig.zig").Guid.initString("220e5f33-afd3-474e-9d31-7d4fe730f557");
pub const GUID_MetadataFormatGifComment = @import("../zig.zig").Guid.initString("c4b6e0e0-cfb4-4ad3-ab33-9aad2355a34a");
pub const GUID_MetadataFormatChunkgAMA = @import("../zig.zig").Guid.initString("f00935a5-1d5d-4cd1-81b2-9324d7eca781");
pub const GUID_MetadataFormatChunkbKGD = @import("../zig.zig").Guid.initString("e14d3571-6b47-4dea-b60a-87ce0a78dfb7");
pub const GUID_MetadataFormatChunkiTXt = @import("../zig.zig").Guid.initString("c2bec729-0b68-4b77-aa0e-6295a6ac1814");
pub const GUID_MetadataFormatChunkcHRM = @import("../zig.zig").Guid.initString("9db3655b-2842-44b3-8067-12e9b375556a");
pub const GUID_MetadataFormatChunkhIST = @import("../zig.zig").Guid.initString("c59a82da-db74-48a4-bd6a-b69c4931ef95");
pub const GUID_MetadataFormatChunkiCCP = @import("../zig.zig").Guid.initString("eb4349ab-b685-450f-91b5-e802e892536c");
pub const GUID_MetadataFormatChunksRGB = @import("../zig.zig").Guid.initString("c115fd36-cc6f-4e3f-8363-524b87c6b0d9");
pub const GUID_MetadataFormatChunktIME = @import("../zig.zig").Guid.initString("6b00ae2d-e24b-460a-98b6-878bd03072fd");
pub const GUID_MetadataFormatDds = @import("../zig.zig").Guid.initString("4a064603-8c33-4e60-9c29-136231702d08");
pub const GUID_MetadataFormatHeif = @import("../zig.zig").Guid.initString("817ef3e1-1288-45f4-a852-260d9e7cce83");
pub const GUID_MetadataFormatHeifHDR = @import("../zig.zig").Guid.initString("568b8d8a-1e65-438c-8968-d60e1012beb9");
pub const GUID_MetadataFormatWebpANIM = @import("../zig.zig").Guid.initString("6dc4fda6-78e6-4102-ae35-bcfa1edcc78b");
pub const GUID_MetadataFormatWebpANMF = @import("../zig.zig").Guid.initString("43c105ee-b93b-4abb-b003-a08c0d870471");
pub const CLSID_WICUnknownMetadataReader = @import("../zig.zig").Guid.initString("699745c2-5066-4b82-a8e3-d40478dbec8c");
pub const CLSID_WICUnknownMetadataWriter = @import("../zig.zig").Guid.initString("a09cca86-27ba-4f39-9053-121fa4dc08fc");
pub const CLSID_WICApp0MetadataWriter = @import("../zig.zig").Guid.initString("f3c633a2-46c8-498e-8fbb-cc6f721bbcde");
pub const CLSID_WICApp0MetadataReader = @import("../zig.zig").Guid.initString("43324b33-a78f-480f-9111-9638aaccc832");
pub const CLSID_WICApp1MetadataWriter = @import("../zig.zig").Guid.initString("ee366069-1832-420f-b381-0479ad066f19");
pub const CLSID_WICApp1MetadataReader = @import("../zig.zig").Guid.initString("dde33513-774e-4bcd-ae79-02f4adfe62fc");
pub const CLSID_WICApp13MetadataWriter = @import("../zig.zig").Guid.initString("7b19a919-a9d6-49e5-bd45-02c34e4e4cd5");
pub const CLSID_WICApp13MetadataReader = @import("../zig.zig").Guid.initString("aa7e3c50-864c-4604-bc04-8b0b76e637f6");
pub const CLSID_WICIfdMetadataReader = @import("../zig.zig").Guid.initString("8f914656-9d0a-4eb2-9019-0bf96d8a9ee6");
pub const CLSID_WICIfdMetadataWriter = @import("../zig.zig").Guid.initString("b1ebfc28-c9bd-47a2-8d33-b948769777a7");
pub const CLSID_WICSubIfdMetadataReader = @import("../zig.zig").Guid.initString("50d42f09-ecd1-4b41-b65d-da1fdaa75663");
pub const CLSID_WICSubIfdMetadataWriter = @import("../zig.zig").Guid.initString("8ade5386-8e9b-4f4c-acf2-f0008706b238");
pub const CLSID_WICExifMetadataReader = @import("../zig.zig").Guid.initString("d9403860-297f-4a49-bf9b-77898150a442");
pub const CLSID_WICExifMetadataWriter = @import("../zig.zig").Guid.initString("c9a14cda-c339-460b-9078-d4debcfabe91");
pub const CLSID_WICGpsMetadataReader = @import("../zig.zig").Guid.initString("3697790b-223b-484e-9925-c4869218f17a");
pub const CLSID_WICGpsMetadataWriter = @import("../zig.zig").Guid.initString("cb8c13e4-62b5-4c96-a48b-6ba6ace39c76");
pub const CLSID_WICInteropMetadataReader = @import("../zig.zig").Guid.initString("b5c8b898-0074-459f-b700-860d4651ea14");
pub const CLSID_WICInteropMetadataWriter = @import("../zig.zig").Guid.initString("122ec645-cd7e-44d8-b186-2c8c20c3b50f");
pub const CLSID_WICThumbnailMetadataReader = @import("../zig.zig").Guid.initString("fb012959-f4f6-44d7-9d09-daa087a9db57");
pub const CLSID_WICThumbnailMetadataWriter = @import("../zig.zig").Guid.initString("d049b20c-5dd0-44fe-b0b3-8f92c8e6d080");
pub const CLSID_WICIPTCMetadataReader = @import("../zig.zig").Guid.initString("03012959-f4f6-44d7-9d09-daa087a9db57");
pub const CLSID_WICIPTCMetadataWriter = @import("../zig.zig").Guid.initString("1249b20c-5dd0-44fe-b0b3-8f92c8e6d080");
pub const CLSID_WICIRBMetadataReader = @import("../zig.zig").Guid.initString("d4dcd3d7-b4c2-47d9-a6bf-b89ba396a4a3");
pub const CLSID_WICIRBMetadataWriter = @import("../zig.zig").Guid.initString("5c5c1935-0235-4434-80bc-251bc1ec39c6");
pub const CLSID_WIC8BIMIPTCMetadataReader = @import("../zig.zig").Guid.initString("0010668c-0801-4da6-a4a4-826522b6d28f");
pub const CLSID_WIC8BIMIPTCMetadataWriter = @import("../zig.zig").Guid.initString("00108226-ee41-44a2-9e9c-4be4d5b1d2cd");
pub const CLSID_WIC8BIMResolutionInfoMetadataReader = @import("../zig.zig").Guid.initString("5805137a-e348-4f7c-b3cc-6db9965a0599");
pub const CLSID_WIC8BIMResolutionInfoMetadataWriter = @import("../zig.zig").Guid.initString("4ff2fe0e-e74a-4b71-98c4-ab7dc16707ba");
pub const CLSID_WIC8BIMIPTCDigestMetadataReader = @import("../zig.zig").Guid.initString("02805f1e-d5aa-415b-82c5-61c033a988a6");
pub const CLSID_WIC8BIMIPTCDigestMetadataWriter = @import("../zig.zig").Guid.initString("2db5e62b-0d67-495f-8f9d-c2f0188647ac");
pub const CLSID_WICPngTextMetadataReader = @import("../zig.zig").Guid.initString("4b59afcc-b8c3-408a-b670-89e5fab6fda7");
pub const CLSID_WICPngTextMetadataWriter = @import("../zig.zig").Guid.initString("b5ebafb9-253e-4a72-a744-0762d2685683");
pub const CLSID_WICXMPMetadataReader = @import("../zig.zig").Guid.initString("72b624df-ae11-4948-a65c-351eb0829419");
pub const CLSID_WICXMPMetadataWriter = @import("../zig.zig").Guid.initString("1765e14e-1bd4-462e-b6b1-590bf1262ac6");
pub const CLSID_WICXMPStructMetadataReader = @import("../zig.zig").Guid.initString("01b90d9a-8209-47f7-9c52-e1244bf50ced");
pub const CLSID_WICXMPStructMetadataWriter = @import("../zig.zig").Guid.initString("22c21f93-7ddb-411c-9b17-c5b7bd064abc");
pub const CLSID_WICXMPBagMetadataReader = @import("../zig.zig").Guid.initString("e7e79a30-4f2c-4fab-8d00-394f2d6bbebe");
pub const CLSID_WICXMPBagMetadataWriter = @import("../zig.zig").Guid.initString("ed822c8c-d6be-4301-a631-0e1416bad28f");
pub const CLSID_WICXMPSeqMetadataReader = @import("../zig.zig").Guid.initString("7f12e753-fc71-43d7-a51d-92f35977abb5");
pub const CLSID_WICXMPSeqMetadataWriter = @import("../zig.zig").Guid.initString("6d68d1de-d432-4b0f-923a-091183a9bda7");
pub const CLSID_WICXMPAltMetadataReader = @import("../zig.zig").Guid.initString("aa94dcc2-b8b0-4898-b835-000aabd74393");
pub const CLSID_WICXMPAltMetadataWriter = @import("../zig.zig").Guid.initString("076c2a6c-f78f-4c46-a723-3583e70876ea");
pub const CLSID_WICLSDMetadataReader = @import("../zig.zig").Guid.initString("41070793-59e4-479a-a1f7-954adc2ef5fc");
pub const CLSID_WICLSDMetadataWriter = @import("../zig.zig").Guid.initString("73c037e7-e5d9-4954-876a-6da81d6e5768");
pub const CLSID_WICGCEMetadataReader = @import("../zig.zig").Guid.initString("b92e345d-f52d-41f3-b562-081bc772e3b9");
pub const CLSID_WICGCEMetadataWriter = @import("../zig.zig").Guid.initString("af95dc76-16b2-47f4-b3ea-3c31796693e7");
pub const CLSID_WICIMDMetadataReader = @import("../zig.zig").Guid.initString("7447a267-0015-42c8-a8f1-fb3b94c68361");
pub const CLSID_WICIMDMetadataWriter = @import("../zig.zig").Guid.initString("8c89071f-452e-4e95-9682-9d1024627172");
pub const CLSID_WICAPEMetadataReader = @import("../zig.zig").Guid.initString("1767b93a-b021-44ea-920f-863c11f4f768");
pub const CLSID_WICAPEMetadataWriter = @import("../zig.zig").Guid.initString("bd6edfca-2890-482f-b233-8d7339a1cf8d");
pub const CLSID_WICJpegChrominanceMetadataReader = @import("../zig.zig").Guid.initString("50b1904b-f28f-4574-93f4-0bade82c69e9");
pub const CLSID_WICJpegChrominanceMetadataWriter = @import("../zig.zig").Guid.initString("3ff566f0-6e6b-49d4-96e6-b78886692c62");
pub const CLSID_WICJpegLuminanceMetadataReader = @import("../zig.zig").Guid.initString("356f2f88-05a6-4728-b9a4-1bfbce04d838");
pub const CLSID_WICJpegLuminanceMetadataWriter = @import("../zig.zig").Guid.initString("1d583abc-8a0e-4657-9982-a380ca58fb4b");
pub const CLSID_WICJpegCommentMetadataReader = @import("../zig.zig").Guid.initString("9f66347c-60c4-4c4d-ab58-d2358685f607");
pub const CLSID_WICJpegCommentMetadataWriter = @import("../zig.zig").Guid.initString("e573236f-55b1-4eda-81ea-9f65db0290d3");
pub const CLSID_WICGifCommentMetadataReader = @import("../zig.zig").Guid.initString("32557d3b-69dc-4f95-836e-f5972b2f6159");
pub const CLSID_WICGifCommentMetadataWriter = @import("../zig.zig").Guid.initString("a02797fc-c4ae-418c-af95-e637c7ead2a1");
pub const CLSID_WICPngGamaMetadataReader = @import("../zig.zig").Guid.initString("3692ca39-e082-4350-9e1f-3704cb083cd5");
pub const CLSID_WICPngGamaMetadataWriter = @import("../zig.zig").Guid.initString("ff036d13-5d4b-46dd-b10f-106693d9fe4f");
pub const CLSID_WICPngBkgdMetadataReader = @import("../zig.zig").Guid.initString("0ce7a4a6-03e8-4a60-9d15-282ef32ee7da");
pub const CLSID_WICPngBkgdMetadataWriter = @import("../zig.zig").Guid.initString("68e3f2fd-31ae-4441-bb6a-fd7047525f90");
pub const CLSID_WICPngItxtMetadataReader = @import("../zig.zig").Guid.initString("aabfb2fa-3e1e-4a8f-8977-5556fb94ea23");
pub const CLSID_WICPngItxtMetadataWriter = @import("../zig.zig").Guid.initString("31879719-e751-4df8-981d-68dff67704ed");
pub const CLSID_WICPngChrmMetadataReader = @import("../zig.zig").Guid.initString("f90b5f36-367b-402a-9dd1-bc0fd59d8f62");
pub const CLSID_WICPngChrmMetadataWriter = @import("../zig.zig").Guid.initString("e23ce3eb-5608-4e83-bcef-27b1987e51d7");
pub const CLSID_WICPngHistMetadataReader = @import("../zig.zig").Guid.initString("877a0bb7-a313-4491-87b5-2e6d0594f520");
pub const CLSID_WICPngHistMetadataWriter = @import("../zig.zig").Guid.initString("8a03e749-672e-446e-bf1f-2c11d233b6ff");
pub const CLSID_WICPngIccpMetadataReader = @import("../zig.zig").Guid.initString("f5d3e63b-cb0f-4628-a478-6d8244be36b1");
pub const CLSID_WICPngIccpMetadataWriter = @import("../zig.zig").Guid.initString("16671e5f-0ce6-4cc4-9768-e89fe5018ade");
pub const CLSID_WICPngSrgbMetadataReader = @import("../zig.zig").Guid.initString("fb40360c-547e-4956-a3b9-d4418859ba66");
pub const CLSID_WICPngSrgbMetadataWriter = @import("../zig.zig").Guid.initString("a6ee35c6-87ec-47df-9f22-1d5aad840c82");
pub const CLSID_WICPngTimeMetadataReader = @import("../zig.zig").Guid.initString("d94edf02-efe5-4f0d-85c8-f5a68b3000b1");
pub const CLSID_WICPngTimeMetadataWriter = @import("../zig.zig").Guid.initString("1ab78400-b5a3-4d91-8ace-33fcd1499be6");
pub const CLSID_WICDdsMetadataReader = @import("../zig.zig").Guid.initString("276c88ca-7533-4a86-b676-66b36080d484");
pub const CLSID_WICDdsMetadataWriter = @import("../zig.zig").Guid.initString("fd688bbd-31ed-4db7-a723-934927d38367");
pub const CLSID_WICHeifMetadataReader = @import("../zig.zig").Guid.initString("acddfc3f-85ec-41bc-bdef-1bc262e4db05");
pub const CLSID_WICHeifMetadataWriter = @import("../zig.zig").Guid.initString("3ae45e79-40bc-4401-ace5-dd3cb16e6afe");
pub const CLSID_WICHeifHDRMetadataReader = @import("../zig.zig").Guid.initString("2438de3d-94d9-4be8-84a8-4de95a575e75");
pub const CLSID_WICWebpAnimMetadataReader = @import("../zig.zig").Guid.initString("076f9911-a348-465c-a807-a252f3f2d3de");
pub const CLSID_WICWebpAnmfMetadataReader = @import("../zig.zig").Guid.initString("85a10b03-c9f6-439f-be5e-c0fbef67807c");
