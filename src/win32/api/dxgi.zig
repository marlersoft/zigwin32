...
pub const DXGI_SHARED_RESOURCE_READ : i32 = -2147483648;
pub const DXGI_SHARED_RESOURCE_WRITE : u32 = 1;
pub const DXGI_DEBUG_BINARY_VERSION : u32 = 1;
pub const DXGI_DEBUG_ALL = @import("../zig.zig").Guid.initString("e48ae283-da80-490b-87e6-43e9a9cfda08");
pub const DXGI_DEBUG_DX = @import("../zig.zig").Guid.initString("35cdd7fc-13b2-421d-a5d7-7e4451287d64");
pub const DXGI_DEBUG_DXGI = @import("../zig.zig").Guid.initString("25cddaa4-b1c6-47e1-ac3e-98875b5a2e2a");
pub const DXGI_DEBUG_APP = @import("../zig.zig").Guid.initString("06cd6e01-4219-4ebd-8709-27ed23360c62");
