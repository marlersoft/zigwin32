...
pub const UI_ANIMATION_UPDATE_NO_CHANGE = UI_ANIMATION_UPDATE_RESULT.UI_ANIMATION_UPDATE_NO_CHANGE;
pub const UI_ANIMATION_UPDATE_VARIABLES_CHANGED = UI_ANIMATION_UPDATE_RESULT.UI_ANIMATION_UPDATE_VARIABLES_CHANGED;

pub const UI_ANIMATION_MANAGER_STATUS = extern enum(i32) {
    UI_ANIMATION_MANAGER_IDLE = 0,
    UI_ANIMATION_MANAGER_BUSY = 1,
};
pub const UI_ANIMATION_MANAGER_IDLE = UI_ANIMATION_MANAGER_STATUS.UI_ANIMATION_MANAGER_IDLE;
pub const UI_ANIMATION_MANAGER_BUSY = UI_ANIMATION_MANAGER_STATUS.UI_ANIMATION_MANAGER_BUSY;
...
pub const UI_ANIMATION_ROUNDING_NEAREST = UI_ANIMATION_ROUNDING_MODE.UI_ANIMATION_ROUNDING_NEAREST;
...
pub const UI_ANIMATION_STORYBOARD_BUILDING = UI_ANIMATION_STORYBOARD_STATUS.UI_ANIMATION_STORYBOARD_BUILDING;
pub const UI_ANIMATION_STORYBOARD_SCHEDULED = UI_ANIMATION_STORYBOARD_STATUS.UI_ANIMATION_STORYBOARD_SCHEDULED;
pub const UI_ANIMATION_STORYBOARD_CANCELLED = UI_ANIMATION_STORYBOARD_STATUS.UI_ANIMATION_STORYBOARD_CANCELLED;
pub const UI_ANIMATION_STORYBOARD_PLAYING = UI_ANIMATION_STORYBOARD_STATUS.UI_ANIMATION_STORYBOARD_PLAYING;
pub const UI_ANIMATION_STORYBOARD_TRUNCATED = UI_ANIMATION_STORYBOARD_STATUS.UI_ANIMATION_STORYBOARD_TRUNCATED;
pub const UI_ANIMATION_STORYBOARD_FINISHED = UI_ANIMATION_STORYBOARD_STATUS.UI_ANIMATION_STORYBOARD_FINISHED;
pub const UI_ANIMATION_STORYBOARD_READY = UI_ANIMATION_STORYBOARD_STATUS.UI_ANIMATION_STORYBOARD_READY;
pub const UI_ANIMATION_STORYBOARD_INSUFFICIENT_PRIORITY = UI_ANIMATION_STORYBOARD_STATUS.UI_ANIMATION_STORYBOARD_INSUFFICIENT_PRIORITY;
...
pub const UI_ANIMATION_SCHEDULING_UNEXPECTED_FAILURE = UI_ANIMATION_SCHEDULING_RESULT.UI_ANIMATION_SCHEDULING_UNEXPECTED_FAILURE;
pub const UI_ANIMATION_SCHEDULING_INSUFFICIENT_PRIORITY = UI_ANIMATION_SCHEDULING_RESULT.UI_ANIMATION_SCHEDULING_INSUFFICIENT_PRIORITY;
pub const UI_ANIMATION_SCHEDULING_ALREADY_SCHEDULED = UI_ANIMATION_SCHEDULING_RESULT.UI_ANIMATION_SCHEDULING_ALREADY_SCHEDULED;
...
pub const UI_ANIMATION_DEPENDENCY_NONE = UI_ANIMATION_DEPENDENCIES.UI_ANIMATION_DEPENDENCY_NONE;
pub const UI_ANIMATION_DEPENDENCY_INTERMEDIATE_VALUES = UI_ANIMATION_DEPENDENCIES.UI_ANIMATION_DEPENDENCY_INTERMEDIATE_VALUES;
pub const UI_ANIMATION_DEPENDENCY_FINAL_VALUE = UI_ANIMATION_DEPENDENCIES.UI_ANIMATION_DEPENDENCY_FINAL_VALUE;
...
// Section: Imports (4)
//--------------------------------------------------------------------------------
const IDCompositionAnimation = @import("direct_composition.zig").IDCompositionAnimation;
...
test {
    ...
    const enum_value_export_count = 38;
    const com_iface_id_export_count = 31;
    const com_class_id_export_count = 7;
