...
pub const ACTCTX_RUN_LEVEL_UNSPECIFIED = ACTCTX_REQUESTED_RUN_LEVEL.ACTCTX_RUN_LEVEL_UNSPECIFIED;
pub const ACTCTX_RUN_LEVEL_AS_INVOKER = ACTCTX_REQUESTED_RUN_LEVEL.ACTCTX_RUN_LEVEL_AS_INVOKER;
pub const ACTCTX_RUN_LEVEL_HIGHEST_AVAILABLE = ACTCTX_REQUESTED_RUN_LEVEL.ACTCTX_RUN_LEVEL_HIGHEST_AVAILABLE;
pub const ACTCTX_RUN_LEVEL_REQUIRE_ADMIN = ACTCTX_REQUESTED_RUN_LEVEL.ACTCTX_RUN_LEVEL_REQUIRE_ADMIN;
pub const ACTCTX_RUN_LEVEL_NUMBERS = ACTCTX_REQUESTED_RUN_LEVEL.ACTCTX_RUN_LEVEL_NUMBERS;
...
pub const ieUnknown = RESULTTYPES.ieUnknown;
pub const ieError = RESULTTYPES.ieError;
pub const ieWarning = RESULTTYPES.ieWarning;
pub const ieInfo = RESULTTYPES.ieInfo;
...
pub const ieStatusGetCUB = STATUSTYPES.ieStatusGetCUB;
pub const ieStatusICECount = STATUSTYPES.ieStatusICECount;
pub const ieStatusMerge = STATUSTYPES.ieStatusMerge;
pub const ieStatusSummaryInfo = STATUSTYPES.ieStatusSummaryInfo;
pub const ieStatusCreateEngine = STATUSTYPES.ieStatusCreateEngine;
pub const ieStatusStarting = STATUSTYPES.ieStatusStarting;
pub const ieStatusRunICE = STATUSTYPES.ieStatusRunICE;
pub const ieStatusShutdown = STATUSTYPES.ieStatusShutdown;
pub const ieStatusSuccess = STATUSTYPES.ieStatusSuccess;
pub const ieStatusFail = STATUSTYPES.ieStatusFail;
pub const ieStatusCancel = STATUSTYPES.ieStatusCancel;
...
pub const msmErrorLanguageUnsupported = msmErrorType.msmErrorLanguageUnsupported;
pub const msmErrorLanguageFailed = msmErrorType.msmErrorLanguageFailed;
pub const msmErrorExclusion = msmErrorType.msmErrorExclusion;
pub const msmErrorTableMerge = msmErrorType.msmErrorTableMerge;
pub const msmErrorResequenceMerge = msmErrorType.msmErrorResequenceMerge;
pub const msmErrorFileCreate = msmErrorType.msmErrorFileCreate;
pub const msmErrorDirCreate = msmErrorType.msmErrorDirCreate;
pub const msmErrorFeatureRequired = msmErrorType.msmErrorFeatureRequired;
...
pub const INSTALLUI_HANDLER_RECORD = fn(
    pvContext: *c_void,
    iMessageType: u32,
    hRecord: MSIHANDLE,
) callconv(@import("std").os.windows.WINAPI) i32;
...
pub const tagINSTALLOGMODE = extern enum(i32) {
...
pub const INSTALLLOGMODE_FATALEXIT = tagINSTALLOGMODE.INSTALLLOGMODE_FATALEXIT;
pub const INSTALLLOGMODE_ERROR = tagINSTALLOGMODE.INSTALLLOGMODE_ERROR;
pub const INSTALLLOGMODE_WARNING = tagINSTALLOGMODE.INSTALLLOGMODE_WARNING;
pub const INSTALLLOGMODE_USER = tagINSTALLOGMODE.INSTALLLOGMODE_USER;
pub const INSTALLLOGMODE_INFO = tagINSTALLOGMODE.INSTALLLOGMODE_INFO;
pub const INSTALLLOGMODE_RESOLVESOURCE = tagINSTALLOGMODE.INSTALLLOGMODE_RESOLVESOURCE;
pub const INSTALLLOGMODE_OUTOFDISKSPACE = tagINSTALLOGMODE.INSTALLLOGMODE_OUTOFDISKSPACE;
pub const INSTALLLOGMODE_ACTIONSTART = tagINSTALLOGMODE.INSTALLLOGMODE_ACTIONSTART;
pub const INSTALLLOGMODE_ACTIONDATA = tagINSTALLOGMODE.INSTALLLOGMODE_ACTIONDATA;
pub const INSTALLLOGMODE_COMMONDATA = tagINSTALLOGMODE.INSTALLLOGMODE_COMMONDATA;
pub const INSTALLLOGMODE_PROPERTYDUMP = tagINSTALLOGMODE.INSTALLLOGMODE_PROPERTYDUMP;
pub const INSTALLLOGMODE_VERBOSE = tagINSTALLOGMODE.INSTALLLOGMODE_VERBOSE;
pub const INSTALLLOGMODE_EXTRADEBUG = tagINSTALLOGMODE.INSTALLLOGMODE_EXTRADEBUG;
pub const INSTALLLOGMODE_LOGONLYONERROR = tagINSTALLOGMODE.INSTALLLOGMODE_LOGONLYONERROR;
pub const INSTALLLOGMODE_LOGPERFORMANCE = tagINSTALLOGMODE.INSTALLLOGMODE_LOGPERFORMANCE;
pub const INSTALLLOGMODE_PROGRESS = tagINSTALLOGMODE.INSTALLLOGMODE_PROGRESS;
pub const INSTALLLOGMODE_INITIALIZE = tagINSTALLOGMODE.INSTALLLOGMODE_INITIALIZE;
pub const INSTALLLOGMODE_TERMINATE = tagINSTALLOGMODE.INSTALLLOGMODE_TERMINATE;
pub const INSTALLLOGMODE_SHOWDIALOG = tagINSTALLOGMODE.INSTALLLOGMODE_SHOWDIALOG;
pub const INSTALLLOGMODE_FILESINUSE = tagINSTALLOGMODE.INSTALLLOGMODE_FILESINUSE;
pub const INSTALLLOGMODE_RMFILESINUSE = tagINSTALLOGMODE.INSTALLLOGMODE_RMFILESINUSE;
pub const INSTALLLOGMODE_INSTALLSTART = tagINSTALLOGMODE.INSTALLLOGMODE_INSTALLSTART;
pub const INSTALLLOGMODE_INSTALLEND = tagINSTALLOGMODE.INSTALLLOGMODE_INSTALLEND;
...
pub const MSIPATCH_DATATYPE_PATCHFILE = MSIPATCHDATATYPE.MSIPATCH_DATATYPE_PATCHFILE;
pub const MSIPATCH_DATATYPE_XMLPATH = MSIPATCHDATATYPE.MSIPATCH_DATATYPE_XMLPATH;
pub const MSIPATCH_DATATYPE_XMLBLOB = MSIPATCHDATATYPE.MSIPATCH_DATATYPE_XMLBLOB;
...
pub const MSIOPENPACKAGEFLAGS_IGNOREMACHINESTATE = MSIOPENPACKAGEFLAGS.IGNOREMACHINESTATE;

pub const MSIADVERTISEOPTIONFLAGS = extern enum(i32) {
    INSTANCE = 1,
};
pub const MSIADVERTISEOPTIONFLAGS_INSTANCE = MSIADVERTISEOPTIONFLAGS.INSTANCE;
...
pub const MSICODE_PRODUCT = MSICODE.PRODUCT;
pub const MSICODE_PATCH = MSICODE.PATCH;
...
pub const __MIDL_IAssemblyName_0002 = extern enum(i32) {
...
pub const ASM_BINDF_FORCE_CACHE_INSTALL = __MIDL_IAssemblyName_0002.ASM_BINDF_FORCE_CACHE_INSTALL;
pub const ASM_BINDF_RFS_INTEGRITY_CHECK = __MIDL_IAssemblyName_0002.ASM_BINDF_RFS_INTEGRITY_CHECK;
pub const ASM_BINDF_RFS_MODULE_CHECK = __MIDL_IAssemblyName_0002.ASM_BINDF_RFS_MODULE_CHECK;
pub const ASM_BINDF_BINPATH_PROBE_ONLY = __MIDL_IAssemblyName_0002.ASM_BINDF_BINPATH_PROBE_ONLY;
pub const ASM_BINDF_SHARED_BINPATH_HINT = __MIDL_IAssemblyName_0002.ASM_BINDF_SHARED_BINPATH_HINT;
pub const ASM_BINDF_PARENT_ASM_HINT = __MIDL_IAssemblyName_0002.ASM_BINDF_PARENT_ASM_HINT;
...
pub const ASM_DISPLAYF_VERSION = ASM_DISPLAY_FLAGS.ASM_DISPLAYF_VERSION;
pub const ASM_DISPLAYF_CULTURE = ASM_DISPLAY_FLAGS.ASM_DISPLAYF_CULTURE;
pub const ASM_DISPLAYF_PUBLIC_KEY_TOKEN = ASM_DISPLAY_FLAGS.ASM_DISPLAYF_PUBLIC_KEY_TOKEN;
pub const ASM_DISPLAYF_PUBLIC_KEY = ASM_DISPLAY_FLAGS.ASM_DISPLAYF_PUBLIC_KEY;
pub const ASM_DISPLAYF_CUSTOM = ASM_DISPLAY_FLAGS.ASM_DISPLAYF_CUSTOM;
pub const ASM_DISPLAYF_PROCESSORARCHITECTURE = ASM_DISPLAY_FLAGS.ASM_DISPLAYF_PROCESSORARCHITECTURE;
pub const ASM_DISPLAYF_LANGUAGEID = ASM_DISPLAY_FLAGS.ASM_DISPLAYF_LANGUAGEID;
...
pub const ASM_CMPF_NAME = ASM_CMP_FLAGS.ASM_CMPF_NAME;
pub const ASM_CMPF_MAJOR_VERSION = ASM_CMP_FLAGS.ASM_CMPF_MAJOR_VERSION;
pub const ASM_CMPF_MINOR_VERSION = ASM_CMP_FLAGS.ASM_CMPF_MINOR_VERSION;
pub const ASM_CMPF_BUILD_NUMBER = ASM_CMP_FLAGS.ASM_CMPF_BUILD_NUMBER;
pub const ASM_CMPF_REVISION_NUMBER = ASM_CMP_FLAGS.ASM_CMPF_REVISION_NUMBER;
pub const ASM_CMPF_PUBLIC_KEY_TOKEN = ASM_CMP_FLAGS.ASM_CMPF_PUBLIC_KEY_TOKEN;
pub const ASM_CMPF_CULTURE = ASM_CMP_FLAGS.ASM_CMPF_CULTURE;
pub const ASM_CMPF_CUSTOM = ASM_CMP_FLAGS.ASM_CMPF_CUSTOM;
pub const ASM_CMPF_ALL = ASM_CMP_FLAGS.ASM_CMPF_ALL;
pub const ASM_CMPF_DEFAULT = ASM_CMP_FLAGS.ASM_CMPF_DEFAULT;
...
pub const IAssemblyCache = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        pub usingnamespace IUnknown.MethodMixin(T);
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAssemblyCache_UninstallAssembly(self: *const T, dwFlags: u32, pszAssemblyName: [*:0]const u16, pRefData: *FUSION_INSTALL_REFERENCE, pulDisposition: *u32) callconv(.Inline) HRESULT {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IAssemblyCache_QueryAssemblyInfo(self: *const T, dwFlags: u32, pszAssemblyName: [*:0]const u16, pAsmInfo: *ASSEMBLY_INFO) callconv(.Inline) HRESULT {
...
pub const CANOF_PARSE_DISPLAY_NAME = CREATE_ASM_NAME_OBJ_FLAGS.CANOF_PARSE_DISPLAY_NAME;
pub const CANOF_SET_DEFAULT_VALUES = CREATE_ASM_NAME_OBJ_FLAGS.CANOF_SET_DEFAULT_VALUES;
...
test {
    ...
    const enum_value_export_count = 320;
