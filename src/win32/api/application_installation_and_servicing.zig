...
pub const CLSID_EvalCom2 = @import("../zig.zig").Guid.initString("6e5e1910-8053-4660-b795-6b612e29bc58");
pub const LIBID_MsmMergeTypeLib = @import("../zig.zig").Guid.initString("0adda82f-2c26-11d2-ad65-00a0c9af11a6");
pub const CLSID_MsmMerge2 = @import("../zig.zig").Guid.initString("f94985d5-29f9-4743-9805-99bc3f35b678");
...
pub const NTDDI_WINTHRESHOLD : u32 = 100925440;
...
pub const FUSION_REFCOUNT_UNINSTALL_SUBKEY_GUID = @import("../zig.zig").Guid.initString("8cedc215-ac4b-488b-93c0-a50a49cb2fb8");
pub const FUSION_REFCOUNT_FILEPATH_GUID = @import("../zig.zig").Guid.initString("b02f9d65-fb77-4f7a-afa5-b391309f11c9");
pub const FUSION_REFCOUNT_OPAQUE_STRING_GUID = @import("../zig.zig").Guid.initString("2ec93463-b0c3-45e1-8364-327e96aea856");
...
pub const MsiSourceList_dwContext = extern enum(u32) {
    USERMANAGED = 1,
    USERUNMANAGED = 2,
    MACHINE = 4,
};
// TODO: enum 'MsiSourceList_dwContext' has known issues with its value aliases
...
pub const MsiViewModify_eModifyModeFlags = extern enum(u32) {
    REFRESH = 0,
    INSERT = 1,
    UPDATE = 2,
    ASSIGN = 3,
...
// TODO: enum 'MsiViewModify_eModifyModeFlags' has known issues with its value aliases
...
pub const LPDISPLAYVAL_uiTypeFlags = extern enum(u32) {
    Unknown = 0,
    Error = 1,
    Warning = 2,
    Info = 3,
};
// TODO: enum 'LPDISPLAYVAL_uiTypeFlags' has known issues with its value aliases
...
pub const LPDISPLAYVAL = fn(
    pContext: *c_void,
    uiType: LPDISPLAYVAL_uiTypeFlags,
    szwVal: [*:0]const u16,
...
pub extern "msi" fn MsiGetComponentPathExA(
    ...
    szUserSid: ?[*:0]const u8,
    dwContext: MsiSourceList_dwContext,
...
pub extern "msi" fn MsiEnumClientsExA(
    ...
    dwProductIndex: u32,
    szProductBuf: ?*i8,
    pdwInstalledContext: MsiSourceList_dwContext,
    szSid: ?[*:0]u8,
    pcchSid: ?*u32,
) callconv(@import("std").os.windows.WINAPI) u32;
...
pub extern "msi" fn MsiViewModify(
    hView: MSIHANDLE,
    eModifyMode: MsiViewModify_eModifyModeFlags,
    hRecord: MSIHANDLE,
) callconv(@import("std").os.windows.WINAPI) u32;
