...
pub const EventTraceGuid = @import("../zig.zig").Guid.initString("68fdd900-4a3e-11d1-84f4-0000f80464e3");
pub const SystemTraceControlGuid = @import("../zig.zig").Guid.initString("9e814aad-3204-11d2-9a82-006008a86939");
pub const EventTraceConfigGuid = @import("../zig.zig").Guid.initString("01853a65-418f-4f36-aefc-dc0f1d2fd235");
pub const DefaultTraceSecurityGuid = @import("../zig.zig").Guid.initString("0811c1af-7a07-4a06-82ed-869455cdf713");
pub const PrivateLoggerNotificationGuid = @import("../zig.zig").Guid.initString("3595ab5c-042a-4c8e-b942-2d059bfeb1b1");
...
pub const EVENT_HEADER_EXT_TYPE_MAX : u32 = 17;
...
test {
    ...
    const constant_export_count = 345;
    const type_export_count = 101;
    const enum_value_export_count = 223;
