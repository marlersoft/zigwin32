...
//--------------------------------------------------------------------------------
pub const CLSID_WMPSkinManager = @import("../zig.zig").Guid.initString("b2a7fd52-301f-4348-b93a-638c6de49229");
pub const CLSID_WMPMediaPluginRegistrar = @import("../zig.zig").Guid.initString("5569e7f5-424b-4b93-89ca-79d17924689a");
pub const WMP_PLUGINTYPE_DSP = @import("../zig.zig").Guid.initString("6434baea-4954-498d-abd5-2b07123e1f04");
pub const WMP_PLUGINTYPE_DSP_OUTOFPROC = @import("../zig.zig").Guid.initString("ef29b174-c347-44cc-9a4f-2399118ff38c");
pub const WMP_PLUGINTYPE_RENDERING = @import("../zig.zig").Guid.initString("a8554541-115d-406a-a4c7-51111c330183");
...
pub const wmposUndefined = WMPOpenState.wmposUndefined;
pub const wmposPlaylistChanging = WMPOpenState.wmposPlaylistChanging;
pub const wmposPlaylistLocating = WMPOpenState.wmposPlaylistLocating;
pub const wmposPlaylistConnecting = WMPOpenState.wmposPlaylistConnecting;
pub const wmposPlaylistLoading = WMPOpenState.wmposPlaylistLoading;
pub const wmposPlaylistOpening = WMPOpenState.wmposPlaylistOpening;
pub const wmposPlaylistOpenNoMedia = WMPOpenState.wmposPlaylistOpenNoMedia;
pub const wmposPlaylistChanged = WMPOpenState.wmposPlaylistChanged;
pub const wmposMediaChanging = WMPOpenState.wmposMediaChanging;
pub const wmposMediaLocating = WMPOpenState.wmposMediaLocating;
pub const wmposMediaConnecting = WMPOpenState.wmposMediaConnecting;
pub const wmposMediaLoading = WMPOpenState.wmposMediaLoading;
pub const wmposMediaOpening = WMPOpenState.wmposMediaOpening;
pub const wmposMediaOpen = WMPOpenState.wmposMediaOpen;
pub const wmposBeginCodecAcquisition = WMPOpenState.wmposBeginCodecAcquisition;
pub const wmposEndCodecAcquisition = WMPOpenState.wmposEndCodecAcquisition;
pub const wmposBeginLicenseAcquisition = WMPOpenState.wmposBeginLicenseAcquisition;
pub const wmposEndLicenseAcquisition = WMPOpenState.wmposEndLicenseAcquisition;
pub const wmposBeginIndividualization = WMPOpenState.wmposBeginIndividualization;
pub const wmposEndIndividualization = WMPOpenState.wmposEndIndividualization;
pub const wmposMediaWaiting = WMPOpenState.wmposMediaWaiting;
pub const wmposOpeningUnknownURL = WMPOpenState.wmposOpeningUnknownURL;
...
pub const wmppsUndefined = WMPPlayState.wmppsUndefined;
pub const wmppsStopped = WMPPlayState.wmppsStopped;
pub const wmppsPaused = WMPPlayState.wmppsPaused;
pub const wmppsPlaying = WMPPlayState.wmppsPlaying;
pub const wmppsScanForward = WMPPlayState.wmppsScanForward;
pub const wmppsScanReverse = WMPPlayState.wmppsScanReverse;
pub const wmppsBuffering = WMPPlayState.wmppsBuffering;
pub const wmppsWaiting = WMPPlayState.wmppsWaiting;
pub const wmppsMediaEnded = WMPPlayState.wmppsMediaEnded;
pub const wmppsTransitioning = WMPPlayState.wmppsTransitioning;
pub const wmppsReady = WMPPlayState.wmppsReady;
pub const wmppsReconnecting = WMPPlayState.wmppsReconnecting;
pub const wmppsLast = WMPPlayState.wmppsLast;
...
pub const wmplcUnknown = WMPPlaylistChangeEventType.wmplcUnknown;
pub const wmplcClear = WMPPlaylistChangeEventType.wmplcClear;
pub const wmplcInfoChange = WMPPlaylistChangeEventType.wmplcInfoChange;
pub const wmplcMove = WMPPlaylistChangeEventType.wmplcMove;
pub const wmplcDelete = WMPPlaylistChangeEventType.wmplcDelete;
pub const wmplcInsert = WMPPlaylistChangeEventType.wmplcInsert;
pub const wmplcAppend = WMPPlaylistChangeEventType.wmplcAppend;
pub const wmplcPrivate = WMPPlaylistChangeEventType.wmplcPrivate;
pub const wmplcNameChange = WMPPlaylistChangeEventType.wmplcNameChange;
pub const wmplcMorph = WMPPlaylistChangeEventType.wmplcMorph;
pub const wmplcSort = WMPPlaylistChangeEventType.wmplcSort;
pub const wmplcLast = WMPPlaylistChangeEventType.wmplcLast;
...
pub const wmpssUnknown = WMPSyncState.wmpssUnknown;
pub const wmpssSynchronizing = WMPSyncState.wmpssSynchronizing;
pub const wmpssStopped = WMPSyncState.wmpssStopped;
pub const wmpssEstimating = WMPSyncState.wmpssEstimating;
pub const wmpssLast = WMPSyncState.wmpssLast;
...
pub const wmpdsUnknown = WMPDeviceStatus.wmpdsUnknown;
pub const wmpdsPartnershipExists = WMPDeviceStatus.wmpdsPartnershipExists;
pub const wmpdsPartnershipDeclined = WMPDeviceStatus.wmpdsPartnershipDeclined;
pub const wmpdsPartnershipAnother = WMPDeviceStatus.wmpdsPartnershipAnother;
pub const wmpdsManualDevice = WMPDeviceStatus.wmpdsManualDevice;
pub const wmpdsNewDevice = WMPDeviceStatus.wmpdsNewDevice;
pub const wmpdsLast = WMPDeviceStatus.wmpdsLast;
...
pub const wmprsUnknown = WMPRipState.wmprsUnknown;
pub const wmprsRipping = WMPRipState.wmprsRipping;
pub const wmprsStopped = WMPRipState.wmprsStopped;

pub const WMPBurnFormat = extern enum(i32) {
    wmpbfAudioCD = 0,
    wmpbfDataCD = 1,
};
pub const wmpbfAudioCD = WMPBurnFormat.wmpbfAudioCD;
pub const wmpbfDataCD = WMPBurnFormat.wmpbfDataCD;
...
pub const wmpbsUnknown = WMPBurnState.wmpbsUnknown;
pub const wmpbsBusy = WMPBurnState.wmpbsBusy;
pub const wmpbsReady = WMPBurnState.wmpbsReady;
pub const wmpbsWaitingForDisc = WMPBurnState.wmpbsWaitingForDisc;
pub const wmpbsRefreshStatusPending = WMPBurnState.wmpbsRefreshStatusPending;
pub const wmpbsPreparingToBurn = WMPBurnState.wmpbsPreparingToBurn;
pub const wmpbsBurning = WMPBurnState.wmpbsBurning;
pub const wmpbsStopped = WMPBurnState.wmpbsStopped;
pub const wmpbsErasing = WMPBurnState.wmpbsErasing;
pub const wmpbsDownloading = WMPBurnState.wmpbsDownloading;
...
pub const wmpsccetUnknown = WMPStringCollectionChangeEventType.wmpsccetUnknown;
pub const wmpsccetInsert = WMPStringCollectionChangeEventType.wmpsccetInsert;
pub const wmpsccetChange = WMPStringCollectionChangeEventType.wmpsccetChange;
pub const wmpsccetDelete = WMPStringCollectionChangeEventType.wmpsccetDelete;
pub const wmpsccetClear = WMPStringCollectionChangeEventType.wmpsccetClear;
pub const wmpsccetBeginUpdates = WMPStringCollectionChangeEventType.wmpsccetBeginUpdates;
pub const wmpsccetEndUpdates = WMPStringCollectionChangeEventType.wmpsccetEndUpdates;
...
pub const wmpltUnknown = WMPLibraryType.wmpltUnknown;
pub const wmpltAll = WMPLibraryType.wmpltAll;
pub const wmpltLocal = WMPLibraryType.wmpltLocal;
pub const wmpltRemote = WMPLibraryType.wmpltRemote;
pub const wmpltDisc = WMPLibraryType.wmpltDisc;
pub const wmpltPortableDevice = WMPLibraryType.wmpltPortableDevice;
...
pub const wmpfssUnknown = WMPFolderScanState.wmpfssUnknown;
pub const wmpfssScanning = WMPFolderScanState.wmpfssScanning;
pub const wmpfssUpdating = WMPFolderScanState.wmpfssUpdating;
pub const wmpfssStopped = WMPFolderScanState.wmpfssStopped;
...
pub const WMPPlugin_Caps = extern enum(i32) {
    CannotConvertFormats = 1,
};
pub const WMPPlugin_Caps_CannotConvertFormats = WMPPlugin_Caps.CannotConvertFormats;
...
pub const FBSA_DISABLE = FEEDS_BACKGROUNDSYNC_ACTION.FBSA_DISABLE;
pub const FBSA_ENABLE = FEEDS_BACKGROUNDSYNC_ACTION.FBSA_ENABLE;
pub const FBSA_RUNNOW = FEEDS_BACKGROUNDSYNC_ACTION.FBSA_RUNNOW;

pub const FEEDS_BACKGROUNDSYNC_STATUS = extern enum(i32) {
    FBSS_DISABLED = 0,
    FBSS_ENABLED = 1,
};
pub const FBSS_DISABLED = FEEDS_BACKGROUNDSYNC_STATUS.FBSS_DISABLED;
pub const FBSS_ENABLED = FEEDS_BACKGROUNDSYNC_STATUS.FBSS_ENABLED;
...
pub const FES_ALL = FEEDS_EVENTS_SCOPE.FES_ALL;
pub const FES_SELF_ONLY = FEEDS_EVENTS_SCOPE.FES_SELF_ONLY;
pub const FES_SELF_AND_CHILDREN_ONLY = FEEDS_EVENTS_SCOPE.FES_SELF_AND_CHILDREN_ONLY;

pub const FEEDS_EVENTS_MASK = extern enum(i32) {
    FEM_FOLDEREVENTS = 1,
    FEM_FEEDEVENTS = 2,
};
pub const FEM_FOLDEREVENTS = FEEDS_EVENTS_MASK.FEM_FOLDEREVENTS;
pub const FEM_FEEDEVENTS = FEEDS_EVENTS_MASK.FEM_FEEDEVENTS;
...
pub const FXSP_NONE = FEEDS_XML_SORT_PROPERTY.FXSP_NONE;
pub const FXSP_PUBDATE = FEEDS_XML_SORT_PROPERTY.FXSP_PUBDATE;
pub const FXSP_DOWNLOADTIME = FEEDS_XML_SORT_PROPERTY.FXSP_DOWNLOADTIME;
...
pub const FXSO_NONE = FEEDS_XML_SORT_ORDER.FXSO_NONE;
pub const FXSO_ASCENDING = FEEDS_XML_SORT_ORDER.FXSO_ASCENDING;
pub const FXSO_DESCENDING = FEEDS_XML_SORT_ORDER.FXSO_DESCENDING;
...
pub const FXFF_ALL = FEEDS_XML_FILTER_FLAGS.FXFF_ALL;
pub const FXFF_UNREAD = FEEDS_XML_FILTER_FLAGS.FXFF_UNREAD;
pub const FXFF_READ = FEEDS_XML_FILTER_FLAGS.FXFF_READ;

pub const FEEDS_XML_INCLUDE_FLAGS = extern enum(i32) {
    FXIF_NONE = 0,
    FXIF_CF_EXTENSIONS = 1,
};
pub const FXIF_NONE = FEEDS_XML_INCLUDE_FLAGS.FXIF_NONE;
pub const FXIF_CF_EXTENSIONS = FEEDS_XML_INCLUDE_FLAGS.FXIF_CF_EXTENSIONS;
...
pub const FDS_NONE = FEEDS_DOWNLOAD_STATUS.FDS_NONE;
pub const FDS_PENDING = FEEDS_DOWNLOAD_STATUS.FDS_PENDING;
pub const FDS_DOWNLOADING = FEEDS_DOWNLOAD_STATUS.FDS_DOWNLOADING;
pub const FDS_DOWNLOADED = FEEDS_DOWNLOAD_STATUS.FDS_DOWNLOADED;
pub const FDS_DOWNLOAD_FAILED = FEEDS_DOWNLOAD_STATUS.FDS_DOWNLOAD_FAILED;
...
pub const FSS_DEFAULT = FEEDS_SYNC_SETTING.FSS_DEFAULT;
pub const FSS_INTERVAL = FEEDS_SYNC_SETTING.FSS_INTERVAL;
pub const FSS_MANUAL = FEEDS_SYNC_SETTING.FSS_MANUAL;
pub const FSS_SUGGESTED = FEEDS_SYNC_SETTING.FSS_SUGGESTED;
...
pub const FDE_NONE = FEEDS_DOWNLOAD_ERROR.FDE_NONE;
pub const FDE_DOWNLOAD_FAILED = FEEDS_DOWNLOAD_ERROR.FDE_DOWNLOAD_FAILED;
pub const FDE_INVALID_FEED_FORMAT = FEEDS_DOWNLOAD_ERROR.FDE_INVALID_FEED_FORMAT;
pub const FDE_NORMALIZATION_FAILED = FEEDS_DOWNLOAD_ERROR.FDE_NORMALIZATION_FAILED;
pub const FDE_PERSISTENCE_FAILED = FEEDS_DOWNLOAD_ERROR.FDE_PERSISTENCE_FAILED;
pub const FDE_DOWNLOAD_BLOCKED = FEEDS_DOWNLOAD_ERROR.FDE_DOWNLOAD_BLOCKED;
pub const FDE_CANCELED = FEEDS_DOWNLOAD_ERROR.FDE_CANCELED;
pub const FDE_UNSUPPORTED_AUTH = FEEDS_DOWNLOAD_ERROR.FDE_UNSUPPORTED_AUTH;
pub const FDE_BACKGROUND_DOWNLOAD_DISABLED = FEEDS_DOWNLOAD_ERROR.FDE_BACKGROUND_DOWNLOAD_DISABLED;
pub const FDE_NOT_EXIST = FEEDS_DOWNLOAD_ERROR.FDE_NOT_EXIST;
pub const FDE_UNSUPPORTED_MSXML = FEEDS_DOWNLOAD_ERROR.FDE_UNSUPPORTED_MSXML;
pub const FDE_UNSUPPORTED_DTD = FEEDS_DOWNLOAD_ERROR.FDE_UNSUPPORTED_DTD;
pub const FDE_DOWNLOAD_SIZE_LIMIT_EXCEEDED = FEEDS_DOWNLOAD_ERROR.FDE_DOWNLOAD_SIZE_LIMIT_EXCEEDED;
pub const FDE_ACCESS_DENIED = FEEDS_DOWNLOAD_ERROR.FDE_ACCESS_DENIED;
pub const FDE_AUTH_FAILED = FEEDS_DOWNLOAD_ERROR.FDE_AUTH_FAILED;
pub const FDE_INVALID_AUTH = FEEDS_DOWNLOAD_ERROR.FDE_INVALID_AUTH;

pub const FEEDS_EVENTS_ITEM_COUNT_FLAGS = extern enum(i32) {
    FEICF_READ_ITEM_COUNT_CHANGED = 1,
    FEICF_UNREAD_ITEM_COUNT_CHANGED = 2,
};
pub const FEICF_READ_ITEM_COUNT_CHANGED = FEEDS_EVENTS_ITEM_COUNT_FLAGS.FEICF_READ_ITEM_COUNT_CHANGED;
pub const FEICF_UNREAD_ITEM_COUNT_CHANGED = FEEDS_EVENTS_ITEM_COUNT_FLAGS.FEICF_UNREAD_ITEM_COUNT_CHANGED;
...
pub const FEC_E_ERRORBASE = FEEDS_ERROR_CODE.FEC_E_ERRORBASE;
pub const FEC_E_INVALIDMSXMLPROPERTY = FEEDS_ERROR_CODE.FEC_E_INVALIDMSXMLPROPERTY;
pub const FEC_E_DOWNLOADSIZELIMITEXCEEDED = FEEDS_ERROR_CODE.FEC_E_DOWNLOADSIZELIMITEXCEEDED;
...
pub const IWMPPluginUI = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPPluginUI_TranslateAcceleratorA(self: *const T, lpmsg: *MSG) callconv(.Inline) HRESULT {
            return @ptrCast(*const IWMPPluginUI.VTable, self.vtable).TranslateAcceleratorA(@ptrCast(*const IWMPPluginUI, self), lpmsg);
        }
    };}
    pub usingnamespace MethodMixin(@This());
};
...
pub const wmpsnBackgroundProcessingBegin = WMPPartnerNotification.wmpsnBackgroundProcessingBegin;
pub const wmpsnBackgroundProcessingEnd = WMPPartnerNotification.wmpsnBackgroundProcessingEnd;
pub const wmpsnCatalogDownloadFailure = WMPPartnerNotification.wmpsnCatalogDownloadFailure;
pub const wmpsnCatalogDownloadComplete = WMPPartnerNotification.wmpsnCatalogDownloadComplete;
...
pub const wmpcnLoginStateChange = WMPCallbackNotification.wmpcnLoginStateChange;
pub const wmpcnAuthResult = WMPCallbackNotification.wmpcnAuthResult;
pub const wmpcnLicenseUpdated = WMPCallbackNotification.wmpcnLicenseUpdated;
pub const wmpcnNewCatalogAvailable = WMPCallbackNotification.wmpcnNewCatalogAvailable;
pub const wmpcnNewPluginAvailable = WMPCallbackNotification.wmpcnNewPluginAvailable;
pub const wmpcnDisableRadioSkipping = WMPCallbackNotification.wmpcnDisableRadioSkipping;
...
pub const wmpttBrowse = WMPTaskType.wmpttBrowse;
pub const wmpttSync = WMPTaskType.wmpttSync;
pub const wmpttBurn = WMPTaskType.wmpttBurn;
pub const wmpttCurrent = WMPTaskType.wmpttCurrent;
...
pub const wmpttNoTransaction = WMPTransactionType.wmpttNoTransaction;
pub const wmpttDownload = WMPTransactionType.wmpttDownload;
pub const wmpttBuy = WMPTransactionType.wmpttBuy;
...
pub const wmptsSmall = WMPTemplateSize.wmptsSmall;
pub const wmptsMedium = WMPTemplateSize.wmptsMedium;
pub const wmptsLarge = WMPTemplateSize.wmptsLarge;
...
pub const wmpstUnknown = WMPStreamingType.wmpstUnknown;
pub const wmpstMusic = WMPStreamingType.wmpstMusic;
pub const wmpstVideo = WMPStreamingType.wmpstVideo;
pub const wmpstRadio = WMPStreamingType.wmpstRadio;
...
pub const wmpatBuyOnly = WMPAccountType.wmpatBuyOnly;
pub const wmpatSubscription = WMPAccountType.wmpatSubscription;
pub const wmpatJanus = WMPAccountType.wmpatJanus;
...
pub const IWMPContentPartner = extern struct {
    ...
    pub fn MethodMixin(comptime T: type) type { return struct {
        ...
        // NOTE: method is namespaced with interface name to avoid conflicts for now
        pub fn IWMPContentPartner_SendMessageA(self: *const T, bstrMsg: BSTR, bstrParam: BSTR) callconv(.Inline) HRESULT {
            return @ptrCast(*const IWMPContentPartner.VTable, self.vtable).SendMessageA(@ptrCast(*const IWMPContentPartner, self), bstrMsg, bstrParam);
        }
        // NOTE: method is namespaced with interface name to avoid conflicts for now
...
pub const wmpsseCurrentBegin = WMPSubscriptionServiceEvent.wmpsseCurrentBegin;
pub const wmpsseCurrentEnd = WMPSubscriptionServiceEvent.wmpsseCurrentEnd;
pub const wmpsseFullBegin = WMPSubscriptionServiceEvent.wmpsseFullBegin;
pub const wmpsseFullEnd = WMPSubscriptionServiceEvent.wmpsseFullEnd;
...
pub const wmpsdlsDownloading = WMPSubscriptionDownloadState.wmpsdlsDownloading;
pub const wmpsdlsPaused = WMPSubscriptionDownloadState.wmpsdlsPaused;
pub const wmpsdlsProcessing = WMPSubscriptionDownloadState.wmpsdlsProcessing;
pub const wmpsdlsCompleted = WMPSubscriptionDownloadState.wmpsdlsCompleted;
pub const wmpsdlsCancelled = WMPSubscriptionDownloadState.wmpsdlsCancelled;
...
const IMFActivate = @import("media_foundation.zig").IMFActivate;
