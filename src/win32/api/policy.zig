...
pub const GPLinkUnknown = GPO_LINK.GPLinkUnknown;
pub const GPLinkMachine = GPO_LINK.GPLinkMachine;
pub const GPLinkSite = GPO_LINK.GPLinkSite;
pub const GPLinkDomain = GPO_LINK.GPLinkDomain;
pub const GPLinkOrganizationalUnit = GPO_LINK.GPLinkOrganizationalUnit;
...
pub const RSOPUnspecified = SETTINGSTATUS.RSOPUnspecified;
pub const RSOPApplied = SETTINGSTATUS.RSOPApplied;
pub const RSOPIgnored = SETTINGSTATUS.RSOPIgnored;
pub const RSOPFailed = SETTINGSTATUS.RSOPFailed;
pub const RSOPSubsettingFailed = SETTINGSTATUS.RSOPSubsettingFailed;
...
pub const GPOTypeLocal = GROUP_POLICY_OBJECT_TYPE.GPOTypeLocal;
pub const GPOTypeRemote = GROUP_POLICY_OBJECT_TYPE.GPOTypeRemote;
pub const GPOTypeDS = GROUP_POLICY_OBJECT_TYPE.GPOTypeDS;
pub const GPOTypeLocalUser = GROUP_POLICY_OBJECT_TYPE.GPOTypeLocalUser;
pub const GPOTypeLocalGroup = GROUP_POLICY_OBJECT_TYPE.GPOTypeLocalGroup;
...
pub const GPHintUnknown = GROUP_POLICY_HINT_TYPE.GPHintUnknown;
pub const GPHintMachine = GROUP_POLICY_HINT_TYPE.GPHintMachine;
pub const GPHintSite = GROUP_POLICY_HINT_TYPE.GPHintSite;
pub const GPHintDomain = GROUP_POLICY_HINT_TYPE.GPHintDomain;
pub const GPHintOrganizationalUnit = GROUP_POLICY_HINT_TYPE.GPHintOrganizationalUnit;
