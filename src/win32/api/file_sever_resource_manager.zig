...
pub const FsrmFileScreenFlags_Enforce = FsrmFileScreenFlags.Enforce;
...
pub const FsrmTemplateApplyOptions = extern enum(i32) {
    ApplyToDerivedMatching = 1,
    ApplyToDerivedAll = 2,
};
pub const FsrmTemplateApplyOptions_ApplyToDerivedMatching = FsrmTemplateApplyOptions.ApplyToDerivedMatching;
pub const FsrmTemplateApplyOptions_ApplyToDerivedAll = FsrmTemplateApplyOptions.ApplyToDerivedAll;
...
pub const FsrmReportLimit_MaxFiles = FsrmReportLimit.MaxFiles;
pub const FsrmReportLimit_MaxFileGroups = FsrmReportLimit.MaxFileGroups;
pub const FsrmReportLimit_MaxOwners = FsrmReportLimit.MaxOwners;
pub const FsrmReportLimit_MaxFilesPerFileGroup = FsrmReportLimit.MaxFilesPerFileGroup;
pub const FsrmReportLimit_MaxFilesPerOwner = FsrmReportLimit.MaxFilesPerOwner;
pub const FsrmReportLimit_MaxFilesPerDuplGroup = FsrmReportLimit.MaxFilesPerDuplGroup;
pub const FsrmReportLimit_MaxDuplicateGroups = FsrmReportLimit.MaxDuplicateGroups;
pub const FsrmReportLimit_MaxQuotas = FsrmReportLimit.MaxQuotas;
pub const FsrmReportLimit_MaxFileScreenEvents = FsrmReportLimit.MaxFileScreenEvents;
pub const FsrmReportLimit_MaxPropertyValues = FsrmReportLimit.MaxPropertyValues;
pub const FsrmReportLimit_MaxFilesPerPropertyValue = FsrmReportLimit.MaxFilesPerPropertyValue;
pub const FsrmReportLimit_MaxFolders = FsrmReportLimit.MaxFolders;
...
pub const FsrmPropertyDefinitionAppliesTo_Files = FsrmPropertyDefinitionAppliesTo.Files;
pub const FsrmPropertyDefinitionAppliesTo_Folders = FsrmPropertyDefinitionAppliesTo.Folders;
...
test {
    ...
    const enum_value_export_count = 209;
    const com_iface_id_export_count = 61;
    const com_class_id_export_count = 15;
