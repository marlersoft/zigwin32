...
pub const GWLP_WNDPROC = @as(i32, -4);
pub const GWLP_HINSTANCE = @as(i32, -6);
pub const GWLP_HWNDPARENT = @as(i32, -8);
pub const GWLP_USERDATA = @as(i32, -21);
pub const GWLP_ID = @as(i32, -12);
pub const GCLP_MENUNAME = @as(i32, -8);
pub const GCLP_HBRBACKGROUND = @as(i32, -10);
pub const GCLP_HCURSOR = @as(i32, -12);
pub const GCLP_HICON = @as(i32, -14);
pub const GCLP_HMODULE = @as(i32, -16);
pub const GCLP_WNDPROC = @as(i32, -24);
pub const GCLP_HICONSM = @as(i32, -34);
...
// TODO: This Enum is marked as [Flags], what do I do with this?
pub const BroadcastSystemMessageW_flags = extern enum(u32) {
    ALLOWSFW = 128,
    FLUSHDISK = 4,
    FORCEIFHUNG = 32,
    IGNORECURRENTTASK = 2,
...
pub const BSF_ALLOWSFW = BroadcastSystemMessageW_flags.ALLOWSFW;
pub const BSF_FLUSHDISK = BroadcastSystemMessageW_flags.FLUSHDISK;
pub const BSF_FORCEIFHUNG = BroadcastSystemMessageW_flags.FORCEIFHUNG;
pub const BSF_IGNORECURRENTTASK = BroadcastSystemMessageW_flags.IGNORECURRENTTASK;
pub const BSF_NOHANG = BroadcastSystemMessageW_flags.NOHANG;
pub const BSF_NOTIMEOUTIFNOTHUNG = BroadcastSystemMessageW_flags.NOTIMEOUTIFNOTHUNG;
pub const BSF_POSTMESSAGE = BroadcastSystemMessageW_flags.POSTMESSAGE;
pub const BSF_QUERY = BroadcastSystemMessageW_flags.QUERY;
pub const BSF_SENDNOTIFYMESSAGE = BroadcastSystemMessageW_flags.SENDNOTIFYMESSAGE;
pub const BSF_LUID = BroadcastSystemMessageW_flags.LUID;
pub const BSF_RETURNHDESK = BroadcastSystemMessageW_flags.RETURNHDESK;
...
pub const LoadIconW_lpIconName = extern enum(u32) {
    APPLICATION = 32512,
    ASTERISK = 32516,
    ERROR = 32513,
    EXCLAMATION = 32515,
...
pub const IDI_APPLICATION = LoadIconW_lpIconName.APPLICATION;
pub const IDI_ASTERISK = LoadIconW_lpIconName.ASTERISK;
pub const IDI_ERROR = LoadIconW_lpIconName.ERROR;
pub const IDI_EXCLAMATION = LoadIconW_lpIconName.EXCLAMATION;
pub const IDI_HAND = LoadIconW_lpIconName.HAND;
pub const IDI_INFORMATION = LoadIconW_lpIconName.INFORMATION;
pub const IDI_QUESTION = LoadIconW_lpIconName.QUESTION;
pub const IDI_SHIELD = LoadIconW_lpIconName.SHIELD;
pub const IDI_WARNING = LoadIconW_lpIconName.WARNING;
pub const IDI_WINLOGO = LoadIconW_lpIconName.WINLOGO;
...
pub const DrawIconEx_diFlags = extern enum(u32) {
    COMPAT = 4,
    DEFAULTSIZE = 8,
    IMAGE = 2,
    MASK = 1,
...
// TODO: enum 'DrawIconEx_diFlags' has known issues with its value aliases
...
pub const SetWindowLong_nIndex = extern enum(i32) {
    EXSTYLE = -20,
    HINSTANCE = -6,
    ID = -12,
    STYLE = -16,
...
pub const GWL_EXSTYLE = SetWindowLong_nIndex.EXSTYLE;
pub const GWL_HINSTANCE = SetWindowLong_nIndex.HINSTANCE;
pub const GWL_ID = SetWindowLong_nIndex.ID;
pub const GWL_STYLE = SetWindowLong_nIndex.STYLE;
pub const GWL_USERDATA = SetWindowLong_nIndex.USERDATA;
pub const GWL_WNDPROC = SetWindowLong_nIndex.WNDPROC;
pub const GWL_HWNDPARENT = SetWindowLong_nIndex.HWNDPARENT;
...
pub extern "USER32" fn BroadcastSystemMessageExA(
    flags: BroadcastSystemMessageW_flags,
...
pub extern "USER32" fn LoadIconW(
    hInstance: HINSTANCE,
    lpIconName: *const LoadIconW_lpIconName,
) callconv(@import("std").os.windows.WINAPI) HICON;
...
test {
    ...
    const constant_export_count = 1512;
    const type_export_count = 198;
    const enum_value_export_count = 933;
